...
.. autosummary::
    :toctree: compute_instance_agent/client
    :nosignatures:
...
.. autosummary::
    :toctree: compute_instance_agent/models
    :nosignatures:
    ...
    oci.compute_instance_agent.models.InstanceAgentCommandExecutionOutputViaObjectStorageUriDetails
    oci.compute_instance_agent.models.InstanceAgentCommandExecutionOutputViaTextDetails
    oci.compute_instance_agent.models.InstanceAgentCommandExecutionSummary
    oci.compute_instance_agent.models.InstanceAgentCommandOutputDetails
    oci.compute_instance_agent.models.InstanceAgentCommandOutputViaObjectStorageTupleDetails
    oci.compute_instance_agent.models.InstanceAgentCommandOutputViaObjectStorageUriDetails
    oci.compute_instance_agent.models.InstanceAgentCommandOutputViaTextDetails
    oci.compute_instance_agent.models.InstanceAgentCommandSourceDetails
    oci.compute_instance_agent.models.InstanceAgentCommandSourceViaObjectStorageTupleDetails
    oci.compute_instance_agent.models.InstanceAgentCommandSourceViaObjectStorageUriDetails
