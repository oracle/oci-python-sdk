...
.. autosummary::
    :toctree: service_mesh/client
    :nosignatures:
    :template: autosummary/service_client.rst

    oci.service_mesh.ServiceMeshClient
    oci.service_mesh.ServiceMeshClientCompositeOperations
...
.. autosummary::
    :toctree: service_mesh/models
    :nosignatures:
    :template: autosummary/model_class.rst

    oci.service_mesh.models.AccessLoggingConfiguration
    ...
    oci.service_mesh.models.ChangeIngressGatewayCompartmentDetails
    oci.service_mesh.models.ChangeIngressGatewayRouteTableCompartmentDetails
    oci.service_mesh.models.ChangeMeshCompartmentDetails
    oci.service_mesh.models.ChangeVirtualDeploymentCompartmentDetails
    oci.service_mesh.models.ChangeVirtualServiceCompartmentDetails
    ...
    oci.service_mesh.models.LocalFileTlsCertificate
    oci.service_mesh.models.Mesh
    oci.service_mesh.models.MeshCollection
    oci.service_mesh.models.MeshMutualTransportLayerSecurity
    oci.service_mesh.models.MeshSummary
    oci.service_mesh.models.MutualTransportLayerSecurity
    oci.service_mesh.models.OciCaBundle
    oci.service_mesh.models.OciTlsCertificate
    ...
    oci.service_mesh.models.UpdateVirtualDeploymentDetails
    oci.service_mesh.models.UpdateVirtualServiceDetails
    oci.service_mesh.models.UpdateVirtualServiceRouteTableDetails
    oci.service_mesh.models.VirtualDeployment
    oci.service_mesh.models.VirtualDeploymentCollection
    ...
    oci.service_mesh.models.WorkRequestErrorCollection
    oci.service_mesh.models.WorkRequestLogEntry
    oci.service_mesh.models.WorkRequestLogEntryCollection
    oci.service_mesh.models.WorkRequestResource
    oci.service_mesh.models.WorkRequestSummary
