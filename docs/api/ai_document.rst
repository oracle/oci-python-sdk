...
.. autosummary::
    :toctree: ai_document/client
    :nosignatures:
    :template: autosummary/service_client.rst

    oci.ai_document.AIServiceDocumentClient
    oci.ai_document.AIServiceDocumentClientCompositeOperations
...
.. autosummary::
    ...
    oci.ai_document.models.DataScienceLabelingDataset
    oci.ai_document.models.Dataset
    oci.ai_document.models.DatasetSummary
    oci.ai_document.models.DetectedDocumentType
    oci.ai_document.models.DetectedLanguage
    oci.ai_document.models.Dimensions
    oci.ai_document.models.DocumentClassificationConfidenceEntry
    ...
    oci.ai_document.models.UpdateProjectDetails
    oci.ai_document.models.ValueArray
    oci.ai_document.models.ValueDate
    oci.ai_document.models.ValueInteger
    oci.ai_document.models.ValueNumber
    oci.ai_document.models.ValuePhoneNumber
    oci.ai_document.models.ValueString
    oci.ai_document.models.ValueTime
    oci.ai_document.models.Word
    oci.ai_document.models.WorkRequest
    oci.ai_document.models.WorkRequestError
    oci.ai_document.models.WorkRequestErrorCollection
    oci.ai_document.models.WorkRequestLogEntry
    oci.ai_document.models.WorkRequestLogEntryCollection
    oci.ai_document.models.WorkRequestResource
    oci.ai_document.models.WorkRequestSummary
    oci.ai_document.models.WorkRequestSummaryCollection
