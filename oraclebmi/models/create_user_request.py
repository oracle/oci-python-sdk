...
class CreateUserRequest(object):
    ...
    def compartment_id(self):
        """
        Gets the compartment_id of this CreateUserRequest.
        The OCID of the tenancy containing the user.

        :return: The compartment_id of this CreateUserRequest.
        :rtype: str
        """
    ...
    def compartment_id(self, compartment_id):
        """
        Sets the compartment_id of this CreateUserRequest.
        The OCID of the tenancy containing the user.

        :param compartment_id: The compartment_id of this CreateUserRequest.
        :type: str
        """
