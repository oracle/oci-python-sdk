...
class TestLoadBalancer:
    ...
    def subtest_basic_operations(self, load_balancer_client, virtual_network):
        ...
        oraclebmc.wait_until(virtual_network, virtual_network.get_subnet(self.subnet_ocid1), 'lifecycle_state',
        ...
        oraclebmc.wait_until(load_balancer_client, load_balancer_client.get_work_request(work_request_id),
                             'lifecycle_state', 'SUCCEEDED', max_wait_seconds=300)
    ...
    def subtest_delete(self, load_balancer_client, virtual_network):
        ...
        if hasattr(self, 'load_balancer_ocid'):
            try:
                ...
                oraclebmc.wait_until(load_balancer_client, load_balancer_client.get_load_balancer(self.load_balancer_ocid), 'lifecycle_state', 'TERMINATED', max_wait_seconds=300)
        ...
        if hasattr(self, 'subnet_ocid1'):
            try:
                ...
                oraclebmc.wait_until(virtual_network,
                                     virtual_network.get_subnet(self.subnet_ocid1),
                                     'lifecycle_state',
                                     'TERMINATED',
        ...
        if hasattr(self, 'subnet_ocid2'):
            try:
                ...
                oraclebmc.wait_until(virtual_network,
                                     virtual_network.get_subnet(self.subnet_ocid2),
                                     'lifecycle_state',
                                     'TERMINATED',
                                     max_wait_seconds=600)
            except Exception as error:
