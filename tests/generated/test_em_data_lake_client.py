...
def test_cancel_work_request(testing_service_client):
    ...
    config = util.test_config_to_python_config(
        testing_service_client.get_test_config('em_warehouse', util.camelize('em_data_lake'), 'CancelWorkRequest')
    )
    ...
    for i in range(len(request_containers)):
        ...
        try:
            ...
            client = oci.em_warehouse.EmDataLakeClient(config, service_endpoint=service_endpoint)
...
def test_change_em_warehouse_compartment(testing_service_client):
    ...
    config = util.test_config_to_python_config(
        testing_service_client.get_test_config('em_warehouse', util.camelize('em_data_lake'), 'ChangeEmWarehouseCompartment')
    )
...
def test_create_em_warehouse(testing_service_client):
    ...
    config = util.test_config_to_python_config(
        testing_service_client.get_test_config('em_warehouse', util.camelize('em_data_lake'), 'CreateEmWarehouse')
    )
...
def test_delete_em_warehouse(testing_service_client):
    ...
    config = util.test_config_to_python_config(
        testing_service_client.get_test_config('em_warehouse', util.camelize('em_data_lake'), 'DeleteEmWarehouse')
    )
...
def test_get_em_warehouse(testing_service_client):
    ...
    config = util.test_config_to_python_config(
        testing_service_client.get_test_config('em_warehouse', util.camelize('em_data_lake'), 'GetEmWarehouse')
    )
...
def test_get_em_warehouse_resource_usage(testing_service_client):
    ...
    config = util.test_config_to_python_config(
        testing_service_client.get_test_config('em_warehouse', util.camelize('em_data_lake'), 'GetEmWarehouseResourceUsage')
    )
...
def test_get_work_request(testing_service_client):
    ...
    config = util.test_config_to_python_config(
        testing_service_client.get_test_config('em_warehouse', util.camelize('em_data_lake'), 'GetWorkRequest')
    )
...
def test_list_em_warehouses(testing_service_client):
    ...
    config = util.test_config_to_python_config(
        testing_service_client.get_test_config('em_warehouse', util.camelize('em_data_lake'), 'ListEmWarehouses')
    )
...
def test_list_etl_runs(testing_service_client):
    ...
    config = util.test_config_to_python_config(
        testing_service_client.get_test_config('em_warehouse', util.camelize('em_data_lake'), 'ListEtlRuns')
    )
    mock_mode = config['test_mode'] == 'mock' if 'test_mode' in config else False
...
def test_list_work_request_errors(testing_service_client):
    ...
    config = util.test_config_to_python_config(
        testing_service_client.get_test_config('em_warehouse', util.camelize('em_data_lake'), 'ListWorkRequestErrors')
    )
    mock_mode = config['test_mode'] == 'mock' if 'test_mode' in config else False
...
def test_list_work_request_logs(testing_service_client):
    ...
    config = util.test_config_to_python_config(
        testing_service_client.get_test_config('em_warehouse', util.camelize('em_data_lake'), 'ListWorkRequestLogs')
    )
    mock_mode = config['test_mode'] == 'mock' if 'test_mode' in config else False
...
def test_list_work_requests(testing_service_client):
    ...
    config = util.test_config_to_python_config(
        testing_service_client.get_test_config('em_warehouse', util.camelize('em_data_lake'), 'ListWorkRequests')
    )
    mock_mode = config['test_mode'] == 'mock' if 'test_mode' in config else False
...
def test_update_em_warehouse(testing_service_client):
    ...
    config = util.test_config_to_python_config(
        testing_service_client.get_test_config('em_warehouse', util.camelize('em_data_lake'), 'UpdateEmWarehouse')
    )
