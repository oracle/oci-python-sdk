    ...
    for i in range(len(request_containers)):
        ...
        try:
            ...
            response = client.change_oda_instance_compartment(
                ...
                change_oda_instance_compartment_details=request.pop(util.camelize('change_oda_instance_compartment_details')),
    ...
    for i in range(len(request_containers)):
        ...
        try:
            ...
            response = client.create_oda_instance(
                create_oda_instance_details=request.pop(util.camelize('create_oda_instance_details')),
                **(util.camel_to_snake_keys(request))
            )
            result.append(response)
        except oci_exception.ServiceError as service_exception:
    ...
    for i in range(len(request_containers)):
        ...
        try:
            ...
            response = client.update_oda_instance(
                oda_instance_id=request.pop(util.camelize('oda_instance_id')),
                update_oda_instance_details=request.pop(util.camelize('update_oda_instance_details')),
                **(util.camel_to_snake_keys(request))
            )
            result.append(response)
        except oci_exception.ServiceError as service_exception:
