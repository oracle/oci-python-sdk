...
def test_list_shipping_vendors(testing_service_client):
    ...
    config = util.test_config_to_python_config(
        testing_service_client.get_test_config('dts', util.camelize('shipping_vendors'), 'ListShippingVendors')
    )

    request_containers = testing_service_client.get_requests(service_name='dts', api_name='ListShippingVendors')
