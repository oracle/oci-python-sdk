    ...
    for i in range(len(request_containers)):
        ...
        try:
            ...
            response = client.change_deployment_compartment(
                deployment_id=request.pop(util.camelize('deployment_id')),
                change_deployment_compartment_details=request.pop(util.camelize('change_deployment_compartment_details')),
    ...
    for i in range(len(request_containers)):
        ...
        try:
            ...
            response = client.create_deployment(
                create_deployment_details=request.pop(util.camelize('create_deployment_details')),
                **(util.camel_to_snake_keys(request))
            )
            result.append(response)
        except oci_exception.ServiceError as service_exception:
    ...
    for i in range(len(request_containers)):
        ...
        try:
            ...
            response = client.update_deployment(
                deployment_id=request.pop(util.camelize('deployment_id')),
                update_deployment_details=request.pop(util.camelize('update_deployment_details')),
                **(util.camel_to_snake_keys(request))
            )
            result.append(response)
        except oci_exception.ServiceError as service_exception:
