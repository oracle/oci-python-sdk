...
def test_get_scheduled_activity(testing_service_client):
    ...
    config = util.test_config_to_python_config(
        testing_service_client.get_test_config('fusion_apps', util.camelize('scheduled_activity'), 'GetScheduledActivity')
    )
    ...
    for i in range(len(request_containers)):
        ...
        try:
            ...
            client = oci.fusion_apps.ScheduledActivityClient(config, service_endpoint=service_endpoint)
...
def test_list_scheduled_activities(testing_service_client):
    ...
    config = util.test_config_to_python_config(
        testing_service_client.get_test_config('fusion_apps', util.camelize('scheduled_activity'), 'ListScheduledActivities')
    )
