...
def test_create_data_masking_activity(testing_service_client):
    ...
    config = util.test_config_to_python_config(
        testing_service_client.get_test_config('fusion_apps', util.camelize('data_masking_activity'), 'CreateDataMaskingActivity')
    )
    ...
    for i in range(len(request_containers)):
        ...
        try:
            ...
            client = oci.fusion_apps.DataMaskingActivityClient(config, service_endpoint=service_endpoint)
...
def test_get_data_masking_activity(testing_service_client):
    ...
    config = util.test_config_to_python_config(
        testing_service_client.get_test_config('fusion_apps', util.camelize('data_masking_activity'), 'GetDataMaskingActivity')
    )
...
def test_list_data_masking_activities(testing_service_client):
    ...
    config = util.test_config_to_python_config(
        testing_service_client.get_test_config('fusion_apps', util.camelize('data_masking_activity'), 'ListDataMaskingActivities')
    )
