...
def test_accept_recommendations(testing_service_client, config):
...
def test_create_waas_policy(testing_service_client, config):
...
def test_delete_waas_policy(testing_service_client, config):
...
def test_get_certificate(testing_service_client, config):
...
def test_get_device_fingerprint_challenge(testing_service_client, config):
...
def test_get_human_interaction_challenge(testing_service_client, config):
...
def test_get_js_challenge(testing_service_client, config):
...
def test_get_policy_config(testing_service_client, config):
...
def test_get_protection_rule(testing_service_client, config):
...
def test_get_protection_settings(testing_service_client, config):
...
def test_get_waas_policy(testing_service_client, config):
...
def test_get_waf_address_rate_limiting(testing_service_client, config):
...
def test_get_waf_config(testing_service_client, config):
...
def test_list_access_rules(testing_service_client, config):
...
def test_list_captchas(testing_service_client, config):
...
def test_list_edge_subnets(testing_service_client, config):
...
def test_list_good_bots(testing_service_client, config):
...
def test_list_protection_rules(testing_service_client, config):
...
def test_list_recommendations(testing_service_client, config):
...
def test_list_threat_feeds(testing_service_client, config):
...
def test_list_waas_policies(testing_service_client, config):
...
def test_list_waf_blocked_requests(testing_service_client, config):
...
def test_list_waf_logs(testing_service_client, config):
...
def test_list_waf_requests(testing_service_client, config):
...
def test_list_waf_traffic(testing_service_client, config):
...
def test_list_whitelists(testing_service_client, config):
...
def test_update_access_rules(testing_service_client, config):
...
def test_update_captchas(testing_service_client, config):
...
def test_update_certificate(testing_service_client, config):
...
def test_update_device_fingerprint_challenge(testing_service_client, config):
...
def test_update_good_bots(testing_service_client, config):
...
def test_update_human_interaction_challenge(testing_service_client, config):
...
def test_update_js_challenge(testing_service_client, config):
...
def test_update_policy_config(testing_service_client, config):
...
def test_update_protection_rules(testing_service_client, config):
...
def test_update_protection_settings(testing_service_client, config):
...
def test_update_threat_feeds(testing_service_client, config):
...
def test_update_waas_policy(testing_service_client, config):
...
def test_update_waf_address_rate_limiting(testing_service_client, config):
...
def test_update_waf_config(testing_service_client, config):
...
def test_update_whitelists(testing_service_client, config):
