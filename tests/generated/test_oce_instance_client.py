    ...
    for i in range(len(request_containers)):
        ...
        try:
            ...
            response = client.change_oce_instance_compartment(
                ...
                change_oce_instance_compartment_details=request.pop(util.camelize('change_oce_instance_compartment_details')),
    ...
    for i in range(len(request_containers)):
        ...
        try:
            ...
            response = client.create_oce_instance(
                create_oce_instance_details=request.pop(util.camelize('create_oce_instance_details')),
                **(util.camel_to_snake_keys(request))
            )
            result.append(response)
        except oci_exception.ServiceError as service_exception:
    ...
    for i in range(len(request_containers)):
        ...
        try:
            ...
            response = client.update_oce_instance(
                oce_instance_id=request.pop(util.camelize('oce_instance_id')),
                update_oce_instance_details=request.pop(util.camelize('update_oce_instance_details')),
                **(util.camel_to_snake_keys(request))
            )
            result.append(response)
        except oci_exception.ServiceError as service_exception:
