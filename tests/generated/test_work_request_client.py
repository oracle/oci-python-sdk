...
def test_get_work_request(testing_service_client):
    ...
    config = util.test_config_to_python_config(
        testing_service_client.get_test_config('work_requests', util.camelize('work_request'), 'GetWorkRequest')
    )

    request_containers = testing_service_client.get_requests(service_name='work_requests', api_name='GetWorkRequest')
