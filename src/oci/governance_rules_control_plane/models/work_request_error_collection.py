...
class WorkRequestErrorCollection(object):
    ...
    def __init__(self, **kwargs):
        ...
        :type items: list[oci.governance_rules_control_plane.models.WorkRequestError]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this WorkRequestErrorCollection.
        ...
        :rtype: list[oci.governance_rules_control_plane.models.WorkRequestError]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.governance_rules_control_plane.models.WorkRequestError]
        """
        self._items = items
