...
class DefaultTagDefinitionValidator(BaseTagDefinitionValidator):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new DefaultTagDefinitionValidator object with values from keyword arguments. The default value of the :py:attr:`~oci.governance_rules_control_plane.models.DefaultTagDefinitionValidator.validator_type` attribute
