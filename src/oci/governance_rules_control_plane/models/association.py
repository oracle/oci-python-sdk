...
class Association(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new Association object with values from keyword arguments. This class has the following subclasses and if you are using this class as input
        to a service operations then you should favor using a subclass over the base class:

        * :class:`~oci.governance_rules_control_plane.models.TenancyAssociation`

        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param type:
            The value to assign to the type property of this Association.
        :type type: str
