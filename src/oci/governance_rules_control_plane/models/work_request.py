...
class WorkRequest(object):
    ...
    #: This constant has a value of "CREATE_GOVERNANCE_RULE"
    OPERATION_TYPE_CREATE_GOVERNANCE_RULE = "CREATE_GOVERNANCE_RULE"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "UPDATE_GOVERNANCE_RULE"
    OPERATION_TYPE_UPDATE_GOVERNANCE_RULE = "UPDATE_GOVERNANCE_RULE"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "DELETE_GOVERNANCE_RULE"
    OPERATION_TYPE_DELETE_GOVERNANCE_RULE = "DELETE_GOVERNANCE_RULE"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "RETRY_GOVERNANCE_RULE"
    OPERATION_TYPE_RETRY_GOVERNANCE_RULE = "RETRY_GOVERNANCE_RULE"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "CREATE_INCLUSION_CRITERIA"
    OPERATION_TYPE_CREATE_INCLUSION_CRITERIA = "CREATE_INCLUSION_CRITERIA"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "DELETE_INCLUSION_CRITERIA"
    OPERATION_TYPE_DELETE_INCLUSION_CRITERIA = "DELETE_INCLUSION_CRITERIA"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "RETRY_TENANCY_ATTACHMENT"
    OPERATION_TYPE_RETRY_TENANCY_ATTACHMENT = "RETRY_TENANCY_ATTACHMENT"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "APPLY_TENANCY_ATTACHMENT"
    OPERATION_TYPE_APPLY_TENANCY_ATTACHMENT = "APPLY_TENANCY_ATTACHMENT"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "CREATE_ENFORCED_QUOTA_GOVERNANCE_RULE"
    OPERATION_TYPE_CREATE_ENFORCED_QUOTA_GOVERNANCE_RULE = "CREATE_ENFORCED_QUOTA_GOVERNANCE_RULE"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "CREATE_ENFORCED_TAG_GOVERNANCE_RULE"
    OPERATION_TYPE_CREATE_ENFORCED_TAG_GOVERNANCE_RULE = "CREATE_ENFORCED_TAG_GOVERNANCE_RULE"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "UPDATE_ENFORCED_QUOTA_GOVERNANCE_RULE"
    OPERATION_TYPE_UPDATE_ENFORCED_QUOTA_GOVERNANCE_RULE = "UPDATE_ENFORCED_QUOTA_GOVERNANCE_RULE"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "UPDATE_ENFORCED_TAG_GOVERNANCE_RULE"
    OPERATION_TYPE_UPDATE_ENFORCED_TAG_GOVERNANCE_RULE = "UPDATE_ENFORCED_TAG_GOVERNANCE_RULE"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "DELETE_ENFORCED_QUOTA_GOVERNANCE_RULE"
    OPERATION_TYPE_DELETE_ENFORCED_QUOTA_GOVERNANCE_RULE = "DELETE_ENFORCED_QUOTA_GOVERNANCE_RULE"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "DELETE_ENFORCED_TAG_GOVERNANCE_RULE"
    OPERATION_TYPE_DELETE_ENFORCED_TAG_GOVERNANCE_RULE = "DELETE_ENFORCED_TAG_GOVERNANCE_RULE"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "TENANT_MANAGER_OPT_IN_EVENT_HANDLER"
    OPERATION_TYPE_TENANT_MANAGER_OPT_IN_EVENT_HANDLER = "TENANT_MANAGER_OPT_IN_EVENT_HANDLER"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "TENANT_MANAGER_OPT_OUT_EVENT_HANDLER"
    OPERATION_TYPE_TENANT_MANAGER_OPT_OUT_EVENT_HANDLER = "TENANT_MANAGER_OPT_OUT_EVENT_HANDLER"
    ...
    def __init__(self, **kwargs):
        ...
        :param operation_type:
            ...
            Allowed values for this property are: "CREATE_GOVERNANCE_RULE", "UPDATE_GOVERNANCE_RULE", "DELETE_GOVERNANCE_RULE", "RETRY_GOVERNANCE_RULE", "CREATE_INCLUSION_CRITERIA", "DELETE_INCLUSION_CRITERIA", "RETRY_TENANCY_ATTACHMENT", "APPLY_TENANCY_ATTACHMENT", "CREATE_ENFORCED_QUOTA_GOVERNANCE_RULE", "CREATE_ENFORCED_TAG_GOVERNANCE_RULE", "UPDATE_ENFORCED_QUOTA_GOVERNANCE_RULE", "UPDATE_ENFORCED_TAG_GOVERNANCE_RULE", "DELETE_ENFORCED_QUOTA_GOVERNANCE_RULE", "DELETE_ENFORCED_TAG_GOVERNANCE_RULE", "TENANT_MANAGER_OPT_IN_EVENT_HANDLER", "TENANT_MANAGER_OPT_OUT_EVENT_HANDLER", 'UNKNOWN_ENUM_VALUE'.
        ...
        :type resources: list[oci.governance_rules_control_plane.models.WorkRequestResource]
    ...
    def resources(self):
        ...
        **[Required]** Gets the resources of this WorkRequest.
        ...
        :rtype: list[oci.governance_rules_control_plane.models.WorkRequestResource]
        """
    ...
    def resources(self, resources):
        ...
        :type: list[oci.governance_rules_control_plane.models.WorkRequestResource]
        """
