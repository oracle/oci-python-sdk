...
class BaseTagDefinitionValidator(object):
    ...
    def __init__(self, **kwargs):
        ...
        * :class:`~oci.governance_rules_control_plane.models.DefaultTagDefinitionValidator`
        * :class:`~oci.governance_rules_control_plane.models.EnumTagDefinitionValidator`
