...
class BackendDetails(object):
    ...
    def port(self):
        ...
        **[Required]** Gets the port of this BackendDetails.
        ...
        :return: The port of this BackendDetails.
        :rtype: int
        """
        return self._port
    ...
    def port(self, port):
        """
        Sets the port of this BackendDetails.
        The communication port for the backend server.

        Example: `8080`


        :param port: The port of this BackendDetails.
        :type: int
        """
        self._port = port
    ...
    def weight(self, weight):
        """
        Sets the weight of this BackendDetails.
        The load balancing policy weight assigned to the server. Backend servers with a higher weight receive a larger
        proportion of incoming traffic. For example, a server weighted '3' receives 3 times the number of new connections
        as a server weighted '1'.
        For more information on load balancing policies, see
