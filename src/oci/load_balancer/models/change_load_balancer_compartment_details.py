...
class ChangeLoadBalancerCompartmentDetails(object):
    """
    ...
    **Warning:** Oracle recommends that you avoid using any confidential information when you supply string values using the API.
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ChangeLoadBalancerCompartmentDetails object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param compartment_id:
            The value to assign to the compartment_id property of this ChangeLoadBalancerCompartmentDetails.
