...
class RevokeDelegatedResourceAccessRequestDetails(object):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new RevokeDelegatedResourceAccessRequestDetails object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param approver_comment:
            The value to assign to the approver_comment property of this RevokeDelegatedResourceAccessRequestDetails.
    ...
    def approver_comment(self):
        ...
        :return: The approver_comment of this RevokeDelegatedResourceAccessRequestDetails.
        :rtype: str
        """
    ...
    def approver_comment(self, approver_comment):
        """
        Sets the approver_comment of this RevokeDelegatedResourceAccessRequestDetails.
        Comment specified by the approver explaining why the approval is revoked.


        :param approver_comment: The approver_comment of this RevokeDelegatedResourceAccessRequestDetails.
        :type: str
        """
