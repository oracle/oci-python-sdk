...
class WorkRequestSummaryCollection(object):
    ...
    def __init__(self, **kwargs):
        ...
        :type items: list[oci.delegate_access_control.models.WorkRequestSummary]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this WorkRequestSummaryCollection.
        ...
        :rtype: list[oci.delegate_access_control.models.WorkRequestSummary]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.delegate_access_control.models.WorkRequestSummary]
        """
        self._items = items
