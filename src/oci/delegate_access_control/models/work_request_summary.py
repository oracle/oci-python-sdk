...
class WorkRequestSummary(object):
    ...
    #: This constant has a value of "CREATE_DELEGATION_CONTROL"
    OPERATION_TYPE_CREATE_DELEGATION_CONTROL = "CREATE_DELEGATION_CONTROL"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "UPDATE_DELEGATION_CONTROL"
    OPERATION_TYPE_UPDATE_DELEGATION_CONTROL = "UPDATE_DELEGATION_CONTROL"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "DELETE_DELEGATION_CONTROL"
    OPERATION_TYPE_DELETE_DELEGATION_CONTROL = "DELETE_DELEGATION_CONTROL"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "MOVE_DELEGATION_CONTROL"
    OPERATION_TYPE_MOVE_DELEGATION_CONTROL = "MOVE_DELEGATION_CONTROL"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "CREATE_DELEGATED_RESOURCE_ACCESS_REQUEST"
    OPERATION_TYPE_CREATE_DELEGATED_RESOURCE_ACCESS_REQUEST = "CREATE_DELEGATED_RESOURCE_ACCESS_REQUEST"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "APPROVE_DELEGATED_RESOURCE_ACCESS_REQUEST"
    OPERATION_TYPE_APPROVE_DELEGATED_RESOURCE_ACCESS_REQUEST = "APPROVE_DELEGATED_RESOURCE_ACCESS_REQUEST"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "REJECT_DELEGATED_RESOURCE_ACCESS_REQUEST"
    OPERATION_TYPE_REJECT_DELEGATED_RESOURCE_ACCESS_REQUEST = "REJECT_DELEGATED_RESOURCE_ACCESS_REQUEST"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "REVOKE_DELEGATED_RESOURCE_ACCESS_REQUEST"
    OPERATION_TYPE_REVOKE_DELEGATED_RESOURCE_ACCESS_REQUEST = "REVOKE_DELEGATED_RESOURCE_ACCESS_REQUEST"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "CREATE_DELEGATION_SUBSCRIPTION"
    OPERATION_TYPE_CREATE_DELEGATION_SUBSCRIPTION = "CREATE_DELEGATION_SUBSCRIPTION"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "UPDATE_DELEGATION_SUBSCRIPTION"
    OPERATION_TYPE_UPDATE_DELEGATION_SUBSCRIPTION = "UPDATE_DELEGATION_SUBSCRIPTION"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "DELETE_DELEGATION_SUBSCRIPTION"
    OPERATION_TYPE_DELETE_DELEGATION_SUBSCRIPTION = "DELETE_DELEGATION_SUBSCRIPTION"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "MOVE_DELEGATION_SUBSCRIPTION"
    OPERATION_TYPE_MOVE_DELEGATION_SUBSCRIPTION = "MOVE_DELEGATION_SUBSCRIPTION"
    ...
    def __init__(self, **kwargs):
        ...
        :param operation_type:
            ...
            Allowed values for this property are: "CREATE_DELEGATION_CONTROL", "UPDATE_DELEGATION_CONTROL", "DELETE_DELEGATION_CONTROL", "MOVE_DELEGATION_CONTROL", "CREATE_DELEGATED_RESOURCE_ACCESS_REQUEST", "APPROVE_DELEGATED_RESOURCE_ACCESS_REQUEST", "REJECT_DELEGATED_RESOURCE_ACCESS_REQUEST", "REVOKE_DELEGATED_RESOURCE_ACCESS_REQUEST", "CREATE_DELEGATION_SUBSCRIPTION", "UPDATE_DELEGATION_SUBSCRIPTION", "DELETE_DELEGATION_SUBSCRIPTION", "MOVE_DELEGATION_SUBSCRIPTION", 'UNKNOWN_ENUM_VALUE'.
        ...
        :type resources: list[oci.delegate_access_control.models.WorkRequestResource]
    ...
    def operation_type(self, operation_type):
        ...
        :type: str
        """
        allowed_values = ["CREATE_DELEGATION_CONTROL", "UPDATE_DELEGATION_CONTROL", "DELETE_DELEGATION_CONTROL", "MOVE_DELEGATION_CONTROL", "CREATE_DELEGATED_RESOURCE_ACCESS_REQUEST", "APPROVE_DELEGATED_RESOURCE_ACCESS_REQUEST", "REJECT_DELEGATED_RESOURCE_ACCESS_REQUEST", "REVOKE_DELEGATED_RESOURCE_ACCESS_REQUEST", "CREATE_DELEGATION_SUBSCRIPTION", "UPDATE_DELEGATION_SUBSCRIPTION", "DELETE_DELEGATION_SUBSCRIPTION", "MOVE_DELEGATION_SUBSCRIPTION"]
    ...
    def resources(self):
        ...
        **[Required]** Gets the resources of this WorkRequestSummary.
        ...
        :rtype: list[oci.delegate_access_control.models.WorkRequestResource]
        """
    ...
    def resources(self, resources):
        ...
        :type: list[oci.delegate_access_control.models.WorkRequestResource]
        """
