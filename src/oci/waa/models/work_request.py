...
class WorkRequest(object):
    ...
    #: This constant has a value of "CREATE_WAA_POLICY"
    OPERATION_TYPE_CREATE_WAA_POLICY = "CREATE_WAA_POLICY"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "UPDATE_WAA_POLICY"
    OPERATION_TYPE_UPDATE_WAA_POLICY = "UPDATE_WAA_POLICY"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "DELETE_WAA_POLICY"
    OPERATION_TYPE_DELETE_WAA_POLICY = "DELETE_WAA_POLICY"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "MOVE_WAA_POLICY"
    OPERATION_TYPE_MOVE_WAA_POLICY = "MOVE_WAA_POLICY"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "CREATE_WEB_APP_ACCELERATION"
    OPERATION_TYPE_CREATE_WEB_APP_ACCELERATION = "CREATE_WEB_APP_ACCELERATION"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "UPDATE_WEB_APP_ACCELERATION"
    OPERATION_TYPE_UPDATE_WEB_APP_ACCELERATION = "UPDATE_WEB_APP_ACCELERATION"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "DELETE_WEB_APP_ACCELERATION"
    OPERATION_TYPE_DELETE_WEB_APP_ACCELERATION = "DELETE_WEB_APP_ACCELERATION"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "MOVE_WEB_APP_ACCELERATION"
    OPERATION_TYPE_MOVE_WEB_APP_ACCELERATION = "MOVE_WEB_APP_ACCELERATION"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "PURGE_WEB_APP_ACCELERATION_CACHE"
    OPERATION_TYPE_PURGE_WEB_APP_ACCELERATION_CACHE = "PURGE_WEB_APP_ACCELERATION_CACHE"
    ...
    def __init__(self, **kwargs):
        ...
        :param operation_type:
            ...
            Allowed values for this property are: "CREATE_WAA_POLICY", "UPDATE_WAA_POLICY", "DELETE_WAA_POLICY", "MOVE_WAA_POLICY", "CREATE_WEB_APP_ACCELERATION", "UPDATE_WEB_APP_ACCELERATION", "DELETE_WEB_APP_ACCELERATION", "MOVE_WEB_APP_ACCELERATION", "PURGE_WEB_APP_ACCELERATION_CACHE", 'UNKNOWN_ENUM_VALUE'.
        ...
        :type resources: list[oci.waa.models.WorkRequestResource]
    ...
    def operation_type(self, operation_type):
        ...
        :type: str
        """
        allowed_values = ["CREATE_WAA_POLICY", "UPDATE_WAA_POLICY", "DELETE_WAA_POLICY", "MOVE_WAA_POLICY", "CREATE_WEB_APP_ACCELERATION", "UPDATE_WEB_APP_ACCELERATION", "DELETE_WEB_APP_ACCELERATION", "MOVE_WEB_APP_ACCELERATION", "PURGE_WEB_APP_ACCELERATION_CACHE"]
    ...
    def id(self):
        ...
        **[Required]** Gets the id of this WorkRequest.
        The `OCID`__ of the WorkRequest.
    ...
    def compartment_id(self):
        ...
        **[Required]** Gets the compartment_id of this WorkRequest.
        The `OCID`__ of the compartment that contains the WorkRequest.
    ...
    def resources(self):
        ...
        **[Required]** Gets the resources of this WorkRequest.
        ...
        :rtype: list[oci.waa.models.WorkRequestResource]
        """
    ...
    def resources(self, resources):
        ...
        :type: list[oci.waa.models.WorkRequestResource]
        """
