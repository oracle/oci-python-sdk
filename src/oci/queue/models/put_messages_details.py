...
class PutMessagesDetails(object):
    ...
    def __init__(self, **kwargs):
        ...
        :type messages: list[oci.queue.models.PutMessagesDetailsEntry]
    ...
    def messages(self):
        ...
        **[Required]** Gets the messages of this PutMessagesDetails.
        ...
        :rtype: list[oci.queue.models.PutMessagesDetailsEntry]
        """
    ...
    def messages(self, messages):
        ...
        :type: list[oci.queue.models.PutMessagesDetailsEntry]
        """
