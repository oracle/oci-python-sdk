...
class GuestOsSoftwareComponentDetails(SoftwareComponentDetails):
    """
    Details of 'GUEST_OS' component in an Exadata software stack.
    """

    #: A constant which can be used with the source_major_version property of a GuestOsSoftwareComponentDetails.
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new GuestOsSoftwareComponentDetails object with values from keyword arguments. The default value of the :py:attr:`~oci.fleet_software_update.models.GuestOsSoftwareComponentDetails.component_type` attribute
        of this class is ``GUEST_OS`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param component_type:
            The value to assign to the component_type property of this GuestOsSoftwareComponentDetails.
            Allowed values for this property are: "GI", "GUEST_OS", 'UNKNOWN_ENUM_VALUE'.
            Any unrecognized values returned by a service will be mapped to 'UNKNOWN_ENUM_VALUE'.
        :type component_type: str

        :param source_major_version:
            The value to assign to the source_major_version property of this GuestOsSoftwareComponentDetails.
        ...
        :param fleet_discovery:
            The value to assign to the fleet_discovery property of this GuestOsSoftwareComponentDetails.
    ...
    def source_major_version(self):
        """
        **[Required]** Gets the source_major_version of this GuestOsSoftwareComponentDetails.
        ...
        :return: The source_major_version of this GuestOsSoftwareComponentDetails.
        :rtype: str
        """
    ...
    def source_major_version(self, source_major_version):
        """
        Sets the source_major_version of this GuestOsSoftwareComponentDetails.
        Major version of Exadata Image (Guest OS) release for Exadata VM Cluster targets to be included in an Exadata Fleet Update Collection.
        Major Versions of Exadata Software are demarcated by the underlying Oracle Linux OS version.
        For more details, refer to `Oracle document 2075007.1`__
        ...
        :param source_major_version: The source_major_version of this GuestOsSoftwareComponentDetails.
        :type: str
        """
    ...
    def fleet_discovery(self):
        ...
        **[Required]** Gets the fleet_discovery of this GuestOsSoftwareComponentDetails.
        ...
        :return: The fleet_discovery of this GuestOsSoftwareComponentDetails.
    ...
    def fleet_discovery(self, fleet_discovery):
        """
        Sets the fleet_discovery of this GuestOsSoftwareComponentDetails.

        :param fleet_discovery: The fleet_discovery of this GuestOsSoftwareComponentDetails.
