...
class GuestOsFreeformTagsFilter(GuestOsFleetDiscoveryFilter):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new GuestOsFreeformTagsFilter object with values from keyword arguments. The default value of the :py:attr:`~oci.fleet_software_update.models.GuestOsFreeformTagsFilter.type` attribute
        of this class is ``FREEFORM_TAG`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param type:
            The value to assign to the type property of this GuestOsFreeformTagsFilter.
        ...
        :param mode:
            The value to assign to the mode property of this GuestOsFreeformTagsFilter.
            Allowed values for this property are: "INCLUDE", "EXCLUDE", 'UNKNOWN_ENUM_VALUE'.
            Any unrecognized values returned by a service will be mapped to 'UNKNOWN_ENUM_VALUE'.
        :type mode: str

        :param tags:
            The value to assign to the tags property of this GuestOsFreeformTagsFilter.
        :type tags: list[oci.fleet_software_update.models.FreeformTagFilterEntry]

        :param operator:
            The value to assign to the operator property of this GuestOsFreeformTagsFilter.
    ...
    def operator(self):
        """
        Gets the operator of this GuestOsFreeformTagsFilter.
        ...
        :return: The operator of this GuestOsFreeformTagsFilter.
        :rtype: str
        """
    ...
    def operator(self, operator):
        """
        Sets the operator of this GuestOsFreeformTagsFilter.
        Type of join for each element in this filter.


        :param operator: The operator of this GuestOsFreeformTagsFilter.
        :type: str
        """
