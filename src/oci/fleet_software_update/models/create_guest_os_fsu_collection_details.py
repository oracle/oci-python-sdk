...
class CreateGuestOsFsuCollectionDetails(CreateFsuCollectionDetails):
    """
    ...
    #: A constant which can be used with the source_major_version property of a CreateGuestOsFsuCollectionDetails.
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new CreateGuestOsFsuCollectionDetails object with values from keyword arguments. The default value of the :py:attr:`~oci.fleet_software_update.models.CreateGuestOsFsuCollectionDetails.type` attribute
        of this class is ``GUEST_OS`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param display_name:
            The value to assign to the display_name property of this CreateGuestOsFsuCollectionDetails.
        :type display_name: str

        :param type:
            The value to assign to the type property of this CreateGuestOsFsuCollectionDetails.
            Allowed values for this property are: "DB", "GI", "GUEST_OS", "EXADB_STACK"
        :type type: str

        :param service_type:
            The value to assign to the service_type property of this CreateGuestOsFsuCollectionDetails.
            Allowed values for this property are: "EXACS", "EXACC"
        :type service_type: str

        :param compartment_id:
            The value to assign to the compartment_id property of this CreateGuestOsFsuCollectionDetails.
        :type compartment_id: str

        :param freeform_tags:
            The value to assign to the freeform_tags property of this CreateGuestOsFsuCollectionDetails.
        :type freeform_tags: dict(str, str)

        :param defined_tags:
            The value to assign to the defined_tags property of this CreateGuestOsFsuCollectionDetails.
        :type defined_tags: dict(str, dict(str, object))

        :param source_major_version:
            The value to assign to the source_major_version property of this CreateGuestOsFsuCollectionDetails.
        ...
        :param fleet_discovery:
            The value to assign to the fleet_discovery property of this CreateGuestOsFsuCollectionDetails.
    ...
    def source_major_version(self):
        """
        **[Required]** Gets the source_major_version of this CreateGuestOsFsuCollectionDetails.
        ...
        :return: The source_major_version of this CreateGuestOsFsuCollectionDetails.
        :rtype: str
        """
    ...
    def source_major_version(self, source_major_version):
        """
        Sets the source_major_version of this CreateGuestOsFsuCollectionDetails.
        Major version of Exadata Image (Guest OS) release for Exadata VM Cluster targets to be included in the Exadata Fleet Update Collection.
        Only Exadata VM Clusters whose 'systemVersion' is related to the major version will be added to the Exadata Fleet Update Collection.
        For more details, refer to `Oracle document 2075007.1`__
        ...
        :param source_major_version: The source_major_version of this CreateGuestOsFsuCollectionDetails.
        :type: str
        """
    ...
    def fleet_discovery(self):
        """
        Gets the fleet_discovery of this CreateGuestOsFsuCollectionDetails.

        :return: The fleet_discovery of this CreateGuestOsFsuCollectionDetails.
    ...
    def fleet_discovery(self, fleet_discovery):
        """
        Sets the fleet_discovery of this CreateGuestOsFsuCollectionDetails.

        :param fleet_discovery: The fleet_discovery of this CreateGuestOsFsuCollectionDetails.
