...
class GuestOsDiscoveryResults(GuestOsFleetDiscoveryDetails):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new GuestOsDiscoveryResults object with values from keyword arguments. The default value of the :py:attr:`~oci.fleet_software_update.models.GuestOsDiscoveryResults.strategy` attribute
        of this class is ``DISCOVERY_RESULTS`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param strategy:
            The value to assign to the strategy property of this GuestOsDiscoveryResults.
            Allowed values for this property are: "SEARCH_QUERY", "FILTERS", "TARGET_LIST", "DISCOVERY_RESULTS"
        :type strategy: str

        :param fsu_discovery_id:
            The value to assign to the fsu_discovery_id property of this GuestOsDiscoveryResults.
