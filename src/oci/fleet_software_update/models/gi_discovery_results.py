...
class GiDiscoveryResults(GiFleetDiscoveryDetails):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new GiDiscoveryResults object with values from keyword arguments. The default value of the :py:attr:`~oci.fleet_software_update.models.GiDiscoveryResults.strategy` attribute
        of this class is ``DISCOVERY_RESULTS`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param strategy:
            The value to assign to the strategy property of this GiDiscoveryResults.
            Allowed values for this property are: "SEARCH_QUERY", "FILTERS", "TARGET_LIST", "DISCOVERY_RESULTS"
        :type strategy: str

        :param fsu_discovery_id:
            The value to assign to the fsu_discovery_id property of this GiDiscoveryResults.
    ...
    def fsu_discovery_id(self):
        """
        **[Required]** Gets the fsu_discovery_id of this GiDiscoveryResults.
        OCIDs of Fleet Software Update Discovery.


        :return: The fsu_discovery_id of this GiDiscoveryResults.
        :rtype: str
        """
    ...
    def fsu_discovery_id(self, fsu_discovery_id):
        """
        Sets the fsu_discovery_id of this GiDiscoveryResults.
        OCIDs of Fleet Software Update Discovery.


        :param fsu_discovery_id: The fsu_discovery_id of this GiDiscoveryResults.
        :type: str
        """
