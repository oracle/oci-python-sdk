...
class UpdateApplyActionDetails(UpdateFsuActionDetails):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new UpdateApplyActionDetails object with values from keyword arguments. The default value of the :py:attr:`~oci.fleet_software_update.models.UpdateApplyActionDetails.type` attribute
        ...
        :param display_name:
            The value to assign to the display_name property of this UpdateApplyActionDetails.
        :type display_name: str

        :param freeform_tags:
            The value to assign to the freeform_tags property of this UpdateApplyActionDetails.
        :type freeform_tags: dict(str, str)

        :param defined_tags:
            The value to assign to the defined_tags property of this UpdateApplyActionDetails.
        :type defined_tags: dict(str, dict(str, object))

        :param schedule_details:
            The value to assign to the schedule_details property of this UpdateApplyActionDetails.
    ...
    def schedule_details(self):
        ...
        :return: The schedule_details of this UpdateApplyActionDetails.
    ...
    def schedule_details(self, schedule_details):
        """
        Sets the schedule_details of this UpdateApplyActionDetails.

        :param schedule_details: The schedule_details of this UpdateApplyActionDetails.
