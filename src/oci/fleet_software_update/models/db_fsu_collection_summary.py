...
class DbFsuCollectionSummary(FsuCollectionSummary):
    """
    'DB' type Exadata Fleet Update Collection summary.
    """

    #: A constant which can be used with the source_major_version property of a DbFsuCollectionSummary.
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new DbFsuCollectionSummary object with values from keyword arguments. The default value of the :py:attr:`~oci.fleet_software_update.models.DbFsuCollectionSummary.type` attribute
        of this class is ``DB`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param id:
            The value to assign to the id property of this DbFsuCollectionSummary.
        :type id: str

        :param display_name:
            The value to assign to the display_name property of this DbFsuCollectionSummary.
        :type display_name: str

        :param type:
            The value to assign to the type property of this DbFsuCollectionSummary.
        ...
        :param compartment_id:
            The value to assign to the compartment_id property of this DbFsuCollectionSummary.
        :type compartment_id: str

        :param active_fsu_cycle:
            The value to assign to the active_fsu_cycle property of this DbFsuCollectionSummary.
        :type active_fsu_cycle: oci.fleet_software_update.models.ActiveCycleDetails

        :param target_count:
            The value to assign to the target_count property of this DbFsuCollectionSummary.
        :type target_count: int

        :param time_created:
            The value to assign to the time_created property of this DbFsuCollectionSummary.
        :type time_created: datetime

        :param time_updated:
            The value to assign to the time_updated property of this DbFsuCollectionSummary.
        :type time_updated: datetime

        :param lifecycle_state:
            The value to assign to the lifecycle_state property of this DbFsuCollectionSummary.
        ...
        :param defined_tags:
            The value to assign to the defined_tags property of this DbFsuCollectionSummary.
        :type defined_tags: dict(str, dict(str, object))

        :param system_tags:
            The value to assign to the system_tags property of this DbFsuCollectionSummary.
        :type system_tags: dict(str, dict(str, object))

        :param source_major_version:
            The value to assign to the source_major_version property of this DbFsuCollectionSummary.
            Allowed values for this property are: "DB_11204", "DB_121", "DB_122", "DB_18", "DB_19", "DB_23", "DB_26", 'UNKNOWN_ENUM_VALUE'.
            Any unrecognized values returned by a service will be mapped to 'UNKNOWN_ENUM_VALUE'.
    ...
    def source_major_version(self):
        """
        **[Required]** Gets the source_major_version of this DbFsuCollectionSummary.
        ...
        :return: The source_major_version of this DbFsuCollectionSummary.
        :rtype: str
        """
    ...
    def source_major_version(self, source_major_version):
        """
        Sets the source_major_version of this DbFsuCollectionSummary.
        Database Major Version of targets to be included in the Exadata Fleet Update Collection.
        https://docs.oracle.com/en-us/iaas/api/#/en/database/20160918/DbVersionSummary/ListDbVersions
        Only Database targets that match the version specified in this value would be added to the Exadata Fleet Update Collection.


        :param source_major_version: The source_major_version of this DbFsuCollectionSummary.
        :type: str
        """
