...
class GuestOsCompartmentIdFilter(GuestOsFleetDiscoveryFilter):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new GuestOsCompartmentIdFilter object with values from keyword arguments. The default value of the :py:attr:`~oci.fleet_software_update.models.GuestOsCompartmentIdFilter.type` attribute
        of this class is ``COMPARTMENT_ID`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param type:
            The value to assign to the type property of this GuestOsCompartmentIdFilter.
            Allowed values for this property are: "COMPARTMENT_ID", "VERSION", "EXADATA_RELEASE_VERSION", "FREEFORM_TAG", "DEFINED_TAG", "RESOURCE_ID"
        :type type: str

        :param mode:
            The value to assign to the mode property of this GuestOsCompartmentIdFilter.
            Allowed values for this property are: "INCLUDE", "EXCLUDE"
        :type mode: str

        :param identifiers:
            The value to assign to the identifiers property of this GuestOsCompartmentIdFilter.
