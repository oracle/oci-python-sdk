...
class CreateStartTimeScheduleDetails(CreateScheduleDetails):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new CreateStartTimeScheduleDetails object with values from keyword arguments. The default value of the :py:attr:`~oci.fleet_software_update.models.CreateStartTimeScheduleDetails.type` attribute
        of this class is ``START_TIME`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param type:
            The value to assign to the type property of this CreateStartTimeScheduleDetails.
            Allowed values for this property are: "START_TIME"
        :type type: str

        :param time_to_start:
            The value to assign to the time_to_start property of this CreateStartTimeScheduleDetails.
    ...
    def time_to_start(self):
        """
        **[Required]** Gets the time_to_start of this CreateStartTimeScheduleDetails.
        ...
        :return: The time_to_start of this CreateStartTimeScheduleDetails.
        :rtype: datetime
        """
    ...
    def time_to_start(self, time_to_start):
        """
        Sets the time_to_start of this CreateStartTimeScheduleDetails.
        The date and time the Exadata Fleet Update Action is expected to start.
        `RFC 3339`__, section 14.29.
        ...
        :param time_to_start: The time_to_start of this CreateStartTimeScheduleDetails.
        :type: datetime
        """
