...
class GuestOsCollection(FsuCollection):
    """
    Details of a 'GUEST_OS' type Exadata Fleet Update Collection.
    """

    #: A constant which can be used with the source_major_version property of a GuestOsCollection.
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new GuestOsCollection object with values from keyword arguments. The default value of the :py:attr:`~oci.fleet_software_update.models.GuestOsCollection.type` attribute
        of this class is ``GUEST_OS`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param id:
            The value to assign to the id property of this GuestOsCollection.
        :type id: str

        :param display_name:
            The value to assign to the display_name property of this GuestOsCollection.
        :type display_name: str

        :param type:
            The value to assign to the type property of this GuestOsCollection.
        ...
        :param compartment_id:
            The value to assign to the compartment_id property of this GuestOsCollection.
        :type compartment_id: str

        :param active_fsu_cycle:
            The value to assign to the active_fsu_cycle property of this GuestOsCollection.
        :type active_fsu_cycle: oci.fleet_software_update.models.ActiveCycleDetails

        :param target_count:
            The value to assign to the target_count property of this GuestOsCollection.
        :type target_count: int

        :param time_created:
            The value to assign to the time_created property of this GuestOsCollection.
        :type time_created: datetime

        :param time_updated:
            The value to assign to the time_updated property of this GuestOsCollection.
        :type time_updated: datetime

        :param lifecycle_state:
            The value to assign to the lifecycle_state property of this GuestOsCollection.
        ...
        :param lifecycle_details:
            The value to assign to the lifecycle_details property of this GuestOsCollection.
        :type lifecycle_details: str

        :param last_completed_fsu_cycle_id:
            The value to assign to the last_completed_fsu_cycle_id property of this GuestOsCollection.
        :type last_completed_fsu_cycle_id: str

        :param freeform_tags:
            The value to assign to the freeform_tags property of this GuestOsCollection.
        :type freeform_tags: dict(str, str)

        :param defined_tags:
            The value to assign to the defined_tags property of this GuestOsCollection.
        :type defined_tags: dict(str, dict(str, object))

        :param system_tags:
            The value to assign to the system_tags property of this GuestOsCollection.
        :type system_tags: dict(str, dict(str, object))

        :param source_major_version:
            The value to assign to the source_major_version property of this GuestOsCollection.
        ...
        :param fleet_discovery:
            The value to assign to the fleet_discovery property of this GuestOsCollection.
    ...
    def source_major_version(self):
        """
        **[Required]** Gets the source_major_version of this GuestOsCollection.
        ...
        :return: The source_major_version of this GuestOsCollection.
        :rtype: str
        """
    ...
    def source_major_version(self, source_major_version):
        """
        Sets the source_major_version of this GuestOsCollection.
        Major version of Exadata Image (Guest OS) release for Exadata VM Cluster targets to be included in the Exadata Fleet Update Collection.
        Only Exadata VM Clusters whose 'systemVersion' is related to the major version will be added to the Exadata Fleet Update Collection.
        For more details, refer to `Oracle document 2075007.1`__
        ...
        :param source_major_version: The source_major_version of this GuestOsCollection.
        :type: str
        """
    ...
    def fleet_discovery(self):
        """
        **[Required]** Gets the fleet_discovery of this GuestOsCollection.

        :return: The fleet_discovery of this GuestOsCollection.
    ...
    def fleet_discovery(self, fleet_discovery):
        """
        Sets the fleet_discovery of this GuestOsCollection.

        :param fleet_discovery: The fleet_discovery of this GuestOsCollection.
