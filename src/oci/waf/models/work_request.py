...
class WorkRequest(object):
    ...
    #: This constant has a value of "CREATE_WAF_POLICY"
    OPERATION_TYPE_CREATE_WAF_POLICY = "CREATE_WAF_POLICY"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "UPDATE_WAF_POLICY"
    OPERATION_TYPE_UPDATE_WAF_POLICY = "UPDATE_WAF_POLICY"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "DELETE_WAF_POLICY"
    OPERATION_TYPE_DELETE_WAF_POLICY = "DELETE_WAF_POLICY"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "MOVE_WAF_POLICY"
    OPERATION_TYPE_MOVE_WAF_POLICY = "MOVE_WAF_POLICY"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "CREATE_NETWORK_ADDRESS_LIST"
    OPERATION_TYPE_CREATE_NETWORK_ADDRESS_LIST = "CREATE_NETWORK_ADDRESS_LIST"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "UPDATE_NETWORK_ADDRESS_LIST"
    OPERATION_TYPE_UPDATE_NETWORK_ADDRESS_LIST = "UPDATE_NETWORK_ADDRESS_LIST"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "DELETE_NETWORK_ADDRESS_LIST"
    OPERATION_TYPE_DELETE_NETWORK_ADDRESS_LIST = "DELETE_NETWORK_ADDRESS_LIST"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "MOVE_NETWORK_ADDRESS_LIST"
    OPERATION_TYPE_MOVE_NETWORK_ADDRESS_LIST = "MOVE_NETWORK_ADDRESS_LIST"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "CREATE_WEB_APP_FIREWALL"
    OPERATION_TYPE_CREATE_WEB_APP_FIREWALL = "CREATE_WEB_APP_FIREWALL"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "UPDATE_WEB_APP_FIREWALL"
    OPERATION_TYPE_UPDATE_WEB_APP_FIREWALL = "UPDATE_WEB_APP_FIREWALL"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "DELETE_WEB_APP_FIREWALL"
    OPERATION_TYPE_DELETE_WEB_APP_FIREWALL = "DELETE_WEB_APP_FIREWALL"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "MOVE_WEB_APP_FIREWALL"
    OPERATION_TYPE_MOVE_WEB_APP_FIREWALL = "MOVE_WEB_APP_FIREWALL"
    ...
    def __init__(self, **kwargs):
        ...
        :param operation_type:
            ...
            Allowed values for this property are: "CREATE_WAF_POLICY", "UPDATE_WAF_POLICY", "DELETE_WAF_POLICY", "MOVE_WAF_POLICY", "CREATE_NETWORK_ADDRESS_LIST", "UPDATE_NETWORK_ADDRESS_LIST", "DELETE_NETWORK_ADDRESS_LIST", "MOVE_NETWORK_ADDRESS_LIST", "CREATE_WEB_APP_FIREWALL", "UPDATE_WEB_APP_FIREWALL", "DELETE_WEB_APP_FIREWALL", "MOVE_WEB_APP_FIREWALL", 'UNKNOWN_ENUM_VALUE'.
        ...
        :type resources: list[oci.waf.models.WorkRequestResource]
    ...
    def operation_type(self, operation_type):
        ...
        :type: str
        """
        allowed_values = ["CREATE_WAF_POLICY", "UPDATE_WAF_POLICY", "DELETE_WAF_POLICY", "MOVE_WAF_POLICY", "CREATE_NETWORK_ADDRESS_LIST", "UPDATE_NETWORK_ADDRESS_LIST", "DELETE_NETWORK_ADDRESS_LIST", "MOVE_NETWORK_ADDRESS_LIST", "CREATE_WEB_APP_FIREWALL", "UPDATE_WEB_APP_FIREWALL", "DELETE_WEB_APP_FIREWALL", "MOVE_WEB_APP_FIREWALL"]
    ...
    def resources(self):
        ...
        **[Required]** Gets the resources of this WorkRequest.
        ...
        :rtype: list[oci.waf.models.WorkRequestResource]
        """
    ...
    def resources(self, resources):
        ...
        :type: list[oci.waf.models.WorkRequestResource]
        """
