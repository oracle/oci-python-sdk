...
class TaskSchedule(object):
    ...
    def execution_recurrences(self):
        ...
        **[Required]** Gets the execution_recurrences of this TaskSchedule.
        Recurrence specification for the task schedule execution (formatted according to `RFC-5545`__). To run daily for 10 occurrences starts on September 2, 2024 09:00 UTC, it should be 'DTSTART=20240902T090000Z;
