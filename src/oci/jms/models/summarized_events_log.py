...
class SummarizedEventsLog(object):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new SummarizedEventsLog object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param log_group_id:
            The value to assign to the log_group_id property of this SummarizedEventsLog.
        :type log_group_id: str

        :param log_id:
            The value to assign to the log_id property of this SummarizedEventsLog.
        :type log_id: str
