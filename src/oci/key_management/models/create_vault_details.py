...
class CreateVaultDetails(object):
    ...
    def __init__(self, **kwargs):
        ...
        self._redacted_field_paths = [
            ['external_key_manager_metadata', 'oauth_metadata', 'client_app_secret'],
        ]
    ...
    def __repr__(self):
        ...
        redact_password_field(as_dict, ['external_key_manager_metadata', 'oauth_metadata', 'client_app_secret'])
