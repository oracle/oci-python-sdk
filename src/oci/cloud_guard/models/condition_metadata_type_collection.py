...
class ConditionMetadataTypeCollection(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ConditionMetadataTypeCollection object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param items:
            The value to assign to the items property of this ConditionMetadataTypeCollection.
        :type items: list[ConditionMetadataTypeSummary]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this ConditionMetadataTypeCollection.
        ...
        :rtype: list[ConditionMetadataTypeSummary]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[ConditionMetadataTypeSummary]
        """
        self._items = items
