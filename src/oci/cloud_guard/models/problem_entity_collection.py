...
class ProblemEntityCollection(object):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ProblemEntityCollection object with values from keyword arguments.
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this ProblemEntityCollection.
        ...
        :rtype: list[oci.cloud_guard.models.ProblemEntitySummary]
        """
        return self._items
