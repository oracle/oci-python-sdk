...
class SightingImpactedResourceCollection(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new SightingImpactedResourceCollection object with values from keyword arguments.
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this SightingImpactedResourceCollection.
        ...
        :rtype: list[oci.cloud_guard.models.SightingImpactedResourceSummary]
        """
        return self._items
