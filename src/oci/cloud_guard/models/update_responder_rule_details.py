...
class UpdateResponderRuleDetails(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new UpdateResponderRuleDetails object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param is_enabled:
            The value to assign to the is_enabled property of this UpdateResponderRuleDetails.
