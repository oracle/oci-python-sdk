...
class TargetResponderRecipeResponderRuleCollection(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new TargetResponderRecipeResponderRuleCollection object with values from keyword arguments.
        ...
        """
        self.swagger_types = {
            'items': 'list[TargetResponderRecipeResponderRuleSummary]'
        }
