...
class DetectorRule(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new DetectorRule object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param id:
            The value to assign to the id property of this DetectorRule.
        :type id: str

        :param display_name:
            The value to assign to the display_name property of this DetectorRule.
        :type display_name: str

        :param description:
            The value to assign to the description property of this DetectorRule.
        :type description: str

        :param recommendation:
            The value to assign to the recommendation property of this DetectorRule.
        ...
        :param service_type:
            The value to assign to the service_type property of this DetectorRule.
        :type service_type: str

        :param resource_type:
            The value to assign to the resource_type property of this DetectorRule.
        ...
        :param lifecycle_state:
            The value to assign to the lifecycle_state property of this DetectorRule.
    ...
    def detector(self):
        ...
        **[Required]** Gets the detector of this DetectorRule.
        ...
        :return: The detector of this DetectorRule.
        :rtype: str
        """
    ...
    def managed_list_types(self):
        ...
        :return: The managed_list_types of this DetectorRule.
        :rtype: list[str]
        """
    ...
    def time_created(self):
        """
        Gets the time_created of this DetectorRule.
        The date and time the detector rule was created. Format defined by RFC3339.


        :return: The time_created of this DetectorRule.
        :rtype: datetime
        """
    ...
    def time_created(self, time_created):
        """
        Sets the time_created of this DetectorRule.
        The date and time the detector rule was created. Format defined by RFC3339.


        :param time_created: The time_created of this DetectorRule.
        :type: datetime
        """
    ...
    def time_updated(self):
        """
        Gets the time_updated of this DetectorRule.
        The date and time the detector rule was updated. Format defined by RFC3339.


        :return: The time_updated of this DetectorRule.
        :rtype: datetime
        """
    ...
    def time_updated(self, time_updated):
        """
        Sets the time_updated of this DetectorRule.
        The date and time the detector rule was updated. Format defined by RFC3339.


        :param time_updated: The time_updated of this DetectorRule.
        :type: datetime
        """
    ...
    def lifecycle_state(self):
        ...
        :return: The lifecycle_state of this DetectorRule.
        :rtype: str
        """
    ...
    def lifecycle_details(self):
        """
        Gets the lifecycle_details of this DetectorRule.
        A message describing the current state in more detail. For example, can be used to provide actionable information for a resource in Failed state.


        :return: The lifecycle_details of this DetectorRule.
        :rtype: str
        """
    ...
    def lifecycle_details(self, lifecycle_details):
        """
        Sets the lifecycle_details of this DetectorRule.
        A message describing the current state in more detail. For example, can be used to provide actionable information for a resource in Failed state.


        :param lifecycle_details: The lifecycle_details of this DetectorRule.
        :type: str
        """
