...
class UpdateResponderRecipeResponderRuleDetails(object):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new UpdateResponderRecipeResponderRuleDetails object with values from keyword arguments.
