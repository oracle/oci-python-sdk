...
class ResourceProfileEndpointCollection(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ResourceProfileEndpointCollection object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param items:
            The value to assign to the items property of this ResourceProfileEndpointCollection.
        :type items: list[oci.cloud_guard.models.ResourceProfileEndpointSummary]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this ResourceProfileEndpointCollection.
        ...
        :rtype: list[oci.cloud_guard.models.ResourceProfileEndpointSummary]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.cloud_guard.models.ResourceProfileEndpointSummary]
        """
        self._items = items
