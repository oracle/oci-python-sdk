...
class RiskScoreAggregationCollection(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new RiskScoreAggregationCollection object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param items:
            The value to assign to the items property of this RiskScoreAggregationCollection.
        :type items: list[oci.cloud_guard.models.RiskScoreAggregation]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this RiskScoreAggregationCollection.
        ...
        :rtype: list[oci.cloud_guard.models.RiskScoreAggregation]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.cloud_guard.models.RiskScoreAggregation]
        """
        self._items = items
