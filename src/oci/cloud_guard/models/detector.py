...
class Detector(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new Detector object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param id:
            The value to assign to the id property of this Detector.
        :type id: str

        :param description:
            The value to assign to the description property of this Detector.
        :type description: str

        :param lifecycle_state:
            The value to assign to the lifecycle_state property of this Detector.
    ...
    def lifecycle_state(self):
        ...
        :return: The lifecycle_state of this Detector.
        :rtype: str
        """
