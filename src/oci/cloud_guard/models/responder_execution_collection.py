...
class ResponderExecutionCollection(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ResponderExecutionCollection object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param items:
            The value to assign to the items property of this ResponderExecutionCollection.
        :type items: list[ResponderExecutionSummary]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this ResponderExecutionCollection.
        ...
        :rtype: list[ResponderExecutionSummary]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[ResponderExecutionSummary]
        """
        self._items = items
