...
class DetectorRecipeDetectorRuleSummary(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new DetectorRecipeDetectorRuleSummary object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param id:
            The value to assign to the id property of this DetectorRecipeDetectorRuleSummary.
        :type id: str

        :param display_name:
            The value to assign to the display_name property of this DetectorRecipeDetectorRuleSummary.
        :type display_name: str

        :param description:
            The value to assign to the description property of this DetectorRecipeDetectorRuleSummary.
        :type description: str

        :param recommendation:
            The value to assign to the recommendation property of this DetectorRecipeDetectorRuleSummary.
        ...
        :param service_type:
            The value to assign to the service_type property of this DetectorRecipeDetectorRuleSummary.
        :type service_type: str

        :param resource_type:
            The value to assign to the resource_type property of this DetectorRecipeDetectorRuleSummary.
        ...
        :param time_updated:
            The value to assign to the time_updated property of this DetectorRecipeDetectorRuleSummary.
        :type time_updated: datetime

        :param lifecycle_state:
            The value to assign to the lifecycle_state property of this DetectorRecipeDetectorRuleSummary.
    ...
    def id(self):
        """
        **[Required]** Gets the id of this DetectorRecipeDetectorRuleSummary.
        The unique identifier of the detector rule


        :return: The id of this DetectorRecipeDetectorRuleSummary.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        """
        Sets the id of this DetectorRecipeDetectorRuleSummary.
        The unique identifier of the detector rule


        :param id: The id of this DetectorRecipeDetectorRuleSummary.
        :type: str
        """
        self._id = id
    ...
    def detector(self):
        ...
        **[Required]** Gets the detector of this DetectorRecipeDetectorRuleSummary.
        ...
        :return: The detector of this DetectorRecipeDetectorRuleSummary.
        :rtype: str
        """
    ...
    def managed_list_types(self):
        ...
        :return: The managed_list_types of this DetectorRecipeDetectorRuleSummary.
        :rtype: list[str]
        """
    ...
    def time_created(self):
        """
        Gets the time_created of this DetectorRecipeDetectorRuleSummary.
        The date and time the detector recipe rule was created. Format defined by RFC3339.


        :return: The time_created of this DetectorRecipeDetectorRuleSummary.
        :rtype: datetime
        """
    ...
    def time_created(self, time_created):
        """
        Sets the time_created of this DetectorRecipeDetectorRuleSummary.
        The date and time the detector recipe rule was created. Format defined by RFC3339.


        :param time_created: The time_created of this DetectorRecipeDetectorRuleSummary.
        :type: datetime
        """
    ...
    def lifecycle_state(self):
        ...
        :return: The lifecycle_state of this DetectorRecipeDetectorRuleSummary.
        :rtype: str
        """
    ...
    def lifecycle_details(self):
        """
        Gets the lifecycle_details of this DetectorRecipeDetectorRuleSummary.
        A message describing the current state in more detail. For example, can be used to provide actionable information for a resource in Failed state.


        :return: The lifecycle_details of this DetectorRecipeDetectorRuleSummary.
        :rtype: str
        """
    ...
    def lifecycle_details(self, lifecycle_details):
        """
        Sets the lifecycle_details of this DetectorRecipeDetectorRuleSummary.
        A message describing the current state in more detail. For example, can be used to provide actionable information for a resource in Failed state.


        :param lifecycle_details: The lifecycle_details of this DetectorRecipeDetectorRuleSummary.
        :type: str
        """
