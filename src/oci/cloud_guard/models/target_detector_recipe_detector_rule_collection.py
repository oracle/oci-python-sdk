...
class TargetDetectorRecipeDetectorRuleCollection(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new TargetDetectorRecipeDetectorRuleCollection object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param items:
            The value to assign to the items property of this TargetDetectorRecipeDetectorRuleCollection.
        :type items: list[TargetDetectorRecipeDetectorRuleSummary]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this TargetDetectorRecipeDetectorRuleCollection.
        ...
        :rtype: list[TargetDetectorRecipeDetectorRuleSummary]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[TargetDetectorRecipeDetectorRuleSummary]
        """
        self._items = items
