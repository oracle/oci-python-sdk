...
class ShapeMemoryOptions(object):
    ...
    def min_in_gbs(self):
        """
        Gets the min_in_gbs of this ShapeMemoryOptions.
    ...
    def max_in_gbs(self):
        """
        Gets the max_in_gbs of this ShapeMemoryOptions.
    ...
    def default_per_ocpu_in_gbs(self):
        """
        Gets the default_per_ocpu_in_gbs of this ShapeMemoryOptions.
