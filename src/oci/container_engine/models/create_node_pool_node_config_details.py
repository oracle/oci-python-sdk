...
class CreateNodePoolNodeConfigDetails(object):
    ...
    def __init__(self, **kwargs):
        ...
        :param node_pool_pod_network_option_details:
            The value to assign to the node_pool_pod_network_option_details property of this CreateNodePoolNodeConfigDetails.
    ...
    def node_pool_pod_network_option_details(self):
        """
        Gets the node_pool_pod_network_option_details of this CreateNodePoolNodeConfigDetails.
        The CNI related configuration of pods in the node pool.


        :return: The node_pool_pod_network_option_details of this CreateNodePoolNodeConfigDetails.
    ...
    def node_pool_pod_network_option_details(self, node_pool_pod_network_option_details):
        """
        Sets the node_pool_pod_network_option_details of this CreateNodePoolNodeConfigDetails.
        The CNI related configuration of pods in the node pool.


        :param node_pool_pod_network_option_details: The node_pool_pod_network_option_details of this CreateNodePoolNodeConfigDetails.
