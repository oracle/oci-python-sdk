...
class WorkRequest(object):
    ...
    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "VIRTUALNODEPOOL_CYCLING"
    OPERATION_TYPE_VIRTUALNODEPOOL_CYCLING = "VIRTUALNODEPOOL_CYCLING"
    ...
    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "START_PUBLIC_API_ENDPOINT_DECOMMISSION"
    OPERATION_TYPE_START_PUBLIC_API_ENDPOINT_DECOMMISSION = "START_PUBLIC_API_ENDPOINT_DECOMMISSION"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "ROLLBACK_PUBLIC_API_ENDPOINT_DECOMMISSION"
    OPERATION_TYPE_ROLLBACK_PUBLIC_API_ENDPOINT_DECOMMISSION = "ROLLBACK_PUBLIC_API_ENDPOINT_DECOMMISSION"
