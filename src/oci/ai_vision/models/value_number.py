...
class ValueNumber(FieldValue):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ValueNumber object with values from keyword arguments. The default value of the :py:attr:`~oci.ai_vision.models.ValueNumber.value_type` attribute
