...
class ObjectStorageDocumentDetails(DocumentDetails):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ObjectStorageDocumentDetails object with values from keyword arguments. The default value of the :py:attr:`~oci.ai_vision.models.ObjectStorageDocumentDetails.source` attribute
