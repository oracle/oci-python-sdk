...
class SteeringPolicyPriorityRule(SteeringPolicyRule):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new SteeringPolicyPriorityRule object with values from keyword arguments. The default value of the :py:attr:`~oci.dns.models.SteeringPolicyPriorityRule.rule_type` attribute
        of this class is ``PRIORITY`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param description:
            The value to assign to the description property of this SteeringPolicyPriorityRule.
        :type description: str

        :param rule_type:
            The value to assign to the rule_type property of this SteeringPolicyPriorityRule.
            Allowed values for this property are: "FILTER", "HEALTH", "WEIGHTED", "PRIORITY", "LIMIT"
        :type rule_type: str

        :param cases:
            The value to assign to the cases property of this SteeringPolicyPriorityRule.
        :type cases: list[oci.dns.models.SteeringPolicyPriorityRuleCase]

        :param default_answer_data:
            The value to assign to the default_answer_data property of this SteeringPolicyPriorityRule.
        :type default_answer_data: list[oci.dns.models.SteeringPolicyPriorityAnswerData]

        """
        self.swagger_types = {
            'description': 'str',
            'rule_type': 'str',
            'cases': 'list[SteeringPolicyPriorityRuleCase]',
            'default_answer_data': 'list[SteeringPolicyPriorityAnswerData]'
        }
        ...
        self._rule_type = 'PRIORITY'

    @property
    def cases(self):
        """
        Gets the cases of this SteeringPolicyPriorityRule.
        ...
        :return: The cases of this SteeringPolicyPriorityRule.
        :rtype: list[oci.dns.models.SteeringPolicyPriorityRuleCase]
        """
        return self._cases
    ...
    def cases(self, cases):
        """
        Sets the cases of this SteeringPolicyPriorityRule.
        An array of `caseConditions`. A rule may optionally include a sequence of cases defining alternate
        configurations for how it should behave during processing for any given DNS query. When a rule has
        no sequence of `cases`, it is always evaluated with the same configuration during processing. When
        a rule has an empty sequence of `cases`, it is always ignored during processing. When a rule has a
        ...
        :param cases: The cases of this SteeringPolicyPriorityRule.
        :type: list[oci.dns.models.SteeringPolicyPriorityRuleCase]
        """
        self._cases = cases
    ...
    def default_answer_data(self):
        """
        Gets the default_answer_data of this SteeringPolicyPriorityRule.
        ...
        :return: The default_answer_data of this SteeringPolicyPriorityRule.
    ...
    def default_answer_data(self, default_answer_data):
        """
        Sets the default_answer_data of this SteeringPolicyPriorityRule.
        Defines a default set of answer conditions and values that are applied to an answer when
        `cases` is not defined for the rule or a matching case does not have any matching
        `answerCondition`s in its `answerData`. `defaultAnswerData` is not applied if `cases` is
        defined and there are no matching cases. In this scenario, the next rule will be processed.
        ...
        :param default_answer_data: The default_answer_data of this SteeringPolicyPriorityRule.
