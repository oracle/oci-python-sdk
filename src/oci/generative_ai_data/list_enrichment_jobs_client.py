...
class ListEnrichmentJobsClient(object):
    """
    ...
    def __init__(self, config, **kwargs):
        ...
        self.base_client = BaseClient("list_enrichment_jobs", config, signer, generative_ai_data_type_mapping, **base_client_init_kwargs)
        self.retry_strategy = kwargs.get('retry_strategy')
        self.circuit_breaker_callback = kwargs.get('circuit_breaker_callback')

    def list_enrichment_jobs(self, semantic_store_id, compartment_id, **kwargs):
        """
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.generative_ai_data.models.EnrichmentJobCollection`
        :rtype: :class:`~oci.response.Response`

        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/generativeaidata/list_enrichment_jobs.py.html>`__ to see an example of how to use list_enrichment_jobs API.
        """
        ...
        if extra_kwargs:
            raise ValueError(
                f"list_enrichment_jobs got unknown kwargs: {extra_kwargs!r}")
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                response_type="EnrichmentJobCollection",
