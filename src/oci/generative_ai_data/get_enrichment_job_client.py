...
from .models import generative_ai_data_type_mapping
missing = Sentinel("Missing")


class GetEnrichmentJobClient(object):
    """
    ...
    def __init__(self, config, **kwargs):
        ...
        """
        if not OCI_SDK_ENABLED_SERVICES_SET.is_service_enabled("generative_ai_data"):
        ...
        self.base_client = BaseClient("get_enrichment_job", config, signer, generative_ai_data_type_mapping, **base_client_init_kwargs)
        self.retry_strategy = kwargs.get('retry_strategy')
        self.circuit_breaker_callback = kwargs.get('circuit_breaker_callback')

    def get_enrichment_job(self, semantic_store_id, enrichment_job_id, **kwargs):
        """
        ...
        :param str enrichment_job_id: (required)
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/generativeaidata/get_enrichment_job.py.html>`__ to see an example of how to use get_enrichment_job API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['semanticStoreId', 'enrichmentJobId']
        resource_path = "/semanticStores/{semanticStoreId}/enrichmentJobs/{enrichmentJobId}"
        method = "GET"
        operation_name = "get_enrichment_job"
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/generative-ai-nl2sql/20260325/EnrichmentJob/GetEnrichmentJob"
        ...
        if extra_kwargs:
            raise ValueError(
                f"get_enrichment_job got unknown kwargs: {extra_kwargs!r}")
