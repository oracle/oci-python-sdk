...
class GenerateSqlFromNlJobClient(object):
    """
    ...
    def __init__(self, config, **kwargs):
        ...
        self.base_client = BaseClient("generate_sql_from_nl_job", config, signer, generative_ai_data_type_mapping, **base_client_init_kwargs)
