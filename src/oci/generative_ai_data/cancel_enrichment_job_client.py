...
class CancelEnrichmentJobClient(object):
    """
    ...
    def __init__(self, config, **kwargs):
        ...
        self.base_client = BaseClient("cancel_enrichment_job", config, signer, generative_ai_data_type_mapping, **base_client_init_kwargs)
        self.retry_strategy = kwargs.get('retry_strategy')
        self.circuit_breaker_callback = kwargs.get('circuit_breaker_callback')

    def cancel_enrichment_job(self, semantic_store_id, enrichment_job_id, **kwargs):
        """
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/generativeaidata/cancel_enrichment_job.py.html>`__ to see an example of how to use cancel_enrichment_job API.
        """
        ...
        if extra_kwargs:
            raise ValueError(
                f"cancel_enrichment_job got unknown kwargs: {extra_kwargs!r}")
