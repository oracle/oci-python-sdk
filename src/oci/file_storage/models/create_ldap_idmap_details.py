...
class CreateLdapIdmapDetails(object):
    """
    Mount target details about the LDAP ID mapping configuration.
    """

    #: A constant which can be used with the schema_type property of a CreateLdapIdmapDetails.
    #: This constant has a value of "RFC2307"
    SCHEMA_TYPE_RFC2307 = "RFC2307"

    def __init__(self, **kwargs):
        """
        Initializes a new CreateLdapIdmapDetails object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param schema_type:
            The value to assign to the schema_type property of this CreateLdapIdmapDetails.
            Allowed values for this property are: "RFC2307"
        :type schema_type: str

        :param cache_refresh_interval_seconds:
            The value to assign to the cache_refresh_interval_seconds property of this CreateLdapIdmapDetails.
        :type cache_refresh_interval_seconds: int

        :param cache_lifetime_seconds:
            The value to assign to the cache_lifetime_seconds property of this CreateLdapIdmapDetails.
        :type cache_lifetime_seconds: int

        :param negative_cache_lifetime_seconds:
            The value to assign to the negative_cache_lifetime_seconds property of this CreateLdapIdmapDetails.
        :type negative_cache_lifetime_seconds: int

        :param user_search_base:
            The value to assign to the user_search_base property of this CreateLdapIdmapDetails.
        :type user_search_base: str

        :param group_search_base:
            The value to assign to the group_search_base property of this CreateLdapIdmapDetails.
        :type group_search_base: str

        :param outbound_connector1_id:
            The value to assign to the outbound_connector1_id property of this CreateLdapIdmapDetails.
        :type outbound_connector1_id: str

        :param outbound_connector2_id:
            The value to assign to the outbound_connector2_id property of this CreateLdapIdmapDetails.
    ...
    def schema_type(self):
        """
        Gets the schema_type of this CreateLdapIdmapDetails.
        Schema type of the LDAP account.

        Allowed values for this property are: "RFC2307"


        :return: The schema_type of this CreateLdapIdmapDetails.
        :rtype: str
        """
    ...
    def schema_type(self, schema_type):
        """
        Sets the schema_type of this CreateLdapIdmapDetails.
        Schema type of the LDAP account.


        :param schema_type: The schema_type of this CreateLdapIdmapDetails.
        :type: str
        """
    ...
    def cache_refresh_interval_seconds(self):
        """
        Gets the cache_refresh_interval_seconds of this CreateLdapIdmapDetails.
        ...
        :return: The cache_refresh_interval_seconds of this CreateLdapIdmapDetails.
        :rtype: int
        """
    ...
    def cache_refresh_interval_seconds(self, cache_refresh_interval_seconds):
        """
        Sets the cache_refresh_interval_seconds of this CreateLdapIdmapDetails.
        The amount of time that the mount target should allow an entry to persist in its cache before attempting to refresh the entry.


        :param cache_refresh_interval_seconds: The cache_refresh_interval_seconds of this CreateLdapIdmapDetails.
        :type: int
        """
    ...
    def cache_lifetime_seconds(self):
        """
        Gets the cache_lifetime_seconds of this CreateLdapIdmapDetails.
        The maximum amount of time the mount target is allowed to use a cached entry.


        :return: The cache_lifetime_seconds of this CreateLdapIdmapDetails.
        :rtype: int
        """
    ...
    def cache_lifetime_seconds(self, cache_lifetime_seconds):
        """
        Sets the cache_lifetime_seconds of this CreateLdapIdmapDetails.
        The maximum amount of time the mount target is allowed to use a cached entry.


        :param cache_lifetime_seconds: The cache_lifetime_seconds of this CreateLdapIdmapDetails.
        :type: int
        """
    ...
    def negative_cache_lifetime_seconds(self):
        """
        Gets the negative_cache_lifetime_seconds of this CreateLdapIdmapDetails.
        ...
        :return: The negative_cache_lifetime_seconds of this CreateLdapIdmapDetails.
        :rtype: int
        """
    ...
    def negative_cache_lifetime_seconds(self, negative_cache_lifetime_seconds):
        """
        Sets the negative_cache_lifetime_seconds of this CreateLdapIdmapDetails.
        The amount of time that a mount target will maintain information that a user is not found in the ID mapping configuration.


        :param negative_cache_lifetime_seconds: The negative_cache_lifetime_seconds of this CreateLdapIdmapDetails.
        :type: int
        """
    ...
    def user_search_base(self):
        """
        Gets the user_search_base of this CreateLdapIdmapDetails.
        All LDAP searches are recursive starting at this user.

        Example: `CN=User,DC=domain,DC=com`


        :return: The user_search_base of this CreateLdapIdmapDetails.
        :rtype: str
        """
    ...
    def user_search_base(self, user_search_base):
        """
        Sets the user_search_base of this CreateLdapIdmapDetails.
        All LDAP searches are recursive starting at this user.

        Example: `CN=User,DC=domain,DC=com`


        :param user_search_base: The user_search_base of this CreateLdapIdmapDetails.
        :type: str
        """
    ...
    def group_search_base(self):
        """
        Gets the group_search_base of this CreateLdapIdmapDetails.
        All LDAP searches are recursive starting at this group.

        Example: `CN=Group,DC=domain,DC=com`


        :return: The group_search_base of this CreateLdapIdmapDetails.
        :rtype: str
        """
    ...
    def group_search_base(self, group_search_base):
        """
        Sets the group_search_base of this CreateLdapIdmapDetails.
        All LDAP searches are recursive starting at this group.

        Example: `CN=Group,DC=domain,DC=com`


        :param group_search_base: The group_search_base of this CreateLdapIdmapDetails.
        :type: str
        """
