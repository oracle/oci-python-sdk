...
class ManagementDashboardCollection(object):
    """
    List of dashboards.
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ManagementDashboardCollection object with values from keyword arguments.
        ...
        """
        self.swagger_types = {
            'items': 'list[ManagementDashboardSummary]'
        }
    ...
    def items(self, items):
        """
        Sets the items of this ManagementDashboardCollection.
        Array of dashboard summaries.
