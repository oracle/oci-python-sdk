...
from .models import limits_increase_type_mapping
missing = Sentinel("Missing")


class LimitsIncreaseClient(object):
    """
    ...
    def __init__(self, config, **kwargs):
        ...
        """
        if not OCI_SDK_ENABLED_SERVICES_SET.is_service_enabled("limits_increase"):
        ...
        self.base_client = BaseClient("limits_increase", config, signer, limits_increase_type_mapping, **base_client_init_kwargs)
        self.retry_strategy = kwargs.get('retry_strategy')
        self.circuit_breaker_callback = kwargs.get('circuit_breaker_callback')

    def cancel_limits_increase_item_request(self, limits_increase_item_request_id, **kwargs):
        """
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.limits_increase.models.LimitsIncreaseItemRequest`
        :rtype: :class:`~oci.response.Response`

        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/limitsincrease/cancel_limits_increase_item_request.py.html>`__ to see an example of how to use cancel_limits_increase_item_request API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['limitsIncreaseItemRequestId']
        ...
        if extra_kwargs:
            raise ValueError(
                f"cancel_limits_increase_item_request got unknown kwargs: {extra_kwargs!r}")

        path_params = {
            "limitsIncreaseItemRequestId": limits_increase_item_request_id
        }
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                response_type="LimitsIncreaseItemRequest",
    ...
    def cancel_limits_increase_request(self, limits_increase_request_id, **kwargs):
        """
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.limits_increase.models.LimitsIncreaseRequest`
        :rtype: :class:`~oci.response.Response`

        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/limitsincrease/cancel_limits_increase_request.py.html>`__ to see an example of how to use cancel_limits_increase_request API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['limitsIncreaseRequestId']
        ...
        if extra_kwargs:
            raise ValueError(
                f"cancel_limits_increase_request got unknown kwargs: {extra_kwargs!r}")

        path_params = {
            "limitsIncreaseRequestId": limits_increase_request_id
        }
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                path_params=path_params,
                header_params=header_params,
                response_type="LimitsIncreaseRequest",
                allow_control_chars=kwargs.get('allow_control_chars'),
                enable_strict_url_encoding=kwargs.get('enable_strict_url_encoding'),
                operation_name=operation_name,
                api_reference_link=api_reference_link,
    ...
    def create_limits_increase_request(self, create_limits_increase_request_details, **kwargs):
        """
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/limitsincrease/create_limits_increase_request.py.html>`__ to see an example of how to use create_limits_increase_request API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        ...
        if extra_kwargs:
            raise ValueError(
                f"create_limits_increase_request got unknown kwargs: {extra_kwargs!r}")
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                method=method,
                header_params=header_params,
                body=create_limits_increase_request_details,
                response_type="LimitsIncreaseRequest",
                allow_control_chars=kwargs.get('allow_control_chars'),
                enable_strict_url_encoding=kwargs.get('enable_strict_url_encoding'),
                operation_name=operation_name,
    ...
    def delete_limits_increase_request(self, limits_increase_request_id, **kwargs):
        """
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/limitsincrease/delete_limits_increase_request.py.html>`__ to see an example of how to use delete_limits_increase_request API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['limitsIncreaseRequestId']
        ...
        if extra_kwargs:
            raise ValueError(
                f"delete_limits_increase_request got unknown kwargs: {extra_kwargs!r}")
    ...
    def get_limits_increase_item_request(self, limits_increase_item_request_id, **kwargs):
        """
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/limitsincrease/get_limits_increase_item_request.py.html>`__ to see an example of how to use get_limits_increase_item_request API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['limitsIncreaseItemRequestId']
        ...
        if extra_kwargs:
            raise ValueError(
                f"get_limits_increase_item_request got unknown kwargs: {extra_kwargs!r}")
    ...
    def get_limits_increase_request(self, limits_increase_request_id, **kwargs):
        """
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/limitsincrease/get_limits_increase_request.py.html>`__ to see an example of how to use get_limits_increase_request API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['limitsIncreaseRequestId']
        resource_path = "/limitsIncreaseRequests/{limitsIncreaseRequestId}"
        ...
        if extra_kwargs:
            raise ValueError(
                f"get_limits_increase_request got unknown kwargs: {extra_kwargs!r}")
    ...
    def list_limits_increase_item_requests(self, compartment_id, **kwargs):
        """
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.limits_increase.models.LimitsIncreaseItemRequestCollection`
        :rtype: :class:`~oci.response.Response`

        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/limitsincrease/list_limits_increase_item_requests.py.html>`__ to see an example of how to use list_limits_increase_item_requests API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        ...
        if extra_kwargs:
            raise ValueError(
                f"list_limits_increase_item_requests got unknown kwargs: {extra_kwargs!r}")
        ...
        query_params = {
            ...
            "limitsIncreaseRequestId": kwargs.get("limits_increase_request_id", missing),
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                header_params=header_params,
                response_type="LimitsIncreaseItemRequestCollection",
                allow_control_chars=kwargs.get('allow_control_chars'),
                enable_strict_url_encoding=kwargs.get('enable_strict_url_encoding'),
                operation_name=operation_name,
                api_reference_link=api_reference_link,
    ...
    def list_limits_increase_questions(self, compartment_id, **kwargs):
        """
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.limits_increase.models.LimitsIncreaseQuestionCollection`
        :rtype: :class:`~oci.response.Response`

        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/limitsincrease/list_limits_increase_questions.py.html>`__ to see an example of how to use list_limits_increase_questions API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        ...
        if extra_kwargs:
            raise ValueError(
                f"list_limits_increase_questions got unknown kwargs: {extra_kwargs!r}")
        ...
        if 'sort_by' in kwargs:
            sort_by_allowed_values = ["serviceName", "limitName"]
            if kwargs['sort_by'] not in sort_by_allowed_values:
                raise ValueError(
                    f"Invalid value for `sort_by`, must be one of { sort_by_allowed_values }"
                )
        ...
        query_params = {
            ...
            "limitName": kwargs.get("limit_name", missing),
            "sortOrder": kwargs.get("sort_order", missing),
            "sortBy": kwargs.get("sort_by", missing),
            "limit": kwargs.get("limit", missing),
            "page": kwargs.get("page", missing)
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                query_params=query_params,
                header_params=header_params,
                response_type="LimitsIncreaseQuestionCollection",
                allow_control_chars=kwargs.get('allow_control_chars'),
                enable_strict_url_encoding=kwargs.get('enable_strict_url_encoding'),
                operation_name=operation_name,
                api_reference_link=api_reference_link,
    ...
    def list_limits_increase_requests(self, compartment_id, **kwargs):
        """
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.limits_increase.models.LimitsIncreaseRequestCollection`
        :rtype: :class:`~oci.response.Response`

        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/limitsincrease/list_limits_increase_requests.py.html>`__ to see an example of how to use list_limits_increase_requests API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        resource_path = "/limitsIncreaseRequests"
        ...
        if extra_kwargs:
            raise ValueError(
                f"list_limits_increase_requests got unknown kwargs: {extra_kwargs!r}")
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                query_params=query_params,
                header_params=header_params,
                response_type="LimitsIncreaseRequestCollection",
                allow_control_chars=kwargs.get('allow_control_chars'),
                enable_strict_url_encoding=kwargs.get('enable_strict_url_encoding'),
                operation_name=operation_name,
                api_reference_link=api_reference_link,
    ...
    def patch_limits_increase_request(self, patch_limits_increase_request_details, limits_increase_request_id, **kwargs):
        """
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/limitsincrease/patch_limits_increase_request.py.html>`__ to see an example of how to use patch_limits_increase_request API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['limitsIncreaseRequestId']
        resource_path = "/limitsIncreaseRequests/{limitsIncreaseRequestId}"
        ...
        if extra_kwargs:
            raise ValueError(
                f"patch_limits_increase_request got unknown kwargs: {extra_kwargs!r}")
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                path_params=path_params,
                header_params=header_params,
                body=patch_limits_increase_request_details,
                response_type="LimitsIncreaseRequest",
                allow_control_chars=kwargs.get('allow_control_chars'),
                enable_strict_url_encoding=kwargs.get('enable_strict_url_encoding'),
                operation_name=operation_name,
    ...
    def update_limits_increase_request(self, update_limits_increase_request_details, limits_increase_request_id, **kwargs):
        """
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/limitsincrease/update_limits_increase_request.py.html>`__ to see an example of how to use update_limits_increase_request API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['limitsIncreaseRequestId']
        resource_path = "/limitsIncreaseRequests/{limitsIncreaseRequestId}"
        ...
        if extra_kwargs:
            raise ValueError(
                f"update_limits_increase_request got unknown kwargs: {extra_kwargs!r}")
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                path_params=path_params,
                header_params=header_params,
                body=update_limits_increase_request_details,
                response_type="LimitsIncreaseRequest",
                allow_control_chars=kwargs.get('allow_control_chars'),
                enable_strict_url_encoding=kwargs.get('enable_strict_url_encoding'),
                operation_name=operation_name,
