...
class WorkRequestSummary(object):
    ...
    #: This constant has a value of "CREATE_PROTECTED_DATABASE"
    OPERATION_TYPE_CREATE_PROTECTED_DATABASE = "CREATE_PROTECTED_DATABASE"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "UPDATE_PROTECTED_DATABASE"
    OPERATION_TYPE_UPDATE_PROTECTED_DATABASE = "UPDATE_PROTECTED_DATABASE"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "DELETE_PROTECTED_DATABASE"
    OPERATION_TYPE_DELETE_PROTECTED_DATABASE = "DELETE_PROTECTED_DATABASE"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "MOVE_PROTECTED_DATABASE"
    OPERATION_TYPE_MOVE_PROTECTED_DATABASE = "MOVE_PROTECTED_DATABASE"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "CREATE_PROTECTION_POLICY"
    OPERATION_TYPE_CREATE_PROTECTION_POLICY = "CREATE_PROTECTION_POLICY"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "UPDATE_PROTECTION_POLICY"
    OPERATION_TYPE_UPDATE_PROTECTION_POLICY = "UPDATE_PROTECTION_POLICY"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "DELETE_PROTECTION_POLICY"
    OPERATION_TYPE_DELETE_PROTECTION_POLICY = "DELETE_PROTECTION_POLICY"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "MOVE_PROTECTION_POLICY"
    OPERATION_TYPE_MOVE_PROTECTION_POLICY = "MOVE_PROTECTION_POLICY"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "CREATE_RECOVERY_SERVICE_SUBNET"
    OPERATION_TYPE_CREATE_RECOVERY_SERVICE_SUBNET = "CREATE_RECOVERY_SERVICE_SUBNET"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "UPDATE_RECOVERY_SERVICE_SUBNET"
    OPERATION_TYPE_UPDATE_RECOVERY_SERVICE_SUBNET = "UPDATE_RECOVERY_SERVICE_SUBNET"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "DELETE_RECOVERY_SERVICE_SUBNET"
    OPERATION_TYPE_DELETE_RECOVERY_SERVICE_SUBNET = "DELETE_RECOVERY_SERVICE_SUBNET"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "MOVE_RECOVERY_SERVICE_SUBNET"
    OPERATION_TYPE_MOVE_RECOVERY_SERVICE_SUBNET = "MOVE_RECOVERY_SERVICE_SUBNET"
    ...
    def __init__(self, **kwargs):
        ...
        :type resources: list[oci.recovery.models.WorkRequestResource]
    ...
    def operation_type(self, operation_type):
        ...
        :type: str
        """
        allowed_values = ["CREATE_PROTECTED_DATABASE", "UPDATE_PROTECTED_DATABASE", "DELETE_PROTECTED_DATABASE", "MOVE_PROTECTED_DATABASE", "CREATE_PROTECTION_POLICY", "UPDATE_PROTECTION_POLICY", "DELETE_PROTECTION_POLICY", "MOVE_PROTECTION_POLICY", "CREATE_RECOVERY_SERVICE_SUBNET", "UPDATE_RECOVERY_SERVICE_SUBNET", "DELETE_RECOVERY_SERVICE_SUBNET", "MOVE_RECOVERY_SERVICE_SUBNET"]
    ...
    def resources(self):
        ...
        **[Required]** Gets the resources of this WorkRequestSummary.
        ...
        :rtype: list[oci.recovery.models.WorkRequestResource]
        """
    ...
    def resources(self, resources):
        ...
        :type: list[oci.recovery.models.WorkRequestResource]
        """
    ...
    def time_accepted(self):
        ...
        **[Required]** Gets the time_accepted of this WorkRequestSummary.
        The date and time the request was accepted, as described in `RFC 3339`__, section 14.29. The precision for this time object is in milliseconds.
    ...
    def time_started(self):
        ...
        The date and time the work request transitioned from ACCEPTED to IN_PROGRESS, as described in `RFC 3339`__, section 14.29. The precision for this time object is in milliseconds.
    ...
    def time_finished(self):
        ...
        The date and time the work request reached a terminal state, either FAILED or SUCCEEDED, as described in `RFC 3339`__, section 14.29. The precision for this time object is in milliseconds.
