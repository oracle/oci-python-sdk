...
class WorkRequestSummary(object):
    ...
    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "CREATE_LONG_TERM_BACKUP"
    OPERATION_TYPE_CREATE_LONG_TERM_BACKUP = "CREATE_LONG_TERM_BACKUP"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "DELETE_LONG_TERM_BACKUP"
    OPERATION_TYPE_DELETE_LONG_TERM_BACKUP = "DELETE_LONG_TERM_BACKUP"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "UPDATE_LONG_TERM_BACKUP"
    OPERATION_TYPE_UPDATE_LONG_TERM_BACKUP = "UPDATE_LONG_TERM_BACKUP"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "CANCEL_LONG_TERM_BACKUP"
    OPERATION_TYPE_CANCEL_LONG_TERM_BACKUP = "CANCEL_LONG_TERM_BACKUP"
