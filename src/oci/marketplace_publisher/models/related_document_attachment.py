...
class RelatedDocumentAttachment(ListingRevisionAttachment):
    ...
    #: A constant which can be used with the document_category property of a RelatedDocumentAttachment.
    #: This constant has a value of "WEBINARS"
    DOCUMENT_CATEGORY_WEBINARS = "WEBINARS"

    #: A constant which can be used with the document_category property of a RelatedDocumentAttachment.
    #: This constant has a value of "WHITEPAPERS"
    ...
    def document_category(self, document_category):
        ...
        :type: str
        """
        allowed_values = ["CASE_STUDIES", "CUSTOMIZATION_GUIDES", "DATA_SHEETS", "PRESS_RELEASE", "PRODUCT_DOCUMENTATION", "USER_GUIDES", "WEBINARS", "WHITEPAPERS"]
