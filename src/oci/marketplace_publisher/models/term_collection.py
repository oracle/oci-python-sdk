...
class TermCollection(object):
    ...
    def __init__(self, **kwargs):
        ...
        :type items: list[oci.marketplace_publisher.models.TermSummary]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this TermCollection.
        ...
        :rtype: list[oci.marketplace_publisher.models.TermSummary]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.marketplace_publisher.models.TermSummary]
        """
        self._items = items
