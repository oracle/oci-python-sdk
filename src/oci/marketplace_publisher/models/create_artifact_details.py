...
class CreateArtifactDetails(object):
    ...
    def __init__(self, **kwargs):
        ...
        * :class:`~oci.marketplace_publisher.models.CreateStackArtifactDetails`
        * :class:`~oci.marketplace_publisher.models.CreateContainerImageArtifactDetails`
        * :class:`~oci.marketplace_publisher.models.CreateMachineImageArtifactDetails`
