...
class UnifiedAgentCsvParser(UnifiedAgentParser):
    """
    CSV Parser.
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new UnifiedAgentCsvParser object with values from keyword arguments. The default value of the :py:attr:`~oci.logging.models.UnifiedAgentCsvParser.parser_type` attribute
        ...
        :param field_time_key:
            The value to assign to the field_time_key property of this UnifiedAgentCsvParser.
        :type field_time_key: str

        :param types:
            The value to assign to the types property of this UnifiedAgentCsvParser.
        :type types: dict(str, str)

        :param null_value_pattern:
            The value to assign to the null_value_pattern property of this UnifiedAgentCsvParser.
        :type null_value_pattern: str

        :param is_null_empty_string:
            The value to assign to the is_null_empty_string property of this UnifiedAgentCsvParser.
        :type is_null_empty_string: bool

        :param is_estimate_current_event:
            The value to assign to the is_estimate_current_event property of this UnifiedAgentCsvParser.
        :type is_estimate_current_event: bool

        :param is_keep_time_key:
            The value to assign to the is_keep_time_key property of this UnifiedAgentCsvParser.
        :type is_keep_time_key: bool

        :param timeout_in_milliseconds:
            The value to assign to the timeout_in_milliseconds property of this UnifiedAgentCsvParser.
        :type timeout_in_milliseconds: int

        :param delimiter:
            The value to assign to the delimiter property of this UnifiedAgentCsvParser.
        :type delimiter: str

        :param keys:
            The value to assign to the keys property of this UnifiedAgentCsvParser.
        :type keys: list[str]
