...
class ServiceConnectorCollection(object):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ServiceConnectorCollection object with values from keyword arguments.
        ...
        """
        self.swagger_types = {
            'items': 'list[ServiceConnectorSummary]'
        }
    ...
    def items(self, items):
        """
        Sets the items of this ServiceConnectorCollection.
        The list of items.
