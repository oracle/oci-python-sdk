...
class CreateCatalogPeerWithExadbXsDetails(object):
    """
    Details required for creation of ExadbXs infrastructure based catalog peer.
    """

    #: A constant which can be used with the protection_mode property of a CreateCatalogPeerWithExadbXsDetails.
    ...
    #: A constant which can be used with the transport_type property of a CreateCatalogPeerWithExadbXsDetails.
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new CreateCatalogPeerWithExadbXsDetails object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param vm_cluster_id:
            The value to assign to the vm_cluster_id property of this CreateCatalogPeerWithExadbXsDetails.
        :type vm_cluster_id: str

        :param protection_mode:
            The value to assign to the protection_mode property of this CreateCatalogPeerWithExadbXsDetails.
            Allowed values for this property are: "MAXIMUM_AVAILABILITY", "MAXIMUM_PERFORMANCE", "MAXIMUM_PROTECTION"
        :type protection_mode: str

        :param transport_type:
            The value to assign to the transport_type property of this CreateCatalogPeerWithExadbXsDetails.
    ...
    def protection_mode(self):
        """
        Gets the protection_mode of this CreateCatalogPeerWithExadbXsDetails.
        The protectionMode for the catalog peer.

        Allowed values for this property are: "MAXIMUM_AVAILABILITY", "MAXIMUM_PERFORMANCE", "MAXIMUM_PROTECTION"


        :return: The protection_mode of this CreateCatalogPeerWithExadbXsDetails.
        :rtype: str
        """
    ...
    def protection_mode(self, protection_mode):
        """
        Sets the protection_mode of this CreateCatalogPeerWithExadbXsDetails.
        The protectionMode for the catalog peer.


        :param protection_mode: The protection_mode of this CreateCatalogPeerWithExadbXsDetails.
        :type: str
        """
    ...
    def transport_type(self):
        """
        Gets the transport_type of this CreateCatalogPeerWithExadbXsDetails.
        The redo transport type to use for this Data Guard association.

        Allowed values for this property are: "SYNC", "ASYNC", "FASTSYNC"


        :return: The transport_type of this CreateCatalogPeerWithExadbXsDetails.
        :rtype: str
        """
    ...
    def transport_type(self, transport_type):
        """
        Sets the transport_type of this CreateCatalogPeerWithExadbXsDetails.
        The redo transport type to use for this Data Guard association.


        :param transport_type: The transport_type of this CreateCatalogPeerWithExadbXsDetails.
        :type: str
        """
