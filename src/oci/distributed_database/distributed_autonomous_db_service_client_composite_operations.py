...
class DistributedAutonomousDbServiceClientCompositeOperations(object):
    ...
    def change_distributed_autonomous_db_backup_config_and_wait_for_state(self, distributed_autonomous_database_id, change_distributed_autonomous_db_backup_config_details, wait_for_states=[], operation_kwargs={}, waiter_kwargs={}):
        """
        Calls :py:func:`~oci.distributed_database.DistributedAutonomousDbServiceClient.change_distributed_autonomous_db_backup_config` and waits for the :py:class:`~oci.distributed_database.models.WorkRequest`
        to enter the given state(s).
        ...
        :param dict operation_kwargs:
            A dictionary of keyword arguments to pass to :py:func:`~oci.distributed_database.DistributedAutonomousDbServiceClient.change_distributed_autonomous_db_backup_config`

        :param dict waiter_kwargs:
            A dictionary of keyword arguments to pass to the :py:func:`oci.wait_until` function. For example, you could pass ``max_interval_seconds`` or ``max_interval_seconds``
            as dictionary keys to modify how long the waiter function will wait between retries and the maximum amount of time it will wait
        """
        operation_result = self.client.change_distributed_autonomous_db_backup_config(distributed_autonomous_database_id, change_distributed_autonomous_db_backup_config_details, **operation_kwargs)
        if not wait_for_states:
            return operation_result
        lowered_wait_for_states = [w.lower() for w in wait_for_states]
        if 'opc-work-request-id' not in operation_result.headers:
    ...
    def configure_distributed_autonomous_database_gsm_wallet_and_wait_for_state(self, configure_distributed_autonomous_database_gsm_wallet_details, distributed_autonomous_database_id, wait_for_states=[], operation_kwargs={}, waiter_kwargs={}):
        """
        Calls :py:func:`~oci.distributed_database.DistributedAutonomousDbServiceClient.configure_distributed_autonomous_database_gsm_wallet` and waits for the :py:class:`~oci.distributed_database.models.WorkRequest`
        to enter the given state(s).

        :param oci.distributed_database.models.ConfigureDistributedAutonomousDatabaseGsmWalletDetails configure_distributed_autonomous_database_gsm_wallet_details: (required)
        ...
        :param dict operation_kwargs:
            A dictionary of keyword arguments to pass to :py:func:`~oci.distributed_database.DistributedAutonomousDbServiceClient.configure_distributed_autonomous_database_gsm_wallet`

        :param dict waiter_kwargs:
            A dictionary of keyword arguments to pass to the :py:func:`oci.wait_until` function. For example, you could pass ``max_interval_seconds`` or ``max_interval_seconds``
            as dictionary keys to modify how long the waiter function will wait between retries and the maximum amount of time it will wait
        """
        operation_result = self.client.configure_distributed_autonomous_database_gsm_wallet(configure_distributed_autonomous_database_gsm_wallet_details, distributed_autonomous_database_id, **operation_kwargs)
        if not wait_for_states:
            return operation_result
        lowered_wait_for_states = [w.lower() for w in wait_for_states]
        if 'opc-work-request-id' not in operation_result.headers:
    ...
    def generate_distributed_autonomous_database_gsm_certificate_signing_request_and_wait_for_state(self, distributed_autonomous_database_id, wait_for_states=[], operation_kwargs={}, waiter_kwargs={}):
        """
        ...
        :param dict waiter_kwargs:
            ...
            as dictionary keys to modify how long the waiter function will wait between retries and the maximum amount of time it will wait
        """
        operation_result = self.client.generate_distributed_autonomous_database_gsm_certificate_signing_request(distributed_autonomous_database_id, **operation_kwargs)
        if not wait_for_states:
            return operation_result
        lowered_wait_for_states = [w.lower() for w in wait_for_states]
        if 'opc-work-request-id' not in operation_result.headers:
    ...
    def move_distributed_autonomous_database_replication_unit_and_wait_for_state(self, distributed_autonomous_database_id, move_distributed_autonomous_database_replication_unit_details, wait_for_states=[], operation_kwargs={}, waiter_kwargs={}):
        """
        Calls :py:func:`~oci.distributed_database.DistributedAutonomousDbServiceClient.move_distributed_autonomous_database_replication_unit` and waits for the :py:class:`~oci.distributed_database.models.WorkRequest`
        to enter the given state(s).

        :param str distributed_autonomous_database_id: (required)
            Globally distributed autonomous database identifier

        :param oci.distributed_database.models.MoveDistributedAutonomousDatabaseReplicationUnitDetails move_distributed_autonomous_database_replication_unit_details: (required)
        ...
        :param dict operation_kwargs:
            A dictionary of keyword arguments to pass to :py:func:`~oci.distributed_database.DistributedAutonomousDbServiceClient.move_distributed_autonomous_database_replication_unit`

        :param dict waiter_kwargs:
            A dictionary of keyword arguments to pass to the :py:func:`oci.wait_until` function. For example, you could pass ``max_interval_seconds`` or ``max_interval_seconds``
            as dictionary keys to modify how long the waiter function will wait between retries and the maximum amount of time it will wait
        """
        operation_result = self.client.move_distributed_autonomous_database_replication_unit(distributed_autonomous_database_id, move_distributed_autonomous_database_replication_unit_details, **operation_kwargs)
        if not wait_for_states:
            return operation_result
        lowered_wait_for_states = [w.lower() for w in wait_for_states]
        if 'opc-work-request-id' not in operation_result.headers:
    ...
    def recreate_failed_distributed_autonomous_database_resource_and_wait_for_state(self, distributed_autonomous_database_id, resource_name, wait_for_states=[], operation_kwargs={}, waiter_kwargs={}):
        """
        Calls :py:func:`~oci.distributed_database.DistributedAutonomousDbServiceClient.recreate_failed_distributed_autonomous_database_resource` and waits for the :py:class:`~oci.distributed_database.models.WorkRequest`
        to enter the given state(s).
        ...
        :param dict operation_kwargs:
            A dictionary of keyword arguments to pass to :py:func:`~oci.distributed_database.DistributedAutonomousDbServiceClient.recreate_failed_distributed_autonomous_database_resource`

        :param dict waiter_kwargs:
            A dictionary of keyword arguments to pass to the :py:func:`oci.wait_until` function. For example, you could pass ``max_interval_seconds`` or ``max_interval_seconds``
            as dictionary keys to modify how long the waiter function will wait between retries and the maximum amount of time it will wait
        """
        operation_result = self.client.recreate_failed_distributed_autonomous_database_resource(distributed_autonomous_database_id, resource_name, **operation_kwargs)
        if not wait_for_states:
            return operation_result
        lowered_wait_for_states = [w.lower() for w in wait_for_states]
        if 'opc-work-request-id' not in operation_result.headers:
    ...
    def validate_distributed_autonomous_database_ca_bundle_and_wait_for_state(self, distributed_autonomous_database_id, wait_for_states=[], operation_kwargs={}, waiter_kwargs={}):
        """
        Calls :py:func:`~oci.distributed_database.DistributedAutonomousDbServiceClient.validate_distributed_autonomous_database_ca_bundle` and waits for the :py:class:`~oci.distributed_database.models.WorkRequest`
        to enter the given state(s).
        ...
        :param dict operation_kwargs:
            A dictionary of keyword arguments to pass to :py:func:`~oci.distributed_database.DistributedAutonomousDbServiceClient.validate_distributed_autonomous_database_ca_bundle`

        :param dict waiter_kwargs:
            A dictionary of keyword arguments to pass to the :py:func:`oci.wait_until` function. For example, you could pass ``max_interval_seconds`` or ``max_interval_seconds``
            as dictionary keys to modify how long the waiter function will wait between retries and the maximum amount of time it will wait
        """
        operation_result = self.client.validate_distributed_autonomous_database_ca_bundle(distributed_autonomous_database_id, **operation_kwargs)
        if not wait_for_states:
            return operation_result
        lowered_wait_for_states = [w.lower() for w in wait_for_states]
        if 'opc-work-request-id' not in operation_result.headers:
