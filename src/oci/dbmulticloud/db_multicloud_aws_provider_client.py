...
class DbMulticloudAwsProviderClient(object):
    ...
    def replicate_oracle_db_aws_key(self, oracle_db_aws_key_id, replicate_oracle_db_aws_key_details, **kwargs):
        """
        ...
        :param oci.dbmulticloud.models.ReplicateOracleDbAwsKeyDetails replicate_oracle_db_aws_key_details: (required)
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/dbmulticloud/replicate_oracle_db_aws_key.py.html>`__ to see an example of how to use replicate_oracle_db_aws_key API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['oracleDbAwsKeyId']
        resource_path = "/oracleDbAwsKey/{oracleDbAwsKeyId}/actions/replicate"
        method = "POST"
        operation_name = "replicate_oracle_db_aws_key"
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/database-multicloud-integrations/20240501/OracleDbAwsKey/ReplicateOracleDbAwsKey"
        ...
        if extra_kwargs:
            raise ValueError(
                f"replicate_oracle_db_aws_key got unknown kwargs: {extra_kwargs!r}")
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                path_params=path_params,
                header_params=header_params,
                body=replicate_oracle_db_aws_key_details,
                allow_control_chars=kwargs.get('allow_control_chars'),
                enable_strict_url_encoding=kwargs.get('enable_strict_url_encoding'),
                operation_name=operation_name,
                api_reference_link=api_reference_link,
