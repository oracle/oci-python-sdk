...
class UpdateOracleDbAzureVaultDetails(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new UpdateOracleDbAzureVaultDetails object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param compartment_id:
            The value to assign to the compartment_id property of this UpdateOracleDbAzureVaultDetails.
        :type compartment_id: str

        :param oracle_db_connector_id:
            The value to assign to the oracle_db_connector_id property of this UpdateOracleDbAzureVaultDetails.
        :type oracle_db_connector_id: str

        :param display_name:
            The value to assign to the display_name property of this UpdateOracleDbAzureVaultDetails.
        :type display_name: str

        :param oracle_db_azure_resource_group:
            The value to assign to the oracle_db_azure_resource_group property of this UpdateOracleDbAzureVaultDetails.
        :type oracle_db_azure_resource_group: str

        :param azure_vault_id:
            The value to assign to the azure_vault_id property of this UpdateOracleDbAzureVaultDetails.
        :type azure_vault_id: str

        :param type:
            The value to assign to the type property of this UpdateOracleDbAzureVaultDetails.
        :type type: str

        :param location:
            The value to assign to the location property of this UpdateOracleDbAzureVaultDetails.
        :type location: str

        :param properties:
            The value to assign to the properties property of this UpdateOracleDbAzureVaultDetails.
        :type properties: dict(str, str)

        :param freeform_tags:
            The value to assign to the freeform_tags property of this UpdateOracleDbAzureVaultDetails.
        :type freeform_tags: dict(str, str)

        :param defined_tags:
            The value to assign to the defined_tags property of this UpdateOracleDbAzureVaultDetails.
    ...
    def freeform_tags(self):
        """
        Gets the freeform_tags of this UpdateOracleDbAzureVaultDetails.
    ...
    def freeform_tags(self, freeform_tags):
        """
        Sets the freeform_tags of this UpdateOracleDbAzureVaultDetails.
        Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace.
        For more information, see `Resource Tags`__.
    ...
    def defined_tags(self):
        """
        Gets the defined_tags of this UpdateOracleDbAzureVaultDetails.
    ...
    def defined_tags(self, defined_tags):
        """
        Sets the defined_tags of this UpdateOracleDbAzureVaultDetails.
        Defined tags for this resource. Each key is predefined and scoped to a namespace.
        For more information, see `Resource Tags`__.
