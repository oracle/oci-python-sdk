...
class OracleDbAzureVaultSummary(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new OracleDbAzureVaultSummary object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param id:
            The value to assign to the id property of this OracleDbAzureVaultSummary.
        :type id: str

        :param display_name:
            The value to assign to the display_name property of this OracleDbAzureVaultSummary.
        :type display_name: str

        :param compartment_id:
            The value to assign to the compartment_id property of this OracleDbAzureVaultSummary.
        :type compartment_id: str

        :param oracle_db_connector_id:
            The value to assign to the oracle_db_connector_id property of this OracleDbAzureVaultSummary.
        :type oracle_db_connector_id: str

        :param azure_vault_id:
            The value to assign to the azure_vault_id property of this OracleDbAzureVaultSummary.
        :type azure_vault_id: str

        :param oracle_db_azure_resource_group:
            The value to assign to the oracle_db_azure_resource_group property of this OracleDbAzureVaultSummary.
        :type oracle_db_azure_resource_group: str

        :param type:
            The value to assign to the type property of this OracleDbAzureVaultSummary.
        :type type: str

        :param location:
            The value to assign to the location property of this OracleDbAzureVaultSummary.
        :type location: str
        ...
        :param lifecycle_state_details:
            The value to assign to the lifecycle_state_details property of this OracleDbAzureVaultSummary.
        :type lifecycle_state_details: str

        :param time_created:
            The value to assign to the time_created property of this OracleDbAzureVaultSummary.
        :type time_created: datetime

        :param time_updated:
            The value to assign to the time_updated property of this OracleDbAzureVaultSummary.
        :type time_updated: datetime

        :param last_modification:
            The value to assign to the last_modification property of this OracleDbAzureVaultSummary.
        :type last_modification: str

        :param freeform_tags:
            The value to assign to the freeform_tags property of this OracleDbAzureVaultSummary.
        :type freeform_tags: dict(str, str)

        :param defined_tags:
            The value to assign to the defined_tags property of this OracleDbAzureVaultSummary.
        :type defined_tags: dict(str, dict(str, object))

        :param system_tags:
            The value to assign to the system_tags property of this OracleDbAzureVaultSummary.
    ...
    def display_name(self):
        """
        Gets the display_name of this OracleDbAzureVaultSummary.
        Oracle DB Azure Vault resource name.


        :return: The display_name of this OracleDbAzureVaultSummary.
        :rtype: str
        """
    ...
    def display_name(self, display_name):
        """
        Sets the display_name of this OracleDbAzureVaultSummary.
        Oracle DB Azure Vault resource name.


        :param display_name: The display_name of this OracleDbAzureVaultSummary.
        :type: str
        """
    ...
    def lifecycle_state_details(self):
        """
        Gets the lifecycle_state_details of this OracleDbAzureVaultSummary.
        Description of the current lifecycle state in more detail.


        :return: The lifecycle_state_details of this OracleDbAzureVaultSummary.
        :rtype: str
        """
    ...
    def lifecycle_state_details(self, lifecycle_state_details):
        """
        Sets the lifecycle_state_details of this OracleDbAzureVaultSummary.
        Description of the current lifecycle state in more detail.


        :param lifecycle_state_details: The lifecycle_state_details of this OracleDbAzureVaultSummary.
        :type: str
        """
    ...
    def time_created(self):
        ...
        :return: The time_created of this OracleDbAzureVaultSummary.
        :rtype: datetime
        """
    ...
    def time_created(self, time_created):
        ...
        :param time_created: The time_created of this OracleDbAzureVaultSummary.
        :type: datetime
        """
    ...
    def time_updated(self):
        ...
        :return: The time_updated of this OracleDbAzureVaultSummary.
        :rtype: datetime
        """
    ...
    def time_updated(self, time_updated):
        ...
        :param time_updated: The time_updated of this OracleDbAzureVaultSummary.
        :type: datetime
        """
    ...
    def freeform_tags(self):
        """
        Gets the freeform_tags of this OracleDbAzureVaultSummary.
    ...
    def freeform_tags(self, freeform_tags):
        """
        Sets the freeform_tags of this OracleDbAzureVaultSummary.
        Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace.
        For more information, see `Resource Tags`__.
    ...
    def defined_tags(self):
        """
        Gets the defined_tags of this OracleDbAzureVaultSummary.
    ...
    def defined_tags(self, defined_tags):
        """
        Sets the defined_tags of this OracleDbAzureVaultSummary.
        Defined tags for this resource. Each key is predefined and scoped to a namespace.
        For more information, see `Resource Tags`__.
    ...
    def system_tags(self):
        """
        Gets the system_tags of this OracleDbAzureVaultSummary.
        System tags for this resource. Each key is predefined and scoped to a namespace.

        Example: `{\"orcl-cloud\": {\"free-tier-retained\": \"true\"}}`


        :return: The system_tags of this OracleDbAzureVaultSummary.
        :rtype: dict(str, dict(str, object))
        """
    ...
    def system_tags(self, system_tags):
        """
        Sets the system_tags of this OracleDbAzureVaultSummary.
        System tags for this resource. Each key is predefined and scoped to a namespace.

        Example: `{\"orcl-cloud\": {\"free-tier-retained\": \"true\"}}`


        :param system_tags: The system_tags of this OracleDbAzureVaultSummary.
        :type: dict(str, dict(str, object))
        """
