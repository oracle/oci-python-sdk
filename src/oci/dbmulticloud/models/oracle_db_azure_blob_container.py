...
class OracleDbAzureBlobContainer(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new OracleDbAzureBlobContainer object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param id:
            The value to assign to the id property of this OracleDbAzureBlobContainer.
        :type id: str

        :param compartment_id:
            The value to assign to the compartment_id property of this OracleDbAzureBlobContainer.
        :type compartment_id: str

        :param display_name:
            The value to assign to the display_name property of this OracleDbAzureBlobContainer.
        :type display_name: str

        :param private_endpoint_ip_address:
            The value to assign to the private_endpoint_ip_address property of this OracleDbAzureBlobContainer.
        :type private_endpoint_ip_address: str

        :param private_endpoint_dns_alias:
            The value to assign to the private_endpoint_dns_alias property of this OracleDbAzureBlobContainer.
        :type private_endpoint_dns_alias: str

        :param azure_storage_account_name:
            The value to assign to the azure_storage_account_name property of this OracleDbAzureBlobContainer.
        :type azure_storage_account_name: str

        :param azure_storage_container_name:
            The value to assign to the azure_storage_container_name property of this OracleDbAzureBlobContainer.
        :type azure_storage_container_name: str

        :param lifecycle_state:
            The value to assign to the lifecycle_state property of this OracleDbAzureBlobContainer.
            Allowed values for this property are: "CREATING", "ACTIVE", "UPDATING", "DELETING", "DELETED", "FAILED", 'UNKNOWN_ENUM_VALUE'.
            Any unrecognized values returned by a service will be mapped to 'UNKNOWN_ENUM_VALUE'.
        :type lifecycle_state: str

        :param lifecycle_state_details:
            The value to assign to the lifecycle_state_details property of this OracleDbAzureBlobContainer.
        :type lifecycle_state_details: str

        :param time_created:
            The value to assign to the time_created property of this OracleDbAzureBlobContainer.
        :type time_created: datetime

        :param time_updated:
            The value to assign to the time_updated property of this OracleDbAzureBlobContainer.
        :type time_updated: datetime

        :param last_modification:
            The value to assign to the last_modification property of this OracleDbAzureBlobContainer.
        :type last_modification: str

        :param freeform_tags:
            The value to assign to the freeform_tags property of this OracleDbAzureBlobContainer.
        :type freeform_tags: dict(str, str)

        :param defined_tags:
            The value to assign to the defined_tags property of this OracleDbAzureBlobContainer.
        :type defined_tags: dict(str, dict(str, object))

        :param system_tags:
            The value to assign to the system_tags property of this OracleDbAzureBlobContainer.
