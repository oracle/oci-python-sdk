...
class ChangeOracleDbAwsKeyCompartmentDetails(object):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ChangeOracleDbAwsKeyCompartmentDetails object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param compartment_id:
            The value to assign to the compartment_id property of this ChangeOracleDbAwsKeyCompartmentDetails.
