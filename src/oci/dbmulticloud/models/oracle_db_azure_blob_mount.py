...
class OracleDbAzureBlobMount(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new OracleDbAzureBlobMount object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param id:
            The value to assign to the id property of this OracleDbAzureBlobMount.
        :type id: str

        :param display_name:
            The value to assign to the display_name property of this OracleDbAzureBlobMount.
        :type display_name: str

        :param compartment_id:
            The value to assign to the compartment_id property of this OracleDbAzureBlobMount.
        :type compartment_id: str

        :param oracle_db_azure_connector_id:
            The value to assign to the oracle_db_azure_connector_id property of this OracleDbAzureBlobMount.
        :type oracle_db_azure_connector_id: str

        :param oracle_db_azure_blob_container_id:
            The value to assign to the oracle_db_azure_blob_container_id property of this OracleDbAzureBlobMount.
        :type oracle_db_azure_blob_container_id: str

        :param mount_path:
            The value to assign to the mount_path property of this OracleDbAzureBlobMount.
        :type mount_path: str

        :param lifecycle_state:
            The value to assign to the lifecycle_state property of this OracleDbAzureBlobMount.
            Allowed values for this property are: "CREATING", "ACTIVE", "UPDATING", "DELETING", "DELETED", "FAILED", 'UNKNOWN_ENUM_VALUE'.
            Any unrecognized values returned by a service will be mapped to 'UNKNOWN_ENUM_VALUE'.
        :type lifecycle_state: str

        :param lifecycle_state_details:
            The value to assign to the lifecycle_state_details property of this OracleDbAzureBlobMount.
        :type lifecycle_state_details: str

        :param time_created:
            The value to assign to the time_created property of this OracleDbAzureBlobMount.
        :type time_created: datetime

        :param time_updated:
            The value to assign to the time_updated property of this OracleDbAzureBlobMount.
        :type time_updated: datetime

        :param last_modification:
            The value to assign to the last_modification property of this OracleDbAzureBlobMount.
        :type last_modification: str

        :param freeform_tags:
            The value to assign to the freeform_tags property of this OracleDbAzureBlobMount.
        :type freeform_tags: dict(str, str)

        :param defined_tags:
            The value to assign to the defined_tags property of this OracleDbAzureBlobMount.
        :type defined_tags: dict(str, dict(str, object))

        :param system_tags:
            The value to assign to the system_tags property of this OracleDbAzureBlobMount.
    ...
    def lifecycle_state(self):
        ...
        :return: The lifecycle_state of this OracleDbAzureBlobMount.
        :rtype: str
        """
    ...
    def lifecycle_state_details(self):
        """
        Gets the lifecycle_state_details of this OracleDbAzureBlobMount.
        Description of the current lifecycle state in more detail.


        :return: The lifecycle_state_details of this OracleDbAzureBlobMount.
        :rtype: str
        """
    ...
    def lifecycle_state_details(self, lifecycle_state_details):
        """
        Sets the lifecycle_state_details of this OracleDbAzureBlobMount.
        Description of the current lifecycle state in more detail.


        :param lifecycle_state_details: The lifecycle_state_details of this OracleDbAzureBlobMount.
        :type: str
        """
    ...
    def time_created(self):
        """
        Gets the time_created of this OracleDbAzureBlobMount.
        Time when the Oracle DB Azure Blob Mount was created in `RFC 3339`__ timestamp format, e.g. '2020-05-22T21:10:29.600Z'

        __ https://tools.ietf.org/html/rfc3339


        :return: The time_created of this OracleDbAzureBlobMount.
        :rtype: datetime
        """
    ...
    def time_created(self, time_created):
        """
        Sets the time_created of this OracleDbAzureBlobMount.
        Time when the Oracle DB Azure Blob Mount was created in `RFC 3339`__ timestamp format, e.g. '2020-05-22T21:10:29.600Z'

        __ https://tools.ietf.org/html/rfc3339


        :param time_created: The time_created of this OracleDbAzureBlobMount.
        :type: datetime
        """
    ...
    def time_updated(self):
        """
        Gets the time_updated of this OracleDbAzureBlobMount.
        Time when the Oracle DB Azure Blob Mount was last modified, expressed in `RFC 3339`__ timestamp format, e.g. '2020-05-22T21:10:29.600Z'

        __ https://tools.ietf.org/html/rfc3339


        :return: The time_updated of this OracleDbAzureBlobMount.
        :rtype: datetime
        """
    ...
    def time_updated(self, time_updated):
        """
        Sets the time_updated of this OracleDbAzureBlobMount.
        Time when the Oracle DB Azure Blob Mount was last modified, expressed in `RFC 3339`__ timestamp format, e.g. '2020-05-22T21:10:29.600Z'

        __ https://tools.ietf.org/html/rfc3339


        :param time_updated: The time_updated of this OracleDbAzureBlobMount.
        :type: datetime
        """
    ...
    def freeform_tags(self):
        """
        Gets the freeform_tags of this OracleDbAzureBlobMount.
    ...
    def freeform_tags(self, freeform_tags):
        """
        Sets the freeform_tags of this OracleDbAzureBlobMount.
        Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace.
        For more information, see `Resource Tags`__.
    ...
    def defined_tags(self):
        """
        Gets the defined_tags of this OracleDbAzureBlobMount.
    ...
    def defined_tags(self, defined_tags):
        """
        Sets the defined_tags of this OracleDbAzureBlobMount.
        Defined tags for this resource. Each key is predefined and scoped to a namespace.
        For more information, see `Resource Tags`__.
    ...
    def system_tags(self):
        """
        Gets the system_tags of this OracleDbAzureBlobMount.
        System tags for this resource. Each key is predefined and scoped to a namespace.

        Example: `{\"orcl-cloud\": {\"free-tier-retained\": \"true\"}}`


        :return: The system_tags of this OracleDbAzureBlobMount.
        :rtype: dict(str, dict(str, object))
        """
    ...
    def system_tags(self, system_tags):
        """
        Sets the system_tags of this OracleDbAzureBlobMount.
        System tags for this resource. Each key is predefined and scoped to a namespace.

        Example: `{\"orcl-cloud\": {\"free-tier-retained\": \"true\"}}`


        :param system_tags: The system_tags of this OracleDbAzureBlobMount.
        :type: dict(str, dict(str, object))
        """
