...
class OracleDbAzureVaultClient(object):
    ...
    def change_oracle_db_azure_vault_compartment(self, oracle_db_azure_vault_id, change_oracle_db_azure_vault_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/dbmulticloud/change_oracle_db_azure_vault_compartment.py.html>`__ to see an example of how to use change_oracle_db_azure_vault_compartment API.
        """
    ...
    def create_oracle_db_azure_vault(self, create_oracle_db_azure_vault_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/dbmulticloud/create_oracle_db_azure_vault.py.html>`__ to see an example of how to use create_oracle_db_azure_vault API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def delete_oracle_db_azure_vault(self, oracle_db_azure_vault_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/dbmulticloud/delete_oracle_db_azure_vault.py.html>`__ to see an example of how to use delete_oracle_db_azure_vault API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['oracleDbAzureVaultId']
    ...
    def get_oracle_db_azure_vault(self, oracle_db_azure_vault_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/dbmulticloud/get_oracle_db_azure_vault.py.html>`__ to see an example of how to use get_oracle_db_azure_vault API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['oracleDbAzureVaultId']
        resource_path = "/oracleDbAzureVault/{oracleDbAzureVaultId}"
    ...
    def list_oracle_db_azure_vaults(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/dbmulticloud/list_oracle_db_azure_vaults.py.html>`__ to see an example of how to use list_oracle_db_azure_vaults API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def refresh_oracle_db_azure_vault(self, oracle_db_azure_vault_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/dbmulticloud/refresh_oracle_db_azure_vault.py.html>`__ to see an example of how to use refresh_oracle_db_azure_vault API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['oracleDbAzureVaultId']
    ...
    def replicate_oracle_db_azure_vault(self, oracle_db_azure_vault_id, replicate_oracle_db_azure_vault_details, **kwargs):
        """
        ...
        :param oci.dbmulticloud.models.ReplicateOracleDbAzureVaultDetails replicate_oracle_db_azure_vault_details: (required)
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/dbmulticloud/replicate_oracle_db_azure_vault.py.html>`__ to see an example of how to use replicate_oracle_db_azure_vault API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['oracleDbAzureVaultId']
        resource_path = "/oracleDbAzureVault/{oracleDbAzureVaultId}/actions/replicate"
        method = "POST"
        operation_name = "replicate_oracle_db_azure_vault"
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/database-multicloud-integrations/20240501/OracleDbAzureVault/ReplicateOracleDbAzureVault"
        ...
        if extra_kwargs:
            raise ValueError(
                f"replicate_oracle_db_azure_vault got unknown kwargs: {extra_kwargs!r}")
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                path_params=path_params,
                header_params=header_params,
                body=replicate_oracle_db_azure_vault_details,
                allow_control_chars=kwargs.get('allow_control_chars'),
                enable_strict_url_encoding=kwargs.get('enable_strict_url_encoding'),
                operation_name=operation_name,
                api_reference_link=api_reference_link,
    ...
    def update_oracle_db_azure_vault(self, oracle_db_azure_vault_id, update_oracle_db_azure_vault_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/dbmulticloud/update_oracle_db_azure_vault.py.html>`__ to see an example of how to use update_oracle_db_azure_vault API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['oracleDbAzureVaultId']
        resource_path = "/oracleDbAzureVault/{oracleDbAzureVaultId}"
