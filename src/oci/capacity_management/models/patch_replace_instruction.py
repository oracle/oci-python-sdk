...
class PatchReplaceInstruction(PatchInstruction):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new PatchReplaceInstruction object with values from keyword arguments. The default value of the :py:attr:`~oci.capacity_management.models.PatchReplaceInstruction.operation` attribute
