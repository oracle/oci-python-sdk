...
class PatchInsertMultipleInstruction(PatchInstruction):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new PatchInsertMultipleInstruction object with values from keyword arguments. The default value of the :py:attr:`~oci.capacity_management.models.PatchInsertMultipleInstruction.operation` attribute
