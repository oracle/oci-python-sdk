...
class PatchInstruction(object):
    ...
    def __init__(self, **kwargs):
        ...
        * :class:`~oci.capacity_management.models.PatchMoveInstruction`
        * :class:`~oci.capacity_management.models.PatchRemoveInstruction`
        * :class:`~oci.capacity_management.models.PatchReplaceInstruction`
        * :class:`~oci.capacity_management.models.PatchInsertMultipleInstruction`
        * :class:`~oci.capacity_management.models.PatchInsertInstruction`
        * :class:`~oci.capacity_management.models.PatchRequireInstruction`
        * :class:`~oci.capacity_management.models.PatchMergeInstruction`
        * :class:`~oci.capacity_management.models.PatchProhibitInstruction`
