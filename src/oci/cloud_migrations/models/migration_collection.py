...
class MigrationCollection(object):
    ...
    def __init__(self, **kwargs):
        ...
        :type items: list[oci.cloud_migrations.models.MigrationSummary]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this MigrationCollection.
        ...
        :rtype: list[oci.cloud_migrations.models.MigrationSummary]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.cloud_migrations.models.MigrationSummary]
        """
        self._items = items
