...
class AwsEc2Asset(Asset):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new AwsEc2Asset object with values from keyword arguments. The default value of the :py:attr:`~oci.cloud_migrations.models.AwsEc2Asset.asset_type` attribute
