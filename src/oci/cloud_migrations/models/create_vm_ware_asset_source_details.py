...
class CreateVmWareAssetSourceDetails(CreateAssetSourceDetails):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new CreateVmWareAssetSourceDetails object with values from keyword arguments. The default value of the :py:attr:`~oci.cloud_migrations.models.CreateVmWareAssetSourceDetails.type` attribute
