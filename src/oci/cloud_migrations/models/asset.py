...
class Asset(object):
    ...
    def __init__(self, **kwargs):
        ...
        * :class:`~oci.cloud_migrations.models.AwsEc2Asset`
        * :class:`~oci.cloud_migrations.models.VmwareVmAsset`
        * :class:`~oci.cloud_migrations.models.AwsEbsAsset`
        * :class:`~oci.cloud_migrations.models.VmAsset`
