...
class VmWareAssetSource(AssetSource):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new VmWareAssetSource object with values from keyword arguments. The default value of the :py:attr:`~oci.cloud_migrations.models.VmWareAssetSource.type` attribute
