...
class UpdateVmAssetDetails(UpdateAssetDetails):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new UpdateVmAssetDetails object with values from keyword arguments. The default value of the :py:attr:`~oci.cloud_migrations.models.UpdateVmAssetDetails.asset_type` attribute
