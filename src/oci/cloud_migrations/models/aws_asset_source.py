...
class AwsAssetSource(AssetSource):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new AwsAssetSource object with values from keyword arguments. The default value of the :py:attr:`~oci.cloud_migrations.models.AwsAssetSource.type` attribute
