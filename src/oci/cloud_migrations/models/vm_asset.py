...
class VmAsset(Asset):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new VmAsset object with values from keyword arguments. The default value of the :py:attr:`~oci.cloud_migrations.models.VmAsset.asset_type` attribute
