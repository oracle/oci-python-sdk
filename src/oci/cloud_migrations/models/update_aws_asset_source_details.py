...
class UpdateAwsAssetSourceDetails(UpdateAssetSourceDetails):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new UpdateAwsAssetSourceDetails object with values from keyword arguments. The default value of the :py:attr:`~oci.cloud_migrations.models.UpdateAwsAssetSourceDetails.type` attribute
