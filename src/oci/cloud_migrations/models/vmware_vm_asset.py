...
class VmwareVmAsset(Asset):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new VmwareVmAsset object with values from keyword arguments. The default value of the :py:attr:`~oci.cloud_migrations.models.VmwareVmAsset.asset_type` attribute
