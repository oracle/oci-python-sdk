...
class UpdateVmwareVmAssetDetails(UpdateAssetDetails):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new UpdateVmwareVmAssetDetails object with values from keyword arguments. The default value of the :py:attr:`~oci.cloud_migrations.models.UpdateVmwareVmAssetDetails.asset_type` attribute
