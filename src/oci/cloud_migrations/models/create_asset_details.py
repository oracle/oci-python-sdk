...
class CreateAssetDetails(object):
    ...
    def __init__(self, **kwargs):
        ...
        * :class:`~oci.cloud_migrations.models.CreateAwsEbsAssetDetails`
        * :class:`~oci.cloud_migrations.models.CreateVmwareVmAssetDetails`
        * :class:`~oci.cloud_migrations.models.CreateAwsEc2AssetDetails`
    ...
    def get_subtype(object_dictionary):
        ...
        if type == 'AWS_EBS':
            return 'CreateAwsEbsAssetDetails'
