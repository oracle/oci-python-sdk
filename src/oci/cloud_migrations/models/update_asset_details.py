...
class UpdateAssetDetails(object):
    ...
    def __init__(self, **kwargs):
        ...
        * :class:`~oci.cloud_migrations.models.UpdateVmAssetDetails`
        * :class:`~oci.cloud_migrations.models.UpdateAwsEbsAssetDetails`
        * :class:`~oci.cloud_migrations.models.UpdateVmwareVmAssetDetails`
        * :class:`~oci.cloud_migrations.models.UpdateAwsEc2AssetDetails`
