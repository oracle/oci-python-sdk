...
class AwsAssetSourceSummary(AssetSourceSummary):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new AwsAssetSourceSummary object with values from keyword arguments. The default value of the :py:attr:`~oci.cloud_migrations.models.AwsAssetSourceSummary.type` attribute
