...
class UpdateAwsEbsAssetDetails(UpdateAssetDetails):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new UpdateAwsEbsAssetDetails object with values from keyword arguments. The default value of the :py:attr:`~oci.cloud_migrations.models.UpdateAwsEbsAssetDetails.asset_type` attribute
