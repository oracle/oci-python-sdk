...
class FirewallConfigDetails(object):
    """
    Details to update the SQL Firewall configuration.
    """

    #: A constant which can be used with the status property of a FirewallConfigDetails.
    ...
    #: A constant which can be used with the violation_log_auto_purge property of a FirewallConfigDetails.
    #: This constant has a value of "ENABLED"
    ...
    #: A constant which can be used with the exclude_job property of a FirewallConfigDetails.
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new FirewallConfigDetails object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param status:
            The value to assign to the status property of this FirewallConfigDetails.
            Allowed values for this property are: "ENABLED", "DISABLED"
        :type status: str

        :param violation_log_auto_purge:
            The value to assign to the violation_log_auto_purge property of this FirewallConfigDetails.
            Allowed values for this property are: "ENABLED", "DISABLED"
        :type violation_log_auto_purge: str

        :param exclude_job:
            The value to assign to the exclude_job property of this FirewallConfigDetails.
    ...
    def status(self):
        """
        Gets the status of this FirewallConfigDetails.
        Specifies whether the firewall is enabled or disabled.

        Allowed values for this property are: "ENABLED", "DISABLED"


        :return: The status of this FirewallConfigDetails.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """
        Sets the status of this FirewallConfigDetails.
        Specifies whether the firewall is enabled or disabled.


        :param status: The status of this FirewallConfigDetails.
        :type: str
        """
    ...
    def violation_log_auto_purge(self):
        """
        Gets the violation_log_auto_purge of this FirewallConfigDetails.
        ...
        :return: The violation_log_auto_purge of this FirewallConfigDetails.
        :rtype: str
        """
    ...
    def violation_log_auto_purge(self, violation_log_auto_purge):
        """
        Sets the violation_log_auto_purge of this FirewallConfigDetails.
        Specifies whether Data Safe should automatically purge the violation logs
        from the database after collecting the violation logs and persisting them in Data Safe.


        :param violation_log_auto_purge: The violation_log_auto_purge of this FirewallConfigDetails.
        :type: str
        """
        allowed_values = ["ENABLED", "DISABLED"]
    ...
    def exclude_job(self):
        """
        Gets the exclude_job of this FirewallConfigDetails.
        Specifies whether the firewall should include or exclude the database internal job activities.

        Allowed values for this property are: "EXCLUDED", "INCLUDED"


        :return: The exclude_job of this FirewallConfigDetails.
        :rtype: str
        """
    ...
    def exclude_job(self, exclude_job):
        """
        Sets the exclude_job of this FirewallConfigDetails.
        Specifies whether the firewall should include or exclude the database internal job activities.


        :param exclude_job: The exclude_job of this FirewallConfigDetails.
        :type: str
        """
