...
class PatchFindingsDetails(object):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new PatchFindingsDetails object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param items:
            The value to assign to the items property of this PatchFindingsDetails.
    ...
    def items(self):
        ...
        :return: The items of this PatchFindingsDetails.
    ...
    def items(self, items):
        """
        Sets the items of this PatchFindingsDetails.
        An array of patch instructions.


        :param items: The items of this PatchFindingsDetails.
