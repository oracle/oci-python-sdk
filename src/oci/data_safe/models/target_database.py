...
class TargetDatabase(object):
    ...
    def __init__(self, **kwargs):
        ...
        self._redacted_field_paths = [
            ...
            ['tls_config', 'store_password'],
            ['peer_target_databases', '*', 'tls_config', 'store_password'],
        ]
    ...
    def __repr__(self):
        ...
        redact_password_field(as_dict, ['tls_config', 'store_password'])
        redact_password_field(as_dict, ['peer_target_databases', '*', 'tls_config', 'store_password'])
