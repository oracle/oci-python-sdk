...
class UserAssessment(object):
    ...
    def __init__(self, **kwargs):
        ...
        :param time_last_assessed:
            The value to assign to the time_last_assessed property of this UserAssessment.
    ...
    def time_last_assessed(self):
        """
        Gets the time_last_assessed of this UserAssessment.
        The date and time the user assessment was last run, in the format defined by `RFC3339`__.

        __ https://tools.ietf.org/html/rfc3339


        :return: The time_last_assessed of this UserAssessment.
        :rtype: datetime
        """
    ...
    def time_last_assessed(self, time_last_assessed):
        """
        Sets the time_last_assessed of this UserAssessment.
        The date and time the user assessment was last run, in the format defined by `RFC3339`__.

        __ https://tools.ietf.org/html/rfc3339


        :param time_last_assessed: The time_last_assessed of this UserAssessment.
        :type: datetime
        """
