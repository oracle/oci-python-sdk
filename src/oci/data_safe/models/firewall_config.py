...
class FirewallConfig(object):
    ...
    #: A constant which can be used with the status property of a FirewallConfig.
    ...
    #: A constant which can be used with the violation_log_auto_purge property of a FirewallConfig.
    #: This constant has a value of "ENABLED"
    ...
    #: A constant which can be used with the exclude_job property of a FirewallConfig.
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new FirewallConfig object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param status:
            The value to assign to the status property of this FirewallConfig.
            Allowed values for this property are: "ENABLED", "DISABLED", 'UNKNOWN_ENUM_VALUE'.
            Any unrecognized values returned by a service will be mapped to 'UNKNOWN_ENUM_VALUE'.
        :type status: str

        :param violation_log_auto_purge:
            The value to assign to the violation_log_auto_purge property of this FirewallConfig.
            Allowed values for this property are: "ENABLED", "DISABLED", 'UNKNOWN_ENUM_VALUE'.
            Any unrecognized values returned by a service will be mapped to 'UNKNOWN_ENUM_VALUE'.
        :type violation_log_auto_purge: str

        :param exclude_job:
            The value to assign to the exclude_job property of this FirewallConfig.
            Allowed values for this property are: "EXCLUDED", "INCLUDED", 'UNKNOWN_ENUM_VALUE'.
            Any unrecognized values returned by a service will be mapped to 'UNKNOWN_ENUM_VALUE'.
        :type exclude_job: str

        :param time_status_updated:
            The value to assign to the time_status_updated property of this FirewallConfig.
    ...
    def status(self):
        """
        **[Required]** Gets the status of this FirewallConfig.
        ...
        :return: The status of this FirewallConfig.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """
        Sets the status of this FirewallConfig.
        Specifies if the firewall is enabled or disabled.


        :param status: The status of this FirewallConfig.
        :type: str
        """
    ...
    def violation_log_auto_purge(self):
        """
        **[Required]** Gets the violation_log_auto_purge of this FirewallConfig.
        ...
        :return: The violation_log_auto_purge of this FirewallConfig.
        :rtype: str
        """
    ...
    def violation_log_auto_purge(self, violation_log_auto_purge):
        """
        Sets the violation_log_auto_purge of this FirewallConfig.
        Specifies whether Data Safe should automatically purge the violation logs
        from the database after collecting the violation logs and persisting on Data Safe.


        :param violation_log_auto_purge: The violation_log_auto_purge of this FirewallConfig.
        :type: str
        """
        allowed_values = ["ENABLED", "DISABLED"]
    ...
    def exclude_job(self):
        """
        Gets the exclude_job of this FirewallConfig.
        ...
        :return: The exclude_job of this FirewallConfig.
        :rtype: str
        """
    ...
    def exclude_job(self, exclude_job):
        """
        Sets the exclude_job of this FirewallConfig.
        Specifies whether the firewall should include or exclude the database internal job activities.


        :param exclude_job: The exclude_job of this FirewallConfig.
        :type: str
        """
    ...
    def time_status_updated(self):
        """
        Gets the time_status_updated of this FirewallConfig.
        The date and time the firewall configuration was last updated, in the format defined by RFC3339.


        :return: The time_status_updated of this FirewallConfig.
        :rtype: datetime
        """
    ...
    def time_status_updated(self, time_status_updated):
        """
        Sets the time_status_updated of this FirewallConfig.
        The date and time the firewall configuration was last updated, in the format defined by RFC3339.


        :param time_status_updated: The time_status_updated of this FirewallConfig.
        :type: datetime
        """
