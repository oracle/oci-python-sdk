...
class MaskDataDetails(object):
    ...
    def __repr__(self):
        ...
        redact_password_field(as_dict, ['seed'])
        redact_password_field(as_dict, ['user_defined_function_seed'])
        redact_password_field(as_dict, ['target_credentials', 'password'])
