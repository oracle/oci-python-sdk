...
class UpdateSensitiveDataModelDetails(object):
    ...
    def __init__(self, **kwargs):
        ...
        :param tables_for_discovery:
            The value to assign to the tables_for_discovery property of this UpdateSensitiveDataModelDetails.
    ...
    def tables_for_discovery(self):
        """
        Gets the tables_for_discovery of this UpdateSensitiveDataModelDetails.
        ...
        :return: The tables_for_discovery of this UpdateSensitiveDataModelDetails.
    ...
    def tables_for_discovery(self, tables_for_discovery):
        """
        Sets the tables_for_discovery of this UpdateSensitiveDataModelDetails.
        The data discovery jobs will scan the tables specified here, including both schemas and tables.
        For instance, the input could be in the format: [{schemaName: \"HR\", tableName: [\"T1\", \"T2\"]}, {schemaName:
        \"OE\", tableName : [\"T3\", \"T4\"]}].


        :param tables_for_discovery: The tables_for_discovery of this UpdateSensitiveDataModelDetails.
