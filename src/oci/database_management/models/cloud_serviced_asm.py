...
class CloudServicedAsm(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new CloudServicedAsm object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param id:
            The value to assign to the id property of this CloudServicedAsm.
        :type id: str

        :param display_name:
            The value to assign to the display_name property of this CloudServicedAsm.
        :type display_name: str

        :param compartment_id:
            The value to assign to the compartment_id property of this CloudServicedAsm.
    ...
    def display_name(self):
        """
        **[Required]** Gets the display_name of this CloudServicedAsm.
        The user-friendly name for the cloud ASM. The name does not have to be unique.


        :return: The display_name of this CloudServicedAsm.
        :rtype: str
        """
    ...
    def display_name(self, display_name):
        """
        Sets the display_name of this CloudServicedAsm.
        The user-friendly name for the cloud ASM. The name does not have to be unique.


        :param display_name: The display_name of this CloudServicedAsm.
        :type: str
        """
