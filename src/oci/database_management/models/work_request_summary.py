...
class WorkRequestSummary(object):
    ...
    #: This constant has a value of "CREATE_DB_MANAGEMENT_PRIVATE_ENDPOINT"
    OPERATION_TYPE_CREATE_DB_MANAGEMENT_PRIVATE_ENDPOINT = "CREATE_DB_MANAGEMENT_PRIVATE_ENDPOINT"
    ...
    def __init__(self, **kwargs):
        ...
        :type resources: list[oci.database_management.models.WorkRequestResource]
    ...
    def resources(self):
        ...
        **[Required]** Gets the resources of this WorkRequestSummary.
        ...
        :rtype: list[oci.database_management.models.WorkRequestResource]
        """
    ...
    def resources(self, resources):
        ...
        :type: list[oci.database_management.models.WorkRequestResource]
        """
