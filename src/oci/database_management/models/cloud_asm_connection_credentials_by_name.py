...
class CloudAsmConnectionCredentialsByName(CloudAsmConnectionCredentials):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new CloudAsmConnectionCredentialsByName object with values from keyword arguments. The default value of the :py:attr:`~oci.database_management.models.CloudAsmConnectionCredentialsByName.credential_type` attribute
        of this class is ``NAME_REFERENCE`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param credential_type:
            The value to assign to the credential_type property of this CloudAsmConnectionCredentialsByName.
            Allowed values for this property are: "NAME_REFERENCE", "DETAILS"
        :type credential_type: str

        :param credential_name:
            The value to assign to the credential_name property of this CloudAsmConnectionCredentialsByName.
    ...
    def credential_name(self):
        """
        **[Required]** Gets the credential_name of this CloudAsmConnectionCredentialsByName.
        ...
        *IMPORTANT* - The name must be unique within the OCI region the credential is being created in.
        ...
        :return: The credential_name of this CloudAsmConnectionCredentialsByName.
        :rtype: str
        """
    ...
    def credential_name(self, credential_name):
        """
        Sets the credential_name of this CloudAsmConnectionCredentialsByName.
        The name of the credential information that used to connect to the DB system resource.
        The name should be in \"x.y\" format, where the length of \"x\" has a maximum of 64 characters,
        and length of \"y\" has a maximum of 199 characters. The name strings can contain letters,
        numbers and the underscore character only. Other characters are not valid, except for
        ...
        *IMPORTANT* - The name must be unique within the OCI region the credential is being created in.
        ...
        :param credential_name: The credential_name of this CloudAsmConnectionCredentialsByName.
        :type: str
        """
