...
class CloudExadataInfrastructureSummary(DbmResource):
    """
    The Exadata infrastructure.
    """

    #: A constant which can be used with the rack_size property of a CloudExadataInfrastructureSummary.
    ...
    #: A constant which can be used with the infrastructure_type property of a CloudExadataInfrastructureSummary.
    #: This constant has a value of "EXADATA"
    INFRASTRUCTURE_TYPE_EXADATA = "EXADATA"

    #: A constant which can be used with the infrastructure_type property of a CloudExadataInfrastructureSummary.
    #: This constant has a value of "EXADATA_CC"
    INFRASTRUCTURE_TYPE_EXADATA_CC = "EXADATA_CC"

    #: A constant which can be used with the license_model property of a CloudExadataInfrastructureSummary.
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new CloudExadataInfrastructureSummary object with values from keyword arguments. The default value of the :py:attr:`~oci.database_management.models.CloudExadataInfrastructureSummary.resource_type` attribute
        of this class is ``CLOUD_INFRASTRUCTURE_SUMMARY`` and it should not be changed.
        ...
        :param version:
            The value to assign to the version property of this CloudExadataInfrastructureSummary.
        :type version: str

        :param internal_id:
            The value to assign to the internal_id property of this CloudExadataInfrastructureSummary.
        :type internal_id: str

        :param status:
            The value to assign to the status property of this CloudExadataInfrastructureSummary.
        :type status: str
        ...
        :param time_updated:
            The value to assign to the time_updated property of this CloudExadataInfrastructureSummary.
        ...
        :param additional_details:
            The value to assign to the additional_details property of this CloudExadataInfrastructureSummary.
        :type additional_details: dict(str, str)

        :param resource_type:
            The value to assign to the resource_type property of this CloudExadataInfrastructureSummary.
        ...
        :param rack_size:
            The value to assign to the rack_size property of this CloudExadataInfrastructureSummary.
            Allowed values for this property are: "FULL", "HALF", "QUARTER", "EIGHTH", 'UNKNOWN_ENUM_VALUE'.
            Any unrecognized values returned by a service will be mapped to 'UNKNOWN_ENUM_VALUE'.
        :type rack_size: str

        :param infrastructure_type:
            The value to assign to the infrastructure_type property of this CloudExadataInfrastructureSummary.
        ...
        :param license_model:
            The value to assign to the license_model property of this CloudExadataInfrastructureSummary.
            Allowed values for this property are: "LICENSE_INCLUDED", "BRING_YOUR_OWN_LICENSE", 'UNKNOWN_ENUM_VALUE'.
            Any unrecognized values returned by a service will be mapped to 'UNKNOWN_ENUM_VALUE'.
        :type license_model: str

        :param grid_home_path:
            The value to assign to the grid_home_path property of this CloudExadataInfrastructureSummary.
        ...
        :param system_tags:
            The value to assign to the system_tags property of this CloudExadataInfrastructureSummary.
        ...
        self._resource_type = 'CLOUD_INFRASTRUCTURE_SUMMARY'

    @property
    def rack_size(self):
        """
        Gets the rack_size of this CloudExadataInfrastructureSummary.
        ...
        :return: The rack_size of this CloudExadataInfrastructureSummary.
        :rtype: str
        """
    ...
    def rack_size(self, rack_size):
        """
        Sets the rack_size of this CloudExadataInfrastructureSummary.
        The rack size of the Exadata infrastructure.


        :param rack_size: The rack_size of this CloudExadataInfrastructureSummary.
        :type: str
        """
    ...
    def infrastructure_type(self):
        """
        Gets the infrastructure_type of this CloudExadataInfrastructureSummary.
        ...
        :return: The infrastructure_type of this CloudExadataInfrastructureSummary.
        :rtype: str
        """
    ...
    def infrastructure_type(self, infrastructure_type):
        """
        Sets the infrastructure_type of this CloudExadataInfrastructureSummary.
        The type of the Exadata infrastructure.


        :param infrastructure_type: The infrastructure_type of this CloudExadataInfrastructureSummary.
        :type: str
        """
    ...
    def license_model(self):
        """
        Gets the license_model of this CloudExadataInfrastructureSummary.
        ...
        :return: The license_model of this CloudExadataInfrastructureSummary.
        :rtype: str
        """
    ...
    def license_model(self, license_model):
        """
        Sets the license_model of this CloudExadataInfrastructureSummary.
        The Oracle license model that applies to the database management resources.


        :param license_model: The license_model of this CloudExadataInfrastructureSummary.
        :type: str
        """
    ...
    def grid_home_path(self):
        """
        Gets the grid_home_path of this CloudExadataInfrastructureSummary.
        The Oracle grid home path.


        :return: The grid_home_path of this CloudExadataInfrastructureSummary.
        :rtype: str
        """
    ...
    def grid_home_path(self, grid_home_path):
        """
        Sets the grid_home_path of this CloudExadataInfrastructureSummary.
        The Oracle grid home path.


        :param grid_home_path: The grid_home_path of this CloudExadataInfrastructureSummary.
        :type: str
        """
    ...
    def system_tags(self):
        ...
        :return: The system_tags of this CloudExadataInfrastructureSummary.
        :rtype: dict(str, dict(str, object))
        """
    ...
    def system_tags(self, system_tags):
        """
        Sets the system_tags of this CloudExadataInfrastructureSummary.
        System tags for this resource. Each key is predefined and scoped to a namespace.
        For more information, see `Resource Tags`__.
        System tags can be viewed by users, but can only be created by the system.
        ...
        :param system_tags: The system_tags of this CloudExadataInfrastructureSummary.
        :type: dict(str, dict(str, object))
        """
