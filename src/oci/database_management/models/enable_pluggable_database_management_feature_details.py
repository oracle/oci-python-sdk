...
class EnablePluggableDatabaseManagementFeatureDetails(object):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new EnablePluggableDatabaseManagementFeatureDetails object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param feature_details:
            The value to assign to the feature_details property of this EnablePluggableDatabaseManagementFeatureDetails.
    ...
    def feature_details(self):
        ...
        **[Required]** Gets the feature_details of this EnablePluggableDatabaseManagementFeatureDetails.
        ...
        :return: The feature_details of this EnablePluggableDatabaseManagementFeatureDetails.
    ...
    def feature_details(self, feature_details):
        """
        Sets the feature_details of this EnablePluggableDatabaseManagementFeatureDetails.

        :param feature_details: The feature_details of this EnablePluggableDatabaseManagementFeatureDetails.
