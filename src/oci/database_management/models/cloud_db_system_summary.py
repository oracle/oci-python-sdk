...
class CloudDbSystemSummary(object):
    """
    The summary of a cloud DB system.
    """

    #: A constant which can be used with the deployment_type property of a CloudDbSystemSummary.
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new CloudDbSystemSummary object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param id:
            The value to assign to the id property of this CloudDbSystemSummary.
        :type id: str

        :param dbaas_parent_infrastructure_id:
            The value to assign to the dbaas_parent_infrastructure_id property of this CloudDbSystemSummary.
        :type dbaas_parent_infrastructure_id: str

        :param deployment_type:
            The value to assign to the deployment_type property of this CloudDbSystemSummary.
            Allowed values for this property are: "VM", "EXADATA", "EXADATA_CC", "EXADATA_XS", 'UNKNOWN_ENUM_VALUE'.
            Any unrecognized values returned by a service will be mapped to 'UNKNOWN_ENUM_VALUE'.
        :type deployment_type: str

        :param display_name:
            The value to assign to the display_name property of this CloudDbSystemSummary.
        :type display_name: str

        :param compartment_id:
            The value to assign to the compartment_id property of this CloudDbSystemSummary.
        :type compartment_id: str

        :param home_directory:
            The value to assign to the home_directory property of this CloudDbSystemSummary.
        :type home_directory: str

        :param database_management_config:
            The value to assign to the database_management_config property of this CloudDbSystemSummary.
        :type database_management_config: oci.database_management.models.CloudDbSystemDatabaseManagementConfigDetails

        :param lifecycle_state:
            The value to assign to the lifecycle_state property of this CloudDbSystemSummary.
        :type lifecycle_state: str

        :param lifecycle_details:
            The value to assign to the lifecycle_details property of this CloudDbSystemSummary.
        :type lifecycle_details: str

        :param time_created:
            The value to assign to the time_created property of this CloudDbSystemSummary.
        :type time_created: datetime

        :param time_updated:
            The value to assign to the time_updated property of this CloudDbSystemSummary.
        :type time_updated: datetime

        :param freeform_tags:
            The value to assign to the freeform_tags property of this CloudDbSystemSummary.
        :type freeform_tags: dict(str, str)

        :param defined_tags:
            The value to assign to the defined_tags property of this CloudDbSystemSummary.
        :type defined_tags: dict(str, dict(str, object))

        :param system_tags:
            The value to assign to the system_tags property of this CloudDbSystemSummary.
    ...
    def deployment_type(self):
        ...
        **[Required]** Gets the deployment_type of this CloudDbSystemSummary.
        ...
        :return: The deployment_type of this CloudDbSystemSummary.
        :rtype: str
        """
    ...
    def display_name(self):
        """
        **[Required]** Gets the display_name of this CloudDbSystemSummary.
        The user-friendly name for the DB system. The name does not have to be unique.


        :return: The display_name of this CloudDbSystemSummary.
        :rtype: str
        """
    ...
    def display_name(self, display_name):
        """
        Sets the display_name of this CloudDbSystemSummary.
        The user-friendly name for the DB system. The name does not have to be unique.


        :param display_name: The display_name of this CloudDbSystemSummary.
        :type: str
        """
    ...
    def home_directory(self):
        """
        Gets the home_directory of this CloudDbSystemSummary.
        ...
        :return: The home_directory of this CloudDbSystemSummary.
        :rtype: str
        """
    ...
    def home_directory(self, home_directory):
        """
        Sets the home_directory of this CloudDbSystemSummary.
        The Oracle Grid home directory in case of cluster-based DB system and
        Oracle home directory in case of single instance-based DB system.


        :param home_directory: The home_directory of this CloudDbSystemSummary.
        :type: str
        """
    ...
    def database_management_config(self):
        """
        Gets the database_management_config of this CloudDbSystemSummary.

        :return: The database_management_config of this CloudDbSystemSummary.
    ...
    def database_management_config(self, database_management_config):
        """
        Sets the database_management_config of this CloudDbSystemSummary.

        :param database_management_config: The database_management_config of this CloudDbSystemSummary.
    ...
    def lifecycle_state(self):
        """
        **[Required]** Gets the lifecycle_state of this CloudDbSystemSummary.
        The current lifecycle state of the cloud DB system resource.


        :return: The lifecycle_state of this CloudDbSystemSummary.
        :rtype: str
        """
    ...
    def lifecycle_state(self, lifecycle_state):
        """
        Sets the lifecycle_state of this CloudDbSystemSummary.
        The current lifecycle state of the cloud DB system resource.


        :param lifecycle_state: The lifecycle_state of this CloudDbSystemSummary.
        :type: str
        """
    ...
    def lifecycle_details(self):
        """
        Gets the lifecycle_details of this CloudDbSystemSummary.
        Additional information about the current lifecycle state.


        :return: The lifecycle_details of this CloudDbSystemSummary.
        :rtype: str
        """
    ...
    def lifecycle_details(self, lifecycle_details):
        """
        Sets the lifecycle_details of this CloudDbSystemSummary.
        Additional information about the current lifecycle state.


        :param lifecycle_details: The lifecycle_details of this CloudDbSystemSummary.
        :type: str
        """
    ...
    def time_created(self):
        """
        **[Required]** Gets the time_created of this CloudDbSystemSummary.
        The date and time the cloud DB system was created.


        :return: The time_created of this CloudDbSystemSummary.
        :rtype: datetime
        """
    ...
    def time_created(self, time_created):
        """
        Sets the time_created of this CloudDbSystemSummary.
        The date and time the cloud DB system was created.


        :param time_created: The time_created of this CloudDbSystemSummary.
        :type: datetime
        """
    ...
    def time_updated(self):
        """
        **[Required]** Gets the time_updated of this CloudDbSystemSummary.
        The date and time the cloud DB system was last updated.


        :return: The time_updated of this CloudDbSystemSummary.
        :rtype: datetime
        """
    ...
    def time_updated(self, time_updated):
        """
        Sets the time_updated of this CloudDbSystemSummary.
        The date and time the cloud DB system was last updated.


        :param time_updated: The time_updated of this CloudDbSystemSummary.
        :type: datetime
        """
    ...
    def freeform_tags(self):
        """
        Gets the freeform_tags of this CloudDbSystemSummary.
    ...
    def freeform_tags(self, freeform_tags):
        """
        Sets the freeform_tags of this CloudDbSystemSummary.
        Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace.
        For more information, see `Resource Tags`__.
        Example: `{\"Department\": \"Finance\"}`
    ...
    def defined_tags(self):
        """
        Gets the defined_tags of this CloudDbSystemSummary.
    ...
    def defined_tags(self, defined_tags):
        """
        Sets the defined_tags of this CloudDbSystemSummary.
        Defined tags for this resource. Each key is predefined and scoped to a namespace.
        For more information, see `Resource Tags`__.
        Example: `{\"Operations\": {\"CostCenter\": \"42\"}}`
    ...
    def system_tags(self):
        """
        Gets the system_tags of this CloudDbSystemSummary.
    ...
    def system_tags(self, system_tags):
        """
        Sets the system_tags of this CloudDbSystemSummary.
        System tags for this resource. Each key is predefined and scoped to a namespace.
        For more information, see `Resource Tags`__.
        System tags can be viewed by users, but can only be created by the system.
