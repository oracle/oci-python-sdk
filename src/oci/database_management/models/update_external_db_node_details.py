...
class UpdateExternalDbNodeDetails(object):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new UpdateExternalDbNodeDetails object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param external_connector_id:
            The value to assign to the external_connector_id property of this UpdateExternalDbNodeDetails.
