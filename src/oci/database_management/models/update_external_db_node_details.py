...
class UpdateExternalDbNodeDetails(object):
    ...
    def __init__(self, **kwargs):
        ...
        :param freeform_tags:
            The value to assign to the freeform_tags property of this UpdateExternalDbNodeDetails.
        :type freeform_tags: dict(str, str)

        :param defined_tags:
            The value to assign to the defined_tags property of this UpdateExternalDbNodeDetails.
    ...
    def freeform_tags(self, freeform_tags):
        """
        Sets the freeform_tags of this UpdateExternalDbNodeDetails.
        Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace.
        For more information, see `Resource Tags`__.
        Example: `{\"Department\": \"Finance\"}`
    ...
    def defined_tags(self):
        """
        Gets the defined_tags of this UpdateExternalDbNodeDetails.
    ...
    def defined_tags(self, defined_tags):
        """
        Sets the defined_tags of this UpdateExternalDbNodeDetails.
        Defined tags for this resource. Each key is predefined and scoped to a namespace.
        For more information, see `Resource Tags`__.
        Example: `{\"Operations\": {\"CostCenter\": \"42\"}}`
