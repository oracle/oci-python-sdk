...
class CloudAsmInstanceParameters(object):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new CloudAsmInstanceParameters object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param asm_instance_id:
            The value to assign to the asm_instance_id property of this CloudAsmInstanceParameters.
        :type asm_instance_id: str

        :param asm_instance_display_name:
            The value to assign to the asm_instance_display_name property of this CloudAsmInstanceParameters.
        :type asm_instance_display_name: str

        :param disk_discovery_path:
            The value to assign to the disk_discovery_path property of this CloudAsmInstanceParameters.
        :type disk_discovery_path: str

        :param auto_mount_disk_groups:
            The value to assign to the auto_mount_disk_groups property of this CloudAsmInstanceParameters.
        :type auto_mount_disk_groups: list[str]

        :param rebalance_power:
            The value to assign to the rebalance_power property of this CloudAsmInstanceParameters.
        :type rebalance_power: int

        :param preferred_read_failure_groups:
            The value to assign to the preferred_read_failure_groups property of this CloudAsmInstanceParameters.
    ...
    def asm_instance_display_name(self):
        """
        **[Required]** Gets the asm_instance_display_name of this CloudAsmInstanceParameters.
        The user-friendly name for the ASM instance. The name does not have to be unique.


        :return: The asm_instance_display_name of this CloudAsmInstanceParameters.
        :rtype: str
        """
    ...
    def asm_instance_display_name(self, asm_instance_display_name):
        """
        Sets the asm_instance_display_name of this CloudAsmInstanceParameters.
        The user-friendly name for the ASM instance. The name does not have to be unique.


        :param asm_instance_display_name: The asm_instance_display_name of this CloudAsmInstanceParameters.
        :type: str
        """
    ...
    def disk_discovery_path(self):
        """
        **[Required]** Gets the disk_discovery_path of this CloudAsmInstanceParameters.
        An operating system-dependent value used to limit the set of disks considered for discovery.


        :return: The disk_discovery_path of this CloudAsmInstanceParameters.
        :rtype: str
        """
    ...
    def disk_discovery_path(self, disk_discovery_path):
        """
        Sets the disk_discovery_path of this CloudAsmInstanceParameters.
        An operating system-dependent value used to limit the set of disks considered for discovery.


        :param disk_discovery_path: The disk_discovery_path of this CloudAsmInstanceParameters.
        :type: str
        """
    ...
    def auto_mount_disk_groups(self):
        """
        **[Required]** Gets the auto_mount_disk_groups of this CloudAsmInstanceParameters.
        ...
        :return: The auto_mount_disk_groups of this CloudAsmInstanceParameters.
        :rtype: list[str]
        """
    ...
    def auto_mount_disk_groups(self, auto_mount_disk_groups):
        """
        Sets the auto_mount_disk_groups of this CloudAsmInstanceParameters.
        The list of disk group names that an ASM instance mounts at startup or when the `ALTER DISKGROUP ALL MOUNT` statement is issued.


        :param auto_mount_disk_groups: The auto_mount_disk_groups of this CloudAsmInstanceParameters.
        :type: list[str]
        """
    ...
    def rebalance_power(self):
        ...
        **[Required]** Gets the rebalance_power of this CloudAsmInstanceParameters.
        ...
        :return: The rebalance_power of this CloudAsmInstanceParameters.
        :rtype: int
        """
    ...
    def rebalance_power(self, rebalance_power):
        """
        Sets the rebalance_power of this CloudAsmInstanceParameters.
        The maximum power on an ASM instance for disk rebalancing.


        :param rebalance_power: The rebalance_power of this CloudAsmInstanceParameters.
        :type: int
        """
    ...
    def preferred_read_failure_groups(self):
        """
        **[Required]** Gets the preferred_read_failure_groups of this CloudAsmInstanceParameters.
        The list of failure groups that contain preferred read disks.


        :return: The preferred_read_failure_groups of this CloudAsmInstanceParameters.
        :rtype: list[str]
        """
    ...
    def preferred_read_failure_groups(self, preferred_read_failure_groups):
        """
        Sets the preferred_read_failure_groups of this CloudAsmInstanceParameters.
        The list of failure groups that contain preferred read disks.


        :param preferred_read_failure_groups: The preferred_read_failure_groups of this CloudAsmInstanceParameters.
        :type: list[str]
        """
