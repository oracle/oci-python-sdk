...
class CreateExternalExadataStorageConnectorDetails(object):
    ...
    def __init__(self, **kwargs):
        ...
        self._redacted_field_paths = [
            ...
            ['credential_info', 'ssl_trust_store_password'],
        ]
    ...
    def __repr__(self):
        ...
        redact_password_field(as_dict, ['credential_info', 'password'])
        redact_password_field(as_dict, ['credential_info', 'ssl_trust_store_password'])
