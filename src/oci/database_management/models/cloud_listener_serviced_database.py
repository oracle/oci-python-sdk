...
class CloudListenerServicedDatabase(object):
    """
    The details of a database serviced by a cloud listener.
    """

    #: A constant which can be used with the database_type property of a CloudListenerServicedDatabase.
    ...
    #: A constant which can be used with the database_sub_type property of a CloudListenerServicedDatabase.
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new CloudListenerServicedDatabase object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param id:
            The value to assign to the id property of this CloudListenerServicedDatabase.
        :type id: str

        :param dbaas_id:
            The value to assign to the dbaas_id property of this CloudListenerServicedDatabase.
        :type dbaas_id: str

        :param display_name:
            The value to assign to the display_name property of this CloudListenerServicedDatabase.
        :type display_name: str

        :param db_unique_name:
            The value to assign to the db_unique_name property of this CloudListenerServicedDatabase.
        :type db_unique_name: str

        :param compartment_id:
            The value to assign to the compartment_id property of this CloudListenerServicedDatabase.
        :type compartment_id: str

        :param database_type:
            The value to assign to the database_type property of this CloudListenerServicedDatabase.
        ...
        :param database_sub_type:
            The value to assign to the database_sub_type property of this CloudListenerServicedDatabase.
            Allowed values for this property are: "CDB", "PDB", "NON_CDB", "ACD", "ADB", 'UNKNOWN_ENUM_VALUE'.
            Any unrecognized values returned by a service will be mapped to 'UNKNOWN_ENUM_VALUE'.
        :type database_sub_type: str

        :param is_managed:
            The value to assign to the is_managed property of this CloudListenerServicedDatabase.
    ...
    def display_name(self):
        """
        **[Required]** Gets the display_name of this CloudListenerServicedDatabase.
        The user-friendly name for the database. The name does not have to be unique.


        :return: The display_name of this CloudListenerServicedDatabase.
        :rtype: str
        """
    ...
    def display_name(self, display_name):
        """
        Sets the display_name of this CloudListenerServicedDatabase.
        The user-friendly name for the database. The name does not have to be unique.


        :param display_name: The display_name of this CloudListenerServicedDatabase.
        :type: str
        """
    ...
    def db_unique_name(self):
        """
        Gets the db_unique_name of this CloudListenerServicedDatabase.
        The unique name of the cloud database.


        :return: The db_unique_name of this CloudListenerServicedDatabase.
        :rtype: str
        """
    ...
    def db_unique_name(self, db_unique_name):
        """
        Sets the db_unique_name of this CloudListenerServicedDatabase.
        The unique name of the cloud database.


        :param db_unique_name: The db_unique_name of this CloudListenerServicedDatabase.
        :type: str
        """
    ...
    def database_type(self):
        """
        Gets the database_type of this CloudListenerServicedDatabase.
        ...
        :return: The database_type of this CloudListenerServicedDatabase.
        :rtype: str
        """
    ...
    def database_type(self, database_type):
        """
        Sets the database_type of this CloudListenerServicedDatabase.
        The type of Oracle Database installation.


        :param database_type: The database_type of this CloudListenerServicedDatabase.
        :type: str
        """
    ...
    def database_sub_type(self):
        """
        Gets the database_sub_type of this CloudListenerServicedDatabase.
        ...
        :return: The database_sub_type of this CloudListenerServicedDatabase.
        :rtype: str
        """
    ...
    def database_sub_type(self, database_sub_type):
        """
        Sets the database_sub_type of this CloudListenerServicedDatabase.
        The subtype of Oracle Database. Indicates whether the database is a Container Database,
        Pluggable Database, Non-container Database, Autonomous Database, or Autonomous Container Database.


        :param database_sub_type: The database_sub_type of this CloudListenerServicedDatabase.
        :type: str
        """
    ...
    def is_managed(self):
        """
        Gets the is_managed of this CloudListenerServicedDatabase.
        Indicates whether the database is a Managed Database or not.


        :return: The is_managed of this CloudListenerServicedDatabase.
        :rtype: bool
        """
    ...
    def is_managed(self, is_managed):
        """
        Sets the is_managed of this CloudListenerServicedDatabase.
        Indicates whether the database is a Managed Database or not.


        :param is_managed: The is_managed of this CloudListenerServicedDatabase.
        :type: bool
        """
