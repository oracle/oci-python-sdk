...
class ExternalExadataStorageServerCollection(object):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ExternalExadataStorageServerCollection object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param items:
            The value to assign to the items property of this ExternalExadataStorageServerCollection.
        :type items: list[oci.database_management.models.ExternalExadataStorageServerSummary]

        """
        self.swagger_types = {
            'items': 'list[ExternalExadataStorageServerSummary]'
        }
