...
class JobCollection(object):
    ...
    def __init__(self, **kwargs):
        ...
        :type items: list[oci.database_management.models.JobSummary]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this JobCollection.
        ...
        :rtype: list[oci.database_management.models.JobSummary]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.database_management.models.JobSummary]
        """
        self._items = items
