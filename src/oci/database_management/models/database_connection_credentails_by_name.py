...
class DatabaseConnectionCredentailsByName(DatabaseConnectionCredentials):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new DatabaseConnectionCredentailsByName object with values from keyword arguments. The default value of the :py:attr:`~oci.database_management.models.DatabaseConnectionCredentailsByName.credential_type` attribute
