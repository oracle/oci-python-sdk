...
class ExternalDbSystem(object):
    ...
    def __init__(self, **kwargs):
        ...
        :param freeform_tags:
            The value to assign to the freeform_tags property of this ExternalDbSystem.
        :type freeform_tags: dict(str, str)

        :param defined_tags:
            The value to assign to the defined_tags property of this ExternalDbSystem.
        :type defined_tags: dict(str, dict(str, object))

        :param system_tags:
            The value to assign to the system_tags property of this ExternalDbSystem.
    ...
    def freeform_tags(self):
        """
        Gets the freeform_tags of this ExternalDbSystem.
    ...
    def freeform_tags(self, freeform_tags):
        """
        Sets the freeform_tags of this ExternalDbSystem.
        Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace.
        For more information, see `Resource Tags`__.
        Example: `{\"Department\": \"Finance\"}`
    ...
    def defined_tags(self):
        """
        Gets the defined_tags of this ExternalDbSystem.
    ...
    def defined_tags(self, defined_tags):
        """
        Sets the defined_tags of this ExternalDbSystem.
        Defined tags for this resource. Each key is predefined and scoped to a namespace.
        For more information, see `Resource Tags`__.
        Example: `{\"Operations\": {\"CostCenter\": \"42\"}}`
    ...
    def system_tags(self):
        """
        Gets the system_tags of this ExternalDbSystem.
    ...
    def system_tags(self, system_tags):
        """
        Sets the system_tags of this ExternalDbSystem.
        System tags for this resource. Each key is predefined and scoped to a namespace.
        For more information, see `Resource Tags`__.
        System tags can be viewed by users, but can only be created by the system.
