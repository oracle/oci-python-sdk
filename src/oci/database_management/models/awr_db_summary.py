...
class AwrDbSummary(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new AwrDbSummary object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param awr_db_id:
            The value to assign to the awr_db_id property of this AwrDbSummary.
        :type awr_db_id: str
        ...
        :param time_db_startup:
            The value to assign to the time_db_startup property of this AwrDbSummary.
        :type time_db_startup: datetime

        :param time_first_snapshot_begin:
            The value to assign to the time_first_snapshot_begin property of this AwrDbSummary.
        :type time_first_snapshot_begin: datetime

        :param time_latest_snapshot_end:
            The value to assign to the time_latest_snapshot_end property of this AwrDbSummary.
        :type time_latest_snapshot_end: datetime

        :param first_snapshot_id:
            The value to assign to the first_snapshot_id property of this AwrDbSummary.
        :type first_snapshot_id: int

        :param latest_snapshot_id:
            The value to assign to the latest_snapshot_id property of this AwrDbSummary.
        :type latest_snapshot_id: int

        :param snapshot_count:
            The value to assign to the snapshot_count property of this AwrDbSummary.
        :type snapshot_count: int

        :param snapshot_interval_in_min:
            The value to assign to the snapshot_interval_in_min property of this AwrDbSummary.
        :type snapshot_interval_in_min: int

        :param container_id:
            The value to assign to the container_id property of this AwrDbSummary.
        :type container_id: int

        :param db_version:
            The value to assign to the db_version property of this AwrDbSummary.
        :type db_version: str

        :param snapshot_timezone:
            The value to assign to the snapshot_timezone property of this AwrDbSummary.
    ...
    def awr_db_id(self):
        """
        **[Required]** Gets the awr_db_id of this AwrDbSummary.
        ...
        :return: The awr_db_id of this AwrDbSummary.
        :rtype: str
        """
    ...
    def awr_db_id(self, awr_db_id):
        """
        Sets the awr_db_id of this AwrDbSummary.
        The internal ID of the database. The internal ID of the database is not the `OCID`__.
        It can be retrieved from the following endpoint:
        /managedDatabases/{managedDatabaseId}/awrDbs
        ...
        :param awr_db_id: The awr_db_id of this AwrDbSummary.
        :type: str
        """
    ...
    def db_name(self):
        """
        **[Required]** Gets the db_name of this AwrDbSummary.
        The name of the database.


        :return: The db_name of this AwrDbSummary.
        :rtype: str
        """
    ...
    def db_name(self, db_name):
        """
        Sets the db_name of this AwrDbSummary.
        The name of the database.


        :param db_name: The db_name of this AwrDbSummary.
        :type: str
        """
    ...
    def instance_list(self):
        """
        Gets the instance_list of this AwrDbSummary.
        The database instance numbers.


        :return: The instance_list of this AwrDbSummary.
        :rtype: list[int]
        """
    ...
    def instance_list(self, instance_list):
        """
        Sets the instance_list of this AwrDbSummary.
        The database instance numbers.


        :param instance_list: The instance_list of this AwrDbSummary.
        :type: list[int]
        """
    ...
    def time_db_startup(self):
        """
        Gets the time_db_startup of this AwrDbSummary.
        The timestamp of the database startup.


        :return: The time_db_startup of this AwrDbSummary.
        :rtype: datetime
        """
    ...
    def time_db_startup(self, time_db_startup):
        """
        Sets the time_db_startup of this AwrDbSummary.
        The timestamp of the database startup.


        :param time_db_startup: The time_db_startup of this AwrDbSummary.
        :type: datetime
        """
    ...
    def time_first_snapshot_begin(self):
        """
        Gets the time_first_snapshot_begin of this AwrDbSummary.
        The start time of the earliest snapshot.


        :return: The time_first_snapshot_begin of this AwrDbSummary.
        :rtype: datetime
        """
    ...
    def time_first_snapshot_begin(self, time_first_snapshot_begin):
        """
        Sets the time_first_snapshot_begin of this AwrDbSummary.
        The start time of the earliest snapshot.


        :param time_first_snapshot_begin: The time_first_snapshot_begin of this AwrDbSummary.
        :type: datetime
        """
    ...
    def time_latest_snapshot_end(self):
        """
        Gets the time_latest_snapshot_end of this AwrDbSummary.
        The end time of the latest snapshot.


        :return: The time_latest_snapshot_end of this AwrDbSummary.
        :rtype: datetime
        """
    ...
    def time_latest_snapshot_end(self, time_latest_snapshot_end):
        """
        Sets the time_latest_snapshot_end of this AwrDbSummary.
        The end time of the latest snapshot.


        :param time_latest_snapshot_end: The time_latest_snapshot_end of this AwrDbSummary.
        :type: datetime
        """
    ...
    def first_snapshot_id(self):
        """
        Gets the first_snapshot_id of this AwrDbSummary.
        ...
        :return: The first_snapshot_id of this AwrDbSummary.
        :rtype: int
        """
    ...
    def first_snapshot_id(self, first_snapshot_id):
        """
        Sets the first_snapshot_id of this AwrDbSummary.
        The ID of the earliest snapshot. The snapshot ID is not the `OCID`__.
        It can be retrieved from the following endpoint:
        /managedDatabases/{managedDatabaseId}/awrDbs/{awrDbId}/awrDbSnapshots
        ...
        :param first_snapshot_id: The first_snapshot_id of this AwrDbSummary.
        :type: int
        """
    ...
    def latest_snapshot_id(self):
        """
        Gets the latest_snapshot_id of this AwrDbSummary.
        ...
        :return: The latest_snapshot_id of this AwrDbSummary.
        :rtype: int
        """
    ...
    def latest_snapshot_id(self, latest_snapshot_id):
        """
        Sets the latest_snapshot_id of this AwrDbSummary.
        The ID of the latest snapshot. The snapshot ID is not the `OCID`__.
        It can be retrieved from the following endpoint:
        /managedDatabases/{managedDatabaseId}/awrDbs/{awrDbId}/awrDbSnapshots
        ...
        :param latest_snapshot_id: The latest_snapshot_id of this AwrDbSummary.
        :type: int
        """
    ...
    def snapshot_count(self):
        ...
        :return: The snapshot_count of this AwrDbSummary.
        :rtype: int
        """
    ...
    def snapshot_count(self, snapshot_count):
        """
        Sets the snapshot_count of this AwrDbSummary.
        The total number of snapshots.


        :param snapshot_count: The snapshot_count of this AwrDbSummary.
        :type: int
        """
    ...
    def snapshot_interval_in_min(self):
        """
        Gets the snapshot_interval_in_min of this AwrDbSummary.
        The interval time between snapshots (in minutes).


        :return: The snapshot_interval_in_min of this AwrDbSummary.
        :rtype: int
        """
    ...
    def snapshot_interval_in_min(self, snapshot_interval_in_min):
        """
        Sets the snapshot_interval_in_min of this AwrDbSummary.
        The interval time between snapshots (in minutes).


        :param snapshot_interval_in_min: The snapshot_interval_in_min of this AwrDbSummary.
        :type: int
        """
    ...
    def container_id(self):
        """
        Gets the container_id of this AwrDbSummary.
        ...
        :return: The container_id of this AwrDbSummary.
        :rtype: int
        """
    ...
    def container_id(self, container_id):
        """
        Sets the container_id of this AwrDbSummary.
        ID of the database container. The database container ID is not the `OCID`__.
        It can be retrieved from the following endpoint:
        /managedDatabases/{managedDatabaseId}/awrDbSnapshotRanges
        ...
        :param container_id: The container_id of this AwrDbSummary.
        :type: int
        """
    ...
    def db_version(self):
        """
        Gets the db_version of this AwrDbSummary.
        The version of the database.


        :return: The db_version of this AwrDbSummary.
        :rtype: str
        """
    ...
    def db_version(self, db_version):
        """
        Sets the db_version of this AwrDbSummary.
        The version of the database.


        :param db_version: The db_version of this AwrDbSummary.
        :type: str
        """
    ...
    def snapshot_timezone(self):
        """
        Gets the snapshot_timezone of this AwrDbSummary.
        The time zone of the snapshot.


        :return: The snapshot_timezone of this AwrDbSummary.
        :rtype: str
        """
    ...
    def snapshot_timezone(self, snapshot_timezone):
        """
        Sets the snapshot_timezone of this AwrDbSummary.
        The time zone of the snapshot.


        :param snapshot_timezone: The snapshot_timezone of this AwrDbSummary.
        :type: str
        """
