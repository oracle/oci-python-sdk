...
class AutonomousDatabaseSqlWatchFeatureDetails(AutonomousDatabaseFeatureDetails):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new AutonomousDatabaseSqlWatchFeatureDetails object with values from keyword arguments. The default value of the :py:attr:`~oci.database_management.models.AutonomousDatabaseSqlWatchFeatureDetails.feature` attribute
        of this class is ``SQLWATCH`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param feature:
            The value to assign to the feature property of this AutonomousDatabaseSqlWatchFeatureDetails.
        ...
        :param database_connection_details:
            The value to assign to the database_connection_details property of this AutonomousDatabaseSqlWatchFeatureDetails.
        :type database_connection_details: oci.database_management.models.DatabaseConnectionDetails

        :param connector_details:
            The value to assign to the connector_details property of this AutonomousDatabaseSqlWatchFeatureDetails.
