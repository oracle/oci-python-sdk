...
class ExternalExadataStorageConnector(DbmResource):
    ...
    def __init__(self, **kwargs):
        ...
        :param system_tags:
            The value to assign to the system_tags property of this ExternalExadataStorageConnector.
    ...
    def system_tags(self):
        """
        Gets the system_tags of this ExternalExadataStorageConnector.
    ...
    def system_tags(self, system_tags):
        """
        Sets the system_tags of this ExternalExadataStorageConnector.
        System tags for this resource. Each key is predefined and scoped to a namespace.
        For more information, see `Resource Tags`__.
        System tags can be viewed by users, but can only be created by the system.
