...
class CloudAsmConnectionCredentialsByDetails(CloudAsmConnectionCredentials):
    """
    The credentials used to connect to the ASM instance.
    """

    #: A constant which can be used with the role property of a CloudAsmConnectionCredentialsByDetails.
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new CloudAsmConnectionCredentialsByDetails object with values from keyword arguments. The default value of the :py:attr:`~oci.database_management.models.CloudAsmConnectionCredentialsByDetails.credential_type` attribute
        of this class is ``DETAILS`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param credential_type:
            The value to assign to the credential_type property of this CloudAsmConnectionCredentialsByDetails.
            Allowed values for this property are: "NAME_REFERENCE", "DETAILS", 'UNKNOWN_ENUM_VALUE'.
            Any unrecognized values returned by a service will be mapped to 'UNKNOWN_ENUM_VALUE'.
        :type credential_type: str

        :param credential_name:
            The value to assign to the credential_name property of this CloudAsmConnectionCredentialsByDetails.
        :type credential_name: str

        :param user_name:
            The value to assign to the user_name property of this CloudAsmConnectionCredentialsByDetails.
        :type user_name: str

        :param password_secret_id:
            The value to assign to the password_secret_id property of this CloudAsmConnectionCredentialsByDetails.
        :type password_secret_id: str

        :param role:
            The value to assign to the role property of this CloudAsmConnectionCredentialsByDetails.
    ...
    def credential_name(self):
        """
        Gets the credential_name of this CloudAsmConnectionCredentialsByDetails.
        ...
        *IMPORTANT* - The name must be unique within the OCI region the credential is being created in.
        ...
        :return: The credential_name of this CloudAsmConnectionCredentialsByDetails.
        :rtype: str
        """
    ...
    def credential_name(self, credential_name):
        """
        Sets the credential_name of this CloudAsmConnectionCredentialsByDetails.
        The name of the credential information that used to connect to the DB system resource.
        The name should be in \"x.y\" format, where the length of \"x\" has a maximum of 64 characters,
        and length of \"y\" has a maximum of 199 characters. The name strings can contain letters,
        numbers and the underscore character only. Other characters are not valid, except for
        ...
        *IMPORTANT* - The name must be unique within the OCI region the credential is being created in.
        ...
        :param credential_name: The credential_name of this CloudAsmConnectionCredentialsByDetails.
        :type: str
        """
    ...
    def user_name(self):
        """
        **[Required]** Gets the user_name of this CloudAsmConnectionCredentialsByDetails.
        The user name used to connect to the ASM instance.


        :return: The user_name of this CloudAsmConnectionCredentialsByDetails.
        :rtype: str
        """
    ...
    def user_name(self, user_name):
        """
        Sets the user_name of this CloudAsmConnectionCredentialsByDetails.
        The user name used to connect to the ASM instance.


        :param user_name: The user_name of this CloudAsmConnectionCredentialsByDetails.
        :type: str
        """
    ...
    def role(self):
        """
        **[Required]** Gets the role of this CloudAsmConnectionCredentialsByDetails.
        ...
        :return: The role of this CloudAsmConnectionCredentialsByDetails.
        :rtype: str
        """
        return self._role
    ...
    def role(self, role):
        """
        Sets the role of this CloudAsmConnectionCredentialsByDetails.
        The role of the user connecting to the ASM instance.


        :param role: The role of this CloudAsmConnectionCredentialsByDetails.
        :type: str
        """
