...
class DbmResource(object):
    ...
    def __init__(self, **kwargs):
        ...
        * :class:`~oci.database_management.models.ExadataVmClusterSummary`
        * :class:`~oci.database_management.models.CloudExadataStorageConnectorSummary`
        ...
        * :class:`~oci.database_management.models.CloudExadataInfrastructure`
        * :class:`~oci.database_management.models.CloudExadataStorageServerSummary`
        * :class:`~oci.database_management.models.CloudExadataStorageGrid`
        * :class:`~oci.database_management.models.ExternalExadataStorageGridSummary`
        * :class:`~oci.database_management.models.CloudExadataStorageConnector`
        * :class:`~oci.database_management.models.CloudExadataInfrastructureSummary`
        ...
        * :class:`~oci.database_management.models.CloudExadataStorageGridSummary`
        * :class:`~oci.database_management.models.ExternalExadataDatabaseSystemSummary`
        * :class:`~oci.database_management.models.CloudExadataStorageServer`
    ...
    def get_subtype(object_dictionary):
        ...
        if type == 'VM_CLUSTER_SUMMARY':
            return 'ExadataVmClusterSummary'

        if type == 'CLOUD_STORAGE_CONNECTOR_SUMMARY':
            return 'CloudExadataStorageConnectorSummary'
        ...
        if type == 'CLOUD_INFRASTRUCTURE':
            return 'CloudExadataInfrastructure'

        if type == 'CLOUD_STORAGE_SERVER_SUMMARY':
            return 'CloudExadataStorageServerSummary'

        if type == 'CLOUD_STORAGE_GRID':
            return 'CloudExadataStorageGrid'

        if type == 'STORAGE_GRID_SUMMARY':
            return 'ExternalExadataStorageGridSummary'

        if type == 'CLOUD_STORAGE_CONNECTOR':
            return 'CloudExadataStorageConnector'

        if type == 'CLOUD_INFRASTRUCTURE_SUMMARY':
        ...
        if type == 'CLOUD_STORAGE_GRID_SUMMARY':
            return 'CloudExadataStorageGridSummary'

        if type == 'DATABASE_SYSTEM_SUMMARY':
            return 'ExternalExadataDatabaseSystemSummary'

        if type == 'CLOUD_STORAGE_SERVER':
