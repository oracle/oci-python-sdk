...
class WorkRequest(object):
    ...
    #: This constant has a value of "CREATE_NETWORK_FIREWALL"
    OPERATION_TYPE_CREATE_NETWORK_FIREWALL = "CREATE_NETWORK_FIREWALL"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "UPDATE_NETWORK_FIREWALL"
    OPERATION_TYPE_UPDATE_NETWORK_FIREWALL = "UPDATE_NETWORK_FIREWALL"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "DELETE_NETWORK_FIREWALL"
    OPERATION_TYPE_DELETE_NETWORK_FIREWALL = "DELETE_NETWORK_FIREWALL"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "MOVE_NETWORK_FIREWALL"
    OPERATION_TYPE_MOVE_NETWORK_FIREWALL = "MOVE_NETWORK_FIREWALL"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "CREATE_NETWORK_FIREWALL_POLICY"
    OPERATION_TYPE_CREATE_NETWORK_FIREWALL_POLICY = "CREATE_NETWORK_FIREWALL_POLICY"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "UPDATE_NETWORK_FIREWALL_POLICY"
    OPERATION_TYPE_UPDATE_NETWORK_FIREWALL_POLICY = "UPDATE_NETWORK_FIREWALL_POLICY"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "DELETE_NETWORK_FIREWALL_POLICY"
    OPERATION_TYPE_DELETE_NETWORK_FIREWALL_POLICY = "DELETE_NETWORK_FIREWALL_POLICY"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "MOVE_NETWORK_FIREWALL_POLICY"
    OPERATION_TYPE_MOVE_NETWORK_FIREWALL_POLICY = "MOVE_NETWORK_FIREWALL_POLICY"
    ...
    def __init__(self, **kwargs):
        ...
        :param operation_type:
            ...
            Allowed values for this property are: "CREATE_NETWORK_FIREWALL", "UPDATE_NETWORK_FIREWALL", "DELETE_NETWORK_FIREWALL", "MOVE_NETWORK_FIREWALL", "CREATE_NETWORK_FIREWALL_POLICY", "UPDATE_NETWORK_FIREWALL_POLICY", "DELETE_NETWORK_FIREWALL_POLICY", "MOVE_NETWORK_FIREWALL_POLICY", 'UNKNOWN_ENUM_VALUE'.
        ...
        :type resources: list[oci.network_firewall.models.WorkRequestResource]
    ...
    def operation_type(self, operation_type):
        ...
        :type: str
        """
        allowed_values = ["CREATE_NETWORK_FIREWALL", "UPDATE_NETWORK_FIREWALL", "DELETE_NETWORK_FIREWALL", "MOVE_NETWORK_FIREWALL", "CREATE_NETWORK_FIREWALL_POLICY", "UPDATE_NETWORK_FIREWALL_POLICY", "DELETE_NETWORK_FIREWALL_POLICY", "MOVE_NETWORK_FIREWALL_POLICY"]
    ...
    def resources(self):
        ...
        **[Required]** Gets the resources of this WorkRequest.
        ...
        :rtype: list[oci.network_firewall.models.WorkRequestResource]
        """
    ...
    def resources(self, resources):
        ...
        :type: list[oci.network_firewall.models.WorkRequestResource]
        """
