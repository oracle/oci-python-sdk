...
class MappedSecret(object):
    ...
    #: A constant which can be used with the source property of a MappedSecret.
    #: This constant has a value of "OCI_VAULT"
    ...
    def __init__(self, **kwargs):
        ...
        * :class:`~oci.network_firewall.models.VaultMappedSecret`
        ...
        :param name:
            The value to assign to the name property of this MappedSecret.
        :type name: str

        :param source:
            The value to assign to the source property of this MappedSecret.
            Allowed values for this property are: "OCI_VAULT", 'UNKNOWN_ENUM_VALUE'.
    ...
    def name(self):
        """
        **[Required]** Gets the name of this MappedSecret.
        Name of the secret.


        :return: The name of this MappedSecret.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this MappedSecret.
        Name of the secret.


        :param name: The name of this MappedSecret.
        :type: str
        """
        self._name = name
    ...
    def parent_resource_id(self):
        """
        **[Required]** Gets the parent_resource_id of this MappedSecret.
        OCID of the Network Firewall Policy this Mapped Secret belongs to.


        :return: The parent_resource_id of this MappedSecret.
        :rtype: str
        """
    ...
    def parent_resource_id(self, parent_resource_id):
        """
        Sets the parent_resource_id of this MappedSecret.
        OCID of the Network Firewall Policy this Mapped Secret belongs to.


        :param parent_resource_id: The parent_resource_id of this MappedSecret.
        :type: str
        """
