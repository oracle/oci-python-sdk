...
class DataLabelingClient(object):
    ...
    def create_annotation(self, create_annotation_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/datalabelingservicedataplane/create_annotation.py.html>`__ to see an example of how to use create_annotation API.
        """
    ...
    def create_record(self, create_record_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/datalabelingservicedataplane/create_record.py.html>`__ to see an example of how to use create_record API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def delete_annotation(self, annotation_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/datalabelingservicedataplane/delete_annotation.py.html>`__ to see an example of how to use delete_annotation API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def delete_record(self, record_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/datalabelingservicedataplane/delete_record.py.html>`__ to see an example of how to use delete_record API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_annotation(self, annotation_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/datalabelingservicedataplane/get_annotation.py.html>`__ to see an example of how to use get_annotation API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['annotationId']
        resource_path = "/annotations/{annotationId}"
    ...
    def get_dataset(self, dataset_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/datalabelingservicedataplane/get_dataset.py.html>`__ to see an example of how to use get_dataset API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_record(self, record_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/datalabelingservicedataplane/get_record.py.html>`__ to see an example of how to use get_record API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['recordId']
        resource_path = "/records/{recordId}"
    ...
    def get_record_content(self, record_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/datalabelingservicedataplane/get_record_content.py.html>`__ to see an example of how to use get_record_content API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['recordId']
    ...
    def get_record_preview_content(self, record_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/datalabelingservicedataplane/get_record_preview_content.py.html>`__ to see an example of how to use get_record_preview_content API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['recordId']
    ...
    def list_annotations(self, compartment_id, dataset_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/datalabelingservicedataplane/list_annotations.py.html>`__ to see an example of how to use list_annotations API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def list_records(self, compartment_id, dataset_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/datalabelingservicedataplane/list_records.py.html>`__ to see an example of how to use list_records API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId', 'datasetId']
        resource_path = "/records"
    ...
    def summarize_annotation_analytics(self, compartment_id, dataset_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/datalabelingservicedataplane/summarize_annotation_analytics.py.html>`__ to see an example of how to use summarize_annotation_analytics API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId', 'datasetId']
    ...
    def summarize_record_analytics(self, compartment_id, dataset_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/datalabelingservicedataplane/summarize_record_analytics.py.html>`__ to see an example of how to use summarize_record_analytics API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId', 'datasetId']
    ...
    def update_annotation(self, annotation_id, update_annotation_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/datalabelingservicedataplane/update_annotation.py.html>`__ to see an example of how to use update_annotation API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['annotationId']
        resource_path = "/annotations/{annotationId}"
    ...
    def update_record(self, record_id, update_record_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/datalabelingservicedataplane/update_record.py.html>`__ to see an example of how to use update_record API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['recordId']
        resource_path = "/records/{recordId}"
