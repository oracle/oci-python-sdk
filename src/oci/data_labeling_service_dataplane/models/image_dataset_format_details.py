...
class ImageDatasetFormatDetails(DatasetFormatDetails):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ImageDatasetFormatDetails object with values from keyword arguments. The default value of the :py:attr:`~oci.data_labeling_service_dataplane.models.ImageDatasetFormatDetails.format_type` attribute
