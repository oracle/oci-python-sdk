...
class RecordCollection(object):
    ...
    def __init__(self, **kwargs):
        ...
        :type items: list[oci.data_labeling_service_dataplane.models.RecordSummary]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this RecordCollection.
        ...
        :rtype: list[oci.data_labeling_service_dataplane.models.RecordSummary]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.data_labeling_service_dataplane.models.RecordSummary]
        """
        self._items = items
