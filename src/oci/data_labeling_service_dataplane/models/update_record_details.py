...
class UpdateRecordDetails(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new UpdateRecordDetails object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param freeform_tags:
            The value to assign to the freeform_tags property of this UpdateRecordDetails.
