...
class DocumentDatasetFormatDetails(DatasetFormatDetails):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new DocumentDatasetFormatDetails object with values from keyword arguments. The default value of the :py:attr:`~oci.data_labeling_service_dataplane.models.DocumentDatasetFormatDetails.format_type` attribute
