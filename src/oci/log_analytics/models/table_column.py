...
class TableColumn(AbstractColumn):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new TableColumn object with values from keyword arguments. The default value of the :py:attr:`~oci.log_analytics.models.TableColumn.type` attribute
        of this class is ``TABLE_COLUMN`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param type:
            The value to assign to the type property of this TableColumn.
        ...
        :param display_name:
            The value to assign to the display_name property of this TableColumn.
        :type display_name: str

        :param sub_system:
            The value to assign to the sub_system property of this TableColumn.
            Allowed values for this property are: "LOG"
        :type sub_system: str

        :param values:
            The value to assign to the values property of this TableColumn.
        :type values: list[oci.log_analytics.models.FieldValue]

        :param is_list_of_values:
            The value to assign to the is_list_of_values property of this TableColumn.
        :type is_list_of_values: bool

        :param is_multi_valued:
            The value to assign to the is_multi_valued property of this TableColumn.
        :type is_multi_valued: bool

        :param is_case_sensitive:
            The value to assign to the is_case_sensitive property of this TableColumn.
        :type is_case_sensitive: bool

        :param is_groupable:
            The value to assign to the is_groupable property of this TableColumn.
        ...
        :param original_display_name:
            The value to assign to the original_display_name property of this TableColumn.
        :type original_display_name: str

        :param internal_name:
            The value to assign to the internal_name property of this TableColumn.
        :type internal_name: str

        :param columns:
            The value to assign to the columns property of this TableColumn.
    ...
    def columns(self):
        """
        Gets the columns of this TableColumn.
        Column descriptors for the table result.


        :return: The columns of this TableColumn.
    ...
    def columns(self, columns):
        """
        Sets the columns of this TableColumn.
        Column descriptors for the table result.


        :param columns: The columns of this TableColumn.
    ...
    def result(self):
        """
        Gets the result of this TableColumn.
        Results data of the table.


        :return: The result of this TableColumn.
    ...
    def result(self, result):
        """
        Sets the result of this TableColumn.
        Results data of the table.


        :param result: The result of this TableColumn.
