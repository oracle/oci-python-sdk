...
class CreateTableCommandDescriptor(AbstractCommandDescriptor):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new CreateTableCommandDescriptor object with values from keyword arguments. The default value of the :py:attr:`~oci.log_analytics.models.CreateTableCommandDescriptor.name` attribute
        of this class is ``CREATETABLE`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param name:
            The value to assign to the name property of this CreateTableCommandDescriptor.
        ...
        :param display_query_string:
            The value to assign to the display_query_string property of this CreateTableCommandDescriptor.
        :type display_query_string: str

        :param internal_query_string:
            The value to assign to the internal_query_string property of this CreateTableCommandDescriptor.
        :type internal_query_string: str

        :param category:
            The value to assign to the category property of this CreateTableCommandDescriptor.
        :type category: str

        :param referenced_fields:
            The value to assign to the referenced_fields property of this CreateTableCommandDescriptor.
        :type referenced_fields: list[oci.log_analytics.models.AbstractField]

        :param declared_fields:
            The value to assign to the declared_fields property of this CreateTableCommandDescriptor.
        :type declared_fields: list[oci.log_analytics.models.AbstractField]

        :param is_hidden:
            The value to assign to the is_hidden property of this CreateTableCommandDescriptor.
        :type is_hidden: bool

        :param table_name:
            The value to assign to the table_name property of this CreateTableCommandDescriptor.
        :type table_name: str
        ...
        self._name = 'CREATETABLE'

    @property
    def table_name(self):
        """
        **[Required]** Gets the table_name of this CreateTableCommandDescriptor.
        Name of the table being created.


        :return: The table_name of this CreateTableCommandDescriptor.
        :rtype: str
        """
    ...
    def table_name(self, table_name):
        """
        Sets the table_name of this CreateTableCommandDescriptor.
        Name of the table being created.


        :param table_name: The table_name of this CreateTableCommandDescriptor.
        :type: str
        """
