...
class LogAnalyticsLabelOperatorCollection(object):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new LogAnalyticsLabelOperatorCollection object with values from keyword arguments.
        ...
        """
        self.swagger_types = {
            'items': 'list[LogAnalyticsLabelOperator]'
        }
