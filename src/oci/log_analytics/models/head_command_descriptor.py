...
class HeadCommandDescriptor(AbstractCommandDescriptor):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new HeadCommandDescriptor object with values from keyword arguments. The default value of the :py:attr:`~oci.log_analytics.models.HeadCommandDescriptor.name` attribute
        of this class is ``HEAD`` and it should not be changed.
        ...
        :param display_query_string:
            The value to assign to the display_query_string property of this HeadCommandDescriptor.
        :type display_query_string: str

        :param internal_query_string:
            The value to assign to the internal_query_string property of this HeadCommandDescriptor.
        :type internal_query_string: str

        :param category:
            The value to assign to the category property of this HeadCommandDescriptor.
        :type category: str

        :param referenced_fields:
            The value to assign to the referenced_fields property of this HeadCommandDescriptor.
        :type referenced_fields: list[oci.log_analytics.models.AbstractField]

        :param declared_fields:
            The value to assign to the declared_fields property of this HeadCommandDescriptor.
        :type declared_fields: list[oci.log_analytics.models.AbstractField]

        :param is_hidden:
            The value to assign to the is_hidden property of this HeadCommandDescriptor.
        :type is_hidden: bool

        :param limit:
            The value to assign to the limit property of this HeadCommandDescriptor.
        :type limit: int
    ...
    def limit(self):
        """
        Gets the limit of this HeadCommandDescriptor.
        Value specified as limit argument in queryString


        :return: The limit of this HeadCommandDescriptor.
        :rtype: int
        """
        return self._limit
    ...
    def limit(self, limit):
        """
        Sets the limit of this HeadCommandDescriptor.
        Value specified as limit argument in queryString


        :param limit: The limit of this HeadCommandDescriptor.
        :type: int
        """
        self._limit = limit
