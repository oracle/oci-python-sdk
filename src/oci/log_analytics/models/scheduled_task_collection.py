...
class ScheduledTaskCollection(object):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ScheduledTaskCollection object with values from keyword arguments.
    ...
    def items(self, items):
        """
        Sets the items of this ScheduledTaskCollection.
        Array of scheduled task summary information.
