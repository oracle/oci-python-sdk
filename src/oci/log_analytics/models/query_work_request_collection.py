...
class QueryWorkRequestCollection(object):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new QueryWorkRequestCollection object with values from keyword arguments.
        ...
        """
        self.swagger_types = {
            'items': 'list[QueryWorkRequestSummary]'
        }
    ...
    def items(self):
        """
        **[Required]** Gets the items of this QueryWorkRequestCollection.
    ...
    def items(self, items):
        """
        Sets the items of this QueryWorkRequestCollection.
        List of work requests.
