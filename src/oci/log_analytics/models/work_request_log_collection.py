...
class WorkRequestLogCollection(object):
    ...
    def __init__(self, **kwargs):
        ...
        :type items: list[oci.log_analytics.models.WorkRequestLog]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this WorkRequestLogCollection.
        ...
        :rtype: list[oci.log_analytics.models.WorkRequestLog]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.log_analytics.models.WorkRequestLog]
        """
        self._items = items
