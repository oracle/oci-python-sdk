...
class LogAnalyticsAssociationParameterCollection(object):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new LogAnalyticsAssociationParameterCollection object with values from keyword arguments.
