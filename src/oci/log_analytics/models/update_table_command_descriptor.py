...
class UpdateTableCommandDescriptor(AbstractCommandDescriptor):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new UpdateTableCommandDescriptor object with values from keyword arguments. The default value of the :py:attr:`~oci.log_analytics.models.UpdateTableCommandDescriptor.name` attribute
        of this class is ``UPDATETABLE`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param name:
            The value to assign to the name property of this UpdateTableCommandDescriptor.
        ...
        :param display_query_string:
            The value to assign to the display_query_string property of this UpdateTableCommandDescriptor.
        :type display_query_string: str

        :param internal_query_string:
            The value to assign to the internal_query_string property of this UpdateTableCommandDescriptor.
        :type internal_query_string: str

        :param category:
            The value to assign to the category property of this UpdateTableCommandDescriptor.
        :type category: str

        :param referenced_fields:
            The value to assign to the referenced_fields property of this UpdateTableCommandDescriptor.
        :type referenced_fields: list[oci.log_analytics.models.AbstractField]

        :param declared_fields:
            The value to assign to the declared_fields property of this UpdateTableCommandDescriptor.
        :type declared_fields: list[oci.log_analytics.models.AbstractField]

        :param is_hidden:
            The value to assign to the is_hidden property of this UpdateTableCommandDescriptor.
        :type is_hidden: bool

        :param table_name:
            The value to assign to the table_name property of this UpdateTableCommandDescriptor.
        :type table_name: str
        ...
        self._name = 'UPDATETABLE'

    @property
    def table_name(self):
        """
        **[Required]** Gets the table_name of this UpdateTableCommandDescriptor.
        Name of the table being updated.


        :return: The table_name of this UpdateTableCommandDescriptor.
        :rtype: str
        """
    ...
    def table_name(self, table_name):
        """
        Sets the table_name of this UpdateTableCommandDescriptor.
        Name of the table being updated.


        :param table_name: The table_name of this UpdateTableCommandDescriptor.
        :type: str
        """
