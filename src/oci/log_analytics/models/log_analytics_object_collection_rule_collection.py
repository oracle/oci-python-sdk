...
class LogAnalyticsObjectCollectionRuleCollection(object):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new LogAnalyticsObjectCollectionRuleCollection object with values from keyword arguments.
        ...
        """
        self.swagger_types = {
            'items': 'list[LogAnalyticsObjectCollectionRuleSummary]'
        }
