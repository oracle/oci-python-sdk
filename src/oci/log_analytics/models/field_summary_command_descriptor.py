...
class FieldSummaryCommandDescriptor(AbstractCommandDescriptor):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new FieldSummaryCommandDescriptor object with values from keyword arguments. The default value of the :py:attr:`~oci.log_analytics.models.FieldSummaryCommandDescriptor.name` attribute
        of this class is ``FIELD_SUMMARY`` and it should not be changed.
        ...
        :param display_query_string:
            The value to assign to the display_query_string property of this FieldSummaryCommandDescriptor.
        :type display_query_string: str

        :param internal_query_string:
            The value to assign to the internal_query_string property of this FieldSummaryCommandDescriptor.
        :type internal_query_string: str

        :param category:
            The value to assign to the category property of this FieldSummaryCommandDescriptor.
        :type category: str

        :param referenced_fields:
            The value to assign to the referenced_fields property of this FieldSummaryCommandDescriptor.
        :type referenced_fields: list[oci.log_analytics.models.AbstractField]

        :param declared_fields:
            The value to assign to the declared_fields property of this FieldSummaryCommandDescriptor.
        :type declared_fields: list[oci.log_analytics.models.AbstractField]

        :param is_hidden:
            The value to assign to the is_hidden property of this FieldSummaryCommandDescriptor.
        :type is_hidden: bool

        :param max_values:
            The value to assign to the max_values property of this FieldSummaryCommandDescriptor.
        :type max_values: int
        ...
        self._name = 'FIELD_SUMMARY'

    @property
    def max_values(self):
        """
        Gets the max_values of this FieldSummaryCommandDescriptor.
        Limit on number of distinct values to process for each field specified in the field summary command in the query string.


        :return: The max_values of this FieldSummaryCommandDescriptor.
        :rtype: int
        """
    ...
    def max_values(self, max_values):
        """
        Sets the max_values of this FieldSummaryCommandDescriptor.
        Limit on number of distinct values to process for each field specified in the field summary command in the query string.


        :param max_values: The max_values of this FieldSummaryCommandDescriptor.
        :type: int
        """
