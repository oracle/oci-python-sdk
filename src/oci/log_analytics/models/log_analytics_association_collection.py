...
class LogAnalyticsAssociationCollection(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new LogAnalyticsAssociationCollection object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param items:
            The value to assign to the items property of this LogAnalyticsAssociationCollection.
        :type items: list[oci.log_analytics.models.LogAnalyticsAssociation]

        """
        self.swagger_types = {
            'items': 'list[LogAnalyticsAssociation]'
        }
