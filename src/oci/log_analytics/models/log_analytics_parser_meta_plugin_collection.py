...
class LogAnalyticsParserMetaPluginCollection(object):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new LogAnalyticsParserMetaPluginCollection object with values from keyword arguments.
        ...
        """
        self.swagger_types = {
            'items': 'list[LogAnalyticsParserMetaPlugin]'
        }
    ...
    def items(self):
        """
        Gets the items of this LogAnalyticsParserMetaPluginCollection.
    ...
    def items(self, items):
        """
        Sets the items of this LogAnalyticsParserMetaPluginCollection.
        list of meta pre-process pagination objects
