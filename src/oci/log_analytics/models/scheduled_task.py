...
class ScheduledTask(object):
    ...
    #: A constant which can be used with the pause_reason property of a ScheduledTask.
    #: This constant has a value of "LIMIT_EXCEEDED"
    PAUSE_REASON_LIMIT_EXCEEDED = "LIMIT_EXCEEDED"
    ...
    def __init__(self, **kwargs):
        ...
        * :class:`~oci.log_analytics.models.StandardTask`
        ...
        :param description:
            The value to assign to the description property of this ScheduledTask.
    ...
    def pause_reason(self, pause_reason):
        ...
        :type: str
        """
        allowed_values = ["METRIC_EXTRACTION_NOT_VALID", "SAVED_SEARCH_NOT_VALID", "SAVED_SEARCH_NOT_FOUND", "QUERY_STRING_NOT_VALID", "USER_ACTION", "TENANCY_LIFECYCLE", "PURGE_RESOURCE_NOT_FOUND", "LIMIT_EXCEEDED"]
