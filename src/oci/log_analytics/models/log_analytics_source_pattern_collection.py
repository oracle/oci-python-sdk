...
class LogAnalyticsSourcePatternCollection(object):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new LogAnalyticsSourcePatternCollection object with values from keyword arguments.
        ...
        """
        self.swagger_types = {
            'items': 'list[LogAnalyticsSourcePattern]'
        }
    ...
    def items(self):
        """
        Gets the items of this LogAnalyticsSourcePatternCollection.
    ...
    def items(self, items):
        """
        Sets the items of this LogAnalyticsSourcePatternCollection.
        An array of source patterns.
