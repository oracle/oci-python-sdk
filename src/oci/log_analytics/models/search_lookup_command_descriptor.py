...
class SearchLookupCommandDescriptor(AbstractCommandDescriptor):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new SearchLookupCommandDescriptor object with values from keyword arguments. The default value of the :py:attr:`~oci.log_analytics.models.SearchLookupCommandDescriptor.name` attribute
        of this class is ``SEARCH_LOOKUP`` and it should not be changed.
        ...
        :param display_query_string:
            The value to assign to the display_query_string property of this SearchLookupCommandDescriptor.
        :type display_query_string: str

        :param internal_query_string:
            The value to assign to the internal_query_string property of this SearchLookupCommandDescriptor.
        :type internal_query_string: str

        :param category:
            The value to assign to the category property of this SearchLookupCommandDescriptor.
        :type category: str
        ...
        :param is_hidden:
            The value to assign to the is_hidden property of this SearchLookupCommandDescriptor.
        :type is_hidden: bool
