...
class LogGroupSummaryReport(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new LogGroupSummaryReport object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param count:
            The value to assign to the count property of this LogGroupSummaryReport.
        :type count: int
