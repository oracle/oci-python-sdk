...
class UploadWarningCollection(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new UploadWarningCollection object with values from keyword arguments.
    ...
    def items(self):
        """
        **[Required]** Gets the items of this UploadWarningCollection.
    ...
    def items(self, items):
        """
        Sets the items of this UploadWarningCollection.
        list of UploadWarningSummary objects.
