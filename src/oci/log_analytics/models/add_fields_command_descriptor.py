...
class AddFieldsCommandDescriptor(AbstractCommandDescriptor):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new AddFieldsCommandDescriptor object with values from keyword arguments. The default value of the :py:attr:`~oci.log_analytics.models.AddFieldsCommandDescriptor.name` attribute
        of this class is ``ADD_FIELDS`` and it should not be changed.
        ...
        :param display_query_string:
            The value to assign to the display_query_string property of this AddFieldsCommandDescriptor.
        :type display_query_string: str

        :param internal_query_string:
            The value to assign to the internal_query_string property of this AddFieldsCommandDescriptor.
        :type internal_query_string: str

        :param category:
            The value to assign to the category property of this AddFieldsCommandDescriptor.
        :type category: str

        :param referenced_fields:
            The value to assign to the referenced_fields property of this AddFieldsCommandDescriptor.
    ...
    def sub_queries(self):
        """
        Gets the sub_queries of this AddFieldsCommandDescriptor.
        List of subQueries specified as addFields command arguments


        :return: The sub_queries of this AddFieldsCommandDescriptor.
    ...
    def sub_queries(self, sub_queries):
        """
        Sets the sub_queries of this AddFieldsCommandDescriptor.
        List of subQueries specified as addFields command arguments


        :param sub_queries: The sub_queries of this AddFieldsCommandDescriptor.
