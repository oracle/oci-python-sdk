...
class TailCommandDescriptor(AbstractCommandDescriptor):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new TailCommandDescriptor object with values from keyword arguments. The default value of the :py:attr:`~oci.log_analytics.models.TailCommandDescriptor.name` attribute
        ...
        :param display_query_string:
            The value to assign to the display_query_string property of this TailCommandDescriptor.
        :type display_query_string: str

        :param internal_query_string:
            The value to assign to the internal_query_string property of this TailCommandDescriptor.
        :type internal_query_string: str

        :param category:
            The value to assign to the category property of this TailCommandDescriptor.
        :type category: str

        :param referenced_fields:
            The value to assign to the referenced_fields property of this TailCommandDescriptor.
        :type referenced_fields: list[oci.log_analytics.models.AbstractField]

        :param declared_fields:
            The value to assign to the declared_fields property of this TailCommandDescriptor.
        :type declared_fields: list[oci.log_analytics.models.AbstractField]

        :param is_hidden:
            The value to assign to the is_hidden property of this TailCommandDescriptor.
        :type is_hidden: bool

        :param limit:
            The value to assign to the limit property of this TailCommandDescriptor.
        :type limit: int
    ...
    def limit(self):
        """
        Gets the limit of this TailCommandDescriptor.
        Value specified as limit argument in queryString


        :return: The limit of this TailCommandDescriptor.
        :rtype: int
        """
        return self._limit
    ...
    def limit(self, limit):
        """
        Sets the limit of this TailCommandDescriptor.
        Value specified as limit argument in queryString


        :param limit: The limit of this TailCommandDescriptor.
        :type: int
        """
        self._limit = limit
