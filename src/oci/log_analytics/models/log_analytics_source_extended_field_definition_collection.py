...
class LogAnalyticsSourceExtendedFieldDefinitionCollection(object):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new LogAnalyticsSourceExtendedFieldDefinitionCollection object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param items:
            The value to assign to the items property of this LogAnalyticsSourceExtendedFieldDefinitionCollection.
        :type items: list[oci.log_analytics.models.LogAnalyticsSourceExtendedFieldDefinition]
