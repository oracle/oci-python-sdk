...
class UpdateManagementAgentDetails(object):
    """
    ...
    def __init__(self, **kwargs):
        ...
        :param freeform_tags:
            The value to assign to the freeform_tags property of this UpdateManagementAgentDetails.
        :type freeform_tags: dict(str, str)

        :param defined_tags:
            The value to assign to the defined_tags property of this UpdateManagementAgentDetails.
    ...
    def display_name(self):
        """
        Gets the display_name of this UpdateManagementAgentDetails.
        New displayName of Agent.


        :return: The display_name of this UpdateManagementAgentDetails.
        :rtype: str
        """
    ...
    def display_name(self, display_name):
        """
        Sets the display_name of this UpdateManagementAgentDetails.
        New displayName of Agent.


        :param display_name: The display_name of this UpdateManagementAgentDetails.
        :type: str
        """
    ...
    def freeform_tags(self):
        """
        Gets the freeform_tags of this UpdateManagementAgentDetails.
        Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only.
        Example: `{\"bar-key\": \"value\"}`


        :return: The freeform_tags of this UpdateManagementAgentDetails.
        :rtype: dict(str, str)
        """
    ...
    def freeform_tags(self, freeform_tags):
        """
        Sets the freeform_tags of this UpdateManagementAgentDetails.
        Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only.
        Example: `{\"bar-key\": \"value\"}`


        :param freeform_tags: The freeform_tags of this UpdateManagementAgentDetails.
        :type: dict(str, str)
        """
    ...
    def defined_tags(self):
        """
        Gets the defined_tags of this UpdateManagementAgentDetails.
        Defined tags for this resource. Each key is predefined and scoped to a namespace.
        Example: `{\"foo-namespace\": {\"bar-key\": \"value\"}}`


        :return: The defined_tags of this UpdateManagementAgentDetails.
    ...
    def defined_tags(self, defined_tags):
        """
        Sets the defined_tags of this UpdateManagementAgentDetails.
        Defined tags for this resource. Each key is predefined and scoped to a namespace.
        Example: `{\"foo-namespace\": {\"bar-key\": \"value\"}}`


        :param defined_tags: The defined_tags of this UpdateManagementAgentDetails.
