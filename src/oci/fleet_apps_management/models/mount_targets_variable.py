...
class MountTargetsVariable(BaseVariable):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new MountTargetsVariable object with values from keyword arguments. The default value of the :py:attr:`~oci.fleet_apps_management.models.MountTargetsVariable.type` attribute
        of this class is ``OCI_MOUNT_TARGET_ID`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param type:
            The value to assign to the type property of this MountTargetsVariable.
        ...
        :param title:
            The value to assign to the title property of this MountTargetsVariable.
        :type title: str

        :param description:
            The value to assign to the description property of this MountTargetsVariable.
        :type description: str

        :param is_required:
            The value to assign to the is_required property of this MountTargetsVariable.
        :type is_required: bool

        :param visible:
            The value to assign to the visible property of this MountTargetsVariable.
        :type visible: str

        :param depends_on:
            The value to assign to the depends_on property of this MountTargetsVariable.
        :type depends_on: oci.fleet_apps_management.models.MountTargetsVariableDependsOn
        ...
        self.swagger_types = {
            ...
            'is_required': 'bool',
            'visible': 'str',
            'depends_on': 'MountTargetsVariableDependsOn'
        }
        self.attribute_map = {
            'type': 'type',
            'title': 'title',
        ...
        self._type = 'OCI_MOUNT_TARGET_ID'

    @property
    def depends_on(self):
        """
        Gets the depends_on of this MountTargetsVariable.

        :return: The depends_on of this MountTargetsVariable.
        :rtype: oci.fleet_apps_management.models.MountTargetsVariableDependsOn
        """
    ...
    def depends_on(self, depends_on):
        """
        Sets the depends_on of this MountTargetsVariable.

        :param depends_on: The depends_on of this MountTargetsVariable.
        :type: oci.fleet_apps_management.models.MountTargetsVariableDependsOn
        """
