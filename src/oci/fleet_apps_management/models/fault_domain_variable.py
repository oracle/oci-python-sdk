...
class FaultDomainVariable(BaseVariable):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new FaultDomainVariable object with values from keyword arguments. The default value of the :py:attr:`~oci.fleet_apps_management.models.FaultDomainVariable.type` attribute
        of this class is ``OCI_IDENTITY_FAULTDOMAIN_NAME`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param type:
            The value to assign to the type property of this FaultDomainVariable.
        ...
        :param title:
            The value to assign to the title property of this FaultDomainVariable.
        :type title: str

        :param description:
            The value to assign to the description property of this FaultDomainVariable.
        :type description: str

        :param is_required:
            The value to assign to the is_required property of this FaultDomainVariable.
        :type is_required: bool

        :param visible:
            The value to assign to the visible property of this FaultDomainVariable.
        :type visible: str

        :param depends_on:
            The value to assign to the depends_on property of this FaultDomainVariable.
        :type depends_on: oci.fleet_apps_management.models.FaultDomainVariableDependsOn
        ...
        self.swagger_types = {
            ...
            'is_required': 'bool',
            'visible': 'str',
            'depends_on': 'FaultDomainVariableDependsOn'
        }
        self.attribute_map = {
            'type': 'type',
            'title': 'title',
        ...
        self._type = 'OCI_IDENTITY_FAULTDOMAIN_NAME'

    @property
    def depends_on(self):
        """
        Gets the depends_on of this FaultDomainVariable.

        :return: The depends_on of this FaultDomainVariable.
        :rtype: oci.fleet_apps_management.models.FaultDomainVariableDependsOn
        """
    ...
    def depends_on(self, depends_on):
        """
        Sets the depends_on of this FaultDomainVariable.

        :param depends_on: The depends_on of this FaultDomainVariable.
        :type: oci.fleet_apps_management.models.FaultDomainVariableDependsOn
        """
