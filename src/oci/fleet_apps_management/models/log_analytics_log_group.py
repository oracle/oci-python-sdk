...
class LogAnalyticsLogGroup(BaseVariable):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new LogAnalyticsLogGroup object with values from keyword arguments. The default value of the :py:attr:`~oci.fleet_apps_management.models.LogAnalyticsLogGroup.type` attribute
        of this class is ``OCI_LOGAN_LOGGROUP_ID`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param type:
            The value to assign to the type property of this LogAnalyticsLogGroup.
        ...
        :param title:
            The value to assign to the title property of this LogAnalyticsLogGroup.
        :type title: str
        ...
        :param is_required:
            The value to assign to the is_required property of this LogAnalyticsLogGroup.
        :type is_required: bool

        :param visible:
            The value to assign to the visible property of this LogAnalyticsLogGroup.
        :type visible: str

        :param depends_on:
            The value to assign to the depends_on property of this LogAnalyticsLogGroup.
        :type depends_on: oci.fleet_apps_management.models.LogAnalyticsLogGroupDependsOn
        ...
        self.swagger_types = {
            ...
            'is_required': 'bool',
            'visible': 'str',
            'depends_on': 'LogAnalyticsLogGroupDependsOn'
        }
        self.attribute_map = {
            'type': 'type',
            'title': 'title',
        ...
        self._type = 'OCI_LOGAN_LOGGROUP_ID'

    @property
    def depends_on(self):
        """
        Gets the depends_on of this LogAnalyticsLogGroup.

        :return: The depends_on of this LogAnalyticsLogGroup.
        :rtype: oci.fleet_apps_management.models.LogAnalyticsLogGroupDependsOn
        """
    ...
    def depends_on(self, depends_on):
        """
        Sets the depends_on of this LogAnalyticsLogGroup.

        :param depends_on: The depends_on of this LogAnalyticsLogGroup.
        :type: oci.fleet_apps_management.models.LogAnalyticsLogGroupDependsOn
        """
