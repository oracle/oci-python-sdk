...
class AutonomousContainerDbVariable(BaseVariable):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new AutonomousContainerDbVariable object with values from keyword arguments. The default value of the :py:attr:`~oci.fleet_apps_management.models.AutonomousContainerDbVariable.type` attribute
        of this class is ``OCI_DATABASE_AUTONOMOUSCONTAINERDATABASE_ID`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param type:
            The value to assign to the type property of this AutonomousContainerDbVariable.
        ...
        :param title:
            The value to assign to the title property of this AutonomousContainerDbVariable.
        :type title: str

        :param description:
            The value to assign to the description property of this AutonomousContainerDbVariable.
        :type description: str

        :param is_required:
            The value to assign to the is_required property of this AutonomousContainerDbVariable.
        :type is_required: bool

        :param visible:
            The value to assign to the visible property of this AutonomousContainerDbVariable.
        :type visible: str

        :param depends_on:
            The value to assign to the depends_on property of this AutonomousContainerDbVariable.
        :type depends_on: oci.fleet_apps_management.models.AutonomousContainerDbVariableDependsOn
        ...
        self.swagger_types = {
            ...
            'is_required': 'bool',
            'visible': 'str',
            'depends_on': 'AutonomousContainerDbVariableDependsOn'
        }
        self.attribute_map = {
            'type': 'type',
            'title': 'title',
        ...
        self._type = 'OCI_DATABASE_AUTONOMOUSCONTAINERDATABASE_ID'

    @property
    def depends_on(self):
        """
        Gets the depends_on of this AutonomousContainerDbVariable.

        :return: The depends_on of this AutonomousContainerDbVariable.
        :rtype: oci.fleet_apps_management.models.AutonomousContainerDbVariableDependsOn
        """
    ...
    def depends_on(self, depends_on):
        """
        Sets the depends_on of this AutonomousContainerDbVariable.

        :param depends_on: The depends_on of this AutonomousContainerDbVariable.
        :type: oci.fleet_apps_management.models.AutonomousContainerDbVariableDependsOn
        """
