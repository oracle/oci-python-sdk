...
class VolumeBackupPoliciesVariable(BaseVariable):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new VolumeBackupPoliciesVariable object with values from keyword arguments. The default value of the :py:attr:`~oci.fleet_apps_management.models.VolumeBackupPoliciesVariable.type` attribute
        of this class is ``OCI_BLOCKSTORAGE_POLICIES_ID`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param type:
            The value to assign to the type property of this VolumeBackupPoliciesVariable.
        ...
        :param title:
            The value to assign to the title property of this VolumeBackupPoliciesVariable.
        :type title: str

        :param description:
            The value to assign to the description property of this VolumeBackupPoliciesVariable.
        :type description: str

        :param is_required:
            The value to assign to the is_required property of this VolumeBackupPoliciesVariable.
        :type is_required: bool

        :param visible:
            The value to assign to the visible property of this VolumeBackupPoliciesVariable.
        :type visible: str

        :param depends_on:
            The value to assign to the depends_on property of this VolumeBackupPoliciesVariable.
        :type depends_on: oci.fleet_apps_management.models.VolumeBackupPoliciesVariableDependsOn
        ...
        self.swagger_types = {
            ...
            'is_required': 'bool',
            'visible': 'str',
            'depends_on': 'VolumeBackupPoliciesVariableDependsOn'
        }
        self.attribute_map = {
            'type': 'type',
            'title': 'title',
        ...
        self._type = 'OCI_BLOCKSTORAGE_POLICIES_ID'

    @property
    def depends_on(self):
        """
        Gets the depends_on of this VolumeBackupPoliciesVariable.

        :return: The depends_on of this VolumeBackupPoliciesVariable.
        :rtype: oci.fleet_apps_management.models.VolumeBackupPoliciesVariableDependsOn
        """
    ...
    def depends_on(self, depends_on):
        """
        Sets the depends_on of this VolumeBackupPoliciesVariable.

        :param depends_on: The depends_on of this VolumeBackupPoliciesVariable.
        :type: oci.fleet_apps_management.models.VolumeBackupPoliciesVariableDependsOn
        """
