...
class NsgVariable(BaseVariable):
    """
    NSG Variable.
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new NsgVariable object with values from keyword arguments. The default value of the :py:attr:`~oci.fleet_apps_management.models.NsgVariable.type` attribute
        of this class is ``OCI_CORE_NSG_ID`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param type:
            The value to assign to the type property of this NsgVariable.
        ...
        :param title:
            The value to assign to the title property of this NsgVariable.
        :type title: str

        :param description:
            The value to assign to the description property of this NsgVariable.
        :type description: str

        :param is_required:
            The value to assign to the is_required property of this NsgVariable.
        :type is_required: bool

        :param visible:
            The value to assign to the visible property of this NsgVariable.
        :type visible: str

        :param depends_on:
            The value to assign to the depends_on property of this NsgVariable.
        :type depends_on: oci.fleet_apps_management.models.NsgVariableDependsOn
        ...
        self.swagger_types = {
            ...
            'is_required': 'bool',
            'visible': 'str',
            'depends_on': 'NsgVariableDependsOn'
        }
        self.attribute_map = {
            'type': 'type',
            'title': 'title',
        ...
        self._type = 'OCI_CORE_NSG_ID'

    @property
    def depends_on(self):
        """
        Gets the depends_on of this NsgVariable.

        :return: The depends_on of this NsgVariable.
        :rtype: oci.fleet_apps_management.models.NsgVariableDependsOn
        """
    ...
    def depends_on(self, depends_on):
        """
        Sets the depends_on of this NsgVariable.

        :param depends_on: The depends_on of this NsgVariable.
        :type: oci.fleet_apps_management.models.NsgVariableDependsOn
        """
