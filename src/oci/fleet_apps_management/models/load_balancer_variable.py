...
class LoadBalancerVariable(BaseVariable):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new LoadBalancerVariable object with values from keyword arguments. The default value of the :py:attr:`~oci.fleet_apps_management.models.LoadBalancerVariable.type` attribute
        of this class is ``OCI_LOADBALANCER_LOADBALANCER_ID`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param type:
            The value to assign to the type property of this LoadBalancerVariable.
        ...
        :param title:
            The value to assign to the title property of this LoadBalancerVariable.
        :type title: str

        :param description:
            The value to assign to the description property of this LoadBalancerVariable.
        :type description: str

        :param is_required:
            The value to assign to the is_required property of this LoadBalancerVariable.
        :type is_required: bool

        :param visible:
            The value to assign to the visible property of this LoadBalancerVariable.
        :type visible: str

        :param depends_on:
            The value to assign to the depends_on property of this LoadBalancerVariable.
        :type depends_on: oci.fleet_apps_management.models.LoadBalancerVariableDependsOn
        ...
        self.swagger_types = {
            ...
            'is_required': 'bool',
            'visible': 'str',
            'depends_on': 'LoadBalancerVariableDependsOn'
        }
        self.attribute_map = {
            'type': 'type',
            'title': 'title',
        ...
        self._type = 'OCI_LOADBALANCER_LOADBALANCER_ID'

    @property
    def depends_on(self):
        """
        Gets the depends_on of this LoadBalancerVariable.

        :return: The depends_on of this LoadBalancerVariable.
        :rtype: oci.fleet_apps_management.models.LoadBalancerVariableDependsOn
        """
    ...
    def depends_on(self, depends_on):
        """
        Sets the depends_on of this LoadBalancerVariable.

        :param depends_on: The depends_on of this LoadBalancerVariable.
        :type: oci.fleet_apps_management.models.LoadBalancerVariableDependsOn
        """
