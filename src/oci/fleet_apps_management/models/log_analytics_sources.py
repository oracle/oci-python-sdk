...
class LogAnalyticsSources(BaseVariable):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new LogAnalyticsSources object with values from keyword arguments. The default value of the :py:attr:`~oci.fleet_apps_management.models.LogAnalyticsSources.type` attribute
        of this class is ``OCI_LOGAN_SOURCE_ID`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param type:
            The value to assign to the type property of this LogAnalyticsSources.
        ...
        :param title:
            The value to assign to the title property of this LogAnalyticsSources.
        :type title: str

        :param description:
            The value to assign to the description property of this LogAnalyticsSources.
        :type description: str

        :param is_required:
            The value to assign to the is_required property of this LogAnalyticsSources.
        :type is_required: bool

        :param visible:
            The value to assign to the visible property of this LogAnalyticsSources.
        :type visible: str

        :param depends_on:
            The value to assign to the depends_on property of this LogAnalyticsSources.
        :type depends_on: oci.fleet_apps_management.models.LogAnalyticsSourcesDependsOn
        ...
        self.swagger_types = {
            ...
            'is_required': 'bool',
            'visible': 'str',
            'depends_on': 'LogAnalyticsSourcesDependsOn'
        }
        self.attribute_map = {
            'type': 'type',
            'title': 'title',
        ...
        self._type = 'OCI_LOGAN_SOURCE_ID'

    @property
    def depends_on(self):
        """
        Gets the depends_on of this LogAnalyticsSources.

        :return: The depends_on of this LogAnalyticsSources.
        :rtype: oci.fleet_apps_management.models.LogAnalyticsSourcesDependsOn
        """
    ...
    def depends_on(self, depends_on):
        """
        Sets the depends_on of this LogAnalyticsSources.

        :param depends_on: The depends_on of this LogAnalyticsSources.
        :type: oci.fleet_apps_management.models.LogAnalyticsSourcesDependsOn
        """
