...
class InstanceVariable(BaseVariable):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new InstanceVariable object with values from keyword arguments. The default value of the :py:attr:`~oci.fleet_apps_management.models.InstanceVariable.type` attribute
        of this class is ``OCI_CORE_INSTANCE_ID`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param type:
            The value to assign to the type property of this InstanceVariable.
        ...
        :param title:
            The value to assign to the title property of this InstanceVariable.
        :type title: str

        :param description:
            The value to assign to the description property of this InstanceVariable.
        :type description: str

        :param is_required:
            The value to assign to the is_required property of this InstanceVariable.
        :type is_required: bool

        :param visible:
            The value to assign to the visible property of this InstanceVariable.
        :type visible: str

        :param depends_on:
            The value to assign to the depends_on property of this InstanceVariable.
        :type depends_on: oci.fleet_apps_management.models.InstanceVariableDependsOn
        ...
        self.swagger_types = {
            ...
            'is_required': 'bool',
            'visible': 'str',
            'depends_on': 'InstanceVariableDependsOn'
        }
        self.attribute_map = {
            'type': 'type',
            'title': 'title',
        ...
        self._type = 'OCI_CORE_INSTANCE_ID'

    @property
    def depends_on(self):
        """
        Gets the depends_on of this InstanceVariable.

        :return: The depends_on of this InstanceVariable.
        :rtype: oci.fleet_apps_management.models.InstanceVariableDependsOn
        """
    ...
    def depends_on(self, depends_on):
        """
        Sets the depends_on of this InstanceVariable.

        :param depends_on: The depends_on of this InstanceVariable.
        :type: oci.fleet_apps_management.models.InstanceVariableDependsOn
        """
