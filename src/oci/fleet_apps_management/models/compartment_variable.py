...
class CompartmentVariable(BaseVariable):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new CompartmentVariable object with values from keyword arguments. The default value of the :py:attr:`~oci.fleet_apps_management.models.CompartmentVariable.type` attribute
        of this class is ``OCI_IDENTITY_COMPARTMENT_ID`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param type:
            The value to assign to the type property of this CompartmentVariable.
        ...
        :param title:
            The value to assign to the title property of this CompartmentVariable.
        :type title: str

        :param description:
            The value to assign to the description property of this CompartmentVariable.
        :type description: str

        :param is_required:
            The value to assign to the is_required property of this CompartmentVariable.
        :type is_required: bool

        :param visible:
            The value to assign to the visible property of this CompartmentVariable.
        :type visible: str

        :param default_value:
            The value to assign to the default_value property of this CompartmentVariable.
        :type default_value: str

        :param depends_on:
            The value to assign to the depends_on property of this CompartmentVariable.
        :type depends_on: object
        ...
        self._type = 'OCI_IDENTITY_COMPARTMENT_ID'

    @property
    def default_value(self):
        """
        Gets the default_value of this CompartmentVariable.
        Default value.


        :return: The default_value of this CompartmentVariable.
        :rtype: str
        """
    ...
    def default_value(self, default_value):
        """
        Sets the default_value of this CompartmentVariable.
        Default value.


        :param default_value: The default_value of this CompartmentVariable.
        :type: str
        """
    ...
    def depends_on(self):
        """
        Gets the depends_on of this CompartmentVariable.
        Depends On object.


        :return: The depends_on of this CompartmentVariable.
        :rtype: object
        """
    ...
    def depends_on(self, depends_on):
        """
        Sets the depends_on of this CompartmentVariable.
        Depends On object.


        :param depends_on: The depends_on of this CompartmentVariable.
        :type: object
        """
