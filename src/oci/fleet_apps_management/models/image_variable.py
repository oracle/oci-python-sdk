...
class ImageVariable(BaseVariable):
    """
    Image variable.
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ImageVariable object with values from keyword arguments. The default value of the :py:attr:`~oci.fleet_apps_management.models.ImageVariable.type` attribute
        of this class is ``OCI_CORE_IMAGE_ID`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param type:
            The value to assign to the type property of this ImageVariable.
        ...
        :param title:
            The value to assign to the title property of this ImageVariable.
        :type title: str

        :param description:
            The value to assign to the description property of this ImageVariable.
        :type description: str

        :param is_required:
            The value to assign to the is_required property of this ImageVariable.
        :type is_required: bool

        :param visible:
            The value to assign to the visible property of this ImageVariable.
        :type visible: str

        :param pattern:
            The value to assign to the pattern property of this ImageVariable.
        :type pattern: str

        :param depends_on:
            The value to assign to the depends_on property of this ImageVariable.
        :type depends_on: oci.fleet_apps_management.models.ImageVariableDependsOn
        ...
        self.swagger_types = {
            ...
            'visible': 'str',
            'pattern': 'str',
            'depends_on': 'ImageVariableDependsOn'
        }
        self.attribute_map = {
            'type': 'type',
            'title': 'title',
        ...
        self._type = 'OCI_CORE_IMAGE_ID'

    @property
    def pattern(self):
        """
        Gets the pattern of this ImageVariable.
        Regex pattern for allowed image references..


        :return: The pattern of this ImageVariable.
        :rtype: str
        """
    ...
    def pattern(self, pattern):
        """
        Sets the pattern of this ImageVariable.
        Regex pattern for allowed image references..


        :param pattern: The pattern of this ImageVariable.
        :type: str
        """
    ...
    def depends_on(self):
        """
        Gets the depends_on of this ImageVariable.

        :return: The depends_on of this ImageVariable.
        :rtype: oci.fleet_apps_management.models.ImageVariableDependsOn
        """
    ...
    def depends_on(self, depends_on):
        """
        Sets the depends_on of this ImageVariable.

        :param depends_on: The depends_on of this ImageVariable.
        :type: oci.fleet_apps_management.models.ImageVariableDependsOn
        """
