...
class PrivateEndpointVariable(BaseVariable):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new PrivateEndpointVariable object with values from keyword arguments. The default value of the :py:attr:`~oci.fleet_apps_management.models.PrivateEndpointVariable.type` attribute
        of this class is ``OCI_RESOURCEMANAGER_PRIVATEENDPOINT_ID`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param type:
            The value to assign to the type property of this PrivateEndpointVariable.
        ...
        :param title:
            The value to assign to the title property of this PrivateEndpointVariable.
        :type title: str

        :param description:
            The value to assign to the description property of this PrivateEndpointVariable.
        :type description: str

        :param is_required:
            The value to assign to the is_required property of this PrivateEndpointVariable.
        :type is_required: bool

        :param visible:
            The value to assign to the visible property of this PrivateEndpointVariable.
        :type visible: str

        :param depends_on:
            The value to assign to the depends_on property of this PrivateEndpointVariable.
        :type depends_on: oci.fleet_apps_management.models.PrivateEndpointVariableDependsOn
        ...
        self.swagger_types = {
            ...
            'is_required': 'bool',
            'visible': 'str',
            'depends_on': 'PrivateEndpointVariableDependsOn'
        }
        self.attribute_map = {
            'type': 'type',
            'title': 'title',
        ...
        self._type = 'OCI_RESOURCEMANAGER_PRIVATEENDPOINT_ID'

    @property
    def depends_on(self):
        """
        Gets the depends_on of this PrivateEndpointVariable.

        :return: The depends_on of this PrivateEndpointVariable.
        :rtype: oci.fleet_apps_management.models.PrivateEndpointVariableDependsOn
        """
    ...
    def depends_on(self, depends_on):
        """
        Sets the depends_on of this PrivateEndpointVariable.

        :param depends_on: The depends_on of this PrivateEndpointVariable.
        :type: oci.fleet_apps_management.models.PrivateEndpointVariableDependsOn
        """
