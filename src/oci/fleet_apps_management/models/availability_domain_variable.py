...
class AvailabilityDomainVariable(BaseVariable):
    """
    AD variable.
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new AvailabilityDomainVariable object with values from keyword arguments. The default value of the :py:attr:`~oci.fleet_apps_management.models.AvailabilityDomainVariable.type` attribute
        of this class is ``OCI_IDENTITY_AVAILABILITYDOMAIN_NAME`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param type:
            The value to assign to the type property of this AvailabilityDomainVariable.
        ...
        :param title:
            The value to assign to the title property of this AvailabilityDomainVariable.
        :type title: str

        :param description:
            The value to assign to the description property of this AvailabilityDomainVariable.
        :type description: str

        :param is_required:
            The value to assign to the is_required property of this AvailabilityDomainVariable.
        :type is_required: bool

        :param visible:
            The value to assign to the visible property of this AvailabilityDomainVariable.
        :type visible: str

        :param depends_on:
            The value to assign to the depends_on property of this AvailabilityDomainVariable.
        :type depends_on: oci.fleet_apps_management.models.AvailabilityDomainVariableDependsOn
        ...
        self.swagger_types = {
            ...
            'is_required': 'bool',
            'visible': 'str',
            'depends_on': 'AvailabilityDomainVariableDependsOn'
        }
        self.attribute_map = {
            'type': 'type',
            'title': 'title',
        ...
        self._type = 'OCI_IDENTITY_AVAILABILITYDOMAIN_NAME'

    @property
    def depends_on(self):
        """
        Gets the depends_on of this AvailabilityDomainVariable.

        :return: The depends_on of this AvailabilityDomainVariable.
        :rtype: oci.fleet_apps_management.models.AvailabilityDomainVariableDependsOn
        """
    ...
    def depends_on(self, depends_on):
        """
        Sets the depends_on of this AvailabilityDomainVariable.

        :param depends_on: The depends_on of this AvailabilityDomainVariable.
        :type: oci.fleet_apps_management.models.AvailabilityDomainVariableDependsOn
        """
