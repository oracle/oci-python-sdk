...
class KubernetesVersionsVariable(BaseVariable):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new KubernetesVersionsVariable object with values from keyword arguments. The default value of the :py:attr:`~oci.fleet_apps_management.models.KubernetesVersionsVariable.type` attribute
        of this class is ``OCI_KUBERNETES_VERSIONS_ID`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param type:
            The value to assign to the type property of this KubernetesVersionsVariable.
        ...
        :param title:
            The value to assign to the title property of this KubernetesVersionsVariable.
        :type title: str

        :param description:
            The value to assign to the description property of this KubernetesVersionsVariable.
        :type description: str

        :param is_required:
            The value to assign to the is_required property of this KubernetesVersionsVariable.
        :type is_required: bool

        :param visible:
            The value to assign to the visible property of this KubernetesVersionsVariable.
        :type visible: str

        :param depends_on:
            The value to assign to the depends_on property of this KubernetesVersionsVariable.
        :type depends_on: oci.fleet_apps_management.models.KubernetesVersionsVariableDependsOn
        ...
        self.swagger_types = {
            ...
            'is_required': 'bool',
            'visible': 'str',
            'depends_on': 'KubernetesVersionsVariableDependsOn'
        }
        self.attribute_map = {
            'type': 'type',
            'title': 'title',
        ...
        self._type = 'OCI_KUBERNETES_VERSIONS_ID'

    @property
    def depends_on(self):
        """
        Gets the depends_on of this KubernetesVersionsVariable.

        :return: The depends_on of this KubernetesVersionsVariable.
        :rtype: oci.fleet_apps_management.models.KubernetesVersionsVariableDependsOn
        """
    ...
    def depends_on(self, depends_on):
        """
        Sets the depends_on of this KubernetesVersionsVariable.

        :param depends_on: The depends_on of this KubernetesVersionsVariable.
        :type: oci.fleet_apps_management.models.KubernetesVersionsVariableDependsOn
        """
