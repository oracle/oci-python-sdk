...
class TagVariable(BaseVariable):
    """
    tag variable.
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new TagVariable object with values from keyword arguments. The default value of the :py:attr:`~oci.fleet_apps_management.models.TagVariable.type` attribute
        of this class is ``OCI_IDENTITY_TAG_VALUE`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param type:
            The value to assign to the type property of this TagVariable.
        ...
        :param title:
            The value to assign to the title property of this TagVariable.
        :type title: str

        :param description:
            The value to assign to the description property of this TagVariable.
        :type description: str

        :param is_required:
            The value to assign to the is_required property of this TagVariable.
        :type is_required: bool

        :param visible:
            The value to assign to the visible property of this TagVariable.
        :type visible: str

        :param depends_on:
            The value to assign to the depends_on property of this TagVariable.
        :type depends_on: oci.fleet_apps_management.models.TagVariableDependsOn
        ...
        self.swagger_types = {
            ...
            'is_required': 'bool',
            'visible': 'str',
            'depends_on': 'TagVariableDependsOn'
        }
        self.attribute_map = {
            'type': 'type',
            'title': 'title',
        ...
        self._type = 'OCI_IDENTITY_TAG_VALUE'

    @property
    def depends_on(self):
        """
        Gets the depends_on of this TagVariable.

        :return: The depends_on of this TagVariable.
        :rtype: oci.fleet_apps_management.models.TagVariableDependsOn
        """
    ...
    def depends_on(self, depends_on):
        """
        Sets the depends_on of this TagVariable.

        :param depends_on: The depends_on of this TagVariable.
        :type: oci.fleet_apps_management.models.TagVariableDependsOn
        """
