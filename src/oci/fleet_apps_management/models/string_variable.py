...
class StringVariable(BaseVariable):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new StringVariable object with values from keyword arguments. The default value of the :py:attr:`~oci.fleet_apps_management.models.StringVariable.type` attribute
        of this class is ``STRING`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param type:
            The value to assign to the type property of this StringVariable.
        ...
        :param title:
            The value to assign to the title property of this StringVariable.
        :type title: str

        :param description:
            The value to assign to the description property of this StringVariable.
        :type description: str

        :param is_required:
            The value to assign to the is_required property of this StringVariable.
        :type is_required: bool

        :param visible:
            The value to assign to the visible property of this StringVariable.
        :type visible: str

        :param default_value:
            The value to assign to the default_value property of this StringVariable.
        :type default_value: str

        :param pattern:
            The value to assign to the pattern property of this StringVariable.
        :type pattern: str

        :param max_length:
            The value to assign to the max_length property of this StringVariable.
        :type max_length: int

        :param min_length:
            The value to assign to the min_length property of this StringVariable.
        :type min_length: int
    ...
    def default_value(self):
        """
        Gets the default_value of this StringVariable.
        The default string value.


        :return: The default_value of this StringVariable.
        :rtype: str
        """
    ...
    def default_value(self, default_value):
        """
        Sets the default_value of this StringVariable.
        The default string value.


        :param default_value: The default_value of this StringVariable.
        :type: str
        """
    ...
    def pattern(self):
        """
        Gets the pattern of this StringVariable.
        Regex pattern that the string must match.


        :return: The pattern of this StringVariable.
        :rtype: str
        """
    ...
    def pattern(self, pattern):
        """
        Sets the pattern of this StringVariable.
        Regex pattern that the string must match.


        :param pattern: The pattern of this StringVariable.
        :type: str
        """
    ...
    def max_length(self):
        """
        Gets the max_length of this StringVariable.
        Maximum allowed length for the string.


        :return: The max_length of this StringVariable.
        :rtype: int
        """
    ...
    def max_length(self, max_length):
        """
        Sets the max_length of this StringVariable.
        Maximum allowed length for the string.


        :param max_length: The max_length of this StringVariable.
        :type: int
        """
    ...
    def min_length(self):
        """
        Gets the min_length of this StringVariable.
        Minimum allowed length for the string.


        :return: The min_length of this StringVariable.
        :rtype: int
        """
    ...
    def min_length(self, min_length):
        """
        Sets the min_length of this StringVariable.
        Minimum allowed length for the string.


        :param min_length: The min_length of this StringVariable.
        :type: int
        """
