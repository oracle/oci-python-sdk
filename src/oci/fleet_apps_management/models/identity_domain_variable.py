...
class IdentityDomainVariable(BaseVariable):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new IdentityDomainVariable object with values from keyword arguments. The default value of the :py:attr:`~oci.fleet_apps_management.models.IdentityDomainVariable.type` attribute
        of this class is ``OCI_IDENTITY_DOMAINS_ID`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param type:
            The value to assign to the type property of this IdentityDomainVariable.
        ...
        :param title:
            The value to assign to the title property of this IdentityDomainVariable.
        :type title: str

        :param description:
            The value to assign to the description property of this IdentityDomainVariable.
        :type description: str

        :param is_required:
            The value to assign to the is_required property of this IdentityDomainVariable.
        :type is_required: bool

        :param visible:
            The value to assign to the visible property of this IdentityDomainVariable.
        :type visible: str

        :param pattern:
            The value to assign to the pattern property of this IdentityDomainVariable.
        :type pattern: str

        :param depends_on:
            The value to assign to the depends_on property of this IdentityDomainVariable.
        :type depends_on: oci.fleet_apps_management.models.IdentityDomainVariableDependsOn
        ...
        self.swagger_types = {
            ...
            'visible': 'str',
            'pattern': 'str',
            'depends_on': 'IdentityDomainVariableDependsOn'
        }
        self.attribute_map = {
            'type': 'type',
            'title': 'title',
        ...
        self._type = 'OCI_IDENTITY_DOMAINS_ID'

    @property
    def pattern(self):
        """
        Gets the pattern of this IdentityDomainVariable.
        The regex pattern for valid values.


        :return: The pattern of this IdentityDomainVariable.
        :rtype: str
        """
    ...
    def pattern(self, pattern):
        """
        Sets the pattern of this IdentityDomainVariable.
        The regex pattern for valid values.


        :param pattern: The pattern of this IdentityDomainVariable.
        :type: str
        """
    ...
    def depends_on(self):
        """
        Gets the depends_on of this IdentityDomainVariable.

        :return: The depends_on of this IdentityDomainVariable.
        :rtype: oci.fleet_apps_management.models.IdentityDomainVariableDependsOn
        """
    ...
    def depends_on(self, depends_on):
        """
        Sets the depends_on of this IdentityDomainVariable.

        :param depends_on: The depends_on of this IdentityDomainVariable.
        :type: oci.fleet_apps_management.models.IdentityDomainVariableDependsOn
        """
