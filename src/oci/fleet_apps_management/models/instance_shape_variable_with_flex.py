...
class InstanceShapeVariableWithFlex(BaseVariable):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new InstanceShapeVariableWithFlex object with values from keyword arguments. The default value of the :py:attr:`~oci.fleet_apps_management.models.InstanceShapeVariableWithFlex.type` attribute
        of this class is ``OCI_CORE_INSTANCESHAPEWITHFLEX_NAME`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param type:
            The value to assign to the type property of this InstanceShapeVariableWithFlex.
        ...
        :param title:
            The value to assign to the title property of this InstanceShapeVariableWithFlex.
        :type title: str

        :param description:
            The value to assign to the description property of this InstanceShapeVariableWithFlex.
        :type description: str

        :param is_required:
            The value to assign to the is_required property of this InstanceShapeVariableWithFlex.
        :type is_required: bool

        :param visible:
            The value to assign to the visible property of this InstanceShapeVariableWithFlex.
        :type visible: str

        :param pattern:
            The value to assign to the pattern property of this InstanceShapeVariableWithFlex.
        :type pattern: str

        :param depends_on:
            The value to assign to the depends_on property of this InstanceShapeVariableWithFlex.
        :type depends_on: oci.fleet_apps_management.models.InstanceShapeVariableWithFlexDependsOn
        ...
        self.swagger_types = {
            ...
            'visible': 'str',
            'pattern': 'str',
            'depends_on': 'InstanceShapeVariableWithFlexDependsOn'
        }
        self.attribute_map = {
            'type': 'type',
            'title': 'title',
        ...
        self._type = 'OCI_CORE_INSTANCESHAPEWITHFLEX_NAME'

    @property
    def pattern(self):
        """
        Gets the pattern of this InstanceShapeVariableWithFlex.
        Regex pattern for shape values.


        :return: The pattern of this InstanceShapeVariableWithFlex.
        :rtype: str
        """
    ...
    def pattern(self, pattern):
        """
        Sets the pattern of this InstanceShapeVariableWithFlex.
        Regex pattern for shape values.


        :param pattern: The pattern of this InstanceShapeVariableWithFlex.
        :type: str
        """
    ...
    def depends_on(self):
        """
        Gets the depends_on of this InstanceShapeVariableWithFlex.

        :return: The depends_on of this InstanceShapeVariableWithFlex.
        :rtype: oci.fleet_apps_management.models.InstanceShapeVariableWithFlexDependsOn
        """
    ...
    def depends_on(self, depends_on):
        """
        Sets the depends_on of this InstanceShapeVariableWithFlex.

        :param depends_on: The depends_on of this InstanceShapeVariableWithFlex.
        :type: oci.fleet_apps_management.models.InstanceShapeVariableWithFlexDependsOn
        """
