...
class ServiceGatewayVariable(BaseVariable):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ServiceGatewayVariable object with values from keyword arguments. The default value of the :py:attr:`~oci.fleet_apps_management.models.ServiceGatewayVariable.type` attribute
        of this class is ``OCI_CORE_SERVICEGATEWAY_ID`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param type:
            The value to assign to the type property of this ServiceGatewayVariable.
        ...
        :param title:
            The value to assign to the title property of this ServiceGatewayVariable.
        :type title: str

        :param description:
            The value to assign to the description property of this ServiceGatewayVariable.
        :type description: str

        :param is_required:
            The value to assign to the is_required property of this ServiceGatewayVariable.
        :type is_required: bool

        :param visible:
            The value to assign to the visible property of this ServiceGatewayVariable.
        :type visible: str

        :param depends_on:
            The value to assign to the depends_on property of this ServiceGatewayVariable.
        :type depends_on: oci.fleet_apps_management.models.ServiceGatewayVariableDependsOn
        ...
        self.swagger_types = {
            ...
            'is_required': 'bool',
            'visible': 'str',
            'depends_on': 'ServiceGatewayVariableDependsOn'
        }
        self.attribute_map = {
            'type': 'type',
            'title': 'title',
        ...
        self._type = 'OCI_CORE_SERVICEGATEWAY_ID'

    @property
    def depends_on(self):
        """
        Gets the depends_on of this ServiceGatewayVariable.

        :return: The depends_on of this ServiceGatewayVariable.
        :rtype: oci.fleet_apps_management.models.ServiceGatewayVariableDependsOn
        """
    ...
    def depends_on(self, depends_on):
        """
        Sets the depends_on of this ServiceGatewayVariable.

        :param depends_on: The depends_on of this ServiceGatewayVariable.
        :type: oci.fleet_apps_management.models.ServiceGatewayVariableDependsOn
        """
