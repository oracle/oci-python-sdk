...
class WorkRequestSummaryCollection(object):
    ...
    def __init__(self, **kwargs):
        ...
        :type items: list[oci.fleet_apps_management.models.WorkRequestSummary]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this WorkRequestSummaryCollection.
        ...
        :rtype: list[oci.fleet_apps_management.models.WorkRequestSummary]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.fleet_apps_management.models.WorkRequestSummary]
        """
        self._items = items
