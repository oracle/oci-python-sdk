...
class GroupsVariable(BaseVariable):
    """
    Group variable.
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new GroupsVariable object with values from keyword arguments. The default value of the :py:attr:`~oci.fleet_apps_management.models.GroupsVariable.type` attribute
        of this class is ``OCI_IDENTITY_GROUPS_ID`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param type:
            The value to assign to the type property of this GroupsVariable.
        ...
        :param title:
            The value to assign to the title property of this GroupsVariable.
        :type title: str

        :param description:
            The value to assign to the description property of this GroupsVariable.
        :type description: str

        :param is_required:
            The value to assign to the is_required property of this GroupsVariable.
        :type is_required: bool

        :param visible:
            The value to assign to the visible property of this GroupsVariable.
        :type visible: str

        :param depends_on:
            The value to assign to the depends_on property of this GroupsVariable.
        :type depends_on: oci.fleet_apps_management.models.GroupsVariableDependsOn
        ...
        self.swagger_types = {
            ...
            'is_required': 'bool',
            'visible': 'str',
            'depends_on': 'GroupsVariableDependsOn'
        }
        self.attribute_map = {
            'type': 'type',
            'title': 'title',
        ...
        self._type = 'OCI_IDENTITY_GROUPS_ID'

    @property
    def depends_on(self):
        """
        Gets the depends_on of this GroupsVariable.

        :return: The depends_on of this GroupsVariable.
        :rtype: oci.fleet_apps_management.models.GroupsVariableDependsOn
        """
    ...
    def depends_on(self, depends_on):
        """
        Sets the depends_on of this GroupsVariable.

        :param depends_on: The depends_on of this GroupsVariable.
        :type: oci.fleet_apps_management.models.GroupsVariableDependsOn
        """
