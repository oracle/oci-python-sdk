...
class KmsKeyVariable(BaseVariable):
    """
    KMS key variable.
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new KmsKeyVariable object with values from keyword arguments. The default value of the :py:attr:`~oci.fleet_apps_management.models.KmsKeyVariable.type` attribute
        of this class is ``OCI_KMS_KEY_ID`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param type:
            The value to assign to the type property of this KmsKeyVariable.
        ...
        :param title:
            The value to assign to the title property of this KmsKeyVariable.
        :type title: str

        :param description:
            The value to assign to the description property of this KmsKeyVariable.
        :type description: str

        :param is_required:
            The value to assign to the is_required property of this KmsKeyVariable.
        :type is_required: bool

        :param visible:
            The value to assign to the visible property of this KmsKeyVariable.
        :type visible: str

        :param depends_on:
            The value to assign to the depends_on property of this KmsKeyVariable.
        :type depends_on: oci.fleet_apps_management.models.KmsKeyVariableDependsOn
        ...
        self.swagger_types = {
            ...
            'is_required': 'bool',
            'visible': 'str',
            'depends_on': 'KmsKeyVariableDependsOn'
        }
        self.attribute_map = {
            'type': 'type',
            'title': 'title',
        ...
        self._type = 'OCI_KMS_KEY_ID'

    @property
    def depends_on(self):
        """
        Gets the depends_on of this KmsKeyVariable.

        :return: The depends_on of this KmsKeyVariable.
        :rtype: oci.fleet_apps_management.models.KmsKeyVariableDependsOn
        """
    ...
    def depends_on(self, depends_on):
        """
        Sets the depends_on of this KmsKeyVariable.

        :param depends_on: The depends_on of this KmsKeyVariable.
        :type: oci.fleet_apps_management.models.KmsKeyVariableDependsOn
        """
