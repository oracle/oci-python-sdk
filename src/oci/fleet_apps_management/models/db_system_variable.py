...
class DbSystemVariable(BaseVariable):
    """
    DB system variable.
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new DbSystemVariable object with values from keyword arguments. The default value of the :py:attr:`~oci.fleet_apps_management.models.DbSystemVariable.type` attribute
        of this class is ``OCI_DATABASE_DBSYSTEM_ID`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param type:
            The value to assign to the type property of this DbSystemVariable.
        ...
        :param title:
            The value to assign to the title property of this DbSystemVariable.
        :type title: str

        :param description:
            The value to assign to the description property of this DbSystemVariable.
        :type description: str

        :param is_required:
            The value to assign to the is_required property of this DbSystemVariable.
        :type is_required: bool

        :param visible:
            The value to assign to the visible property of this DbSystemVariable.
        :type visible: str

        :param depends_on:
            The value to assign to the depends_on property of this DbSystemVariable.
        :type depends_on: oci.fleet_apps_management.models.DbSystemVariableDependsOn
        ...
        self.swagger_types = {
            ...
            'is_required': 'bool',
            'visible': 'str',
            'depends_on': 'DbSystemVariableDependsOn'
        }
        self.attribute_map = {
            'type': 'type',
            'title': 'title',
        ...
        self._type = 'OCI_DATABASE_DBSYSTEM_ID'

    @property
    def depends_on(self):
        """
        Gets the depends_on of this DbSystemVariable.

        :return: The depends_on of this DbSystemVariable.
        :rtype: oci.fleet_apps_management.models.DbSystemVariableDependsOn
        """
    ...
    def depends_on(self, depends_on):
        """
        Sets the depends_on of this DbSystemVariable.

        :param depends_on: The depends_on of this DbSystemVariable.
        :type: oci.fleet_apps_management.models.DbSystemVariableDependsOn
        """
