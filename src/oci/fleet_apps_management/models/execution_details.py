...
class ExecutionDetails(object):
    ...
    def __init__(self, **kwargs):
        ...
        * :class:`~oci.fleet_apps_management.models.TerraformBasedExecutionDetails`
        * :class:`~oci.fleet_apps_management.models.ApiBasedExecutionDetails`
        ...
        :param execution_type:
            ...
            Allowed values for this property are: "SCRIPT", "API", "TERRAFORM", 'UNKNOWN_ENUM_VALUE'.
    ...
    def get_subtype(object_dictionary):
        ...
        if type == 'TERRAFORM':
            return 'TerraformBasedExecutionDetails'
    ...
    def execution_type(self, execution_type):
        ...
        :type: str
        """
        allowed_values = ["SCRIPT", "API", "TERRAFORM"]
