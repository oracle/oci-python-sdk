...
class DatetimeVariable(BaseVariable):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new DatetimeVariable object with values from keyword arguments. The default value of the :py:attr:`~oci.fleet_apps_management.models.DatetimeVariable.type` attribute
        of this class is ``DATETIME`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param type:
            The value to assign to the type property of this DatetimeVariable.
        ...
        :param title:
            The value to assign to the title property of this DatetimeVariable.
        :type title: str

        :param description:
            The value to assign to the description property of this DatetimeVariable.
        :type description: str

        :param is_required:
            The value to assign to the is_required property of this DatetimeVariable.
        :type is_required: bool

        :param visible:
            The value to assign to the visible property of this DatetimeVariable.
        :type visible: str

        :param default_value:
            The value to assign to the default_value property of this DatetimeVariable.
    ...
    def default_value(self):
        """
        Gets the default_value of this DatetimeVariable.
        Default value for date/time input.


        :return: The default_value of this DatetimeVariable.
        :rtype: str
        """
    ...
    def default_value(self, default_value):
        """
        Sets the default_value of this DatetimeVariable.
        Default value for date/time input.


        :param default_value: The default_value of this DatetimeVariable.
        :type: str
        """
