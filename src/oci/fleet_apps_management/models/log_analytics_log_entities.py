...
class LogAnalyticsLogEntities(BaseVariable):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new LogAnalyticsLogEntities object with values from keyword arguments. The default value of the :py:attr:`~oci.fleet_apps_management.models.LogAnalyticsLogEntities.type` attribute
        of this class is ``OCI_LOGAN_LOGENTITY_ID`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param type:
            The value to assign to the type property of this LogAnalyticsLogEntities.
        ...
        :param title:
            The value to assign to the title property of this LogAnalyticsLogEntities.
        :type title: str

        :param description:
            The value to assign to the description property of this LogAnalyticsLogEntities.
        :type description: str

        :param is_required:
            The value to assign to the is_required property of this LogAnalyticsLogEntities.
        :type is_required: bool

        :param visible:
            The value to assign to the visible property of this LogAnalyticsLogEntities.
        :type visible: str

        :param depends_on:
            The value to assign to the depends_on property of this LogAnalyticsLogEntities.
        :type depends_on: oci.fleet_apps_management.models.LogAnalyticsLogEntitiesDependsOn
        ...
        self.swagger_types = {
            ...
            'is_required': 'bool',
            'visible': 'str',
            'depends_on': 'LogAnalyticsLogEntitiesDependsOn'
        }
        self.attribute_map = {
            'type': 'type',
            'title': 'title',
        ...
        self._type = 'OCI_LOGAN_LOGENTITY_ID'

    @property
    def depends_on(self):
        """
        Gets the depends_on of this LogAnalyticsLogEntities.

        :return: The depends_on of this LogAnalyticsLogEntities.
        :rtype: oci.fleet_apps_management.models.LogAnalyticsLogEntitiesDependsOn
        """
    ...
    def depends_on(self, depends_on):
        """
        Sets the depends_on of this LogAnalyticsLogEntities.

        :param depends_on: The depends_on of this LogAnalyticsLogEntities.
        :type: oci.fleet_apps_management.models.LogAnalyticsLogEntitiesDependsOn
        """
