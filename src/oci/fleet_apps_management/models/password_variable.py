...
class PasswordVariable(BaseVariable):
    """
    Password variable.
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new PasswordVariable object with values from keyword arguments. The default value of the :py:attr:`~oci.fleet_apps_management.models.PasswordVariable.type` attribute
        of this class is ``PASSWORD`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param type:
            The value to assign to the type property of this PasswordVariable.
        ...
        :param title:
            The value to assign to the title property of this PasswordVariable.
        :type title: str

        :param description:
            The value to assign to the description property of this PasswordVariable.
        :type description: str

        :param is_required:
            The value to assign to the is_required property of this PasswordVariable.
        :type is_required: bool

        :param visible:
            The value to assign to the visible property of this PasswordVariable.
        :type visible: str

        :param default_value:
            The value to assign to the default_value property of this PasswordVariable.
        :type default_value: str

        :param confirmation:
            The value to assign to the confirmation property of this PasswordVariable.
    ...
    def default_value(self):
        """
        Gets the default_value of this PasswordVariable.
        he default value to populate for the password variable.


        :return: The default_value of this PasswordVariable.
        :rtype: str
        """
    ...
    def default_value(self, default_value):
        """
        Sets the default_value of this PasswordVariable.
        he default value to populate for the password variable.


        :param default_value: The default_value of this PasswordVariable.
        :type: str
        """
    ...
    def confirmation(self):
        """
        Gets the confirmation of this PasswordVariable.
        Confirmation string for password validation.


        :return: The confirmation of this PasswordVariable.
        :rtype: str
        """
    ...
    def confirmation(self, confirmation):
        """
        Sets the confirmation of this PasswordVariable.
        Confirmation string for password validation.


        :param confirmation: The confirmation of this PasswordVariable.
        :type: str
        """
