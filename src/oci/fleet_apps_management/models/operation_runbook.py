...
class OperationRunbook(object):
    ...
    def __init__(self, **kwargs):
        ...
        :param runbook_id:
            The value to assign to the runbook_id property of this OperationRunbook.
        :type runbook_id: str

        :param runbook_version_name:
            The value to assign to the runbook_version_name property of this OperationRunbook.
    ...
    def runbook_id(self):
        """
        **[Required]** Gets the runbook_id of this OperationRunbook.
        The ID of the Runbook


        :return: The runbook_id of this OperationRunbook.
        :rtype: str
        """
    ...
    def runbook_id(self, runbook_id):
        """
        Sets the runbook_id of this OperationRunbook.
        The ID of the Runbook


        :param runbook_id: The runbook_id of this OperationRunbook.
        :type: str
        """
    ...
    def runbook_version_name(self):
        """
        **[Required]** Gets the runbook_version_name of this OperationRunbook.
        The runbook version name


        :return: The runbook_version_name of this OperationRunbook.
        :rtype: str
        """
    ...
    def runbook_version_name(self, runbook_version_name):
        """
        Sets the runbook_version_name of this OperationRunbook.
        The runbook version name


        :param runbook_version_name: The runbook_version_name of this OperationRunbook.
        :type: str
        """
