...
class RegionVariable(BaseVariable):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new RegionVariable object with values from keyword arguments. The default value of the :py:attr:`~oci.fleet_apps_management.models.RegionVariable.type` attribute
        of this class is ``OCI_IDENTITY_REGION_NAME`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param type:
            The value to assign to the type property of this RegionVariable.
        ...
        :param title:
            The value to assign to the title property of this RegionVariable.
        :type title: str

        :param description:
            The value to assign to the description property of this RegionVariable.
        :type description: str

        :param is_required:
            The value to assign to the is_required property of this RegionVariable.
        :type is_required: bool

        :param visible:
            The value to assign to the visible property of this RegionVariable.
        :type visible: str

        :param default_value:
            The value to assign to the default_value property of this RegionVariable.
        ...
        self._type = 'OCI_IDENTITY_REGION_NAME'

    @property
    def default_value(self):
        """
        Gets the default_value of this RegionVariable.
        default region value .


        :return: The default_value of this RegionVariable.
        :rtype: str
        """
    ...
    def default_value(self, default_value):
        """
        Sets the default_value of this RegionVariable.
        default region value .


        :param default_value: The default_value of this RegionVariable.
        :type: str
        """
