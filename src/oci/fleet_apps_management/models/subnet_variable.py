...
class SubnetVariable(BaseVariable):
    """
    Subnet variable.
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new SubnetVariable object with values from keyword arguments. The default value of the :py:attr:`~oci.fleet_apps_management.models.SubnetVariable.type` attribute
        of this class is ``OCI_CORE_SUBNET_ID`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param type:
            The value to assign to the type property of this SubnetVariable.
        ...
        :param title:
            The value to assign to the title property of this SubnetVariable.
        :type title: str

        :param description:
            The value to assign to the description property of this SubnetVariable.
        :type description: str

        :param is_required:
            The value to assign to the is_required property of this SubnetVariable.
        :type is_required: bool

        :param visible:
            The value to assign to the visible property of this SubnetVariable.
        :type visible: str

        :param depends_on:
            The value to assign to the depends_on property of this SubnetVariable.
        :type depends_on: oci.fleet_apps_management.models.SubnetVariableDependsOn
        ...
        self.swagger_types = {
            ...
            'is_required': 'bool',
            'visible': 'str',
            'depends_on': 'SubnetVariableDependsOn'
        }
        self.attribute_map = {
            'type': 'type',
            'title': 'title',
        ...
        self._type = 'OCI_CORE_SUBNET_ID'

    @property
    def depends_on(self):
        """
        Gets the depends_on of this SubnetVariable.

        :return: The depends_on of this SubnetVariable.
        :rtype: oci.fleet_apps_management.models.SubnetVariableDependsOn
        """
    ...
    def depends_on(self, depends_on):
        """
        Sets the depends_on of this SubnetVariable.

        :param depends_on: The depends_on of this SubnetVariable.
        :type: oci.fleet_apps_management.models.SubnetVariableDependsOn
        """
