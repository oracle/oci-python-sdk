...
class CompliancePolicyRule(object):
    """
    ...
    #: A constant which can be used with the severity property of a CompliancePolicyRule.
    ...
    #: A constant which can be used with the lifecycle_state property of a CompliancePolicyRule.
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new CompliancePolicyRule object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param id:
            The value to assign to the id property of this CompliancePolicyRule.
        :type id: str

        :param display_name:
            The value to assign to the display_name property of this CompliancePolicyRule.
        :type display_name: str

        :param compliance_policy_id:
            The value to assign to the compliance_policy_id property of this CompliancePolicyRule.
        :type compliance_policy_id: str

        :param product_version:
            The value to assign to the product_version property of this CompliancePolicyRule.
        :type product_version: oci.fleet_apps_management.models.ProductVersionDetails

        :param patch_type_id:
            The value to assign to the patch_type_id property of this CompliancePolicyRule.
        :type patch_type_id: list[str]

        :param severity:
            The value to assign to the severity property of this CompliancePolicyRule.
        ...
        :param patch_selection:
            The value to assign to the patch_selection property of this CompliancePolicyRule.
        :type patch_selection: oci.fleet_apps_management.models.PatchSelectionDetails

        :param grace_period:
            The value to assign to the grace_period property of this CompliancePolicyRule.
        :type grace_period: str

        :param compartment_id:
            The value to assign to the compartment_id property of this CompliancePolicyRule.
        :type compartment_id: str

        :param time_created:
            The value to assign to the time_created property of this CompliancePolicyRule.
        :type time_created: datetime

        :param time_updated:
            The value to assign to the time_updated property of this CompliancePolicyRule.
        :type time_updated: datetime

        :param lifecycle_state:
            The value to assign to the lifecycle_state property of this CompliancePolicyRule.
            Allowed values for this property are: "CREATING", "UPDATING", "ACTIVE", "DELETING", "DELETED", "FAILED", 'UNKNOWN_ENUM_VALUE'.
            Any unrecognized values returned by a service will be mapped to 'UNKNOWN_ENUM_VALUE'.
        :type lifecycle_state: str

        :param lifecycle_details:
            The value to assign to the lifecycle_details property of this CompliancePolicyRule.
        :type lifecycle_details: str

        :param freeform_tags:
            The value to assign to the freeform_tags property of this CompliancePolicyRule.
        :type freeform_tags: dict(str, str)

        :param defined_tags:
            The value to assign to the defined_tags property of this CompliancePolicyRule.
        :type defined_tags: dict(str, dict(str, object))

        :param system_tags:
            The value to assign to the system_tags property of this CompliancePolicyRule.
    ...
    def patch_type_id(self):
        """
        **[Required]** Gets the patch_type_id of this CompliancePolicyRule.
        PlatformConfiguration OCID for the patch type to which this CompliancePolicyRule applies.


        :return: The patch_type_id of this CompliancePolicyRule.
        :rtype: list[str]
        """
    ...
    def patch_type_id(self, patch_type_id):
        """
        Sets the patch_type_id of this CompliancePolicyRule.
        PlatformConfiguration OCID for the patch type to which this CompliancePolicyRule applies.


        :param patch_type_id: The patch_type_id of this CompliancePolicyRule.
        :type: list[str]
        """
