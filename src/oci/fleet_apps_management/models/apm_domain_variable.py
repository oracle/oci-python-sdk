...
class ApmDomainVariable(BaseVariable):
    """
    APM domain variable.
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ApmDomainVariable object with values from keyword arguments. The default value of the :py:attr:`~oci.fleet_apps_management.models.ApmDomainVariable.type` attribute
        of this class is ``OCI_APM_DOMAIN_ID`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param type:
            The value to assign to the type property of this ApmDomainVariable.
        ...
        :param title:
            The value to assign to the title property of this ApmDomainVariable.
        :type title: str

        :param description:
            The value to assign to the description property of this ApmDomainVariable.
        :type description: str

        :param is_required:
            The value to assign to the is_required property of this ApmDomainVariable.
        :type is_required: bool

        :param visible:
            The value to assign to the visible property of this ApmDomainVariable.
        :type visible: str
