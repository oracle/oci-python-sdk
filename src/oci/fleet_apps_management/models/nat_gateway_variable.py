...
class NatGatewayVariable(BaseVariable):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new NatGatewayVariable object with values from keyword arguments. The default value of the :py:attr:`~oci.fleet_apps_management.models.NatGatewayVariable.type` attribute
        of this class is ``OCI_CORE_NATGATEWAY_ID`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param type:
            The value to assign to the type property of this NatGatewayVariable.
        ...
        :param title:
            The value to assign to the title property of this NatGatewayVariable.
        :type title: str

        :param description:
            The value to assign to the description property of this NatGatewayVariable.
        :type description: str

        :param is_required:
            The value to assign to the is_required property of this NatGatewayVariable.
        :type is_required: bool

        :param visible:
            The value to assign to the visible property of this NatGatewayVariable.
        :type visible: str

        :param depends_on:
            The value to assign to the depends_on property of this NatGatewayVariable.
        :type depends_on: oci.fleet_apps_management.models.NatGatewayVariableDependsOn
        ...
        self.swagger_types = {
            ...
            'is_required': 'bool',
            'visible': 'str',
            'depends_on': 'NatGatewayVariableDependsOn'
        }
        self.attribute_map = {
            'type': 'type',
            'title': 'title',
        ...
        self._type = 'OCI_CORE_NATGATEWAY_ID'

    @property
    def depends_on(self):
        """
        Gets the depends_on of this NatGatewayVariable.

        :return: The depends_on of this NatGatewayVariable.
        :rtype: oci.fleet_apps_management.models.NatGatewayVariableDependsOn
        """
    ...
    def depends_on(self, depends_on):
        """
        Sets the depends_on of this NatGatewayVariable.

        :param depends_on: The depends_on of this NatGatewayVariable.
        :type: oci.fleet_apps_management.models.NatGatewayVariableDependsOn
        """
