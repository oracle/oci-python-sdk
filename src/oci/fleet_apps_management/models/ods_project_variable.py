...
class OdsProjectVariable(BaseVariable):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new OdsProjectVariable object with values from keyword arguments. The default value of the :py:attr:`~oci.fleet_apps_management.models.OdsProjectVariable.type` attribute
        of this class is ``OCI_ODS_PROJECT_ID`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param type:
            The value to assign to the type property of this OdsProjectVariable.
        ...
        :param title:
            The value to assign to the title property of this OdsProjectVariable.
        :type title: str

        :param description:
            The value to assign to the description property of this OdsProjectVariable.
        :type description: str

        :param is_required:
            The value to assign to the is_required property of this OdsProjectVariable.
        :type is_required: bool

        :param visible:
            The value to assign to the visible property of this OdsProjectVariable.
        :type visible: str

        :param depends_on:
            The value to assign to the depends_on property of this OdsProjectVariable.
        :type depends_on: oci.fleet_apps_management.models.OdsProjectVariableDependsOn
        ...
        self.swagger_types = {
            ...
            'is_required': 'bool',
            'visible': 'str',
            'depends_on': 'OdsProjectVariableDependsOn'
        }
        self.attribute_map = {
            'type': 'type',
            'title': 'title',
        ...
        self._type = 'OCI_ODS_PROJECT_ID'

    @property
    def depends_on(self):
        """
        Gets the depends_on of this OdsProjectVariable.

        :return: The depends_on of this OdsProjectVariable.
        :rtype: oci.fleet_apps_management.models.OdsProjectVariableDependsOn
        """
    ...
    def depends_on(self, depends_on):
        """
        Sets the depends_on of this OdsProjectVariable.

        :param depends_on: The depends_on of this OdsProjectVariable.
        :type: oci.fleet_apps_management.models.OdsProjectVariableDependsOn
        """
