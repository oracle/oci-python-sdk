...
class DbHomeVariable(BaseVariable):
    """
    DB home variable.
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new DbHomeVariable object with values from keyword arguments. The default value of the :py:attr:`~oci.fleet_apps_management.models.DbHomeVariable.type` attribute
        of this class is ``OCI_DATABASE_DBHOME_ID`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param type:
            The value to assign to the type property of this DbHomeVariable.
        ...
        :param title:
            The value to assign to the title property of this DbHomeVariable.
        :type title: str

        :param description:
            The value to assign to the description property of this DbHomeVariable.
        :type description: str

        :param is_required:
            The value to assign to the is_required property of this DbHomeVariable.
        :type is_required: bool

        :param visible:
            The value to assign to the visible property of this DbHomeVariable.
        :type visible: str

        :param depends_on:
            The value to assign to the depends_on property of this DbHomeVariable.
        :type depends_on: oci.fleet_apps_management.models.DbHomeVariableDependsOn
        ...
        self.swagger_types = {
            ...
            'is_required': 'bool',
            'visible': 'str',
            'depends_on': 'DbHomeVariableDependsOn'
        }
        self.attribute_map = {
            'type': 'type',
            'title': 'title',
        ...
        self._type = 'OCI_DATABASE_DBHOME_ID'

    @property
    def depends_on(self):
        """
        Gets the depends_on of this DbHomeVariable.

        :return: The depends_on of this DbHomeVariable.
        :rtype: oci.fleet_apps_management.models.DbHomeVariableDependsOn
        """
    ...
    def depends_on(self, depends_on):
        """
        Sets the depends_on of this DbHomeVariable.

        :param depends_on: The depends_on of this DbHomeVariable.
        :type: oci.fleet_apps_management.models.DbHomeVariableDependsOn
        """
