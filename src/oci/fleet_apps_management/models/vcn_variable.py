...
class VcnVariable(BaseVariable):
    """
    VCN variable.
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new VcnVariable object with values from keyword arguments. The default value of the :py:attr:`~oci.fleet_apps_management.models.VcnVariable.type` attribute
        of this class is ``OCI_CORE_VCN_ID`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param type:
            The value to assign to the type property of this VcnVariable.
        ...
        :param title:
            The value to assign to the title property of this VcnVariable.
        :type title: str

        :param description:
            The value to assign to the description property of this VcnVariable.
        :type description: str

        :param is_required:
            The value to assign to the is_required property of this VcnVariable.
        :type is_required: bool

        :param visible:
            The value to assign to the visible property of this VcnVariable.
        :type visible: str

        :param depends_on:
            The value to assign to the depends_on property of this VcnVariable.
        :type depends_on: oci.fleet_apps_management.models.VcnVariableDependsOn
        ...
        self.swagger_types = {
            ...
            'is_required': 'bool',
            'visible': 'str',
            'depends_on': 'VcnVariableDependsOn'
        }
        self.attribute_map = {
            'type': 'type',
            'title': 'title',
    ...
    def depends_on(self):
        ...
        :return: The depends_on of this VcnVariable.
        :rtype: oci.fleet_apps_management.models.VcnVariableDependsOn
        """
    ...
    def depends_on(self, depends_on):
        """
        Sets the depends_on of this VcnVariable.

        :param depends_on: The depends_on of this VcnVariable.
        :type: oci.fleet_apps_management.models.VcnVariableDependsOn
        """
