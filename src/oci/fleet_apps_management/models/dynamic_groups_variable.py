...
class DynamicGroupsVariable(BaseVariable):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new DynamicGroupsVariable object with values from keyword arguments. The default value of the :py:attr:`~oci.fleet_apps_management.models.DynamicGroupsVariable.type` attribute
        of this class is ``OCI_IDENTITY_DYNAMICGROUPS_ID`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param type:
            The value to assign to the type property of this DynamicGroupsVariable.
        ...
        :param title:
            The value to assign to the title property of this DynamicGroupsVariable.
        :type title: str

        :param description:
            The value to assign to the description property of this DynamicGroupsVariable.
        :type description: str

        :param is_required:
            The value to assign to the is_required property of this DynamicGroupsVariable.
        :type is_required: bool

        :param visible:
            The value to assign to the visible property of this DynamicGroupsVariable.
        :type visible: str

        :param depends_on:
            The value to assign to the depends_on property of this DynamicGroupsVariable.
        :type depends_on: oci.fleet_apps_management.models.DynamicGroupsVariableDependsOn
        ...
        self.swagger_types = {
            ...
            'is_required': 'bool',
            'visible': 'str',
            'depends_on': 'DynamicGroupsVariableDependsOn'
        }
        self.attribute_map = {
            'type': 'type',
            'title': 'title',
        ...
        self._type = 'OCI_IDENTITY_DYNAMICGROUPS_ID'

    @property
    def depends_on(self):
        """
        Gets the depends_on of this DynamicGroupsVariable.

        :return: The depends_on of this DynamicGroupsVariable.
        :rtype: oci.fleet_apps_management.models.DynamicGroupsVariableDependsOn
        """
    ...
    def depends_on(self, depends_on):
        """
        Sets the depends_on of this DynamicGroupsVariable.

        :param depends_on: The depends_on of this DynamicGroupsVariable.
        :type: oci.fleet_apps_management.models.DynamicGroupsVariableDependsOn
        """
