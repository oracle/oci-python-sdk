...
class MysqlShapeId(BaseVariable):
    """
    Mysql shape Id.
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new MysqlShapeId object with values from keyword arguments. The default value of the :py:attr:`~oci.fleet_apps_management.models.MysqlShapeId.type` attribute
        of this class is ``OCI_DATABASE_MYSQL_SHAPE_ID`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param type:
            The value to assign to the type property of this MysqlShapeId.
        ...
        :param title:
            The value to assign to the title property of this MysqlShapeId.
        :type title: str

        :param description:
            The value to assign to the description property of this MysqlShapeId.
        :type description: str

        :param is_required:
            The value to assign to the is_required property of this MysqlShapeId.
        :type is_required: bool

        :param visible:
            The value to assign to the visible property of this MysqlShapeId.
        :type visible: str
        ...
        self._visible = None
        self._type = 'OCI_DATABASE_MYSQL_SHAPE_ID'
