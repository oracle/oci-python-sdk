...
class ContentDetails(object):
    ...
    def __init__(self, **kwargs):
        ...
        * :class:`~oci.fleet_apps_management.models.CatalogContentDetails`
        * :class:`~oci.fleet_apps_management.models.ObjectStorageBucketContentDetails`
        ...
        :param source_type:
            ...
            Allowed values for this property are: "OBJECT_STORAGE_BUCKET", "CATALOG", 'UNKNOWN_ENUM_VALUE'.
    ...
    def source_type(self, source_type):
        ...
        :type: str
        """
        allowed_values = ["OBJECT_STORAGE_BUCKET", "CATALOG"]
