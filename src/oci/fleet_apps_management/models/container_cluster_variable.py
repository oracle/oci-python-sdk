...
class ContainerClusterVariable(BaseVariable):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ContainerClusterVariable object with values from keyword arguments. The default value of the :py:attr:`~oci.fleet_apps_management.models.ContainerClusterVariable.type` attribute
        of this class is ``OCI_CONTAINER_CLUSTER_ID`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param type:
            The value to assign to the type property of this ContainerClusterVariable.
        ...
        :param title:
            The value to assign to the title property of this ContainerClusterVariable.
        :type title: str

        :param description:
            The value to assign to the description property of this ContainerClusterVariable.
        :type description: str

        :param is_required:
            The value to assign to the is_required property of this ContainerClusterVariable.
        :type is_required: bool

        :param visible:
            The value to assign to the visible property of this ContainerClusterVariable.
        :type visible: str

        :param depends_on:
            The value to assign to the depends_on property of this ContainerClusterVariable.
        :type depends_on: oci.fleet_apps_management.models.ContainerClusterVariableDependsOn
        ...
        self.swagger_types = {
            ...
            'is_required': 'bool',
            'visible': 'str',
            'depends_on': 'ContainerClusterVariableDependsOn'
        }
        self.attribute_map = {
            'type': 'type',
            'title': 'title',
        ...
        self._type = 'OCI_CONTAINER_CLUSTER_ID'

    @property
    def depends_on(self):
        """
        Gets the depends_on of this ContainerClusterVariable.

        :return: The depends_on of this ContainerClusterVariable.
        :rtype: oci.fleet_apps_management.models.ContainerClusterVariableDependsOn
        """
    ...
    def depends_on(self, depends_on):
        """
        Sets the depends_on of this ContainerClusterVariable.

        :param depends_on: The depends_on of this ContainerClusterVariable.
        :type: oci.fleet_apps_management.models.ContainerClusterVariableDependsOn
        """
