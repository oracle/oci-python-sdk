...
class BooleanVariable(BaseVariable):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new BooleanVariable object with values from keyword arguments. The default value of the :py:attr:`~oci.fleet_apps_management.models.BooleanVariable.type` attribute
        of this class is ``BOOLEAN`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param type:
            The value to assign to the type property of this BooleanVariable.
        ...
        :param title:
            The value to assign to the title property of this BooleanVariable.
        :type title: str

        :param description:
            The value to assign to the description property of this BooleanVariable.
        :type description: str

        :param is_required:
            The value to assign to the is_required property of this BooleanVariable.
        :type is_required: bool

        :param visible:
            The value to assign to the visible property of this BooleanVariable.
        :type visible: str

        :param default_value:
            The value to assign to the default_value property of this BooleanVariable.
    ...
    def default_value(self):
        """
        Gets the default_value of this BooleanVariable.
        The default boolean value if none is provided.


        :return: The default_value of this BooleanVariable.
        :rtype: bool
        """
    ...
    def default_value(self, default_value):
        """
        Sets the default_value of this BooleanVariable.
        The default boolean value if none is provided.


        :param default_value: The default_value of this BooleanVariable.
        :type: bool
        """
