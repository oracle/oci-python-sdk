...
class PropertyCollection(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new PropertyCollection object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param items:
            The value to assign to the items property of this PropertyCollection.
        :type items: list[oci.fleet_apps_management.models.PropertySummary]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this PropertyCollection.
        ...
        :rtype: list[oci.fleet_apps_management.models.PropertySummary]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.fleet_apps_management.models.PropertySummary]
        """
        self._items = items
