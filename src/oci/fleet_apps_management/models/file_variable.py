...
class FileVariable(BaseVariable):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new FileVariable object with values from keyword arguments. The default value of the :py:attr:`~oci.fleet_apps_management.models.FileVariable.type` attribute
        of this class is ``FILE`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param type:
            The value to assign to the type property of this FileVariable.
        ...
        :param title:
            The value to assign to the title property of this FileVariable.
        :type title: str

        :param description:
            The value to assign to the description property of this FileVariable.
        :type description: str

        :param is_required:
            The value to assign to the is_required property of this FileVariable.
        :type is_required: bool

        :param visible:
            The value to assign to the visible property of this FileVariable.
        :type visible: str
