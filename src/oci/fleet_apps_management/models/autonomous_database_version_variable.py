...
class AutonomousDatabaseVersionVariable(BaseVariable):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new AutonomousDatabaseVersionVariable object with values from keyword arguments. The default value of the :py:attr:`~oci.fleet_apps_management.models.AutonomousDatabaseVersionVariable.type` attribute
        of this class is ``OCI_DATABASE_AUTONOMOUSDATABASEVERSION_ID`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param type:
            The value to assign to the type property of this AutonomousDatabaseVersionVariable.
        ...
        :param title:
            The value to assign to the title property of this AutonomousDatabaseVersionVariable.
        :type title: str

        :param description:
            The value to assign to the description property of this AutonomousDatabaseVersionVariable.
        :type description: str

        :param is_required:
            The value to assign to the is_required property of this AutonomousDatabaseVersionVariable.
        :type is_required: bool

        :param visible:
            The value to assign to the visible property of this AutonomousDatabaseVersionVariable.
        :type visible: str

        :param depends_on:
            The value to assign to the depends_on property of this AutonomousDatabaseVersionVariable.
        :type depends_on: oci.fleet_apps_management.models.AutonomousDatabaseVersionVariableDependsOn
        ...
        self.swagger_types = {
            ...
            'is_required': 'bool',
            'visible': 'str',
            'depends_on': 'AutonomousDatabaseVersionVariableDependsOn'
        }
        self.attribute_map = {
            'type': 'type',
            'title': 'title',
        ...
        self._type = 'OCI_DATABASE_AUTONOMOUSDATABASEVERSION_ID'

    @property
    def depends_on(self):
        """
        Gets the depends_on of this AutonomousDatabaseVersionVariable.

        :return: The depends_on of this AutonomousDatabaseVersionVariable.
        :rtype: oci.fleet_apps_management.models.AutonomousDatabaseVersionVariableDependsOn
        """
    ...
    def depends_on(self, depends_on):
        """
        Sets the depends_on of this AutonomousDatabaseVersionVariable.

        :param depends_on: The depends_on of this AutonomousDatabaseVersionVariable.
        :type: oci.fleet_apps_management.models.AutonomousDatabaseVersionVariableDependsOn
        """
