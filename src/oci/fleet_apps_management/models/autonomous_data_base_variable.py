...
class AutonomousDataBaseVariable(BaseVariable):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new AutonomousDataBaseVariable object with values from keyword arguments. The default value of the :py:attr:`~oci.fleet_apps_management.models.AutonomousDataBaseVariable.type` attribute
        of this class is ``OCI_DATABASE_AUTONOMOUSDATABASE_ID`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param type:
            The value to assign to the type property of this AutonomousDataBaseVariable.
        ...
        :param title:
            The value to assign to the title property of this AutonomousDataBaseVariable.
        :type title: str

        :param description:
            The value to assign to the description property of this AutonomousDataBaseVariable.
        :type description: str

        :param is_required:
            The value to assign to the is_required property of this AutonomousDataBaseVariable.
        :type is_required: bool

        :param visible:
            The value to assign to the visible property of this AutonomousDataBaseVariable.
        :type visible: str

        :param depends_on:
            The value to assign to the depends_on property of this AutonomousDataBaseVariable.
        :type depends_on: oci.fleet_apps_management.models.AutonomousDataBaseVariableDependsOn
        ...
        self.swagger_types = {
            ...
            'is_required': 'bool',
            'visible': 'str',
            'depends_on': 'AutonomousDataBaseVariableDependsOn'
        }
        self.attribute_map = {
            'type': 'type',
            'title': 'title',
        ...
        self._type = 'OCI_DATABASE_AUTONOMOUSDATABASE_ID'

    @property
    def depends_on(self):
        """
        Gets the depends_on of this AutonomousDataBaseVariable.

        :return: The depends_on of this AutonomousDataBaseVariable.
        :rtype: oci.fleet_apps_management.models.AutonomousDataBaseVariableDependsOn
        """
    ...
    def depends_on(self, depends_on):
        """
        Sets the depends_on of this AutonomousDataBaseVariable.

        :param depends_on: The depends_on of this AutonomousDataBaseVariable.
        :type: oci.fleet_apps_management.models.AutonomousDataBaseVariableDependsOn
        """
