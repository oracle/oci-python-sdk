...
class DbHomeVersionVariable(BaseVariable):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new DbHomeVersionVariable object with values from keyword arguments. The default value of the :py:attr:`~oci.fleet_apps_management.models.DbHomeVersionVariable.type` attribute
        of this class is ``OCI_DATABASE_DBHOME_DBVERSION`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param type:
            The value to assign to the type property of this DbHomeVersionVariable.
        ...
        :param title:
            The value to assign to the title property of this DbHomeVersionVariable.
        :type title: str

        :param description:
            The value to assign to the description property of this DbHomeVersionVariable.
        :type description: str

        :param is_required:
            The value to assign to the is_required property of this DbHomeVersionVariable.
        :type is_required: bool

        :param visible:
            The value to assign to the visible property of this DbHomeVersionVariable.
        :type visible: str

        :param depends_on:
            The value to assign to the depends_on property of this DbHomeVersionVariable.
        :type depends_on: oci.fleet_apps_management.models.DbHomeVersionVariableDependsOn
        ...
        self.swagger_types = {
            ...
            'is_required': 'bool',
            'visible': 'str',
            'depends_on': 'DbHomeVersionVariableDependsOn'
        }
        self.attribute_map = {
            'type': 'type',
            'title': 'title',
        ...
        self._type = 'OCI_DATABASE_DBHOME_DBVERSION'

    @property
    def depends_on(self):
        """
        Gets the depends_on of this DbHomeVersionVariable.

        :return: The depends_on of this DbHomeVersionVariable.
        :rtype: oci.fleet_apps_management.models.DbHomeVersionVariableDependsOn
        """
    ...
    def depends_on(self, depends_on):
        """
        Sets the depends_on of this DbHomeVersionVariable.

        :param depends_on: The depends_on of this DbHomeVersionVariable.
        :type: oci.fleet_apps_management.models.DbHomeVersionVariableDependsOn
        """
