...
class ManagementAgents(BaseVariable):
    """
    Management agent.
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ManagementAgents object with values from keyword arguments. The default value of the :py:attr:`~oci.fleet_apps_management.models.ManagementAgents.type` attribute
        of this class is ``OCI_MGMT_AGENT_ID`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param type:
            The value to assign to the type property of this ManagementAgents.
        ...
        :param title:
            The value to assign to the title property of this ManagementAgents.
        :type title: str

        :param description:
            The value to assign to the description property of this ManagementAgents.
        :type description: str

        :param is_required:
            The value to assign to the is_required property of this ManagementAgents.
        :type is_required: bool

        :param visible:
            The value to assign to the visible property of this ManagementAgents.
        :type visible: str

        :param depends_on:
            The value to assign to the depends_on property of this ManagementAgents.
        :type depends_on: oci.fleet_apps_management.models.ManagementAgentDependsOn
        ...
        self.swagger_types = {
            ...
            'is_required': 'bool',
            'visible': 'str',
            'depends_on': 'ManagementAgentDependsOn'
        }
        self.attribute_map = {
            'type': 'type',
            'title': 'title',
        ...
        self._type = 'OCI_MGMT_AGENT_ID'

    @property
    def depends_on(self):
        """
        Gets the depends_on of this ManagementAgents.

        :return: The depends_on of this ManagementAgents.
        :rtype: oci.fleet_apps_management.models.ManagementAgentDependsOn
        """
    ...
    def depends_on(self, depends_on):
        """
        Sets the depends_on of this ManagementAgents.

        :param depends_on: The depends_on of this ManagementAgents.
        :type: oci.fleet_apps_management.models.ManagementAgentDependsOn
        """
