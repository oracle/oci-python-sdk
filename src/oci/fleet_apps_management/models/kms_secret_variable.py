...
class KmsSecretVariable(BaseVariable):
    """
    KMS secret variable.
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new KmsSecretVariable object with values from keyword arguments. The default value of the :py:attr:`~oci.fleet_apps_management.models.KmsSecretVariable.type` attribute
        of this class is ``OCI_KMS_SECRET_ID`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param type:
            The value to assign to the type property of this KmsSecretVariable.
        ...
        :param title:
            The value to assign to the title property of this KmsSecretVariable.
        :type title: str

        :param description:
            The value to assign to the description property of this KmsSecretVariable.
        :type description: str

        :param is_required:
            The value to assign to the is_required property of this KmsSecretVariable.
        :type is_required: bool

        :param visible:
            The value to assign to the visible property of this KmsSecretVariable.
        :type visible: str

        :param depends_on:
            The value to assign to the depends_on property of this KmsSecretVariable.
        :type depends_on: oci.fleet_apps_management.models.KmsSecretVariableDependsOn
        ...
        self.swagger_types = {
            ...
            'is_required': 'bool',
            'visible': 'str',
            'depends_on': 'KmsSecretVariableDependsOn'
        }
        self.attribute_map = {
            'type': 'type',
            'title': 'title',
        ...
        self._type = 'OCI_KMS_SECRET_ID'

    @property
    def depends_on(self):
        """
        Gets the depends_on of this KmsSecretVariable.

        :return: The depends_on of this KmsSecretVariable.
        :rtype: oci.fleet_apps_management.models.KmsSecretVariableDependsOn
        """
    ...
    def depends_on(self, depends_on):
        """
        Sets the depends_on of this KmsSecretVariable.

        :param depends_on: The depends_on of this KmsSecretVariable.
        :type: oci.fleet_apps_management.models.KmsSecretVariableDependsOn
        """
