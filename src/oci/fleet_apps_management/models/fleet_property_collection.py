...
class FleetPropertyCollection(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new FleetPropertyCollection object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param items:
            The value to assign to the items property of this FleetPropertyCollection.
        :type items: list[oci.fleet_apps_management.models.FleetPropertySummary]

        """
        self.swagger_types = {
            'items': 'list[FleetPropertySummary]'
        }
        self.attribute_map = {
            'items': 'items'
        }
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this FleetPropertyCollection.
        ...
        :rtype: list[oci.fleet_apps_management.models.FleetPropertySummary]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.fleet_apps_management.models.FleetPropertySummary]
        """
        self._items = items
