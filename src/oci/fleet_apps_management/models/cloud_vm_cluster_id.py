...
class CloudVmClusterId(BaseVariable):
    """
    Cloud VM cluster Id.
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new CloudVmClusterId object with values from keyword arguments. The default value of the :py:attr:`~oci.fleet_apps_management.models.CloudVmClusterId.type` attribute
        of this class is ``OCI_DATABASE_CLOUDVMCLUSTER_ID`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param type:
            The value to assign to the type property of this CloudVmClusterId.
        ...
        :param title:
            The value to assign to the title property of this CloudVmClusterId.
        :type title: str

        :param description:
            The value to assign to the description property of this CloudVmClusterId.
        :type description: str

        :param is_required:
            The value to assign to the is_required property of this CloudVmClusterId.
        :type is_required: bool

        :param visible:
            The value to assign to the visible property of this CloudVmClusterId.
        :type visible: str
        ...
        self._visible = None
        self._type = 'OCI_DATABASE_CLOUDVMCLUSTER_ID'
