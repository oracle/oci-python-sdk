...
class ModelProperty(object):
    ...
    def __init__(self, **kwargs):
        ...
        :param name:
            The value to assign to the name property of this ModelProperty.
        :type name: str

        :param value:
            The value to assign to the value property of this ModelProperty.
        :type value: str
    ...
    def name(self):
        """
        **[Required]** Gets the name of this ModelProperty.
    ...
    def value(self):
        """
        **[Required]** Gets the value of this ModelProperty.
