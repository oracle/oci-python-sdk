...
class WlsDomainConfiguration(object):
    """
    The WebLogic domain configuration.
    """

    #: A constant which can be used with the admin_server_control_mode property of a WlsDomainConfiguration.
    ...
    #: A constant which can be used with the managed_server_control_mode property of a WlsDomainConfiguration.
    #: This constant has a value of "USE_NODE_MANAGER"
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new WlsDomainConfiguration object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param is_patch_enabled:
            The value to assign to the is_patch_enabled property of this WlsDomainConfiguration.
        :type is_patch_enabled: bool

        :param is_rollback_on_failure:
            The value to assign to the is_rollback_on_failure property of this WlsDomainConfiguration.
        :type is_rollback_on_failure: bool

        :param servers_shutdown_timeout:
            The value to assign to the servers_shutdown_timeout property of this WlsDomainConfiguration.
        :type servers_shutdown_timeout: int

        :param admin_server_control_mode:
            The value to assign to the admin_server_control_mode property of this WlsDomainConfiguration.
            Allowed values for this property are: "USE_NODE_MANAGER", "USE_SCRIPTS", 'UNKNOWN_ENUM_VALUE'.
            Any unrecognized values returned by a service will be mapped to 'UNKNOWN_ENUM_VALUE'.
        :type admin_server_control_mode: str

        :param managed_server_control_mode:
            The value to assign to the managed_server_control_mode property of this WlsDomainConfiguration.
            Allowed values for this property are: "USE_NODE_MANAGER", "USE_SCRIPTS", 'UNKNOWN_ENUM_VALUE'.
            Any unrecognized values returned by a service will be mapped to 'UNKNOWN_ENUM_VALUE'.
        :type managed_server_control_mode: str

        :param admin_server_start_script_path:
            The value to assign to the admin_server_start_script_path property of this WlsDomainConfiguration.
        :type admin_server_start_script_path: str

        :param admin_server_stop_script_path:
            The value to assign to the admin_server_stop_script_path property of this WlsDomainConfiguration.
        :type admin_server_stop_script_path: str

        :param managed_server_start_script_path:
            The value to assign to the managed_server_start_script_path property of this WlsDomainConfiguration.
        :type managed_server_start_script_path: str

        :param managed_server_stop_script_path:
            The value to assign to the managed_server_stop_script_path property of this WlsDomainConfiguration.
    ...
    def is_patch_enabled(self):
        """
        **[Required]** Gets the is_patch_enabled of this WlsDomainConfiguration.
        Whether or not the WebLogic domain is enabled for patching.


        :return: The is_patch_enabled of this WlsDomainConfiguration.
        :rtype: bool
        """
    ...
    def is_patch_enabled(self, is_patch_enabled):
        """
        Sets the is_patch_enabled of this WlsDomainConfiguration.
        Whether or not the WebLogic domain is enabled for patching.


        :param is_patch_enabled: The is_patch_enabled of this WlsDomainConfiguration.
        :type: bool
        """
    ...
    def is_rollback_on_failure(self):
        """
        Gets the is_rollback_on_failure of this WlsDomainConfiguration.
        Whether or not to rollback on failure during patching of WebLogic domain.


        :return: The is_rollback_on_failure of this WlsDomainConfiguration.
        :rtype: bool
        """
    ...
    def is_rollback_on_failure(self, is_rollback_on_failure):
        """
        Sets the is_rollback_on_failure of this WlsDomainConfiguration.
        Whether or not to rollback on failure during patching of WebLogic domain.


        :param is_rollback_on_failure: The is_rollback_on_failure of this WlsDomainConfiguration.
        :type: bool
        """
    ...
    def servers_shutdown_timeout(self):
        """
        Gets the servers_shutdown_timeout of this WlsDomainConfiguration.
        Servers shutdown timeout.


        :return: The servers_shutdown_timeout of this WlsDomainConfiguration.
        :rtype: int
        """
    ...
    def servers_shutdown_timeout(self, servers_shutdown_timeout):
        """
        Sets the servers_shutdown_timeout of this WlsDomainConfiguration.
        Servers shutdown timeout.


        :param servers_shutdown_timeout: The servers_shutdown_timeout of this WlsDomainConfiguration.
        :type: int
        """
    ...
    def admin_server_control_mode(self):
        """
        Gets the admin_server_control_mode of this WlsDomainConfiguration.
        ...
        :return: The admin_server_control_mode of this WlsDomainConfiguration.
        :rtype: str
        """
    ...
    def admin_server_control_mode(self, admin_server_control_mode):
        """
        Sets the admin_server_control_mode of this WlsDomainConfiguration.
        Whether to manage the admin server using Node Manager or scripts.


        :param admin_server_control_mode: The admin_server_control_mode of this WlsDomainConfiguration.
        :type: str
        """
        ...
        if not value_allowed_none_or_none_sentinel(admin_server_control_mode, allowed_values):
            admin_server_control_mode = 'UNKNOWN_ENUM_VALUE'
        self._admin_server_control_mode = admin_server_control_mode

    @property
    def managed_server_control_mode(self):
        """
        Gets the managed_server_control_mode of this WlsDomainConfiguration.
        ...
        :return: The managed_server_control_mode of this WlsDomainConfiguration.
        :rtype: str
        """
    ...
    def managed_server_control_mode(self, managed_server_control_mode):
        """
        Sets the managed_server_control_mode of this WlsDomainConfiguration.
        Whether to manage the managed server using Node Manager or scripts.


        :param managed_server_control_mode: The managed_server_control_mode of this WlsDomainConfiguration.
        :type: str
        """
        allowed_values = ["USE_NODE_MANAGER", "USE_SCRIPTS"]
        if not value_allowed_none_or_none_sentinel(managed_server_control_mode, allowed_values):
            managed_server_control_mode = 'UNKNOWN_ENUM_VALUE'
        self._managed_server_control_mode = managed_server_control_mode

    @property
    def admin_server_start_script_path(self):
        """
        Gets the admin_server_start_script_path of this WlsDomainConfiguration.
        Path to admin server start script.


        :return: The admin_server_start_script_path of this WlsDomainConfiguration.
        :rtype: str
        """
    ...
    def admin_server_start_script_path(self, admin_server_start_script_path):
        """
        Sets the admin_server_start_script_path of this WlsDomainConfiguration.
        Path to admin server start script.


        :param admin_server_start_script_path: The admin_server_start_script_path of this WlsDomainConfiguration.
        :type: str
        """
    ...
    def admin_server_stop_script_path(self):
        """
        Gets the admin_server_stop_script_path of this WlsDomainConfiguration.
        Path to admin server stop script.


        :return: The admin_server_stop_script_path of this WlsDomainConfiguration.
        :rtype: str
        """
    ...
    def admin_server_stop_script_path(self, admin_server_stop_script_path):
        """
        Sets the admin_server_stop_script_path of this WlsDomainConfiguration.
        Path to admin server stop script.


        :param admin_server_stop_script_path: The admin_server_stop_script_path of this WlsDomainConfiguration.
        :type: str
        """
    ...
    def managed_server_start_script_path(self):
        """
        Gets the managed_server_start_script_path of this WlsDomainConfiguration.
        Path to managed server start script.


        :return: The managed_server_start_script_path of this WlsDomainConfiguration.
        :rtype: str
        """
    ...
    def managed_server_start_script_path(self, managed_server_start_script_path):
        """
        Sets the managed_server_start_script_path of this WlsDomainConfiguration.
        Path to managed server start script.


        :param managed_server_start_script_path: The managed_server_start_script_path of this WlsDomainConfiguration.
        :type: str
        """
    ...
    def managed_server_stop_script_path(self):
        """
        Gets the managed_server_stop_script_path of this WlsDomainConfiguration.
        Path to managed server stop script.


        :return: The managed_server_stop_script_path of this WlsDomainConfiguration.
        :rtype: str
        """
    ...
    def managed_server_stop_script_path(self, managed_server_stop_script_path):
        """
        Sets the managed_server_stop_script_path of this WlsDomainConfiguration.
        Path to managed server stop script.


        :param managed_server_stop_script_path: The managed_server_stop_script_path of this WlsDomainConfiguration.
        :type: str
        """
