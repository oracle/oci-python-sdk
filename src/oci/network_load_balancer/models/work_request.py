...
class WorkRequest(object):
    ...
    #: This constant has a value of "CREATE_NETWORK_LOAD_BALANCER"
    OPERATION_TYPE_CREATE_NETWORK_LOAD_BALANCER = "CREATE_NETWORK_LOAD_BALANCER"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "UPDATE_NETWORK_LOAD_BALANCER"
    OPERATION_TYPE_UPDATE_NETWORK_LOAD_BALANCER = "UPDATE_NETWORK_LOAD_BALANCER"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "DELETE_NETWORK_LOAD_BALANCER"
    OPERATION_TYPE_DELETE_NETWORK_LOAD_BALANCER = "DELETE_NETWORK_LOAD_BALANCER"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "CREATE_BACKEND"
    OPERATION_TYPE_CREATE_BACKEND = "CREATE_BACKEND"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "UPDATE_BACKEND"
    OPERATION_TYPE_UPDATE_BACKEND = "UPDATE_BACKEND"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "DELETE_BACKEND"
    OPERATION_TYPE_DELETE_BACKEND = "DELETE_BACKEND"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "CREATE_LISTENER"
    OPERATION_TYPE_CREATE_LISTENER = "CREATE_LISTENER"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "UPDATE_LISTENER"
    OPERATION_TYPE_UPDATE_LISTENER = "UPDATE_LISTENER"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "DELETE_LISTENER"
    OPERATION_TYPE_DELETE_LISTENER = "DELETE_LISTENER"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "CREATE_BACKENDSET"
    OPERATION_TYPE_CREATE_BACKENDSET = "CREATE_BACKENDSET"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "UPDATE_BACKENDSET"
    OPERATION_TYPE_UPDATE_BACKENDSET = "UPDATE_BACKENDSET"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "DELETE_BACKENDSET"
    OPERATION_TYPE_DELETE_BACKENDSET = "DELETE_BACKENDSET"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "UPDATE_NSGS"
    OPERATION_TYPE_UPDATE_NSGS = "UPDATE_NSGS"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "UPDATE_HEALTH_CHECKER"
    OPERATION_TYPE_UPDATE_HEALTH_CHECKER = "UPDATE_HEALTH_CHECKER"
    ...
    def __init__(self, **kwargs):
        ...
        :type resources: list[oci.network_load_balancer.models.WorkRequestResource]
    ...
    def resources(self):
        ...
        **[Required]** Gets the resources of this WorkRequest.
        ...
        :rtype: list[oci.network_load_balancer.models.WorkRequestResource]
        """
    ...
    def resources(self, resources):
        ...
        :type: list[oci.network_load_balancer.models.WorkRequestResource]
        """
    ...
    def time_started(self):
        ...
        The date and time that the request was started, as described in `RFC 3339`__,
        section 14.29.
    ...
    def time_finished(self):
        ...
        The date and time that the object was finished, as described in `RFC 3339`__.
