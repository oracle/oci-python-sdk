...
class BackendSetSummary(object):
    ...
    **Caution:** Oracle recommends that you avoid using any confidential information when you supply string values using the API.
    ...
    __ https://docs.oracle.com/iaas/Content/NetworkLoadBalancer/BackendSets/backend-set-management.htm
    """
    ...
    def __init__(self, **kwargs):
        ...
        :param is_instant_failover_tcp_reset_enabled:
            The value to assign to the is_instant_failover_tcp_reset_enabled property of this BackendSetSummary.
        :type is_instant_failover_tcp_reset_enabled: bool

        :param are_operationally_active_backends_preferred:
            The value to assign to the are_operationally_active_backends_preferred property of this BackendSetSummary.
    ...
    def is_instant_failover_tcp_reset_enabled(self):
        """
        Gets the is_instant_failover_tcp_reset_enabled of this BackendSetSummary.
        ...
        :return: The is_instant_failover_tcp_reset_enabled of this BackendSetSummary.
        :rtype: bool
        """
    ...
    def is_instant_failover_tcp_reset_enabled(self, is_instant_failover_tcp_reset_enabled):
        """
        Sets the is_instant_failover_tcp_reset_enabled of this BackendSetSummary.
        This only applies when using instant failover. If enabled, the network load balancer will send TCP RST to clients when a backend becomes unhealthy and the traffic is moved to a healthy backend.
        If disabled, the network load balancer will not send TCP RST before moving traffic to a healthy backend.  By default, TCP RST is enabled.


        :param is_instant_failover_tcp_reset_enabled: The is_instant_failover_tcp_reset_enabled of this BackendSetSummary.
        :type: bool
        """
    ...
    def are_operationally_active_backends_preferred(self):
        """
        Gets the are_operationally_active_backends_preferred of this BackendSetSummary.
        ...
        :return: The are_operationally_active_backends_preferred of this BackendSetSummary.
        :rtype: bool
        """
    ...
    def are_operationally_active_backends_preferred(self, are_operationally_active_backends_preferred):
        """
        Sets the are_operationally_active_backends_preferred of this BackendSetSummary.
        If enabled, NLB supports active-standby backends, with the initial standby being the configured backup backend. The standby backend becomes active and takes over serving traffic when the current active backend becomes unhealthy.
        The new active backend continues to serve the traffic while healthy even when the old active backend becomes healthy.


        :param are_operationally_active_backends_preferred: The are_operationally_active_backends_preferred of this BackendSetSummary.
        :type: bool
        """
