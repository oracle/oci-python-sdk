...
class WorkRequestErrorCollection(object):
    ...
    def __init__(self, **kwargs):
        ...
        :type items: list[oci.network_load_balancer.models.WorkRequestError]
    ...
    def items(self):
        ...
        :rtype: list[oci.network_load_balancer.models.WorkRequestError]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.network_load_balancer.models.WorkRequestError]
        """
        self._items = items
