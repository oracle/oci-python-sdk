...
class BackendDetails(object):
    ...
    def __init__(self, **kwargs):
        ...
        :param name:
            The value to assign to the name property of this BackendDetails.
        :type name: str
        ...
        :param target_id:
            The value to assign to the target_id property of this BackendDetails.
        :type target_id: str
        ...
        :param is_backup:
            The value to assign to the is_backup property of this BackendDetails.
        :type is_backup: bool

        :param is_drain:
            The value to assign to the is_drain property of this BackendDetails.
        :type is_drain: bool

        :param is_offline:
            The value to assign to the is_offline property of this BackendDetails.
    ...
    def name(self):
        """
        Gets the name of this BackendDetails.
        ...
        :return: The name of this BackendDetails.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this BackendDetails.
        A read-only field showing the IP address/OCID and port that uniquely identify this backend server in the backend set.

        Example: `10.0.0.3:8080`, or `ocid1.privateip..oc1.<var>&lt;unique_ID&gt;</var>:443` or `10.0.0.3:0`


        :param name: The name of this BackendDetails.
        :type: str
        """
        self._name = name
    ...
    def target_id(self, target_id):
        """
        Sets the target_id of this BackendDetails.
        The IP OCID/Instance OCID associated with the backend server.
        Example: `ocid1.privateip..oc1.<var>&lt;unique_ID&gt;</var>`


        :param target_id: The target_id of this BackendDetails.
        :type: str
        """
    ...
    def is_backup(self):
        """
        Gets the is_backup of this BackendDetails.
        ...
        :return: The is_backup of this BackendDetails.
        :rtype: bool
        """
    ...
    def is_backup(self, is_backup):
        """
        Sets the is_backup of this BackendDetails.
        Whether the network load balancer should treat this server as a backup unit. If `true`, then the network load balancer forwards no ingress
        traffic to this backend server unless all other backend servers not marked as \"isBackup\" fail the health check policy.
        ...
        :param is_backup: The is_backup of this BackendDetails.
        :type: bool
        """
    ...
    def is_drain(self):
        """
        Gets the is_drain of this BackendDetails.
        ...
        :return: The is_drain of this BackendDetails.
        :rtype: bool
        """
    ...
    def is_drain(self, is_drain):
        """
        Sets the is_drain of this BackendDetails.
        Whether the network load balancer should drain this server. Servers marked \"isDrain\" receive no
        incoming traffic.
        ...
        :param is_drain: The is_drain of this BackendDetails.
        :type: bool
        """
    ...
    def is_offline(self):
        """
        Gets the is_offline of this BackendDetails.
        ...
        :return: The is_offline of this BackendDetails.
        :rtype: bool
        """
    ...
    def is_offline(self, is_offline):
        """
        Sets the is_offline of this BackendDetails.
        Whether the network load balancer should treat this server as offline. Offline servers receive no incoming
        traffic.
        ...
        :param is_offline: The is_offline of this BackendDetails.
        :type: bool
        """
