...
class WorkRequestCollection(object):
    ...
    def __init__(self, **kwargs):
        ...
        :type items: list[oci.network_load_balancer.models.WorkRequestSummary]
    ...
    def items(self):
        """
        Gets the items of this WorkRequestCollection.
        An array of WorkRequest objects.


        :return: The items of this WorkRequestCollection.
        :rtype: list[oci.network_load_balancer.models.WorkRequestSummary]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.network_load_balancer.models.WorkRequestSummary]
        """
        self._items = items
