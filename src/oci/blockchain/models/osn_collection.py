...
class OsnCollection(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new OsnCollection object with values from keyword arguments.
    ...
    def items(self, items):
        """
        Sets the items of this OsnCollection.
        Collection of OsnSummary
