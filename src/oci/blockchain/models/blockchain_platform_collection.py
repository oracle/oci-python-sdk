...
class BlockchainPlatformCollection(object):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new BlockchainPlatformCollection object with values from keyword arguments.
        ...
        """
        self.swagger_types = {
            'items': 'list[BlockchainPlatformSummary]'
        }
    ...
    def items(self, items):
        """
        Sets the items of this BlockchainPlatformCollection.
        Collection of BlockchainPlatformSummary
