...
class CustomPropertyCollection(object):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new CustomPropertyCollection object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param count:
            The value to assign to the count property of this CustomPropertyCollection.
        :type count: int
    ...
    def count(self):
        """
        Gets the count of this CustomPropertyCollection.
        Total number of items returned.


        :return: The count of this CustomPropertyCollection.
        :rtype: int
        """
        return self._count
    ...
    def count(self, count):
        """
        Sets the count of this CustomPropertyCollection.
        Total number of items returned.


        :param count: The count of this CustomPropertyCollection.
        :type: int
        """
        self._count = count
    ...
    def items(self):
        """
        **[Required]** Gets the items of this CustomPropertyCollection.
    ...
    def items(self, items):
        """
        Sets the items of this CustomPropertyCollection.
        Collection of custom property summaries
