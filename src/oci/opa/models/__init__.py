...
from .opa_instance_collection import OpaInstanceCollection
from .opa_instance_summary import OpaInstanceSummary
from .update_opa_instance_details import UpdateOpaInstanceDetails
...
opa_type_mapping = {
    ...
    "OpaInstanceCollection": OpaInstanceCollection,
    "OpaInstanceSummary": OpaInstanceSummary,
    "UpdateOpaInstanceDetails": UpdateOpaInstanceDetails,
