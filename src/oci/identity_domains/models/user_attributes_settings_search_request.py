...
class UserAttributesSettingsSearchRequest(object):
    """
    ...
    #: A constant which can be used with the attribute_sets property of a UserAttributesSettingsSearchRequest.
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new UserAttributesSettingsSearchRequest object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param schemas:
            The value to assign to the schemas property of this UserAttributesSettingsSearchRequest.
        :type schemas: list[str]

        :param attributes:
            The value to assign to the attributes property of this UserAttributesSettingsSearchRequest.
        :type attributes: list[str]

        :param attribute_sets:
            The value to assign to the attribute_sets property of this UserAttributesSettingsSearchRequest.
    ...
    def schemas(self):
        """
        **[Required]** Gets the schemas of this UserAttributesSettingsSearchRequest.
        ...
        :return: The schemas of this UserAttributesSettingsSearchRequest.
        :rtype: list[str]
        """
    ...
    def schemas(self, schemas):
        """
        Sets the schemas of this UserAttributesSettingsSearchRequest.
        The schemas attribute is an array of Strings which allows introspection of the supported schema version for a SCIM representation as well any schema extensions supported by that representation. Each String value must be a unique URI. Query requests MUST be identified using the following URI: \"urn:ietf:params:scim:api:messages:2.0:SearchRequest\" REQUIRED.


        :param schemas: The schemas of this UserAttributesSettingsSearchRequest.
        :type: list[str]
        """
    ...
    def attributes(self):
        """
        Gets the attributes of this UserAttributesSettingsSearchRequest.
        ...
        :return: The attributes of this UserAttributesSettingsSearchRequest.
        :rtype: list[str]
        """
    ...
    def attributes(self, attributes):
        """
        Sets the attributes of this UserAttributesSettingsSearchRequest.
        A multi-valued list of strings indicating the names of resource attributes to return in the response overriding the set of attributes that would be returned by default. Attribute names MUST be in standard attribute notation (`Section 3.10`__) form. See (`additional retrieval query parameters`__). OPTIONAL.
        ...
        :param attributes: The attributes of this UserAttributesSettingsSearchRequest.
        :type: list[str]
        """
    ...
    def attribute_sets(self):
        """
        Gets the attribute_sets of this UserAttributesSettingsSearchRequest.
        A multi-valued list of strings indicating the return type of attribute definition. The specified set of attributes can be fetched by the return type of the attribute. One or more values can be given together to fetch more than one group of attributes. If \"attributes\" query parameter is also available, union of the two is fetched. Valid values : all, always, never, request, default. Values are case-insensitive. OPTIONAL.

        Allowed values for items in this list are: "all", "always", "never", "request", "default"


        :return: The attribute_sets of this UserAttributesSettingsSearchRequest.
        :rtype: list[str]
        """
    ...
    def attribute_sets(self, attribute_sets):
        """
        Sets the attribute_sets of this UserAttributesSettingsSearchRequest.
        A multi-valued list of strings indicating the return type of attribute definition. The specified set of attributes can be fetched by the return type of the attribute. One or more values can be given together to fetch more than one group of attributes. If \"attributes\" query parameter is also available, union of the two is fetched. Valid values : all, always, never, request, default. Values are case-insensitive. OPTIONAL.


        :param attribute_sets: The attribute_sets of this UserAttributesSettingsSearchRequest.
        :type: list[str]
        """
