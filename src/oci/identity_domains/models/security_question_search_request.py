...
class SecurityQuestionSearchRequest(object):
    """
    ...
    #: A constant which can be used with the attribute_sets property of a SecurityQuestionSearchRequest.
    ...
    #: A constant which can be used with the sort_order property of a SecurityQuestionSearchRequest.
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new SecurityQuestionSearchRequest object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param schemas:
            The value to assign to the schemas property of this SecurityQuestionSearchRequest.
        :type schemas: list[str]

        :param attributes:
            The value to assign to the attributes property of this SecurityQuestionSearchRequest.
        :type attributes: list[str]

        :param attribute_sets:
            The value to assign to the attribute_sets property of this SecurityQuestionSearchRequest.
            Allowed values for items in this list are: "all", "always", "never", "request", "default"
        :type attribute_sets: list[str]

        :param filter:
            The value to assign to the filter property of this SecurityQuestionSearchRequest.
        :type filter: str

        :param sort_by:
            The value to assign to the sort_by property of this SecurityQuestionSearchRequest.
        :type sort_by: str

        :param sort_order:
            The value to assign to the sort_order property of this SecurityQuestionSearchRequest.
            Allowed values for this property are: "ASCENDING", "DESCENDING"
        :type sort_order: str

        :param start_index:
            The value to assign to the start_index property of this SecurityQuestionSearchRequest.
        :type start_index: int

        :param count:
            The value to assign to the count property of this SecurityQuestionSearchRequest.
        :type count: int
    ...
    def schemas(self):
        """
        **[Required]** Gets the schemas of this SecurityQuestionSearchRequest.
        ...
        :return: The schemas of this SecurityQuestionSearchRequest.
        :rtype: list[str]
        """
    ...
    def schemas(self, schemas):
        """
        Sets the schemas of this SecurityQuestionSearchRequest.
        The schemas attribute is an array of Strings which allows introspection of the supported schema version for a SCIM representation as well any schema extensions supported by that representation. Each String value must be a unique URI. Query requests MUST be identified using the following URI: \"urn:ietf:params:scim:api:messages:2.0:SearchRequest\" REQUIRED.


        :param schemas: The schemas of this SecurityQuestionSearchRequest.
        :type: list[str]
        """
    ...
    def attributes(self):
        """
        Gets the attributes of this SecurityQuestionSearchRequest.
        ...
        :return: The attributes of this SecurityQuestionSearchRequest.
        :rtype: list[str]
        """
    ...
    def attributes(self, attributes):
        """
        Sets the attributes of this SecurityQuestionSearchRequest.
        A multi-valued list of strings indicating the names of resource attributes to return in the response overriding the set of attributes that would be returned by default. Attribute names MUST be in standard attribute notation (`Section 3.10`__) form. See (`additional retrieval query parameters`__). OPTIONAL.
        ...
        :param attributes: The attributes of this SecurityQuestionSearchRequest.
        :type: list[str]
        """
    ...
    def attribute_sets(self):
        """
        Gets the attribute_sets of this SecurityQuestionSearchRequest.
        A multi-valued list of strings indicating the return type of attribute definition. The specified set of attributes can be fetched by the return type of the attribute. One or more values can be given together to fetch more than one group of attributes. If \"attributes\" query parameter is also available, union of the two is fetched. Valid values : all, always, never, request, default. Values are case-insensitive. OPTIONAL.

        Allowed values for items in this list are: "all", "always", "never", "request", "default"


        :return: The attribute_sets of this SecurityQuestionSearchRequest.
        :rtype: list[str]
        """
    ...
    def attribute_sets(self, attribute_sets):
        """
        Sets the attribute_sets of this SecurityQuestionSearchRequest.
        A multi-valued list of strings indicating the return type of attribute definition. The specified set of attributes can be fetched by the return type of the attribute. One or more values can be given together to fetch more than one group of attributes. If \"attributes\" query parameter is also available, union of the two is fetched. Valid values : all, always, never, request, default. Values are case-insensitive. OPTIONAL.


        :param attribute_sets: The attribute_sets of this SecurityQuestionSearchRequest.
        :type: list[str]
        """
    ...
    def filter(self):
        """
        Gets the filter of this SecurityQuestionSearchRequest.
        ...
        :return: The filter of this SecurityQuestionSearchRequest.
        :rtype: str
        """
        return self._filter
    ...
    def filter(self, filter):
        """
        Sets the filter of this SecurityQuestionSearchRequest.
        The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See `Section 3.4.2.2`__. OPTIONAL.

        __ https://tools.ietf.org/html/draft-ietf-scim-api-19#section-3.4.2.2


        :param filter: The filter of this SecurityQuestionSearchRequest.
        :type: str
        """
        self._filter = filter
    ...
    def sort_by(self):
        """
        Gets the sort_by of this SecurityQuestionSearchRequest.
        ...
        :return: The sort_by of this SecurityQuestionSearchRequest.
        :rtype: str
        """
    ...
    def sort_by(self, sort_by):
        """
        Sets the sort_by of this SecurityQuestionSearchRequest.
        A string that indicates the attribute whose value SHALL be used to order the returned responses. The sortBy attribute MUST be in standard attribute notation (`Section 3.10`__) form. See `Sorting section`__. OPTIONAL.
        ...
        :param sort_by: The sort_by of this SecurityQuestionSearchRequest.
        :type: str
        """
    ...
    def sort_order(self):
        """
        Gets the sort_order of this SecurityQuestionSearchRequest.
        ...
        :return: The sort_order of this SecurityQuestionSearchRequest.
        :rtype: str
        """
    ...
    def sort_order(self, sort_order):
        """
        Sets the sort_order of this SecurityQuestionSearchRequest.
        A string that indicates the order in which the sortBy parameter is applied. Allowed values are \"ascending\" and \"descending\". See (`Sorting Section`__). OPTIONAL.

        __ https://tools.ietf.org/html/draft-ietf-scim-api-19#section-3.4.2.3


        :param sort_order: The sort_order of this SecurityQuestionSearchRequest.
        :type: str
        """
    ...
    def start_index(self):
        """
        Gets the start_index of this SecurityQuestionSearchRequest.
        ...
        :return: The start_index of this SecurityQuestionSearchRequest.
        :rtype: int
        """
    ...
    def start_index(self, start_index):
        """
        Sets the start_index of this SecurityQuestionSearchRequest.
        An integer that indicates the 1-based index of the first query result. See `Pagination Section`__. OPTIONAL.

        __ https://tools.ietf.org/html/draft-ietf-scim-api-19#section-3.4.2.4


        :param start_index: The start_index of this SecurityQuestionSearchRequest.
        :type: int
        """
    ...
    def count(self):
        """
        Gets the count of this SecurityQuestionSearchRequest.
        ...
        :return: The count of this SecurityQuestionSearchRequest.
        :rtype: int
        """
        return self._count
    ...
    def count(self, count):
        """
        Sets the count of this SecurityQuestionSearchRequest.
        An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (`Section 3.4.2.4`__). OPTIONAL.

        __ https://tools.ietf.org/html/draft-ietf-scim-api-19#section-3.4.2.4


        :param count: The count of this SecurityQuestionSearchRequest.
        :type: int
        """
        self._count = count
