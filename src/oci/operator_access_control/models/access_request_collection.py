...
class AccessRequestCollection(object):
    ...
    def __init__(self, **kwargs):
        ...
        :type items: list[oci.operator_access_control.models.AccessRequestSummary]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this AccessRequestCollection.
        ...
        :rtype: list[oci.operator_access_control.models.AccessRequestSummary]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.operator_access_control.models.AccessRequestSummary]
        """
        self._items = items
