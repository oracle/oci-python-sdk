...
class DiscoveryJobCollection(object):
    ...
    def __init__(self, **kwargs):
        ...
        :type items: list[oci.stack_monitoring.models.DiscoveryJobSummary]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this DiscoveryJobCollection.
        ...
        :rtype: list[oci.stack_monitoring.models.DiscoveryJobSummary]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.stack_monitoring.models.DiscoveryJobSummary]
        """
        self._items = items
