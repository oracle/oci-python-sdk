...
class WorkRequest(object):
    ...
    #: This constant has a value of "CREATE_RESOURCES"
    OPERATION_TYPE_CREATE_RESOURCES = "CREATE_RESOURCES"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "UPDATE_RESOURCES"
    OPERATION_TYPE_UPDATE_RESOURCES = "UPDATE_RESOURCES"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "DELETE_RESOURCES"
    OPERATION_TYPE_DELETE_RESOURCES = "DELETE_RESOURCES"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "MOVE_RESOURCES"
    OPERATION_TYPE_MOVE_RESOURCES = "MOVE_RESOURCES"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "ENABLE_EXTERNAL_DATABASE"
    OPERATION_TYPE_ENABLE_EXTERNAL_DATABASE = "ENABLE_EXTERNAL_DATABASE"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "DISABLE_EXTERNAL_DATABASE"
    OPERATION_TYPE_DISABLE_EXTERNAL_DATABASE = "DISABLE_EXTERNAL_DATABASE"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "ADD_SOURCES_TO_AGENT"
    OPERATION_TYPE_ADD_SOURCES_TO_AGENT = "ADD_SOURCES_TO_AGENT"
    ...
    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "UPDATE_AND_PROPAGATE_TAGS"
    OPERATION_TYPE_UPDATE_AND_PROPAGATE_TAGS = "UPDATE_AND_PROPAGATE_TAGS"
    ...
    def __init__(self, **kwargs):
        ...
        :param operation_type:
            ...
            Allowed values for this property are: "CREATE_RESOURCES", "UPDATE_RESOURCES", "DELETE_RESOURCES", "MOVE_RESOURCES", "ENABLE_EXTERNAL_DATABASE", "DISABLE_EXTERNAL_DATABASE", "ADD_SOURCES_TO_AGENT", "BULK_ADD_RESOURCES", "BULK_DELETE_RESOURCES", "UPDATE_AND_PROPAGATE_TAGS", 'UNKNOWN_ENUM_VALUE'.
        ...
        :type resources: list[oci.stack_monitoring.models.WorkRequestResource]
    ...
    def operation_type(self, operation_type):
        ...
        :type: str
        """
        allowed_values = ["CREATE_RESOURCES", "UPDATE_RESOURCES", "DELETE_RESOURCES", "MOVE_RESOURCES", "ENABLE_EXTERNAL_DATABASE", "DISABLE_EXTERNAL_DATABASE", "ADD_SOURCES_TO_AGENT", "BULK_ADD_RESOURCES", "BULK_DELETE_RESOURCES", "UPDATE_AND_PROPAGATE_TAGS"]
    ...
    def resources(self):
        ...
        **[Required]** Gets the resources of this WorkRequest.
        ...
        :rtype: list[oci.stack_monitoring.models.WorkRequestResource]
        """
    ...
    def resources(self, resources):
        ...
        :type: list[oci.stack_monitoring.models.WorkRequestResource]
        """
