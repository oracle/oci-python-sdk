...
class CredentialCollection(object):
    ...
    def __init__(self, **kwargs):
        ...
        :type items: list[oci.stack_monitoring.models.CredentialDetails]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this CredentialCollection.
        ...
        :rtype: list[oci.stack_monitoring.models.CredentialDetails]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.stack_monitoring.models.CredentialDetails]
        """
        self._items = items
