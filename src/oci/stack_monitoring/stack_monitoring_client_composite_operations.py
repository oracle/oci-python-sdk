...
class StackMonitoringClientCompositeOperations(object):
    ...
    def create_maintenance_window_and_wait_for_state(self, create_maintenance_window_details, wait_for_states=[], operation_kwargs={}, waiter_kwargs={}):
        """
        Calls :py:func:`~oci.stack_monitoring.StackMonitoringClient.create_maintenance_window` and waits for the :py:class:`~oci.stack_monitoring.models.WorkRequest`
        to enter the given state(s).
        ...
        :param dict operation_kwargs:
            A dictionary of keyword arguments to pass to :py:func:`~oci.stack_monitoring.StackMonitoringClient.create_maintenance_window`
    ...
    def delete_maintenance_window_and_wait_for_state(self, maintenance_window_id, wait_for_states=[], operation_kwargs={}, waiter_kwargs={}):
        """
        Calls :py:func:`~oci.stack_monitoring.StackMonitoringClient.delete_maintenance_window` and waits for the :py:class:`~oci.stack_monitoring.models.WorkRequest`
        to enter the given state(s).
        ...
        :param dict operation_kwargs:
            A dictionary of keyword arguments to pass to :py:func:`~oci.stack_monitoring.StackMonitoringClient.delete_maintenance_window`
    ...
    def retry_failed_maintenance_window_operation_and_wait_for_state(self, maintenance_window_id, wait_for_states=[], operation_kwargs={}, waiter_kwargs={}):
        """
        Calls :py:func:`~oci.stack_monitoring.StackMonitoringClient.retry_failed_maintenance_window_operation` and waits for the :py:class:`~oci.stack_monitoring.models.WorkRequest`
        to enter the given state(s).
        ...
        :param dict operation_kwargs:
            A dictionary of keyword arguments to pass to :py:func:`~oci.stack_monitoring.StackMonitoringClient.retry_failed_maintenance_window_operation`

        :param dict waiter_kwargs:
            A dictionary of keyword arguments to pass to the :py:func:`oci.wait_until` function. For example, you could pass ``max_interval_seconds`` or ``max_interval_seconds``
            as dictionary keys to modify how long the waiter function will wait between retries and the maximum amount of time it will wait
        """
        operation_result = self.client.retry_failed_maintenance_window_operation(maintenance_window_id, **operation_kwargs)
        if not wait_for_states:
            return operation_result
        lowered_wait_for_states = [w.lower() for w in wait_for_states]
        if 'opc-work-request-id' not in operation_result.headers:
    ...
    def stop_maintenance_window_and_wait_for_state(self, maintenance_window_id, wait_for_states=[], operation_kwargs={}, waiter_kwargs={}):
        """
        Calls :py:func:`~oci.stack_monitoring.StackMonitoringClient.stop_maintenance_window` and waits for the :py:class:`~oci.stack_monitoring.models.WorkRequest`
        to enter the given state(s).
        ...
        :param dict operation_kwargs:
            A dictionary of keyword arguments to pass to :py:func:`~oci.stack_monitoring.StackMonitoringClient.stop_maintenance_window`

        :param dict waiter_kwargs:
            A dictionary of keyword arguments to pass to the :py:func:`oci.wait_until` function. For example, you could pass ``max_interval_seconds`` or ``max_interval_seconds``
            as dictionary keys to modify how long the waiter function will wait between retries and the maximum amount of time it will wait
        """
        operation_result = self.client.stop_maintenance_window(maintenance_window_id, **operation_kwargs)
        if not wait_for_states:
            return operation_result
        lowered_wait_for_states = [w.lower() for w in wait_for_states]
        if 'opc-work-request-id' not in operation_result.headers:
    ...
    def update_maintenance_window_and_wait_for_state(self, maintenance_window_id, update_maintenance_window_details, wait_for_states=[], operation_kwargs={}, waiter_kwargs={}):
        """
        Calls :py:func:`~oci.stack_monitoring.StackMonitoringClient.update_maintenance_window` and waits for the :py:class:`~oci.stack_monitoring.models.WorkRequest`
        to enter the given state(s).
        ...
        :param dict operation_kwargs:
            A dictionary of keyword arguments to pass to :py:func:`~oci.stack_monitoring.StackMonitoringClient.update_maintenance_window`
