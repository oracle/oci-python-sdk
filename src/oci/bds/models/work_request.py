...
class WorkRequest(object):
    ...
    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "STOP_BDS"
    OPERATION_TYPE_STOP_BDS = "STOP_BDS"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "START_BDS"
    OPERATION_TYPE_START_BDS = "START_BDS"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "ADD_KAFKA"
    OPERATION_TYPE_ADD_KAFKA = "ADD_KAFKA"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "REMOVE_KAFKA"
