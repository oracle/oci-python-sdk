...
class BulkEditTagsResourceTypeCollection(object):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new BulkEditTagsResourceTypeCollection object with values from keyword arguments.
        ...
        """
        self.swagger_types = {
            'items': 'list[BulkEditTagsResourceType]'
        }
    ...
    def items(self, items):
        """
        Sets the items of this BulkEditTagsResourceTypeCollection.
        The collection of resource types that support bulk editing of tags.
