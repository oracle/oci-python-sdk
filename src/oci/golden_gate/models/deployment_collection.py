...
class DeploymentCollection(object):
    ...
    def __init__(self, **kwargs):
        ...
        :type items: list[oci.golden_gate.models.DeploymentSummary]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this DeploymentCollection.
        ...
        :rtype: list[oci.golden_gate.models.DeploymentSummary]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.golden_gate.models.DeploymentSummary]
        """
        self._items = items
