...
class CreateAzureDataLakeStorageIcebergStorageDetails(CreateIcebergStorageDetails):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new CreateAzureDataLakeStorageIcebergStorageDetails object with values from keyword arguments. The default value of the :py:attr:`~oci.golden_gate.models.CreateAzureDataLakeStorageIcebergStorageDetails.storage_type` attribute
        of this class is ``AZURE_DATA_LAKE_STORAGE`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param storage_type:
            The value to assign to the storage_type property of this CreateAzureDataLakeStorageIcebergStorageDetails.
        ...
        :param account_name:
            The value to assign to the account_name property of this CreateAzureDataLakeStorageIcebergStorageDetails.
        :type account_name: str

        :param container:
            The value to assign to the container property of this CreateAzureDataLakeStorageIcebergStorageDetails.
        :type container: str
    ...
    def account_name(self):
        """
        **[Required]** Gets the account_name of this CreateAzureDataLakeStorageIcebergStorageDetails.
        Sets the Azure storage account name.


        :return: The account_name of this CreateAzureDataLakeStorageIcebergStorageDetails.
        :rtype: str
        """
    ...
    def account_name(self, account_name):
        """
        Sets the account_name of this CreateAzureDataLakeStorageIcebergStorageDetails.
        Sets the Azure storage account name.


        :param account_name: The account_name of this CreateAzureDataLakeStorageIcebergStorageDetails.
        :type: str
        """
    ...
    def container(self):
        """
        **[Required]** Gets the container of this CreateAzureDataLakeStorageIcebergStorageDetails.
        The Azure Blob Storage container where Iceberg tables are stored.


        :return: The container of this CreateAzureDataLakeStorageIcebergStorageDetails.
        :rtype: str
        """
    ...
    def container(self, container):
        """
        Sets the container of this CreateAzureDataLakeStorageIcebergStorageDetails.
        The Azure Blob Storage container where Iceberg tables are stored.


        :param container: The container of this CreateAzureDataLakeStorageIcebergStorageDetails.
        :type: str
        """
    ...
    def account_key_secret_id(self):
        ...
        :return: The account_key_secret_id of this CreateAzureDataLakeStorageIcebergStorageDetails.
        :rtype: str
        """
    ...
    def account_key_secret_id(self, account_key_secret_id):
        """
        Sets the account_key_secret_id of this CreateAzureDataLakeStorageIcebergStorageDetails.
        The `OCID`__ of the Secret where the account key is stored.

        __ https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm


        :param account_key_secret_id: The account_key_secret_id of this CreateAzureDataLakeStorageIcebergStorageDetails.
        :type: str
        """
    ...
    def endpoint(self):
        """
        Gets the endpoint of this CreateAzureDataLakeStorageIcebergStorageDetails.
        The Azure Blob Storage endpoint where Iceberg data is stored.
        e.g.: 'https://my-azure-storage-account.blob.core.windows.net'


        :return: The endpoint of this CreateAzureDataLakeStorageIcebergStorageDetails.
        :rtype: str
        """
    ...
    def endpoint(self, endpoint):
        """
        Sets the endpoint of this CreateAzureDataLakeStorageIcebergStorageDetails.
        The Azure Blob Storage endpoint where Iceberg data is stored.
        e.g.: 'https://my-azure-storage-account.blob.core.windows.net'


        :param endpoint: The endpoint of this CreateAzureDataLakeStorageIcebergStorageDetails.
        :type: str
        """
