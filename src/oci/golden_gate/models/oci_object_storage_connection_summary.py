...
class OciObjectStorageConnectionSummary(ConnectionSummary):
    ...
    def __init__(self, **kwargs):
        ...
        :param locks:
            The value to assign to the locks property of this OciObjectStorageConnectionSummary.
        :type locks: list[oci.golden_gate.models.ResourceLock]

        :param does_use_secret_ids:
            The value to assign to the does_use_secret_ids property of this OciObjectStorageConnectionSummary.
        :type does_use_secret_ids: bool

        :param subscription_id:
            The value to assign to the subscription_id property of this OciObjectStorageConnectionSummary.
        :type subscription_id: str

        :param cluster_placement_group_id:
            The value to assign to the cluster_placement_group_id property of this OciObjectStorageConnectionSummary.
        :type cluster_placement_group_id: str

        :param security_attributes:
            The value to assign to the security_attributes property of this OciObjectStorageConnectionSummary.
        ...
        :param private_key_file_secret_id:
            The value to assign to the private_key_file_secret_id property of this OciObjectStorageConnectionSummary.
    ...
    def private_key_file_secret_id(self):
        """
        Gets the private_key_file_secret_id of this OciObjectStorageConnectionSummary.
    ...
    def private_key_file_secret_id(self, private_key_file_secret_id):
        """
        Sets the private_key_file_secret_id of this OciObjectStorageConnectionSummary.
        The `OCID`__ of the Secret that stores the content of the private key file (PEM file) corresponding to the API key of the fingerprint.
        See documentation: https://docs.oracle.com/en-us/iaas/Content/Identity/Tasks/managingcredentials.htm
        Note: When provided, 'privateKeyFile' field must not be provided.
    ...
    def private_key_passphrase_secret_id(self):
        """
        Gets the private_key_passphrase_secret_id of this OciObjectStorageConnectionSummary.
    ...
    def private_key_passphrase_secret_id(self, private_key_passphrase_secret_id):
        """
        Sets the private_key_passphrase_secret_id of this OciObjectStorageConnectionSummary.
        The `OCID`__ of the Secret that stores the passphrase of the private key.
        Note: When provided, 'privateKeyPassphrase' field must not be provided.
