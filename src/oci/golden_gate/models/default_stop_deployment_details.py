...
class DefaultStopDeploymentDetails(StopDeploymentDetails):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new DefaultStopDeploymentDetails object with values from keyword arguments. The default value of the :py:attr:`~oci.golden_gate.models.DefaultStopDeploymentDetails.type` attribute
        of this class is ``DEFAULT`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param type:
            The value to assign to the type property of this DefaultStopDeploymentDetails.
