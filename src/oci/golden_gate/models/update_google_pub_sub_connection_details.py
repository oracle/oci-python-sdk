...
class UpdateGooglePubSubConnectionDetails(UpdateConnectionDetails):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new UpdateGooglePubSubConnectionDetails object with values from keyword arguments. The default value of the :py:attr:`~oci.golden_gate.models.UpdateGooglePubSubConnectionDetails.connection_type` attribute
        ...
        :param display_name:
            The value to assign to the display_name property of this UpdateGooglePubSubConnectionDetails.
        :type display_name: str

        :param description:
            The value to assign to the description property of this UpdateGooglePubSubConnectionDetails.
        :type description: str

        :param freeform_tags:
            The value to assign to the freeform_tags property of this UpdateGooglePubSubConnectionDetails.
        :type freeform_tags: dict(str, str)

        :param defined_tags:
            The value to assign to the defined_tags property of this UpdateGooglePubSubConnectionDetails.
        :type defined_tags: dict(str, dict(str, object))

        :param vault_id:
            The value to assign to the vault_id property of this UpdateGooglePubSubConnectionDetails.
        :type vault_id: str

        :param key_id:
            The value to assign to the key_id property of this UpdateGooglePubSubConnectionDetails.
        :type key_id: str

        :param nsg_ids:
            The value to assign to the nsg_ids property of this UpdateGooglePubSubConnectionDetails.
        :type nsg_ids: list[str]

        :param subnet_id:
            The value to assign to the subnet_id property of this UpdateGooglePubSubConnectionDetails.
        :type subnet_id: str

        :param routing_method:
            The value to assign to the routing_method property of this UpdateGooglePubSubConnectionDetails.
        ...
        :param service_account_key_file_secret_id:
            The value to assign to the service_account_key_file_secret_id property of this UpdateGooglePubSubConnectionDetails.
    ...
    def service_account_key_file(self):
        """
        Gets the service_account_key_file of this UpdateGooglePubSubConnectionDetails.
        ...
        :return: The service_account_key_file of this UpdateGooglePubSubConnectionDetails.
        :rtype: str
        """
    ...
    def service_account_key_file(self, service_account_key_file):
        """
        Sets the service_account_key_file of this UpdateGooglePubSubConnectionDetails.
        The base64 encoded content of the service account key file containing
        the credentials required to use Google PubSub.
        Deprecated: This field is deprecated and replaced by \"serviceAccountKeyFileSecretId\".
        This change follows the GoldenGate \"Plain Text Fields in Connections\" deprecation:
        ...
        :param service_account_key_file: The service_account_key_file of this UpdateGooglePubSubConnectionDetails.
        :type: str
        """
    ...
    def service_account_key_file_secret_id(self):
        """
        Gets the service_account_key_file_secret_id of this UpdateGooglePubSubConnectionDetails.
        ...
        :return: The service_account_key_file_secret_id of this UpdateGooglePubSubConnectionDetails.
        :rtype: str
        """
    ...
    def service_account_key_file_secret_id(self, service_account_key_file_secret_id):
        """
        Sets the service_account_key_file_secret_id of this UpdateGooglePubSubConnectionDetails.
        The `OCID`__ of the Secret where the content of the service account key file is stored,
        which contains the credentials required to use Google PubSub.
        Note: When provided, 'serviceAccountKeyFile' field must not be provided.
        ...
        :param service_account_key_file_secret_id: The service_account_key_file_secret_id of this UpdateGooglePubSubConnectionDetails.
        :type: str
        """
