...
class UpdateGoogleCloudStorageIcebergStorageDetails(UpdateIcebergStorageDetails):
    ...
    def __init__(self, **kwargs):
        ...
        :param service_account_key_file:
            The value to assign to the service_account_key_file property of this UpdateGoogleCloudStorageIcebergStorageDetails.
        :type service_account_key_file: str

        :param endpoint:
            The value to assign to the endpoint property of this UpdateGoogleCloudStorageIcebergStorageDetails.
        :type endpoint: str
    ...
    def service_account_key_file(self):
        """
        Gets the service_account_key_file of this UpdateGoogleCloudStorageIcebergStorageDetails.
        ...
        :return: The service_account_key_file of this UpdateGoogleCloudStorageIcebergStorageDetails.
        :rtype: str
        """
    ...
    def service_account_key_file(self, service_account_key_file):
        """
        Sets the service_account_key_file of this UpdateGoogleCloudStorageIcebergStorageDetails.
        The base64 encoded content of the service account key file containing
        the credentials required to use Google Cloud Storage.
        Deprecated: This field is deprecated and replaced by \"serviceAccountKeyFileSecretId\".
        This change follows the GoldenGate \"Plain Text Fields in Connections\" deprecation:
        ...
        :param service_account_key_file: The service_account_key_file of this UpdateGoogleCloudStorageIcebergStorageDetails.
        :type: str
        """
    ...
    def endpoint(self):
        """
        Gets the endpoint of this UpdateGoogleCloudStorageIcebergStorageDetails.
        A legal URL to connect to Google Cloud Storage including scheme, server name and port (if not the default port).
        Default: https://storage.googleapis.com


        :return: The endpoint of this UpdateGoogleCloudStorageIcebergStorageDetails.
        :rtype: str
        """
    ...
    def endpoint(self, endpoint):
        """
        Sets the endpoint of this UpdateGoogleCloudStorageIcebergStorageDetails.
        A legal URL to connect to Google Cloud Storage including scheme, server name and port (if not the default port).
        Default: https://storage.googleapis.com


        :param endpoint: The endpoint of this UpdateGoogleCloudStorageIcebergStorageDetails.
        :type: str
        """
