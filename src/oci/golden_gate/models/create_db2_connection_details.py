...
class CreateDb2ConnectionDetails(CreateConnectionDetails):
    ...
    def __init__(self, **kwargs):
        ...
        :param subscription_id:
            The value to assign to the subscription_id property of this CreateDb2ConnectionDetails.
        :type subscription_id: str

        :param cluster_placement_group_id:
            The value to assign to the cluster_placement_group_id property of this CreateDb2ConnectionDetails.
        :type cluster_placement_group_id: str

        :param security_attributes:
            The value to assign to the security_attributes property of this CreateDb2ConnectionDetails.
