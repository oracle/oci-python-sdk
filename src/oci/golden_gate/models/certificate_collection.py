...
class CertificateCollection(object):
    ...
    def __init__(self, **kwargs):
        ...
        :type items: list[oci.golden_gate.models.CertificateSummary]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this CertificateCollection.
        ...
        :rtype: list[oci.golden_gate.models.CertificateSummary]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.golden_gate.models.CertificateSummary]
        """
        self._items = items
