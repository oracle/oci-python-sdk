...
class Db2Connection(Connection):
    ...
    def __init__(self, **kwargs):
        ...
        :param subscription_id:
            The value to assign to the subscription_id property of this Db2Connection.
        :type subscription_id: str

        :param cluster_placement_group_id:
            The value to assign to the cluster_placement_group_id property of this Db2Connection.
        :type cluster_placement_group_id: str

        :param security_attributes:
            The value to assign to the security_attributes property of this Db2Connection.
