...
class UpdateHdfsConnectionDetails(UpdateConnectionDetails):
    ...
    def __init__(self, **kwargs):
        ...
        :param does_use_secret_ids:
            The value to assign to the does_use_secret_ids property of this UpdateHdfsConnectionDetails.
        :type does_use_secret_ids: bool

        :param security_attributes:
            The value to assign to the security_attributes property of this UpdateHdfsConnectionDetails.
