...
class WorkRequest(object):
    ...
    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "GOLDENGATE_CONNECTION_MIGRATE_SECRETS"
    OPERATION_TYPE_GOLDENGATE_CONNECTION_MIGRATE_SECRETS = "GOLDENGATE_CONNECTION_MIGRATE_SECRETS"
    ...
    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "GOLDENGATE_PIPELINE_DIAGNOSTICS_COLLECT"
    OPERATION_TYPE_GOLDENGATE_PIPELINE_DIAGNOSTICS_COLLECT = "GOLDENGATE_PIPELINE_DIAGNOSTICS_COLLECT"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "GOLDENGATE_SWITCHOVER_DEPLOYMENT_PEER"
    OPERATION_TYPE_GOLDENGATE_SWITCHOVER_DEPLOYMENT_PEER = "GOLDENGATE_SWITCHOVER_DEPLOYMENT_PEER"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "GOLDENGATE_PIPELINE_PAUSE"
    OPERATION_TYPE_GOLDENGATE_PIPELINE_PAUSE = "GOLDENGATE_PIPELINE_PAUSE"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "GOLDENGATE_PIPELINE_CLONE"
    OPERATION_TYPE_GOLDENGATE_PIPELINE_CLONE = "GOLDENGATE_PIPELINE_CLONE"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "GOLDENGATE_DEPLOYMENT_DISASTER_RECOVERY_PRECHECK"
    OPERATION_TYPE_GOLDENGATE_DEPLOYMENT_DISASTER_RECOVERY_PRECHECK = "GOLDENGATE_DEPLOYMENT_DISASTER_RECOVERY_PRECHECK"
