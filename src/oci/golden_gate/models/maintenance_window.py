...
class MaintenanceWindow(object):
    ...
    #: A constant which can be used with the day property of a MaintenanceWindow.
    ...
    def __init__(self, **kwargs):
        ...
        :param day:
            The value to assign to the day property of this MaintenanceWindow.
        ...
        :param start_hour:
            The value to assign to the start_hour property of this MaintenanceWindow.
        :type start_hour: int
    ...
    def day(self):
        """
        **[Required]** Gets the day of this MaintenanceWindow.
        Days of the week.
    ...
    def day(self, day):
        ...
        if not value_allowed_none_or_none_sentinel(day, allowed_values):
            day = 'UNKNOWN_ENUM_VALUE'
        self._day = day

    @property
    def start_hour(self):
        """
        **[Required]** Gets the start_hour of this MaintenanceWindow.
        Start hour for maintenance period. Hour is in UTC.


        :return: The start_hour of this MaintenanceWindow.
        :rtype: int
        """
    ...
    def start_hour(self, start_hour):
        """
        Sets the start_hour of this MaintenanceWindow.
        Start hour for maintenance period. Hour is in UTC.


        :param start_hour: The start_hour of this MaintenanceWindow.
        :type: int
        """
