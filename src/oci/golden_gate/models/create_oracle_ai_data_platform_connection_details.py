...
class CreateOracleAiDataPlatformConnectionDetails(CreateConnectionDetails):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new CreateOracleAiDataPlatformConnectionDetails object with values from keyword arguments. The default value of the :py:attr:`~oci.golden_gate.models.CreateOracleAiDataPlatformConnectionDetails.connection_type` attribute
        of this class is ``ORACLE_AI_DATA_PLATFORM`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param connection_type:
            The value to assign to the connection_type property of this CreateOracleAiDataPlatformConnectionDetails.
        ...
        :param display_name:
            The value to assign to the display_name property of this CreateOracleAiDataPlatformConnectionDetails.
        :type display_name: str

        :param description:
            The value to assign to the description property of this CreateOracleAiDataPlatformConnectionDetails.
        :type description: str

        :param compartment_id:
            The value to assign to the compartment_id property of this CreateOracleAiDataPlatformConnectionDetails.
        :type compartment_id: str

        :param freeform_tags:
            The value to assign to the freeform_tags property of this CreateOracleAiDataPlatformConnectionDetails.
        :type freeform_tags: dict(str, str)

        :param defined_tags:
            The value to assign to the defined_tags property of this CreateOracleAiDataPlatformConnectionDetails.
        :type defined_tags: dict(str, dict(str, object))

        :param locks:
            The value to assign to the locks property of this CreateOracleAiDataPlatformConnectionDetails.
        :type locks: list[oci.golden_gate.models.AddResourceLockDetails]

        :param vault_id:
            The value to assign to the vault_id property of this CreateOracleAiDataPlatformConnectionDetails.
        :type vault_id: str

        :param key_id:
            The value to assign to the key_id property of this CreateOracleAiDataPlatformConnectionDetails.
        :type key_id: str

        :param nsg_ids:
            The value to assign to the nsg_ids property of this CreateOracleAiDataPlatformConnectionDetails.
        :type nsg_ids: list[str]

        :param subnet_id:
            The value to assign to the subnet_id property of this CreateOracleAiDataPlatformConnectionDetails.
        :type subnet_id: str

        :param routing_method:
            The value to assign to the routing_method property of this CreateOracleAiDataPlatformConnectionDetails.
            Allowed values for this property are: "SHARED_SERVICE_ENDPOINT", "SHARED_DEPLOYMENT_ENDPOINT", "DEDICATED_ENDPOINT"
        :type routing_method: str

        :param does_use_secret_ids:
            The value to assign to the does_use_secret_ids property of this CreateOracleAiDataPlatformConnectionDetails.
        :type does_use_secret_ids: bool

        :param subscription_id:
            The value to assign to the subscription_id property of this CreateOracleAiDataPlatformConnectionDetails.
        :type subscription_id: str

        :param cluster_placement_group_id:
            The value to assign to the cluster_placement_group_id property of this CreateOracleAiDataPlatformConnectionDetails.
        :type cluster_placement_group_id: str

        :param security_attributes:
            The value to assign to the security_attributes property of this CreateOracleAiDataPlatformConnectionDetails.
        :type security_attributes: dict(str, dict(str, object))

        :param technology_type:
            The value to assign to the technology_type property of this CreateOracleAiDataPlatformConnectionDetails.
        :type technology_type: str

        :param connection_url:
            The value to assign to the connection_url property of this CreateOracleAiDataPlatformConnectionDetails.
        :type connection_url: str

        :param tenancy_id:
            The value to assign to the tenancy_id property of this CreateOracleAiDataPlatformConnectionDetails.
        :type tenancy_id: str

        :param region:
            The value to assign to the region property of this CreateOracleAiDataPlatformConnectionDetails.
        :type region: str

        :param user_id:
            The value to assign to the user_id property of this CreateOracleAiDataPlatformConnectionDetails.
        :type user_id: str

        :param private_key_file_secret_id:
            The value to assign to the private_key_file_secret_id property of this CreateOracleAiDataPlatformConnectionDetails.
        ...
        :param should_use_resource_principal:
            The value to assign to the should_use_resource_principal property of this CreateOracleAiDataPlatformConnectionDetails.
    ...
    def technology_type(self):
        """
        **[Required]** Gets the technology_type of this CreateOracleAiDataPlatformConnectionDetails.
        The Oracle AI Data Platform technology type.


        :return: The technology_type of this CreateOracleAiDataPlatformConnectionDetails.
        :rtype: str
        """
    ...
    def technology_type(self, technology_type):
        """
        Sets the technology_type of this CreateOracleAiDataPlatformConnectionDetails.
        The Oracle AI Data Platform technology type.


        :param technology_type: The technology_type of this CreateOracleAiDataPlatformConnectionDetails.
        :type: str
        """
    ...
    def connection_url(self):
        """
        **[Required]** Gets the connection_url of this CreateOracleAiDataPlatformConnectionDetails.
        Connection URL.
        It must start with 'jdbc:spark://'


        :return: The connection_url of this CreateOracleAiDataPlatformConnectionDetails.
        :rtype: str
        """
    ...
    def connection_url(self, connection_url):
        """
        Sets the connection_url of this CreateOracleAiDataPlatformConnectionDetails.
        Connection URL.
        It must start with 'jdbc:spark://'


        :param connection_url: The connection_url of this CreateOracleAiDataPlatformConnectionDetails.
        :type: str
        """
    ...
    def region(self):
        """
        Gets the region of this CreateOracleAiDataPlatformConnectionDetails.
        The name of the region. e.g.: us-ashburn-1
        If the region is not provided, backend will default to the default region.


        :return: The region of this CreateOracleAiDataPlatformConnectionDetails.
        :rtype: str
        """
        return self._region
    ...
    def region(self, region):
        """
        Sets the region of this CreateOracleAiDataPlatformConnectionDetails.
        The name of the region. e.g.: us-ashburn-1
        If the region is not provided, backend will default to the default region.


        :param region: The region of this CreateOracleAiDataPlatformConnectionDetails.
        :type: str
        """
        self._region = region
    ...
    def user_id(self):
        """
        Gets the user_id of this CreateOracleAiDataPlatformConnectionDetails.
    ...
    def user_id(self, user_id):
        """
        Sets the user_id of this CreateOracleAiDataPlatformConnectionDetails.
        The `OCID`__ of the OCI user who will access the Object Storage.
        The user must have write access to the bucket they want to connect to.
        If the user is not provided, backend will default to the user who is calling the API endpoint.
    ...
    def private_key_file_secret_id(self):
        """
        Gets the private_key_file_secret_id of this CreateOracleAiDataPlatformConnectionDetails.
    ...
    def private_key_file_secret_id(self, private_key_file_secret_id):
        """
        Sets the private_key_file_secret_id of this CreateOracleAiDataPlatformConnectionDetails.
        The `OCID`__ of the Secret that stores the content of the private key file (PEM file) corresponding to the API key of the fingerprint.
        See documentation: https://docs.oracle.com/en-us/iaas/Content/Identity/Tasks/managingcredentials.htm
        Note: When provided, 'privateKeyFile' field must not be provided.
    ...
    def private_key_passphrase_secret_id(self):
        """
        Gets the private_key_passphrase_secret_id of this CreateOracleAiDataPlatformConnectionDetails.
    ...
    def private_key_passphrase_secret_id(self, private_key_passphrase_secret_id):
        """
        Sets the private_key_passphrase_secret_id of this CreateOracleAiDataPlatformConnectionDetails.
        The `OCID`__ of the Secret that stores the passphrase of the private key.
        Note: When provided, 'privateKeyPassphrase' field must not be provided.
    ...
    def public_key_fingerprint(self):
        """
        Gets the public_key_fingerprint of this CreateOracleAiDataPlatformConnectionDetails.
        The fingerprint of the API Key of the user specified by the userId.
        See documentation: https://docs.oracle.com/en-us/iaas/Content/Identity/Tasks/managingcredentials.htm


        :return: The public_key_fingerprint of this CreateOracleAiDataPlatformConnectionDetails.
        :rtype: str
        """
    ...
    def public_key_fingerprint(self, public_key_fingerprint):
        """
        Sets the public_key_fingerprint of this CreateOracleAiDataPlatformConnectionDetails.
        The fingerprint of the API Key of the user specified by the userId.
        See documentation: https://docs.oracle.com/en-us/iaas/Content/Identity/Tasks/managingcredentials.htm


        :param public_key_fingerprint: The public_key_fingerprint of this CreateOracleAiDataPlatformConnectionDetails.
        :type: str
        """
    ...
    def should_use_resource_principal(self):
        """
        Gets the should_use_resource_principal of this CreateOracleAiDataPlatformConnectionDetails.
        Specifies that the user intends to authenticate to the instance using a resource principal.
        Default: false


        :return: The should_use_resource_principal of this CreateOracleAiDataPlatformConnectionDetails.
        :rtype: bool
        """
    ...
    def should_use_resource_principal(self, should_use_resource_principal):
        """
        Sets the should_use_resource_principal of this CreateOracleAiDataPlatformConnectionDetails.
        Specifies that the user intends to authenticate to the instance using a resource principal.
        Default: false


        :param should_use_resource_principal: The should_use_resource_principal of this CreateOracleAiDataPlatformConnectionDetails.
        :type: bool
        """
