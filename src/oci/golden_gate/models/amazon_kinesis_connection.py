...
class AmazonKinesisConnection(Connection):
    """
    Represents the metadata of a Amazon Kinesis Connection.
    """

    #: A constant which can be used with the technology_type property of a AmazonKinesisConnection.
    #: This constant has a value of "AMAZON_KINESIS"
    TECHNOLOGY_TYPE_AMAZON_KINESIS = "AMAZON_KINESIS"

    def __init__(self, **kwargs):
        """
        Initializes a new AmazonKinesisConnection object with values from keyword arguments. The default value of the :py:attr:`~oci.golden_gate.models.AmazonKinesisConnection.connection_type` attribute
        of this class is ``AMAZON_KINESIS`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param connection_type:
            The value to assign to the connection_type property of this AmazonKinesisConnection.
        ...
        :param id:
            The value to assign to the id property of this AmazonKinesisConnection.
        :type id: str

        :param display_name:
            The value to assign to the display_name property of this AmazonKinesisConnection.
        :type display_name: str

        :param description:
            The value to assign to the description property of this AmazonKinesisConnection.
        :type description: str

        :param compartment_id:
            The value to assign to the compartment_id property of this AmazonKinesisConnection.
        :type compartment_id: str

        :param freeform_tags:
            The value to assign to the freeform_tags property of this AmazonKinesisConnection.
        :type freeform_tags: dict(str, str)

        :param defined_tags:
            The value to assign to the defined_tags property of this AmazonKinesisConnection.
        :type defined_tags: dict(str, dict(str, object))

        :param system_tags:
            The value to assign to the system_tags property of this AmazonKinesisConnection.
        :type system_tags: dict(str, dict(str, object))

        :param lifecycle_state:
            The value to assign to the lifecycle_state property of this AmazonKinesisConnection.
            Allowed values for this property are: "CREATING", "UPDATING", "ACTIVE", "DELETING", "DELETED", "FAILED", 'UNKNOWN_ENUM_VALUE'.
            Any unrecognized values returned by a service will be mapped to 'UNKNOWN_ENUM_VALUE'.
        :type lifecycle_state: str

        :param lifecycle_details:
            The value to assign to the lifecycle_details property of this AmazonKinesisConnection.
        :type lifecycle_details: str

        :param time_created:
            The value to assign to the time_created property of this AmazonKinesisConnection.
        :type time_created: datetime

        :param time_updated:
            The value to assign to the time_updated property of this AmazonKinesisConnection.
        :type time_updated: datetime

        :param locks:
            The value to assign to the locks property of this AmazonKinesisConnection.
        :type locks: list[oci.golden_gate.models.ResourceLock]

        :param vault_id:
            The value to assign to the vault_id property of this AmazonKinesisConnection.
        :type vault_id: str

        :param key_id:
            The value to assign to the key_id property of this AmazonKinesisConnection.
        :type key_id: str

        :param ingress_ips:
            The value to assign to the ingress_ips property of this AmazonKinesisConnection.
        :type ingress_ips: list[oci.golden_gate.models.IngressIpDetails]

        :param nsg_ids:
            The value to assign to the nsg_ids property of this AmazonKinesisConnection.
        :type nsg_ids: list[str]

        :param subnet_id:
            The value to assign to the subnet_id property of this AmazonKinesisConnection.
        :type subnet_id: str

        :param routing_method:
            The value to assign to the routing_method property of this AmazonKinesisConnection.
        ...
        :param subscription_id:
            The value to assign to the subscription_id property of this AmazonKinesisConnection.
        :type subscription_id: str

        :param cluster_placement_group_id:
            The value to assign to the cluster_placement_group_id property of this AmazonKinesisConnection.
        :type cluster_placement_group_id: str

        :param security_attributes:
            The value to assign to the security_attributes property of this AmazonKinesisConnection.
    ...
    def technology_type(self):
        """
        **[Required]** Gets the technology_type of this AmazonKinesisConnection.
        ...
        :return: The technology_type of this AmazonKinesisConnection.
        :rtype: str
        """
    ...
    def technology_type(self, technology_type):
        """
        Sets the technology_type of this AmazonKinesisConnection.
        The Amazon Kinesis technology type.


        :param technology_type: The technology_type of this AmazonKinesisConnection.
        :type: str
        """
        allowed_values = ["AMAZON_KINESIS"]
    ...
    def access_key_id(self):
        """
        **[Required]** Gets the access_key_id of this AmazonKinesisConnection.
        Access key ID to access the Amazon Kinesis.


        :return: The access_key_id of this AmazonKinesisConnection.
        :rtype: str
        """
    ...
    def access_key_id(self, access_key_id):
        """
        Sets the access_key_id of this AmazonKinesisConnection.
        Access key ID to access the Amazon Kinesis.


        :param access_key_id: The access_key_id of this AmazonKinesisConnection.
        :type: str
        """
