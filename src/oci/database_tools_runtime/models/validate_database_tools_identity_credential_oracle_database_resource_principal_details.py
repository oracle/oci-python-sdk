...
class ValidateDatabaseToolsIdentityCredentialOracleDatabaseResourcePrincipalDetails(ValidateDatabaseToolsIdentityCredentialDetails):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ValidateDatabaseToolsIdentityCredentialOracleDatabaseResourcePrincipalDetails object with values from keyword arguments. The default value of the :py:attr:`~oci.database_tools_runtime.models.ValidateDatabaseToolsIdentityCredentialOracleDatabaseResourcePrincipalDetails.type` attribute
