...
class ValidateDatabaseToolsIdentityCredentialOracleDatabaseResourcePrincipalResult(ValidateDatabaseToolsIdentityCredentialResult):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ValidateDatabaseToolsIdentityCredentialOracleDatabaseResourcePrincipalResult object with values from keyword arguments. The default value of the :py:attr:`~oci.database_tools_runtime.models.ValidateDatabaseToolsIdentityCredentialOracleDatabaseResourcePrincipalResult.type` attribute
