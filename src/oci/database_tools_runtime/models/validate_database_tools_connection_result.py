...
class ValidateDatabaseToolsConnectionResult(object):
    ...
    def __init__(self, **kwargs):
        ...
        * :class:`~oci.database_tools_runtime.models.ValidateDatabaseToolsConnectionOracleDatabaseResult`
        * :class:`~oci.database_tools_runtime.models.ValidateDatabaseToolsConnectionMySqlResult`
        * :class:`~oci.database_tools_runtime.models.ValidateDatabaseToolsConnectionPostgresqlResult`

        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param type:
            The value to assign to the type property of this ValidateDatabaseToolsConnectionResult.
            Allowed values for this property are: "ORACLE_DATABASE", "MYSQL", "POSTGRESQL", 'UNKNOWN_ENUM_VALUE'.
    ...
    def type(self, type):
        ...
        :type: str
        """
        allowed_values = ["ORACLE_DATABASE", "MYSQL", "POSTGRESQL"]
