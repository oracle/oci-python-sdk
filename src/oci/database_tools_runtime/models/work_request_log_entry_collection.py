...
class WorkRequestLogEntryCollection(object):
    ...
    def __init__(self, **kwargs):
        ...
        :type items: list[oci.database_tools_runtime.models.WorkRequestLogEntry]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this WorkRequestLogEntryCollection.
        ...
        :rtype: list[oci.database_tools_runtime.models.WorkRequestLogEntry]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.database_tools_runtime.models.WorkRequestLogEntry]
        """
        self._items = items
