...
class WorkRequestSummary(object):
    ...
    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "EXECUTE_SQL_SCHEDULED_DELETION"
    ...
    def __init__(self, **kwargs):
        ...
        :param operation_type:
            ...
            Allowed values for this property are: "EXECUTE_SQL", "EXECUTE_SQL_SCHEDULED_DELETION", 'UNKNOWN_ENUM_VALUE'.
        ...
        :param created_by_principal_id:
            The value to assign to the created_by_principal_id property of this WorkRequestSummary.
        :type created_by_principal_id: str

        :param created_by_principal_domain_id:
            The value to assign to the created_by_principal_domain_id property of this WorkRequestSummary.
        :type created_by_principal_domain_id: str

        :param resources:
            The value to assign to the resources property of this WorkRequestSummary.
        :type resources: list[oci.database_tools_runtime.models.WorkRequestResource]
        ...
        self.swagger_types = {
            ...
            'created_by_principal_domain_id': 'str',
        ...
        self.attribute_map = {
            ...
            'created_by_principal_domain_id': 'createdByPrincipalDomainId',
            'resources': 'resources',
        ...
        self._created_by_principal_domain_id = None
    ...
    def operation_type(self, operation_type):
        ...
        :type: str
        """
        allowed_values = ["EXECUTE_SQL", "EXECUTE_SQL_SCHEDULED_DELETION"]
    ...
    def created_by_principal_id(self):
        """
        Gets the created_by_principal_id of this WorkRequestSummary.
        Principal id of the user or resource that submitted the asynchrounous request.


        :return: The created_by_principal_id of this WorkRequestSummary.
        :rtype: str
        """
    ...
    def created_by_principal_id(self, created_by_principal_id):
        """
        Sets the created_by_principal_id of this WorkRequestSummary.
        Principal id of the user or resource that submitted the asynchrounous request.


        :param created_by_principal_id: The created_by_principal_id of this WorkRequestSummary.
        :type: str
        """
        self._created_by_principal_id = created_by_principal_id

    @property
    def created_by_principal_domain_id(self):
        """
        Gets the created_by_principal_domain_id of this WorkRequestSummary.
        Identity domain OCID for the user that submitted the asynchronous request.


        :return: The created_by_principal_domain_id of this WorkRequestSummary.
        :rtype: str
        """
        return self._created_by_principal_domain_id

    @created_by_principal_domain_id.setter
    def created_by_principal_domain_id(self, created_by_principal_domain_id):
        """
        Sets the created_by_principal_domain_id of this WorkRequestSummary.
        Identity domain OCID for the user that submitted the asynchronous request.


        :param created_by_principal_domain_id: The created_by_principal_domain_id of this WorkRequestSummary.
        :type: str
        """
        self._created_by_principal_domain_id = created_by_principal_domain_id
    ...
    def resources(self):
        ...
        :rtype: list[oci.database_tools_runtime.models.WorkRequestResource]
        """
    ...
    def resources(self, resources):
        ...
        :type: list[oci.database_tools_runtime.models.WorkRequestResource]
        """
