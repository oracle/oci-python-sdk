...
class ValidateDatabaseToolsConnectionOracleDatabaseDetails(ValidateDatabaseToolsConnectionDetails):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ValidateDatabaseToolsConnectionOracleDatabaseDetails object with values from keyword arguments. The default value of the :py:attr:`~oci.database_tools_runtime.models.ValidateDatabaseToolsConnectionOracleDatabaseDetails.type` attribute
