...
class ValidateDatabaseToolsConnectionDetails(object):
    ...
    def __init__(self, **kwargs):
        ...
        * :class:`~oci.database_tools_runtime.models.ValidateDatabaseToolsConnectionPostgresqlDetails`
        * :class:`~oci.database_tools_runtime.models.ValidateDatabaseToolsConnectionMySqlDetails`
        * :class:`~oci.database_tools_runtime.models.ValidateDatabaseToolsConnectionOracleDatabaseDetails`
