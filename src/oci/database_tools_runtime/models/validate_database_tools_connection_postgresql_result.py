...
class ValidateDatabaseToolsConnectionPostgresqlResult(ValidateDatabaseToolsConnectionResult):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ValidateDatabaseToolsConnectionPostgresqlResult object with values from keyword arguments. The default value of the :py:attr:`~oci.database_tools_runtime.models.ValidateDatabaseToolsConnectionPostgresqlResult.type` attribute
