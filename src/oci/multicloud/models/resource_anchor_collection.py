...
class ResourceAnchorCollection(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ResourceAnchorCollection object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param items:
            The value to assign to the items property of this ResourceAnchorCollection.
        :type items: list[oci.multicloud.models.ResourceAnchorSummary]

        """
        self.swagger_types = {
            'items': 'list[ResourceAnchorSummary]'
        }
        self.attribute_map = {
            'items': 'items'
        }
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this ResourceAnchorCollection.
        ...
        :rtype: list[oci.multicloud.models.ResourceAnchorSummary]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.multicloud.models.ResourceAnchorSummary]
        """
        self._items = items
