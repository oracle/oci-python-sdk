...
class MulticloudPoliciesClient(object):
    """
    ...
    def __init__(self, config, **kwargs):
        ...
        self.base_client = BaseClient("multicloud_policies", config, signer, multicloud_type_mapping, **base_client_init_kwargs)
        self.retry_strategy = kwargs.get('retry_strategy')
        self.circuit_breaker_callback = kwargs.get('circuit_breaker_callback')

    def list_multicloud_policies(self, compartment_id, **kwargs):
        """
        ...
        :param bool is_force_refresh: (optional)
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.multicloud.models.MulticloudPolicyCollection`
        :rtype: :class:`~oci.response.Response`

        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/multicloud/list_multicloud_policies.py.html>`__ to see an example of how to use list_multicloud_policies API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        resource_path = "/multicloudpolicies"
        method = "GET"
        operation_name = "list_multicloud_policies"
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/multicloud-omhub-cp/20180828/MulticloudPolicyCollection/ListMulticloudPolicies"
        ...
        if extra_kwargs:
            raise ValueError(
                f"list_multicloud_policies got unknown kwargs: {extra_kwargs!r}")
        ...
        query_params = {
            ...
            "isForceRefresh": kwargs.get("is_force_refresh", missing),
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                response_type="MulticloudPolicyCollection",
