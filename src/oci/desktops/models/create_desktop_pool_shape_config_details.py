...
class CreateDesktopPoolShapeConfigDetails(object):
    """
    The compute instance shape configuration requested for each desktop in the desktop pool.
    """

    #: A constant which can be used with the baseline_ocpu_utilization property of a CreateDesktopPoolShapeConfigDetails.
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new CreateDesktopPoolShapeConfigDetails object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param ocpus:
            The value to assign to the ocpus property of this CreateDesktopPoolShapeConfigDetails.
        :type ocpus: int

        :param memory_in_gbs:
            The value to assign to the memory_in_gbs property of this CreateDesktopPoolShapeConfigDetails.
        :type memory_in_gbs: int

        :param baseline_ocpu_utilization:
            The value to assign to the baseline_ocpu_utilization property of this CreateDesktopPoolShapeConfigDetails.
    ...
    def ocpus(self):
        """
        Gets the ocpus of this CreateDesktopPoolShapeConfigDetails.
        The total number of OCPUs available for each desktop compute instance in the desktop pool.


        :return: The ocpus of this CreateDesktopPoolShapeConfigDetails.
        :rtype: int
        """
        return self._ocpus
    ...
    def ocpus(self, ocpus):
        """
        Sets the ocpus of this CreateDesktopPoolShapeConfigDetails.
        The total number of OCPUs available for each desktop compute instance in the desktop pool.


        :param ocpus: The ocpus of this CreateDesktopPoolShapeConfigDetails.
        :type: int
        """
        self._ocpus = ocpus
    ...
    def memory_in_gbs(self):
        """
        Gets the memory_in_gbs of this CreateDesktopPoolShapeConfigDetails.
        The total amount of memory available in gigabytes for each desktop compute instance in the desktop pool.


        :return: The memory_in_gbs of this CreateDesktopPoolShapeConfigDetails.
        :rtype: int
        """
    ...
    def memory_in_gbs(self, memory_in_gbs):
        """
        Sets the memory_in_gbs of this CreateDesktopPoolShapeConfigDetails.
        The total amount of memory available in gigabytes for each desktop compute instance in the desktop pool.


        :param memory_in_gbs: The memory_in_gbs of this CreateDesktopPoolShapeConfigDetails.
        :type: int
        """
    ...
    def baseline_ocpu_utilization(self):
        """
        Gets the baseline_ocpu_utilization of this CreateDesktopPoolShapeConfigDetails.
        ...
        :return: The baseline_ocpu_utilization of this CreateDesktopPoolShapeConfigDetails.
        :rtype: str
        """
    ...
    def baseline_ocpu_utilization(self, baseline_ocpu_utilization):
        """
        Sets the baseline_ocpu_utilization of this CreateDesktopPoolShapeConfigDetails.
        The baseline OCPU utilization for a subcore burstable VM instance used for each desktop compute instance in
        the desktop pool.
        Leave this attribute blank for a non-burstable instance, or explicitly specify non-burstable with
        `BASELINE_1_1`.
        ...
        :param baseline_ocpu_utilization: The baseline_ocpu_utilization of this CreateDesktopPoolShapeConfigDetails.
        :type: str
        """
