...
class WorkRequest(object):
    ...
    #: This constant has a value of "CREATE_DESKTOP_POOL"
    OPERATION_TYPE_CREATE_DESKTOP_POOL = "CREATE_DESKTOP_POOL"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "UPDATE_DESKTOP_POOL"
    OPERATION_TYPE_UPDATE_DESKTOP_POOL = "UPDATE_DESKTOP_POOL"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "DELETE_DESKTOP_POOL"
    OPERATION_TYPE_DELETE_DESKTOP_POOL = "DELETE_DESKTOP_POOL"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "MOVE_DESKTOP_POOL"
    OPERATION_TYPE_MOVE_DESKTOP_POOL = "MOVE_DESKTOP_POOL"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "START_DESKTOP_POOL"
    OPERATION_TYPE_START_DESKTOP_POOL = "START_DESKTOP_POOL"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "STOP_DESKTOP_POOL"
    OPERATION_TYPE_STOP_DESKTOP_POOL = "STOP_DESKTOP_POOL"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "DELETE_DESKTOP"
    OPERATION_TYPE_DELETE_DESKTOP = "DELETE_DESKTOP"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "UPDATE_DESKTOP"
    OPERATION_TYPE_UPDATE_DESKTOP = "UPDATE_DESKTOP"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "START_DESKTOP"
    OPERATION_TYPE_START_DESKTOP = "START_DESKTOP"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "STOP_DESKTOP"
    OPERATION_TYPE_STOP_DESKTOP = "STOP_DESKTOP"
    ...
    def __init__(self, **kwargs):
        ...
        :param operation_type:
            ...
            Allowed values for this property are: "CREATE_DESKTOP_POOL", "UPDATE_DESKTOP_POOL", "DELETE_DESKTOP_POOL", "MOVE_DESKTOP_POOL", "START_DESKTOP_POOL", "STOP_DESKTOP_POOL", "DELETE_DESKTOP", "UPDATE_DESKTOP", "START_DESKTOP", "STOP_DESKTOP", 'UNKNOWN_ENUM_VALUE'.
        ...
        :type resources: list[oci.desktops.models.WorkRequestResource]
    ...
    def operation_type(self, operation_type):
        ...
        :type: str
        """
        allowed_values = ["CREATE_DESKTOP_POOL", "UPDATE_DESKTOP_POOL", "DELETE_DESKTOP_POOL", "MOVE_DESKTOP_POOL", "START_DESKTOP_POOL", "STOP_DESKTOP_POOL", "DELETE_DESKTOP", "UPDATE_DESKTOP", "START_DESKTOP", "STOP_DESKTOP"]
    ...
    def resources(self):
        ...
        **[Required]** Gets the resources of this WorkRequest.
        ...
        :rtype: list[oci.desktops.models.WorkRequestResource]
        """
    ...
    def resources(self, resources):
        ...
        :type: list[oci.desktops.models.WorkRequestResource]
        """
