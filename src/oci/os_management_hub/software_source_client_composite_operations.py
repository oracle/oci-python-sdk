...
class SoftwareSourceClientCompositeOperations(object):
    """
    This class provides a wrapper around :py:class:`~oci.os_management_hub.SoftwareSourceClient` and offers convenience methods
    ...
    def __init__(self, client, **kwargs):
        """
        Creates a new SoftwareSourceClientCompositeOperations object

        :param SoftwareSourceClient client:
    ...
    def create_software_source_and_wait_for_state(self, create_software_source_details, wait_for_states=[], operation_kwargs={}, waiter_kwargs={}):
        ...
        :param dict operation_kwargs:
            A dictionary of keyword arguments to pass to :py:func:`~oci.os_management_hub.SoftwareSourceClient.create_software_source`
    ...
    def delete_software_source_and_wait_for_state(self, software_source_id, wait_for_states=[], operation_kwargs={}, waiter_kwargs={}):
        """
        Calls :py:func:`~oci.os_management_hub.SoftwareSourceClient.delete_software_source` and waits for the :py:class:`~oci.os_management_hub.models.SoftwareSource` acted upon
        to enter the given state(s).
        ...
        :param dict operation_kwargs:
            A dictionary of keyword arguments to pass to :py:func:`~oci.os_management_hub.SoftwareSourceClient.delete_software_source`
    ...
    def update_software_source_and_wait_for_state(self, software_source_id, update_software_source_details, wait_for_states=[], operation_kwargs={}, waiter_kwargs={}):
        ...
        :param dict operation_kwargs:
            A dictionary of keyword arguments to pass to :py:func:`~oci.os_management_hub.SoftwareSourceClient.update_software_source`
