...
class ModuleCollection(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ModuleCollection object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param items:
            The value to assign to the items property of this ModuleCollection.
        :type items: list[oci.os_management_hub.models.ModuleSummary]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this ModuleCollection.
        ...
        :rtype: list[oci.os_management_hub.models.ModuleSummary]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.os_management_hub.models.ModuleSummary]
        """
        self._items = items
