...
class StageUpdateOnManagedInstanceDetails(object):
    """
    Provides the information used to stage updates on an instance.
    """

    #: A constant which can be used with the update_types property of a StageUpdateOnManagedInstanceDetails.
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new StageUpdateOnManagedInstanceDetails object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param package_names:
            The value to assign to the package_names property of this StageUpdateOnManagedInstanceDetails.
        :type package_names: list[str]

        :param update_types:
            The value to assign to the update_types property of this StageUpdateOnManagedInstanceDetails.
        ...
        :param work_request_details:
            The value to assign to the work_request_details property of this StageUpdateOnManagedInstanceDetails.
    ...
    def package_names(self):
        """
        Gets the package_names of this StageUpdateOnManagedInstanceDetails.
        The list of package names.


        :return: The package_names of this StageUpdateOnManagedInstanceDetails.
        :rtype: list[str]
        """
    ...
    def package_names(self, package_names):
        """
        Sets the package_names of this StageUpdateOnManagedInstanceDetails.
        The list of package names.


        :param package_names: The package_names of this StageUpdateOnManagedInstanceDetails.
        :type: list[str]
        """
    ...
    def update_types(self):
        """
        Gets the update_types of this StageUpdateOnManagedInstanceDetails.
        The types of updates to be applied.

        Allowed values for items in this list are: "SECURITY", "BUGFIX", "ENHANCEMENT", "OTHER", "KSPLICE_KERNEL", "KSPLICE_USERSPACE", "ALL"


        :return: The update_types of this StageUpdateOnManagedInstanceDetails.
        :rtype: list[str]
        """
    ...
    def update_types(self, update_types):
        """
        Sets the update_types of this StageUpdateOnManagedInstanceDetails.
        The types of updates to be applied.


        :param update_types: The update_types of this StageUpdateOnManagedInstanceDetails.
        :type: list[str]
        """
    ...
    def work_request_details(self):
        """
        Gets the work_request_details of this StageUpdateOnManagedInstanceDetails.

        :return: The work_request_details of this StageUpdateOnManagedInstanceDetails.
    ...
    def work_request_details(self, work_request_details):
        """
        Sets the work_request_details of this StageUpdateOnManagedInstanceDetails.

        :param work_request_details: The work_request_details of this StageUpdateOnManagedInstanceDetails.
