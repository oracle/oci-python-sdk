...
class ModuleStreamCollection(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ModuleStreamCollection object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param items:
            The value to assign to the items property of this ModuleStreamCollection.
        :type items: list[oci.os_management_hub.models.ModuleStreamSummary]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this ModuleStreamCollection.
        ...
        :rtype: list[oci.os_management_hub.models.ModuleStreamSummary]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.os_management_hub.models.ModuleStreamSummary]
        """
        self._items = items
