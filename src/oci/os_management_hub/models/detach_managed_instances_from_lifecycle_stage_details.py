...
class DetachManagedInstancesFromLifecycleStageDetails(object):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new DetachManagedInstancesFromLifecycleStageDetails object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param managed_instance_details:
            The value to assign to the managed_instance_details property of this DetachManagedInstancesFromLifecycleStageDetails.
    ...
    def managed_instance_details(self, managed_instance_details):
        """
        Sets the managed_instance_details of this DetachManagedInstancesFromLifecycleStageDetails.

        :param managed_instance_details: The managed_instance_details of this DetachManagedInstancesFromLifecycleStageDetails.
