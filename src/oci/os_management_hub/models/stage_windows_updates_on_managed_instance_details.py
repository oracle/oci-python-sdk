...
class StageWindowsUpdatesOnManagedInstanceDetails(object):
    """
    Provides the information used to download Windows updates on a managed instance.
    """

    #: A constant which can be used with the windows_update_types property of a StageWindowsUpdatesOnManagedInstanceDetails.
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new StageWindowsUpdatesOnManagedInstanceDetails object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param windows_update_name:
            The value to assign to the windows_update_name property of this StageWindowsUpdatesOnManagedInstanceDetails.
        :type windows_update_name: list[str]

        :param windows_update_types:
            The value to assign to the windows_update_types property of this StageWindowsUpdatesOnManagedInstanceDetails.
        ...
        :param work_request_details:
            The value to assign to the work_request_details property of this StageWindowsUpdatesOnManagedInstanceDetails.
    ...
    def windows_update_name(self):
        """
        Gets the windows_update_name of this StageWindowsUpdatesOnManagedInstanceDetails.
        ...
        :return: The windows_update_name of this StageWindowsUpdatesOnManagedInstanceDetails.
        :rtype: list[str]
        """
    ...
    def windows_update_name(self, windows_update_name):
        """
        Sets the windows_update_name of this StageWindowsUpdatesOnManagedInstanceDetails.
        The list of Windows update unique identifiers.
        Note that this is not an OCID, but is a unique identifier assigned by Microsoft.
        Example: '6981d463-cd91-4a26-b7c4-ea4ded9183ed'


        :param windows_update_name: The windows_update_name of this StageWindowsUpdatesOnManagedInstanceDetails.
        :type: list[str]
        """
    ...
    def windows_update_types(self):
        """
        Gets the windows_update_types of this StageWindowsUpdatesOnManagedInstanceDetails.
        The types of Windows updates to be installed.

        Allowed values for items in this list are: "SECURITY", "BUGFIX", "ENHANCEMENT", "OTHER", "ALL"


        :return: The windows_update_types of this StageWindowsUpdatesOnManagedInstanceDetails.
        :rtype: list[str]
        """
    ...
    def windows_update_types(self, windows_update_types):
        """
        Sets the windows_update_types of this StageWindowsUpdatesOnManagedInstanceDetails.
        The types of Windows updates to be installed.


        :param windows_update_types: The windows_update_types of this StageWindowsUpdatesOnManagedInstanceDetails.
        :type: list[str]
        """
    ...
    def work_request_details(self):
        """
        Gets the work_request_details of this StageWindowsUpdatesOnManagedInstanceDetails.

        :return: The work_request_details of this StageWindowsUpdatesOnManagedInstanceDetails.
    ...
    def work_request_details(self, work_request_details):
        """
        Sets the work_request_details of this StageWindowsUpdatesOnManagedInstanceDetails.

        :param work_request_details: The work_request_details of this StageWindowsUpdatesOnManagedInstanceDetails.
