...
class SoftwareSourceCollection(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new SoftwareSourceCollection object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param items:
            The value to assign to the items property of this SoftwareSourceCollection.
        :type items: list[oci.os_management_hub.models.SoftwareSourceSummary]

        """
        self.swagger_types = {
            'items': 'list[SoftwareSourceSummary]'
        }
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this SoftwareSourceCollection.
        ...
        :rtype: list[oci.os_management_hub.models.SoftwareSourceSummary]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.os_management_hub.models.SoftwareSourceSummary]
        """
        self._items = items
