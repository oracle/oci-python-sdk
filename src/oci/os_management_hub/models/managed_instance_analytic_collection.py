...
class ManagedInstanceAnalyticCollection(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ManagedInstanceAnalyticCollection object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param items:
            The value to assign to the items property of this ManagedInstanceAnalyticCollection.
        :type items: list[oci.os_management_hub.models.ManagedInstanceAnalyticSummary]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this ManagedInstanceAnalyticCollection.
        ...
        :rtype: list[oci.os_management_hub.models.ManagedInstanceAnalyticSummary]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.os_management_hub.models.ManagedInstanceAnalyticSummary]
        """
        self._items = items
