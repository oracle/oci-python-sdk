...
class ManagementStationCollection(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ManagementStationCollection object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param items:
            The value to assign to the items property of this ManagementStationCollection.
        :type items: list[oci.os_management_hub.models.ManagementStationSummary]

        """
        self.swagger_types = {
            'items': 'list[ManagementStationSummary]'
        }
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this ManagementStationCollection.
        ...
        :rtype: list[oci.os_management_hub.models.ManagementStationSummary]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.os_management_hub.models.ManagementStationSummary]
        """
        self._items = items
