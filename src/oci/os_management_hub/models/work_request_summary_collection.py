...
class WorkRequestSummaryCollection(object):
    ...
    def __init__(self, **kwargs):
        ...
        :type items: list[oci.os_management_hub.models.WorkRequestSummary]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this WorkRequestSummaryCollection.
        ...
        :rtype: list[oci.os_management_hub.models.WorkRequestSummary]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.os_management_hub.models.WorkRequestSummary]
        """
        self._items = items
