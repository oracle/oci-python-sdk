...
class DetachSoftwareSourcesFromManagedInstanceGroupDetails(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new DetachSoftwareSourcesFromManagedInstanceGroupDetails object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param software_sources:
            The value to assign to the software_sources property of this DetachSoftwareSourcesFromManagedInstanceGroupDetails.
        :type software_sources: list[str]

        :param work_request_details:
            The value to assign to the work_request_details property of this DetachSoftwareSourcesFromManagedInstanceGroupDetails.
    ...
    def work_request_details(self):
        ...
        :return: The work_request_details of this DetachSoftwareSourcesFromManagedInstanceGroupDetails.
    ...
    def work_request_details(self, work_request_details):
        """
        Sets the work_request_details of this DetachSoftwareSourcesFromManagedInstanceGroupDetails.

        :param work_request_details: The work_request_details of this DetachSoftwareSourcesFromManagedInstanceGroupDetails.
