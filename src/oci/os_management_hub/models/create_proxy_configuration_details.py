...
class CreateProxyConfigurationDetails(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new CreateProxyConfigurationDetails object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param is_enabled:
            The value to assign to the is_enabled property of this CreateProxyConfigurationDetails.
        :type is_enabled: bool

        :param hosts:
            The value to assign to the hosts property of this CreateProxyConfigurationDetails.
        :type hosts: list[str]

        :param port:
            The value to assign to the port property of this CreateProxyConfigurationDetails.
        :type port: str

        :param forward:
            The value to assign to the forward property of this CreateProxyConfigurationDetails.
        :type forward: str
