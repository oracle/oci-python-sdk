...
class UpdatePackagesOnDynamicSetDetails(object):
    """
    Provides the information used to update software packages on a dynamic set.
    """

    #: A constant which can be used with the update_types property of a UpdatePackagesOnDynamicSetDetails.
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new UpdatePackagesOnDynamicSetDetails object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param update_types:
            The value to assign to the update_types property of this UpdatePackagesOnDynamicSetDetails.
        ...
        :param managed_instances:
            The value to assign to the managed_instances property of this UpdatePackagesOnDynamicSetDetails.
        :type managed_instances: list[str]

        :param work_request_details:
            The value to assign to the work_request_details property of this UpdatePackagesOnDynamicSetDetails.
    ...
    def update_types(self):
        """
        Gets the update_types of this UpdatePackagesOnDynamicSetDetails.
        The types of updates to be applied.

        Allowed values for items in this list are: "SECURITY", "BUGFIX", "ENHANCEMENT", "OTHER", "KSPLICE_KERNEL", "KSPLICE_USERSPACE", "ALL"


        :return: The update_types of this UpdatePackagesOnDynamicSetDetails.
        :rtype: list[str]
        """
    ...
    def update_types(self, update_types):
        """
        Sets the update_types of this UpdatePackagesOnDynamicSetDetails.
        The types of updates to be applied.


        :param update_types: The update_types of this UpdatePackagesOnDynamicSetDetails.
        :type: list[str]
        """
    ...
    def managed_instances(self):
        """
        Gets the managed_instances of this UpdatePackagesOnDynamicSetDetails.
        The list of managed instance OCIDs to be attached/detached.


        :return: The managed_instances of this UpdatePackagesOnDynamicSetDetails.
        :rtype: list[str]
        """
    ...
    def managed_instances(self, managed_instances):
        """
        Sets the managed_instances of this UpdatePackagesOnDynamicSetDetails.
        The list of managed instance OCIDs to be attached/detached.


        :param managed_instances: The managed_instances of this UpdatePackagesOnDynamicSetDetails.
        :type: list[str]
        """
    ...
    def work_request_details(self):
        """
        Gets the work_request_details of this UpdatePackagesOnDynamicSetDetails.

        :return: The work_request_details of this UpdatePackagesOnDynamicSetDetails.
    ...
    def work_request_details(self, work_request_details):
        """
        Sets the work_request_details of this UpdatePackagesOnDynamicSetDetails.

        :param work_request_details: The work_request_details of this UpdatePackagesOnDynamicSetDetails.
