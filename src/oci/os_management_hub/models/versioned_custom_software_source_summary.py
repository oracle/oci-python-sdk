...
class VersionedCustomSoftwareSourceSummary(SoftwareSourceSummary):
    ...
    def __init__(self, **kwargs):
        ...
        :param id:
            The value to assign to the id property of this VersionedCustomSoftwareSourceSummary.
        :type id: str

        :param compartment_id:
            The value to assign to the compartment_id property of this VersionedCustomSoftwareSourceSummary.
        :type compartment_id: str

        :param display_name:
            The value to assign to the display_name property of this VersionedCustomSoftwareSourceSummary.
        :type display_name: str

        :param repo_id:
            The value to assign to the repo_id property of this VersionedCustomSoftwareSourceSummary.
        :type repo_id: str

        :param url:
            The value to assign to the url property of this VersionedCustomSoftwareSourceSummary.
        :type url: str

        :param time_created:
            The value to assign to the time_created property of this VersionedCustomSoftwareSourceSummary.
        :type time_created: datetime

        :param time_updated:
            The value to assign to the time_updated property of this VersionedCustomSoftwareSourceSummary.
        :type time_updated: datetime

        :param description:
            The value to assign to the description property of this VersionedCustomSoftwareSourceSummary.
        ...
        :param package_count:
            The value to assign to the package_count property of this VersionedCustomSoftwareSourceSummary.
        ...
        :param defined_tags:
            The value to assign to the defined_tags property of this VersionedCustomSoftwareSourceSummary.
        :type defined_tags: dict(str, dict(str, object))

        :param system_tags:
            The value to assign to the system_tags property of this VersionedCustomSoftwareSourceSummary.
        :type system_tags: dict(str, dict(str, object))

        :param vendor_software_sources:
            The value to assign to the vendor_software_sources property of this VersionedCustomSoftwareSourceSummary.
    ...
    def software_source_version(self):
        """
        **[Required]** Gets the software_source_version of this VersionedCustomSoftwareSourceSummary.
        The version to assign to this custom software source.


        :return: The software_source_version of this VersionedCustomSoftwareSourceSummary.
        :rtype: str
        """
    ...
    def software_source_version(self, software_source_version):
        """
        Sets the software_source_version of this VersionedCustomSoftwareSourceSummary.
        The version to assign to this custom software source.


        :param software_source_version: The software_source_version of this VersionedCustomSoftwareSourceSummary.
        :type: str
        """
