...
class LustreFileStorageClient(object):
    ...
    def list_available_maintenance_schedule_start_times(self, **kwargs):
        """
        ...
        :param str day_of_week: (optional)
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.lustre_file_storage.models.AvailableMaintenanceScheduleStartTimeCollection`
        :rtype: :class:`~oci.response.Response`
        ...
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/availableMaintenanceScheduleStartTimes"
        method = "GET"
        operation_name = "list_available_maintenance_schedule_start_times"
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/lustre/20250228/AvailableMaintenanceScheduleStartTimeCollection/ListAvailableMaintenanceScheduleStartTimes"
        ...
        if extra_kwargs:
            raise ValueError(
                f"list_available_maintenance_schedule_start_times got unknown kwargs: {extra_kwargs!r}")

        if 'day_of_week' in kwargs:
            day_of_week_allowed_values = ["MONDAY", "TUESDAY", "WEDNESDAY", "THURSDAY", "FRIDAY", "SATURDAY", "SUNDAY"]
            if kwargs['day_of_week'] not in day_of_week_allowed_values:
                raise ValueError(
                    f"Invalid value for `day_of_week`, must be one of { day_of_week_allowed_values }"
                )

        if 'sort_by' in kwargs:
            sort_by_allowed_values = ["dayOfWeek"]
        ...
        query_params = {
            ...
            "dayOfWeek": kwargs.get("day_of_week", missing),
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                header_params=header_params,
                response_type="AvailableMaintenanceScheduleStartTimeCollection",
                allow_control_chars=kwargs.get('allow_control_chars'),
                enable_strict_url_encoding=kwargs.get('enable_strict_url_encoding'),
                operation_name=operation_name,
                api_reference_link=api_reference_link,
    ...
    def list_available_override_maintenance_start_times(self, id, **kwargs):
        """
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.lustre_file_storage.models.AvailableOverrideMaintenanceStartTimeCollection`
        :rtype: :class:`~oci.response.Response`
        ...
        resource_path = "/availableOverrideMaintenanceStartTimes"
        method = "GET"
        operation_name = "list_available_override_maintenance_start_times"
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/lustre/20250228/AvailableOverrideMaintenanceStartTimeCollection/ListAvailableOverrideMaintenanceStartTimes"
        ...
        if extra_kwargs:
            raise ValueError(
                f"list_available_override_maintenance_start_times got unknown kwargs: {extra_kwargs!r}")

        if 'sort_by' in kwargs:
            sort_by_allowed_values = ["date"]
            if kwargs['sort_by'] not in sort_by_allowed_values:
                raise ValueError(
                    f"Invalid value for `sort_by`, must be one of { sort_by_allowed_values }"
                )
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                query_params=query_params,
                header_params=header_params,
                response_type="AvailableOverrideMaintenanceStartTimeCollection",
                allow_control_chars=kwargs.get('allow_control_chars'),
                enable_strict_url_encoding=kwargs.get('enable_strict_url_encoding'),
                operation_name=operation_name,
                api_reference_link=api_reference_link,
    ...
    def override_maintenance(self, lustre_file_system_id, override_maintenance_details, **kwargs):
        """
        ...
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['lustreFileSystemId']
        resource_path = "/lustreFileSystems/{lustreFileSystemId}/actions/overrideMaintenance"
        method = "POST"
        operation_name = "override_maintenance"
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/lustre/20250228/LustreFileSystem/OverrideMaintenance"
        ...
        if extra_kwargs:
            raise ValueError(
                f"override_maintenance got unknown kwargs: {extra_kwargs!r}")
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                path_params=path_params,
                header_params=header_params,
                body=override_maintenance_details,
                allow_control_chars=kwargs.get('allow_control_chars'),
                enable_strict_url_encoding=kwargs.get('enable_strict_url_encoding'),
                operation_name=operation_name,
                api_reference_link=api_reference_link,
