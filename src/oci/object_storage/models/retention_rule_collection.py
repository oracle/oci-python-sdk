...
class RetentionRuleCollection(object):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new RetentionRuleCollection object with values from keyword arguments.
    ...
    def items(self):
        """
        **[Required]** Gets the items of this RetentionRuleCollection.
    ...
    def items(self, items):
        """
        Sets the items of this RetentionRuleCollection.
        An array of retention rule summaries.
