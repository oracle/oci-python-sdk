...
class CreateBucketDetails(object):
    ...
    def __init__(self, **kwargs):
        ...
        :param is_bucket_key_enabled:
            The value to assign to the is_bucket_key_enabled property of this CreateBucketDetails.
    ...
    def is_bucket_key_enabled(self):
        """
        Gets the is_bucket_key_enabled of this CreateBucketDetails.
        ...
        :return: The is_bucket_key_enabled of this CreateBucketDetails.
        :rtype: bool
        """
    ...
    def is_bucket_key_enabled(self, is_bucket_key_enabled):
        """
        Sets the is_bucket_key_enabled of this CreateBucketDetails.
        Specifies whether Object Storage should use intermediate cached Bucket Encryption Keys with server-side
        encryption using KMS (SSE-KMS) for new objects in the bucket. This reduces calls to OCI Vault Key Management
        Service (KMS). Existing objects are not affected.


        :param is_bucket_key_enabled: The is_bucket_key_enabled of this CreateBucketDetails.
        :type: bool
        """
