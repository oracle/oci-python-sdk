...
class UpdateRetentionRuleDetails(object):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new UpdateRetentionRuleDetails object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param display_name:
            The value to assign to the display_name property of this UpdateRetentionRuleDetails.
        :type display_name: str

        :param duration:
            The value to assign to the duration property of this UpdateRetentionRuleDetails.
        :type duration: Duration

        :param time_rule_locked:
            The value to assign to the time_rule_locked property of this UpdateRetentionRuleDetails.
    ...
    def duration(self):
        ...
        :return: The duration of this UpdateRetentionRuleDetails.
        :rtype: Duration
        """
    ...
    def duration(self, duration):
        """
        Sets the duration of this UpdateRetentionRuleDetails.

        :param duration: The duration of this UpdateRetentionRuleDetails.
        :type: Duration
        """
    ...
    def time_rule_locked(self):
        """
        Gets the time_rule_locked of this UpdateRetentionRuleDetails.
        ...
        :return: The time_rule_locked of this UpdateRetentionRuleDetails.
        :rtype: datetime
        """
    ...
    def time_rule_locked(self, time_rule_locked):
        """
        Sets the time_rule_locked of this UpdateRetentionRuleDetails.
        The date and time as per `RFC 3339`__ after which this rule is locked
        and can only be deleted by deleting the bucket. Once a rule is locked, only increases in the duration are
        allowed and no other properties can be changed. This property cannot be updated for rules that are in a
        locked state. Specifying it when a duration is not specified is considered an error.
        ...
        :param time_rule_locked: The time_rule_locked of this UpdateRetentionRuleDetails.
        :type: datetime
        """
