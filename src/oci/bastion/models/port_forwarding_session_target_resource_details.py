...
class PortForwardingSessionTargetResourceDetails(TargetResourceDetails):
    ...
    def __init__(self, **kwargs):
        ...
        :param target_resource_fqdn:
            The value to assign to the target_resource_fqdn property of this PortForwardingSessionTargetResourceDetails.
    ...
    def target_resource_fqdn(self):
        """
        Gets the target_resource_fqdn of this PortForwardingSessionTargetResourceDetails.
        The Fully Qualified Domain Name of the target resource that the session connects to.


        :return: The target_resource_fqdn of this PortForwardingSessionTargetResourceDetails.
        :rtype: str
        """
    ...
    def target_resource_fqdn(self, target_resource_fqdn):
        """
        Sets the target_resource_fqdn of this PortForwardingSessionTargetResourceDetails.
        The Fully Qualified Domain Name of the target resource that the session connects to.


        :param target_resource_fqdn: The target_resource_fqdn of this PortForwardingSessionTargetResourceDetails.
        :type: str
        """
    ...
    def target_resource_port(self):
        """
        Gets the target_resource_port of this PortForwardingSessionTargetResourceDetails.
        The port number to connect to on the target resource.


        :return: The target_resource_port of this PortForwardingSessionTargetResourceDetails.
        :rtype: int
        """
    ...
    def target_resource_port(self, target_resource_port):
        """
        Sets the target_resource_port of this PortForwardingSessionTargetResourceDetails.
        The port number to connect to on the target resource.


        :param target_resource_port: The target_resource_port of this PortForwardingSessionTargetResourceDetails.
        :type: int
        """
