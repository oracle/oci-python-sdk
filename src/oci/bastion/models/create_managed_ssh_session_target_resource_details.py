...
class CreateManagedSshSessionTargetResourceDetails(CreateSessionTargetResourceDetails):
    ...
    def target_resource_port(self):
        """
        Gets the target_resource_port of this CreateManagedSshSessionTargetResourceDetails.
        The port number to connect to on the target resource.


        :return: The target_resource_port of this CreateManagedSshSessionTargetResourceDetails.
        :rtype: int
        """
    ...
    def target_resource_port(self, target_resource_port):
        """
        Sets the target_resource_port of this CreateManagedSshSessionTargetResourceDetails.
        The port number to connect to on the target resource.


        :param target_resource_port: The target_resource_port of this CreateManagedSshSessionTargetResourceDetails.
        :type: int
        """
