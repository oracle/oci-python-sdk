...
class Profile(object):
    ...
    def __init__(self, **kwargs):
        ...
        :param aggregation_interval_in_days:
            The value to assign to the aggregation_interval_in_days property of this Profile.
    ...
    def aggregation_interval_in_days(self):
        """
        Gets the aggregation_interval_in_days of this Profile.
        The time period over which to collect data for the recommendations, measured in number of days.


        :return: The aggregation_interval_in_days of this Profile.
        :rtype: int
        """
    ...
    def aggregation_interval_in_days(self, aggregation_interval_in_days):
        """
        Sets the aggregation_interval_in_days of this Profile.
        The time period over which to collect data for the recommendations, measured in number of days.


        :param aggregation_interval_in_days: The aggregation_interval_in_days of this Profile.
        :type: int
        """
