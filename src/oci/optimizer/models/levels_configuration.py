...
class LevelsConfiguration(object):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new LevelsConfiguration object with values from keyword arguments.
    ...
    def items(self):
        """
        Gets the items of this LevelsConfiguration.
    ...
    def items(self, items):
        """
        Sets the items of this LevelsConfiguration.
        The array of configuration levels.
