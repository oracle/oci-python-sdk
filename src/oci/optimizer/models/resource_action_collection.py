...
class ResourceActionCollection(object):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ResourceActionCollection object with values from keyword arguments.
    ...
    def items(self, items):
        """
        Sets the items of this ResourceActionCollection.
        A collection of resource actions.
