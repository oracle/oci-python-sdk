...
class CreateMdsMySqlDatabaseInsightDetails(CreateDatabaseInsightDetails):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new CreateMdsMySqlDatabaseInsightDetails object with values from keyword arguments. The default value of the :py:attr:`~oci.opsi.models.CreateMdsMySqlDatabaseInsightDetails.entity_source` attribute
        ...
        :param compartment_id:
            The value to assign to the compartment_id property of this CreateMdsMySqlDatabaseInsightDetails.
        :type compartment_id: str

        :param freeform_tags:
            The value to assign to the freeform_tags property of this CreateMdsMySqlDatabaseInsightDetails.
        :type freeform_tags: dict(str, str)

        :param defined_tags:
            The value to assign to the defined_tags property of this CreateMdsMySqlDatabaseInsightDetails.
        :type defined_tags: dict(str, dict(str, object))

        :param database_id:
            The value to assign to the database_id property of this CreateMdsMySqlDatabaseInsightDetails.
