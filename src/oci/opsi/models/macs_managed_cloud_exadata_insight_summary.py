...
class MacsManagedCloudExadataInsightSummary(ExadataInsightSummary):
    """
    Summary of a Cloud MACS-managed Exadata insight resource (ExaCC).
    """

    #: A constant which can be used with the exadata_infra_resource_type property of a MacsManagedCloudExadataInsightSummary.
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new MacsManagedCloudExadataInsightSummary object with values from keyword arguments. The default value of the :py:attr:`~oci.opsi.models.MacsManagedCloudExadataInsightSummary.entity_source` attribute
        of this class is ``MACS_MANAGED_CLOUD_EXADATA`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param entity_source:
            The value to assign to the entity_source property of this MacsManagedCloudExadataInsightSummary.
        ...
        :param id:
            The value to assign to the id property of this MacsManagedCloudExadataInsightSummary.
        :type id: str

        :param compartment_id:
            The value to assign to the compartment_id property of this MacsManagedCloudExadataInsightSummary.
        :type compartment_id: str

        :param exadata_name:
            The value to assign to the exadata_name property of this MacsManagedCloudExadataInsightSummary.
        :type exadata_name: str

        :param exadata_display_name:
            The value to assign to the exadata_display_name property of this MacsManagedCloudExadataInsightSummary.
        ...
        :param exadata_rack_type:
            The value to assign to the exadata_rack_type property of this MacsManagedCloudExadataInsightSummary.
        ...
        :param defined_tags:
            The value to assign to the defined_tags property of this MacsManagedCloudExadataInsightSummary.
        :type defined_tags: dict(str, dict(str, object))

        :param system_tags:
            The value to assign to the system_tags property of this MacsManagedCloudExadataInsightSummary.
        :type system_tags: dict(str, dict(str, object))

        :param status:
            The value to assign to the status property of this MacsManagedCloudExadataInsightSummary.
            Allowed values for this property are: "DISABLED", "ENABLED", "TERMINATED", 'UNKNOWN_ENUM_VALUE'.
            Any unrecognized values returned by a service will be mapped to 'UNKNOWN_ENUM_VALUE'.
        :type status: str

        :param chargeback_plan_details:
            The value to assign to the chargeback_plan_details property of this MacsManagedCloudExadataInsightSummary.
        :type chargeback_plan_details: oci.opsi.models.ChargebackPlanDetails

        :param time_created:
            The value to assign to the time_created property of this MacsManagedCloudExadataInsightSummary.
        ...
        :param lifecycle_state:
            The value to assign to the lifecycle_state property of this MacsManagedCloudExadataInsightSummary.
        ...
        :param lifecycle_details:
            The value to assign to the lifecycle_details property of this MacsManagedCloudExadataInsightSummary.
        :type lifecycle_details: str

        :param status_details:
            The value to assign to the status_details property of this MacsManagedCloudExadataInsightSummary.
        :type status_details: str

        :param exadata_infra_id:
            The value to assign to the exadata_infra_id property of this MacsManagedCloudExadataInsightSummary.
        :type exadata_infra_id: str

        :param exadata_infra_resource_type:
            The value to assign to the exadata_infra_resource_type property of this MacsManagedCloudExadataInsightSummary.
        ...
        :param exadata_shape:
            The value to assign to the exadata_shape property of this MacsManagedCloudExadataInsightSummary.
    ...
    def exadata_infra_resource_type(self):
        """
        **[Required]** Gets the exadata_infra_resource_type of this MacsManagedCloudExadataInsightSummary.
        ...
        :return: The exadata_infra_resource_type of this MacsManagedCloudExadataInsightSummary.
        :rtype: str
        """
    ...
    def exadata_infra_resource_type(self, exadata_infra_resource_type):
        """
        Sets the exadata_infra_resource_type of this MacsManagedCloudExadataInsightSummary.
        OCI exadata infrastructure resource type


        :param exadata_infra_resource_type: The exadata_infra_resource_type of this MacsManagedCloudExadataInsightSummary.
        :type: str
        """
    ...
    def exadata_shape(self):
        """
        **[Required]** Gets the exadata_shape of this MacsManagedCloudExadataInsightSummary.
        The shape of the Exadata Infrastructure.


        :return: The exadata_shape of this MacsManagedCloudExadataInsightSummary.
        :rtype: str
        """
    ...
    def exadata_shape(self, exadata_shape):
        """
        Sets the exadata_shape of this MacsManagedCloudExadataInsightSummary.
        The shape of the Exadata Infrastructure.


        :param exadata_shape: The exadata_shape of this MacsManagedCloudExadataInsightSummary.
        :type: str
        """
