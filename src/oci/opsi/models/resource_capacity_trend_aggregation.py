...
class ResourceCapacityTrendAggregation(object):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ResourceCapacityTrendAggregation object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param end_timestamp:
            The value to assign to the end_timestamp property of this ResourceCapacityTrendAggregation.
        :type end_timestamp: datetime

        :param capacity:
            The value to assign to the capacity property of this ResourceCapacityTrendAggregation.
        :type capacity: float
    ...
    def end_timestamp(self):
        ...
        **[Required]** Gets the end_timestamp of this ResourceCapacityTrendAggregation.
        ...
        :return: The end_timestamp of this ResourceCapacityTrendAggregation.
        :rtype: datetime
        """
    ...
    def end_timestamp(self, end_timestamp):
        """
        Sets the end_timestamp of this ResourceCapacityTrendAggregation.
        The timestamp in which the current sampling period ends in RFC 3339 format.


        :param end_timestamp: The end_timestamp of this ResourceCapacityTrendAggregation.
        :type: datetime
        """
