...
class ConfigurationItemSummary(object):
    ...
    #: A constant which can be used with the config_item_type property of a ConfigurationItemSummary.
    #: This constant has a value of "BASIC"
    CONFIG_ITEM_TYPE_BASIC = "BASIC"

    def __init__(self, **kwargs):
        """
        Initializes a new ConfigurationItemSummary object with values from keyword arguments. This class has the following subclasses and if you are using this class as input
        ...
        * :class:`~oci.opsi.models.BasicConfigurationItemSummary`
        ...
        :param config_item_type:
            The value to assign to the config_item_type property of this ConfigurationItemSummary.
    ...
    def get_subtype(object_dictionary):
        ...
        if type == 'BASIC':
            return 'BasicConfigurationItemSummary'
        else:
    ...
    def config_item_type(self):
        """
        **[Required]** Gets the config_item_type of this ConfigurationItemSummary.
        ...
        :return: The config_item_type of this ConfigurationItemSummary.
        :rtype: str
        """
    ...
    def config_item_type(self, config_item_type):
        """
        Sets the config_item_type of this ConfigurationItemSummary.
        Type of configuration item.


        :param config_item_type: The config_item_type of this ConfigurationItemSummary.
        :type: str
        """
