...
class MacsManagedCloudExadataInsight(ExadataInsight):
    """
    Cloud MACS-managed Exadata insight resource (ExaCC) (ExaCS will be supported in the future).
    """

    #: A constant which can be used with the exadata_infra_resource_type property of a MacsManagedCloudExadataInsight.
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new MacsManagedCloudExadataInsight object with values from keyword arguments. The default value of the :py:attr:`~oci.opsi.models.MacsManagedCloudExadataInsight.entity_source` attribute
        of this class is ``MACS_MANAGED_CLOUD_EXADATA`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param entity_source:
            The value to assign to the entity_source property of this MacsManagedCloudExadataInsight.
        ...
        :param id:
            The value to assign to the id property of this MacsManagedCloudExadataInsight.
        :type id: str

        :param compartment_id:
            The value to assign to the compartment_id property of this MacsManagedCloudExadataInsight.
        :type compartment_id: str

        :param exadata_name:
            The value to assign to the exadata_name property of this MacsManagedCloudExadataInsight.
        :type exadata_name: str

        :param exadata_display_name:
            The value to assign to the exadata_display_name property of this MacsManagedCloudExadataInsight.
        :type exadata_display_name: str

        :param exadata_type:
            The value to assign to the exadata_type property of this MacsManagedCloudExadataInsight.
        ...
        :param exadata_rack_type:
            The value to assign to the exadata_rack_type property of this MacsManagedCloudExadataInsight.
        ...
        :param is_virtualized_exadata:
            The value to assign to the is_virtualized_exadata property of this MacsManagedCloudExadataInsight.
        :type is_virtualized_exadata: bool

        :param status:
            The value to assign to the status property of this MacsManagedCloudExadataInsight.
            Allowed values for this property are: "DISABLED", "ENABLED", "TERMINATED", 'UNKNOWN_ENUM_VALUE'.
            Any unrecognized values returned by a service will be mapped to 'UNKNOWN_ENUM_VALUE'.
        :type status: str

        :param chargeback_plan_details:
            The value to assign to the chargeback_plan_details property of this MacsManagedCloudExadataInsight.
        :type chargeback_plan_details: oci.opsi.models.ChargebackPlanDetails

        :param freeform_tags:
            The value to assign to the freeform_tags property of this MacsManagedCloudExadataInsight.
        :type freeform_tags: dict(str, str)

        :param defined_tags:
            The value to assign to the defined_tags property of this MacsManagedCloudExadataInsight.
        :type defined_tags: dict(str, dict(str, object))

        :param system_tags:
            The value to assign to the system_tags property of this MacsManagedCloudExadataInsight.
        :type system_tags: dict(str, dict(str, object))

        :param time_created:
            The value to assign to the time_created property of this MacsManagedCloudExadataInsight.
        :type time_created: datetime

        :param time_updated:
            The value to assign to the time_updated property of this MacsManagedCloudExadataInsight.
        :type time_updated: datetime

        :param lifecycle_state:
            The value to assign to the lifecycle_state property of this MacsManagedCloudExadataInsight.
        ...
        :param lifecycle_details:
            The value to assign to the lifecycle_details property of this MacsManagedCloudExadataInsight.
        :type lifecycle_details: str

        :param status_details:
            The value to assign to the status_details property of this MacsManagedCloudExadataInsight.
        :type status_details: str

        :param exadata_infra_id:
            The value to assign to the exadata_infra_id property of this MacsManagedCloudExadataInsight.
        :type exadata_infra_id: str

        :param exadata_infra_resource_type:
            The value to assign to the exadata_infra_resource_type property of this MacsManagedCloudExadataInsight.
        ...
        :param exadata_shape:
            The value to assign to the exadata_shape property of this MacsManagedCloudExadataInsight.
    ...
    def exadata_infra_resource_type(self):
        """
        **[Required]** Gets the exadata_infra_resource_type of this MacsManagedCloudExadataInsight.
        ...
        :return: The exadata_infra_resource_type of this MacsManagedCloudExadataInsight.
        :rtype: str
        """
    ...
    def exadata_infra_resource_type(self, exadata_infra_resource_type):
        """
        Sets the exadata_infra_resource_type of this MacsManagedCloudExadataInsight.
        OCI exadata infrastructure resource type


        :param exadata_infra_resource_type: The exadata_infra_resource_type of this MacsManagedCloudExadataInsight.
        :type: str
        """
    ...
    def exadata_shape(self):
        """
        **[Required]** Gets the exadata_shape of this MacsManagedCloudExadataInsight.
        The shape of the Exadata Infrastructure.


        :return: The exadata_shape of this MacsManagedCloudExadataInsight.
        :rtype: str
        """
    ...
    def exadata_shape(self, exadata_shape):
        """
        Sets the exadata_shape of this MacsManagedCloudExadataInsight.
        The shape of the Exadata Infrastructure.


        :param exadata_shape: The exadata_shape of this MacsManagedCloudExadataInsight.
        :type: str
        """
