...
class CreateExadataInsightDetails(object):
    """
    ...
    def __init__(self, **kwargs):
        ...
        * :class:`~oci.opsi.models.CreateEmManagedExternalExadataInsightDetails`
        ...
        :param compartment_id:
            The value to assign to the compartment_id property of this CreateExadataInsightDetails.
        :type compartment_id: str

        :param freeform_tags:
            The value to assign to the freeform_tags property of this CreateExadataInsightDetails.
        :type freeform_tags: dict(str, str)

        :param defined_tags:
            The value to assign to the defined_tags property of this CreateExadataInsightDetails.
    ...
    def entity_source(self, entity_source):
        """
        Sets the entity_source of this CreateExadataInsightDetails.
        Source of the Exadata system.
    ...
    def compartment_id(self):
        """
        **[Required]** Gets the compartment_id of this CreateExadataInsightDetails.
        Compartment Identifier of Exadata insight


        :return: The compartment_id of this CreateExadataInsightDetails.
        :rtype: str
        """
    ...
    def compartment_id(self, compartment_id):
        """
        Sets the compartment_id of this CreateExadataInsightDetails.
        Compartment Identifier of Exadata insight


        :param compartment_id: The compartment_id of this CreateExadataInsightDetails.
        :type: str
        """
    ...
    def freeform_tags(self):
        """
        Gets the freeform_tags of this CreateExadataInsightDetails.
        Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only.
        Example: `{\"bar-key\": \"value\"}`


        :return: The freeform_tags of this CreateExadataInsightDetails.
        :rtype: dict(str, str)
        """
    ...
    def freeform_tags(self, freeform_tags):
        """
        Sets the freeform_tags of this CreateExadataInsightDetails.
        Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only.
        Example: `{\"bar-key\": \"value\"}`


        :param freeform_tags: The freeform_tags of this CreateExadataInsightDetails.
        :type: dict(str, str)
        """
    ...
    def defined_tags(self):
        """
        Gets the defined_tags of this CreateExadataInsightDetails.
        Defined tags for this resource. Each key is predefined and scoped to a namespace.
        Example: `{\"foo-namespace\": {\"bar-key\": \"value\"}}`


        :return: The defined_tags of this CreateExadataInsightDetails.
    ...
    def defined_tags(self, defined_tags):
        """
        Sets the defined_tags of this CreateExadataInsightDetails.
        Defined tags for this resource. Each key is predefined and scoped to a namespace.
        Example: `{\"foo-namespace\": {\"bar-key\": \"value\"}}`


        :param defined_tags: The defined_tags of this CreateExadataInsightDetails.
