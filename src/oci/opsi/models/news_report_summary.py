...
class NewsReportSummary(object):
    """
    ...
    #: A constant which can be used with the status property of a NewsReportSummary.
    ...
    #: A constant which can be used with the lifecycle_state property of a NewsReportSummary.
    ...
    def __init__(self, **kwargs):
        ...
        :param content_types:
            The value to assign to the content_types property of this NewsReportSummary.
        :type content_types: oci.opsi.models.NewsContentTypes

        :param locale:
            The value to assign to the locale property of this NewsReportSummary.
            Allowed values for this property are: "EN", 'UNKNOWN_ENUM_VALUE'.
            Any unrecognized values returned by a service will be mapped to 'UNKNOWN_ENUM_VALUE'.
        :type locale: str

        :param id:
            The value to assign to the id property of this NewsReportSummary.
        :type id: str

        :param description:
            The value to assign to the description property of this NewsReportSummary.
        :type description: str

        :param compartment_id:
            The value to assign to the compartment_id property of this NewsReportSummary.
        :type compartment_id: str

        :param name:
            The value to assign to the name property of this NewsReportSummary.
        :type name: str

        :param ons_topic_id:
            The value to assign to the ons_topic_id property of this NewsReportSummary.
        :type ons_topic_id: str

        :param freeform_tags:
            The value to assign to the freeform_tags property of this NewsReportSummary.
        :type freeform_tags: dict(str, str)

        :param defined_tags:
            The value to assign to the defined_tags property of this NewsReportSummary.
        :type defined_tags: dict(str, dict(str, object))

        :param system_tags:
            The value to assign to the system_tags property of this NewsReportSummary.
        :type system_tags: dict(str, dict(str, object))

        :param status:
            The value to assign to the status property of this NewsReportSummary.
            Allowed values for this property are: "DISABLED", "ENABLED", "TERMINATED", 'UNKNOWN_ENUM_VALUE'.
            Any unrecognized values returned by a service will be mapped to 'UNKNOWN_ENUM_VALUE'.
        :type status: str

        :param time_created:
            The value to assign to the time_created property of this NewsReportSummary.
        :type time_created: datetime

        :param time_updated:
            The value to assign to the time_updated property of this NewsReportSummary.
        :type time_updated: datetime

        :param lifecycle_state:
            The value to assign to the lifecycle_state property of this NewsReportSummary.
    ...
    def news_frequency(self):
        ...
        **[Required]** Gets the news_frequency of this NewsReportSummary.
        ...
        :return: The news_frequency of this NewsReportSummary.
        :rtype: str
        """
    ...
    def news_frequency(self, news_frequency):
        """
        Sets the news_frequency of this NewsReportSummary.
        News report frequency.
    ...
    def content_types(self):
        ...
        **[Required]** Gets the content_types of this NewsReportSummary.
        ...
        :return: The content_types of this NewsReportSummary.
    ...
    def content_types(self, content_types):
        """
        Sets the content_types of this NewsReportSummary.

        :param content_types: The content_types of this NewsReportSummary.
    ...
    def locale(self):
        """
        Gets the locale of this NewsReportSummary.
        ...
        :return: The locale of this NewsReportSummary.
        :rtype: str
        """
        return self._locale
    ...
    def locale(self, locale):
        """
        Sets the locale of this NewsReportSummary.
        Language of the news report.


        :param locale: The locale of this NewsReportSummary.
        :type: str
        """
        allowed_values = ["EN"]
    ...
    def id(self):
        """
        **[Required]** Gets the id of this NewsReportSummary.
        The `OCID`__ of the news report resource.

        __ https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm


        :return: The id of this NewsReportSummary.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        """
        Sets the id of this NewsReportSummary.
        The `OCID`__ of the news report resource.

        __ https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm


        :param id: The id of this NewsReportSummary.
        :type: str
        """
        self._id = id
    ...
    def description(self):
        """
        Gets the description of this NewsReportSummary.
        The description of the news report.


        :return: The description of this NewsReportSummary.
        :rtype: str
        """
    ...
    def description(self, description):
        """
        Sets the description of this NewsReportSummary.
        The description of the news report.


        :param description: The description of this NewsReportSummary.
        :type: str
        """
    ...
    def compartment_id(self):
        """
        **[Required]** Gets the compartment_id of this NewsReportSummary.
        The `OCID`__ of the compartment.

        __ https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm


        :return: The compartment_id of this NewsReportSummary.
        :rtype: str
        """
    ...
    def compartment_id(self, compartment_id):
        """
        Sets the compartment_id of this NewsReportSummary.
        The `OCID`__ of the compartment.

        __ https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm


        :param compartment_id: The compartment_id of this NewsReportSummary.
        :type: str
        """
    ...
    def name(self):
        """
        Gets the name of this NewsReportSummary.
        The news report name.


        :return: The name of this NewsReportSummary.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this NewsReportSummary.
        The news report name.


        :param name: The name of this NewsReportSummary.
        :type: str
        """
        self._name = name
    ...
    def ons_topic_id(self):
        """
        Gets the ons_topic_id of this NewsReportSummary.
        The `OCID`__ of the ONS topic.

        __ https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm


        :return: The ons_topic_id of this NewsReportSummary.
        :rtype: str
        """
    ...
    def ons_topic_id(self, ons_topic_id):
        """
        Sets the ons_topic_id of this NewsReportSummary.
        The `OCID`__ of the ONS topic.

        __ https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm


        :param ons_topic_id: The ons_topic_id of this NewsReportSummary.
        :type: str
        """
    ...
    def freeform_tags(self):
        """
        Gets the freeform_tags of this NewsReportSummary.
        Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only.
        Example: `{\"bar-key\": \"value\"}`


        :return: The freeform_tags of this NewsReportSummary.
        :rtype: dict(str, str)
        """
    ...
    def freeform_tags(self, freeform_tags):
        """
        Sets the freeform_tags of this NewsReportSummary.
        Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only.
        Example: `{\"bar-key\": \"value\"}`


        :param freeform_tags: The freeform_tags of this NewsReportSummary.
        :type: dict(str, str)
        """
    ...
    def defined_tags(self):
        """
        Gets the defined_tags of this NewsReportSummary.
        Defined tags for this resource. Each key is predefined and scoped to a namespace.
        Example: `{\"foo-namespace\": {\"bar-key\": \"value\"}}`


        :return: The defined_tags of this NewsReportSummary.
    ...
    def defined_tags(self, defined_tags):
        """
        Sets the defined_tags of this NewsReportSummary.
        Defined tags for this resource. Each key is predefined and scoped to a namespace.
        Example: `{\"foo-namespace\": {\"bar-key\": \"value\"}}`


        :param defined_tags: The defined_tags of this NewsReportSummary.
    ...
    def system_tags(self):
        """
        Gets the system_tags of this NewsReportSummary.
        System tags for this resource. Each key is predefined and scoped to a namespace.
        Example: `{\"orcl-cloud\": {\"free-tier-retained\": \"true\"}}`


        :return: The system_tags of this NewsReportSummary.
        :rtype: dict(str, dict(str, object))
        """
    ...
    def system_tags(self, system_tags):
        """
        Sets the system_tags of this NewsReportSummary.
        System tags for this resource. Each key is predefined and scoped to a namespace.
        Example: `{\"orcl-cloud\": {\"free-tier-retained\": \"true\"}}`


        :param system_tags: The system_tags of this NewsReportSummary.
        :type: dict(str, dict(str, object))
        """
    ...
    def status(self):
        """
        Gets the status of this NewsReportSummary.
        ...
        :return: The status of this NewsReportSummary.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """
        Sets the status of this NewsReportSummary.
        Indicates the status of a news report in Ops Insights.


        :param status: The status of this NewsReportSummary.
        :type: str
        """
    ...
    def time_created(self):
        """
        Gets the time_created of this NewsReportSummary.
        The time the the news report was first enabled. An RFC3339 formatted datetime string.


        :return: The time_created of this NewsReportSummary.
        :rtype: datetime
        """
    ...
    def time_created(self, time_created):
        """
        Sets the time_created of this NewsReportSummary.
        The time the the news report was first enabled. An RFC3339 formatted datetime string.


        :param time_created: The time_created of this NewsReportSummary.
        :type: datetime
        """
    ...
    def time_updated(self):
        """
        Gets the time_updated of this NewsReportSummary.
        The time the news report was updated. An RFC3339 formatted datetime string.


        :return: The time_updated of this NewsReportSummary.
        :rtype: datetime
        """
    ...
    def time_updated(self, time_updated):
        """
        Sets the time_updated of this NewsReportSummary.
        The time the news report was updated. An RFC3339 formatted datetime string.


        :param time_updated: The time_updated of this NewsReportSummary.
        :type: datetime
        """
    ...
    def lifecycle_state(self):
        """
        Gets the lifecycle_state of this NewsReportSummary.
        ...
        :return: The lifecycle_state of this NewsReportSummary.
        :rtype: str
        """
    ...
    def lifecycle_state(self, lifecycle_state):
        """
        Sets the lifecycle_state of this NewsReportSummary.
        The current state of the news report.


        :param lifecycle_state: The lifecycle_state of this NewsReportSummary.
        :type: str
        """
    ...
    def lifecycle_details(self):
        """
        Gets the lifecycle_details of this NewsReportSummary.
        A message describing the current state in more detail. For example, can be used to provide actionable information for a resource in Failed state.


        :return: The lifecycle_details of this NewsReportSummary.
        :rtype: str
        """
    ...
    def lifecycle_details(self, lifecycle_details):
        """
        Sets the lifecycle_details of this NewsReportSummary.
        A message describing the current state in more detail. For example, can be used to provide actionable information for a resource in Failed state.


        :param lifecycle_details: The lifecycle_details of this NewsReportSummary.
        :type: str
        """
