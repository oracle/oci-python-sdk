...
class HostInsightsDataObjectSummary(OpsiDataObjectSummary):
    ...
    def __init__(self, **kwargs):
        ...
        :param name:
            The value to assign to the name property of this HostInsightsDataObjectSummary.
        :type name: str

        :param group_names:
            The value to assign to the group_names property of this HostInsightsDataObjectSummary.
