...
class IngestSqlTextDetails(object):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new IngestSqlTextDetails object with values from keyword arguments.
    ...
    def items(self):
        """
        Gets the items of this IngestSqlTextDetails.
    ...
    def items(self, items):
        """
        Sets the items of this IngestSqlTextDetails.
        List of SQL Text Entries.
