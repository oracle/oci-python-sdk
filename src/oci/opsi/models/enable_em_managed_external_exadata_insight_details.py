...
class EnableEmManagedExternalExadataInsightDetails(EnableExadataInsightDetails):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new EnableEmManagedExternalExadataInsightDetails object with values from keyword arguments. The default value of the :py:attr:`~oci.opsi.models.EnableEmManagedExternalExadataInsightDetails.entity_source` attribute
