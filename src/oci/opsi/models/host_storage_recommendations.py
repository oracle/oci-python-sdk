...
class HostStorageRecommendations(HostInsightHostRecommendations):
    """
    Contains storage recommendation.
    """

    #: A constant which can be used with the unused_instance property of a HostStorageRecommendations.
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new HostStorageRecommendations object with values from keyword arguments. The default value of the :py:attr:`~oci.opsi.models.HostStorageRecommendations.metric_recommendation_name` attribute
        of this class is ``HOST_STORAGE_RECOMMENDATIONS`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param metric_recommendation_name:
            The value to assign to the metric_recommendation_name property of this HostStorageRecommendations.
        ...
        :param unused_instance:
            The value to assign to the unused_instance property of this HostStorageRecommendations.
        ...
        :param is_abandoned_instance:
            The value to assign to the is_abandoned_instance property of this HostStorageRecommendations.
        ...
        self._metric_recommendation_name = 'HOST_STORAGE_RECOMMENDATIONS'

    @property
    def unused_instance(self):
        """
        Gets the unused_instance of this HostStorageRecommendations.
        ...
        :return: The unused_instance of this HostStorageRecommendations.
        :rtype: str
        """
    ...
    def unused_instance(self, unused_instance):
        """
        Sets the unused_instance of this HostStorageRecommendations.
        Identify unused instances based on cpu, memory and network metrics.


        :param unused_instance: The unused_instance of this HostStorageRecommendations.
        :type: str
        """
    ...
    def is_abandoned_instance(self):
        """
        Gets the is_abandoned_instance of this HostStorageRecommendations.
        Identify if an instance is abandoned.


        :return: The is_abandoned_instance of this HostStorageRecommendations.
        :rtype: bool
        """
    ...
    def is_abandoned_instance(self, is_abandoned_instance):
        """
        Sets the is_abandoned_instance of this HostStorageRecommendations.
        Identify if an instance is abandoned.


        :param is_abandoned_instance: The is_abandoned_instance of this HostStorageRecommendations.
        :type: bool
        """
