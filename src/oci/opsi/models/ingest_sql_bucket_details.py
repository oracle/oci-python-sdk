...
class IngestSqlBucketDetails(object):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new IngestSqlBucketDetails object with values from keyword arguments.
    ...
    def items(self, items):
        """
        Sets the items of this IngestSqlBucketDetails.
        List of SQL Bucket Metric Entries.
