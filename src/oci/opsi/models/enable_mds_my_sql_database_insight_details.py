...
class EnableMdsMySqlDatabaseInsightDetails(EnableDatabaseInsightDetails):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new EnableMdsMySqlDatabaseInsightDetails object with values from keyword arguments. The default value of the :py:attr:`~oci.opsi.models.EnableMdsMySqlDatabaseInsightDetails.entity_source` attribute
        of this class is ``MDS_MYSQL_DATABASE_SYSTEM`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param entity_source:
            The value to assign to the entity_source property of this EnableMdsMySqlDatabaseInsightDetails.
