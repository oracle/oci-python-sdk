...
class UpdateCertificateDetails(object):
    ...
    **Warning:** Oracle recommends that you avoid using any confidential information when you supply string values using the API.
    ...
    def __init__(self, **kwargs):
        ...
        :param display_name:
            The value to assign to the display_name property of this UpdateCertificateDetails.
    ...
    def display_name(self):
        """
        Gets the display_name of this UpdateCertificateDetails.
        A user-friendly name for the SSL certificate. The name can be changed and does not need to be unique.


        :return: The display_name of this UpdateCertificateDetails.
        :rtype: str
        """
    ...
    def display_name(self, display_name):
        """
        Sets the display_name of this UpdateCertificateDetails.
        A user-friendly name for the SSL certificate. The name can be changed and does not need to be unique.


        :param display_name: The display_name of this UpdateCertificateDetails.
        :type: str
        """
