...
class WorkRequestResource(object):
    ...
    def __init__(self, **kwargs):
        ...
        :param action_type:
            ...
            Allowed values for this property are: "IN_PROGRESS", "CREATED", "UPDATED", "DELETED", "RELATED", "PURGED", 'UNKNOWN_ENUM_VALUE'.
    ...
    def action_type(self, action_type):
        ...
        :type: str
        """
        allowed_values = ["IN_PROGRESS", "CREATED", "UPDATED", "DELETED", "RELATED", "PURGED"]
