...
class VirtualNetworkClientCompositeOperations(object):
    ...
    def change_drg_compartment_and_wait_for_state(self, drg_id, change_drg_compartment_details, wait_for_states=[], operation_kwargs={}, waiter_kwargs={}):
        """
        Calls :py:func:`~oci.core.VirtualNetworkClient.change_drg_compartment` and waits for the :py:class:`~oci.core.models.WorkRequest`
        to enter the given state(s).
    ...
    def change_subnet_compartment_and_wait_for_state(self, subnet_id, change_subnet_compartment_details, wait_for_states=[], operation_kwargs={}, waiter_kwargs={}):
        """
        Calls :py:func:`~oci.core.VirtualNetworkClient.change_subnet_compartment` and waits for the :py:class:`~oci.core.models.WorkRequest`
        to enter the given state(s).
    ...
    def change_vcn_compartment_and_wait_for_state(self, vcn_id, change_vcn_compartment_details, wait_for_states=[], operation_kwargs={}, waiter_kwargs={}):
        """
        Calls :py:func:`~oci.core.VirtualNetworkClient.change_vcn_compartment` and waits for the :py:class:`~oci.core.models.WorkRequest`
        to enter the given state(s).
    ...
    def create_ipv6_and_wait_for_state(self, create_ipv6_details, wait_for_states=[], operation_kwargs={}, waiter_kwargs={}):
        ...
        try:
            waiter_result = oci.wait_until(
                self.client,
                self.client.get_ipv6(wait_for_resource_id),
                evaluate_response=lambda r: getattr(r.data, 'lifecycle_state') and getattr(r.data, 'lifecycle_state').lower() in lowered_wait_for_states,
                **waiter_kwargs
            )
            result_to_return = waiter_result
    ...
    def create_network_security_group_and_wait_for_state(self, create_network_security_group_details, wait_for_states=[], operation_kwargs={}, waiter_kwargs={}):
        ...
        try:
            waiter_result = oci.wait_until(
                self.client,
                self.client.get_network_security_group(wait_for_resource_id),
                evaluate_response=lambda r: getattr(r.data, 'lifecycle_state') and getattr(r.data, 'lifecycle_state').lower() in lowered_wait_for_states,
                **waiter_kwargs
            )
            result_to_return = waiter_result
