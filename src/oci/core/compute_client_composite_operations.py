...
class ComputeClientCompositeOperations(object):
    ...
    def apply_host_configuration_and_wait_for_work_request(self, compute_host_id, work_request_states=[], operation_kwargs={}, waiter_kwargs={}):
        """
        Calls :py:func:`~oci.core.ComputeClient.apply_host_configuration` and waits for the oci.work_requests.models.WorkRequest
        ...
        :param dict operation_kwargs:
            A dictionary of keyword arguments to pass to :py:func:`~oci.core.ComputeClient.apply_host_configuration`

        :param dict waiter_kwargs:
            A dictionary of keyword arguments to pass to the :py:func:`oci.wait_until` function. For example, you could pass ``max_interval_seconds`` or ``max_interval_seconds``
            as dictionary keys to modify how long the waiter function will wait between retries and the maximum amount of time it will wait
        """
        operation_result = self.client.apply_host_configuration(compute_host_id, **operation_kwargs)
    ...
    def apply_host_configuration_and_wait_for_state(self, compute_host_id, wait_for_states=[], operation_kwargs={}, waiter_kwargs={}):
        """
        Calls :py:func:`~oci.core.ComputeClient.apply_host_configuration` and waits for the :py:class:`~oci.core.models.ComputeHost` acted upon
        to enter the given state(s).
    ...
    def attach_volume_and_wait_for_work_request(self, attach_volume_details, work_request_states=[], operation_kwargs={}, waiter_kwargs={}):
        """
        Calls :py:func:`~oci.core.ComputeClient.attach_volume` and waits for the oci.work_requests.models.WorkRequest
        to enter the given state(s).
    ...
    def check_host_configuration_and_wait_for_state(self, compute_host_id, wait_for_states=[], operation_kwargs={}, waiter_kwargs={}):
        """
        Calls :py:func:`~oci.core.ComputeClient.check_host_configuration` and waits for the :py:class:`~oci.core.models.ComputeHost` acted upon
        to enter the given state(s).
        ...
        :param dict operation_kwargs:
            A dictionary of keyword arguments to pass to :py:func:`~oci.core.ComputeClient.check_host_configuration`

        :param dict waiter_kwargs:
            A dictionary of keyword arguments to pass to the :py:func:`oci.wait_until` function. For example, you could pass ``max_interval_seconds`` or ``max_interval_seconds``
            as dictionary keys to modify how long the waiter function will wait between retries and the maximum amount of time it will wait
        """
        operation_result = self.client.check_host_configuration(compute_host_id, **operation_kwargs)
        if not wait_for_states:
            return operation_result
        lowered_wait_for_states = [w.lower() for w in wait_for_states]
        compute_host_id = operation_result.data.id
    ...
    def detach_volume_and_wait_for_work_request(self, volume_attachment_id, work_request_states=[], operation_kwargs={}, waiter_kwargs={}):
        """
        Calls :py:func:`~oci.core.ComputeClient.detach_volume` and waits for the oci.work_requests.models.WorkRequest
        to enter the given state(s).
    ...
    def terminate_instance_and_wait_for_work_request(self, instance_id, work_request_states=[], operation_kwargs={}, waiter_kwargs={}):
        """
        Calls :py:func:`~oci.core.ComputeClient.terminate_instance` and waits for the oci.work_requests.models.WorkRequest
        to enter the given state(s).
