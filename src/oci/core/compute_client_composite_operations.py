...
class ComputeClientCompositeOperations(object):
    ...
    def change_dedicated_vm_host_compartment_and_wait_for_state(self, dedicated_vm_host_id, change_dedicated_vm_host_compartment_details, wait_for_states=[], operation_kwargs={}, waiter_kwargs={}):
        """
        Calls :py:func:`~oci.core.ComputeClient.change_dedicated_vm_host_compartment` and waits for the :py:class:`~oci.core.models.WorkRequest`
        to enter the given state(s).
    ...
    def change_instance_compartment_and_wait_for_state(self, instance_id, change_instance_compartment_details, wait_for_states=[], operation_kwargs={}, waiter_kwargs={}):
        """
        Calls :py:func:`~oci.core.ComputeClient.change_instance_compartment` and waits for the :py:class:`~oci.core.models.WorkRequest`
        to enter the given state(s).
    ...
    def create_dedicated_vm_host_and_wait_for_state(self, create_dedicated_vm_host_details, wait_for_states=[], operation_kwargs={}, waiter_kwargs={}):
        ...
        try:
            waiter_result = oci.wait_until(
                self.client,
                self.client.get_dedicated_vm_host(wait_for_resource_id),
                evaluate_response=lambda r: getattr(r.data, 'lifecycle_state') and getattr(r.data, 'lifecycle_state').lower() in lowered_wait_for_states,
                **waiter_kwargs
            )
            result_to_return = waiter_result
    ...
    def delete_dedicated_vm_host_and_wait_for_state(self, dedicated_vm_host_id, wait_for_states=[], operation_kwargs={}, waiter_kwargs={}):
        """
        Calls :py:func:`~oci.core.ComputeClient.delete_dedicated_vm_host` and waits for the :py:class:`~oci.core.models.WorkRequest`
        to enter the given state(s).
