...
class IntelSkylakeBmPlatformConfig(PlatformConfig):
    ...
    def __init__(self, **kwargs):
        ...
        :param is_secure_boot_enabled:
            The value to assign to the is_secure_boot_enabled property of this IntelSkylakeBmPlatformConfig.
        :type is_secure_boot_enabled: bool

        :param is_trusted_platform_module_enabled:
            The value to assign to the is_trusted_platform_module_enabled property of this IntelSkylakeBmPlatformConfig.
        :type is_trusted_platform_module_enabled: bool

        :param is_measured_boot_enabled:
            The value to assign to the is_measured_boot_enabled property of this IntelSkylakeBmPlatformConfig.
