...
class BulkCreateIpv6sDetails(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new BulkCreateIpv6sDetails object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param vnic_id:
            The value to assign to the vnic_id property of this BulkCreateIpv6sDetails.
        :type vnic_id: str

        :param subnet_id:
            The value to assign to the subnet_id property of this BulkCreateIpv6sDetails.
        :type subnet_id: str

        :param bulk_create_ipv6s_item:
            The value to assign to the bulk_create_ipv6s_item property of this BulkCreateIpv6sDetails.
        :type bulk_create_ipv6s_item: list[oci.core.models.BulkCreateIpv6sItem]

        """
        self.swagger_types = {
            'vnic_id': 'str',
            'subnet_id': 'str',
            'bulk_create_ipv6s_item': 'list[BulkCreateIpv6sItem]'
        }
        self.attribute_map = {
            'vnic_id': 'vnicId',
            'subnet_id': 'subnetId',
        ...
        self._bulk_create_ipv6s_item = None
    ...
    def subnet_id(self):
        """
        Gets the subnet_id of this BulkCreateIpv6sDetails.
    ...
    def subnet_id(self, subnet_id):
        """
        Sets the subnet_id of this BulkCreateIpv6sDetails.
        The `OCID`__ of the subnet from which the IPv6s are to be drawn. The IP addresses,
        *if supplied*, must be valid for the given subnet, only valid for reserved IPs currently.
    ...
    def bulk_create_ipv6s_item(self):
        ...
        **[Required]** Gets the bulk_create_ipv6s_item of this BulkCreateIpv6sDetails.
        ...
        :rtype: list[oci.core.models.BulkCreateIpv6sItem]
        """
        return self._bulk_create_ipv6s_item

    @bulk_create_ipv6s_item.setter
    def bulk_create_ipv6s_item(self, bulk_create_ipv6s_item):
        ...
        :type: list[oci.core.models.BulkCreateIpv6sItem]
        """
        self._bulk_create_ipv6s_item = bulk_create_ipv6s_item
