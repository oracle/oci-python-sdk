...
class BulkDeletePrivateIpItem(object):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new BulkDeletePrivateIpItem object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param private_ip_id:
            The value to assign to the private_ip_id property of this BulkDeletePrivateIpItem.
