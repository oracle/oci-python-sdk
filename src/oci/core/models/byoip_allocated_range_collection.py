...
class ByoipAllocatedRangeCollection(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ByoipAllocatedRangeCollection object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param items:
            The value to assign to the items property of this ByoipAllocatedRangeCollection.
        :type items: list[oci.core.models.ByoipAllocatedRangeSummary]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this ByoipAllocatedRangeCollection.
        ...
        :rtype: list[oci.core.models.ByoipAllocatedRangeSummary]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.core.models.ByoipAllocatedRangeSummary]
        """
        self._items = items
