...
class InstanceConfigurationLaunchInstanceShapeConfigDetails(object):
    ...
    def __init__(self, **kwargs):
        ...
        :param local_volume_size_in_gbs:
            The value to assign to the local_volume_size_in_gbs property of this InstanceConfigurationLaunchInstanceShapeConfigDetails.
    ...
    def local_volume_size_in_gbs(self):
        """
        Gets the local_volume_size_in_gbs of this InstanceConfigurationLaunchInstanceShapeConfigDetails.
        ...
        :return: The local_volume_size_in_gbs of this InstanceConfigurationLaunchInstanceShapeConfigDetails.
        :rtype: int
        """
    ...
    def local_volume_size_in_gbs(self, local_volume_size_in_gbs):
        """
        Sets the local_volume_size_in_gbs of this InstanceConfigurationLaunchInstanceShapeConfigDetails.
        The NVMe-backed local storage capacity, in GB, for flexible dense (DenseLV) VM shapes. If the selected shape
        is DenseLV, the value must be greater than 0. For all other shapes, the value must be null (if specified);
        any non-null value for a non-DenseLV shape results in an error.


        :param local_volume_size_in_gbs: The local_volume_size_in_gbs of this InstanceConfigurationLaunchInstanceShapeConfigDetails.
        :type: int
        """
