...
class AutotunePolicy(object):
    """
    An autotune policy automatically tunes the volume's performace based on the type of the policy.
    """

    #: A constant which can be used with the autotune_type property of a AutotunePolicy.
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new AutotunePolicy object with values from keyword arguments. This class has the following subclasses and if you are using this class as input
        to a service operations then you should favor using a subclass over the base class:

        * :class:`~oci.core.models.DetachedVolumeAutotunePolicy`
        * :class:`~oci.core.models.PerformanceBasedAutotunePolicy`

        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param autotune_type:
            The value to assign to the autotune_type property of this AutotunePolicy.
    ...
    def get_subtype(object_dictionary):
        ...
        if type == 'DETACHED_VOLUME':
            return 'DetachedVolumeAutotunePolicy'

        if type == 'PERFORMANCE_BASED':
            return 'PerformanceBasedAutotunePolicy'
        else:
    ...
    def autotune_type(self):
        """
        **[Required]** Gets the autotune_type of this AutotunePolicy.
        ...
        :return: The autotune_type of this AutotunePolicy.
        :rtype: str
        """
    ...
    def autotune_type(self, autotune_type):
        """
        Sets the autotune_type of this AutotunePolicy.
        This specifies the type of autotunes supported by OCI.


        :param autotune_type: The autotune_type of this AutotunePolicy.
        :type: str
        """
