...
class IntelSkylakeBmLaunchInstancePlatformConfig(LaunchInstancePlatformConfig):
    ...
    #: A constant which can be used with the numa_nodes_per_socket property of a IntelSkylakeBmLaunchInstancePlatformConfig.
    ...
    def __init__(self, **kwargs):
        ...
        :param numa_nodes_per_socket:
            The value to assign to the numa_nodes_per_socket property of this IntelSkylakeBmLaunchInstancePlatformConfig.
            Allowed values for this property are: "NPS1", "NPS2"
        :type numa_nodes_per_socket: str

        :param is_symmetric_multi_threading_enabled:
            The value to assign to the is_symmetric_multi_threading_enabled property of this IntelSkylakeBmLaunchInstancePlatformConfig.
        :type is_symmetric_multi_threading_enabled: bool

        :param is_input_output_memory_management_unit_enabled:
            The value to assign to the is_input_output_memory_management_unit_enabled property of this IntelSkylakeBmLaunchInstancePlatformConfig.
        :type is_input_output_memory_management_unit_enabled: bool

        :param percentage_of_cores_enabled:
            The value to assign to the percentage_of_cores_enabled property of this IntelSkylakeBmLaunchInstancePlatformConfig.
        :type percentage_of_cores_enabled: int

        :param config_map:
            The value to assign to the config_map property of this IntelSkylakeBmLaunchInstancePlatformConfig.
    ...
    def numa_nodes_per_socket(self):
        """
        Gets the numa_nodes_per_socket of this IntelSkylakeBmLaunchInstancePlatformConfig.
        The number of NUMA nodes per socket (NPS).

        Allowed values for this property are: "NPS1", "NPS2"


        :return: The numa_nodes_per_socket of this IntelSkylakeBmLaunchInstancePlatformConfig.
        :rtype: str
        """
    ...
    def numa_nodes_per_socket(self, numa_nodes_per_socket):
        """
        Sets the numa_nodes_per_socket of this IntelSkylakeBmLaunchInstancePlatformConfig.
        The number of NUMA nodes per socket (NPS).


        :param numa_nodes_per_socket: The numa_nodes_per_socket of this IntelSkylakeBmLaunchInstancePlatformConfig.
        :type: str
        """
    ...
    def is_symmetric_multi_threading_enabled(self):
        """
        Gets the is_symmetric_multi_threading_enabled of this IntelSkylakeBmLaunchInstancePlatformConfig.
        ...
        :return: The is_symmetric_multi_threading_enabled of this IntelSkylakeBmLaunchInstancePlatformConfig.
        :rtype: bool
        """
    ...
    def is_symmetric_multi_threading_enabled(self, is_symmetric_multi_threading_enabled):
        """
        Sets the is_symmetric_multi_threading_enabled of this IntelSkylakeBmLaunchInstancePlatformConfig.
        Whether symmetric multithreading is enabled on the instance. Symmetric multithreading is also
        called simultaneous multithreading (SMT) or Intel Hyper-Threading.
        ...
        :param is_symmetric_multi_threading_enabled: The is_symmetric_multi_threading_enabled of this IntelSkylakeBmLaunchInstancePlatformConfig.
        :type: bool
        """
    ...
    def is_input_output_memory_management_unit_enabled(self):
        """
        Gets the is_input_output_memory_management_unit_enabled of this IntelSkylakeBmLaunchInstancePlatformConfig.
        Whether the input-output memory management unit is enabled.


        :return: The is_input_output_memory_management_unit_enabled of this IntelSkylakeBmLaunchInstancePlatformConfig.
        :rtype: bool
        """
    ...
    def is_input_output_memory_management_unit_enabled(self, is_input_output_memory_management_unit_enabled):
        """
        Sets the is_input_output_memory_management_unit_enabled of this IntelSkylakeBmLaunchInstancePlatformConfig.
        Whether the input-output memory management unit is enabled.


        :param is_input_output_memory_management_unit_enabled: The is_input_output_memory_management_unit_enabled of this IntelSkylakeBmLaunchInstancePlatformConfig.
        :type: bool
        """
    ...
    def percentage_of_cores_enabled(self):
        """
        Gets the percentage_of_cores_enabled of this IntelSkylakeBmLaunchInstancePlatformConfig.
        ...
        :return: The percentage_of_cores_enabled of this IntelSkylakeBmLaunchInstancePlatformConfig.
        :rtype: int
        """
    ...
    def percentage_of_cores_enabled(self, percentage_of_cores_enabled):
        """
        Sets the percentage_of_cores_enabled of this IntelSkylakeBmLaunchInstancePlatformConfig.
        The percentage of cores enabled. Value must be a multiple of 25%. If the requested percentage
        results in a fractional number of cores, the system rounds up the number of cores across processors
        and provisions an instance with a whole number of cores.
        ...
        :param percentage_of_cores_enabled: The percentage_of_cores_enabled of this IntelSkylakeBmLaunchInstancePlatformConfig.
        :type: int
        """
    ...
    def config_map(self):
        """
        Gets the config_map of this IntelSkylakeBmLaunchInstancePlatformConfig.
        Instance Platform Configuration Configuration Map for flexible setting input.


        :return: The config_map of this IntelSkylakeBmLaunchInstancePlatformConfig.
        :rtype: dict(str, str)
        """
    ...
    def config_map(self, config_map):
        """
        Sets the config_map of this IntelSkylakeBmLaunchInstancePlatformConfig.
        Instance Platform Configuration Configuration Map for flexible setting input.


        :param config_map: The config_map of this IntelSkylakeBmLaunchInstancePlatformConfig.
        :type: dict(str, str)
        """
