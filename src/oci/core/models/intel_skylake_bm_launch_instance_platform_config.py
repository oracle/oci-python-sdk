...
class IntelSkylakeBmLaunchInstancePlatformConfig(LaunchInstancePlatformConfig):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new IntelSkylakeBmLaunchInstancePlatformConfig object with values from keyword arguments. The default value of the :py:attr:`~oci.core.models.IntelSkylakeBmLaunchInstancePlatformConfig.type` attribute
        of this class is ``INTEL_SKYLAKE_BM`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param type:
            The value to assign to the type property of this IntelSkylakeBmLaunchInstancePlatformConfig.
        ...
        :param is_secure_boot_enabled:
            The value to assign to the is_secure_boot_enabled property of this IntelSkylakeBmLaunchInstancePlatformConfig.
        :type is_secure_boot_enabled: bool

        :param is_trusted_platform_module_enabled:
            The value to assign to the is_trusted_platform_module_enabled property of this IntelSkylakeBmLaunchInstancePlatformConfig.
