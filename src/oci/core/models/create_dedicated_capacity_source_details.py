...
class CreateDedicatedCapacitySourceDetails(CreateCapacitySourceDetails):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new CreateDedicatedCapacitySourceDetails object with values from keyword arguments. The default value of the :py:attr:`~oci.core.models.CreateDedicatedCapacitySourceDetails.capacity_type` attribute
        of this class is ``DEDICATED`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param capacity_type:
            The value to assign to the capacity_type property of this CreateDedicatedCapacitySourceDetails.
        :type capacity_type: str

        :param compartment_id:
            The value to assign to the compartment_id property of this CreateDedicatedCapacitySourceDetails.
