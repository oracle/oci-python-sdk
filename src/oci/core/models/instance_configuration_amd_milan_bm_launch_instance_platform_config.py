...
class InstanceConfigurationAmdMilanBmLaunchInstancePlatformConfig(InstanceConfigurationLaunchInstancePlatformConfig):
    ...
    def __init__(self, **kwargs):
        ...
        :param is_symmetric_multi_threading_enabled:
            The value to assign to the is_symmetric_multi_threading_enabled property of this InstanceConfigurationAmdMilanBmLaunchInstancePlatformConfig.
        :type is_symmetric_multi_threading_enabled: bool

        :param is_access_control_service_enabled:
            The value to assign to the is_access_control_service_enabled property of this InstanceConfigurationAmdMilanBmLaunchInstancePlatformConfig.
        :type is_access_control_service_enabled: bool

        :param are_virtual_instructions_enabled:
            The value to assign to the are_virtual_instructions_enabled property of this InstanceConfigurationAmdMilanBmLaunchInstancePlatformConfig.
        :type are_virtual_instructions_enabled: bool

        :param is_input_output_memory_management_unit_enabled:
            The value to assign to the is_input_output_memory_management_unit_enabled property of this InstanceConfigurationAmdMilanBmLaunchInstancePlatformConfig.
        :type is_input_output_memory_management_unit_enabled: bool

        :param percentage_of_cores_enabled:
            The value to assign to the percentage_of_cores_enabled property of this InstanceConfigurationAmdMilanBmLaunchInstancePlatformConfig.
    ...
    def is_symmetric_multi_threading_enabled(self):
        """
        Gets the is_symmetric_multi_threading_enabled of this InstanceConfigurationAmdMilanBmLaunchInstancePlatformConfig.
        ...
        :return: The is_symmetric_multi_threading_enabled of this InstanceConfigurationAmdMilanBmLaunchInstancePlatformConfig.
        :rtype: bool
        """
    ...
    def is_symmetric_multi_threading_enabled(self, is_symmetric_multi_threading_enabled):
        """
        Sets the is_symmetric_multi_threading_enabled of this InstanceConfigurationAmdMilanBmLaunchInstancePlatformConfig.
        Whether symmetric multithreading is enabled on the instance. Symmetric multithreading is also
        called simultaneous multithreading (SMT) or Intel Hyper-Threading.
        ...
        :param is_symmetric_multi_threading_enabled: The is_symmetric_multi_threading_enabled of this InstanceConfigurationAmdMilanBmLaunchInstancePlatformConfig.
        :type: bool
        """
    ...
    def is_access_control_service_enabled(self):
        """
        Gets the is_access_control_service_enabled of this InstanceConfigurationAmdMilanBmLaunchInstancePlatformConfig.
        Whether the Access Control Service is enabled on the instance. When enabled,
        the platform can enforce PCIe device isolation, required for VFIO device pass-through.


        :return: The is_access_control_service_enabled of this InstanceConfigurationAmdMilanBmLaunchInstancePlatformConfig.
        :rtype: bool
        """
    ...
    def is_access_control_service_enabled(self, is_access_control_service_enabled):
        """
        Sets the is_access_control_service_enabled of this InstanceConfigurationAmdMilanBmLaunchInstancePlatformConfig.
        Whether the Access Control Service is enabled on the instance. When enabled,
        the platform can enforce PCIe device isolation, required for VFIO device pass-through.


        :param is_access_control_service_enabled: The is_access_control_service_enabled of this InstanceConfigurationAmdMilanBmLaunchInstancePlatformConfig.
        :type: bool
        """
    ...
    def are_virtual_instructions_enabled(self):
        """
        Gets the are_virtual_instructions_enabled of this InstanceConfigurationAmdMilanBmLaunchInstancePlatformConfig.
        ...
        :return: The are_virtual_instructions_enabled of this InstanceConfigurationAmdMilanBmLaunchInstancePlatformConfig.
        :rtype: bool
        """
    ...
    def are_virtual_instructions_enabled(self, are_virtual_instructions_enabled):
        """
        Sets the are_virtual_instructions_enabled of this InstanceConfigurationAmdMilanBmLaunchInstancePlatformConfig.
        Whether virtualization instructions are available. For example, Secure Virtual Machine for AMD shapes
        or VT-x for Intel shapes.


        :param are_virtual_instructions_enabled: The are_virtual_instructions_enabled of this InstanceConfigurationAmdMilanBmLaunchInstancePlatformConfig.
        :type: bool
        """
    ...
    def is_input_output_memory_management_unit_enabled(self):
        """
        Gets the is_input_output_memory_management_unit_enabled of this InstanceConfigurationAmdMilanBmLaunchInstancePlatformConfig.
        Whether the input-output memory management unit is enabled.


        :return: The is_input_output_memory_management_unit_enabled of this InstanceConfigurationAmdMilanBmLaunchInstancePlatformConfig.
        :rtype: bool
        """
    ...
    def is_input_output_memory_management_unit_enabled(self, is_input_output_memory_management_unit_enabled):
        """
        Sets the is_input_output_memory_management_unit_enabled of this InstanceConfigurationAmdMilanBmLaunchInstancePlatformConfig.
        Whether the input-output memory management unit is enabled.


        :param is_input_output_memory_management_unit_enabled: The is_input_output_memory_management_unit_enabled of this InstanceConfigurationAmdMilanBmLaunchInstancePlatformConfig.
        :type: bool
        """
    ...
    def percentage_of_cores_enabled(self):
        """
        Gets the percentage_of_cores_enabled of this InstanceConfigurationAmdMilanBmLaunchInstancePlatformConfig.
        ...
        :return: The percentage_of_cores_enabled of this InstanceConfigurationAmdMilanBmLaunchInstancePlatformConfig.
        :rtype: int
        """
    ...
    def percentage_of_cores_enabled(self, percentage_of_cores_enabled):
        """
        Sets the percentage_of_cores_enabled of this InstanceConfigurationAmdMilanBmLaunchInstancePlatformConfig.
        The percentage of cores enabled. Value must be a multiple of 25%. If the requested percentage
        results in a fractional number of cores, the system rounds up the number of cores across processors
        and provisions an instance with a whole number of cores.
        ...
        :param percentage_of_cores_enabled: The percentage_of_cores_enabled of this InstanceConfigurationAmdMilanBmLaunchInstancePlatformConfig.
        :type: int
        """
