...
class AmdVmLaunchInstancePlatformConfig(LaunchInstancePlatformConfig):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new AmdVmLaunchInstancePlatformConfig object with values from keyword arguments. The default value of the :py:attr:`~oci.core.models.AmdVmLaunchInstancePlatformConfig.type` attribute
        of this class is ``AMD_VM`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param type:
            The value to assign to the type property of this AmdVmLaunchInstancePlatformConfig.
        ...
        :param is_secure_boot_enabled:
            The value to assign to the is_secure_boot_enabled property of this AmdVmLaunchInstancePlatformConfig.
        :type is_secure_boot_enabled: bool

        :param is_trusted_platform_module_enabled:
            The value to assign to the is_trusted_platform_module_enabled property of this AmdVmLaunchInstancePlatformConfig.
        :type is_trusted_platform_module_enabled: bool

        :param is_measured_boot_enabled:
            The value to assign to the is_measured_boot_enabled property of this AmdVmLaunchInstancePlatformConfig.
        :type is_measured_boot_enabled: bool

        :param is_memory_encryption_enabled:
            The value to assign to the is_memory_encryption_enabled property of this AmdVmLaunchInstancePlatformConfig.
