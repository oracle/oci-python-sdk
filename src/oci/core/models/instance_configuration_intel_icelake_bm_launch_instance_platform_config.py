...
class InstanceConfigurationIntelIcelakeBmLaunchInstancePlatformConfig(InstanceConfigurationLaunchInstancePlatformConfig):
    """
    ...
    #: A constant which can be used with the numa_nodes_per_socket property of a InstanceConfigurationIntelIcelakeBmLaunchInstancePlatformConfig.
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new InstanceConfigurationIntelIcelakeBmLaunchInstancePlatformConfig object with values from keyword arguments. The default value of the :py:attr:`~oci.core.models.InstanceConfigurationIntelIcelakeBmLaunchInstancePlatformConfig.type` attribute
        of this class is ``INTEL_ICELAKE_BM`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param type:
            The value to assign to the type property of this InstanceConfigurationIntelIcelakeBmLaunchInstancePlatformConfig.
        ...
        :param is_secure_boot_enabled:
            The value to assign to the is_secure_boot_enabled property of this InstanceConfigurationIntelIcelakeBmLaunchInstancePlatformConfig.
        :type is_secure_boot_enabled: bool

        :param is_trusted_platform_module_enabled:
            The value to assign to the is_trusted_platform_module_enabled property of this InstanceConfigurationIntelIcelakeBmLaunchInstancePlatformConfig.
        :type is_trusted_platform_module_enabled: bool

        :param is_measured_boot_enabled:
            The value to assign to the is_measured_boot_enabled property of this InstanceConfigurationIntelIcelakeBmLaunchInstancePlatformConfig.
        :type is_measured_boot_enabled: bool

        :param is_memory_encryption_enabled:
            The value to assign to the is_memory_encryption_enabled property of this InstanceConfigurationIntelIcelakeBmLaunchInstancePlatformConfig.
        :type is_memory_encryption_enabled: bool

        :param numa_nodes_per_socket:
            The value to assign to the numa_nodes_per_socket property of this InstanceConfigurationIntelIcelakeBmLaunchInstancePlatformConfig.
        ...
        :param is_symmetric_multi_threading_enabled:
            The value to assign to the is_symmetric_multi_threading_enabled property of this InstanceConfigurationIntelIcelakeBmLaunchInstancePlatformConfig.
        :type is_symmetric_multi_threading_enabled: bool

        :param is_input_output_memory_management_unit_enabled:
            The value to assign to the is_input_output_memory_management_unit_enabled property of this InstanceConfigurationIntelIcelakeBmLaunchInstancePlatformConfig.
        :type is_input_output_memory_management_unit_enabled: bool

        :param percentage_of_cores_enabled:
            The value to assign to the percentage_of_cores_enabled property of this InstanceConfigurationIntelIcelakeBmLaunchInstancePlatformConfig.
    ...
    def numa_nodes_per_socket(self):
        """
        Gets the numa_nodes_per_socket of this InstanceConfigurationIntelIcelakeBmLaunchInstancePlatformConfig.
        ...
        :return: The numa_nodes_per_socket of this InstanceConfigurationIntelIcelakeBmLaunchInstancePlatformConfig.
        :rtype: str
        """
    ...
    def numa_nodes_per_socket(self, numa_nodes_per_socket):
        """
        Sets the numa_nodes_per_socket of this InstanceConfigurationIntelIcelakeBmLaunchInstancePlatformConfig.
        The number of NUMA nodes per socket (NPS).


        :param numa_nodes_per_socket: The numa_nodes_per_socket of this InstanceConfigurationIntelIcelakeBmLaunchInstancePlatformConfig.
        :type: str
        """
    ...
    def is_symmetric_multi_threading_enabled(self):
        """
        Gets the is_symmetric_multi_threading_enabled of this InstanceConfigurationIntelIcelakeBmLaunchInstancePlatformConfig.
        ...
        :return: The is_symmetric_multi_threading_enabled of this InstanceConfigurationIntelIcelakeBmLaunchInstancePlatformConfig.
        :rtype: bool
        """
    ...
    def is_symmetric_multi_threading_enabled(self, is_symmetric_multi_threading_enabled):
        """
        Sets the is_symmetric_multi_threading_enabled of this InstanceConfigurationIntelIcelakeBmLaunchInstancePlatformConfig.
        Whether symmetric multithreading is enabled on the instance. Symmetric multithreading is also
        called simultaneous multithreading (SMT) or Intel Hyper-Threading.
        ...
        :param is_symmetric_multi_threading_enabled: The is_symmetric_multi_threading_enabled of this InstanceConfigurationIntelIcelakeBmLaunchInstancePlatformConfig.
        :type: bool
        """
    ...
    def is_input_output_memory_management_unit_enabled(self):
        """
        Gets the is_input_output_memory_management_unit_enabled of this InstanceConfigurationIntelIcelakeBmLaunchInstancePlatformConfig.
        Whether the input-output memory management unit is enabled.


        :return: The is_input_output_memory_management_unit_enabled of this InstanceConfigurationIntelIcelakeBmLaunchInstancePlatformConfig.
        :rtype: bool
        """
    ...
    def is_input_output_memory_management_unit_enabled(self, is_input_output_memory_management_unit_enabled):
        """
        Sets the is_input_output_memory_management_unit_enabled of this InstanceConfigurationIntelIcelakeBmLaunchInstancePlatformConfig.
        Whether the input-output memory management unit is enabled.


        :param is_input_output_memory_management_unit_enabled: The is_input_output_memory_management_unit_enabled of this InstanceConfigurationIntelIcelakeBmLaunchInstancePlatformConfig.
        :type: bool
        """
    ...
    def percentage_of_cores_enabled(self):
        """
        Gets the percentage_of_cores_enabled of this InstanceConfigurationIntelIcelakeBmLaunchInstancePlatformConfig.
        ...
        :return: The percentage_of_cores_enabled of this InstanceConfigurationIntelIcelakeBmLaunchInstancePlatformConfig.
        :rtype: int
        """
    ...
    def percentage_of_cores_enabled(self, percentage_of_cores_enabled):
        """
        Sets the percentage_of_cores_enabled of this InstanceConfigurationIntelIcelakeBmLaunchInstancePlatformConfig.
        The percentage of cores enabled. Value must be a multiple of 25%. If the requested percentage
        results in a fractional number of cores, the system rounds up the number of cores across processors
        and provisions an instance with a whole number of cores.
        ...
        :param percentage_of_cores_enabled: The percentage_of_cores_enabled of this InstanceConfigurationIntelIcelakeBmLaunchInstancePlatformConfig.
        :type: int
        """
