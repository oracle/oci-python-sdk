...
class UpdateVolumeBackupDetails(object):
    ...
    def __init__(self, **kwargs):
        ...
        :param kms_key_id:
            The value to assign to the kms_key_id property of this UpdateVolumeBackupDetails.
        :type kms_key_id: str

        :param retention_period:
            The value to assign to the retention_period property of this UpdateVolumeBackupDetails.
        :type retention_period: oci.core.models.RetentionDuration

        :param is_prevent_deletion_enabled:
            The value to assign to the is_prevent_deletion_enabled property of this UpdateVolumeBackupDetails.
        :type is_prevent_deletion_enabled: bool

        :param is_retention_lock_enabled:
            The value to assign to the is_retention_lock_enabled property of this UpdateVolumeBackupDetails.
        :type is_retention_lock_enabled: bool

        :param is_indefinite_retention_enabled:
            The value to assign to the is_indefinite_retention_enabled property of this UpdateVolumeBackupDetails.
    ...
    def kms_key_id(self):
        """
        Gets the kms_key_id of this UpdateVolumeBackupDetails.
        ...
        :return: The kms_key_id of this UpdateVolumeBackupDetails.
        :rtype: str
        """
    ...
    def kms_key_id(self, kms_key_id):
        """
        Sets the kms_key_id of this UpdateVolumeBackupDetails.
        The OCID of the Vault service key which is the master encryption key for the volume backup.
        For more information about the Vault service and encryption keys, see
        `Overview of Vault service`__ and
        `Using Keys`__.
        ...
        :param kms_key_id: The kms_key_id of this UpdateVolumeBackupDetails.
        :type: str
        """
    ...
    def retention_period(self):
        """
        Gets the retention_period of this UpdateVolumeBackupDetails.

        :return: The retention_period of this UpdateVolumeBackupDetails.
    ...
    def retention_period(self, retention_period):
        """
        Sets the retention_period of this UpdateVolumeBackupDetails.

        :param retention_period: The retention_period of this UpdateVolumeBackupDetails.
    ...
    def is_prevent_deletion_enabled(self):
        """
        Gets the is_prevent_deletion_enabled of this UpdateVolumeBackupDetails.
        ...
        :return: The is_prevent_deletion_enabled of this UpdateVolumeBackupDetails.
        :rtype: bool
        """
    ...
    def is_prevent_deletion_enabled(self, is_prevent_deletion_enabled):
        """
        Sets the is_prevent_deletion_enabled of this UpdateVolumeBackupDetails.
        Prevent backups from being deleted during the configured retention period. This is an optional field. If it is not specified, it is set to null, prevent deletion will not be applied to the backups.


        :param is_prevent_deletion_enabled: The is_prevent_deletion_enabled of this UpdateVolumeBackupDetails.
        :type: bool
        """
    ...
    def is_retention_lock_enabled(self):
        """
        Gets the is_retention_lock_enabled of this UpdateVolumeBackupDetails.
        ...
        :return: The is_retention_lock_enabled of this UpdateVolumeBackupDetails.
        :rtype: bool
        """
    ...
    def is_retention_lock_enabled(self, is_retention_lock_enabled):
        """
        Sets the is_retention_lock_enabled of this UpdateVolumeBackupDetails.
        feature that prevents deletion or alteration of backup data for a specified period to ensure data protection and regulatory compliance. This is an optional field. If it is not specified, it is set to null, no retention lock will be applied to the backups. This feature should be used in conjunction with the retention-period field.


        :param is_retention_lock_enabled: The is_retention_lock_enabled of this UpdateVolumeBackupDetails.
        :type: bool
        """
    ...
    def is_indefinite_retention_enabled(self):
        """
        Gets the is_indefinite_retention_enabled of this UpdateVolumeBackupDetails.
        ...
        :return: The is_indefinite_retention_enabled of this UpdateVolumeBackupDetails.
        :rtype: bool
        """
    ...
    def is_indefinite_retention_enabled(self, is_indefinite_retention_enabled):
        """
        Sets the is_indefinite_retention_enabled of this UpdateVolumeBackupDetails.
        feature that preserves backup data from modification or deletion to ensure it remains available for legal or regulatory investigations or litigation, regardless of standard retention policies. This is an optional field. If it is not specified, it is set to null, no legal hold will be applied to the backups.


        :param is_indefinite_retention_enabled: The is_indefinite_retention_enabled of this UpdateVolumeBackupDetails.
        :type: bool
        """
