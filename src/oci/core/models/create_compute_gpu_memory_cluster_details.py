...
class CreateComputeGpuMemoryClusterDetails(object):
    ...
    def gpu_memory_cluster_scale_config(self):
        """
        Gets the gpu_memory_cluster_scale_config of this CreateComputeGpuMemoryClusterDetails.

        :return: The gpu_memory_cluster_scale_config of this CreateComputeGpuMemoryClusterDetails.
        :rtype: oci.core.models.CreateComputeGpuMemoryClusterScaleConfig
        """
    ...
    def gpu_memory_cluster_scale_config(self, gpu_memory_cluster_scale_config):
        """
        Sets the gpu_memory_cluster_scale_config of this CreateComputeGpuMemoryClusterDetails.

        :param gpu_memory_cluster_scale_config: The gpu_memory_cluster_scale_config of this CreateComputeGpuMemoryClusterDetails.
