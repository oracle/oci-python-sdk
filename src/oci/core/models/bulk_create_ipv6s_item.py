...
class BulkCreateIpv6sItem(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new BulkCreateIpv6sItem object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param defined_tags:
            The value to assign to the defined_tags property of this BulkCreateIpv6sItem.
        :type defined_tags: dict(str, dict(str, object))

        :param display_name:
            The value to assign to the display_name property of this BulkCreateIpv6sItem.
        :type display_name: str

        :param freeform_tags:
            The value to assign to the freeform_tags property of this BulkCreateIpv6sItem.
        :type freeform_tags: dict(str, str)

        :param ip_address:
            The value to assign to the ip_address property of this BulkCreateIpv6sItem.
        :type ip_address: str

        :param lifetime:
            The value to assign to the lifetime property of this BulkCreateIpv6sItem.
            Allowed values for this property are: "EPHEMERAL", "RESERVED"
        :type lifetime: str

        :param route_table_id:
            The value to assign to the route_table_id property of this BulkCreateIpv6sItem.
    ...
    def defined_tags(self):
        """
        Gets the defined_tags of this BulkCreateIpv6sItem.
        ...
        :return: The defined_tags of this BulkCreateIpv6sItem.
    ...
    def defined_tags(self, defined_tags):
        """
        Sets the defined_tags of this BulkCreateIpv6sItem.
        Defined tags for this resource. Each key is predefined and scoped to a
        namespace. For more information, see `Resource Tags`__.
        ...
        :param defined_tags: The defined_tags of this BulkCreateIpv6sItem.
    ...
    def display_name(self):
        """
        Gets the display_name of this BulkCreateIpv6sItem.
        A user-friendly name. Does not have to be unique, and it's changeable.
        Avoid entering confidential information.


        :return: The display_name of this BulkCreateIpv6sItem.
        :rtype: str
        """
    ...
    def display_name(self, display_name):
        """
        Sets the display_name of this BulkCreateIpv6sItem.
        A user-friendly name. Does not have to be unique, and it's changeable.
        Avoid entering confidential information.


        :param display_name: The display_name of this BulkCreateIpv6sItem.
        :type: str
        """
    ...
    def freeform_tags(self):
        """
        Gets the freeform_tags of this BulkCreateIpv6sItem.
        ...
        :return: The freeform_tags of this BulkCreateIpv6sItem.
        :rtype: dict(str, str)
        """
    ...
    def freeform_tags(self, freeform_tags):
        """
        Sets the freeform_tags of this BulkCreateIpv6sItem.
        Free-form tags for this resource. Each tag is a simple key-value pair with no
        predefined name, type, or namespace. For more information, see `Resource Tags`__.
        ...
        :param freeform_tags: The freeform_tags of this BulkCreateIpv6sItem.
        :type: dict(str, str)
        """
    ...
    def ip_address(self):
        """
        Gets the ip_address of this BulkCreateIpv6sItem.
        ...
        :return: The ip_address of this BulkCreateIpv6sItem.
        :rtype: str
        """
    ...
    def ip_address(self, ip_address):
        """
        Sets the ip_address of this BulkCreateIpv6sItem.
        An IPv6 address of your choice. Must be an available IP address within
        the subnet's CIDR. If you don't specify a value, Oracle automatically
        assigns an IPv6 address from the subnet. The subnet is the one that
        contains the VNIC you specify in `vnicId`.
        ...
        :param ip_address: The ip_address of this BulkCreateIpv6sItem.
        :type: str
        """
    ...
    def lifetime(self):
        """
        Gets the lifetime of this BulkCreateIpv6sItem.
        ...
        :return: The lifetime of this BulkCreateIpv6sItem.
        :rtype: str
        """
    ...
    def lifetime(self, lifetime):
        """
        Sets the lifetime of this BulkCreateIpv6sItem.
        Lifetime of the IP address.
        There are two types of IPs:
         - Ephemeral
         - Reserved
        ...
        :param lifetime: The lifetime of this BulkCreateIpv6sItem.
        :type: str
        """
    ...
    def route_table_id(self):
        """
        Gets the route_table_id of this BulkCreateIpv6sItem.
        ...
        :return: The route_table_id of this BulkCreateIpv6sItem.
        :rtype: str
        """
    ...
    def route_table_id(self, route_table_id):
        """
        Sets the route_table_id of this BulkCreateIpv6sItem.
        The `OCID`__ of the route table the IP address or VNIC will use. For more information, see
        `Per-resource Routing`__.
        ...
        :param route_table_id: The route_table_id of this BulkCreateIpv6sItem.
        :type: str
        """
    ...
    def ipv6_subnet_cidr(self):
        """
        Gets the ipv6_subnet_cidr of this BulkCreateIpv6sItem.
        The IPv6 prefix allocated to the subnet. This is required if more than one IPv6 prefix exists on the subnet.


        :return: The ipv6_subnet_cidr of this BulkCreateIpv6sItem.
        :rtype: str
        """
    ...
    def ipv6_subnet_cidr(self, ipv6_subnet_cidr):
        """
        Sets the ipv6_subnet_cidr of this BulkCreateIpv6sItem.
        The IPv6 prefix allocated to the subnet. This is required if more than one IPv6 prefix exists on the subnet.


        :param ipv6_subnet_cidr: The ipv6_subnet_cidr of this BulkCreateIpv6sItem.
        :type: str
        """
