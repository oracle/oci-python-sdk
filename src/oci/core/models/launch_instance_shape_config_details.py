...
class LaunchInstanceShapeConfigDetails(object):
    ...
    def __init__(self, **kwargs):
        ...
        :param vcpus:
            The value to assign to the vcpus property of this LaunchInstanceShapeConfigDetails.
        :type vcpus: int
        ...
        :param local_volume_size_in_gbs:
            The value to assign to the local_volume_size_in_gbs property of this LaunchInstanceShapeConfigDetails.
    ...
    def vcpus(self):
        """
        Gets the vcpus of this LaunchInstanceShapeConfigDetails.
        ...
        :return: The vcpus of this LaunchInstanceShapeConfigDetails.
        :rtype: int
        """
        return self._vcpus
    ...
    def vcpus(self, vcpus):
        """
        Sets the vcpus of this LaunchInstanceShapeConfigDetails.
        The total number of VCPUs available to the instance. This can be used instead of OCPUs,
        in which case the actual number of OCPUs will be calculated based on this value
        and the actual hardware. This must be a multiple of 2.


        :param vcpus: The vcpus of this LaunchInstanceShapeConfigDetails.
        :type: int
        """
        self._vcpus = vcpus
    ...
    def local_volume_size_in_gbs(self):
        """
        Gets the local_volume_size_in_gbs of this LaunchInstanceShapeConfigDetails.
        ...
        :return: The local_volume_size_in_gbs of this LaunchInstanceShapeConfigDetails.
        :rtype: int
        """
    ...
    def local_volume_size_in_gbs(self, local_volume_size_in_gbs):
        """
        Sets the local_volume_size_in_gbs of this LaunchInstanceShapeConfigDetails.
        The NVMe-backed local storage capacity, in GB, for flexible dense (DenseLV) VM shapes. If the selected shape
        is DenseLV, the value must be greater than 0. For all other shapes, the value must be null (if specified);
        any non-null value for a non-DenseLV shape results in an error.


        :param local_volume_size_in_gbs: The local_volume_size_in_gbs of this LaunchInstanceShapeConfigDetails.
        :type: int
        """
