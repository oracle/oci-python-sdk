...
class AmdMilanBmGpuLaunchInstancePlatformConfig(LaunchInstancePlatformConfig):
    """
    The platform configuration used when launching a bare metal instance with a GPU shape on the AMD Milan platform.
    """

    #: A constant which can be used with the numa_nodes_per_socket property of a AmdMilanBmGpuLaunchInstancePlatformConfig.
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new AmdMilanBmGpuLaunchInstancePlatformConfig object with values from keyword arguments. The default value of the :py:attr:`~oci.core.models.AmdMilanBmGpuLaunchInstancePlatformConfig.type` attribute
        ...
        :param is_secure_boot_enabled:
            The value to assign to the is_secure_boot_enabled property of this AmdMilanBmGpuLaunchInstancePlatformConfig.
        :type is_secure_boot_enabled: bool

        :param is_trusted_platform_module_enabled:
            The value to assign to the is_trusted_platform_module_enabled property of this AmdMilanBmGpuLaunchInstancePlatformConfig.
        :type is_trusted_platform_module_enabled: bool

        :param is_measured_boot_enabled:
            The value to assign to the is_measured_boot_enabled property of this AmdMilanBmGpuLaunchInstancePlatformConfig.
        :type is_measured_boot_enabled: bool

        :param is_memory_encryption_enabled:
            The value to assign to the is_memory_encryption_enabled property of this AmdMilanBmGpuLaunchInstancePlatformConfig.
        :type is_memory_encryption_enabled: bool

        :param numa_nodes_per_socket:
            The value to assign to the numa_nodes_per_socket property of this AmdMilanBmGpuLaunchInstancePlatformConfig.
        ...
        :param is_symmetric_multi_threading_enabled:
            The value to assign to the is_symmetric_multi_threading_enabled property of this AmdMilanBmGpuLaunchInstancePlatformConfig.
        :type is_symmetric_multi_threading_enabled: bool

        :param is_access_control_service_enabled:
            The value to assign to the is_access_control_service_enabled property of this AmdMilanBmGpuLaunchInstancePlatformConfig.
        :type is_access_control_service_enabled: bool

        :param are_virtual_instructions_enabled:
            The value to assign to the are_virtual_instructions_enabled property of this AmdMilanBmGpuLaunchInstancePlatformConfig.
    ...
    def numa_nodes_per_socket(self):
        """
        Gets the numa_nodes_per_socket of this AmdMilanBmGpuLaunchInstancePlatformConfig.
        The number of NUMA nodes per socket (NPS).

        Allowed values for this property are: "NPS0", "NPS1", "NPS2", "NPS4"


        :return: The numa_nodes_per_socket of this AmdMilanBmGpuLaunchInstancePlatformConfig.
        :rtype: str
        """
    ...
    def numa_nodes_per_socket(self, numa_nodes_per_socket):
        """
        Sets the numa_nodes_per_socket of this AmdMilanBmGpuLaunchInstancePlatformConfig.
        The number of NUMA nodes per socket (NPS).


        :param numa_nodes_per_socket: The numa_nodes_per_socket of this AmdMilanBmGpuLaunchInstancePlatformConfig.
        :type: str
        """
    ...
    def is_symmetric_multi_threading_enabled(self):
        """
        Gets the is_symmetric_multi_threading_enabled of this AmdMilanBmGpuLaunchInstancePlatformConfig.
        ...
        :return: The is_symmetric_multi_threading_enabled of this AmdMilanBmGpuLaunchInstancePlatformConfig.
        :rtype: bool
        """
    ...
    def is_symmetric_multi_threading_enabled(self, is_symmetric_multi_threading_enabled):
        """
        Sets the is_symmetric_multi_threading_enabled of this AmdMilanBmGpuLaunchInstancePlatformConfig.
        Whether symmetric multithreading is enabled on the instance. Symmetric multithreading is also
        called simultaneous multithreading (SMT) or Intel Hyper-Threading.
        ...
        :param is_symmetric_multi_threading_enabled: The is_symmetric_multi_threading_enabled of this AmdMilanBmGpuLaunchInstancePlatformConfig.
        :type: bool
        """
    ...
    def is_access_control_service_enabled(self):
        """
        Gets the is_access_control_service_enabled of this AmdMilanBmGpuLaunchInstancePlatformConfig.
        Whether the Access Control Service is enabled on the instance. When enabled,
        the platform can enforce PCIe device isolation, required for VFIO device pass-through.


        :return: The is_access_control_service_enabled of this AmdMilanBmGpuLaunchInstancePlatformConfig.
        :rtype: bool
        """
    ...
    def is_access_control_service_enabled(self, is_access_control_service_enabled):
        """
        Sets the is_access_control_service_enabled of this AmdMilanBmGpuLaunchInstancePlatformConfig.
        Whether the Access Control Service is enabled on the instance. When enabled,
        the platform can enforce PCIe device isolation, required for VFIO device pass-through.


        :param is_access_control_service_enabled: The is_access_control_service_enabled of this AmdMilanBmGpuLaunchInstancePlatformConfig.
        :type: bool
        """
    ...
    def are_virtual_instructions_enabled(self):
        """
        Gets the are_virtual_instructions_enabled of this AmdMilanBmGpuLaunchInstancePlatformConfig.
        ...
        :return: The are_virtual_instructions_enabled of this AmdMilanBmGpuLaunchInstancePlatformConfig.
        :rtype: bool
        """
    ...
    def are_virtual_instructions_enabled(self, are_virtual_instructions_enabled):
        """
        Sets the are_virtual_instructions_enabled of this AmdMilanBmGpuLaunchInstancePlatformConfig.
        Whether virtualization instructions are available. For example, Secure Virtual Machine for AMD shapes
        or VT-x for Intel shapes.


        :param are_virtual_instructions_enabled: The are_virtual_instructions_enabled of this AmdMilanBmGpuLaunchInstancePlatformConfig.
        :type: bool
        """
    ...
    def is_input_output_memory_management_unit_enabled(self):
        """
        Gets the is_input_output_memory_management_unit_enabled of this AmdMilanBmGpuLaunchInstancePlatformConfig.
        Whether the input-output memory management unit is enabled.


        :return: The is_input_output_memory_management_unit_enabled of this AmdMilanBmGpuLaunchInstancePlatformConfig.
        :rtype: bool
        """
    ...
    def is_input_output_memory_management_unit_enabled(self, is_input_output_memory_management_unit_enabled):
        """
        Sets the is_input_output_memory_management_unit_enabled of this AmdMilanBmGpuLaunchInstancePlatformConfig.
        Whether the input-output memory management unit is enabled.


        :param is_input_output_memory_management_unit_enabled: The is_input_output_memory_management_unit_enabled of this AmdMilanBmGpuLaunchInstancePlatformConfig.
        :type: bool
        """
