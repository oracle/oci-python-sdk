...
class UpdateBootVolumeBackupDetails(object):
    ...
    def __init__(self, **kwargs):
        ...
        :param kms_key_id:
            The value to assign to the kms_key_id property of this UpdateBootVolumeBackupDetails.
        :type kms_key_id: str

        :param retention_period:
            The value to assign to the retention_period property of this UpdateBootVolumeBackupDetails.
        :type retention_period: oci.core.models.RetentionDuration

        :param is_prevent_deletion_enabled:
            The value to assign to the is_prevent_deletion_enabled property of this UpdateBootVolumeBackupDetails.
        :type is_prevent_deletion_enabled: bool

        :param is_retention_lock_enabled:
            The value to assign to the is_retention_lock_enabled property of this UpdateBootVolumeBackupDetails.
        :type is_retention_lock_enabled: bool

        :param is_indefinite_retention_enabled:
            The value to assign to the is_indefinite_retention_enabled property of this UpdateBootVolumeBackupDetails.
    ...
    def kms_key_id(self):
        """
        Gets the kms_key_id of this UpdateBootVolumeBackupDetails.
        ...
        :return: The kms_key_id of this UpdateBootVolumeBackupDetails.
        :rtype: str
        """
    ...
    def kms_key_id(self, kms_key_id):
        """
        Sets the kms_key_id of this UpdateBootVolumeBackupDetails.
        The OCID of the Vault service key which is the master encryption key for the volume backup.
        For more information about the Vault service and encryption keys, see
        `Overview of Vault service`__ and
        `Using Keys`__.
        ...
        :param kms_key_id: The kms_key_id of this UpdateBootVolumeBackupDetails.
        :type: str
        """
    ...
    def retention_period(self):
        """
        Gets the retention_period of this UpdateBootVolumeBackupDetails.
    ...
    def retention_period(self, retention_period):
        """
        Sets the retention_period of this UpdateBootVolumeBackupDetails.

        :param retention_period: The retention_period of this UpdateBootVolumeBackupDetails.
    ...
    def is_prevent_deletion_enabled(self):
        """
        Gets the is_prevent_deletion_enabled of this UpdateBootVolumeBackupDetails.
    ...
    def is_prevent_deletion_enabled(self, is_prevent_deletion_enabled):
        """
        Sets the is_prevent_deletion_enabled of this UpdateBootVolumeBackupDetails.
        Prevent backups from being deleted during the configured retention period. This is an optional field. If it is not specified, it is set to null, prevent deletion will not be applied to the backups.
    ...
    def is_retention_lock_enabled(self):
        """
        Gets the is_retention_lock_enabled of this UpdateBootVolumeBackupDetails.
        ...
        :return: The is_retention_lock_enabled of this UpdateBootVolumeBackupDetails.
        :rtype: bool
        """
    ...
    def is_retention_lock_enabled(self, is_retention_lock_enabled):
        """
        Sets the is_retention_lock_enabled of this UpdateBootVolumeBackupDetails.
        feature that prevents deletion or alteration of backup data for a specified period to ensure data protection and regulatory compliance. This is an optional field. If it is not specified, it is set to null, no retention lock will be applied to the backups. This feature should be used in conjunction with the retention-period field.


        :param is_retention_lock_enabled: The is_retention_lock_enabled of this UpdateBootVolumeBackupDetails.
        :type: bool
        """
    ...
    def is_indefinite_retention_enabled(self):
        """
        Gets the is_indefinite_retention_enabled of this UpdateBootVolumeBackupDetails.
        ...
        :return: The is_indefinite_retention_enabled of this UpdateBootVolumeBackupDetails.
        :rtype: bool
        """
    ...
    def is_indefinite_retention_enabled(self, is_indefinite_retention_enabled):
        """
        Sets the is_indefinite_retention_enabled of this UpdateBootVolumeBackupDetails.
        feature that preserves backup data from modification or deletion to ensure it remains available for legal or regulatory investigations or litigation, regardless of standard retention policies. This is an optional field. If it is not specified, it is set to null, no legal hold will be applied to the backups.


        :param is_indefinite_retention_enabled: The is_indefinite_retention_enabled of this UpdateBootVolumeBackupDetails.
        :type: bool
        """
