...
class VolumeSourceDetails(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new VolumeSourceDetails object with values from values from keyword arguments. This class has the following subclasses and if you are using this class as input
