...
class InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig(InstanceConfigurationLaunchInstancePlatformConfig):
    ...
    #: A constant which can be used with the numa_nodes_per_socket property of a InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig.
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig object with values from keyword arguments. The default value of the :py:attr:`~oci.core.models.InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig.type` attribute
        of this class is ``AMD_ROME_BM`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param type:
            The value to assign to the type property of this InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig.
        ...
        :param is_secure_boot_enabled:
            The value to assign to the is_secure_boot_enabled property of this InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig.
        :type is_secure_boot_enabled: bool

        :param is_trusted_platform_module_enabled:
            The value to assign to the is_trusted_platform_module_enabled property of this InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig.
        :type is_trusted_platform_module_enabled: bool

        :param is_measured_boot_enabled:
            The value to assign to the is_measured_boot_enabled property of this InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig.
        :type is_measured_boot_enabled: bool

        :param is_memory_encryption_enabled:
            The value to assign to the is_memory_encryption_enabled property of this InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig.
        :type is_memory_encryption_enabled: bool

        :param numa_nodes_per_socket:
            The value to assign to the numa_nodes_per_socket property of this InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig.
        ...
        :param is_symmetric_multi_threading_enabled:
            The value to assign to the is_symmetric_multi_threading_enabled property of this InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig.
        :type is_symmetric_multi_threading_enabled: bool

        :param is_access_control_service_enabled:
            The value to assign to the is_access_control_service_enabled property of this InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig.
        :type is_access_control_service_enabled: bool

        :param are_virtual_instructions_enabled:
            The value to assign to the are_virtual_instructions_enabled property of this InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig.
        :type are_virtual_instructions_enabled: bool

        :param is_input_output_memory_management_unit_enabled:
            The value to assign to the is_input_output_memory_management_unit_enabled property of this InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig.
        :type is_input_output_memory_management_unit_enabled: bool

        :param percentage_of_cores_enabled:
            The value to assign to the percentage_of_cores_enabled property of this InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig.
    ...
    def numa_nodes_per_socket(self):
        """
        Gets the numa_nodes_per_socket of this InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig.
        ...
        :return: The numa_nodes_per_socket of this InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig.
        :rtype: str
        """
    ...
    def numa_nodes_per_socket(self, numa_nodes_per_socket):
        """
        Sets the numa_nodes_per_socket of this InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig.
        The number of NUMA nodes per socket (NPS).


        :param numa_nodes_per_socket: The numa_nodes_per_socket of this InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig.
        :type: str
        """
    ...
    def is_symmetric_multi_threading_enabled(self):
        """
        Gets the is_symmetric_multi_threading_enabled of this InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig.
        ...
        :return: The is_symmetric_multi_threading_enabled of this InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig.
        :rtype: bool
        """
    ...
    def is_symmetric_multi_threading_enabled(self, is_symmetric_multi_threading_enabled):
        """
        Sets the is_symmetric_multi_threading_enabled of this InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig.
        Whether symmetric multithreading is enabled on the instance. Symmetric multithreading is also
        called simultaneous multithreading (SMT) or Intel Hyper-Threading.
        ...
        :param is_symmetric_multi_threading_enabled: The is_symmetric_multi_threading_enabled of this InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig.
        :type: bool
        """
    ...
    def is_access_control_service_enabled(self):
        """
        Gets the is_access_control_service_enabled of this InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig.
        Whether the Access Control Service is enabled on the instance. When enabled,
        the platform can enforce PCIe device isolation, required for VFIO device pass-through.


        :return: The is_access_control_service_enabled of this InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig.
        :rtype: bool
        """
    ...
    def is_access_control_service_enabled(self, is_access_control_service_enabled):
        """
        Sets the is_access_control_service_enabled of this InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig.
        Whether the Access Control Service is enabled on the instance. When enabled,
        the platform can enforce PCIe device isolation, required for VFIO device pass-through.


        :param is_access_control_service_enabled: The is_access_control_service_enabled of this InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig.
        :type: bool
        """
    ...
    def are_virtual_instructions_enabled(self):
        """
        Gets the are_virtual_instructions_enabled of this InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig.
        ...
        :return: The are_virtual_instructions_enabled of this InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig.
        :rtype: bool
        """
    ...
    def are_virtual_instructions_enabled(self, are_virtual_instructions_enabled):
        """
        Sets the are_virtual_instructions_enabled of this InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig.
        Whether virtualization instructions are available. For example, Secure Virtual Machine for AMD shapes
        or VT-x for Intel shapes.


        :param are_virtual_instructions_enabled: The are_virtual_instructions_enabled of this InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig.
        :type: bool
        """
    ...
    def is_input_output_memory_management_unit_enabled(self):
        """
        Gets the is_input_output_memory_management_unit_enabled of this InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig.
        Whether the input-output memory management unit is enabled.


        :return: The is_input_output_memory_management_unit_enabled of this InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig.
        :rtype: bool
        """
    ...
    def is_input_output_memory_management_unit_enabled(self, is_input_output_memory_management_unit_enabled):
        """
        Sets the is_input_output_memory_management_unit_enabled of this InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig.
        Whether the input-output memory management unit is enabled.


        :param is_input_output_memory_management_unit_enabled: The is_input_output_memory_management_unit_enabled of this InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig.
        :type: bool
        """
    ...
    def percentage_of_cores_enabled(self):
        ...
        :return: The percentage_of_cores_enabled of this InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig.
        :rtype: int
        """
    ...
    def percentage_of_cores_enabled(self, percentage_of_cores_enabled):
        """
        Sets the percentage_of_cores_enabled of this InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig.
        The percentage of cores enabled. Value must be a multiple of 25%. If the requested percentage
        results in a fractional number of cores, the system rounds up the number of cores across processors
        and provisions an instance with a whole number of cores.
        ...
        :param percentage_of_cores_enabled: The percentage_of_cores_enabled of this InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig.
        :type: int
        """
