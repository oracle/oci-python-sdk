...
class CreatePublicIpPoolDetails(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new CreatePublicIpPoolDetails object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param compartment_id:
            The value to assign to the compartment_id property of this CreatePublicIpPoolDetails.
        :type compartment_id: str

        :param defined_tags:
            The value to assign to the defined_tags property of this CreatePublicIpPoolDetails.
        :type defined_tags: dict(str, dict(str, object))

        :param display_name:
            The value to assign to the display_name property of this CreatePublicIpPoolDetails.
    ...
    def defined_tags(self):
        """
        Gets the defined_tags of this CreatePublicIpPoolDetails.
    ...
    def defined_tags(self, defined_tags):
        """
        Sets the defined_tags of this CreatePublicIpPoolDetails.
        Defined tags for this resource. Each key is predefined and scoped to a
        namespace. For more information, see `Resource Tags`__.
    ...
    def display_name(self):
        """
        Gets the display_name of this CreatePublicIpPoolDetails.
    ...
    def display_name(self, display_name):
        """
        Sets the display_name of this CreatePublicIpPoolDetails.
        A user-friendly name. Does not have to be unique, and it's changeable.
        Avoid entering confidential information.
    ...
    def freeform_tags(self):
        """
        Gets the freeform_tags of this CreatePublicIpPoolDetails.
    ...
    def freeform_tags(self, freeform_tags):
        """
        Sets the freeform_tags of this CreatePublicIpPoolDetails.
        Free-form tags for this resource. Each tag is a simple key-value pair with no
        predefined name, type, or namespace. For more information, see `Resource Tags`__.
