...
class ComputeClient(object):
    ...
    def get_compute_host(self, compute_host_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/core/get_compute_host.py.html>`__ to see an example of how to use get_compute_host API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['computeHostId']
    ...
    def update_compute_host(self, compute_host_id, update_compute_host_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/core/update_compute_host.py.html>`__ to see an example of how to use update_compute_host API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['computeHostId']
        resource_path = "/computeHosts/{computeHostId}"
