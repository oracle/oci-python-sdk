    ...
    def create_subscription_and_wait_for_state(self, create_subscription_details, wait_for_states=[], operation_kwargs={}, waiter_kwargs={}):
        ...
        try:
            waiter_result = oci.wait_until(
                self.client,
                self.client.get_subscription(subscription_id),  # noqa: F821
    ...
    def delete_subscription_and_wait_for_state(self, subscription_id, wait_for_states=[], operation_kwargs={}, waiter_kwargs={}):
        ...
        try:
            if ("succeed_on_not_found" in waiter_kwargs) and (waiter_kwargs["succeed_on_not_found"] is False):
                self.client.base_client.logger.warning("The waiter kwarg succeed_on_not_found was passed as False for the delete composite operation delete_subscription, this would result in the operation to fail if the resource is not found! Please, do not pass this kwarg if this was not intended")
            else:
                """
