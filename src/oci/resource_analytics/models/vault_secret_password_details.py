...
class VaultSecretPasswordDetails(AdwAdminPasswordDetails):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new VaultSecretPasswordDetails object with values from keyword arguments. The default value of the :py:attr:`~oci.resource_analytics.models.VaultSecretPasswordDetails.password_type` attribute
