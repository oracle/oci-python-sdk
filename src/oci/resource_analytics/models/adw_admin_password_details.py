...
class AdwAdminPasswordDetails(object):
    """
    ...
    #: A constant which can be used with the password_type property of a AdwAdminPasswordDetails.
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new AdwAdminPasswordDetails object with values from keyword arguments. This class has the following subclasses and if you are using this class as input
        to a service operations then you should favor using a subclass over the base class:

        * :class:`~oci.resource_analytics.models.PlainTextPasswordDetails`
        * :class:`~oci.resource_analytics.models.VaultSecretPasswordDetails`

        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param password_type:
            The value to assign to the password_type property of this AdwAdminPasswordDetails.
    ...
    def get_subtype(object_dictionary):
        ...
        if type == 'VAULT_SECRET':
            ...
            return 'AdwAdminPasswordDetails'

    @property
    def password_type(self):
        """
        **[Required]** Gets the password_type of this AdwAdminPasswordDetails.
        Password type

        Allowed values for this property are: "PLAIN_TEXT", "VAULT_SECRET"


        :return: The password_type of this AdwAdminPasswordDetails.
        :rtype: str
        """
    ...
    def password_type(self, password_type):
        """
        Sets the password_type of this AdwAdminPasswordDetails.
        Password type


        :param password_type: The password_type of this AdwAdminPasswordDetails.
        :type: str
        """
