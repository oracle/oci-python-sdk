...
class WorkRequestSummary(object):
    ...
    #: This constant has a value of "CREATE_RESOURCE_ANALYTICS_INSTANCE"
    OPERATION_TYPE_CREATE_RESOURCE_ANALYTICS_INSTANCE = "CREATE_RESOURCE_ANALYTICS_INSTANCE"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "UPDATE_RESOURCE_ANALYTICS_INSTANCE"
    OPERATION_TYPE_UPDATE_RESOURCE_ANALYTICS_INSTANCE = "UPDATE_RESOURCE_ANALYTICS_INSTANCE"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "DELETE_RESOURCE_ANALYTICS_INSTANCE"
    OPERATION_TYPE_DELETE_RESOURCE_ANALYTICS_INSTANCE = "DELETE_RESOURCE_ANALYTICS_INSTANCE"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "MOVE_RESOURCE_ANALYTICS_INSTANCE"
    OPERATION_TYPE_MOVE_RESOURCE_ANALYTICS_INSTANCE = "MOVE_RESOURCE_ANALYTICS_INSTANCE"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "CREATE_TENANCY_ATTACHMENT"
    OPERATION_TYPE_CREATE_TENANCY_ATTACHMENT = "CREATE_TENANCY_ATTACHMENT"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "UPDATE_TENANCY_ATTACHMENT"
    OPERATION_TYPE_UPDATE_TENANCY_ATTACHMENT = "UPDATE_TENANCY_ATTACHMENT"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "DELETE_TENANCY_ATTACHMENT"
    OPERATION_TYPE_DELETE_TENANCY_ATTACHMENT = "DELETE_TENANCY_ATTACHMENT"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "CREATE_MONITORED_REGION"
    OPERATION_TYPE_CREATE_MONITORED_REGION = "CREATE_MONITORED_REGION"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "DELETE_MONITORED_REGION"
    OPERATION_TYPE_DELETE_MONITORED_REGION = "DELETE_MONITORED_REGION"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "ENABLE_OAC"
    OPERATION_TYPE_ENABLE_OAC = "ENABLE_OAC"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "DISABLE_OAC"
    OPERATION_TYPE_DISABLE_OAC = "DISABLE_OAC"
    ...
    def __init__(self, **kwargs):
        ...
        :param operation_type:
            ...
            Allowed values for this property are: "CREATE_RESOURCE_ANALYTICS_INSTANCE", "UPDATE_RESOURCE_ANALYTICS_INSTANCE", "DELETE_RESOURCE_ANALYTICS_INSTANCE", "MOVE_RESOURCE_ANALYTICS_INSTANCE", "CREATE_TENANCY_ATTACHMENT", "UPDATE_TENANCY_ATTACHMENT", "DELETE_TENANCY_ATTACHMENT", "CREATE_MONITORED_REGION", "DELETE_MONITORED_REGION", "ENABLE_OAC", "DISABLE_OAC", 'UNKNOWN_ENUM_VALUE'.
        ...
        :type resources: list[oci.resource_analytics.models.WorkRequestResource]
    ...
    def operation_type(self, operation_type):
        ...
        :type: str
        """
        allowed_values = ["CREATE_RESOURCE_ANALYTICS_INSTANCE", "UPDATE_RESOURCE_ANALYTICS_INSTANCE", "DELETE_RESOURCE_ANALYTICS_INSTANCE", "MOVE_RESOURCE_ANALYTICS_INSTANCE", "CREATE_TENANCY_ATTACHMENT", "UPDATE_TENANCY_ATTACHMENT", "DELETE_TENANCY_ATTACHMENT", "CREATE_MONITORED_REGION", "DELETE_MONITORED_REGION", "ENABLE_OAC", "DISABLE_OAC"]
    ...
    def resources(self):
        ...
        **[Required]** Gets the resources of this WorkRequestSummary.
        ...
        :rtype: list[oci.resource_analytics.models.WorkRequestResource]
        """
    ...
    def resources(self, resources):
        ...
        :type: list[oci.resource_analytics.models.WorkRequestResource]
        """
