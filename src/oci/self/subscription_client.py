...
class SubscriptionClient(object):
    ...
    def list_subscriptions(self, **kwargs):
        ...
        :param str lifecycle_details: (optional)
            ...
            Allowed values are: "CREATED", "PENDING_ACTIVATION", "PROVISIONING_STARTED", "PROVISIONING_COMPLETED", "PROVISIONING_FAILED", "ACTIVE", "EXPIRED", "TERMINATED", "FAILED", "DELETING", "UPDATING", "DELETED"
        ...
        if 'lifecycle_details' in kwargs:
            lifecycle_details_allowed_values = ["CREATED", "PENDING_ACTIVATION", "PROVISIONING_STARTED", "PROVISIONING_COMPLETED", "PROVISIONING_FAILED", "ACTIVE", "EXPIRED", "TERMINATED", "FAILED", "DELETING", "UPDATING", "DELETED"]
