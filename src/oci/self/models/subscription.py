...
class Subscription(object):
    ...
    #: A constant which can be used with the source_type property of a Subscription.
    ...
    def __init__(self, **kwargs):
        ...
        :param display_name:
            The value to assign to the display_name property of this Subscription.
        ...
        :param tenant_id:
            The value to assign to the tenant_id property of this Subscription.
        :type tenant_id: str

        :param subscription_details:
            The value to assign to the subscription_details property of this Subscription.
        :type subscription_details: oci.self.models.SubscriptionDetails

        :param seller_id:
            The value to assign to the seller_id property of this Subscription.
        :type seller_id: str

        :param source_type:
            The value to assign to the source_type property of this Subscription.
            Allowed values for this property are: "OCI_NATIVE", "THIRD_PARTY", 'UNKNOWN_ENUM_VALUE'.
            Any unrecognized values returned by a service will be mapped to 'UNKNOWN_ENUM_VALUE'.
        :type source_type: str

        :param product_id:
            The value to assign to the product_id property of this Subscription.
        :type product_id: str

        :param additional_details:
            The value to assign to the additional_details property of this Subscription.
        :type additional_details: list[oci.self.models.ExtendedMetadata]

        :param realm:
            The value to assign to the realm property of this Subscription.
        :type realm: str

        :param region:
            The value to assign to the region property of this Subscription.
        :type region: str
        ...
        :param time_started:
            The value to assign to the time_started property of this Subscription.
        :type time_started: datetime

        :param time_ended:
            The value to assign to the time_ended property of this Subscription.
        ...
        :param system_tags:
            The value to assign to the system_tags property of this Subscription.
    ...
    def display_name(self):
        """
        **[Required]** Gets the display_name of this Subscription.
    ...
    def tenant_id(self):
        """
        **[Required]** Gets the tenant_id of this Subscription.
    ...
    def subscription_details(self):
        """
        Gets the subscription_details of this Subscription.

        :return: The subscription_details of this Subscription.
    ...
    def subscription_details(self, subscription_details):
        """
        Sets the subscription_details of this Subscription.

        :param subscription_details: The subscription_details of this Subscription.
    ...
    def seller_id(self):
        """
        Gets the seller_id of this Subscription.
        The OCID that identifies the seller within the platform.


        :return: The seller_id of this Subscription.
        :rtype: str
        """
    ...
    def seller_id(self, seller_id):
        """
        Sets the seller_id of this Subscription.
        The OCID that identifies the seller within the platform.


        :param seller_id: The seller_id of this Subscription.
        :type: str
        """
    ...
    def source_type(self):
        """
        Gets the source_type of this Subscription.
        ...
        :return: The source_type of this Subscription.
        :rtype: str
        """
    ...
    def source_type(self, source_type):
        ...
        :param source_type: The source_type of this Subscription.
        :type: str
        """
    ...
    def additional_details(self):
        """
        Gets the additional_details of this Subscription.
        Additional details that are specific for this subscription such as activation details.


        :return: The additional_details of this Subscription.
    ...
    def additional_details(self, additional_details):
        """
        Sets the additional_details of this Subscription.
        Additional details that are specific for this subscription such as activation details.


        :param additional_details: The additional_details of this Subscription.
    ...
    def realm(self):
        """
        Gets the realm of this Subscription.
        The realm from where customer is buying the subscription.


        :return: The realm of this Subscription.
        :rtype: str
        """
        return self._realm
    ...
    def realm(self, realm):
        """
        Sets the realm of this Subscription.
        The realm from where customer is buying the subscription.


        :param realm: The realm of this Subscription.
        :type: str
        """
        self._realm = realm
    ...
    def region(self):
        """
        Gets the region of this Subscription.
        The region from where customer is buying the subscription.


        :return: The region of this Subscription.
        :rtype: str
        """
        return self._region
    ...
    def region(self, region):
        ...
        :param region: The region of this Subscription.
        :type: str
        """
        self._region = region
    ...
    def time_started(self):
        """
        Gets the time_started of this Subscription.
        ...
        :return: The time_started of this Subscription.
        :rtype: datetime
        """
    ...
    def time_started(self, time_started):
        """
        Sets the time_started of this Subscription.
        The date and time the Subscription was started, in the format defined by `RFC 3339`__.
        ...
        :param time_started: The time_started of this Subscription.
        :type: datetime
        """
    ...
    def time_ended(self):
        """
        Gets the time_ended of this Subscription.
        ...
        :return: The time_ended of this Subscription.
        :rtype: datetime
        """
    ...
    def time_ended(self, time_ended):
        """
        Sets the time_ended of this Subscription.
        The date and time the Subscription was ended, in the format defined by `RFC 3339`__.
        ...
        :param time_ended: The time_ended of this Subscription.
        :type: datetime
        """
    ...
    def system_tags(self):
        """
        Gets the system_tags of this Subscription.
        System tags for this resource. Each key is predefined and scoped to a namespace.

        Example: `{\"orcl-cloud\": {\"free-tier-retained\": \"true\"}}`


        :return: The system_tags of this Subscription.
        :rtype: dict(str, dict(str, object))
        """
    ...
    def system_tags(self, system_tags):
        """
        Sets the system_tags of this Subscription.
        System tags for this resource. Each key is predefined and scoped to a namespace.

        Example: `{\"orcl-cloud\": {\"free-tier-retained\": \"true\"}}`


        :param system_tags: The system_tags of this Subscription.
        :type: dict(str, dict(str, object))
        """
