...
class ScheduledQueryClientCompositeOperations(object):
    """
    This class provides a wrapper around :py:class:`~oci.apm_traces.ScheduledQueryClient` and offers convenience methods
    ...
    def __init__(self, client, **kwargs):
        """
        Creates a new ScheduledQueryClientCompositeOperations object

        :param ScheduledQueryClient client:
            The service client which will be wrapped by this object
        """
        self.client = client

    def create_scheduled_query_and_wait_for_state(self, apm_domain_id, create_scheduled_query_details, wait_for_states=[], operation_kwargs={}, waiter_kwargs={}):
        """
        Calls :py:func:`~oci.apm_traces.ScheduledQueryClient.create_scheduled_query` and waits for the :py:class:`~oci.apm_traces.models.ScheduledQuery` acted upon
        ...
        :param dict operation_kwargs:
            A dictionary of keyword arguments to pass to :py:func:`~oci.apm_traces.ScheduledQueryClient.create_scheduled_query`

        :param dict waiter_kwargs:
            A dictionary of keyword arguments to pass to the :py:func:`oci.wait_until` function. For example, you could pass ``max_interval_seconds`` or ``max_interval_seconds``
            as dictionary keys to modify how long the waiter function will wait between retries and the maximum amount of time it will wait
        """
        operation_result = self.client.create_scheduled_query(apm_domain_id, create_scheduled_query_details, **operation_kwargs)
    ...
    def delete_scheduled_query_and_wait_for_state(self, apm_domain_id, scheduled_query_id, wait_for_states=[], operation_kwargs={}, waiter_kwargs={}):
        """
        Calls :py:func:`~oci.apm_traces.ScheduledQueryClient.delete_scheduled_query` and waits for the :py:class:`~oci.apm_traces.models.ScheduledQuery` acted upon
        to enter the given state(s).
