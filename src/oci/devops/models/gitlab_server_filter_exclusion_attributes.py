...
class GitlabServerFilterExclusionAttributes(object):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new GitlabServerFilterExclusionAttributes object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param file_filter:
            The value to assign to the file_filter property of this GitlabServerFilterExclusionAttributes.
    ...
    def file_filter(self):
        ...
        :return: The file_filter of this GitlabServerFilterExclusionAttributes.
    ...
    def file_filter(self, file_filter):
        """
        Sets the file_filter of this GitlabServerFilterExclusionAttributes.

        :param file_filter: The file_filter of this GitlabServerFilterExclusionAttributes.
