...
class RepositoryPathCollection(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new RepositoryPathCollection object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param items:
            The value to assign to the items property of this RepositoryPathCollection.
        :type items: list[oci.devops.models.RepositoryPathSummary]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this RepositoryPathCollection.
        ...
        :rtype: list[oci.devops.models.RepositoryPathSummary]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.devops.models.RepositoryPathSummary]
        """
        self._items = items
