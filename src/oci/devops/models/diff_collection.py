...
class DiffCollection(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new DiffCollection object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param items:
            The value to assign to the items property of this DiffCollection.
        :type items: list[oci.devops.models.DiffSummary]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this DiffCollection.
        ...
        :rtype: list[oci.devops.models.DiffSummary]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.devops.models.DiffSummary]
        """
        self._items = items
