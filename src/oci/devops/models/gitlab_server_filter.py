...
class GitlabServerFilter(Filter):
    """
    The filter for GitLab self-hosted events.
    """

    #: A constant which can be used with the events property of a GitlabServerFilter.
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new GitlabServerFilter object with values from keyword arguments. The default value of the :py:attr:`~oci.devops.models.GitlabServerFilter.trigger_source` attribute
        of this class is ``GITLAB_SERVER`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param trigger_source:
            The value to assign to the trigger_source property of this GitlabServerFilter.
        :type trigger_source: str

        :param events:
            The value to assign to the events property of this GitlabServerFilter.
    ...
    def events(self):
        """
        Gets the events of this GitlabServerFilter.
        ...
        :return: The events of this GitlabServerFilter.
        :rtype: list[str]
        """
        return self._events
    ...
    def events(self, events):
        """
        Sets the events of this GitlabServerFilter.
        The events, for example, PUSH, PULL_REQUEST_MERGE.


        :param events: The events of this GitlabServerFilter.
        :type: list[str]
        """
    ...
    def include(self):
        """
        Gets the include of this GitlabServerFilter.

        :return: The include of this GitlabServerFilter.
        :rtype: oci.devops.models.GitlabServerFilterAttributes
        """
    ...
    def include(self, include):
        """
        Sets the include of this GitlabServerFilter.

        :param include: The include of this GitlabServerFilter.
