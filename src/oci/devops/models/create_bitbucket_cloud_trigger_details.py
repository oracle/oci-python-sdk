...
class CreateBitbucketCloudTriggerDetails(CreateTriggerDetails):
    ...
    def __init__(self, **kwargs):
        ...
        :param connection_id:
            The value to assign to the connection_id property of this CreateBitbucketCloudTriggerDetails.
    ...
    def connection_id(self):
        """
        Gets the connection_id of this CreateBitbucketCloudTriggerDetails.
        The OCID of the connection resource used to get details for triggered events.


        :return: The connection_id of this CreateBitbucketCloudTriggerDetails.
        :rtype: str
        """
    ...
    def connection_id(self, connection_id):
        """
        Sets the connection_id of this CreateBitbucketCloudTriggerDetails.
        The OCID of the connection resource used to get details for triggered events.


        :param connection_id: The connection_id of this CreateBitbucketCloudTriggerDetails.
        :type: str
        """
