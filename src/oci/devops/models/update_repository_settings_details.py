...
class UpdateRepositorySettingsDetails(object):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new UpdateRepositorySettingsDetails object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param merge_checks:
            The value to assign to the merge_checks property of this UpdateRepositorySettingsDetails.
        :type merge_checks: oci.devops.models.MergeChecks

        :param merge_settings:
            The value to assign to the merge_settings property of this UpdateRepositorySettingsDetails.
        :type merge_settings: oci.devops.models.MergeSettings

        :param approval_rules:
            The value to assign to the approval_rules property of this UpdateRepositorySettingsDetails.
    ...
    def merge_checks(self):
        ...
        :return: The merge_checks of this UpdateRepositorySettingsDetails.
    ...
    def merge_checks(self, merge_checks):
        """
        Sets the merge_checks of this UpdateRepositorySettingsDetails.

        :param merge_checks: The merge_checks of this UpdateRepositorySettingsDetails.
    ...
    def merge_settings(self):
        ...
        :return: The merge_settings of this UpdateRepositorySettingsDetails.
    ...
    def merge_settings(self, merge_settings):
        """
        Sets the merge_settings of this UpdateRepositorySettingsDetails.

        :param merge_settings: The merge_settings of this UpdateRepositorySettingsDetails.
    ...
    def approval_rules(self):
        ...
        :return: The approval_rules of this UpdateRepositorySettingsDetails.
    ...
    def approval_rules(self, approval_rules):
        """
        Sets the approval_rules of this UpdateRepositorySettingsDetails.

        :param approval_rules: The approval_rules of this UpdateRepositorySettingsDetails.
