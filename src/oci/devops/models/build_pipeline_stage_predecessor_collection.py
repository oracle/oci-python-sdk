...
class BuildPipelineStagePredecessorCollection(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new BuildPipelineStagePredecessorCollection object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param items:
            The value to assign to the items property of this BuildPipelineStagePredecessorCollection.
        :type items: list[oci.devops.models.BuildPipelineStagePredecessor]

        """
        self.swagger_types = {
            'items': 'list[BuildPipelineStagePredecessor]'
        }
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this BuildPipelineStagePredecessorCollection.
        ...
        :rtype: list[oci.devops.models.BuildPipelineStagePredecessor]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.devops.models.BuildPipelineStagePredecessor]
        """
        self._items = items
