...
class BitbucketCloudAppPasswordConnection(Connection):
    ...
    def __init__(self, **kwargs):
        ...
        :param last_connection_validation_result:
            The value to assign to the last_connection_validation_result property of this BitbucketCloudAppPasswordConnection.
        :type last_connection_validation_result: oci.devops.models.ConnectionValidationResult

        :param lifecycle_details:
            The value to assign to the lifecycle_details property of this BitbucketCloudAppPasswordConnection.
