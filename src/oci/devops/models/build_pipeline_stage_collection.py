...
class BuildPipelineStageCollection(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new BuildPipelineStageCollection object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param items:
            The value to assign to the items property of this BuildPipelineStageCollection.
        :type items: list[oci.devops.models.BuildPipelineStageSummary]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this BuildPipelineStageCollection.
        ...
        :rtype: list[oci.devops.models.BuildPipelineStageSummary]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.devops.models.BuildPipelineStageSummary]
        """
        self._items = items
