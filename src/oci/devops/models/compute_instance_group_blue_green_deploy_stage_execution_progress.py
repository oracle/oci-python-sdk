...
class ComputeInstanceGroupBlueGreenDeployStageExecutionProgress(DeployStageExecutionProgress):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ComputeInstanceGroupBlueGreenDeployStageExecutionProgress object with values from keyword arguments. The default value of the :py:attr:`~oci.devops.models.ComputeInstanceGroupBlueGreenDeployStageExecutionProgress.deploy_stage_type` attribute
        ...
        :param deploy_stage_display_name:
            The value to assign to the deploy_stage_display_name property of this ComputeInstanceGroupBlueGreenDeployStageExecutionProgress.
        :type deploy_stage_display_name: str

        :param deploy_stage_type:
            The value to assign to the deploy_stage_type property of this ComputeInstanceGroupBlueGreenDeployStageExecutionProgress.
        :type deploy_stage_type: str

        :param deploy_stage_id:
            The value to assign to the deploy_stage_id property of this ComputeInstanceGroupBlueGreenDeployStageExecutionProgress.
        :type deploy_stage_id: str

        :param time_started:
            The value to assign to the time_started property of this ComputeInstanceGroupBlueGreenDeployStageExecutionProgress.
        :type time_started: datetime

        :param time_finished:
            The value to assign to the time_finished property of this ComputeInstanceGroupBlueGreenDeployStageExecutionProgress.
        :type time_finished: datetime

        :param status:
            The value to assign to the status property of this ComputeInstanceGroupBlueGreenDeployStageExecutionProgress.
        ...
        :param deploy_stage_predecessors:
            The value to assign to the deploy_stage_predecessors property of this ComputeInstanceGroupBlueGreenDeployStageExecutionProgress.
