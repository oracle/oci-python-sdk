...
class PatchInstruction(object):
    ...
    def __init__(self, **kwargs):
        ...
        * :class:`~oci.devops.models.PatchMoveInstruction`
        * :class:`~oci.devops.models.PatchRemoveInstruction`
        * :class:`~oci.devops.models.PatchReplaceInstruction`
        * :class:`~oci.devops.models.PatchInsertInstruction`
        * :class:`~oci.devops.models.PatchRequireInstruction`
        * :class:`~oci.devops.models.PatchMergeInstruction`
        * :class:`~oci.devops.models.PatchProhibitInstruction`
