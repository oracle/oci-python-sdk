...
class OkeCanaryApprovalDeployStageExecutionProgress(DeployStageExecutionProgress):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new OkeCanaryApprovalDeployStageExecutionProgress object with values from keyword arguments. The default value of the :py:attr:`~oci.devops.models.OkeCanaryApprovalDeployStageExecutionProgress.deploy_stage_type` attribute
        of this class is ``OKE_CANARY_APPROVAL`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param deploy_stage_display_name:
            The value to assign to the deploy_stage_display_name property of this OkeCanaryApprovalDeployStageExecutionProgress.
        :type deploy_stage_display_name: str

        :param deploy_stage_type:
            The value to assign to the deploy_stage_type property of this OkeCanaryApprovalDeployStageExecutionProgress.
        :type deploy_stage_type: str

        :param deploy_stage_id:
            The value to assign to the deploy_stage_id property of this OkeCanaryApprovalDeployStageExecutionProgress.
        :type deploy_stage_id: str

        :param time_started:
            The value to assign to the time_started property of this OkeCanaryApprovalDeployStageExecutionProgress.
        :type time_started: datetime

        :param time_finished:
            The value to assign to the time_finished property of this OkeCanaryApprovalDeployStageExecutionProgress.
        :type time_finished: datetime

        :param status:
            The value to assign to the status property of this OkeCanaryApprovalDeployStageExecutionProgress.
        ...
        :param deploy_stage_predecessors:
            The value to assign to the deploy_stage_predecessors property of this OkeCanaryApprovalDeployStageExecutionProgress.
        ...
        :param deploy_stage_execution_progress_details:
            The value to assign to the deploy_stage_execution_progress_details property of this OkeCanaryApprovalDeployStageExecutionProgress.
        ...
        :param approval_actions:
            The value to assign to the approval_actions property of this OkeCanaryApprovalDeployStageExecutionProgress.
    ...
    def approval_actions(self):
        """
        Gets the approval_actions of this OkeCanaryApprovalDeployStageExecutionProgress.

        :return: The approval_actions of this OkeCanaryApprovalDeployStageExecutionProgress.
    ...
    def approval_actions(self, approval_actions):
        """
        Sets the approval_actions of this OkeCanaryApprovalDeployStageExecutionProgress.

        :param approval_actions: The approval_actions of this OkeCanaryApprovalDeployStageExecutionProgress.
