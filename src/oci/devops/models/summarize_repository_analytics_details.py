...
class SummarizeRepositoryAnalyticsDetails(object):
    """
    Details of the user configured settings for viewing the metrics at repository level.
    """

    #: A constant which can be used with the repository_metrics property of a SummarizeRepositoryAnalyticsDetails.
    ...
    #: A constant which can be used with the aggregation_duration property of a SummarizeRepositoryAnalyticsDetails.
    ...
    #: A constant which can be used with the group_by property of a SummarizeRepositoryAnalyticsDetails.
    #: This constant has a value of "AUTHOR"
    GROUP_BY_AUTHOR = "AUTHOR"

    def __init__(self, **kwargs):
        """
        Initializes a new SummarizeRepositoryAnalyticsDetails object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param author_email:
            The value to assign to the author_email property of this SummarizeRepositoryAnalyticsDetails.
        :type author_email: str

        :param repository_metrics:
            The value to assign to the repository_metrics property of this SummarizeRepositoryAnalyticsDetails.
        ...
        :param aggregation_duration:
            The value to assign to the aggregation_duration property of this SummarizeRepositoryAnalyticsDetails.
            Allowed values for this property are: "DAILY", "WEEKLY", "MONTHLY", "YEARLY"
        :type aggregation_duration: str

        :param start_time:
            The value to assign to the start_time property of this SummarizeRepositoryAnalyticsDetails.
        :type start_time: datetime

        :param end_time:
            The value to assign to the end_time property of this SummarizeRepositoryAnalyticsDetails.
        :type end_time: datetime

        :param group_by:
            The value to assign to the group_by property of this SummarizeRepositoryAnalyticsDetails.
    ...
    def author_email(self):
        """
        Gets the author_email of this SummarizeRepositoryAnalyticsDetails.
        Email address of the author.


        :return: The author_email of this SummarizeRepositoryAnalyticsDetails.
        :rtype: str
        """
    ...
    def author_email(self, author_email):
        """
        Sets the author_email of this SummarizeRepositoryAnalyticsDetails.
        Email address of the author.


        :param author_email: The author_email of this SummarizeRepositoryAnalyticsDetails.
        :type: str
        """
    ...
    def repository_metrics(self, repository_metrics):
        """
        Sets the repository_metrics of this SummarizeRepositoryAnalyticsDetails.
        The name of the metric to be filtered.


        :param repository_metrics: The repository_metrics of this SummarizeRepositoryAnalyticsDetails.
        :type: list[str]
        """
    ...
    def aggregation_duration(self):
        """
        Gets the aggregation_duration of this SummarizeRepositoryAnalyticsDetails.
        Metrics aggregated for the defined period.

        Allowed values for this property are: "DAILY", "WEEKLY", "MONTHLY", "YEARLY"


        :return: The aggregation_duration of this SummarizeRepositoryAnalyticsDetails.
        :rtype: str
        """
    ...
    def aggregation_duration(self, aggregation_duration):
        """
        Sets the aggregation_duration of this SummarizeRepositoryAnalyticsDetails.
        Metrics aggregated for the defined period.


        :param aggregation_duration: The aggregation_duration of this SummarizeRepositoryAnalyticsDetails.
        :type: str
        """
    ...
    def start_time(self):
        """
        **[Required]** Gets the start_time of this SummarizeRepositoryAnalyticsDetails.
        The beginning of the metric data query time range.


        :return: The start_time of this SummarizeRepositoryAnalyticsDetails.
        :rtype: datetime
        """
    ...
    def start_time(self, start_time):
        """
        Sets the start_time of this SummarizeRepositoryAnalyticsDetails.
        The beginning of the metric data query time range.


        :param start_time: The start_time of this SummarizeRepositoryAnalyticsDetails.
        :type: datetime
        """
    ...
    def end_time(self):
        """
        Gets the end_time of this SummarizeRepositoryAnalyticsDetails.
        The end of the metric data query time range.


        :return: The end_time of this SummarizeRepositoryAnalyticsDetails.
        :rtype: datetime
        """
    ...
    def end_time(self, end_time):
        """
        Sets the end_time of this SummarizeRepositoryAnalyticsDetails.
        The end of the metric data query time range.


        :param end_time: The end_time of this SummarizeRepositoryAnalyticsDetails.
        :type: datetime
        """
    ...
    def group_by(self):
        """
        Gets the group_by of this SummarizeRepositoryAnalyticsDetails.
        Attribute by which metric data has to be grouped

        Allowed values for this property are: "AUTHOR"


        :return: The group_by of this SummarizeRepositoryAnalyticsDetails.
        :rtype: str
        """
    ...
    def group_by(self, group_by):
        """
        Sets the group_by of this SummarizeRepositoryAnalyticsDetails.
        Attribute by which metric data has to be grouped


        :param group_by: The group_by of this SummarizeRepositoryAnalyticsDetails.
        :type: str
        """
