...
class OkeHelmChartDeployStage(DeployStage):
    ...
    def __init__(self, **kwargs):
        ...
        :param set_values:
            The value to assign to the set_values property of this OkeHelmChartDeployStage.
        :type set_values: oci.devops.models.HelmSetValueCollection

        :param set_string:
            The value to assign to the set_string property of this OkeHelmChartDeployStage.
        :type set_string: oci.devops.models.HelmSetValueCollection

        :param are_hooks_enabled:
            The value to assign to the are_hooks_enabled property of this OkeHelmChartDeployStage.
        :type are_hooks_enabled: bool

        :param should_reuse_values:
            The value to assign to the should_reuse_values property of this OkeHelmChartDeployStage.
        :type should_reuse_values: bool

        :param should_reset_values:
            The value to assign to the should_reset_values property of this OkeHelmChartDeployStage.
        :type should_reset_values: bool

        :param is_force_enabled:
            The value to assign to the is_force_enabled property of this OkeHelmChartDeployStage.
        :type is_force_enabled: bool

        :param should_cleanup_on_fail:
            The value to assign to the should_cleanup_on_fail property of this OkeHelmChartDeployStage.
        :type should_cleanup_on_fail: bool

        :param max_history:
            The value to assign to the max_history property of this OkeHelmChartDeployStage.
        :type max_history: int

        :param should_skip_crds:
            The value to assign to the should_skip_crds property of this OkeHelmChartDeployStage.
        :type should_skip_crds: bool

        :param should_skip_render_subchart_notes:
            The value to assign to the should_skip_render_subchart_notes property of this OkeHelmChartDeployStage.
        :type should_skip_render_subchart_notes: bool

        :param should_not_wait:
            The value to assign to the should_not_wait property of this OkeHelmChartDeployStage.
        :type should_not_wait: bool

        :param is_debug_enabled:
            The value to assign to the is_debug_enabled property of this OkeHelmChartDeployStage.
    ...
    def set_values(self):
        """
        Gets the set_values of this OkeHelmChartDeployStage.

        :return: The set_values of this OkeHelmChartDeployStage.
    ...
    def set_values(self, set_values):
        """
        Sets the set_values of this OkeHelmChartDeployStage.

        :param set_values: The set_values of this OkeHelmChartDeployStage.
    ...
    def set_string(self):
        """
        Gets the set_string of this OkeHelmChartDeployStage.

        :return: The set_string of this OkeHelmChartDeployStage.
        :rtype: oci.devops.models.HelmSetValueCollection
        """
    ...
    def set_string(self, set_string):
        """
        Sets the set_string of this OkeHelmChartDeployStage.

        :param set_string: The set_string of this OkeHelmChartDeployStage.
        :type: oci.devops.models.HelmSetValueCollection
        """
    ...
    def are_hooks_enabled(self):
        """
        Gets the are_hooks_enabled of this OkeHelmChartDeployStage.
        Disable pre/post upgrade hooks. Set to false by default.


        :return: The are_hooks_enabled of this OkeHelmChartDeployStage.
        :rtype: bool
        """
    ...
    def are_hooks_enabled(self, are_hooks_enabled):
        """
        Sets the are_hooks_enabled of this OkeHelmChartDeployStage.
        Disable pre/post upgrade hooks. Set to false by default.


        :param are_hooks_enabled: The are_hooks_enabled of this OkeHelmChartDeployStage.
        :type: bool
        """
    ...
    def should_reuse_values(self):
        """
        Gets the should_reuse_values of this OkeHelmChartDeployStage.
        During upgrade, reuse the values of the last release and merge overrides from the command line. Set to false by default.


        :return: The should_reuse_values of this OkeHelmChartDeployStage.
        :rtype: bool
        """
    ...
    def should_reuse_values(self, should_reuse_values):
        """
        Sets the should_reuse_values of this OkeHelmChartDeployStage.
        During upgrade, reuse the values of the last release and merge overrides from the command line. Set to false by default.


        :param should_reuse_values: The should_reuse_values of this OkeHelmChartDeployStage.
        :type: bool
        """
    ...
    def should_reset_values(self):
        """
        Gets the should_reset_values of this OkeHelmChartDeployStage.
        During upgrade, reset the values to the ones built into the chart. It overrides shouldReuseValues. Set to false by default.


        :return: The should_reset_values of this OkeHelmChartDeployStage.
        :rtype: bool
        """
    ...
    def should_reset_values(self, should_reset_values):
        """
        Sets the should_reset_values of this OkeHelmChartDeployStage.
        During upgrade, reset the values to the ones built into the chart. It overrides shouldReuseValues. Set to false by default.


        :param should_reset_values: The should_reset_values of this OkeHelmChartDeployStage.
        :type: bool
        """
    ...
    def is_force_enabled(self):
        """
        Gets the is_force_enabled of this OkeHelmChartDeployStage.
        Force resource update through delete; or if required, recreate. Set to false by default.


        :return: The is_force_enabled of this OkeHelmChartDeployStage.
        :rtype: bool
        """
    ...
    def is_force_enabled(self, is_force_enabled):
        """
        Sets the is_force_enabled of this OkeHelmChartDeployStage.
        Force resource update through delete; or if required, recreate. Set to false by default.


        :param is_force_enabled: The is_force_enabled of this OkeHelmChartDeployStage.
        :type: bool
        """
    ...
    def should_cleanup_on_fail(self):
        """
        Gets the should_cleanup_on_fail of this OkeHelmChartDeployStage.
        Allow deletion of new resources created during when an upgrade fails. Set to false by default.


        :return: The should_cleanup_on_fail of this OkeHelmChartDeployStage.
        :rtype: bool
        """
    ...
    def should_cleanup_on_fail(self, should_cleanup_on_fail):
        """
        Sets the should_cleanup_on_fail of this OkeHelmChartDeployStage.
        Allow deletion of new resources created during when an upgrade fails. Set to false by default.


        :param should_cleanup_on_fail: The should_cleanup_on_fail of this OkeHelmChartDeployStage.
        :type: bool
        """
    ...
    def max_history(self):
        """
        Gets the max_history of this OkeHelmChartDeployStage.
        Limit the maximum number of revisions saved per release. Use 0 for no limit. Set to 10 by default


        :return: The max_history of this OkeHelmChartDeployStage.
        :rtype: int
        """
    ...
    def max_history(self, max_history):
        """
        Sets the max_history of this OkeHelmChartDeployStage.
        Limit the maximum number of revisions saved per release. Use 0 for no limit. Set to 10 by default


        :param max_history: The max_history of this OkeHelmChartDeployStage.
        :type: int
        """
    ...
    def should_skip_crds(self, should_skip_crds):
        """
        Sets the should_skip_crds of this OkeHelmChartDeployStage.
        If set, no CRDs are installed. By default, CRDs are installed only if they are not present already. Set to false by default.


        :param should_skip_crds: The should_skip_crds of this OkeHelmChartDeployStage.
        :type: bool
        """
    ...
    def should_skip_render_subchart_notes(self):
        """
        Gets the should_skip_render_subchart_notes of this OkeHelmChartDeployStage.
        If set, renders subchart notes along with the parent. Set to false by default.


        :return: The should_skip_render_subchart_notes of this OkeHelmChartDeployStage.
        :rtype: bool
        """
    ...
    def should_skip_render_subchart_notes(self, should_skip_render_subchart_notes):
        """
        Sets the should_skip_render_subchart_notes of this OkeHelmChartDeployStage.
        If set, renders subchart notes along with the parent. Set to false by default.


        :param should_skip_render_subchart_notes: The should_skip_render_subchart_notes of this OkeHelmChartDeployStage.
        :type: bool
        """
    ...
    def should_not_wait(self):
        """
        Gets the should_not_wait of this OkeHelmChartDeployStage.
        Waits until all the resources are in a ready state to mark the release as successful. Set to false by default.


        :return: The should_not_wait of this OkeHelmChartDeployStage.
        :rtype: bool
        """
    ...
    def should_not_wait(self, should_not_wait):
        """
        Sets the should_not_wait of this OkeHelmChartDeployStage.
        Waits until all the resources are in a ready state to mark the release as successful. Set to false by default.


        :param should_not_wait: The should_not_wait of this OkeHelmChartDeployStage.
        :type: bool
        """
    ...
    def is_debug_enabled(self):
        """
        Gets the is_debug_enabled of this OkeHelmChartDeployStage.
        Enables helm --debug option to stream output to tf stdout. Set to false by default.


        :return: The is_debug_enabled of this OkeHelmChartDeployStage.
        :rtype: bool
        """
    ...
    def is_debug_enabled(self, is_debug_enabled):
        """
        Sets the is_debug_enabled of this OkeHelmChartDeployStage.
        Enables helm --debug option to stream output to tf stdout. Set to false by default.


        :param is_debug_enabled: The is_debug_enabled of this OkeHelmChartDeployStage.
        :type: bool
        """
