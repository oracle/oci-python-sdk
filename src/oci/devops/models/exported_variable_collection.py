...
class ExportedVariableCollection(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ExportedVariableCollection object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param items:
            The value to assign to the items property of this ExportedVariableCollection.
        :type items: list[oci.devops.models.ExportedVariable]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this ExportedVariableCollection.
        ...
        :rtype: list[oci.devops.models.ExportedVariable]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.devops.models.ExportedVariable]
        """
        self._items = items
