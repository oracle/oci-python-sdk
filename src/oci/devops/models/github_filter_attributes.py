...
class GithubFilterAttributes(object):
    ...
    def __init__(self, **kwargs):
        ...
        :param file_filter:
            The value to assign to the file_filter property of this GithubFilterAttributes.
    ...
    def file_filter(self):
        """
        Gets the file_filter of this GithubFilterAttributes.

        :return: The file_filter of this GithubFilterAttributes.
    ...
    def file_filter(self, file_filter):
        """
        Sets the file_filter of this GithubFilterAttributes.

        :param file_filter: The file_filter of this GithubFilterAttributes.
