...
class LoadBalancerTrafficShiftDeployStageExecutionProgress(DeployStageExecutionProgress):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new LoadBalancerTrafficShiftDeployStageExecutionProgress object with values from keyword arguments. The default value of the :py:attr:`~oci.devops.models.LoadBalancerTrafficShiftDeployStageExecutionProgress.deploy_stage_type` attribute
        ...
        :param deploy_stage_display_name:
            The value to assign to the deploy_stage_display_name property of this LoadBalancerTrafficShiftDeployStageExecutionProgress.
        :type deploy_stage_display_name: str

        :param deploy_stage_type:
            The value to assign to the deploy_stage_type property of this LoadBalancerTrafficShiftDeployStageExecutionProgress.
        :type deploy_stage_type: str

        :param deploy_stage_id:
            The value to assign to the deploy_stage_id property of this LoadBalancerTrafficShiftDeployStageExecutionProgress.
        :type deploy_stage_id: str

        :param time_started:
            The value to assign to the time_started property of this LoadBalancerTrafficShiftDeployStageExecutionProgress.
        :type time_started: datetime

        :param time_finished:
            The value to assign to the time_finished property of this LoadBalancerTrafficShiftDeployStageExecutionProgress.
        :type time_finished: datetime

        :param status:
            The value to assign to the status property of this LoadBalancerTrafficShiftDeployStageExecutionProgress.
        ...
        :param deploy_stage_predecessors:
            The value to assign to the deploy_stage_predecessors property of this LoadBalancerTrafficShiftDeployStageExecutionProgress.
        ...
        :param deploy_stage_execution_progress_details:
            The value to assign to the deploy_stage_execution_progress_details property of this LoadBalancerTrafficShiftDeployStageExecutionProgress.
