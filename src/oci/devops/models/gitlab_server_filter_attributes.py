...
class GitlabServerFilterAttributes(object):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new GitlabServerFilterAttributes object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param head_ref:
            The value to assign to the head_ref property of this GitlabServerFilterAttributes.
        :type head_ref: str
    ...
    def head_ref(self):
        """
        Gets the head_ref of this GitlabServerFilterAttributes.
        Branch for push event; source branch for pull requests.


        :return: The head_ref of this GitlabServerFilterAttributes.
        :rtype: str
        """
    ...
    def head_ref(self, head_ref):
        """
        Sets the head_ref of this GitlabServerFilterAttributes.
        Branch for push event; source branch for pull requests.


        :param head_ref: The head_ref of this GitlabServerFilterAttributes.
        :type: str
        """
    ...
    def base_ref(self):
        """
        Gets the base_ref of this GitlabServerFilterAttributes.
        The target branch for pull requests; not applicable for push requests.


        :return: The base_ref of this GitlabServerFilterAttributes.
        :rtype: str
        """
    ...
    def base_ref(self, base_ref):
        """
        Sets the base_ref of this GitlabServerFilterAttributes.
        The target branch for pull requests; not applicable for push requests.


        :param base_ref: The base_ref of this GitlabServerFilterAttributes.
        :type: str
        """
