...
class BuildPipelineStageSummary(object):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new BuildPipelineStageSummary object with values from keyword arguments. This class has the following subclasses and if you are using this class as input
        to a service operations then you should favor using a subclass over the base class:

        * :class:`~oci.devops.models.WaitStageSummary`
        * :class:`~oci.devops.models.BuildStageSummary`
        * :class:`~oci.devops.models.DeliverArtifactStageSummary`
        * :class:`~oci.devops.models.TriggerDeploymentStageSummary`

        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param id:
            The value to assign to the id property of this BuildPipelineStageSummary.
        :type id: str

        :param display_name:
            The value to assign to the display_name property of this BuildPipelineStageSummary.
        :type display_name: str

        :param project_id:
            The value to assign to the project_id property of this BuildPipelineStageSummary.
        :type project_id: str

        :param build_pipeline_id:
            The value to assign to the build_pipeline_id property of this BuildPipelineStageSummary.
        :type build_pipeline_id: str

        :param compartment_id:
            The value to assign to the compartment_id property of this BuildPipelineStageSummary.
        :type compartment_id: str

        :param build_pipeline_stage_type:
            The value to assign to the build_pipeline_stage_type property of this BuildPipelineStageSummary.
        :type build_pipeline_stage_type: str

        :param time_created:
            The value to assign to the time_created property of this BuildPipelineStageSummary.
        :type time_created: datetime

        :param time_updated:
            The value to assign to the time_updated property of this BuildPipelineStageSummary.
        :type time_updated: datetime

        :param lifecycle_state:
            The value to assign to the lifecycle_state property of this BuildPipelineStageSummary.
        :type lifecycle_state: str

        :param lifecycle_details:
            The value to assign to the lifecycle_details property of this BuildPipelineStageSummary.
        :type lifecycle_details: str

        :param description:
            The value to assign to the description property of this BuildPipelineStageSummary.
        :type description: str

        :param build_pipeline_stage_predecessor_collection:
            The value to assign to the build_pipeline_stage_predecessor_collection property of this BuildPipelineStageSummary.
        :type build_pipeline_stage_predecessor_collection: oci.devops.models.BuildPipelineStagePredecessorCollection

        :param freeform_tags:
            The value to assign to the freeform_tags property of this BuildPipelineStageSummary.
        :type freeform_tags: dict(str, str)

        :param defined_tags:
            The value to assign to the defined_tags property of this BuildPipelineStageSummary.
        :type defined_tags: dict(str, dict(str, object))

        :param system_tags:
            The value to assign to the system_tags property of this BuildPipelineStageSummary.
    ...
    def get_subtype(object_dictionary):
        ...
        if type == 'WAIT':
            return 'WaitStageSummary'

        if type == 'BUILD':
            return 'BuildStageSummary'

        if type == 'DELIVER_ARTIFACT':
            return 'DeliverArtifactStageSummary'

        if type == 'TRIGGER_DEPLOYMENT_PIPELINE':
            return 'TriggerDeploymentStageSummary'
        else:
            return 'BuildPipelineStageSummary'
    ...
    def lifecycle_details(self):
        """
        Gets the lifecycle_details of this BuildPipelineStageSummary.
        A message describing the current state in more detail. For example, can be used to provide actionable information for a resource in Failed state.


        :return: The lifecycle_details of this BuildPipelineStageSummary.
        :rtype: str
        """
    ...
    def lifecycle_details(self, lifecycle_details):
        """
        Sets the lifecycle_details of this BuildPipelineStageSummary.
        A message describing the current state in more detail. For example, can be used to provide actionable information for a resource in Failed state.


        :param lifecycle_details: The lifecycle_details of this BuildPipelineStageSummary.
        :type: str
        """
    ...
    def build_pipeline_stage_predecessor_collection(self):
        """
        Gets the build_pipeline_stage_predecessor_collection of this BuildPipelineStageSummary.

        :return: The build_pipeline_stage_predecessor_collection of this BuildPipelineStageSummary.
    ...
    def build_pipeline_stage_predecessor_collection(self, build_pipeline_stage_predecessor_collection):
        """
        Sets the build_pipeline_stage_predecessor_collection of this BuildPipelineStageSummary.

        :param build_pipeline_stage_predecessor_collection: The build_pipeline_stage_predecessor_collection of this BuildPipelineStageSummary.
    ...
    def freeform_tags(self):
        """
        Gets the freeform_tags of this BuildPipelineStageSummary.
        Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only.  See `Resource Tags`__. Example: `{\"bar-key\": \"value\"}`

        __ https://docs.cloud.oracle.com/Content/General/Concepts/resourcetags.htm


        :return: The freeform_tags of this BuildPipelineStageSummary.
        :rtype: dict(str, str)
        """
    ...
    def freeform_tags(self, freeform_tags):
        """
        Sets the freeform_tags of this BuildPipelineStageSummary.
        Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only.  See `Resource Tags`__. Example: `{\"bar-key\": \"value\"}`

        __ https://docs.cloud.oracle.com/Content/General/Concepts/resourcetags.htm


        :param freeform_tags: The freeform_tags of this BuildPipelineStageSummary.
        :type: dict(str, str)
        """
    ...
    def defined_tags(self):
        """
        Gets the defined_tags of this BuildPipelineStageSummary.
        Defined tags for this resource. Each key is predefined and scoped to a namespace. See `Resource Tags`__. Example: `{\"foo-namespace\": {\"bar-key\": \"value\"}}`

        __ https://docs.cloud.oracle.com/Content/General/Concepts/resourcetags.htm


        :return: The defined_tags of this BuildPipelineStageSummary.
    ...
    def defined_tags(self, defined_tags):
        """
        Sets the defined_tags of this BuildPipelineStageSummary.
        Defined tags for this resource. Each key is predefined and scoped to a namespace. See `Resource Tags`__. Example: `{\"foo-namespace\": {\"bar-key\": \"value\"}}`

        __ https://docs.cloud.oracle.com/Content/General/Concepts/resourcetags.htm


        :param defined_tags: The defined_tags of this BuildPipelineStageSummary.
    ...
    def system_tags(self):
        """
        Gets the system_tags of this BuildPipelineStageSummary.
        ...
        :return: The system_tags of this BuildPipelineStageSummary.
        :rtype: dict(str, dict(str, object))
        """
    ...
    def system_tags(self, system_tags):
        """
        Sets the system_tags of this BuildPipelineStageSummary.
        Usage of system tag keys. These predefined keys are scoped to namespaces. See `Resource Tags`__. Example: `{\"orcl-cloud\": {\"free-tier-retained\": \"true\"}}`

        __ https://docs.cloud.oracle.com/Content/General/Concepts/resourcetags.htm


        :param system_tags: The system_tags of this BuildPipelineStageSummary.
        :type: dict(str, dict(str, object))
        """
