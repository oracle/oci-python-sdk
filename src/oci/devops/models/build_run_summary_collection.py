...
class BuildRunSummaryCollection(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new BuildRunSummaryCollection object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param items:
            The value to assign to the items property of this BuildRunSummaryCollection.
        :type items: list[oci.devops.models.BuildRunSummary]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this BuildRunSummaryCollection.
        ...
        :rtype: list[oci.devops.models.BuildRunSummary]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.devops.models.BuildRunSummary]
        """
        self._items = items
