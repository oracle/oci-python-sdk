...
class BuildSourceCollection(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new BuildSourceCollection object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param items:
            The value to assign to the items property of this BuildSourceCollection.
        :type items: list[oci.devops.models.BuildSource]

        """
        self.swagger_types = {
            'items': 'list[BuildSource]'
        }
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this BuildSourceCollection.
        ...
        :rtype: list[oci.devops.models.BuildSource]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.devops.models.BuildSource]
        """
        self._items = items
