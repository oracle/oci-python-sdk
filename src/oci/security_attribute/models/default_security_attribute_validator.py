...
class DefaultSecurityAttributeValidator(BaseSecurityAttributeValidator):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new DefaultSecurityAttributeValidator object with values from keyword arguments. The default value of the :py:attr:`~oci.security_attribute.models.DefaultSecurityAttributeValidator.validator_type` attribute
        of this class is ``DEFAULT`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param validator_type:
            The value to assign to the validator_type property of this DefaultSecurityAttributeValidator.
