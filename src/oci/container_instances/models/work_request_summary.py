...
class WorkRequestSummary(object):
    ...
    #: This constant has a value of "CREATE_CONTAINER_INSTANCE"
    OPERATION_TYPE_CREATE_CONTAINER_INSTANCE = "CREATE_CONTAINER_INSTANCE"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "UPDATE_CONTAINER_INSTANCE"
    OPERATION_TYPE_UPDATE_CONTAINER_INSTANCE = "UPDATE_CONTAINER_INSTANCE"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "DELETE_CONTAINER_INSTANCE"
    OPERATION_TYPE_DELETE_CONTAINER_INSTANCE = "DELETE_CONTAINER_INSTANCE"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "MOVE_CONTAINER_INSTANCE"
    OPERATION_TYPE_MOVE_CONTAINER_INSTANCE = "MOVE_CONTAINER_INSTANCE"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "START_CONTAINER_INSTANCE"
    OPERATION_TYPE_START_CONTAINER_INSTANCE = "START_CONTAINER_INSTANCE"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "STOP_CONTAINER_INSTANCE"
    OPERATION_TYPE_STOP_CONTAINER_INSTANCE = "STOP_CONTAINER_INSTANCE"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "RESTART_CONTAINER_INSTANCE"
    OPERATION_TYPE_RESTART_CONTAINER_INSTANCE = "RESTART_CONTAINER_INSTANCE"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "UPDATE_CONTAINER"
    OPERATION_TYPE_UPDATE_CONTAINER = "UPDATE_CONTAINER"
    ...
    def __init__(self, **kwargs):
        ...
        :type resources: list[oci.container_instances.models.WorkRequestResource]
    ...
    def operation_type(self, operation_type):
        ...
        :type: str
        """
        allowed_values = ["CREATE_CONTAINER_INSTANCE", "UPDATE_CONTAINER_INSTANCE", "DELETE_CONTAINER_INSTANCE", "MOVE_CONTAINER_INSTANCE", "START_CONTAINER_INSTANCE", "STOP_CONTAINER_INSTANCE", "RESTART_CONTAINER_INSTANCE", "UPDATE_CONTAINER"]
    ...
    def resources(self):
        ...
        **[Required]** Gets the resources of this WorkRequestSummary.
        ...
        :rtype: list[oci.container_instances.models.WorkRequestResource]
        """
    ...
    def resources(self, resources):
        ...
        :type: list[oci.container_instances.models.WorkRequestResource]
        """
