...
class WorkRequestSummaryCollection(object):
    ...
    def __init__(self, **kwargs):
        ...
        :type items: list[oci.container_instances.models.WorkRequestSummary]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this WorkRequestSummaryCollection.
        ...
        :rtype: list[oci.container_instances.models.WorkRequestSummary]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.container_instances.models.WorkRequestSummary]
        """
        self._items = items
