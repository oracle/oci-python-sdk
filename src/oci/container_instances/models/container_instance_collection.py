...
class ContainerInstanceCollection(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ContainerInstanceCollection object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param items:
            The value to assign to the items property of this ContainerInstanceCollection.
        :type items: list[oci.container_instances.models.ContainerInstanceSummary]

        """
        self.swagger_types = {
            'items': 'list[ContainerInstanceSummary]'
        }
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this ContainerInstanceCollection.
        ...
        :rtype: list[oci.container_instances.models.ContainerInstanceSummary]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.container_instances.models.ContainerInstanceSummary]
        """
        self._items = items
