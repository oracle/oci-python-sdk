...
class CreateContainerInstanceShapeConfigDetails(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new CreateContainerInstanceShapeConfigDetails object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param ocpus:
            The value to assign to the ocpus property of this CreateContainerInstanceShapeConfigDetails.
        :type ocpus: float

        :param memory_in_gbs:
            The value to assign to the memory_in_gbs property of this CreateContainerInstanceShapeConfigDetails.
