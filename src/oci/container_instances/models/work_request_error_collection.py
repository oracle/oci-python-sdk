...
class WorkRequestErrorCollection(object):
    ...
    def __init__(self, **kwargs):
        ...
        :type items: list[oci.container_instances.models.WorkRequestError]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this WorkRequestErrorCollection.
        ...
        :rtype: list[oci.container_instances.models.WorkRequestError]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.container_instances.models.WorkRequestError]
        """
        self._items = items
