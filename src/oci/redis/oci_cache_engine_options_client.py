...
class OciCacheEngineOptionsClient(object):
    ...
    def list_oci_cache_engine_options(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/redis/list_oci_cache_engine_options.py.html>`__ to see an example of how to use list_oci_cache_engine_options API.
        """
