...
class RedisClusterClientCompositeOperations(object):
    """
    This class provides a wrapper around :py:class:`~oci.redis.RedisClusterClient` and offers convenience methods
    ...
    def __init__(self, client, **kwargs):
        ...
        :param RedisClusterClient client:
    ...
    def change_redis_cluster_compartment_and_wait_for_state(self, redis_cluster_id, change_redis_cluster_compartment_details, wait_for_states=[], operation_kwargs={}, waiter_kwargs={}):
        ...
        :param dict operation_kwargs:
            A dictionary of keyword arguments to pass to :py:func:`~oci.redis.RedisClusterClient.change_redis_cluster_compartment`

        :param dict waiter_kwargs:
            A dictionary of keyword arguments to pass to the :py:func:`oci.wait_until` function. For example, you could pass ``max_interval_seconds`` or ``max_interval_seconds``
            as dictionary keys to modify how long the waiter function will wait between retries and the maximum amount of time it will wait
        """
        operation_result = self.client.change_redis_cluster_compartment(redis_cluster_id, change_redis_cluster_compartment_details, **operation_kwargs)
    ...
    def create_redis_cluster_and_wait_for_state(self, create_redis_cluster_details, wait_for_states=[], operation_kwargs={}, waiter_kwargs={}):
        ...
        :param dict operation_kwargs:
            A dictionary of keyword arguments to pass to :py:func:`~oci.redis.RedisClusterClient.create_redis_cluster`

        :param dict waiter_kwargs:
            A dictionary of keyword arguments to pass to the :py:func:`oci.wait_until` function. For example, you could pass ``max_interval_seconds`` or ``max_interval_seconds``
            as dictionary keys to modify how long the waiter function will wait between retries and the maximum amount of time it will wait
        """
        operation_result = self.client.create_redis_cluster(create_redis_cluster_details, **operation_kwargs)
        if not wait_for_states:
            return operation_result
        lowered_wait_for_states = [w.lower() for w in wait_for_states]
        if 'opc-work-request-id' not in operation_result.headers:
    ...
    def delete_redis_cluster_and_wait_for_state(self, redis_cluster_id, wait_for_states=[], operation_kwargs={}, waiter_kwargs={}):
        """
        Calls :py:func:`~oci.redis.RedisClusterClient.delete_redis_cluster` and waits for the :py:class:`~oci.redis.models.WorkRequest`
        to enter the given state(s).
        ...
        :param dict operation_kwargs:
            A dictionary of keyword arguments to pass to :py:func:`~oci.redis.RedisClusterClient.delete_redis_cluster`
        ...
        try:
            operation_result = self.client.delete_redis_cluster(redis_cluster_id, **operation_kwargs)
    ...
    def update_redis_cluster_and_wait_for_state(self, redis_cluster_id, update_redis_cluster_details, wait_for_states=[], operation_kwargs={}, waiter_kwargs={}):
        ...
        :param dict operation_kwargs:
            A dictionary of keyword arguments to pass to :py:func:`~oci.redis.RedisClusterClient.update_redis_cluster`

        :param dict waiter_kwargs:
            A dictionary of keyword arguments to pass to the :py:func:`oci.wait_until` function. For example, you could pass ``max_interval_seconds`` or ``max_interval_seconds``
            as dictionary keys to modify how long the waiter function will wait between retries and the maximum amount of time it will wait
        """
        operation_result = self.client.update_redis_cluster(redis_cluster_id, update_redis_cluster_details, **operation_kwargs)
        if not wait_for_states:
            return operation_result
        lowered_wait_for_states = [w.lower() for w in wait_for_states]
        if 'opc-work-request-id' not in operation_result.headers:
