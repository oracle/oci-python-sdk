...
class WorkRequestSummary(object):
    ...
    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "CREATE_OCI_CACHE_BACKUP"
    OPERATION_TYPE_CREATE_OCI_CACHE_BACKUP = "CREATE_OCI_CACHE_BACKUP"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "UPDATE_OCI_CACHE_BACKUP"
    OPERATION_TYPE_UPDATE_OCI_CACHE_BACKUP = "UPDATE_OCI_CACHE_BACKUP"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "DELETE_OCI_CACHE_BACKUP"
    OPERATION_TYPE_DELETE_OCI_CACHE_BACKUP = "DELETE_OCI_CACHE_BACKUP"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "MOVE_OCI_CACHE_BACKUP"
    OPERATION_TYPE_MOVE_OCI_CACHE_BACKUP = "MOVE_OCI_CACHE_BACKUP"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "EXPORT_OCI_CACHE_BACKUP_TO_OS"
    OPERATION_TYPE_EXPORT_OCI_CACHE_BACKUP_TO_OS = "EXPORT_OCI_CACHE_BACKUP_TO_OS"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "PATCH_OCI_CACHE_CLUSTER"
    OPERATION_TYPE_PATCH_OCI_CACHE_CLUSTER = "PATCH_OCI_CACHE_CLUSTER"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "REPLACE_OCI_CACHE_NODE"
    OPERATION_TYPE_REPLACE_OCI_CACHE_NODE = "REPLACE_OCI_CACHE_NODE"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "CONVERT_TO_SECONDARY_CLUSTER"
    OPERATION_TYPE_CONVERT_TO_SECONDARY_CLUSTER = "CONVERT_TO_SECONDARY_CLUSTER"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "CONVERT_TO_STANDALONE_CLUSTER"
    OPERATION_TYPE_CONVERT_TO_STANDALONE_CLUSTER = "CONVERT_TO_STANDALONE_CLUSTER"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "ROLLBACK_CRR_SETUP"
    OPERATION_TYPE_ROLLBACK_CRR_SETUP = "ROLLBACK_CRR_SETUP"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "SWITCHOVER"
    OPERATION_TYPE_SWITCHOVER = "SWITCHOVER"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "SETUP_CRR"
    OPERATION_TYPE_SETUP_CRR = "SETUP_CRR"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "CHANGE_ROLE_TO_SECONDARY"
    OPERATION_TYPE_CHANGE_ROLE_TO_SECONDARY = "CHANGE_ROLE_TO_SECONDARY"
    ...
    def operation_type(self, operation_type):
        ...
        :type: str
        """
        allowed_values = ["CREATE_REDIS_CLUSTER", "UPDATE_REDIS_CLUSTER", "DELETE_REDIS_CLUSTER", "MOVE_REDIS_CLUSTER", "FAILOVER_REDIS_CLUSTER", "CREATE_REDIS_CONFIG_SET", "UPDATE_REDIS_CONFIG_SET", "DELETE_REDIS_CONFIG_SET", "MOVE_REDIS_CONFIG_SET", "MIGRATE_CLUSTER", "CLUSTER_ROLLBACK", "ATTACH_OCI_CACHE_USERS", "DETACH_OCI_CACHE_USERS", "CREATE_OCI_CACHE_USER", "UPDATE_OCI_CACHE_USER", "DELETE_OCI_CACHE_USER", "CREATE_OCI_CACHE_CONFIG_SET", "UPDATE_OCI_CACHE_CONFIG_SET", "DELETE_OCI_CACHE_CONFIG_SET", "CHANGE_OCI_CACHE_CONFIG_SET_COMPARTMENT", "CHANGE_OCI_CACHE_USER_COMPARTMENT", "CREATE_OCI_CACHE_BACKUP", "UPDATE_OCI_CACHE_BACKUP", "DELETE_OCI_CACHE_BACKUP", "MOVE_OCI_CACHE_BACKUP", "EXPORT_OCI_CACHE_BACKUP_TO_OS", "PATCH_OCI_CACHE_CLUSTER", "REPLACE_OCI_CACHE_NODE", "CONVERT_TO_SECONDARY_CLUSTER", "CONVERT_TO_STANDALONE_CLUSTER", "ROLLBACK_CRR_SETUP", "SWITCHOVER", "SETUP_CRR", "CHANGE_ROLE_TO_SECONDARY"]
