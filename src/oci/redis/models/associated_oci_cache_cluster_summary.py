...
class AssociatedOciCacheClusterSummary(object):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new AssociatedOciCacheClusterSummary object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param id:
            The value to assign to the id property of this AssociatedOciCacheClusterSummary.
        :type id: str
