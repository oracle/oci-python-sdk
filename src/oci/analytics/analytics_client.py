...
class AnalyticsClient(object):
    ...
    def list_analytics_instances(self, compartment_id, **kwargs):
        ...
        :param str sort_by: (optional)
            ...
            Allowed values are: "capacityType", "featureSet", "lifecycleState", "name", "timeCreated"
        ...
        if 'sort_by' in kwargs:
            sort_by_allowed_values = ["capacityType", "featureSet", "lifecycleState", "name", "timeCreated"]
