...
class WorkRequest(object):
    ...
    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "UPDATE_INSTANCE_ENCRYPTION_KEY"
    OPERATION_TYPE_UPDATE_INSTANCE_ENCRYPTION_KEY = "UPDATE_INSTANCE_ENCRYPTION_KEY"
    ...
    def __init__(self, **kwargs):
        ...
        :type resources: list[oci.analytics.models.WorkRequestResource]
    ...
    def resources(self):
        ...
        **[Required]** Gets the resources of this WorkRequest.
        ...
        :rtype: list[oci.analytics.models.WorkRequestResource]
        """
    ...
    def resources(self, resources):
        ...
        :type: list[oci.analytics.models.WorkRequestResource]
        """
