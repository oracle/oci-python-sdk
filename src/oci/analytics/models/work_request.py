...
class WorkRequest(object):
    ...
    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "CREATE_RESOURCE_GROUP"
    OPERATION_TYPE_CREATE_RESOURCE_GROUP = "CREATE_RESOURCE_GROUP"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "UPDATE_RESOURCE_GROUP"
    OPERATION_TYPE_UPDATE_RESOURCE_GROUP = "UPDATE_RESOURCE_GROUP"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "DELETE_RESOURCE_GROUP"
    OPERATION_TYPE_DELETE_RESOURCE_GROUP = "DELETE_RESOURCE_GROUP"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "SET_FEATURE_SET"
    ...
    def __init__(self, **kwargs):
        ...
        :param operation_type:
            ...
            Allowed values for this property are: "CREATE_ANALYTICS_INSTANCE", "DELETE_ANALYTICS_INSTANCE", "START_ANALYTICS_INSTANCE", "STOP_ANALYTICS_INSTANCE", "SCALE_ANALYTICS_INSTANCE", "CHANGE_ANALYTICS_INSTANCE_COMPARTMENT", "CHANGE_ANALYTICS_INSTANCE_NETWORK_ENDPOINT", "CREATE_VANITY_URL", "UPDATE_VANITY_URL", "DELETE_VANITY_URL", "CREATE_PRIVATE_ACCESS_CHANNEL", "UPDATE_PRIVATE_ACCESS_CHANNEL", "DELETE_PRIVATE_ACCESS_CHANNEL", "UPDATE_INSTANCE_ENCRYPTION_KEY", "CREATE_RESOURCE_GROUP", "UPDATE_RESOURCE_GROUP", "DELETE_RESOURCE_GROUP", "SET_FEATURE_SET", 'UNKNOWN_ENUM_VALUE'.
    ...
    def operation_type(self, operation_type):
        ...
        :type: str
        """
        allowed_values = ["CREATE_ANALYTICS_INSTANCE", "DELETE_ANALYTICS_INSTANCE", "START_ANALYTICS_INSTANCE", "STOP_ANALYTICS_INSTANCE", "SCALE_ANALYTICS_INSTANCE", "CHANGE_ANALYTICS_INSTANCE_COMPARTMENT", "CHANGE_ANALYTICS_INSTANCE_NETWORK_ENDPOINT", "CREATE_VANITY_URL", "UPDATE_VANITY_URL", "DELETE_VANITY_URL", "CREATE_PRIVATE_ACCESS_CHANNEL", "UPDATE_PRIVATE_ACCESS_CHANNEL", "DELETE_PRIVATE_ACCESS_CHANNEL", "UPDATE_INSTANCE_ENCRYPTION_KEY", "CREATE_RESOURCE_GROUP", "UPDATE_RESOURCE_GROUP", "DELETE_RESOURCE_GROUP", "SET_FEATURE_SET"]
