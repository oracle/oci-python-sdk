...
class WorkRequestSummaryCollection(object):
    ...
    def __init__(self, **kwargs):
        ...
        :type items: list[oci.ai_language.models.WorkRequestSummary]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this WorkRequestSummaryCollection.
        ...
        :rtype: list[oci.ai_language.models.WorkRequestSummary]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.ai_language.models.WorkRequestSummary]
        """
        self._items = items
