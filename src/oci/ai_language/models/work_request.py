...
class WorkRequest(object):
    ...
    OPERATION_TYPE_CREATE_MODEL = "CREATE_MODEL"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "UPDATE_MODEL"
    OPERATION_TYPE_UPDATE_MODEL = "UPDATE_MODEL"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "DELETE_MODEL"
    OPERATION_TYPE_DELETE_MODEL = "DELETE_MODEL"
    ...
    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "CREATE_ENDPOINT"
    OPERATION_TYPE_CREATE_ENDPOINT = "CREATE_ENDPOINT"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "UPDATE_ENDPOINT"
    OPERATION_TYPE_UPDATE_ENDPOINT = "UPDATE_ENDPOINT"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "DELETE_ENDPOINT"
    OPERATION_TYPE_DELETE_ENDPOINT = "DELETE_ENDPOINT"
    ...
    def __init__(self, **kwargs):
        ...
        :param operation_type:
            ...
            Allowed values for this property are: "CREATE_MODEL", "UPDATE_MODEL", "DELETE_MODEL", "CREATE_PROJECT", "UPDATE_PROJECT", "DELETE_PROJECT", "CREATE_ENDPOINT", "UPDATE_ENDPOINT", "DELETE_ENDPOINT", 'UNKNOWN_ENUM_VALUE'.
            Any unrecognized values returned by a service will be mapped to 'UNKNOWN_ENUM_VALUE'.
        :type operation_type: str

        :param status:
            The value to assign to the status property of this WorkRequest.
            Allowed values for this property are: "ACCEPTED", "IN_PROGRESS", "FAILED", "WAITING", "SUCCEEDED", "CANCELING", "CANCELED", "NEEDS_ATTENTION", 'UNKNOWN_ENUM_VALUE'.
            Any unrecognized values returned by a service will be mapped to 'UNKNOWN_ENUM_VALUE'.
        :type status: str
        ...
        :type resources: list[oci.ai_language.models.WorkRequestResource]
    ...
    def operation_type(self, operation_type):
        ...
        :type: str
        """
        allowed_values = ["CREATE_MODEL", "UPDATE_MODEL", "DELETE_MODEL", "CREATE_PROJECT", "UPDATE_PROJECT", "DELETE_PROJECT", "CREATE_ENDPOINT", "UPDATE_ENDPOINT", "DELETE_ENDPOINT"]
    ...
    def status(self, status):
        ...
        :type: str
        """
        allowed_values = ["ACCEPTED", "IN_PROGRESS", "FAILED", "WAITING", "SUCCEEDED", "CANCELING", "CANCELED", "NEEDS_ATTENTION"]
    ...
    def resources(self):
        ...
        :rtype: list[oci.ai_language.models.WorkRequestResource]
        """
    ...
    def resources(self, resources):
        ...
        :type: list[oci.ai_language.models.WorkRequestResource]
        """
