...
class WorkRequestSummary(object):
    ...
    OPERATION_TYPE_CREATE_TABLE = "CREATE_TABLE"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "UPDATE_TABLE"
    OPERATION_TYPE_UPDATE_TABLE = "UPDATE_TABLE"
    ...
    def __init__(self, **kwargs):
        ...
        :type resources: list[oci.nosql.models.WorkRequestResource]
    ...
    def resources(self):
        ...
        **[Required]** Gets the resources of this WorkRequestSummary.
        ...
        :rtype: list[oci.nosql.models.WorkRequestResource]
        """
    ...
    def resources(self, resources):
        ...
        :type: list[oci.nosql.models.WorkRequestResource]
        """
