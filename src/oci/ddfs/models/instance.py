...
class Instance(object):
    ...
    def __init__(self, **kwargs):
        ...
        :param idcs_url:
            The value to assign to the idcs_url property of this Instance.
        :type idcs_url: str

        :param public_ip:
            The value to assign to the public_ip property of this Instance.
        :type public_ip: str

        :param fhir_service_endpoint:
            The value to assign to the fhir_service_endpoint property of this Instance.
        :type fhir_service_endpoint: str
        ...
        :param time_updated:
            The value to assign to the time_updated property of this Instance.
        ...
        :param lifecycle_details:
            The value to assign to the lifecycle_details property of this Instance.
        ...
        self._fhir_service_endpoint = None
    ...
    def display_name(self):
        """
        **[Required]** Gets the display_name of this Instance.
    ...
    def idcs_url(self):
        """
        **[Required]** Gets the idcs_url of this Instance.
        ...
        :return: The idcs_url of this Instance.
        :rtype: str
        """
    ...
    def idcs_url(self, idcs_url):
        """
        Sets the idcs_url of this Instance.
        The Oracle Identity Cloud Service (IDCS) URL for the identity domain associated with the instance.
        Use the IDCS tenant URL from your identity domain configuration.
        ...
        :param idcs_url: The idcs_url of this Instance.
        :type: str
        """
    ...
    def public_ip(self):
        """
        Gets the public_ip of this Instance.
        The public IP address for the instance's FHIR service endpoint.


        :return: The public_ip of this Instance.
        :rtype: str
        """
    ...
    def public_ip(self, public_ip):
        """
        Sets the public_ip of this Instance.
        The public IP address for the instance's FHIR service endpoint.


        :param public_ip: The public_ip of this Instance.
        :type: str
        """
        self._public_ip = public_ip

    @property
    def fhir_service_endpoint(self):
        """
        Gets the fhir_service_endpoint of this Instance.
        ...
        :return: The fhir_service_endpoint of this Instance.
        :rtype: str
        """
        return self._fhir_service_endpoint

    @fhir_service_endpoint.setter
    def fhir_service_endpoint(self, fhir_service_endpoint):
        """
        Sets the fhir_service_endpoint of this Instance.
        The HTTPS endpoint for the instance's Fast Healthcare Interoperability Resources (FHIR) service.

        Example: `https://example.ddfs.oraclecloud.com/api/fhir`


        :param fhir_service_endpoint: The fhir_service_endpoint of this Instance.
        :type: str
        """
        self._fhir_service_endpoint = fhir_service_endpoint
    ...
    def time_updated(self):
        """
        Gets the time_updated of this Instance.
        ...
        :return: The time_updated of this Instance.
        :rtype: datetime
        """
    ...
    def time_updated(self, time_updated):
        """
        Sets the time_updated of this Instance.
        The date and time the Instance was updated, in the format defined by `RFC 3339`__.
        ...
        :param time_updated: The time_updated of this Instance.
        :type: datetime
        """
    ...
    def lifecycle_details(self, lifecycle_details):
        """
        Sets the lifecycle_details of this Instance.
        A message that describes the current state of the Instance in more detail. For example,
        can be used to provide actionable information for a resource in the Failed state.


        :param lifecycle_details: The lifecycle_details of this Instance.
        :type: str
        """
    ...
    def freeform_tags(self):
        """
        **[Required]** Gets the freeform_tags of this Instance.
    ...
    def defined_tags(self):
        """
        **[Required]** Gets the defined_tags of this Instance.
