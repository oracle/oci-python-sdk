...
class WorkRequestErrorCollection(object):
    ...
    def __init__(self, **kwargs):
        ...
        :type items: list[oci.ai_anomaly_detection.models.WorkRequestError]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this WorkRequestErrorCollection.
        ...
        :rtype: list[oci.ai_anomaly_detection.models.WorkRequestError]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.ai_anomaly_detection.models.WorkRequestError]
        """
        self._items = items
