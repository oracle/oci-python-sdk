...
class ObjectListInputJobDetails(InputJobDetails):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ObjectListInputJobDetails object with values from keyword arguments. The default value of the :py:attr:`~oci.ai_anomaly_detection.models.ObjectListInputJobDetails.input_type` attribute
        of this class is ``OBJECT_LIST`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param input_type:
            The value to assign to the input_type property of this ObjectListInputJobDetails.
            Allowed values for this property are: "INLINE", "OBJECT_LIST"
        :type input_type: str

        :param object_locations:
            The value to assign to the object_locations property of this ObjectListInputJobDetails.
    ...
    def object_locations(self):
        """
        **[Required]** Gets the object_locations of this ObjectListInputJobDetails.
        List of ObjectLocations.


        :return: The object_locations of this ObjectListInputJobDetails.
    ...
    def object_locations(self, object_locations):
        """
        Sets the object_locations of this ObjectListInputJobDetails.
        List of ObjectLocations.


        :param object_locations: The object_locations of this ObjectListInputJobDetails.
