...
class DataAssetCollection(object):
    ...
    def __init__(self, **kwargs):
        ...
        :type items: list[oci.ai_anomaly_detection.models.DataAssetSummary]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this DataAssetCollection.
        ...
        :rtype: list[oci.ai_anomaly_detection.models.DataAssetSummary]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.ai_anomaly_detection.models.DataAssetSummary]
        """
        self._items = items
