...
class WorkRequest(object):
    ...
    def __init__(self, **kwargs):
        ...
        :param operation_type:
            ...
            Allowed values for this property are: "CREATE_MODEL", "UPDATE_MODEL", "DELETE_MODEL", "CREATE_PRIVATE_ENDPOINT", "DELETE_PRIVATE_ENDPOINT", "UPDATE_PRIVATE_ENDPOINT", "MOVE_PRIVATE_ENDPOINT", 'UNKNOWN_ENUM_VALUE'.
            Any unrecognized values returned by a service will be mapped to 'UNKNOWN_ENUM_VALUE'.
        :type operation_type: str

        :param status:
            The value to assign to the status property of this WorkRequest.
            Allowed values for this property are: "ACCEPTED", "IN_PROGRESS", "FAILED", "WAITING", "SUCCEEDED", "CANCELING", "CANCELED", 'UNKNOWN_ENUM_VALUE'.
            Any unrecognized values returned by a service will be mapped to 'UNKNOWN_ENUM_VALUE'.
        :type status: str
        ...
        :type resources: list[oci.ai_anomaly_detection.models.WorkRequestResource]
    ...
    def operation_type(self, operation_type):
        ...
        :type: str
        """
        allowed_values = ["CREATE_MODEL", "UPDATE_MODEL", "DELETE_MODEL", "CREATE_PRIVATE_ENDPOINT", "DELETE_PRIVATE_ENDPOINT", "UPDATE_PRIVATE_ENDPOINT", "MOVE_PRIVATE_ENDPOINT"]
    ...
    def status(self, status):
        ...
        :type: str
        """
        allowed_values = ["ACCEPTED", "IN_PROGRESS", "FAILED", "WAITING", "SUCCEEDED", "CANCELING", "CANCELED"]
    ...
    def resources(self):
        ...
        **[Required]** Gets the resources of this WorkRequest.
        ...
        :rtype: list[oci.ai_anomaly_detection.models.WorkRequestResource]
        """
    ...
    def resources(self, resources):
        ...
        :type: list[oci.ai_anomaly_detection.models.WorkRequestResource]
        """
