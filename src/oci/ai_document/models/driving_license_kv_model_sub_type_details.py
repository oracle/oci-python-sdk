...
class DrivingLicenseKvModelSubTypeDetails(object):
    """
    Driving licence KV model sub type details
    """

    #: A constant which can be used with the model_sub_type property of a DrivingLicenseKvModelSubTypeDetails.
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new DrivingLicenseKvModelSubTypeDetails object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param model_sub_type:
            The value to assign to the model_sub_type property of this DrivingLicenseKvModelSubTypeDetails.
    ...
    def model_sub_type(self):
        """
        **[Required]** Gets the model_sub_type of this DrivingLicenseKvModelSubTypeDetails.
        ...
        :return: The model_sub_type of this DrivingLicenseKvModelSubTypeDetails.
        :rtype: str
        """
    ...
    def model_sub_type(self, model_sub_type):
        """
        Sets the model_sub_type of this DrivingLicenseKvModelSubTypeDetails.
        The model sub type for KEY_VALUE_EXTRACTION
        The allowed values are:
        - `RECEIPT`
        - `INVOICE`
        ...
        :param model_sub_type: The model_sub_type of this DrivingLicenseKvModelSubTypeDetails.
        :type: str
        """
