...
class ValueString(FieldValue):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ValueString object with values from keyword arguments. The default value of the :py:attr:`~oci.ai_document.models.ValueString.value_type` attribute
