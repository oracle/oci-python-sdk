...
class ReceiptKvModelSubTypeDetails(object):
    """
    Receipt KV model sub type details
    """

    #: A constant which can be used with the model_sub_type property of a ReceiptKvModelSubTypeDetails.
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ReceiptKvModelSubTypeDetails object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param model_sub_type:
            The value to assign to the model_sub_type property of this ReceiptKvModelSubTypeDetails.
    ...
    def model_sub_type(self):
        """
        **[Required]** Gets the model_sub_type of this ReceiptKvModelSubTypeDetails.
        ...
        :return: The model_sub_type of this ReceiptKvModelSubTypeDetails.
        :rtype: str
        """
    ...
    def model_sub_type(self, model_sub_type):
        """
        Sets the model_sub_type of this ReceiptKvModelSubTypeDetails.
        The model sub type for KEY_VALUE_EXTRACTION
        The allowed values are:
        - `RECEIPT`
        - `INVOICE`
        ...
        :param model_sub_type: The model_sub_type of this ReceiptKvModelSubTypeDetails.
        :type: str
        """
