...
class ValuePhoneNumber(FieldValue):
    ...
    def __init__(self, **kwargs):
        ...
        :param normalized_value:
            The value to assign to the normalized_value property of this ValuePhoneNumber.
        :type normalized_value: str

        :param normalized_confidence:
            The value to assign to the normalized_confidence property of this ValuePhoneNumber.
