...
class DocumentLanguageClassificationFeature(DocumentFeature):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new DocumentLanguageClassificationFeature object with values from keyword arguments. The default value of the :py:attr:`~oci.ai_document.models.DocumentLanguageClassificationFeature.feature_type` attribute
