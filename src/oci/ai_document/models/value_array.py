...
class ValueArray(FieldValue):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ValueArray object with values from keyword arguments. The default value of the :py:attr:`~oci.ai_document.models.ValueArray.value_type` attribute
