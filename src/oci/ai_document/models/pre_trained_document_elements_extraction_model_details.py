...
class PreTrainedDocumentElementsExtractionModelDetails(ModelMetrics):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new PreTrainedDocumentElementsExtractionModelDetails object with values from keyword arguments. The default value of the :py:attr:`~oci.ai_document.models.PreTrainedDocumentElementsExtractionModelDetails.model_type` attribute
        of this class is ``PRE_TRAINED_DOCUMENT_ELEMENTS_EXTRACTION`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param model_type:
            The value to assign to the model_type property of this PreTrainedDocumentElementsExtractionModelDetails.
        ...
        :param dataset_summary:
            The value to assign to the dataset_summary property of this PreTrainedDocumentElementsExtractionModelDetails.
