...
class DataScienceLabelingDataset(Dataset):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new DataScienceLabelingDataset object with values from keyword arguments. The default value of the :py:attr:`~oci.ai_document.models.DataScienceLabelingDataset.dataset_type` attribute
