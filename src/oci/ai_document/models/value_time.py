...
class ValueTime(FieldValue):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ValueTime object with values from keyword arguments. The default value of the :py:attr:`~oci.ai_document.models.ValueTime.value_type` attribute
