...
class ObjectStorageDataset(Dataset):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ObjectStorageDataset object with values from keyword arguments. The default value of the :py:attr:`~oci.ai_document.models.ObjectStorageDataset.dataset_type` attribute
