...
class NoneSourceDetails(SourceDetails):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new NoneSourceDetails object with values from keyword arguments. The default value of the :py:attr:`~oci.psql.models.NoneSourceDetails.source_type` attribute
