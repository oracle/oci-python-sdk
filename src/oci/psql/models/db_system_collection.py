...
class DbSystemCollection(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new DbSystemCollection object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param items:
            The value to assign to the items property of this DbSystemCollection.
        :type items: list[oci.psql.models.DbSystemSummary]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this DbSystemCollection.
        ...
        :rtype: list[oci.psql.models.DbSystemSummary]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.psql.models.DbSystemSummary]
        """
        self._items = items
