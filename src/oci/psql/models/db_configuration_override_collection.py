...
class DbConfigurationOverrideCollection(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new DbConfigurationOverrideCollection object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param items:
            The value to assign to the items property of this DbConfigurationOverrideCollection.
        :type items: list[oci.psql.models.ConfigOverrides]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this DbConfigurationOverrideCollection.
        ...
        :rtype: list[oci.psql.models.ConfigOverrides]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.psql.models.ConfigOverrides]
        """
        self._items = items
