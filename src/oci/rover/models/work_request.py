...
class WorkRequest(object):
    ...
    def __init__(self, **kwargs):
        ...
        :param status_details:
            The value to assign to the status_details property of this WorkRequest.
    ...
    def status_details(self):
        """
        Gets the status_details of this WorkRequest.
        The fine-grained sub-state of a work request.


        :return: The status_details of this WorkRequest.
        :rtype: str
        """
    ...
    def status_details(self, status_details):
        """
        Sets the status_details of this WorkRequest.
        The fine-grained sub-state of a work request.


        :param status_details: The status_details of this WorkRequest.
        :type: str
        """
