...
class ShapeCollection(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ShapeCollection object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param items:
            The value to assign to the items property of this ShapeCollection.
        :type items: list[oci.rover.models.ShapeSummary]

        """
        self.swagger_types = {
            'items': 'list[ShapeSummary]'
        }
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this ShapeCollection.
        ...
        :rtype: list[oci.rover.models.ShapeSummary]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.rover.models.ShapeSummary]
        """
        self._items = items
