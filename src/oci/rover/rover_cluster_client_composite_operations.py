...
class RoverClusterClientCompositeOperations(object):
    ...
    def delete_rover_cluster_and_wait_for_state(self, rover_cluster_id, wait_for_states=[], operation_kwargs={}, waiter_kwargs={}):
        ...
        try:
            if ("succeed_on_not_found" in waiter_kwargs) and (waiter_kwargs["succeed_on_not_found"] is False):
                self.client.base_client.logger.warning("The waiter kwarg succeed_on_not_found was passed as False for the delete composite operation delete_rover_cluster, this would result in the operation to fail if the resource is not found! Please, do not pass this kwarg if this was not intended")
            else:
                """
    ...
    def request_additional_nodes_and_wait_for_state(self, rover_cluster_id, request_additional_nodes_details, wait_for_states=[], operation_kwargs={}, waiter_kwargs={}):
        """
        Calls :py:func:`~oci.rover.RoverClusterClient.request_additional_nodes` and waits for the :py:class:`~oci.rover.models.WorkRequest`
        to enter the given state(s).
        ...
        :param dict operation_kwargs:
            A dictionary of keyword arguments to pass to :py:func:`~oci.rover.RoverClusterClient.request_additional_nodes`
