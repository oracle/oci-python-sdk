...
class HttpEndpointBearerAuthScopeConfig(HttpEndpointAuthScopeConfig):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new HttpEndpointBearerAuthScopeConfig object with values from keyword arguments. The default value of the :py:attr:`~oci.generative_ai_agent.models.HttpEndpointBearerAuthScopeConfig.http_endpoint_auth_scope_config_type` attribute
        of this class is ``HTTP_ENDPOINT_BEARER_AUTH_SCOPE_CONFIG`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param http_endpoint_auth_scope_config_type:
            The value to assign to the http_endpoint_auth_scope_config_type property of this HttpEndpointBearerAuthScopeConfig.
        ...
        :param vault_secret_id:
            The value to assign to the vault_secret_id property of this HttpEndpointBearerAuthScopeConfig.
        ...
        self._http_endpoint_auth_scope_config_type = 'HTTP_ENDPOINT_BEARER_AUTH_SCOPE_CONFIG'

    @property
    def vault_secret_id(self):
        """
        Gets the vault_secret_id of this HttpEndpointBearerAuthScopeConfig.
        The OCID of the vault secret with the bearer token.
        Required when `authScope` is AGENT.


        :return: The vault_secret_id of this HttpEndpointBearerAuthScopeConfig.
        :rtype: str
        """
    ...
    def vault_secret_id(self, vault_secret_id):
        """
        Sets the vault_secret_id of this HttpEndpointBearerAuthScopeConfig.
        The OCID of the vault secret with the bearer token.
        Required when `authScope` is AGENT.


        :param vault_secret_id: The vault_secret_id of this HttpEndpointBearerAuthScopeConfig.
        :type: str
        """
