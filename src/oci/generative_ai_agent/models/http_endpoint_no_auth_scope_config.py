...
class HttpEndpointNoAuthScopeConfig(HttpEndpointAuthScopeConfig):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new HttpEndpointNoAuthScopeConfig object with values from keyword arguments. The default value of the :py:attr:`~oci.generative_ai_agent.models.HttpEndpointNoAuthScopeConfig.http_endpoint_auth_scope_config_type` attribute
        of this class is ``HTTP_ENDPOINT_NO_AUTH_SCOPE_CONFIG`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param http_endpoint_auth_scope_config_type:
            The value to assign to the http_endpoint_auth_scope_config_type property of this HttpEndpointNoAuthScopeConfig.
        ...
        self._http_endpoint_auth_scope_config_type = 'HTTP_ENDPOINT_NO_AUTH_SCOPE_CONFIG'
