...
class AgentCollection(object):
    ...
    def __init__(self, **kwargs):
        ...
        :type items: list[oci.generative_ai_agent.models.AgentSummary]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this AgentCollection.
        ...
        :rtype: list[oci.generative_ai_agent.models.AgentSummary]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.generative_ai_agent.models.AgentSummary]
        """
        self._items = items
