...
class GenerativeAiAgentClientCompositeOperations(object):
    ...
    def change_provisioned_capacity_compartment_and_wait_for_state(self, provisioned_capacity_id, change_provisioned_capacity_compartment_details, wait_for_states=[], operation_kwargs={}, waiter_kwargs={}):
        """
        Calls :py:func:`~oci.generative_ai_agent.GenerativeAiAgentClient.change_provisioned_capacity_compartment` and waits for the :py:class:`~oci.generative_ai_agent.models.WorkRequest`
        to enter the given state(s).
        ...
        :param dict operation_kwargs:
            A dictionary of keyword arguments to pass to :py:func:`~oci.generative_ai_agent.GenerativeAiAgentClient.change_provisioned_capacity_compartment`

        :param dict waiter_kwargs:
            A dictionary of keyword arguments to pass to the :py:func:`oci.wait_until` function. For example, you could pass ``max_interval_seconds`` or ``max_interval_seconds``
            as dictionary keys to modify how long the waiter function will wait between retries and the maximum amount of time it will wait
        """
        operation_result = self.client.change_provisioned_capacity_compartment(provisioned_capacity_id, change_provisioned_capacity_compartment_details, **operation_kwargs)
        if not wait_for_states:
            return operation_result
        lowered_wait_for_states = [w.lower() for w in wait_for_states]
        if 'opc-work-request-id' not in operation_result.headers:
    ...
    def create_provisioned_capacity_and_wait_for_state(self, create_provisioned_capacity_details, wait_for_states=[], operation_kwargs={}, waiter_kwargs={}):
        """
        Calls :py:func:`~oci.generative_ai_agent.GenerativeAiAgentClient.create_provisioned_capacity` and waits for the :py:class:`~oci.generative_ai_agent.models.WorkRequest`
        to enter the given state(s).
        ...
        :param dict operation_kwargs:
            A dictionary of keyword arguments to pass to :py:func:`~oci.generative_ai_agent.GenerativeAiAgentClient.create_provisioned_capacity`

        :param dict waiter_kwargs:
            A dictionary of keyword arguments to pass to the :py:func:`oci.wait_until` function. For example, you could pass ``max_interval_seconds`` or ``max_interval_seconds``
            as dictionary keys to modify how long the waiter function will wait between retries and the maximum amount of time it will wait
        """
        operation_result = self.client.create_provisioned_capacity(create_provisioned_capacity_details, **operation_kwargs)
        if not wait_for_states:
            return operation_result
        lowered_wait_for_states = [w.lower() for w in wait_for_states]
        if 'opc-work-request-id' not in operation_result.headers:
    ...
    def create_tool_and_wait_for_state(self, create_tool_details, wait_for_states=[], operation_kwargs={}, waiter_kwargs={}):
        """
        Calls :py:func:`~oci.generative_ai_agent.GenerativeAiAgentClient.create_tool` and waits for the :py:class:`~oci.generative_ai_agent.models.WorkRequest`
        to enter the given state(s).
        ...
        :param dict operation_kwargs:
            A dictionary of keyword arguments to pass to :py:func:`~oci.generative_ai_agent.GenerativeAiAgentClient.create_tool`

        :param dict waiter_kwargs:
            A dictionary of keyword arguments to pass to the :py:func:`oci.wait_until` function. For example, you could pass ``max_interval_seconds`` or ``max_interval_seconds``
            as dictionary keys to modify how long the waiter function will wait between retries and the maximum amount of time it will wait
        """
        operation_result = self.client.create_tool(create_tool_details, **operation_kwargs)
        if not wait_for_states:
            return operation_result
        lowered_wait_for_states = [w.lower() for w in wait_for_states]
        if 'opc-work-request-id' not in operation_result.headers:
    ...
    def delete_provisioned_capacity_and_wait_for_state(self, provisioned_capacity_id, wait_for_states=[], operation_kwargs={}, waiter_kwargs={}):
        """
        Calls :py:func:`~oci.generative_ai_agent.GenerativeAiAgentClient.delete_provisioned_capacity` and waits for the :py:class:`~oci.generative_ai_agent.models.WorkRequest`
        to enter the given state(s).
        ...
        :param dict operation_kwargs:
            A dictionary of keyword arguments to pass to :py:func:`~oci.generative_ai_agent.GenerativeAiAgentClient.delete_provisioned_capacity`
        ...
        operation_result = None
        try:
            operation_result = self.client.delete_provisioned_capacity(provisioned_capacity_id, **operation_kwargs)
        except oci.exceptions.ServiceError as e:
            if e.status == 404:
                return WAIT_RESOURCE_NOT_FOUND
            else:
    ...
    def delete_tool_and_wait_for_state(self, tool_id, wait_for_states=[], operation_kwargs={}, waiter_kwargs={}):
        """
        Calls :py:func:`~oci.generative_ai_agent.GenerativeAiAgentClient.delete_tool` and waits for the :py:class:`~oci.generative_ai_agent.models.WorkRequest`
        to enter the given state(s).
        ...
        :param dict operation_kwargs:
            A dictionary of keyword arguments to pass to :py:func:`~oci.generative_ai_agent.GenerativeAiAgentClient.delete_tool`
        ...
        operation_result = None
        try:
            operation_result = self.client.delete_tool(tool_id, **operation_kwargs)
        except oci.exceptions.ServiceError as e:
            if e.status == 404:
                return WAIT_RESOURCE_NOT_FOUND
            else:
    ...
    def update_provisioned_capacity_and_wait_for_state(self, provisioned_capacity_id, update_provisioned_capacity_details, wait_for_states=[], operation_kwargs={}, waiter_kwargs={}):
        """
        Calls :py:func:`~oci.generative_ai_agent.GenerativeAiAgentClient.update_provisioned_capacity` and waits for the :py:class:`~oci.generative_ai_agent.models.WorkRequest`
        to enter the given state(s).
        ...
        :param dict operation_kwargs:
            A dictionary of keyword arguments to pass to :py:func:`~oci.generative_ai_agent.GenerativeAiAgentClient.update_provisioned_capacity`

        :param dict waiter_kwargs:
            A dictionary of keyword arguments to pass to the :py:func:`oci.wait_until` function. For example, you could pass ``max_interval_seconds`` or ``max_interval_seconds``
            as dictionary keys to modify how long the waiter function will wait between retries and the maximum amount of time it will wait
        """
        operation_result = self.client.update_provisioned_capacity(provisioned_capacity_id, update_provisioned_capacity_details, **operation_kwargs)
        if not wait_for_states:
            return operation_result
        lowered_wait_for_states = [w.lower() for w in wait_for_states]
        if 'opc-work-request-id' not in operation_result.headers:
    ...
    def update_tool_and_wait_for_state(self, tool_id, update_tool_details, wait_for_states=[], operation_kwargs={}, waiter_kwargs={}):
        """
        Calls :py:func:`~oci.generative_ai_agent.GenerativeAiAgentClient.update_tool` and waits for the :py:class:`~oci.generative_ai_agent.models.WorkRequest`
        to enter the given state(s).
        ...
        :param dict operation_kwargs:
            A dictionary of keyword arguments to pass to :py:func:`~oci.generative_ai_agent.GenerativeAiAgentClient.update_tool`

        :param dict waiter_kwargs:
            A dictionary of keyword arguments to pass to the :py:func:`oci.wait_until` function. For example, you could pass ``max_interval_seconds`` or ``max_interval_seconds``
            as dictionary keys to modify how long the waiter function will wait between retries and the maximum amount of time it will wait
        """
        operation_result = self.client.update_tool(tool_id, update_tool_details, **operation_kwargs)
        if not wait_for_states:
            return operation_result
        lowered_wait_for_states = [w.lower() for w in wait_for_states]
        if 'opc-work-request-id' not in operation_result.headers:
