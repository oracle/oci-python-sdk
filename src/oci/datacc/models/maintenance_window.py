...
class MaintenanceWindow(object):
    ...
    #: A constant which can be used with the months property of a MaintenanceWindow.
    ...
    #: A constant which can be used with the days_of_week property of a MaintenanceWindow.
    ...
    def __init__(self, **kwargs):
        ...
        :param months:
            ...
            Allowed values for items in this list are: "JANUARY", "FEBRUARY", "MARCH", "APRIL", "MAY", "JUNE", "JULY", "AUGUST", "SEPTEMBER", "OCTOBER", "NOVEMBER", "DECEMBER", 'UNKNOWN_ENUM_VALUE'.
            Any unrecognized values returned by a service will be mapped to 'UNKNOWN_ENUM_VALUE'.
        ...
        :param days_of_week:
            ...
            Allowed values for items in this list are: "MONDAY", "TUESDAY", "WEDNESDAY", "THURSDAY", "FRIDAY", "SATURDAY", "SUNDAY", 'UNKNOWN_ENUM_VALUE'.
            Any unrecognized values returned by a service will be mapped to 'UNKNOWN_ENUM_VALUE'.
    ...
    def patching_mode(self):
        ...
        *IMPORTANT*: Non-rolling infrastructure patching involves system down time.
        See `Oracle-Managed Database Infrastructure Maintenance Updates`__
    ...
    def months(self, months):
        ...
        if months:
            months[:] = ['UNKNOWN_ENUM_VALUE' if not value_allowed_none_or_none_sentinel(x, allowed_values) else x for x in months]
        self._months = months
    ...
    def days_of_week(self, days_of_week):
        ...
        if days_of_week:
            days_of_week[:] = ['UNKNOWN_ENUM_VALUE' if not value_allowed_none_or_none_sentinel(x, allowed_values) else x for x in days_of_week]
