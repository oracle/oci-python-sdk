...
class WorkRequestResource(object):
    ...
    def __init__(self, **kwargs):
        ...
        :param action_type:
            ...
            Allowed values for this property are: "CREATED", "UPDATED", "DELETED", "IN_PROGRESS", "FAILED", "RELATED", "CANCELED_CREATE", "CANCELED_UPDATE", "CANCELED_DELETE", 'UNKNOWN_ENUM_VALUE'.
    ...
    def action_type(self, action_type):
        ...
        :type: str
        """
        allowed_values = ["CREATED", "UPDATED", "DELETED", "IN_PROGRESS", "FAILED", "RELATED", "CANCELED_CREATE", "CANCELED_UPDATE", "CANCELED_DELETE"]
    ...
    def identifier(self):
        ...
        **[Required]** Gets the identifier of this WorkRequestResource.
        The `OCID`__ of the resource being acted on by the work request.
