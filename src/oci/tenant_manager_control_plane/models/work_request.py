...
class WorkRequest(object):
    ...
    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "SELF_OPT_IN"
    OPERATION_TYPE_SELF_OPT_IN = "SELF_OPT_IN"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "SELF_OPT_OUT"
    OPERATION_TYPE_SELF_OPT_OUT = "SELF_OPT_OUT"
