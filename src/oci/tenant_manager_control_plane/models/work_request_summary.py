...
class WorkRequestSummary(object):
    ...
    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "STANDALONE_TENANCY_TERMINATION_REQUEST"
    OPERATION_TYPE_STANDALONE_TENANCY_TERMINATION_REQUEST = "STANDALONE_TENANCY_TERMINATION_REQUEST"
    ...
    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "ORDER_PAYLOADS_BACKFILL_ETL"
    OPERATION_TYPE_ORDER_PAYLOADS_BACKFILL_ETL = "ORDER_PAYLOADS_BACKFILL_ETL"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "PUBLISH_TO_TOPIC"
    OPERATION_TYPE_PUBLISH_TO_TOPIC = "PUBLISH_TO_TOPIC"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "TERMINATE_LINK"
    OPERATION_TYPE_TERMINATE_LINK = "TERMINATE_LINK"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "TRANSFER_SUBSCRIPTION"
    OPERATION_TYPE_TRANSFER_SUBSCRIPTION = "TRANSFER_SUBSCRIPTION"
