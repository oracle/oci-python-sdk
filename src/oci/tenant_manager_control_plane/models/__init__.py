...
from .assigned_subscription_line_item_summary import AssignedSubscriptionLineItemSummary
...
from .classic_assigned_subscription import ClassicAssignedSubscription
from .classic_assigned_subscription_summary import ClassicAssignedSubscriptionSummary
from .classic_subscription import ClassicSubscription
from .classic_subscription_summary import ClassicSubscriptionSummary
from .cloud_assigned_subscription import CloudAssignedSubscription
from .cloud_assigned_subscription_summary import CloudAssignedSubscriptionSummary
from .cloud_subscription import CloudSubscription
from .cloud_subscription_summary import CloudSubscriptionSummary
...
from .subscription_line_item_collection import SubscriptionLineItemCollection
from .subscription_line_item_summary import SubscriptionLineItemSummary
...
tenant_manager_control_plane_type_mapping = {
    ...
    "AssignedSubscriptionLineItemSummary": AssignedSubscriptionLineItemSummary,
    ...
    "ClassicAssignedSubscription": ClassicAssignedSubscription,
    "ClassicAssignedSubscriptionSummary": ClassicAssignedSubscriptionSummary,
    "ClassicSubscription": ClassicSubscription,
    "ClassicSubscriptionSummary": ClassicSubscriptionSummary,
    "CloudAssignedSubscription": CloudAssignedSubscription,
    "CloudAssignedSubscriptionSummary": CloudAssignedSubscriptionSummary,
    "CloudSubscription": CloudSubscription,
    "CloudSubscriptionSummary": CloudSubscriptionSummary,
    ...
    "SubscriptionLineItemCollection": SubscriptionLineItemCollection,
    "SubscriptionLineItemSummary": SubscriptionLineItemSummary,
