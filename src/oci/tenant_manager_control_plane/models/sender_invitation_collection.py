...
class SenderInvitationCollection(object):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new SenderInvitationCollection object with values from keyword arguments.
        ...
        """
        self.swagger_types = {
            'items': 'list[SenderInvitationSummary]'
        }
    ...
    def items(self):
        """
        **[Required]** Gets the items of this SenderInvitationCollection.
    ...
    def items(self, items):
        """
        Sets the items of this SenderInvitationCollection.
        Array containing SenderInvitationSummary items.
