...
class SenderInvitationSummary(object):
    """
    The summary of the invitation model that the sender owns.
    """

    #: A constant which can be used with the lifecycle_state property of a SenderInvitationSummary.
    ...
    def __init__(self, **kwargs):
        ...
        :param id:
            The value to assign to the id property of this SenderInvitationSummary.
        :type id: str

        :param compartment_id:
            The value to assign to the compartment_id property of this SenderInvitationSummary.
        ...
        :param recipient_tenancy_id:
            The value to assign to the recipient_tenancy_id property of this SenderInvitationSummary.
        :type recipient_tenancy_id: str

        :param lifecycle_state:
            The value to assign to the lifecycle_state property of this SenderInvitationSummary.
        ...
        :param time_created:
            The value to assign to the time_created property of this SenderInvitationSummary.
        :type time_created: datetime

        :param time_updated:
            The value to assign to the time_updated property of this SenderInvitationSummary.
        ...
        :param defined_tags:
            The value to assign to the defined_tags property of this SenderInvitationSummary.
        :type defined_tags: dict(str, dict(str, object))

        :param system_tags:
            The value to assign to the system_tags property of this SenderInvitationSummary.
    ...
    def id(self):
        """
        **[Required]** Gets the id of this SenderInvitationSummary.
        OCID of the sender invitation.


        :return: The id of this SenderInvitationSummary.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        """
        Sets the id of this SenderInvitationSummary.
        OCID of the sender invitation.


        :param id: The id of this SenderInvitationSummary.
        :type: str
        """
        self._id = id
    ...
    def compartment_id(self):
        """
        **[Required]** Gets the compartment_id of this SenderInvitationSummary.
        OCID of the sender tenancy.


        :return: The compartment_id of this SenderInvitationSummary.
        :rtype: str
        """
    ...
    def compartment_id(self, compartment_id):
        """
        Sets the compartment_id of this SenderInvitationSummary.
        OCID of the sender tenancy.


        :param compartment_id: The compartment_id of this SenderInvitationSummary.
        :type: str
        """
    ...
    def recipient_invitation_id(self):
        """
        Gets the recipient_invitation_id of this SenderInvitationSummary.
        OCID of the corresponding recipient invitation.


        :return: The recipient_invitation_id of this SenderInvitationSummary.
        :rtype: str
        """
    ...
    def recipient_invitation_id(self, recipient_invitation_id):
        """
        Sets the recipient_invitation_id of this SenderInvitationSummary.
        OCID of the corresponding recipient invitation.


        :param recipient_invitation_id: The recipient_invitation_id of this SenderInvitationSummary.
        :type: str
        """
    ...
    def recipient_tenancy_id(self):
        """
        **[Required]** Gets the recipient_tenancy_id of this SenderInvitationSummary.
        OCID of the recipient tenancy.


        :return: The recipient_tenancy_id of this SenderInvitationSummary.
        :rtype: str
        """
    ...
    def recipient_tenancy_id(self, recipient_tenancy_id):
        """
        Sets the recipient_tenancy_id of this SenderInvitationSummary.
        OCID of the recipient tenancy.


        :param recipient_tenancy_id: The recipient_tenancy_id of this SenderInvitationSummary.
        :type: str
        """
    ...
    def lifecycle_state(self):
        """
        **[Required]** Gets the lifecycle_state of this SenderInvitationSummary.
        ...
        :return: The lifecycle_state of this SenderInvitationSummary.
        :rtype: str
        """
    ...
    def lifecycle_state(self, lifecycle_state):
        """
        Sets the lifecycle_state of this SenderInvitationSummary.
        Lifecycle state of the sender invitation.


        :param lifecycle_state: The lifecycle_state of this SenderInvitationSummary.
        :type: str
        """
    ...
    def status(self):
        ...
        **[Required]** Gets the status of this SenderInvitationSummary.
        ...
        :return: The status of this SenderInvitationSummary.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """
        Sets the status of this SenderInvitationSummary.
        Status of the sender invitation.
    ...
    def recipient_email_address(self):
        """
        Gets the recipient_email_address of this SenderInvitationSummary.
        Email address of the recipient.


        :return: The recipient_email_address of this SenderInvitationSummary.
        :rtype: str
        """
    ...
    def recipient_email_address(self, recipient_email_address):
        """
        Sets the recipient_email_address of this SenderInvitationSummary.
        Email address of the recipient.


        :param recipient_email_address: The recipient_email_address of this SenderInvitationSummary.
        :type: str
        """
    ...
    def freeform_tags(self):
        """
        Gets the freeform_tags of this SenderInvitationSummary.
        Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only.
        Example: `{\"bar-key\": \"value\"}`


        :return: The freeform_tags of this SenderInvitationSummary.
        :rtype: dict(str, str)
        """
    ...
    def freeform_tags(self, freeform_tags):
        """
        Sets the freeform_tags of this SenderInvitationSummary.
        Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only.
        Example: `{\"bar-key\": \"value\"}`


        :param freeform_tags: The freeform_tags of this SenderInvitationSummary.
        :type: dict(str, str)
        """
    ...
    def defined_tags(self):
        """
        Gets the defined_tags of this SenderInvitationSummary.
        Defined tags for this resource. Each key is predefined and scoped to a namespace.
        Example: `{\"foo-namespace\": {\"bar-key\": \"value\"}}`


        :return: The defined_tags of this SenderInvitationSummary.
    ...
    def defined_tags(self, defined_tags):
        """
        Sets the defined_tags of this SenderInvitationSummary.
        Defined tags for this resource. Each key is predefined and scoped to a namespace.
        Example: `{\"foo-namespace\": {\"bar-key\": \"value\"}}`


        :param defined_tags: The defined_tags of this SenderInvitationSummary.
    ...
    def system_tags(self):
        """
        Gets the system_tags of this SenderInvitationSummary.
        Usage of system tag keys. These predefined keys are scoped to namespaces.
        Example: `{\"orcl-cloud\": {\"free-tier-retained\": \"true\"}}`


        :return: The system_tags of this SenderInvitationSummary.
        :rtype: dict(str, dict(str, object))
        """
    ...
    def system_tags(self, system_tags):
        """
        Sets the system_tags of this SenderInvitationSummary.
        Usage of system tag keys. These predefined keys are scoped to namespaces.
        Example: `{\"orcl-cloud\": {\"free-tier-retained\": \"true\"}}`


        :param system_tags: The system_tags of this SenderInvitationSummary.
        :type: dict(str, dict(str, object))
        """
