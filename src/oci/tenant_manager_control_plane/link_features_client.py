...
class LinkFeaturesClient(object):
    """
    ...
    def __init__(self, config, **kwargs):
        ...
        self.base_client = BaseClient("link_features", config, signer, tenant_manager_control_plane_type_mapping, **base_client_init_kwargs)
        self.retry_strategy = kwargs.get('retry_strategy')
        self.circuit_breaker_callback = kwargs.get('circuit_breaker_callback')

    def list_link_features(self, compartment_id, **kwargs):
        """
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.tenant_manager_control_plane.models.LinkFeaturesCollection`
        :rtype: :class:`~oci.response.Response`

        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/tenantmanagercontrolplane/list_link_features.py.html>`__ to see an example of how to use list_link_features API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        resource_path = "/linkFeatures"
        method = "GET"
        operation_name = "list_link_features"
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/organizations/20230401/LinkFeaturesCollection/ListLinkFeatures"
        ...
        if extra_kwargs:
            raise ValueError(
                f"list_link_features got unknown kwargs: {extra_kwargs!r}")
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                response_type="LinkFeaturesCollection",
