...
class UpdateManagedInstanceGroupDetails(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new UpdateManagedInstanceGroupDetails object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param display_name:
            The value to assign to the display_name property of this UpdateManagedInstanceGroupDetails.
        ...
        :param defined_tags:
            The value to assign to the defined_tags property of this UpdateManagedInstanceGroupDetails.
    ...
    def freeform_tags(self):
        """
        Gets the freeform_tags of this UpdateManagedInstanceGroupDetails.
    ...
    def freeform_tags(self, freeform_tags):
        """
        Sets the freeform_tags of this UpdateManagedInstanceGroupDetails.
        Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only.
        Example: `{\"bar-key\": \"value\"}`
    ...
    def defined_tags(self):
        """
        Gets the defined_tags of this UpdateManagedInstanceGroupDetails.
    ...
    def defined_tags(self, defined_tags):
        """
        Sets the defined_tags of this UpdateManagedInstanceGroupDetails.
        Defined tags for this resource. Each key is predefined and scoped to a namespace.
        Example: `{\"foo-namespace\": {\"bar-key\": \"value\"}}`
