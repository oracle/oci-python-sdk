...
class InputPort(TypedObject):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new InputPort object with values from keyword arguments. The default value of the :py:attr:`~oci.data_connectivity.models.InputPort.model_type` attribute
