...
class JsonFormatAttribute(AbstractFormatAttribute):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new JsonFormatAttribute object with values from keyword arguments. The default value of the :py:attr:`~oci.data_connectivity.models.JsonFormatAttribute.model_type` attribute
