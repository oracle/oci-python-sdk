...
class FolderSummaryCollection(object):
    ...
    def __init__(self, **kwargs):
        ...
        :type items: list[oci.data_connectivity.models.FolderSummary]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this FolderSummaryCollection.
        ...
        :rtype: list[oci.data_connectivity.models.FolderSummary]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.data_connectivity.models.FolderSummary]
        """
        self._items = items
