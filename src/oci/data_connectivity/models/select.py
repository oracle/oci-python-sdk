...
class Select(PushDownOperation):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new Select object with values from keyword arguments. The default value of the :py:attr:`~oci.data_connectivity.models.Select.model_type` attribute
        ...
        :type select_columns: list[oci.data_connectivity.models.ShapeField]
    ...
    def select_columns(self):
        """
        **[Required]** Gets the select_columns of this Select.
        An array of selected columns.


        :return: The select_columns of this Select.
        :rtype: list[oci.data_connectivity.models.ShapeField]
        """
    ...
    def select_columns(self, select_columns):
        ...
        :type: list[oci.data_connectivity.models.ShapeField]
        """
