...
class ConnectionValidationSummaryCollection(object):
    ...
    def __init__(self, **kwargs):
        ...
        :type items: list[oci.data_connectivity.models.ConnectionValidationSummary]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this ConnectionValidationSummaryCollection.
        ...
        :rtype: list[oci.data_connectivity.models.ConnectionValidationSummary]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.data_connectivity.models.ConnectionValidationSummary]
        """
        self._items = items
