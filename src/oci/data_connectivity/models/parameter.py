...
class Parameter(TypedObject):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new Parameter object with values from keyword arguments. The default value of the :py:attr:`~oci.data_connectivity.models.Parameter.model_type` attribute
        ...
        :type type: oci.data_connectivity.models.BaseType
        ...
        :param output_aggregation_type:
            ...
            Allowed values for this property are: "MIN", "MAX", "COUNT", "SUM"
    ...
    def output_aggregation_type(self, output_aggregation_type):
        ...
        if not value_allowed_none_or_none_sentinel(output_aggregation_type, allowed_values):
            raise ValueError(
                "Invalid value for `output_aggregation_type`, must be None or one of {0}"
