...
class OracleReadAttribute(AbstractReadAttribute):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new OracleReadAttribute object with values from keyword arguments. The default value of the :py:attr:`~oci.data_connectivity.models.OracleReadAttribute.model_type` attribute
