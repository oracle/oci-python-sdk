...
class Shape(TypedObject):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new Shape object with values from keyword arguments. The default value of the :py:attr:`~oci.data_connectivity.models.Shape.model_type` attribute
        ...
        :param model_type:
            ...
            Allowed values for this property are: "SHAPE", "SHAPE_FIELD", "NATIVE_SHAPE_FIELD", 'UNKNOWN_ENUM_VALUE'.
