...
class OperationSummaryCollection(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new OperationSummaryCollection object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param items:
            The value to assign to the items property of this OperationSummaryCollection.
        :type items: list[oci.data_connectivity.models.OperationSummary]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this OperationSummaryCollection.
        ...
        :rtype: list[oci.data_connectivity.models.OperationSummary]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.data_connectivity.models.OperationSummary]
        """
        self._items = items
