...
class EndpointSummaryCollection(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new EndpointSummaryCollection object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param items:
            The value to assign to the items property of this EndpointSummaryCollection.
        :type items: list[oci.data_connectivity.models.EndpointSummary]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this EndpointSummaryCollection.
        ...
        :rtype: list[oci.data_connectivity.models.EndpointSummary]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.data_connectivity.models.EndpointSummary]
        """
        self._items = items
