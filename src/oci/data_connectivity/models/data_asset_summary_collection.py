...
class DataAssetSummaryCollection(object):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new DataAssetSummaryCollection object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param items:
            The value to assign to the items property of this DataAssetSummaryCollection.
        :type items: list[oci.data_connectivity.models.DataAssetSummary]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this DataAssetSummaryCollection.
        ...
        :rtype: list[oci.data_connectivity.models.DataAssetSummary]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.data_connectivity.models.DataAssetSummary]
        """
        self._items = items
