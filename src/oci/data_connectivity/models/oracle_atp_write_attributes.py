...
class OracleAtpWriteAttributes(AbstractWriteAttribute):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new OracleAtpWriteAttributes object with values from keyword arguments. The default value of the :py:attr:`~oci.data_connectivity.models.OracleAtpWriteAttributes.model_type` attribute
