...
class HdfsWriteAttributes(AbstractWriteAttribute):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new HdfsWriteAttributes object with values from keyword arguments. The default value of the :py:attr:`~oci.data_connectivity.models.HdfsWriteAttributes.model_type` attribute
        of this class is ``HDFS_WRITE_ATTRIBUTE`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param model_type:
            The value to assign to the model_type property of this HdfsWriteAttributes.
        ...
        :param write_to_single_file:
            The value to assign to the write_to_single_file property of this HdfsWriteAttributes.
        ...
        self._model_type = 'HDFS_WRITE_ATTRIBUTE'
