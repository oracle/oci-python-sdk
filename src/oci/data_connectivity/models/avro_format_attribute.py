...
class AvroFormatAttribute(AbstractFormatAttribute):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new AvroFormatAttribute object with values from keyword arguments. The default value of the :py:attr:`~oci.data_connectivity.models.AvroFormatAttribute.model_type` attribute
