...
class ConfiguredType(BaseType):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ConfiguredType object with values from keyword arguments. The default value of the :py:attr:`~oci.data_connectivity.models.ConfiguredType.model_type` attribute
        ...
        :type wrapped_type: oci.data_connectivity.models.BaseType
