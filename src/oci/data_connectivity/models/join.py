...
class Join(PushDownOperation):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new Join object with values from keyword arguments. The default value of the :py:attr:`~oci.data_connectivity.models.Join.model_type` attribute
        ...
        :param policy:
            ...
            Allowed values for this property are: "INNER_JOIN", "LEFT_JOIN", "RIGHT_JOIN", "FULL_JOIN"
        :type policy: str
    ...
    def condition(self):
        """
        **[Required]** Gets the condition of this Join.
        The join condition.
    ...
    def policy(self):
        """
        **[Required]** Gets the policy of this Join.
        The type of join.
