...
class ParquetFormatAttribute(AbstractFormatAttribute):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ParquetFormatAttribute object with values from keyword arguments. The default value of the :py:attr:`~oci.data_connectivity.models.ParquetFormatAttribute.model_type` attribute
