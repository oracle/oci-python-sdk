...
class PushDownOperation(object):
    ...
    def __init__(self, **kwargs):
        ...
        * :class:`~oci.data_connectivity.models.Query`
        * :class:`~oci.data_connectivity.models.Select`
        * :class:`~oci.data_connectivity.models.Join`
        * :class:`~oci.data_connectivity.models.Sort`
        * :class:`~oci.data_connectivity.models.FilterPush`
