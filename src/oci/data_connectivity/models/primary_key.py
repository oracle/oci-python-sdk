...
class PrimaryKey(UniqueKey):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new PrimaryKey object with values from keyword arguments. The default value of the :py:attr:`~oci.data_connectivity.models.PrimaryKey.model_type` attribute
