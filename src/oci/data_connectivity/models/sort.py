...
class Sort(PushDownOperation):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new Sort object with values from keyword arguments. The default value of the :py:attr:`~oci.data_connectivity.models.Sort.model_type` attribute
        ...
        :type sort_clauses: list[oci.data_connectivity.models.SortClause]
    ...
    def sort_clauses(self):
        """
        **[Required]** Gets the sort_clauses of this Sort.
        The sort clause.


        :return: The sort_clauses of this Sort.
        :rtype: list[oci.data_connectivity.models.SortClause]
        """
    ...
    def sort_clauses(self, sort_clauses):
        ...
        :type: list[oci.data_connectivity.models.SortClause]
        """
