...
class EntityShapeFromView(EntityShape):
    ...
    def __init__(self, **kwargs):
        ...
        :param entity_properties:
            The value to assign to the entity_properties property of this EntityShapeFromView.
    ...
    def entity_properties(self):
        """
        Gets the entity_properties of this EntityShapeFromView.
        Map<String, String> for entity properties


        :return: The entity_properties of this EntityShapeFromView.
        :rtype: dict(str, str)
        """
    ...
    def entity_properties(self, entity_properties):
        """
        Sets the entity_properties of this EntityShapeFromView.
        Map<String, String> for entity properties


        :param entity_properties: The entity_properties of this EntityShapeFromView.
        :type: dict(str, str)
        """
