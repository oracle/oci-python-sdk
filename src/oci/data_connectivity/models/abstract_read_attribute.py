...
class AbstractReadAttribute(object):
    ...
    def __init__(self, **kwargs):
        ...
        * :class:`~oci.data_connectivity.models.OracleReadAttributes`
        * :class:`~oci.data_connectivity.models.BiccReadAttributes`
        * :class:`~oci.data_connectivity.models.OracleReadAttribute`
