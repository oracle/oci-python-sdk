...
class ConnectionSummaryCollection(object):
    ...
    def __init__(self, **kwargs):
        ...
        :type items: list[oci.data_connectivity.models.ConnectionSummary]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this ConnectionSummaryCollection.
        ...
        :rtype: list[oci.data_connectivity.models.ConnectionSummary]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.data_connectivity.models.ConnectionSummary]
        """
        self._items = items
