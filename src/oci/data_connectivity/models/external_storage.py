...
class ExternalStorage(ConnectorAttribute):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ExternalStorage object with values from keyword arguments. The default value of the :py:attr:`~oci.data_connectivity.models.ExternalStorage.model_type` attribute
