...
class CreateDataAssetDetails(object):
    ...
    def __init__(self, **kwargs):
        ...
        :param object_version:
            The value to assign to the object_version property of this CreateDataAssetDetails.
        ...
        :param type:
            The value to assign to the type property of this CreateDataAssetDetails.
        :type type: str

        :param native_type_system:
            The value to assign to the native_type_system property of this CreateDataAssetDetails.
        ...
        :param metadata:
            The value to assign to the metadata property of this CreateDataAssetDetails.
        :type metadata: oci.data_connectivity.models.ObjectMetadata

        :param default_connection:
            The value to assign to the default_connection property of this CreateDataAssetDetails.
        :type default_connection: oci.data_connectivity.models.Connection

        :param end_points:
            The value to assign to the end_points property of this CreateDataAssetDetails.
    ...
    def model_type(self):
        """
        Gets the model_type of this CreateDataAssetDetails.
    ...
    def object_version(self):
        """
        Gets the object_version of this CreateDataAssetDetails.
        The version of the object that is used to track changes in the object instance.


        :return: The object_version of this CreateDataAssetDetails.
        :rtype: int
        """
    ...
    def object_version(self, object_version):
        """
        Sets the object_version of this CreateDataAssetDetails.
        The version of the object that is used to track changes in the object instance.


        :param object_version: The object_version of this CreateDataAssetDetails.
        :type: int
        """
    ...
    def properties(self):
        """
        **[Required]** Gets the properties of this CreateDataAssetDetails.
    ...
    def type(self):
        """
        **[Required]** Gets the type of this CreateDataAssetDetails.
        Specific DataAsset Type


        :return: The type of this CreateDataAssetDetails.
        :rtype: str
        """
        return self._type
    ...
    def type(self, type):
        """
        Sets the type of this CreateDataAssetDetails.
        Specific DataAsset Type


        :param type: The type of this CreateDataAssetDetails.
        :type: str
        """
        self._type = type
    ...
    def native_type_system(self):
        ...
        :return: The native_type_system of this CreateDataAssetDetails.
    ...
    def native_type_system(self, native_type_system):
        """
        Sets the native_type_system of this CreateDataAssetDetails.

        :param native_type_system: The native_type_system of this CreateDataAssetDetails.
    ...
    def metadata(self):
        ...
        :return: The metadata of this CreateDataAssetDetails.
    ...
    def metadata(self, metadata):
        """
        Sets the metadata of this CreateDataAssetDetails.

        :param metadata: The metadata of this CreateDataAssetDetails.
    ...
    def default_connection(self):
        ...
        :return: The default_connection of this CreateDataAssetDetails.
    ...
    def default_connection(self, default_connection):
        """
        Sets the default_connection of this CreateDataAssetDetails.

        :param default_connection: The default_connection of this CreateDataAssetDetails.
    ...
    def end_points(self):
        """
        Gets the end_points of this CreateDataAssetDetails.
        The list of endpoints with which this data asset is associated.


        :return: The end_points of this CreateDataAssetDetails.
    ...
    def end_points(self, end_points):
        """
        Sets the end_points of this CreateDataAssetDetails.
        The list of endpoints with which this data asset is associated.


        :param end_points: The end_points of this CreateDataAssetDetails.
