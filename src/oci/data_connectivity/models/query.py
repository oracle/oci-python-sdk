...
class Query(PushDownOperation):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new Query object with values from keyword arguments. The default value of the :py:attr:`~oci.data_connectivity.models.Query.model_type` attribute
    ...
    def query(self):
        """
        **[Required]** Gets the query of this Query.
        A query string.
