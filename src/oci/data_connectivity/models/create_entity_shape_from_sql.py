...
class CreateEntityShapeFromSQL(CreateEntityShapeDetails):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new CreateEntityShapeFromSQL object with values from keyword arguments. The default value of the :py:attr:`~oci.data_connectivity.models.CreateEntityShapeFromSQL.model_type` attribute
        ...
        :param types:
            The value to assign to the types property of this CreateEntityShapeFromSQL.
        :type types: oci.data_connectivity.models.TypeLibrary

        :param entity_properties:
            The value to assign to the entity_properties property of this CreateEntityShapeFromSQL.
