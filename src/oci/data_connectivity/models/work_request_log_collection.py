...
class WorkRequestLogCollection(object):
    ...
    def __init__(self, **kwargs):
        ...
        :type items: list[oci.data_connectivity.models.WorkRequestLog]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this WorkRequestLogCollection.
        ...
        :rtype: list[oci.data_connectivity.models.WorkRequestLog]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.data_connectivity.models.WorkRequestLog]
        """
        self._items = items
