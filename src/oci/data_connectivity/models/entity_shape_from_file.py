...
class EntityShapeFromFile(EntityShape):
    """
    The file data entity details.
    """

    #: A constant which can be used with the entity_type property of a EntityShapeFromFile.
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new EntityShapeFromFile object with values from keyword arguments. The default value of the :py:attr:`~oci.data_connectivity.models.EntityShapeFromFile.model_type` attribute
        ...
        :param model_version:
            The value to assign to the model_version property of this EntityShapeFromFile.
        ...
        :param description:
            The value to assign to the description property of this EntityShapeFromFile.
        :type description: str

        :param object_version:
            The value to assign to the object_version property of this EntityShapeFromFile.
        :type object_version: int

        :param external_key:
            The value to assign to the external_key property of this EntityShapeFromFile.
        ...
        :param other_type_label:
            The value to assign to the other_type_label property of this EntityShapeFromFile.
        ...
        :param identifier:
            The value to assign to the identifier property of this EntityShapeFromFile.
        :type identifier: str

        :param entity_properties:
            The value to assign to the entity_properties property of this EntityShapeFromFile.
    ...
    def description(self):
        """
        Gets the description of this EntityShapeFromFile.
        Detailed description of the object.


        :return: The description of this EntityShapeFromFile.
        :rtype: str
        """
    ...
    def description(self, description):
        """
        Sets the description of this EntityShapeFromFile.
        Detailed description of the object.


        :param description: The description of this EntityShapeFromFile.
        :type: str
        """
    ...
    def object_version(self):
        """
        Gets the object_version of this EntityShapeFromFile.
        The version of the object that is used to track changes in the object instance.


        :return: The object_version of this EntityShapeFromFile.
        :rtype: int
        """
    ...
    def object_version(self, object_version):
        """
        Sets the object_version of this EntityShapeFromFile.
        The version of the object that is used to track changes in the object instance.


        :param object_version: The object_version of this EntityShapeFromFile.
        :type: int
        """
    ...
    def external_key(self):
        """
        Gets the external_key of this EntityShapeFromFile.
        The external key of the object.


        :return: The external_key of this EntityShapeFromFile.
        :rtype: str
        """
    ...
    def external_key(self, external_key):
        """
        Sets the external_key of this EntityShapeFromFile.
        The external key of the object.


        :param external_key: The external_key of this EntityShapeFromFile.
        :type: str
        """
    ...
    def shape_id(self):
        """
        Gets the shape_id of this EntityShapeFromFile.
        The shape ID.


        :return: The shape_id of this EntityShapeFromFile.
        :rtype: str
        """
    ...
    def shape_id(self, shape_id):
        """
        Sets the shape_id of this EntityShapeFromFile.
        The shape ID.


        :param shape_id: The shape_id of this EntityShapeFromFile.
        :type: str
        """
    ...
    def entity_type(self):
        """
        Gets the entity_type of this EntityShapeFromFile.
        The entity type.
        ...
        :return: The entity_type of this EntityShapeFromFile.
        :rtype: str
        """
    ...
    def entity_type(self, entity_type):
        """
        Sets the entity_type of this EntityShapeFromFile.
        The entity type.


        :param entity_type: The entity_type of this EntityShapeFromFile.
        :type: str
        """
    ...
    def other_type_label(self):
        """
        Gets the other_type_label of this EntityShapeFromFile.
        Specifies other type label.


        :return: The other_type_label of this EntityShapeFromFile.
        :rtype: str
        """
    ...
    def other_type_label(self, other_type_label):
        """
        Sets the other_type_label of this EntityShapeFromFile.
        Specifies other type label.


        :param other_type_label: The other_type_label of this EntityShapeFromFile.
        :type: str
        """
    ...
    def unique_keys(self):
        """
        Gets the unique_keys of this EntityShapeFromFile.
    ...
    def unique_keys(self, unique_keys):
        """
        Sets the unique_keys of this EntityShapeFromFile.
        An array of unique keys.
    ...
    def foreign_keys(self):
        """
        Gets the foreign_keys of this EntityShapeFromFile.
    ...
    def foreign_keys(self, foreign_keys):
        """
        Sets the foreign_keys of this EntityShapeFromFile.
        An array of foreign keys.
    ...
    def resource_name(self):
        """
        Gets the resource_name of this EntityShapeFromFile.
        The resource name.


        :return: The resource_name of this EntityShapeFromFile.
        :rtype: str
        """
    ...
    def resource_name(self, resource_name):
        """
        Sets the resource_name of this EntityShapeFromFile.
        The resource name.


        :param resource_name: The resource_name of this EntityShapeFromFile.
        :type: str
        """
    ...
    def object_status(self):
        """
        Gets the object_status of this EntityShapeFromFile.
        The status of an object that can be set to value 1 for shallow references across objects, other values reserved.


        :return: The object_status of this EntityShapeFromFile.
        :rtype: int
        """
    ...
    def object_status(self, object_status):
        """
        Sets the object_status of this EntityShapeFromFile.
        The status of an object that can be set to value 1 for shallow references across objects, other values reserved.


        :param object_status: The object_status of this EntityShapeFromFile.
        :type: int
        """
    ...
    def entity_properties(self):
        """
        Gets the entity_properties of this EntityShapeFromFile.
        Map<String, String> for entity properties


        :return: The entity_properties of this EntityShapeFromFile.
        :rtype: dict(str, str)
        """
    ...
    def entity_properties(self, entity_properties):
        """
        Sets the entity_properties of this EntityShapeFromFile.
        Map<String, String> for entity properties


        :param entity_properties: The entity_properties of this EntityShapeFromFile.
        :type: dict(str, str)
        """
