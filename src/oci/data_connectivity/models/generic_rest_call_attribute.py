...
class GenericRestCallAttribute(AbstractCallAttribute):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new GenericRestCallAttribute object with values from keyword arguments. The default value of the :py:attr:`~oci.data_connectivity.models.GenericRestCallAttribute.model_type` attribute
