...
class ConnectionValidationSummary(object):
    ...
    def __init__(self, **kwargs):
        ...
        :param registry_metadata:
            The value to assign to the registry_metadata property of this ConnectionValidationSummary.
        :type registry_metadata: oci.data_connectivity.models.RegistryMetadata

        :param connection:
            The value to assign to the connection property of this ConnectionValidationSummary.
        :type connection: oci.data_connectivity.models.CreateConnectionDetails

        :param data_asset:
            The value to assign to the data_asset property of this ConnectionValidationSummary.
    ...
    def model_type(self):
        """
        **[Required]** Gets the model_type of this ConnectionValidationSummary.
    ...
    def registry_metadata(self):
        """
        Gets the registry_metadata of this ConnectionValidationSummary.

        :return: The registry_metadata of this ConnectionValidationSummary.
    ...
    def registry_metadata(self, registry_metadata):
        """
        Sets the registry_metadata of this ConnectionValidationSummary.

        :param registry_metadata: The registry_metadata of this ConnectionValidationSummary.
    ...
    def connection(self):
        """
        Gets the connection of this ConnectionValidationSummary.

        :return: The connection of this ConnectionValidationSummary.
    ...
    def connection(self, connection):
        """
        Sets the connection of this ConnectionValidationSummary.

        :param connection: The connection of this ConnectionValidationSummary.
    ...
    def data_asset(self):
        """
        Gets the data_asset of this ConnectionValidationSummary.

        :return: The data_asset of this ConnectionValidationSummary.
    ...
    def data_asset(self, data_asset):
        """
        Sets the data_asset of this ConnectionValidationSummary.

        :param data_asset: The data_asset of this ConnectionValidationSummary.
