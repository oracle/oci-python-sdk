...
class DataEntitySummary(object):
    ...
    def __init__(self, **kwargs):
        ...
        * :class:`~oci.data_connectivity.models.DataEntitySummaryFromFile`
        * :class:`~oci.data_connectivity.models.DataEntitySummaryFromTable`
        * :class:`~oci.data_connectivity.models.DataEntitySummaryFromDataStore`
        * :class:`~oci.data_connectivity.models.DataEntitySummaryFromSql`
        * :class:`~oci.data_connectivity.models.DataEntitySummaryFromView`
