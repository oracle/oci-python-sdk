...
class DataEntityFromView(DataEntity):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new DataEntityFromView object with values from keyword arguments. The default value of the :py:attr:`~oci.data_connectivity.models.DataEntityFromView.model_type` attribute
        of this class is ``VIEW_ENTITY`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param entity_properties:
            The value to assign to the entity_properties property of this DataEntityFromView.
