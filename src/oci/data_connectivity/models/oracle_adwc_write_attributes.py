...
class OracleAdwcWriteAttributes(AbstractWriteAttribute):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new OracleAdwcWriteAttributes object with values from keyword arguments. The default value of the :py:attr:`~oci.data_connectivity.models.OracleAdwcWriteAttributes.model_type` attribute
