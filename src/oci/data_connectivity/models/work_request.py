...
class WorkRequest(object):
    ...
    def __init__(self, **kwargs):
        ...
        :type resources: list[oci.data_connectivity.models.WorkRequestResource]
    ...
    def operation_type(self, operation_type):
        ...
        :type: str
        """
        allowed_values = ["CREATE", "UPDATE", "DELETE", "MOVE"]
    ...
    def resources(self):
        ...
        **[Required]** Gets the resources of this WorkRequest.
        ...
        :rtype: list[oci.data_connectivity.models.WorkRequestResource]
        """
    ...
    def resources(self, resources):
        ...
        :type: list[oci.data_connectivity.models.WorkRequestResource]
        """
