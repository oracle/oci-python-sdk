...
class ForeignKey(Key):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ForeignKey object with values from keyword arguments. The default value of the :py:attr:`~oci.data_connectivity.models.ForeignKey.model_type` attribute
        ...
        :type reference_unique_key: oci.data_connectivity.models.UniqueKey
