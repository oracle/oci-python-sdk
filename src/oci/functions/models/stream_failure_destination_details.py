...
class StreamFailureDestinationDetails(FailureDestinationDetails):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new StreamFailureDestinationDetails object with values from keyword arguments. The default value of the :py:attr:`~oci.functions.models.StreamFailureDestinationDetails.kind` attribute
        of this class is ``STREAM`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param kind:
            The value to assign to the kind property of this StreamFailureDestinationDetails.
            Allowed values for this property are: "NOTIFICATION", "QUEUE", "STREAM", "NONE"
        :type kind: str

        :param stream_id:
            The value to assign to the stream_id property of this StreamFailureDestinationDetails.
        :type stream_id: str
