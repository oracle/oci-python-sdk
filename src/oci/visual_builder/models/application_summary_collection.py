...
class ApplicationSummaryCollection(object):
    ...
    def __init__(self, **kwargs):
        ...
        :type items: list[oci.visual_builder.models.ApplicationSummary]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this ApplicationSummaryCollection.
        ...
        :rtype: list[oci.visual_builder.models.ApplicationSummary]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.visual_builder.models.ApplicationSummary]
        """
        self._items = items
