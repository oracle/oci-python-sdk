...
class VmCluster(object):
    ...
    #: A constant which can be used with the vm_file_system_storage_type property of a VmCluster.
    ...
    #: A constant which can be used with the vm_backup_storage_type property of a VmCluster.
    #: This constant has a value of "LOCAL"
    ...
    def __init__(self, **kwargs):
        ...
        :param live_image_version_details:
            The value to assign to the live_image_version_details property of this VmCluster.
        :type live_image_version_details: oci.database.models.ExadataLiveImageVersionDetails

        :param oracle_linux_version:
            The value to assign to the oracle_linux_version property of this VmCluster.
        ...
        :param exascale_db_storage_vault_id:
            The value to assign to the exascale_db_storage_vault_id property of this VmCluster.
        :type exascale_db_storage_vault_id: str

        :param storage_management_type:
            The value to assign to the storage_management_type property of this VmCluster.
        ...
        :param vm_file_system_storage_type:
            The value to assign to the vm_file_system_storage_type property of this VmCluster.
        ...
        :param vm_backup_storage_type:
            The value to assign to the vm_backup_storage_type property of this VmCluster.
            Allowed values for this property are: "LOCAL", "EXASCALE", 'UNKNOWN_ENUM_VALUE'.
            Any unrecognized values returned by a service will be mapped to 'UNKNOWN_ENUM_VALUE'.
    ...
    def live_image_version_details(self):
        """
        Gets the live_image_version_details of this VmCluster.

        :return: The live_image_version_details of this VmCluster.
    ...
    def live_image_version_details(self, live_image_version_details):
        """
        Sets the live_image_version_details of this VmCluster.

        :param live_image_version_details: The live_image_version_details of this VmCluster.
    ...
    def oracle_linux_version(self):
        """
        Gets the oracle_linux_version of this VmCluster.
        Oracle Linux version for the respective Exadata Image.


        :return: The oracle_linux_version of this VmCluster.
        :rtype: str
        """
    ...
    def oracle_linux_version(self, oracle_linux_version):
        """
        Sets the oracle_linux_version of this VmCluster.
        Oracle Linux version for the respective Exadata Image.


        :param oracle_linux_version: The oracle_linux_version of this VmCluster.
        :type: str
        """
    ...
    def file_system_configuration_details(self):
        """
        Gets the file_system_configuration_details of this VmCluster.
        Details of the file system configuration of the VM cluster.


        :return: The file_system_configuration_details of this VmCluster.
    ...
    def file_system_configuration_details(self, file_system_configuration_details):
        """
        Sets the file_system_configuration_details of this VmCluster.
        Details of the file system configuration of the VM cluster.


        :param file_system_configuration_details: The file_system_configuration_details of this VmCluster.
    ...
    def cloud_automation_update_details(self):
        """
        Gets the cloud_automation_update_details of this VmCluster.

        :return: The cloud_automation_update_details of this VmCluster.
    ...
    def cloud_automation_update_details(self, cloud_automation_update_details):
        """
        Sets the cloud_automation_update_details of this VmCluster.
    ...
    def exascale_db_storage_vault_id(self):
        """
        Gets the exascale_db_storage_vault_id of this VmCluster.
        The `OCID`__ of the Exadata Database Storage Vault.

        __ https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm


        :return: The exascale_db_storage_vault_id of this VmCluster.
        :rtype: str
        """
    ...
    def exascale_db_storage_vault_id(self, exascale_db_storage_vault_id):
        """
        Sets the exascale_db_storage_vault_id of this VmCluster.
        The `OCID`__ of the Exadata Database Storage Vault.

        __ https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm


        :param exascale_db_storage_vault_id: The exascale_db_storage_vault_id of this VmCluster.
        :type: str
        """
    ...
    def storage_management_type(self):
        """
        Gets the storage_management_type of this VmCluster.
        ...
        :return: The storage_management_type of this VmCluster.
        :rtype: str
        """
    ...
    def storage_management_type(self, storage_management_type):
        """
        Sets the storage_management_type of this VmCluster.
        Specifies whether the type of storage management for the VM cluster is ASM or Exascale.


        :param storage_management_type: The storage_management_type of this VmCluster.
        :type: str
        """
    ...
    def vm_file_system_storage_type(self):
        """
        Gets the vm_file_system_storage_type of this VmCluster.
        ...
        :return: The vm_file_system_storage_type of this VmCluster.
        :rtype: str
        """
    ...
    def vm_file_system_storage_type(self, vm_file_system_storage_type):
        """
        Sets the vm_file_system_storage_type of this VmCluster.
        Specifies the type of file system storage and supported values are LOCAL and EXASCALE. - LOCAL if selected then file system storage will be on DB Servers. - EXASCALE if selected then file system storage will be on Exascale Storage Servers. Default Value is LOCAL


        :param vm_file_system_storage_type: The vm_file_system_storage_type of this VmCluster.
        :type: str
        """
    ...
    def vm_backup_storage_type(self):
        """
        Gets the vm_backup_storage_type of this VmCluster.
        ...
        :return: The vm_backup_storage_type of this VmCluster.
        :rtype: str
        """
    ...
    def vm_backup_storage_type(self, vm_backup_storage_type):
        """
        Sets the vm_backup_storage_type of this VmCluster.
        Specifies the type of VM Backups Storage and supported values are LOCAL and EXASCALE. - LOCAL if selected then VM Backups storage will be on DB Servers. - EXASCALE if selected then VM Backups storage will be on Exascale Storage Servers. Default Value is LOCAL.


        :param vm_backup_storage_type: The vm_backup_storage_type of this VmCluster.
        :type: str
        """
        allowed_values = ["LOCAL", "EXASCALE"]
