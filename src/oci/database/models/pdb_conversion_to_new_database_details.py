...
class PdbConversionToNewDatabaseDetails(ConvertToPdbTargetBase):
    ...
    def __repr__(self):
        ...
        redact_password_field(as_dict, ['cdb_admin_password'])
        redact_password_field(as_dict, ['pdb_admin_password'])
        redact_password_field(as_dict, ['cdb_tde_wallet_password'])
        redact_password_field(as_dict, ['non_cdb_tde_wallet_password'])
