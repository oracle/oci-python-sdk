...
class LaunchDbSystemFromDbSystemDetails(LaunchDbSystemBase):
    ...
    def __init__(self, **kwargs):
        ...
        :param private_ip_v6:
            The value to assign to the private_ip_v6 property of this LaunchDbSystemFromDbSystemDetails.
        :type private_ip_v6: str

        :param cluster_placement_group_id:
            The value to assign to the cluster_placement_group_id property of this LaunchDbSystemFromDbSystemDetails.
        :type cluster_placement_group_id: str

        :param subscription_id:
            The value to assign to the subscription_id property of this LaunchDbSystemFromDbSystemDetails.
