...
class ModifyPluggableDatabaseManagementDetails(object):
    """
    Data to update one or more attributes of the Database Management configuration for the pluggable database.
    """

    #: A constant which can be used with the protocol property of a ModifyPluggableDatabaseManagementDetails.
    ...
    def __init__(self, **kwargs):
        ...
        :param credential_details:
            The value to assign to the credential_details property of this ModifyPluggableDatabaseManagementDetails.
        :type credential_details: oci.database.models.DatabaseCredentialDetails

        :param private_end_point_id:
            The value to assign to the private_end_point_id property of this ModifyPluggableDatabaseManagementDetails.
        :type private_end_point_id: str

        :param service_name:
            The value to assign to the service_name property of this ModifyPluggableDatabaseManagementDetails.
        :type service_name: str

        :param protocol:
            The value to assign to the protocol property of this ModifyPluggableDatabaseManagementDetails.
            Allowed values for this property are: "TCP", "TCPS"
        :type protocol: str

        :param port:
            The value to assign to the port property of this ModifyPluggableDatabaseManagementDetails.
        :type port: int

        :param ssl_secret_id:
            The value to assign to the ssl_secret_id property of this ModifyPluggableDatabaseManagementDetails.
    ...
    def credential_details(self):
        """
        Gets the credential_details of this ModifyPluggableDatabaseManagementDetails.

        :return: The credential_details of this ModifyPluggableDatabaseManagementDetails.
    ...
    def credential_details(self, credential_details):
        """
        Sets the credential_details of this ModifyPluggableDatabaseManagementDetails.

        :param credential_details: The credential_details of this ModifyPluggableDatabaseManagementDetails.
    ...
    def service_name(self):
        """
        Gets the service_name of this ModifyPluggableDatabaseManagementDetails.
        The name of the Oracle Database service that will be used to connect to the database.


        :return: The service_name of this ModifyPluggableDatabaseManagementDetails.
        :rtype: str
        """
    ...
    def service_name(self, service_name):
        """
        Sets the service_name of this ModifyPluggableDatabaseManagementDetails.
        The name of the Oracle Database service that will be used to connect to the database.


        :param service_name: The service_name of this ModifyPluggableDatabaseManagementDetails.
        :type: str
        """
    ...
    def protocol(self):
        """
        Gets the protocol of this ModifyPluggableDatabaseManagementDetails.
        Protocol used by the database connection.

        Allowed values for this property are: "TCP", "TCPS"


        :return: The protocol of this ModifyPluggableDatabaseManagementDetails.
        :rtype: str
        """
    ...
    def protocol(self, protocol):
        """
        Sets the protocol of this ModifyPluggableDatabaseManagementDetails.
        Protocol used by the database connection.


        :param protocol: The protocol of this ModifyPluggableDatabaseManagementDetails.
        :type: str
        """
    ...
    def port(self):
        """
        Gets the port of this ModifyPluggableDatabaseManagementDetails.
        The port used to connect to the database.


        :return: The port of this ModifyPluggableDatabaseManagementDetails.
        :rtype: int
        """
        return self._port
    ...
    def port(self, port):
        """
        Sets the port of this ModifyPluggableDatabaseManagementDetails.
        The port used to connect to the database.


        :param port: The port of this ModifyPluggableDatabaseManagementDetails.
        :type: int
        """
        self._port = port
    ...
    def role(self, role):
        """
        Sets the role of this ModifyPluggableDatabaseManagementDetails.
        The role of the user that will be connecting to the database.
