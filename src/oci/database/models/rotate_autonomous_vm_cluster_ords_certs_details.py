...
class RotateAutonomousVmClusterOrdsCertsDetails(object):
    """
    The details for configuring the SSL certificates on Autonomous VM Cluster
    """

    #: A constant which can be used with the certificate_generation_type property of a RotateAutonomousVmClusterOrdsCertsDetails.
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new RotateAutonomousVmClusterOrdsCertsDetails object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param certificate_generation_type:
            The value to assign to the certificate_generation_type property of this RotateAutonomousVmClusterOrdsCertsDetails.
            Allowed values for this property are: "SYSTEM", "BYOC"
        :type certificate_generation_type: str

        :param certificate_id:
            The value to assign to the certificate_id property of this RotateAutonomousVmClusterOrdsCertsDetails.
        :type certificate_id: str

        :param certificate_authority_id:
            The value to assign to the certificate_authority_id property of this RotateAutonomousVmClusterOrdsCertsDetails.
        :type certificate_authority_id: str

        :param ca_bundle_id:
            The value to assign to the ca_bundle_id property of this RotateAutonomousVmClusterOrdsCertsDetails.
    ...
    def certificate_generation_type(self):
        ...
        **[Required]** Gets the certificate_generation_type of this RotateAutonomousVmClusterOrdsCertsDetails.
        ...
        :return: The certificate_generation_type of this RotateAutonomousVmClusterOrdsCertsDetails.
        :rtype: str
        """
    ...
    def certificate_id(self):
        """
        Gets the certificate_id of this RotateAutonomousVmClusterOrdsCertsDetails.
        The `OCID`__ of the certificate to use.

        __ https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm


        :return: The certificate_id of this RotateAutonomousVmClusterOrdsCertsDetails.
        :rtype: str
        """
    ...
    def certificate_id(self, certificate_id):
        """
        Sets the certificate_id of this RotateAutonomousVmClusterOrdsCertsDetails.
        The `OCID`__ of the certificate to use.

        __ https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm


        :param certificate_id: The certificate_id of this RotateAutonomousVmClusterOrdsCertsDetails.
        :type: str
        """
    ...
    def certificate_authority_id(self):
        """
        Gets the certificate_authority_id of this RotateAutonomousVmClusterOrdsCertsDetails.
        The `OCID`__ of the certificate authority.

        __ https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm


        :return: The certificate_authority_id of this RotateAutonomousVmClusterOrdsCertsDetails.
        :rtype: str
        """
    ...
    def certificate_authority_id(self, certificate_authority_id):
        """
        Sets the certificate_authority_id of this RotateAutonomousVmClusterOrdsCertsDetails.
        The `OCID`__ of the certificate authority.

        __ https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm


        :param certificate_authority_id: The certificate_authority_id of this RotateAutonomousVmClusterOrdsCertsDetails.
        :type: str
        """
    ...
    def ca_bundle_id(self):
        """
        Gets the ca_bundle_id of this RotateAutonomousVmClusterOrdsCertsDetails.
        The `OCID`__ of the certificate bundle.

        __ https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm


        :return: The ca_bundle_id of this RotateAutonomousVmClusterOrdsCertsDetails.
        :rtype: str
        """
    ...
    def ca_bundle_id(self, ca_bundle_id):
        """
        Sets the ca_bundle_id of this RotateAutonomousVmClusterOrdsCertsDetails.
        The `OCID`__ of the certificate bundle.

        __ https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm


        :param ca_bundle_id: The ca_bundle_id of this RotateAutonomousVmClusterOrdsCertsDetails.
        :type: str
        """
