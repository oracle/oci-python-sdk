...
class CloudVmCluster(object):
    ...
    #: A constant which can be used with the storage_management_type property of a CloudVmCluster.
    ...
    def __init__(self, **kwargs):
        ...
        :param reco_storage_percentage:
            The value to assign to the reco_storage_percentage property of this CloudVmCluster.
        :type reco_storage_percentage: int

        :param sparse_storage_percentage:
            The value to assign to the sparse_storage_percentage property of this CloudVmCluster.
        ...
        :param exascale_db_storage_vault_id:
            The value to assign to the exascale_db_storage_vault_id property of this CloudVmCluster.
        :type exascale_db_storage_vault_id: str

        :param storage_management_type:
            The value to assign to the storage_management_type property of this CloudVmCluster.
    ...
    def reco_storage_percentage(self):
        """
        Gets the reco_storage_percentage of this CloudVmCluster.
        ...
        :return: The reco_storage_percentage of this CloudVmCluster.
        :rtype: int
        """
    ...
    def reco_storage_percentage(self, reco_storage_percentage):
        """
        Sets the reco_storage_percentage of this CloudVmCluster.
        The percentage assigned to RECO storage (database redo logs, archive logs, and recovery manager backups). See `Storage Configuration`__ in the Exadata documentation for details on the impact of the configuration settings on storage.

        __ https://docs.oracle.com/iaas/Content/Database/Concepts/exaoverview.htm#Exadata


        :param reco_storage_percentage: The reco_storage_percentage of this CloudVmCluster.
        :type: int
        """
    ...
    def sparse_storage_percentage(self):
        """
        Gets the sparse_storage_percentage of this CloudVmCluster.
        ...
        :return: The sparse_storage_percentage of this CloudVmCluster.
        :rtype: int
        """
    ...
    def sparse_storage_percentage(self, sparse_storage_percentage):
        """
        Sets the sparse_storage_percentage of this CloudVmCluster.
        The percentage assigned to SPARSE storage (Exadata snapshots). See `Storage Configuration`__ in the Exadata documentation for details on the impact of the configuration settings on storage.

        __ https://docs.oracle.com/iaas/Content/Database/Concepts/exaoverview.htm#Exadata


        :param sparse_storage_percentage: The sparse_storage_percentage of this CloudVmCluster.
        :type: int
        """
    ...
    def system_tags(self):
        ...
        :return: The system_tags of this CloudVmCluster.
        :rtype: dict(str, dict(str, object))
        """
    ...
    def system_tags(self, system_tags):
        """
        Sets the system_tags of this CloudVmCluster.
        System tags for this resource. Each key is predefined and scoped to a namespace.
        For more information, see `Resource Tags`__.
        ...
        :param system_tags: The system_tags of this CloudVmCluster.
        :type: dict(str, dict(str, object))
        """
    ...
    def exascale_db_storage_vault_id(self):
        """
        Gets the exascale_db_storage_vault_id of this CloudVmCluster.
        The `OCID`__ of the Exadata Database Storage Vault.

        __ https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm


        :return: The exascale_db_storage_vault_id of this CloudVmCluster.
        :rtype: str
        """
    ...
    def exascale_db_storage_vault_id(self, exascale_db_storage_vault_id):
        """
        Sets the exascale_db_storage_vault_id of this CloudVmCluster.
        The `OCID`__ of the Exadata Database Storage Vault.

        __ https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm


        :param exascale_db_storage_vault_id: The exascale_db_storage_vault_id of this CloudVmCluster.
        :type: str
        """
    ...
    def storage_management_type(self):
        """
        Gets the storage_management_type of this CloudVmCluster.
        ...
        :return: The storage_management_type of this CloudVmCluster.
        :rtype: str
        """
    ...
    def storage_management_type(self, storage_management_type):
        """
        Sets the storage_management_type of this CloudVmCluster.
        Specifies the type of storage management for the Cloud VM Cluster if its ASM or Exascale.


        :param storage_management_type: The storage_management_type of this CloudVmCluster.
        :type: str
        """
    ...
    def compute_model(self):
        ...
        :return: The compute_model of this CloudVmCluster.
        :rtype: str
        """
    ...
    def compute_model(self, compute_model):
        """
        Sets the compute_model of this CloudVmCluster.
        The compute model of the Autonomous AI Database. This is required if using the `computeCount` parameter. If using `cpuCoreCount` then it is an error to specify `computeModel` to a non-null value. ECPU compute model is the recommended model and OCPU compute model is legacy.


        :param compute_model: The compute_model of this CloudVmCluster.
        :type: str
        """
