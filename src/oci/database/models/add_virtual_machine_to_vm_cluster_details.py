...
class AddVirtualMachineToVmClusterDetails(object):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new AddVirtualMachineToVmClusterDetails object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param db_servers:
            The value to assign to the db_servers property of this AddVirtualMachineToVmClusterDetails.
    ...
    def db_servers(self):
        ...
        **[Required]** Gets the db_servers of this AddVirtualMachineToVmClusterDetails.
        ...
        :return: The db_servers of this AddVirtualMachineToVmClusterDetails.
    ...
    def db_servers(self, db_servers):
        """
        Sets the db_servers of this AddVirtualMachineToVmClusterDetails.
        The list of Exacc DB servers for the cluster to be added.


        :param db_servers: The db_servers of this AddVirtualMachineToVmClusterDetails.
