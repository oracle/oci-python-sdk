...
class UnregisterExadbVmClusterPkcsDetails(object):
    """
    Details of unregistering PKCS11 driver.
    """

    #: A constant which can be used with the tde_key_store_type property of a UnregisterExadbVmClusterPkcsDetails.
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new UnregisterExadbVmClusterPkcsDetails object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param tde_key_store_type:
            The value to assign to the tde_key_store_type property of this UnregisterExadbVmClusterPkcsDetails.
            Allowed values for this property are: "AZURE", "OCI", "GCP", "AWS"
    ...
    def tde_key_store_type(self):
        """
        **[Required]** Gets the tde_key_store_type of this UnregisterExadbVmClusterPkcsDetails.
        TDE keystore type

        Allowed values for this property are: "AZURE", "OCI", "GCP", "AWS"


        :return: The tde_key_store_type of this UnregisterExadbVmClusterPkcsDetails.
        :rtype: str
        """
    ...
    def tde_key_store_type(self, tde_key_store_type):
        """
        Sets the tde_key_store_type of this UnregisterExadbVmClusterPkcsDetails.
        TDE keystore type


        :param tde_key_store_type: The tde_key_store_type of this UnregisterExadbVmClusterPkcsDetails.
        :type: str
        """
