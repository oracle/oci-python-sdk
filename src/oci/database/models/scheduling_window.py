...
class SchedulingWindow(object):
    ...
    #: A constant which can be used with the lifecycle_state property of a SchedulingWindow.
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new SchedulingWindow object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param id:
            The value to assign to the id property of this SchedulingWindow.
        :type id: str

        :param compartment_id:
            The value to assign to the compartment_id property of this SchedulingWindow.
        :type compartment_id: str

        :param display_name:
            The value to assign to the display_name property of this SchedulingWindow.
        :type display_name: str

        :param time_next_scheduling_window_starts:
            The value to assign to the time_next_scheduling_window_starts property of this SchedulingWindow.
        :type time_next_scheduling_window_starts: datetime

        :param lifecycle_state:
            The value to assign to the lifecycle_state property of this SchedulingWindow.
        ...
        :param lifecycle_details:
            The value to assign to the lifecycle_details property of this SchedulingWindow.
        :type lifecycle_details: str

        :param time_created:
            The value to assign to the time_created property of this SchedulingWindow.
        :type time_created: datetime

        :param time_updated:
            The value to assign to the time_updated property of this SchedulingWindow.
        :type time_updated: datetime

        :param window_preference:
            The value to assign to the window_preference property of this SchedulingWindow.
        :type window_preference: oci.database.models.WindowPreferenceDetail

        :param scheduling_policy_id:
            The value to assign to the scheduling_policy_id property of this SchedulingWindow.
        :type scheduling_policy_id: str

        :param freeform_tags:
            The value to assign to the freeform_tags property of this SchedulingWindow.
        :type freeform_tags: dict(str, str)

        :param defined_tags:
            The value to assign to the defined_tags property of this SchedulingWindow.
        :type defined_tags: dict(str, dict(str, object))

        :param system_tags:
            The value to assign to the system_tags property of this SchedulingWindow.
    ...
    def display_name(self):
        """
        Gets the display_name of this SchedulingWindow.
        The user-friendly name for the Scheduling Window. The name does not need to be unique.


        :return: The display_name of this SchedulingWindow.
        :rtype: str
        """
    ...
    def display_name(self, display_name):
        """
        Sets the display_name of this SchedulingWindow.
        The user-friendly name for the Scheduling Window. The name does not need to be unique.


        :param display_name: The display_name of this SchedulingWindow.
        :type: str
        """
    ...
    def time_next_scheduling_window_starts(self):
        """
        Gets the time_next_scheduling_window_starts of this SchedulingWindow.
        The date and time of the next upcoming window associated within the schedulingWindow is planned to start.


        :return: The time_next_scheduling_window_starts of this SchedulingWindow.
        :rtype: datetime
        """
    ...
    def time_next_scheduling_window_starts(self, time_next_scheduling_window_starts):
        """
        Sets the time_next_scheduling_window_starts of this SchedulingWindow.
        The date and time of the next upcoming window associated within the schedulingWindow is planned to start.


        :param time_next_scheduling_window_starts: The time_next_scheduling_window_starts of this SchedulingWindow.
        :type: datetime
        """
    ...
    def lifecycle_state(self):
        """
        **[Required]** Gets the lifecycle_state of this SchedulingWindow.
        ...
        :return: The lifecycle_state of this SchedulingWindow.
        :rtype: str
        """
    ...
    def lifecycle_state(self, lifecycle_state):
        """
        Sets the lifecycle_state of this SchedulingWindow.
        The current state of the Scheduling Window. Valid states are CREATING, ACTIVE, UPDATING, FAILED, DELETING and DELETED.


        :param lifecycle_state: The lifecycle_state of this SchedulingWindow.
        :type: str
        """
    ...
    def lifecycle_details(self):
        """
        Gets the lifecycle_details of this SchedulingWindow.
        Additional information about the current lifecycle state.


        :return: The lifecycle_details of this SchedulingWindow.
        :rtype: str
        """
    ...
    def lifecycle_details(self, lifecycle_details):
        """
        Sets the lifecycle_details of this SchedulingWindow.
        Additional information about the current lifecycle state.


        :param lifecycle_details: The lifecycle_details of this SchedulingWindow.
        :type: str
        """
    ...
    def time_created(self):
        """
        Gets the time_created of this SchedulingWindow.
        The date and time the Scheduling Window was created.


        :return: The time_created of this SchedulingWindow.
        :rtype: datetime
        """
    ...
    def time_created(self, time_created):
        """
        Sets the time_created of this SchedulingWindow.
        The date and time the Scheduling Window was created.


        :param time_created: The time_created of this SchedulingWindow.
        :type: datetime
        """
    ...
    def time_updated(self):
        """
        Gets the time_updated of this SchedulingWindow.
        The last date and time that the Scheduling Window was updated.


        :return: The time_updated of this SchedulingWindow.
        :rtype: datetime
        """
    ...
    def time_updated(self, time_updated):
        """
        Sets the time_updated of this SchedulingWindow.
        The last date and time that the Scheduling Window was updated.


        :param time_updated: The time_updated of this SchedulingWindow.
        :type: datetime
        """
    ...
    def window_preference(self):
        ...
        **[Required]** Gets the window_preference of this SchedulingWindow.
        ...
        :return: The window_preference of this SchedulingWindow.
    ...
    def window_preference(self, window_preference):
        """
        Sets the window_preference of this SchedulingWindow.

        :param window_preference: The window_preference of this SchedulingWindow.
    ...
    def freeform_tags(self):
        """
        Gets the freeform_tags of this SchedulingWindow.
    ...
    def freeform_tags(self, freeform_tags):
        """
        Sets the freeform_tags of this SchedulingWindow.
        Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace.
        For more information, see `Resource Tags`__.
    ...
    def defined_tags(self):
        """
        Gets the defined_tags of this SchedulingWindow.
    ...
    def defined_tags(self, defined_tags):
        """
        Sets the defined_tags of this SchedulingWindow.
        Defined tags for this resource. Each key is predefined and scoped to a namespace.
        For more information, see `Resource Tags`__.
