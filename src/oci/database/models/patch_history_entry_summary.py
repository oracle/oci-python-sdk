...
class PatchHistoryEntrySummary(object):
    ...
    #: A constant which can be used with the action property of a PatchHistoryEntrySummary.
    ...
    #: A constant which can be used with the lifecycle_state property of a PatchHistoryEntrySummary.
    ...
    #: A constant which can be used with the patch_type property of a PatchHistoryEntrySummary.
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new PatchHistoryEntrySummary object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param id:
            The value to assign to the id property of this PatchHistoryEntrySummary.
        :type id: str

        :param patch_id:
            The value to assign to the patch_id property of this PatchHistoryEntrySummary.
        :type patch_id: str

        :param action:
            The value to assign to the action property of this PatchHistoryEntrySummary.
            Allowed values for this property are: "APPLY", "PRECHECK", 'UNKNOWN_ENUM_VALUE'.
            Any unrecognized values returned by a service will be mapped to 'UNKNOWN_ENUM_VALUE'.
        :type action: str

        :param lifecycle_state:
            The value to assign to the lifecycle_state property of this PatchHistoryEntrySummary.
            Allowed values for this property are: "IN_PROGRESS", "SUCCEEDED", "FAILED", 'UNKNOWN_ENUM_VALUE'.
            Any unrecognized values returned by a service will be mapped to 'UNKNOWN_ENUM_VALUE'.
        :type lifecycle_state: str

        :param lifecycle_details:
            The value to assign to the lifecycle_details property of this PatchHistoryEntrySummary.
        :type lifecycle_details: str

        :param time_started:
            The value to assign to the time_started property of this PatchHistoryEntrySummary.
        :type time_started: datetime

        :param time_ended:
            The value to assign to the time_ended property of this PatchHistoryEntrySummary.
        :type time_ended: datetime

        :param patch_type:
            The value to assign to the patch_type property of this PatchHistoryEntrySummary.
    ...
    def patch_type(self):
        """
        Gets the patch_type of this PatchHistoryEntrySummary.
        ...
        :return: The patch_type of this PatchHistoryEntrySummary.
        :rtype: str
        """
    ...
    def patch_type(self, patch_type):
        """
        Sets the patch_type of this PatchHistoryEntrySummary.
        The type of Patch operation.


        :param patch_type: The patch_type of this PatchHistoryEntrySummary.
        :type: str
        """
