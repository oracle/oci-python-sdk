...
class LaunchDbSystemFromBackupDetails(LaunchDbSystemBase):
    ...
    def __init__(self, **kwargs):
        ...
        :param security_attributes:
            The value to assign to the security_attributes property of this LaunchDbSystemFromBackupDetails.
        ...
        :param private_ip_v6:
            The value to assign to the private_ip_v6 property of this LaunchDbSystemFromBackupDetails.
        :type private_ip_v6: str

        :param cluster_placement_group_id:
            The value to assign to the cluster_placement_group_id property of this LaunchDbSystemFromBackupDetails.
        :type cluster_placement_group_id: str

        :param subscription_id:
            The value to assign to the subscription_id property of this LaunchDbSystemFromBackupDetails.
        ...
        :param compute_model:
            The value to assign to the compute_model property of this LaunchDbSystemFromBackupDetails.
            Allowed values for this property are: "ECPU", "OCPU"
        :type compute_model: str

        :param compute_count:
            The value to assign to the compute_count property of this LaunchDbSystemFromBackupDetails.
