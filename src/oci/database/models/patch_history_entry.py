...
class PatchHistoryEntry(object):
    ...
    def action(self):
        ...
        Allowed values for this property are: "PRECHECK", "ROLLBACK", "APPLY", 'UNKNOWN_ENUM_VALUE'.
    ...
    def action(self, action):
        ...
        :type: str
        """
        allowed_values = ["PRECHECK", "ROLLBACK", "APPLY"]
    ...
    def id(self):
        ...
        The OCID of the patch history item.
    ...
    def lifecycle_status(self):
        """
        Gets the lifecycle_status of this PatchHistoryEntry.
        ...
        :return: The lifecycle_status of this PatchHistoryEntry.
        :rtype: str
        """
    ...
    def lifecycle_status(self, lifecycle_status):
        """
        Sets the lifecycle_status of this PatchHistoryEntry.
        The current status of the action.


        :param lifecycle_status: The lifecycle_status of this PatchHistoryEntry.
        :type: str
        """
        allowed_values = ["IN_PROGRESS", "SUCCEEDED", "FAILED"]
        if lifecycle_status not in allowed_values:
            lifecycle_status = 'UNKNOWN_ENUM_VALUE'
