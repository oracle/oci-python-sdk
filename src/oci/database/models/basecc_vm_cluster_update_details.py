...
class BaseccVmClusterUpdateDetails(object):
    """
    ...
    #: A constant which can be used with the update_action property of a BaseccVmClusterUpdateDetails.
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new BaseccVmClusterUpdateDetails object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param update_id:
            The value to assign to the update_id property of this BaseccVmClusterUpdateDetails.
        :type update_id: str

        :param update_action:
            The value to assign to the update_action property of this BaseccVmClusterUpdateDetails.
            Allowed values for this property are: "ROLLING_APPLY", "PRECHECK", "ROLLBACK"
        :type update_action: str

        :param gi_software_image_id:
            The value to assign to the gi_software_image_id property of this BaseccVmClusterUpdateDetails.
    ...
    def update_id(self):
        """
        Gets the update_id of this BaseccVmClusterUpdateDetails.
        The `OCID`__ of the maintenance update.

        __ https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm


        :return: The update_id of this BaseccVmClusterUpdateDetails.
        :rtype: str
        """
    ...
    def update_id(self, update_id):
        """
        Sets the update_id of this BaseccVmClusterUpdateDetails.
        The `OCID`__ of the maintenance update.

        __ https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm


        :param update_id: The update_id of this BaseccVmClusterUpdateDetails.
        :type: str
        """
    ...
    def update_action(self):
        """
        Gets the update_action of this BaseccVmClusterUpdateDetails.
        The update action to perform.

        Allowed values for this property are: "ROLLING_APPLY", "PRECHECK", "ROLLBACK"


        :return: The update_action of this BaseccVmClusterUpdateDetails.
        :rtype: str
        """
    ...
    def update_action(self, update_action):
        """
        Sets the update_action of this BaseccVmClusterUpdateDetails.
        The update action to perform.


        :param update_action: The update_action of this BaseccVmClusterUpdateDetails.
        :type: str
        """
    ...
    def gi_software_image_id(self):
        """
        Gets the gi_software_image_id of this BaseccVmClusterUpdateDetails.
        The `OCID`__ of a grid infrastructure software image. This is a database software image of the type `GRID_IMAGE`.

        __ https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm


        :return: The gi_software_image_id of this BaseccVmClusterUpdateDetails.
        :rtype: str
        """
    ...
    def gi_software_image_id(self, gi_software_image_id):
        """
        Sets the gi_software_image_id of this BaseccVmClusterUpdateDetails.
        The `OCID`__ of a grid infrastructure software image. This is a database software image of the type `GRID_IMAGE`.

        __ https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm


        :param gi_software_image_id: The gi_software_image_id of this BaseccVmClusterUpdateDetails.
        :type: str
        """
