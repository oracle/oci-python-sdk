...
class RestoreDatabaseDetails(object):
    ...
    def database_scn(self):
        ...
        Database internally tracks all the commits via a monotonically increasing number (SCN). This restores the database back to the SCN number provided. The default value is null.
    ...
    def latest(self):
        ...
        Restores the database to the latest state possible. The default value is false.
    ...
    def timestamp(self):
        ...
        Any valid timestamp within the recovery window of the database from which the database is to be restored to. The default value is null.
