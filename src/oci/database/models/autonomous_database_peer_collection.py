...
class AutonomousDatabasePeerCollection(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new AutonomousDatabasePeerCollection object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param items:
            The value to assign to the items property of this AutonomousDatabasePeerCollection.
        :type items: list[oci.database.models.AutonomousDatabasePeerSummary]

        """
        self.swagger_types = {
            'items': 'list[AutonomousDatabasePeerSummary]'
        }
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this AutonomousDatabasePeerCollection.
        ...
        :rtype: list[oci.database.models.AutonomousDatabasePeerSummary]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.database.models.AutonomousDatabasePeerSummary]
        """
        self._items = items
