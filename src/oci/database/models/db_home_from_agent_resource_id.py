...
class DbHomeFromAgentResourceId(object):
    """
    DbHomeFromAgentResourceId model.
    """

    #: A constant which can be used with the lifecycle_state property of a DbHomeFromAgentResourceId.
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new DbHomeFromAgentResourceId object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param id:
            The value to assign to the id property of this DbHomeFromAgentResourceId.
        :type id: str

        :param compartment_id:
            The value to assign to the compartment_id property of this DbHomeFromAgentResourceId.
        :type compartment_id: str

        :param display_name:
            The value to assign to the display_name property of this DbHomeFromAgentResourceId.
        :type display_name: str

        :param last_patch_history_entry_id:
            The value to assign to the last_patch_history_entry_id property of this DbHomeFromAgentResourceId.
        :type last_patch_history_entry_id: str

        :param lifecycle_state:
            The value to assign to the lifecycle_state property of this DbHomeFromAgentResourceId.
            Allowed values for this property are: "PROVISIONING", "AVAILABLE", "UPDATING", "TERMINATING", "TERMINATED", "FAILED"
        :type lifecycle_state: str

        :param db_system_id:
            The value to assign to the db_system_id property of this DbHomeFromAgentResourceId.
        :type db_system_id: str

        :param vm_cluster_id:
            The value to assign to the vm_cluster_id property of this DbHomeFromAgentResourceId.
        :type vm_cluster_id: str

        :param db_version:
            The value to assign to the db_version property of this DbHomeFromAgentResourceId.
        :type db_version: str

        :param db_home_location:
            The value to assign to the db_home_location property of this DbHomeFromAgentResourceId.
        :type db_home_location: str

        :param lifecycle_details:
            The value to assign to the lifecycle_details property of this DbHomeFromAgentResourceId.
        :type lifecycle_details: str

        :param time_created:
            The value to assign to the time_created property of this DbHomeFromAgentResourceId.
        :type time_created: datetime

        :param kms_key_id:
            The value to assign to the kms_key_id property of this DbHomeFromAgentResourceId.
        :type kms_key_id: str

        :param one_off_patches:
            The value to assign to the one_off_patches property of this DbHomeFromAgentResourceId.
        :type one_off_patches: list[str]

        :param freeform_tags:
            The value to assign to the freeform_tags property of this DbHomeFromAgentResourceId.
        :type freeform_tags: dict(str, str)

        :param defined_tags:
            The value to assign to the defined_tags property of this DbHomeFromAgentResourceId.
    ...
    def display_name(self):
        """
        **[Required]** Gets the display_name of this DbHomeFromAgentResourceId.
        The user-provided name for the Database Home. The name does not need to be unique.


        :return: The display_name of this DbHomeFromAgentResourceId.
        :rtype: str
        """
    ...
    def display_name(self, display_name):
        """
        Sets the display_name of this DbHomeFromAgentResourceId.
        The user-provided name for the Database Home. The name does not need to be unique.


        :param display_name: The display_name of this DbHomeFromAgentResourceId.
        :type: str
        """
    ...
    def lifecycle_state(self):
        """
        **[Required]** Gets the lifecycle_state of this DbHomeFromAgentResourceId.
        The current state of the Database Home.

        Allowed values for this property are: "PROVISIONING", "AVAILABLE", "UPDATING", "TERMINATING", "TERMINATED", "FAILED"


        :return: The lifecycle_state of this DbHomeFromAgentResourceId.
        :rtype: str
        """
    ...
    def lifecycle_state(self, lifecycle_state):
        """
        Sets the lifecycle_state of this DbHomeFromAgentResourceId.
        The current state of the Database Home.


        :param lifecycle_state: The lifecycle_state of this DbHomeFromAgentResourceId.
        :type: str
        """
    ...
    def db_version(self):
        """
        **[Required]** Gets the db_version of this DbHomeFromAgentResourceId.
        The Oracle Database version.


        :return: The db_version of this DbHomeFromAgentResourceId.
        :rtype: str
        """
    ...
    def db_version(self, db_version):
        """
        Sets the db_version of this DbHomeFromAgentResourceId.
        The Oracle Database version.


        :param db_version: The db_version of this DbHomeFromAgentResourceId.
        :type: str
        """
    ...
    def db_home_location(self):
        """
        **[Required]** Gets the db_home_location of this DbHomeFromAgentResourceId.
        The location of the Oracle Database Home.


        :return: The db_home_location of this DbHomeFromAgentResourceId.
        :rtype: str
        """
    ...
    def db_home_location(self, db_home_location):
        """
        Sets the db_home_location of this DbHomeFromAgentResourceId.
        The location of the Oracle Database Home.


        :param db_home_location: The db_home_location of this DbHomeFromAgentResourceId.
        :type: str
        """
    ...
    def lifecycle_details(self):
        """
        Gets the lifecycle_details of this DbHomeFromAgentResourceId.
        Additional information about the current lifecycle state.


        :return: The lifecycle_details of this DbHomeFromAgentResourceId.
        :rtype: str
        """
    ...
    def lifecycle_details(self, lifecycle_details):
        """
        Sets the lifecycle_details of this DbHomeFromAgentResourceId.
        Additional information about the current lifecycle state.


        :param lifecycle_details: The lifecycle_details of this DbHomeFromAgentResourceId.
        :type: str
        """
    ...
    def time_created(self):
        """
        Gets the time_created of this DbHomeFromAgentResourceId.
        The date and time the Database Home was created.


        :return: The time_created of this DbHomeFromAgentResourceId.
        :rtype: datetime
        """
    ...
    def time_created(self, time_created):
        """
        Sets the time_created of this DbHomeFromAgentResourceId.
        The date and time the Database Home was created.


        :param time_created: The time_created of this DbHomeFromAgentResourceId.
        :type: datetime
        """
    ...
    def kms_key_id(self):
        """
        Gets the kms_key_id of this DbHomeFromAgentResourceId.
        The OCID of the key container that is used as the master encryption key in database transparent data encryption (TDE) operations.


        :return: The kms_key_id of this DbHomeFromAgentResourceId.
        :rtype: str
        """
    ...
    def kms_key_id(self, kms_key_id):
        """
        Sets the kms_key_id of this DbHomeFromAgentResourceId.
        The OCID of the key container that is used as the master encryption key in database transparent data encryption (TDE) operations.


        :param kms_key_id: The kms_key_id of this DbHomeFromAgentResourceId.
        :type: str
        """
    ...
    def one_off_patches(self):
        """
        Gets the one_off_patches of this DbHomeFromAgentResourceId.
        List of one-off patches for Database Homes.


        :return: The one_off_patches of this DbHomeFromAgentResourceId.
        :rtype: list[str]
        """
    ...
    def one_off_patches(self, one_off_patches):
        """
        Sets the one_off_patches of this DbHomeFromAgentResourceId.
        List of one-off patches for Database Homes.


        :param one_off_patches: The one_off_patches of this DbHomeFromAgentResourceId.
        :type: list[str]
        """
    ...
    def freeform_tags(self):
        """
        Gets the freeform_tags of this DbHomeFromAgentResourceId.
    ...
    def freeform_tags(self, freeform_tags):
        """
        Sets the freeform_tags of this DbHomeFromAgentResourceId.
        Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace.
        For more information, see `Resource Tags`__.
    ...
    def defined_tags(self):
        """
        Gets the defined_tags of this DbHomeFromAgentResourceId.
    ...
    def defined_tags(self, defined_tags):
        """
        Sets the defined_tags of this DbHomeFromAgentResourceId.
        Defined tags for this resource. Each key is predefined and scoped to a namespace.
        For more information, see `Resource Tags`__.
