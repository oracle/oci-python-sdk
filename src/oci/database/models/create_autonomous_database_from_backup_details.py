...
class CreateAutonomousDatabaseFromBackupDetails(CreateAutonomousDatabaseBase):
    ...
    def __init__(self, **kwargs):
        ...
        :param character_set:
            The value to assign to the character_set property of this CreateAutonomousDatabaseFromBackupDetails.
        :type character_set: str

        :param ncharacter_set:
            The value to assign to the ncharacter_set property of this CreateAutonomousDatabaseFromBackupDetails.
        ...
        :param compute_model:
            The value to assign to the compute_model property of this CreateAutonomousDatabaseFromBackupDetails.
            Allowed values for this property are: "ECPU", "OCPU"
        :type compute_model: str

        :param compute_count:
            The value to assign to the compute_count property of this CreateAutonomousDatabaseFromBackupDetails.
        :type compute_count: float

        :param ocpu_count:
            The value to assign to the ocpu_count property of this CreateAutonomousDatabaseFromBackupDetails.
        ...
        :param data_storage_size_in_gbs:
            The value to assign to the data_storage_size_in_gbs property of this CreateAutonomousDatabaseFromBackupDetails.
        ...
        :param is_local_data_guard_enabled:
            The value to assign to the is_local_data_guard_enabled property of this CreateAutonomousDatabaseFromBackupDetails.
        ...
        :param private_endpoint_ip:
            The value to assign to the private_endpoint_ip property of this CreateAutonomousDatabaseFromBackupDetails.
        ...
        :param is_mtls_connection_required:
            The value to assign to the is_mtls_connection_required property of this CreateAutonomousDatabaseFromBackupDetails.
        ...
        :param is_auto_scaling_for_storage_enabled:
            The value to assign to the is_auto_scaling_for_storage_enabled property of this CreateAutonomousDatabaseFromBackupDetails.
        :type is_auto_scaling_for_storage_enabled: bool

        :param max_cpu_core_count:
            The value to assign to the max_cpu_core_count property of this CreateAutonomousDatabaseFromBackupDetails.
        :type max_cpu_core_count: int

        :param database_edition:
            The value to assign to the database_edition property of this CreateAutonomousDatabaseFromBackupDetails.
