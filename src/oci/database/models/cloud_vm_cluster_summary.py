...
class CloudVmClusterSummary(object):
    ...
    def data_collection_options(self):
        """
        Gets the data_collection_options of this CloudVmClusterSummary.

        :return: The data_collection_options of this CloudVmClusterSummary.
    ...
    def data_collection_options(self, data_collection_options):
        """
        Sets the data_collection_options of this CloudVmClusterSummary.

        :param data_collection_options: The data_collection_options of this CloudVmClusterSummary.
