    ...
    **Warning:** Oracle recommends that you avoid using any confidential information when you supply string values using the API.
    ...
    def __init__(self, **kwargs):
        ...
        self._redacted_field_paths = [
            ['database', 'database_admin_password'],
            ['database', 'source_tde_wallet_password'],
        ]
    ...
    def __repr__(self):
        ...
        redact_password_field(as_dict, ['database', 'database_admin_password'])
        redact_password_field(as_dict, ['database', 'source_tde_wallet_password'])
