...
class DatabaseSoftwareImageSummary(object):
    ...
    **Warning:** Oracle recommends that you avoid using any confidential information when you supply string values using the API.
    ...
    #: A constant which can be used with the image_shape_family property of a DatabaseSoftwareImageSummary.
    #: This constant has a value of "BDBCC_SHAPE"
    IMAGE_SHAPE_FAMILY_BDBCC_SHAPE = "BDBCC_SHAPE"
    ...
    def __init__(self, **kwargs):
        ...
        :param image_shape_family:
            ...
            Allowed values for this property are: "VM_BM_SHAPE", "EXADATA_SHAPE", "EXACC_SHAPE", "EXADBXS_SHAPE", "BDBCC_SHAPE", 'UNKNOWN_ENUM_VALUE'.
            Any unrecognized values returned by a service will be mapped to 'UNKNOWN_ENUM_VALUE'.
    ...
    def image_shape_family(self, image_shape_family):
        ...
        :type: str
        """
        allowed_values = ["VM_BM_SHAPE", "EXADATA_SHAPE", "EXACC_SHAPE", "EXADBXS_SHAPE", "BDBCC_SHAPE"]
