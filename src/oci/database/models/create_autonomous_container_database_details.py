...
class CreateAutonomousContainerDatabaseDetails(CreateAutonomousContainerDatabaseBase):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new CreateAutonomousContainerDatabaseDetails object with values from keyword arguments. The default value of the :py:attr:`~oci.database.models.CreateAutonomousContainerDatabaseDetails.source` attribute
        ...
        :param okv_end_point_group_name:
            The value to assign to the okv_end_point_group_name property of this CreateAutonomousContainerDatabaseDetails.
        ...
        :param encryption_key_location_details:
            The value to assign to the encryption_key_location_details property of this CreateAutonomousContainerDatabaseDetails.
