...
class AttachDatastoreClusterToEsxiHostDetails(object):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new AttachDatastoreClusterToEsxiHostDetails object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param esxi_host_id:
            The value to assign to the esxi_host_id property of this AttachDatastoreClusterToEsxiHostDetails.
    ...
    def esxi_host_id(self, esxi_host_id):
        """
        Sets the esxi_host_id of this AttachDatastoreClusterToEsxiHostDetails.
        The `OCID`__ of the ESXi host to attach the
        datastore cluster to.
