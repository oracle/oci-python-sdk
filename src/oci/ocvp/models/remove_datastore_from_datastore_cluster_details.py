...
class RemoveDatastoreFromDatastoreClusterDetails(object):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new RemoveDatastoreFromDatastoreClusterDetails object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param datastore_ids:
            The value to assign to the datastore_ids property of this RemoveDatastoreFromDatastoreClusterDetails.
    ...
    def datastore_ids(self):
        ...
        **[Required]** Gets the datastore_ids of this RemoveDatastoreFromDatastoreClusterDetails.
        ...
        :return: The datastore_ids of this RemoveDatastoreFromDatastoreClusterDetails.
        :rtype: list[str]
        """
    ...
    def datastore_ids(self, datastore_ids):
        """
        Sets the datastore_ids of this RemoveDatastoreFromDatastoreClusterDetails.
        A list of datastores to be removed.


        :param datastore_ids: The datastore_ids of this RemoveDatastoreFromDatastoreClusterDetails.
        :type: list[str]
        """
