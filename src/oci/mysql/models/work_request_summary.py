...
class WorkRequestSummary(object):
    ...
    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "GENERATE_DBSYSTEM_STATUS"
    OPERATION_TYPE_GENERATE_DBSYSTEM_STATUS = "GENERATE_DBSYSTEM_STATUS"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "GENERATE_CHANNEL_STATUS"
    OPERATION_TYPE_GENERATE_CHANNEL_STATUS = "GENERATE_CHANNEL_STATUS"
    ...
    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "CREATE_BLUE_GREEN_DEPLOYMENT"
    OPERATION_TYPE_CREATE_BLUE_GREEN_DEPLOYMENT = "CREATE_BLUE_GREEN_DEPLOYMENT"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "UPDATE_BLUE_GREEN_DEPLOYMENT"
    OPERATION_TYPE_UPDATE_BLUE_GREEN_DEPLOYMENT = "UPDATE_BLUE_GREEN_DEPLOYMENT"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "DELETE_BLUE_GREEN_DEPLOYMENT"
    OPERATION_TYPE_DELETE_BLUE_GREEN_DEPLOYMENT = "DELETE_BLUE_GREEN_DEPLOYMENT"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "CHANGE_BLUE_GREEN_DEPLOYMENT_COMPARTMENT"
    OPERATION_TYPE_CHANGE_BLUE_GREEN_DEPLOYMENT_COMPARTMENT = "CHANGE_BLUE_GREEN_DEPLOYMENT_COMPARTMENT"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "SWITCHOVER_BLUE_GREEN_DEPLOYMENT"
    OPERATION_TYPE_SWITCHOVER_BLUE_GREEN_DEPLOYMENT = "SWITCHOVER_BLUE_GREEN_DEPLOYMENT"
    ...
    def __init__(self, **kwargs):
        ...
        :param operation_type:
            ...
            Allowed values for this property are: "CREATE_DBSYSTEM", "UPDATE_DBSYSTEM", "DELETE_DBSYSTEM", "START_DBSYSTEM", "STOP_DBSYSTEM", "RESTART_DBSYSTEM", "ADD_HEATWAVE_CLUSTER", "UPDATE_HEATWAVE_CLUSTER", "DELETE_HEATWAVE_CLUSTER", "START_HEATWAVE_CLUSTER", "STOP_HEATWAVE_CLUSTER", "RESTART_HEATWAVE_CLUSTER", "GENERATE_HEATWAVE_CLUSTER_MEMORY_ESTIMATE", "GENERATE_DBSYSTEM_STATUS", "GENERATE_CHANNEL_STATUS", "CREATE_REPLICA", "UPDATE_REPLICA", "DELETE_REPLICA", "CREATE_CHANNEL", "UPDATE_CHANNEL", "RESUME_CHANNEL", "RESET_CHANNEL", "DELETE_CHANNEL", "COPY_BACKUP", "CREATE_BACKUP", "DELETE_BACKUP", "UPDATE_BACKUP", "EXPORT_BACKUP", "CREATE_BLUE_GREEN_DEPLOYMENT", "UPDATE_BLUE_GREEN_DEPLOYMENT", "DELETE_BLUE_GREEN_DEPLOYMENT", "CHANGE_BLUE_GREEN_DEPLOYMENT_COMPARTMENT", "SWITCHOVER_BLUE_GREEN_DEPLOYMENT", 'UNKNOWN_ENUM_VALUE'.
