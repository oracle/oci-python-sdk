...
class UpdateBackupDetails(object):
    ...
    def retention_in_days(self):
        """
        Gets the retention_in_days of this UpdateBackupDetails.
        The number of days backups are retained.


        :return: The retention_in_days of this UpdateBackupDetails.
        :rtype: int
        """
    ...
    def retention_in_days(self, retention_in_days):
        """
        Sets the retention_in_days of this UpdateBackupDetails.
        The number of days backups are retained.


        :param retention_in_days: The retention_in_days of this UpdateBackupDetails.
        :type: int
        """
