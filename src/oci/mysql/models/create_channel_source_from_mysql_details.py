...
class CreateChannelSourceFromMysqlDetails(CreateChannelSourceDetails):
    ...
    def anonymous_transactions_handling(self):
        ...
        :return: The anonymous_transactions_handling of this CreateChannelSourceFromMysqlDetails.
    ...
    def anonymous_transactions_handling(self, anonymous_transactions_handling):
        """
        Sets the anonymous_transactions_handling of this CreateChannelSourceFromMysqlDetails.

        :param anonymous_transactions_handling: The anonymous_transactions_handling of this CreateChannelSourceFromMysqlDetails.
