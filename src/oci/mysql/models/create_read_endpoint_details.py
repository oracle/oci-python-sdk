...
class CreateReadEndpointDetails(object):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new CreateReadEndpointDetails object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param is_enabled:
            The value to assign to the is_enabled property of this CreateReadEndpointDetails.
        :type is_enabled: bool

        :param read_endpoint_ip_address:
            The value to assign to the read_endpoint_ip_address property of this CreateReadEndpointDetails.
        :type read_endpoint_ip_address: str

        :param read_endpoint_ipv6_address_ipv6_subnet_cidr_pair_details:
            The value to assign to the read_endpoint_ipv6_address_ipv6_subnet_cidr_pair_details property of this CreateReadEndpointDetails.
        ...
        :param read_endpoint_hostname_label:
            The value to assign to the read_endpoint_hostname_label property of this CreateReadEndpointDetails.
        :type read_endpoint_hostname_label: str

        :param exclude_ips:
            The value to assign to the exclude_ips property of this CreateReadEndpointDetails.
    ...
    def is_enabled(self):
        """
        Gets the is_enabled of this CreateReadEndpointDetails.
        Specifies if the DB System read endpoint is enabled or not.


        :return: The is_enabled of this CreateReadEndpointDetails.
        :rtype: bool
        """
    ...
    def is_enabled(self, is_enabled):
        """
        Sets the is_enabled of this CreateReadEndpointDetails.
        Specifies if the DB System read endpoint is enabled or not.


        :param is_enabled: The is_enabled of this CreateReadEndpointDetails.
        :type: bool
        """
    ...
    def read_endpoint_ip_address(self):
        """
        Gets the read_endpoint_ip_address of this CreateReadEndpointDetails.
        ...
        :return: The read_endpoint_ip_address of this CreateReadEndpointDetails.
        :rtype: str
        """
    ...
    def read_endpoint_ip_address(self, read_endpoint_ip_address):
        """
        Sets the read_endpoint_ip_address of this CreateReadEndpointDetails.
        The IP address the DB System read endpoint is configured to listen on.
        A private IP address of your choice to assign to the read endpoint of the DB System.
        Must be an available IP address within the subnet's CIDR. If you don't specify a value,
        Oracle automatically assigns a private IP address from the subnet. This should be a
        ...
        :param read_endpoint_ip_address: The read_endpoint_ip_address of this CreateReadEndpointDetails.
        :type: str
        """
    ...
    def read_endpoint_ipv6_address_ipv6_subnet_cidr_pair_details(self):
        """
        Gets the read_endpoint_ipv6_address_ipv6_subnet_cidr_pair_details of this CreateReadEndpointDetails.

        :return: The read_endpoint_ipv6_address_ipv6_subnet_cidr_pair_details of this CreateReadEndpointDetails.
    ...
    def read_endpoint_ipv6_address_ipv6_subnet_cidr_pair_details(self, read_endpoint_ipv6_address_ipv6_subnet_cidr_pair_details):
        """
        Sets the read_endpoint_ipv6_address_ipv6_subnet_cidr_pair_details of this CreateReadEndpointDetails.

        :param read_endpoint_ipv6_address_ipv6_subnet_cidr_pair_details: The read_endpoint_ipv6_address_ipv6_subnet_cidr_pair_details of this CreateReadEndpointDetails.
    ...
    def read_endpoint_hostname_label(self):
        """
        Gets the read_endpoint_hostname_label of this CreateReadEndpointDetails.
        ...
        :return: The read_endpoint_hostname_label of this CreateReadEndpointDetails.
        :rtype: str
        """
    ...
    def read_endpoint_hostname_label(self, read_endpoint_hostname_label):
        """
        Sets the read_endpoint_hostname_label of this CreateReadEndpointDetails.
        The hostname for the read endpoint of the DB System. Used for DNS.
        ...
        :param read_endpoint_hostname_label: The read_endpoint_hostname_label of this CreateReadEndpointDetails.
        :type: str
        """
    ...
    def exclude_ips(self):
        """
        Gets the exclude_ips of this CreateReadEndpointDetails.
        A list of IP addresses of read replicas that are excluded from serving read requests.


        :return: The exclude_ips of this CreateReadEndpointDetails.
        :rtype: list[str]
        """
    ...
    def exclude_ips(self, exclude_ips):
        """
        Sets the exclude_ips of this CreateReadEndpointDetails.
        A list of IP addresses of read replicas that are excluded from serving read requests.


        :param exclude_ips: The exclude_ips of this CreateReadEndpointDetails.
        :type: list[str]
        """
