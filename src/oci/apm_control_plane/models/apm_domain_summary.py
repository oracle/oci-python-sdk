...
class ApmDomainSummary(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ApmDomainSummary object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param id:
            The value to assign to the id property of this ApmDomainSummary.
        :type id: str

        :param display_name:
            The value to assign to the display_name property of this ApmDomainSummary.
        :type display_name: str

        :param description:
            The value to assign to the description property of this ApmDomainSummary.
        :type description: str

        :param compartment_id:
            The value to assign to the compartment_id property of this ApmDomainSummary.
        ...
        :param time_updated:
            The value to assign to the time_updated property of this ApmDomainSummary.
        :type time_updated: datetime

        :param freeform_tags:
            The value to assign to the freeform_tags property of this ApmDomainSummary.
        :type freeform_tags: dict(str, str)

        :param defined_tags:
            The value to assign to the defined_tags property of this ApmDomainSummary.
    ...
    def id(self):
        """
        **[Required]** Gets the id of this ApmDomainSummary.
        Unique identifier that is immutable on creation.


        :return: The id of this ApmDomainSummary.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        """
        Sets the id of this ApmDomainSummary.
        Unique identifier that is immutable on creation.


        :param id: The id of this ApmDomainSummary.
        :type: str
        """
        self._id = id
    ...
    def lifecycle_state(self):
        ...
        :return: The lifecycle_state of this ApmDomainSummary.
        :rtype: str
        """
    ...
    def is_free_tier(self):
        """
        Gets the is_free_tier of this ApmDomainSummary.
        Indicates if this is an Always Free resource.


        :return: The is_free_tier of this ApmDomainSummary.
        :rtype: bool
        """
    ...
    def is_free_tier(self, is_free_tier):
        """
        Sets the is_free_tier of this ApmDomainSummary.
        Indicates if this is an Always Free resource.


        :param is_free_tier: The is_free_tier of this ApmDomainSummary.
        :type: bool
        """
    ...
    def freeform_tags(self):
        """
        Gets the freeform_tags of this ApmDomainSummary.
        Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only.
        Example: `{\"bar-key\": \"value\"}`


        :return: The freeform_tags of this ApmDomainSummary.
        :rtype: dict(str, str)
        """
    ...
    def freeform_tags(self, freeform_tags):
        """
        Sets the freeform_tags of this ApmDomainSummary.
        Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only.
        Example: `{\"bar-key\": \"value\"}`


        :param freeform_tags: The freeform_tags of this ApmDomainSummary.
        :type: dict(str, str)
        """
    ...
    def defined_tags(self):
        """
        Gets the defined_tags of this ApmDomainSummary.
        Defined tags for this resource. Each key is predefined and scoped to a namespace.
        Example: `{\"foo-namespace\": {\"bar-key\": \"value\"}}`


        :return: The defined_tags of this ApmDomainSummary.
    ...
    def defined_tags(self, defined_tags):
        """
        Sets the defined_tags of this ApmDomainSummary.
        Defined tags for this resource. Each key is predefined and scoped to a namespace.
        Example: `{\"foo-namespace\": {\"bar-key\": \"value\"}}`


        :param defined_tags: The defined_tags of this ApmDomainSummary.
