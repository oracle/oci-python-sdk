...
class WorkRequest(object):
    ...
    #: This constant has a value of "CREATE_APM_DOMAIN"
    OPERATION_TYPE_CREATE_APM_DOMAIN = "CREATE_APM_DOMAIN"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "UPDATE_APM_DOMAIN"
    OPERATION_TYPE_UPDATE_APM_DOMAIN = "UPDATE_APM_DOMAIN"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "DELETE_APM_DOMAIN"
    OPERATION_TYPE_DELETE_APM_DOMAIN = "DELETE_APM_DOMAIN"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "GENERATE_DATA_KEYS"
    OPERATION_TYPE_GENERATE_DATA_KEYS = "GENERATE_DATA_KEYS"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "REMOVE_DATA_KEYS"
    OPERATION_TYPE_REMOVE_DATA_KEYS = "REMOVE_DATA_KEYS"
    ...
    def __init__(self, **kwargs):
        ...
        :type resources: list[oci.apm_control_plane.models.WorkRequestResource]
    ...
    def operation_type(self, operation_type):
        ...
        :type: str
        """
        allowed_values = ["CREATE_APM_DOMAIN", "UPDATE_APM_DOMAIN", "DELETE_APM_DOMAIN", "GENERATE_DATA_KEYS", "REMOVE_DATA_KEYS"]
    ...
    def resources(self):
        ...
        **[Required]** Gets the resources of this WorkRequest.
        ...
        :rtype: list[oci.apm_control_plane.models.WorkRequestResource]
        """
    ...
    def resources(self, resources):
        ...
        :type: list[oci.apm_control_plane.models.WorkRequestResource]
        """
