...
class BaseDomainDetails(object):
    ...
    def __init__(self, **kwargs):
        ...
        :param log_group_id:
            The value to assign to the log_group_id property of this BaseDomainDetails.
    ...
    def log_group_id(self, log_group_id):
        """
        Sets the log_group_id of this BaseDomainDetails.
        The OCID of the Log Analytics log group to which the data uploaded to this APM domain will be mapped to.


        :param log_group_id: The log_group_id of this BaseDomainDetails.
        :type: str
        """
