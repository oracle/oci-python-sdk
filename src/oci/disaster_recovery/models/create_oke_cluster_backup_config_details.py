...
class CreateOkeClusterBackupConfigDetails(object):
    ...
    def __init__(self, **kwargs):
        ...
        :param exclude_namespaces:
            The value to assign to the exclude_namespaces property of this CreateOkeClusterBackupConfigDetails.
    ...
    def exclude_namespaces(self):
        """
        Gets the exclude_namespaces of this CreateOkeClusterBackupConfigDetails.
        ...
        :return: The exclude_namespaces of this CreateOkeClusterBackupConfigDetails.
        :rtype: list[str]
        """
    ...
    def exclude_namespaces(self, exclude_namespaces):
        """
        Sets the exclude_namespaces of this CreateOkeClusterBackupConfigDetails.
        A list of namespaces to be excluded from the backup.
        The default value is null. If a list of namespaces to exclude is not provided, all namespaces will be backed up.
        Specify either the `namespaces` or the `excludeNamespaces` parameter, but not both.
        This property applies to OKE cluster members in the primary region.
        ...
        :param exclude_namespaces: The exclude_namespaces of this CreateOkeClusterBackupConfigDetails.
        :type: list[str]
        """
