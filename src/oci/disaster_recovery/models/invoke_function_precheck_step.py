...
class InvokeFunctionPrecheckStep(DrPlanUserDefinedStep):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new InvokeFunctionPrecheckStep object with values from keyword arguments. The default value of the :py:attr:`~oci.disaster_recovery.models.InvokeFunctionPrecheckStep.step_type` attribute
