...
class CreateDrProtectionGroupMemberOkeClusterDetails(CreateDrProtectionGroupMemberDetails):
    ...
    def __init__(self, **kwargs):
        ...
        :param resource_modifier_mappings:
            The value to assign to the resource_modifier_mappings property of this CreateDrProtectionGroupMemberOkeClusterDetails.
        :type resource_modifier_mappings: list[oci.disaster_recovery.models.CreateOkeClusterResourceModifierMappingDetails]
        ...
        self.swagger_types = {
            ...
            'resource_modifier_mappings': 'list[CreateOkeClusterResourceModifierMappingDetails]'
        }
        self.attribute_map = {
            'member_id': 'memberId',
    ...
    def resource_modifier_mappings(self):
        """
        Gets the resource_modifier_mappings of this CreateDrProtectionGroupMemberOkeClusterDetails.
        The list of config maps along with their corresponding namespaces.
        This property applies to the OKE cluster member in primary region.


        :return: The resource_modifier_mappings of this CreateDrProtectionGroupMemberOkeClusterDetails.
        :rtype: list[oci.disaster_recovery.models.CreateOkeClusterResourceModifierMappingDetails]
        """
    ...
    def resource_modifier_mappings(self, resource_modifier_mappings):
        """
        Sets the resource_modifier_mappings of this CreateDrProtectionGroupMemberOkeClusterDetails.
        The list of config maps along with their corresponding namespaces.
        This property applies to the OKE cluster member in primary region.


        :param resource_modifier_mappings: The resource_modifier_mappings of this CreateDrProtectionGroupMemberOkeClusterDetails.
        :type: list[oci.disaster_recovery.models.CreateOkeClusterResourceModifierMappingDetails]
        """
