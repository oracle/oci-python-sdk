...
class CreateDrProtectionGroupMemberFileSystemDetails(CreateDrProtectionGroupMemberDetails):
    ...
    def __init__(self, **kwargs):
        ...
        :param destination_compartment_id:
            The value to assign to the destination_compartment_id property of this CreateDrProtectionGroupMemberFileSystemDetails.
    ...
    def destination_compartment_id(self):
        """
        Gets the destination_compartment_id of this CreateDrProtectionGroupMemberFileSystemDetails.
        The OCID of a compartment in the destination region in which the file system should be launched.

        Example: `ocid1.compartment.oc1..uniqueID`


        :return: The destination_compartment_id of this CreateDrProtectionGroupMemberFileSystemDetails.
        :rtype: str
        """
    ...
    def destination_compartment_id(self, destination_compartment_id):
        """
        Sets the destination_compartment_id of this CreateDrProtectionGroupMemberFileSystemDetails.
        The OCID of a compartment in the destination region in which the file system should be launched.

        Example: `ocid1.compartment.oc1..uniqueID`


        :param destination_compartment_id: The destination_compartment_id of this CreateDrProtectionGroupMemberFileSystemDetails.
        :type: str
        """
