...
class UpdateDrProtectionGroupMemberAutonomousContainerDatabaseDetails(UpdateDrProtectionGroupMemberDetails):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new UpdateDrProtectionGroupMemberAutonomousContainerDatabaseDetails object with values from keyword arguments. The default value of the :py:attr:`~oci.disaster_recovery.models.UpdateDrProtectionGroupMemberAutonomousContainerDatabaseDetails.member_type` attribute
        of this class is ``AUTONOMOUS_CONTAINER_DATABASE`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param member_id:
            The value to assign to the member_id property of this UpdateDrProtectionGroupMemberAutonomousContainerDatabaseDetails.
        :type member_id: str

        :param member_type:
            The value to assign to the member_type property of this UpdateDrProtectionGroupMemberAutonomousContainerDatabaseDetails.
        ...
        :param connection_string_type:
            The value to assign to the connection_string_type property of this UpdateDrProtectionGroupMemberAutonomousContainerDatabaseDetails.
    ...
    def connection_string_type(self):
        """
        Gets the connection_string_type of this UpdateDrProtectionGroupMemberAutonomousContainerDatabaseDetails.
        ...
        :return: The connection_string_type of this UpdateDrProtectionGroupMemberAutonomousContainerDatabaseDetails.
        :rtype: str
        """
    ...
    def connection_string_type(self, connection_string_type):
        """
        Sets the connection_string_type of this UpdateDrProtectionGroupMemberAutonomousContainerDatabaseDetails.
        The type of connection strings used to connect to an Autonomous Container Database snapshot standby created during a DR Drill operation.
        See https://docs.oracle.com/en/cloud/paas/autonomous-database/dedicated/adbcl/index.html for information about these service types.


        :param connection_string_type: The connection_string_type of this UpdateDrProtectionGroupMemberAutonomousContainerDatabaseDetails.
        :type: str
        """
