...
class UpdateDrProtectionGroupMemberDatabaseDetails(UpdateDrProtectionGroupMemberDetails):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new UpdateDrProtectionGroupMemberDatabaseDetails object with values from keyword arguments. The default value of the :py:attr:`~oci.disaster_recovery.models.UpdateDrProtectionGroupMemberDatabaseDetails.member_type` attribute
        of this class is ``DATABASE`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param member_id:
            The value to assign to the member_id property of this UpdateDrProtectionGroupMemberDatabaseDetails.
        :type member_id: str
        ...
        :param password_vault_secret_id:
            The value to assign to the password_vault_secret_id property of this UpdateDrProtectionGroupMemberDatabaseDetails.
