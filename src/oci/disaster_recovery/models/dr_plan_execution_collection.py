...
class DrPlanExecutionCollection(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new DrPlanExecutionCollection object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param items:
            The value to assign to the items property of this DrPlanExecutionCollection.
        :type items: list[oci.disaster_recovery.models.DrPlanExecutionSummary]

        """
        self.swagger_types = {
            'items': 'list[DrPlanExecutionSummary]'
        }
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this DrPlanExecutionCollection.
        ...
        :rtype: list[oci.disaster_recovery.models.DrPlanExecutionSummary]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.disaster_recovery.models.DrPlanExecutionSummary]
        """
        self._items = items
