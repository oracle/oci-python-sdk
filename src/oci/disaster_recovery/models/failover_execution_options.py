...
class FailoverExecutionOptions(DrPlanExecutionOptions):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new FailoverExecutionOptions object with values from keyword arguments. The default value of the :py:attr:`~oci.disaster_recovery.models.FailoverExecutionOptions.plan_execution_type` attribute
        of this class is ``FAILOVER`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param plan_execution_type:
            The value to assign to the plan_execution_type property of this FailoverExecutionOptions.
        ...
        :param are_prechecks_enabled:
            The value to assign to the are_prechecks_enabled property of this FailoverExecutionOptions.
        :type are_prechecks_enabled: bool

        :param are_warnings_ignored:
            The value to assign to the are_warnings_ignored property of this FailoverExecutionOptions.
    ...
    def are_prechecks_enabled(self):
        """
        Gets the are_prechecks_enabled of this FailoverExecutionOptions.
        A flag indicating whether a precheck was executed before the plan.

        Example: `true`


        :return: The are_prechecks_enabled of this FailoverExecutionOptions.
        :rtype: bool
        """
    ...
    def are_prechecks_enabled(self, are_prechecks_enabled):
        """
        Sets the are_prechecks_enabled of this FailoverExecutionOptions.
        A flag indicating whether a precheck was executed before the plan.

        Example: `true`


        :param are_prechecks_enabled: The are_prechecks_enabled of this FailoverExecutionOptions.
        :type: bool
        """
    ...
    def are_warnings_ignored(self):
        """
        Gets the are_warnings_ignored of this FailoverExecutionOptions.
        A flag indicating whether warnigs was ignored during the failover.

        Example: `false`


        :return: The are_warnings_ignored of this FailoverExecutionOptions.
        :rtype: bool
        """
    ...
    def are_warnings_ignored(self, are_warnings_ignored):
        """
        Sets the are_warnings_ignored of this FailoverExecutionOptions.
        A flag indicating whether warnigs was ignored during the failover.

        Example: `false`


        :param are_warnings_ignored: The are_warnings_ignored of this FailoverExecutionOptions.
        :type: bool
        """
