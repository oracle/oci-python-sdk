...
class DisassociateDrProtectionGroupDetails(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new DisassociateDrProtectionGroupDetails object with values from keyword arguments. This class has the following subclasses and if you are using this class as input
        to a service operations then you should favor using a subclass over the base class:

        * :class:`~oci.disaster_recovery.models.DisassociateDrProtectionGroupDefaultDetails`

        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param type:
            The value to assign to the type property of this DisassociateDrProtectionGroupDetails.
    ...
    def get_subtype(object_dictionary):
        ...
        if type == 'DEFAULT':
            return 'DisassociateDrProtectionGroupDefaultDetails'
        else:
    ...
    def type(self):
        ...
        **[Required]** Gets the type of this DisassociateDrProtectionGroupDetails.
        ...
        :return: The type of this DisassociateDrProtectionGroupDetails.
        :rtype: str
        """
        return self._type
