...
class RunObjectStoreScriptUserDefinedStep(DrPlanUserDefinedStep):
    ...
    def __init__(self, **kwargs):
        ...
        :param script_command:
            The value to assign to the script_command property of this RunObjectStoreScriptUserDefinedStep.
        :type script_command: str

        :param run_as_user:
            The value to assign to the run_as_user property of this RunObjectStoreScriptUserDefinedStep.
    ...
    def script_command(self):
        """
        Gets the script_command of this RunObjectStoreScriptUserDefinedStep.
        ...
        :return: The script_command of this RunObjectStoreScriptUserDefinedStep.
        :rtype: str
        """
    ...
    def script_command(self, script_command):
        """
        Sets the script_command of this RunObjectStoreScriptUserDefinedStep.
        The entire path and arguments for the script that is stored in object store, or inside a compressed archive in object store.
        Example: `/usr/bin/python3.7 scripts/start_server.py --port 8080 --env \"production\" --max-connections 200 --log-level \"INFO\"`


        :param script_command: The script_command of this RunObjectStoreScriptUserDefinedStep.
        :type: str
        """
    ...
    def run_as_user(self):
        """
        Gets the run_as_user of this RunObjectStoreScriptUserDefinedStep.
        The user ID on the instance that will be used to execute the script specified in 'scriptCommand'.
        Example: `opc`


        :return: The run_as_user of this RunObjectStoreScriptUserDefinedStep.
        :rtype: str
        """
    ...
    def run_as_user(self, run_as_user):
        """
        Sets the run_as_user of this RunObjectStoreScriptUserDefinedStep.
        The user ID on the instance that will be used to execute the script specified in 'scriptCommand'.
        Example: `opc`


        :param run_as_user: The run_as_user of this RunObjectStoreScriptUserDefinedStep.
        :type: str
        """
