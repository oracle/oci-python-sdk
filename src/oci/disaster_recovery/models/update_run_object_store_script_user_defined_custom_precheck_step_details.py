...
class UpdateRunObjectStoreScriptUserDefinedCustomPrecheckStepDetails(UpdateDrPlanUserDefinedStepDetails):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new UpdateRunObjectStoreScriptUserDefinedCustomPrecheckStepDetails object with values from keyword arguments. The default value of the :py:attr:`~oci.disaster_recovery.models.UpdateRunObjectStoreScriptUserDefinedCustomPrecheckStepDetails.step_type` attribute
        of this class is ``RUN_OBJECTSTORE_SCRIPT_USER_DEFINED_CUSTOM_PRECHECK`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param step_type:
            The value to assign to the step_type property of this UpdateRunObjectStoreScriptUserDefinedCustomPrecheckStepDetails.
        ...
        :param run_on_instance_id:
            The value to assign to the run_on_instance_id property of this UpdateRunObjectStoreScriptUserDefinedCustomPrecheckStepDetails.
    ...
    def run_on_instance_id(self):
        """
        **[Required]** Gets the run_on_instance_id of this UpdateRunObjectStoreScriptUserDefinedCustomPrecheckStepDetails.
        ...
        **For non-moving instances:** *runOnInstanceId* must be the OCID of the non-moving instance.
        ...
        :return: The run_on_instance_id of this UpdateRunObjectStoreScriptUserDefinedCustomPrecheckStepDetails.
        :rtype: str
        """
    ...
    def run_on_instance_id(self, run_on_instance_id):
        """
        Sets the run_on_instance_id of this UpdateRunObjectStoreScriptUserDefinedCustomPrecheckStepDetails.
        The OCID of the instance on which this precjeck script or command should be executed.
        ...
        **For non-moving instances:** *runOnInstanceId* must be the OCID of the non-moving instance.
        ...
        :param run_on_instance_id: The run_on_instance_id of this UpdateRunObjectStoreScriptUserDefinedCustomPrecheckStepDetails.
        :type: str
        """
    ...
    def object_storage_script_location(self):
        """
        **[Required]** Gets the object_storage_script_location of this UpdateRunObjectStoreScriptUserDefinedCustomPrecheckStepDetails.

        :return: The object_storage_script_location of this UpdateRunObjectStoreScriptUserDefinedCustomPrecheckStepDetails.
    ...
    def object_storage_script_location(self, object_storage_script_location):
        """
        Sets the object_storage_script_location of this UpdateRunObjectStoreScriptUserDefinedCustomPrecheckStepDetails.

        :param object_storage_script_location: The object_storage_script_location of this UpdateRunObjectStoreScriptUserDefinedCustomPrecheckStepDetails.
