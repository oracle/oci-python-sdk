...
class WorkRequestErrorCollection(object):
    ...
    def __init__(self, **kwargs):
        ...
        :type items: list[oci.disaster_recovery.models.WorkRequestError]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this WorkRequestErrorCollection.
        ...
        :rtype: list[oci.disaster_recovery.models.WorkRequestError]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.disaster_recovery.models.WorkRequestError]
        """
        self._items = items
