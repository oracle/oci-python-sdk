...
class ComputeInstanceMovableVnicMappingDetails(object):
    ...
    def __init__(self, **kwargs):
        ...
        :param destination_reserved_public_ip_id:
            The value to assign to the destination_reserved_public_ip_id property of this ComputeInstanceMovableVnicMappingDetails.
    ...
    def destination_reserved_public_ip_id(self):
        """
        Gets the destination_reserved_public_ip_id of this ComputeInstanceMovableVnicMappingDetails.
        ...
        :return: The destination_reserved_public_ip_id of this ComputeInstanceMovableVnicMappingDetails.
        :rtype: str
        """
    ...
    def destination_reserved_public_ip_id(self, destination_reserved_public_ip_id):
        """
        Sets the destination_reserved_public_ip_id of this ComputeInstanceMovableVnicMappingDetails.
        The OCID of the reserved public IP address to be assigned to the compute instance in the destination region.

        Example: `ocid1.publicip.oc1..uniqueID`


        :param destination_reserved_public_ip_id: The destination_reserved_public_ip_id of this ComputeInstanceMovableVnicMappingDetails.
        :type: str
        """
