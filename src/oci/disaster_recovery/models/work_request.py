...
class WorkRequest(object):
    ...
    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "CREATE_AUTOMATIC_DR_CONFIGURATION"
    OPERATION_TYPE_CREATE_AUTOMATIC_DR_CONFIGURATION = "CREATE_AUTOMATIC_DR_CONFIGURATION"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "DELETE_AUTOMATIC_DR_CONFIGURATION"
    OPERATION_TYPE_DELETE_AUTOMATIC_DR_CONFIGURATION = "DELETE_AUTOMATIC_DR_CONFIGURATION"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "UPDATE_AUTOMATIC_DR_CONFIGURATION"
    OPERATION_TYPE_UPDATE_AUTOMATIC_DR_CONFIGURATION = "UPDATE_AUTOMATIC_DR_CONFIGURATION"
    ...
    def __init__(self, **kwargs):
        ...
        :param operation_type:
            ...
            Allowed values for this property are: "CREATE_DR_PROTECTION_GROUP", "UPDATE_DR_PROTECTION_GROUP", "DELETE_DR_PROTECTION_GROUP", "MOVE_DR_PROTECTION_GROUP", "ASSOCIATE_DR_PROTECTION_GROUP", "DISASSOCIATE_DR_PROTECTION_GROUP", "UPDATE_ROLE_DR_PROTECTION_GROUP", "CREATE_DR_PLAN", "UPDATE_DR_PLAN", "DELETE_DR_PLAN", "REFRESH_DR_PLAN", "VERIFY_DR_PLAN", "CREATE_DR_PLAN_EXECUTION", "UPDATE_DR_PLAN_EXECUTION", "DELETE_DR_PLAN_EXECUTION", "RETRY_DR_PLAN_EXECUTION", "IGNORE_DR_PLAN_EXECUTION", "CANCEL_DR_PLAN_EXECUTION", "PAUSE_DR_PLAN_EXECUTION", "RESUME_DR_PLAN_EXECUTION", "CREATE_AUTOMATIC_DR_CONFIGURATION", "DELETE_AUTOMATIC_DR_CONFIGURATION", "UPDATE_AUTOMATIC_DR_CONFIGURATION", 'UNKNOWN_ENUM_VALUE'.
