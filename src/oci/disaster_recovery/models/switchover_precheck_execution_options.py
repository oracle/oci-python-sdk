...
class SwitchoverPrecheckExecutionOptions(DrPlanExecutionOptions):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new SwitchoverPrecheckExecutionOptions object with values from keyword arguments. The default value of the :py:attr:`~oci.disaster_recovery.models.SwitchoverPrecheckExecutionOptions.plan_execution_type` attribute
        of this class is ``SWITCHOVER_PRECHECK`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param plan_execution_type:
            The value to assign to the plan_execution_type property of this SwitchoverPrecheckExecutionOptions.
        ...
        :param are_warnings_ignored:
            The value to assign to the are_warnings_ignored property of this SwitchoverPrecheckExecutionOptions.
    ...
    def are_warnings_ignored(self):
        ...
        :return: The are_warnings_ignored of this SwitchoverPrecheckExecutionOptions.
        :rtype: bool
        """
    ...
    def are_warnings_ignored(self, are_warnings_ignored):
        ...
        :param are_warnings_ignored: The are_warnings_ignored of this SwitchoverPrecheckExecutionOptions.
        :type: bool
        """
