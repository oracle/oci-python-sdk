...
class NetworkLoadBalancerBackendSetMappingDetails(object):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new NetworkLoadBalancerBackendSetMappingDetails object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param is_backend_set_for_non_movable:
            The value to assign to the is_backend_set_for_non_movable property of this NetworkLoadBalancerBackendSetMappingDetails.
        :type is_backend_set_for_non_movable: bool

        :param source_backend_set_name:
            The value to assign to the source_backend_set_name property of this NetworkLoadBalancerBackendSetMappingDetails.
        :type source_backend_set_name: str

        :param destination_backend_set_name:
            The value to assign to the destination_backend_set_name property of this NetworkLoadBalancerBackendSetMappingDetails.
    ...
    def is_backend_set_for_non_movable(self):
        """
        **[Required]** Gets the is_backend_set_for_non_movable of this NetworkLoadBalancerBackendSetMappingDetails.
        ...
        :return: The is_backend_set_for_non_movable of this NetworkLoadBalancerBackendSetMappingDetails.
        :rtype: bool
        """
    ...
    def is_backend_set_for_non_movable(self, is_backend_set_for_non_movable):
        """
        Sets the is_backend_set_for_non_movable of this NetworkLoadBalancerBackendSetMappingDetails.
        This flag specifies if this backend set is used for traffic for non-movable compute instances.
        Backend sets that point to non-movable instances are only enabled or disabled during DR, their contents
        are not altered. For non-movable instances this flag should be set to 'true'.
        Backend sets that point to movable instances are emptied and their contents are transferred to the
        ...
        :param is_backend_set_for_non_movable: The is_backend_set_for_non_movable of this NetworkLoadBalancerBackendSetMappingDetails.
        :type: bool
        """
    ...
    def source_backend_set_name(self):
        """
        **[Required]** Gets the source_backend_set_name of this NetworkLoadBalancerBackendSetMappingDetails.
        The name of the source backend set.

        Example: `Source-BackendSet-1`


        :return: The source_backend_set_name of this NetworkLoadBalancerBackendSetMappingDetails.
        :rtype: str
        """
    ...
    def source_backend_set_name(self, source_backend_set_name):
        """
        Sets the source_backend_set_name of this NetworkLoadBalancerBackendSetMappingDetails.
        The name of the source backend set.

        Example: `Source-BackendSet-1`


        :param source_backend_set_name: The source_backend_set_name of this NetworkLoadBalancerBackendSetMappingDetails.
        :type: str
        """
    ...
    def destination_backend_set_name(self):
        """
        **[Required]** Gets the destination_backend_set_name of this NetworkLoadBalancerBackendSetMappingDetails.
        The name of the destination backend set.

        Example: `Destination-BackendSet-1`


        :return: The destination_backend_set_name of this NetworkLoadBalancerBackendSetMappingDetails.
        :rtype: str
        """
    ...
    def destination_backend_set_name(self, destination_backend_set_name):
        """
        Sets the destination_backend_set_name of this NetworkLoadBalancerBackendSetMappingDetails.
        The name of the destination backend set.

        Example: `Destination-BackendSet-1`


        :param destination_backend_set_name: The destination_backend_set_name of this NetworkLoadBalancerBackendSetMappingDetails.
        :type: str
        """
