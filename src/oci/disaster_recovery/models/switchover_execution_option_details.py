...
class SwitchoverExecutionOptionDetails(DrPlanExecutionOptionDetails):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new SwitchoverExecutionOptionDetails object with values from keyword arguments. The default value of the :py:attr:`~oci.disaster_recovery.models.SwitchoverExecutionOptionDetails.plan_execution_type` attribute
        of this class is ``SWITCHOVER`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param plan_execution_type:
            The value to assign to the plan_execution_type property of this SwitchoverExecutionOptionDetails.
        ...
        :param are_prechecks_enabled:
            The value to assign to the are_prechecks_enabled property of this SwitchoverExecutionOptionDetails.
        :type are_prechecks_enabled: bool

        :param are_warnings_ignored:
            The value to assign to the are_warnings_ignored property of this SwitchoverExecutionOptionDetails.
    ...
    def are_prechecks_enabled(self):
        ...
        :return: The are_prechecks_enabled of this SwitchoverExecutionOptionDetails.
        :rtype: bool
        """
    ...
    def are_prechecks_enabled(self, are_prechecks_enabled):
        ...
        :param are_prechecks_enabled: The are_prechecks_enabled of this SwitchoverExecutionOptionDetails.
        :type: bool
        """
    ...
    def are_warnings_ignored(self):
        ...
        :return: The are_warnings_ignored of this SwitchoverExecutionOptionDetails.
        :rtype: bool
        """
    ...
    def are_warnings_ignored(self, are_warnings_ignored):
        ...
        :param are_warnings_ignored: The are_warnings_ignored of this SwitchoverExecutionOptionDetails.
        :type: bool
        """
