...
class IgnoreDrPlanExecutionDetails(object):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new IgnoreDrPlanExecutionDetails object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param group_id:
            The value to assign to the group_id property of this IgnoreDrPlanExecutionDetails.
        :type group_id: str

        :param step_id:
            The value to assign to the step_id property of this IgnoreDrPlanExecutionDetails.
        :type step_id: str
