...
class ManagedComputeClusterCustomExpressionQueryScalingConfiguration(ManagedComputeClusterScalingConfiguration):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ManagedComputeClusterCustomExpressionQueryScalingConfiguration object with values from keyword arguments. The default value of the :py:attr:`~oci.data_science.models.ManagedComputeClusterCustomExpressionQueryScalingConfiguration.scaling_configuration_type` attribute
        of this class is ``QUERY`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param scaling_configuration_type:
            The value to assign to the scaling_configuration_type property of this ManagedComputeClusterCustomExpressionQueryScalingConfiguration.
        ...
        :param pending_duration:
            The value to assign to the pending_duration property of this ManagedComputeClusterCustomExpressionQueryScalingConfiguration.
        :type pending_duration: str

        :param instance_count_adjustment:
            The value to assign to the instance_count_adjustment property of this ManagedComputeClusterCustomExpressionQueryScalingConfiguration.
        :type instance_count_adjustment: int

        :param query:
            The value to assign to the query property of this ManagedComputeClusterCustomExpressionQueryScalingConfiguration.
        :type query: str
    ...
    def query(self):
        """
        **[Required]** Gets the query of this ManagedComputeClusterCustomExpressionQueryScalingConfiguration.
        ...
        :return: The query of this ManagedComputeClusterCustomExpressionQueryScalingConfiguration.
        :rtype: str
        """
        return self._query
    ...
    def query(self, query):
        """
        Sets the query of this ManagedComputeClusterCustomExpressionQueryScalingConfiguration.
        The Monitoring Query Language (MQL) expression to evaluate for the alarm. The Alarms feature of the Monitoring service
        interprets results for each returned time series as Boolean values, where zero represents false and a non-zero value
        represents true. A true value means that the trigger rule condition has been met. The query must specify a metric,
        statistic, interval, and trigger rule (threshold or absence). Supported values for interval: 1m-60m (also 1h).
        ...
        :param query: The query of this ManagedComputeClusterCustomExpressionQueryScalingConfiguration.
        :type: str
        """
        self._query = query
