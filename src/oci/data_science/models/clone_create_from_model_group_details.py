...
class CloneCreateFromModelGroupDetails(ModelGroupCloneSourceDetails):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new CloneCreateFromModelGroupDetails object with values from keyword arguments. The default value of the :py:attr:`~oci.data_science.models.CloneCreateFromModelGroupDetails.model_group_clone_source_type` attribute
        of this class is ``MODEL_GROUP`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param model_group_clone_source_type:
            The value to assign to the model_group_clone_source_type property of this CloneCreateFromModelGroupDetails.
            Allowed values for this property are: "MODEL_GROUP", "MODEL_GROUP_VERSION_HISTORY"
        :type model_group_clone_source_type: str

        :param source_id:
            The value to assign to the source_id property of this CloneCreateFromModelGroupDetails.
        :type source_id: str

        :param modify_model_group_details:
            The value to assign to the modify_model_group_details property of this CloneCreateFromModelGroupDetails.
        ...
        :param patch_model_group_member_model_details:
            The value to assign to the patch_model_group_member_model_details property of this CloneCreateFromModelGroupDetails.
        ...
        self._model_group_clone_source_type = 'MODEL_GROUP'
    ...
    def modify_model_group_details(self):
        ...
        :return: The modify_model_group_details of this CloneCreateFromModelGroupDetails.
    ...
    def modify_model_group_details(self, modify_model_group_details):
        """
        Sets the modify_model_group_details of this CloneCreateFromModelGroupDetails.

        :param modify_model_group_details: The modify_model_group_details of this CloneCreateFromModelGroupDetails.
    ...
    def patch_model_group_member_model_details(self):
        ...
        :return: The patch_model_group_member_model_details of this CloneCreateFromModelGroupDetails.
    ...
    def patch_model_group_member_model_details(self, patch_model_group_member_model_details):
        """
        Sets the patch_model_group_member_model_details of this CloneCreateFromModelGroupDetails.

        :param patch_model_group_member_model_details: The patch_model_group_member_model_details of this CloneCreateFromModelGroupDetails.
