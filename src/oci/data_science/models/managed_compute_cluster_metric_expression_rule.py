...
class ManagedComputeClusterMetricExpressionRule(object):
    """
    The metric expression rule base.
    """

    #: A constant which can be used with the metric_expression_rule_type property of a ManagedComputeClusterMetricExpressionRule.
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ManagedComputeClusterMetricExpressionRule object with values from keyword arguments. This class has the following subclasses and if you are using this class as input
        to a service operations then you should favor using a subclass over the base class:

        * :class:`~oci.data_science.models.ManagedComputeClusterPredefinedMetricExpressionRule`
        * :class:`~oci.data_science.models.ManagedComputeClusterCustomMetricExpressionRule`

        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param metric_expression_rule_type:
            The value to assign to the metric_expression_rule_type property of this ManagedComputeClusterMetricExpressionRule.
    ...
    def get_subtype(object_dictionary):
        ...
        if type == 'PREDEFINED_EXPRESSION':
            return 'ManagedComputeClusterPredefinedMetricExpressionRule'

        if type == 'CUSTOM_EXPRESSION':
            return 'ManagedComputeClusterCustomMetricExpressionRule'
        else:
            return 'ManagedComputeClusterMetricExpressionRule'

    @property
    def metric_expression_rule_type(self):
        """
        **[Required]** Gets the metric_expression_rule_type of this ManagedComputeClusterMetricExpressionRule.
        ...
        :return: The metric_expression_rule_type of this ManagedComputeClusterMetricExpressionRule.
        :rtype: str
        """
    ...
    def metric_expression_rule_type(self, metric_expression_rule_type):
        """
        Sets the metric_expression_rule_type of this ManagedComputeClusterMetricExpressionRule.
        The metric expression for creating the alarm used to trigger autoscaling actions on the managed compute cluster type compute target .


        :param metric_expression_rule_type: The metric_expression_rule_type of this ManagedComputeClusterMetricExpressionRule.
        :type: str
        """
