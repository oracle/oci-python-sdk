...
class ManagedComputeClusterScalingConfiguration(object):
    """
    Scaling configuration for the metric expression rule.
    """

    #: A constant which can be used with the scaling_configuration_type property of a ManagedComputeClusterScalingConfiguration.
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ManagedComputeClusterScalingConfiguration object with values from keyword arguments. This class has the following subclasses and if you are using this class as input
        to a service operations then you should favor using a subclass over the base class:

        * :class:`~oci.data_science.models.ManagedComputeClusterCustomExpressionQueryScalingConfiguration`
        * :class:`~oci.data_science.models.ManagedComputeClusterPredefinedExpressionThresholdScalingConfiguration`

        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param scaling_configuration_type:
            The value to assign to the scaling_configuration_type property of this ManagedComputeClusterScalingConfiguration.
        ...
        :param pending_duration:
            The value to assign to the pending_duration property of this ManagedComputeClusterScalingConfiguration.
        :type pending_duration: str

        :param instance_count_adjustment:
            The value to assign to the instance_count_adjustment property of this ManagedComputeClusterScalingConfiguration.
    ...
    def get_subtype(object_dictionary):
        ...
        if type == 'QUERY':
            return 'ManagedComputeClusterCustomExpressionQueryScalingConfiguration'

        if type == 'THRESHOLD':
            return 'ManagedComputeClusterPredefinedExpressionThresholdScalingConfiguration'
        else:
            return 'ManagedComputeClusterScalingConfiguration'

    @property
    def scaling_configuration_type(self):
        """
        **[Required]** Gets the scaling_configuration_type of this ManagedComputeClusterScalingConfiguration.
        ...
        :return: The scaling_configuration_type of this ManagedComputeClusterScalingConfiguration.
        :rtype: str
        """
    ...
    def scaling_configuration_type(self, scaling_configuration_type):
        """
        Sets the scaling_configuration_type of this ManagedComputeClusterScalingConfiguration.
        The type of scaling configuration.


        :param scaling_configuration_type: The scaling_configuration_type of this ManagedComputeClusterScalingConfiguration.
        :type: str
        """
    ...
    def pending_duration(self):
        """
        Gets the pending_duration of this ManagedComputeClusterScalingConfiguration.
        ...
        :return: The pending_duration of this ManagedComputeClusterScalingConfiguration.
        :rtype: str
        """
    ...
    def pending_duration(self, pending_duration):
        """
        Sets the pending_duration of this ManagedComputeClusterScalingConfiguration.
        The period of time that the condition defined in the alarm must persist before the alarm state changes from \"OK\" to \"FIRING\"
        or vice versa. For example, a value of 5 minutes means that the alarm must persist in breaching the condition for five minutes
        before the alarm updates its state to \"FIRING\"; likewise, the alarm must persist in not breaching the condition for five minutes
        before the alarm updates its state to \"OK.\" The duration is specified as a string in ISO 8601 format (PT10M for ten minutes or
        ...
        :param pending_duration: The pending_duration of this ManagedComputeClusterScalingConfiguration.
        :type: str
        """
    ...
    def instance_count_adjustment(self):
        """
        Gets the instance_count_adjustment of this ManagedComputeClusterScalingConfiguration.
        The value is used for adjusting the count of instances by.


        :return: The instance_count_adjustment of this ManagedComputeClusterScalingConfiguration.
        :rtype: int
        """
    ...
    def instance_count_adjustment(self, instance_count_adjustment):
        """
        Sets the instance_count_adjustment of this ManagedComputeClusterScalingConfiguration.
        The value is used for adjusting the count of instances by.


        :param instance_count_adjustment: The instance_count_adjustment of this ManagedComputeClusterScalingConfiguration.
        :type: int
        """
