...
class StackedModelGroupDetails(ModelGroupDetails):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new StackedModelGroupDetails object with values from keyword arguments. The default value of the :py:attr:`~oci.data_science.models.StackedModelGroupDetails.type` attribute
        of this class is ``STACKED`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param type:
            The value to assign to the type property of this StackedModelGroupDetails.
            Allowed values for this property are: "HOMOGENEOUS", "HETEROGENEOUS", "STACKED"
        :type type: str

        :param custom_metadata_list:
            The value to assign to the custom_metadata_list property of this StackedModelGroupDetails.
        :type custom_metadata_list: list[oci.data_science.models.CustomMetadata]

        :param base_model_id:
            The value to assign to the base_model_id property of this StackedModelGroupDetails.
