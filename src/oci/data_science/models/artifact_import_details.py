...
class ArtifactImportDetails(object):
    """
    Details of Artifact source
    """

    #: A constant which can be used with the artifact_source_type property of a ArtifactImportDetails.
    #: This constant has a value of "ORACLE_OBJECT_STORAGE"
    ARTIFACT_SOURCE_TYPE_ORACLE_OBJECT_STORAGE = "ORACLE_OBJECT_STORAGE"

    def __init__(self, **kwargs):
        """
        Initializes a new ArtifactImportDetails object with values from keyword arguments. This class has the following subclasses and if you are using this class as input
        to a service operations then you should favor using a subclass over the base class:

        * :class:`~oci.data_science.models.ArtifactImportDetailsObjectStorage`

        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param artifact_source_type:
            The value to assign to the artifact_source_type property of this ArtifactImportDetails.
    ...
    def get_subtype(object_dictionary):
        ...
        if type == 'ORACLE_OBJECT_STORAGE':
            return 'ArtifactImportDetailsObjectStorage'
        else:
    ...
    def artifact_source_type(self):
        """
        **[Required]** Gets the artifact_source_type of this ArtifactImportDetails.
        Source type where actually artifact is being stored

        Allowed values for this property are: "ORACLE_OBJECT_STORAGE"


        :return: The artifact_source_type of this ArtifactImportDetails.
        :rtype: str
        """
    ...
    def artifact_source_type(self, artifact_source_type):
        """
        Sets the artifact_source_type of this ArtifactImportDetails.
        Source type where actually artifact is being stored


        :param artifact_source_type: The artifact_source_type of this ArtifactImportDetails.
        :type: str
        """
