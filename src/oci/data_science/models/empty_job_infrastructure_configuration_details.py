...
class EmptyJobInfrastructureConfigurationDetails(JobInfrastructureConfigurationDetails):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new EmptyJobInfrastructureConfigurationDetails object with values from keyword arguments. The default value of the :py:attr:`~oci.data_science.models.EmptyJobInfrastructureConfigurationDetails.job_infrastructure_type` attribute
        of this class is ``EMPTY`` and it should not be changed.
        ...
        self._job_infrastructure_type = 'EMPTY'
