...
class ApproverDetail(object):
    ...
    def time_of_authorization(self):
        ...
        Time when the privilegedApi request was authorized by the customer in `RFC 3339`__ timestamp format.Example: '2020-05-22T21:10:29.600Z'
    ...
    def time_approved_for_access(self):
        ...
        Time for when the privilegedApi request should start that is authorized by the customer in `RFC 3339`__ timestamp format.Example: '2020-05-22T21:10:29.600Z'
