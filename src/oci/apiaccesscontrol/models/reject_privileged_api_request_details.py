...
class RejectPrivilegedApiRequestDetails(object):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new RejectPrivilegedApiRequestDetails object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param approver_comment:
            The value to assign to the approver_comment property of this RejectPrivilegedApiRequestDetails.
    ...
    def approver_comment(self):
        ...
        :return: The approver_comment of this RejectPrivilegedApiRequestDetails.
        :rtype: str
        """
    ...
    def approver_comment(self, approver_comment):
        """
        Sets the approver_comment of this RejectPrivilegedApiRequestDetails.
        Comment by the approver explaining why the request is rejected.


        :param approver_comment: The approver_comment of this RejectPrivilegedApiRequestDetails.
        :type: str
        """
