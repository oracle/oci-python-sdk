...
class OciLoggingConfiguration(LoggingConfiguration):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new OciLoggingConfiguration object with values from keyword arguments. The default value of the :py:attr:`~oci.batch.models.OciLoggingConfiguration.type` attribute
        of this class is ``OCI_LOGGING`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param type:
            The value to assign to the type property of this OciLoggingConfiguration.
            Allowed values for this property are: "OCI_LOGGING"
        :type type: str

        :param log_group_id:
            The value to assign to the log_group_id property of this OciLoggingConfiguration.
