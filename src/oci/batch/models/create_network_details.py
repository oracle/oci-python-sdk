...
class CreateNetworkDetails(object):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new CreateNetworkDetails object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param subnet_id:
            The value to assign to the subnet_id property of this CreateNetworkDetails.
        :type subnet_id: str

        :param nsg_ids:
            The value to assign to the nsg_ids property of this CreateNetworkDetails.
