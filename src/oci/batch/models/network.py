...
class Network(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new Network object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param subnet_id:
            The value to assign to the subnet_id property of this Network.
        :type subnet_id: str

        :param nsg_ids:
            The value to assign to the nsg_ids property of this Network.
        :type nsg_ids: list[str]

        :param vnics:
            The value to assign to the vnics property of this Network.
        :type vnics: list[oci.batch.models.Vnic]
    ...
    def vnics(self):
        """
        **[Required]** Gets the vnics of this Network.
        A list of private endpoint's VNICs.


        :return: The vnics of this Network.
        :rtype: list[oci.batch.models.Vnic]
        """
        return self._vnics
    ...
    def vnics(self, vnics):
        """
        Sets the vnics of this Network.
        A list of private endpoint's VNICs.


        :param vnics: The vnics of this Network.
        :type: list[oci.batch.models.Vnic]
        """
        self._vnics = vnics
