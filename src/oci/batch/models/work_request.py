...
class WorkRequest(object):
    ...
    #: This constant has a value of "CREATE_BATCH_CONTEXT"
    OPERATION_TYPE_CREATE_BATCH_CONTEXT = "CREATE_BATCH_CONTEXT"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "UPDATE_BATCH_CONTEXT"
    OPERATION_TYPE_UPDATE_BATCH_CONTEXT = "UPDATE_BATCH_CONTEXT"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "DELETE_BATCH_CONTEXT"
    OPERATION_TYPE_DELETE_BATCH_CONTEXT = "DELETE_BATCH_CONTEXT"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "START_BATCH_CONTEXT"
    OPERATION_TYPE_START_BATCH_CONTEXT = "START_BATCH_CONTEXT"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "STOP_BATCH_CONTEXT"
    OPERATION_TYPE_STOP_BATCH_CONTEXT = "STOP_BATCH_CONTEXT"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "MOVE_BATCH_CONTEXT"
    OPERATION_TYPE_MOVE_BATCH_CONTEXT = "MOVE_BATCH_CONTEXT"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "CREATE_BATCH_JOB"
    OPERATION_TYPE_CREATE_BATCH_JOB = "CREATE_BATCH_JOB"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "UPDATE_BATCH_JOB"
    OPERATION_TYPE_UPDATE_BATCH_JOB = "UPDATE_BATCH_JOB"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "DELETE_BATCH_JOB"
    OPERATION_TYPE_DELETE_BATCH_JOB = "DELETE_BATCH_JOB"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "MOVE_BATCH_JOB"
    OPERATION_TYPE_MOVE_BATCH_JOB = "MOVE_BATCH_JOB"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "PAUSE_BATCH_JOB"
    OPERATION_TYPE_PAUSE_BATCH_JOB = "PAUSE_BATCH_JOB"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "UNPAUSE_BATCH_JOB"
    OPERATION_TYPE_UNPAUSE_BATCH_JOB = "UNPAUSE_BATCH_JOB"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "MOVE_BATCH_JOB_POOL"
    OPERATION_TYPE_MOVE_BATCH_JOB_POOL = "MOVE_BATCH_JOB_POOL"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "UPDATE_BATCH_JOB_POOL"
    OPERATION_TYPE_UPDATE_BATCH_JOB_POOL = "UPDATE_BATCH_JOB_POOL"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "START_BATCH_JOB_POOL"
    OPERATION_TYPE_START_BATCH_JOB_POOL = "START_BATCH_JOB_POOL"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "STOP_BATCH_JOB_POOL"
    OPERATION_TYPE_STOP_BATCH_JOB_POOL = "STOP_BATCH_JOB_POOL"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "MOVE_BATCH_TASK_ENVIRONMENT"
    OPERATION_TYPE_MOVE_BATCH_TASK_ENVIRONMENT = "MOVE_BATCH_TASK_ENVIRONMENT"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "MOVE_BATCH_TASK_PROFILE"
    OPERATION_TYPE_MOVE_BATCH_TASK_PROFILE = "MOVE_BATCH_TASK_PROFILE"
    ...
    def __init__(self, **kwargs):
        ...
        :type resources: list[oci.batch.models.WorkRequestResource]
    ...
    def operation_type(self, operation_type):
        ...
        :type: str
        """
        allowed_values = ["CREATE_BATCH_CONTEXT", "UPDATE_BATCH_CONTEXT", "DELETE_BATCH_CONTEXT", "START_BATCH_CONTEXT", "STOP_BATCH_CONTEXT", "MOVE_BATCH_CONTEXT", "CREATE_BATCH_JOB", "UPDATE_BATCH_JOB", "DELETE_BATCH_JOB", "MOVE_BATCH_JOB", "PAUSE_BATCH_JOB", "UNPAUSE_BATCH_JOB", "MOVE_BATCH_JOB_POOL", "UPDATE_BATCH_JOB_POOL", "START_BATCH_JOB_POOL", "STOP_BATCH_JOB_POOL", "MOVE_BATCH_TASK_ENVIRONMENT", "MOVE_BATCH_TASK_PROFILE", "INTERNAL"]
    ...
    def resources(self):
        ...
        **[Required]** Gets the resources of this WorkRequest.
        ...
        :rtype: list[oci.batch.models.WorkRequestResource]
        """
    ...
    def resources(self, resources):
        ...
        :type: list[oci.batch.models.WorkRequestResource]
        """
