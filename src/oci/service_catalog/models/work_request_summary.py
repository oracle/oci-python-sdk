...
class WorkRequestSummary(object):
    ...
    #: This constant has a value of "CREATE_PRIVATE_APPLICATION"
    OPERATION_TYPE_CREATE_PRIVATE_APPLICATION = "CREATE_PRIVATE_APPLICATION"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "UPDATE_PRIVATE_APPLICATION"
    OPERATION_TYPE_UPDATE_PRIVATE_APPLICATION = "UPDATE_PRIVATE_APPLICATION"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "DELETE_PRIVATE_APPLICATION"
    OPERATION_TYPE_DELETE_PRIVATE_APPLICATION = "DELETE_PRIVATE_APPLICATION"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "MOVE_PRIVATE_APPLICATION"
    OPERATION_TYPE_MOVE_PRIVATE_APPLICATION = "MOVE_PRIVATE_APPLICATION"
    ...
    def __init__(self, **kwargs):
        ...
        :param operation_type:
            ...
            Allowed values for this property are: "CREATE_PRIVATE_APPLICATION", "UPDATE_PRIVATE_APPLICATION", "DELETE_PRIVATE_APPLICATION", "MOVE_PRIVATE_APPLICATION", 'UNKNOWN_ENUM_VALUE'.
            Any unrecognized values returned by a service will be mapped to 'UNKNOWN_ENUM_VALUE'.
        :type operation_type: str

        :param status:
            The value to assign to the status property of this WorkRequestSummary.
            Allowed values for this property are: "ACCEPTED", "FAILED", "SUCCEEDED", 'UNKNOWN_ENUM_VALUE'.
            Any unrecognized values returned by a service will be mapped to 'UNKNOWN_ENUM_VALUE'.
        :type status: str
        ...
        :type resources: list[oci.service_catalog.models.WorkRequestResource]
    ...
    def operation_type(self, operation_type):
        ...
        :type: str
        """
        allowed_values = ["CREATE_PRIVATE_APPLICATION", "UPDATE_PRIVATE_APPLICATION", "DELETE_PRIVATE_APPLICATION", "MOVE_PRIVATE_APPLICATION"]
    ...
    def status(self, status):
        ...
        :type: str
        """
        allowed_values = ["ACCEPTED", "FAILED", "SUCCEEDED"]
    ...
    def resources(self):
        ...
        **[Required]** Gets the resources of this WorkRequestSummary.
        ...
        :rtype: list[oci.service_catalog.models.WorkRequestResource]
        """
    ...
    def resources(self, resources):
        ...
        :type: list[oci.service_catalog.models.WorkRequestResource]
        """
