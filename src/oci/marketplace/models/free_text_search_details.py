...
class FreeTextSearchDetails(SearchListingsDetails):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new FreeTextSearchDetails object with values from keyword arguments. The default value of the :py:attr:`~oci.marketplace.models.FreeTextSearchDetails.type` attribute
