...
class WorkRequestResource(object):
    ...
    ACTION_TYPE_WAITING = "WAITING"

    #: A constant which can be used with the action_type property of a WorkRequestResource.
    #: This constant has a value of "NEEDS_ATTENTION"
    ACTION_TYPE_NEEDS_ATTENTION = "NEEDS_ATTENTION"
    ...
    def __init__(self, **kwargs):
        ...
        :param action_type:
            ...
            Allowed values for this property are: "ACCEPTED", "IN_PROGRESS", "WAITING", "NEEDS_ATTENTION", "FAILED", "SUCCEEDED", "CANCELED", 'UNKNOWN_ENUM_VALUE'.
    ...
    def action_type(self, action_type):
        ...
        :type: str
        """
        allowed_values = ["ACCEPTED", "IN_PROGRESS", "WAITING", "NEEDS_ATTENTION", "FAILED", "SUCCEEDED", "CANCELED"]
