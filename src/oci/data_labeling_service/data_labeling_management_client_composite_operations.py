...
class DataLabelingManagementClientCompositeOperations(object):
    ...
    def import_pre_annotated_data_and_wait_for_state(self, dataset_id, import_pre_annotated_data_details, wait_for_states=[], operation_kwargs={}, waiter_kwargs={}):
        """
        Calls :py:func:`~oci.data_labeling_service.DataLabelingManagementClient.import_pre_annotated_data` and waits for the :py:class:`~oci.data_labeling_service.models.WorkRequest`
        to enter the given state(s).
        ...
        :param dict operation_kwargs:
            A dictionary of keyword arguments to pass to :py:func:`~oci.data_labeling_service.DataLabelingManagementClient.import_pre_annotated_data`
