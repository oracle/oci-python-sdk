...
class WorkRequestErrorCollection(object):
    ...
    def __init__(self, **kwargs):
        ...
        :type items: list[oci.data_labeling_service.models.WorkRequestError]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this WorkRequestErrorCollection.
        ...
        :rtype: list[oci.data_labeling_service.models.WorkRequestError]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.data_labeling_service.models.WorkRequestError]
        """
        self._items = items
