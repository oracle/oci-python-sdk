...
class CreateConnectionFromAtp(CreateConnectionDetails):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new CreateConnectionFromAtp object with values from keyword arguments. The default value of the :py:attr:`~oci.data_integration.models.CreateConnectionFromAtp.model_type` attribute
        ...
        :param key:
            The value to assign to the key property of this CreateConnectionFromAtp.
        :type key: str

        :param model_version:
            The value to assign to the model_version property of this CreateConnectionFromAtp.
        :type model_version: str

        :param parent_ref:
            The value to assign to the parent_ref property of this CreateConnectionFromAtp.
        :type parent_ref: oci.data_integration.models.ParentReference

        :param name:
            The value to assign to the name property of this CreateConnectionFromAtp.
        :type name: str

        :param description:
            The value to assign to the description property of this CreateConnectionFromAtp.
        :type description: str

        :param object_status:
            The value to assign to the object_status property of this CreateConnectionFromAtp.
        :type object_status: int

        :param identifier:
            The value to assign to the identifier property of this CreateConnectionFromAtp.
        :type identifier: str

        :param connection_properties:
            The value to assign to the connection_properties property of this CreateConnectionFromAtp.
    ...
    def username(self):
        """
        Gets the username of this CreateConnectionFromAtp.
        The user name for the connection.


        :return: The username of this CreateConnectionFromAtp.
        :rtype: str
        """
    ...
    def username(self, username):
        """
        Sets the username of this CreateConnectionFromAtp.
        The user name for the connection.


        :param username: The username of this CreateConnectionFromAtp.
        :type: str
        """
    ...
    def password(self):
        """
        Gets the password of this CreateConnectionFromAtp.
        The password for the connection.


        :return: The password of this CreateConnectionFromAtp.
        :rtype: str
        """
    ...
    def password(self, password):
        """
        Sets the password of this CreateConnectionFromAtp.
        The password for the connection.


        :param password: The password of this CreateConnectionFromAtp.
        :type: str
        """
