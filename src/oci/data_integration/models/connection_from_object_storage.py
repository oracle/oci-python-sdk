...
class ConnectionFromObjectStorage(Connection):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ConnectionFromObjectStorage object with values from keyword arguments. The default value of the :py:attr:`~oci.data_integration.models.ConnectionFromObjectStorage.model_type` attribute
        ...
        :param key:
            The value to assign to the key property of this ConnectionFromObjectStorage.
        :type key: str

        :param model_version:
            The value to assign to the model_version property of this ConnectionFromObjectStorage.
        :type model_version: str

        :param parent_ref:
            The value to assign to the parent_ref property of this ConnectionFromObjectStorage.
        :type parent_ref: oci.data_integration.models.ParentReference

        :param name:
            The value to assign to the name property of this ConnectionFromObjectStorage.
        :type name: str

        :param description:
            The value to assign to the description property of this ConnectionFromObjectStorage.
        :type description: str

        :param object_version:
            The value to assign to the object_version property of this ConnectionFromObjectStorage.
        :type object_version: int

        :param object_status:
            The value to assign to the object_status property of this ConnectionFromObjectStorage.
        :type object_status: int

        :param identifier:
            The value to assign to the identifier property of this ConnectionFromObjectStorage.
        :type identifier: str

        :param primary_schema:
            The value to assign to the primary_schema property of this ConnectionFromObjectStorage.
        :type primary_schema: oci.data_integration.models.Schema

        :param connection_properties:
            The value to assign to the connection_properties property of this ConnectionFromObjectStorage.
        :type connection_properties: list[oci.data_integration.models.ConnectionProperty]

        :param is_default:
            The value to assign to the is_default property of this ConnectionFromObjectStorage.
        :type is_default: bool

        :param metadata:
            The value to assign to the metadata property of this ConnectionFromObjectStorage.
        :type metadata: oci.data_integration.models.ObjectMetadata

        :param key_map:
            The value to assign to the key_map property of this ConnectionFromObjectStorage.
        :type key_map: dict(str, str)

        :param credential_file_content:
            The value to assign to the credential_file_content property of this ConnectionFromObjectStorage.
        :type credential_file_content: str

        :param user_id:
            The value to assign to the user_id property of this ConnectionFromObjectStorage.
        :type user_id: str

        :param finger_print:
            The value to assign to the finger_print property of this ConnectionFromObjectStorage.
        :type finger_print: str

        :param pass_phrase:
            The value to assign to the pass_phrase property of this ConnectionFromObjectStorage.
    ...
    def user_id(self):
        """
        Gets the user_id of this ConnectionFromObjectStorage.
        The OCI user OCID for the user to connect to.


        :return: The user_id of this ConnectionFromObjectStorage.
        :rtype: str
        """
    ...
    def user_id(self, user_id):
        """
        Sets the user_id of this ConnectionFromObjectStorage.
        The OCI user OCID for the user to connect to.


        :param user_id: The user_id of this ConnectionFromObjectStorage.
        :type: str
        """
