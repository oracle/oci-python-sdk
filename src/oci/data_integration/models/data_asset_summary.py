...
class DataAssetSummary(object):
    ...
    def __init__(self, **kwargs):
        ...
        * :class:`~oci.data_integration.models.DataAssetSummaryFromOracleSiebel`
        * :class:`~oci.data_integration.models.DataAssetSummaryFromMySqlHeatWave`
        * :class:`~oci.data_integration.models.DataAssetSummaryFromMySQL`
        * :class:`~oci.data_integration.models.DataAssetSummaryFromHdfs`
        * :class:`~oci.data_integration.models.DataAssetSummaryFromAmazonS3`
        * :class:`~oci.data_integration.models.DataAssetSummaryFromOraclePeopleSoft`
        ...
        * :class:`~oci.data_integration.models.DataAssetSummaryFromOracleEbs`
    ...
    def get_subtype(object_dictionary):
        ...
        if type == 'ORACLE_EBS_DATA_ASSET':
            return 'DataAssetSummaryFromOracleEbs'
