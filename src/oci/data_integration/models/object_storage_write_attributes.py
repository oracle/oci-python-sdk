...
class ObjectStorageWriteAttributes(AbstractWriteAttribute):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ObjectStorageWriteAttributes object with values from keyword arguments. The default value of the :py:attr:`~oci.data_integration.models.ObjectStorageWriteAttributes.model_type` attribute
