...
class RuntimePipeline(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new RuntimePipeline object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param pipeline:
            The value to assign to the pipeline property of this RuntimePipeline.
        :type pipeline: oci.data_integration.models.Pipeline

        :param runtime_operators:
            The value to assign to the runtime_operators property of this RuntimePipeline.
        :type runtime_operators: list[oci.data_integration.models.RuntimeOperator]

        :param parent_runtime_operator_key:
            The value to assign to the parent_runtime_operator_key property of this RuntimePipeline.
    ...
    def pipeline(self):
        """
        Gets the pipeline of this RuntimePipeline.

        :return: The pipeline of this RuntimePipeline.
    ...
    def pipeline(self, pipeline):
        """
        Sets the pipeline of this RuntimePipeline.

        :param pipeline: The pipeline of this RuntimePipeline.
    ...
    def runtime_operators(self):
        """
        Gets the runtime_operators of this RuntimePipeline.
        A list of RuntimeOperators attached to the RuntimePipeline.


        :return: The runtime_operators of this RuntimePipeline.
    ...
    def runtime_operators(self, runtime_operators):
        """
        Sets the runtime_operators of this RuntimePipeline.
        A list of RuntimeOperators attached to the RuntimePipeline.


        :param runtime_operators: The runtime_operators of this RuntimePipeline.
    ...
    def parent_runtime_operator_key(self):
        """
        Gets the parent_runtime_operator_key of this RuntimePipeline.
        The parent RuntimePipeline's RuntimeOperator key.


        :return: The parent_runtime_operator_key of this RuntimePipeline.
        :rtype: str
        """
    ...
    def parent_runtime_operator_key(self, parent_runtime_operator_key):
        """
        Sets the parent_runtime_operator_key of this RuntimePipeline.
        The parent RuntimePipeline's RuntimeOperator key.


        :param parent_runtime_operator_key: The parent_runtime_operator_key of this RuntimePipeline.
        :type: str
        """
