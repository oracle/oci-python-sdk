...
class DataFlow(object):
    ...
    def __init__(self, **kwargs):
        ...
        :param typed_object_map:
            The value to assign to the typed_object_map property of this DataFlow.
        :type typed_object_map: dict(str, TypedObjectWrapper)

        :param target_field_map_summary:
            The value to assign to the target_field_map_summary property of this DataFlow.
    ...
    def typed_object_map(self):
        """
        Gets the typed_object_map of this DataFlow.
        A hash map that maps TypedObject keys to the object itself, for java sdk.


        :return: The typed_object_map of this DataFlow.
    ...
    def typed_object_map(self, typed_object_map):
        """
        Sets the typed_object_map of this DataFlow.
        A hash map that maps TypedObject keys to the object itself, for java sdk.


        :param typed_object_map: The typed_object_map of this DataFlow.
    ...
    def target_field_map_summary(self, target_field_map_summary):
        """
        Sets the target_field_map_summary of this DataFlow.
        A hash map that maps TypedObject keys to a field map that maps to the typed object as a target, for java sdk.


        :param target_field_map_summary: The target_field_map_summary of this DataFlow.
