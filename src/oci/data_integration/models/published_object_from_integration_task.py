...
class PublishedObjectFromIntegrationTask(PublishedObject):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new PublishedObjectFromIntegrationTask object with values from keyword arguments. The default value of the :py:attr:`~oci.data_integration.models.PublishedObjectFromIntegrationTask.model_type` attribute
        ...
        :param key:
            The value to assign to the key property of this PublishedObjectFromIntegrationTask.
        :type key: str

        :param model_version:
            The value to assign to the model_version property of this PublishedObjectFromIntegrationTask.
        ...
        :param description:
            The value to assign to the description property of this PublishedObjectFromIntegrationTask.
        :type description: str

        :param object_version:
            The value to assign to the object_version property of this PublishedObjectFromIntegrationTask.
        :type object_version: int

        :param object_status:
            The value to assign to the object_status property of this PublishedObjectFromIntegrationTask.
        :type object_status: int

        :param identifier:
            The value to assign to the identifier property of this PublishedObjectFromIntegrationTask.
        :type identifier: str
    ...
    def input_ports(self):
        """
        Gets the input_ports of this PublishedObjectFromIntegrationTask.
    ...
    def input_ports(self, input_ports):
        """
        Sets the input_ports of this PublishedObjectFromIntegrationTask.
        An array of input ports.
    ...
    def output_ports(self):
        """
        Gets the output_ports of this PublishedObjectFromIntegrationTask.
    ...
    def output_ports(self, output_ports):
        """
        Sets the output_ports of this PublishedObjectFromIntegrationTask.
        An array of output ports.
    ...
    def parameters(self):
        """
        Gets the parameters of this PublishedObjectFromIntegrationTask.
    ...
    def parameters(self, parameters):
        """
        Sets the parameters of this PublishedObjectFromIntegrationTask.
        An array of parameters.
