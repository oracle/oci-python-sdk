...
class TemplateSummaryCollection(object):
    ...
    def __init__(self, **kwargs):
        ...
        :type items: list[oci.data_integration.models.TemplateSummary]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this TemplateSummaryCollection.
        ...
        :rtype: list[oci.data_integration.models.TemplateSummary]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.data_integration.models.TemplateSummary]
        """
        self._items = items
