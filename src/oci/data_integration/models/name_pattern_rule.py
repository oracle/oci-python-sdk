...
class NamePatternRule(ProjectionRule):
    ...
    #: A constant which can be used with the rule_type property of a NamePatternRule.
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new NamePatternRule object with values from keyword arguments. The default value of the :py:attr:`~oci.data_integration.models.NamePatternRule.model_type` attribute
        of this class is ``NAME_PATTERN_RULE`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param model_type:
            The value to assign to the model_type property of this NamePatternRule.
        ...
        :param key:
            The value to assign to the key property of this NamePatternRule.
        :type key: str

        :param model_version:
            The value to assign to the model_version property of this NamePatternRule.
        :type model_version: str

        :param parent_ref:
            The value to assign to the parent_ref property of this NamePatternRule.
        :type parent_ref: oci.data_integration.models.ParentReference

        :param is_java_regex_syntax:
            The value to assign to the is_java_regex_syntax property of this NamePatternRule.
        :type is_java_regex_syntax: bool

        :param config_values:
            The value to assign to the config_values property of this NamePatternRule.
        :type config_values: oci.data_integration.models.ConfigValues

        :param object_status:
            The value to assign to the object_status property of this NamePatternRule.
        :type object_status: int

        :param description:
            The value to assign to the description property of this NamePatternRule.
        :type description: str

        :param is_skip_remaining_rules_on_match:
            The value to assign to the is_skip_remaining_rules_on_match property of this NamePatternRule.
        :type is_skip_remaining_rules_on_match: bool

        :param scope:
            The value to assign to the scope property of this NamePatternRule.
        :type scope: object

        :param is_cascade:
            The value to assign to the is_cascade property of this NamePatternRule.
        :type is_cascade: bool

        :param matching_strategy:
            The value to assign to the matching_strategy property of this NamePatternRule.
        ...
        :param is_case_sensitive:
            The value to assign to the is_case_sensitive property of this NamePatternRule.
        :type is_case_sensitive: bool

        :param rule_type:
            The value to assign to the rule_type property of this NamePatternRule.
            Allowed values for this property are: "INCLUDE", "EXCLUDE", 'UNKNOWN_ENUM_VALUE'.
            Any unrecognized values returned by a service will be mapped to 'UNKNOWN_ENUM_VALUE'.
        :type rule_type: str

        :param pattern:
            The value to assign to the pattern property of this NamePatternRule.
        :type pattern: str
        ...
        self._pattern = None
        self._model_type = 'NAME_PATTERN_RULE'
    ...
    def matching_strategy(self):
        ...
        :return: The matching_strategy of this NamePatternRule.
        :rtype: str
        """
    ...
    def rule_type(self):
        ...
        :return: The rule_type of this NamePatternRule.
        :rtype: str
        """
