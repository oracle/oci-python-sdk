...
class ShapeField(TypedObject):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ShapeField object with values from keyword arguments. The default value of the :py:attr:`~oci.data_integration.models.ShapeField.model_type` attribute
