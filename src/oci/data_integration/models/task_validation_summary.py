...
class TaskValidationSummary(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new TaskValidationSummary object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param total_message_count:
            The value to assign to the total_message_count property of this TaskValidationSummary.
        :type total_message_count: int

        :param error_message_count:
            The value to assign to the error_message_count property of this TaskValidationSummary.
        :type error_message_count: int

        :param warn_message_count:
            The value to assign to the warn_message_count property of this TaskValidationSummary.
        :type warn_message_count: int

        :param info_message_count:
            The value to assign to the info_message_count property of this TaskValidationSummary.
        :type info_message_count: int

        :param validation_messages:
            The value to assign to the validation_messages property of this TaskValidationSummary.
        :type validation_messages: dict(str, list[ValidationMessage])

        :param key:
            The value to assign to the key property of this TaskValidationSummary.
        :type key: str

        :param model_type:
            The value to assign to the model_type property of this TaskValidationSummary.
        :type model_type: str

        :param model_version:
            The value to assign to the model_version property of this TaskValidationSummary.
        ...
        :param description:
            The value to assign to the description property of this TaskValidationSummary.
        :type description: str

        :param object_version:
            The value to assign to the object_version property of this TaskValidationSummary.
        :type object_version: int

        :param object_status:
            The value to assign to the object_status property of this TaskValidationSummary.
        :type object_status: int

        :param identifier:
            The value to assign to the identifier property of this TaskValidationSummary.
        :type identifier: str
    ...
    def model_type(self):
        """
        Gets the model_type of this TaskValidationSummary.
        The type of the object.


        :return: The model_type of this TaskValidationSummary.
        :rtype: str
        """
    ...
    def model_type(self, model_type):
        """
        Sets the model_type of this TaskValidationSummary.
        The type of the object.


        :param model_type: The model_type of this TaskValidationSummary.
        :type: str
        """
    ...
    def model_version(self):
        """
        Gets the model_version of this TaskValidationSummary.
        The model version of an object.


        :return: The model_version of this TaskValidationSummary.
        :rtype: str
        """
    ...
    def model_version(self, model_version):
        """
        Sets the model_version of this TaskValidationSummary.
        The model version of an object.


        :param model_version: The model_version of this TaskValidationSummary.
        :type: str
        """
    ...
    def description(self):
        """
        Gets the description of this TaskValidationSummary.
        Detailed description for the object.


        :return: The description of this TaskValidationSummary.
        :rtype: str
        """
    ...
    def description(self, description):
        """
        Sets the description of this TaskValidationSummary.
        Detailed description for the object.


        :param description: The description of this TaskValidationSummary.
        :type: str
        """
    ...
    def object_version(self):
        """
        Gets the object_version of this TaskValidationSummary.
        The version of the object that is used to track changes in the object instance.


        :return: The object_version of this TaskValidationSummary.
        :rtype: int
        """
    ...
    def object_version(self, object_version):
        """
        Sets the object_version of this TaskValidationSummary.
        The version of the object that is used to track changes in the object instance.


        :param object_version: The object_version of this TaskValidationSummary.
        :type: int
        """
    ...
    def object_status(self):
        """
        Gets the object_status of this TaskValidationSummary.
        The status of an object that can be set to value 1 for shallow references across objects, other values reserved.


        :return: The object_status of this TaskValidationSummary.
        :rtype: int
        """
    ...
    def object_status(self, object_status):
        """
        Sets the object_status of this TaskValidationSummary.
        The status of an object that can be set to value 1 for shallow references across objects, other values reserved.


        :param object_status: The object_status of this TaskValidationSummary.
        :type: int
        """
