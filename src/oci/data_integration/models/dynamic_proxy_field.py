...
class DynamicProxyField(TypedObject):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new DynamicProxyField object with values from keyword arguments. The default value of the :py:attr:`~oci.data_integration.models.DynamicProxyField.model_type` attribute
        of this class is ``DYNAMIC_PROXY_FIELD`` and it should not be changed.
        ...
        :param key:
            The value to assign to the key property of this DynamicProxyField.
        :type key: str

        :param model_version:
            The value to assign to the model_version property of this DynamicProxyField.
        ...
        :param name:
            The value to assign to the name property of this DynamicProxyField.
        :type name: str

        :param description:
            The value to assign to the description property of this DynamicProxyField.
        ...
        self._type = None
        self._labels = None
        self._model_type = 'DYNAMIC_PROXY_FIELD'
