...
class CreateConnectionFromAdwc(CreateConnectionDetails):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new CreateConnectionFromAdwc object with values from keyword arguments. The default value of the :py:attr:`~oci.data_integration.models.CreateConnectionFromAdwc.model_type` attribute
        ...
        :param key:
            The value to assign to the key property of this CreateConnectionFromAdwc.
        :type key: str

        :param model_version:
            The value to assign to the model_version property of this CreateConnectionFromAdwc.
        ...
        :param description:
            The value to assign to the description property of this CreateConnectionFromAdwc.
        :type description: str

        :param object_status:
            The value to assign to the object_status property of this CreateConnectionFromAdwc.
        :type object_status: int

        :param identifier:
            The value to assign to the identifier property of this CreateConnectionFromAdwc.
        :type identifier: str
    ...
    def username(self):
        """
        Gets the username of this CreateConnectionFromAdwc.
        The user name for the connection.


        :return: The username of this CreateConnectionFromAdwc.
        :rtype: str
        """
    ...
    def username(self, username):
        """
        Sets the username of this CreateConnectionFromAdwc.
        The user name for the connection.


        :param username: The username of this CreateConnectionFromAdwc.
        :type: str
        """
    ...
    def password(self):
        """
        Gets the password of this CreateConnectionFromAdwc.
        The password for the connection.


        :return: The password of this CreateConnectionFromAdwc.
        :rtype: str
        """
    ...
    def password(self, password):
        """
        Sets the password of this CreateConnectionFromAdwc.
        The password for the connection.


        :param password: The password of this CreateConnectionFromAdwc.
        :type: str
        """
