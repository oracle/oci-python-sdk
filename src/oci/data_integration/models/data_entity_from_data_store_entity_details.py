...
class DataEntityFromDataStoreEntityDetails(DataEntityDetails):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new DataEntityFromDataStoreEntityDetails object with values from keyword arguments. The default value of the :py:attr:`~oci.data_integration.models.DataEntityFromDataStoreEntityDetails.model_type` attribute
        ...
        :param types:
            The value to assign to the types property of this DataEntityFromDataStoreEntityDetails.
    ...
    def types(self):
        ...
        :return: The types of this DataEntityFromDataStoreEntityDetails.
    ...
    def types(self, types):
        """
        Sets the types of this DataEntityFromDataStoreEntityDetails.

        :param types: The types of this DataEntityFromDataStoreEntityDetails.
