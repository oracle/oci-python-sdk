...
class DataAssetFromOracleDetails(DataAsset):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new DataAssetFromOracleDetails object with values from keyword arguments. The default value of the :py:attr:`~oci.data_integration.models.DataAssetFromOracleDetails.model_type` attribute
        ...
        :param key:
            The value to assign to the key property of this DataAssetFromOracleDetails.
        :type key: str

        :param model_version:
            The value to assign to the model_version property of this DataAssetFromOracleDetails.
        :type model_version: str

        :param name:
            The value to assign to the name property of this DataAssetFromOracleDetails.
        :type name: str

        :param description:
            The value to assign to the description property of this DataAssetFromOracleDetails.
        :type description: str

        :param object_status:
            The value to assign to the object_status property of this DataAssetFromOracleDetails.
        :type object_status: int

        :param identifier:
            The value to assign to the identifier property of this DataAssetFromOracleDetails.
        :type identifier: str

        :param external_key:
            The value to assign to the external_key property of this DataAssetFromOracleDetails.
        :type external_key: str

        :param asset_properties:
            The value to assign to the asset_properties property of this DataAssetFromOracleDetails.
        :type asset_properties: dict(str, str)

        :param native_type_system:
            The value to assign to the native_type_system property of this DataAssetFromOracleDetails.
        :type native_type_system: oci.data_integration.models.TypeSystem

        :param object_version:
            The value to assign to the object_version property of this DataAssetFromOracleDetails.
        :type object_version: int

        :param parent_ref:
            The value to assign to the parent_ref property of this DataAssetFromOracleDetails.
        :type parent_ref: oci.data_integration.models.ParentReference

        :param metadata:
            The value to assign to the metadata property of this DataAssetFromOracleDetails.
        :type metadata: oci.data_integration.models.ObjectMetadata

        :param key_map:
            The value to assign to the key_map property of this DataAssetFromOracleDetails.
        :type key_map: dict(str, str)

        :param host:
            The value to assign to the host property of this DataAssetFromOracleDetails.
        :type host: str

        :param port:
            The value to assign to the port property of this DataAssetFromOracleDetails.
        :type port: str

        :param service_name:
            The value to assign to the service_name property of this DataAssetFromOracleDetails.
        :type service_name: str

        :param driver_class:
            The value to assign to the driver_class property of this DataAssetFromOracleDetails.
        :type driver_class: str

        :param sid:
            The value to assign to the sid property of this DataAssetFromOracleDetails.
        :type sid: str
    ...
    def credential_file_content(self):
        """
        Gets the credential_file_content of this DataAssetFromOracleDetails.
        The credential file content from a wallet for the data asset.


        :return: The credential_file_content of this DataAssetFromOracleDetails.
        :rtype: str
        """
    ...
    def credential_file_content(self, credential_file_content):
        """
        Sets the credential_file_content of this DataAssetFromOracleDetails.
        The credential file content from a wallet for the data asset.


        :param credential_file_content: The credential_file_content of this DataAssetFromOracleDetails.
        :type: str
        """
    ...
    def default_connection(self):
        """
        Gets the default_connection of this DataAssetFromOracleDetails.

        :return: The default_connection of this DataAssetFromOracleDetails.
        :rtype: oci.data_integration.models.ConnectionFromOracleDetails
        """
    ...
    def default_connection(self, default_connection):
        """
        Sets the default_connection of this DataAssetFromOracleDetails.

        :param default_connection: The default_connection of this DataAssetFromOracleDetails.
        :type: oci.data_integration.models.ConnectionFromOracleDetails
        """
