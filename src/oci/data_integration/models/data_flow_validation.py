...
class DataFlowValidation(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new DataFlowValidation object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param total_message_count:
            The value to assign to the total_message_count property of this DataFlowValidation.
        :type total_message_count: int

        :param error_message_count:
            The value to assign to the error_message_count property of this DataFlowValidation.
        :type error_message_count: int

        :param warn_message_count:
            The value to assign to the warn_message_count property of this DataFlowValidation.
        :type warn_message_count: int

        :param info_message_count:
            The value to assign to the info_message_count property of this DataFlowValidation.
        :type info_message_count: int

        :param validation_messages:
            The value to assign to the validation_messages property of this DataFlowValidation.
        :type validation_messages: dict(str, list[ValidationMessage])

        :param key:
            The value to assign to the key property of this DataFlowValidation.
        :type key: str

        :param model_type:
            The value to assign to the model_type property of this DataFlowValidation.
        :type model_type: str

        :param model_version:
            The value to assign to the model_version property of this DataFlowValidation.
        :type model_version: str

        :param parent_ref:
            The value to assign to the parent_ref property of this DataFlowValidation.
        :type parent_ref: ParentReference

        :param name:
            The value to assign to the name property of this DataFlowValidation.
        :type name: str

        :param description:
            The value to assign to the description property of this DataFlowValidation.
        :type description: str

        :param object_version:
            The value to assign to the object_version property of this DataFlowValidation.
        :type object_version: int

        :param object_status:
            The value to assign to the object_status property of this DataFlowValidation.
        :type object_status: int

        :param identifier:
            The value to assign to the identifier property of this DataFlowValidation.
        :type identifier: str

        :param metadata:
            The value to assign to the metadata property of this DataFlowValidation.
    ...
    def model_type(self):
        """
        Gets the model_type of this DataFlowValidation.
        The type of the object.


        :return: The model_type of this DataFlowValidation.
        :rtype: str
        """
    ...
    def model_type(self, model_type):
        """
        Sets the model_type of this DataFlowValidation.
        The type of the object.


        :param model_type: The model_type of this DataFlowValidation.
        :type: str
        """
    ...
    def parent_ref(self):
        """
        Gets the parent_ref of this DataFlowValidation.

        :return: The parent_ref of this DataFlowValidation.
    ...
    def parent_ref(self, parent_ref):
        """
        Sets the parent_ref of this DataFlowValidation.

        :param parent_ref: The parent_ref of this DataFlowValidation.
    ...
    def description(self):
        """
        Gets the description of this DataFlowValidation.
        Detailed description for the object.


        :return: The description of this DataFlowValidation.
        :rtype: str
        """
    ...
    def description(self, description):
        """
        Sets the description of this DataFlowValidation.
        Detailed description for the object.


        :param description: The description of this DataFlowValidation.
        :type: str
        """
    ...
    def object_version(self):
        """
        Gets the object_version of this DataFlowValidation.
        The version of the object that is used to track changes in the object instance.


        :return: The object_version of this DataFlowValidation.
        :rtype: int
        """
    ...
    def object_version(self, object_version):
        """
        Sets the object_version of this DataFlowValidation.
        The version of the object that is used to track changes in the object instance.


        :param object_version: The object_version of this DataFlowValidation.
        :type: int
        """
    ...
    def object_status(self):
        """
        Gets the object_status of this DataFlowValidation.
        The status of an object that can be set to value 1 for shallow references across objects, other values reserved.


        :return: The object_status of this DataFlowValidation.
        :rtype: int
        """
    ...
    def object_status(self, object_status):
        """
        Sets the object_status of this DataFlowValidation.
        The status of an object that can be set to value 1 for shallow references across objects, other values reserved.


        :param object_status: The object_status of this DataFlowValidation.
        :type: int
        """
    ...
    def metadata(self):
        """
        Gets the metadata of this DataFlowValidation.

        :return: The metadata of this DataFlowValidation.
    ...
    def metadata(self, metadata):
        """
        Sets the metadata of this DataFlowValidation.

        :param metadata: The metadata of this DataFlowValidation.
        :type: ObjectMetadata
        """
