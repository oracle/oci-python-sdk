...
class FlowPort(TypedObject):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new FlowPort object with values from keyword arguments. The default value of the :py:attr:`~oci.data_integration.models.FlowPort.model_type` attribute
        of this class is ``FLOW_PORT`` and it should not be changed.
        ...
        :param key:
            The value to assign to the key property of this FlowPort.
        :type key: str

        :param model_version:
            The value to assign to the model_version property of this FlowPort.
        ...
        :param name:
            The value to assign to the name property of this FlowPort.
        :type name: str

        :param description:
            The value to assign to the description property of this FlowPort.
