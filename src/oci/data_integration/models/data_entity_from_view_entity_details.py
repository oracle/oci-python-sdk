...
class DataEntityFromViewEntityDetails(DataEntityDetails):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new DataEntityFromViewEntityDetails object with values from keyword arguments. The default value of the :py:attr:`~oci.data_integration.models.DataEntityFromViewEntityDetails.model_type` attribute
