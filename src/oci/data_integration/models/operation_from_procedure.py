...
class OperationFromProcedure(Operation):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new OperationFromProcedure object with values from keyword arguments. The default value of the :py:attr:`~oci.data_integration.models.OperationFromProcedure.model_type` attribute
