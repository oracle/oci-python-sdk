...
class ReferencedDataObjectFromProcedure(ReferencedDataObject):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ReferencedDataObjectFromProcedure object with values from keyword arguments. The default value of the :py:attr:`~oci.data_integration.models.ReferencedDataObjectFromProcedure.model_type` attribute
