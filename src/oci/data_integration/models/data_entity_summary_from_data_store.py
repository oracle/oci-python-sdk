...
class DataEntitySummaryFromDataStore(DataEntitySummary):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new DataEntitySummaryFromDataStore object with values from keyword arguments. The default value of the :py:attr:`~oci.data_integration.models.DataEntitySummaryFromDataStore.model_type` attribute
        ...
        :param types:
            The value to assign to the types property of this DataEntitySummaryFromDataStore.
    ...
    def types(self):
        """
        Gets the types of this DataEntitySummaryFromDataStore.

        :return: The types of this DataEntitySummaryFromDataStore.
    ...
    def types(self, types):
        """
        Sets the types of this DataEntitySummaryFromDataStore.

        :param types: The types of this DataEntitySummaryFromDataStore.
