...
class DecisionOperator(Operator):
    ...
    #: A constant which can be used with the trigger_rule property of a DecisionOperator.
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new DecisionOperator object with values from keyword arguments. The default value of the :py:attr:`~oci.data_integration.models.DecisionOperator.model_type` attribute
        of this class is ``DECISION_OPERATOR`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param model_type:
            The value to assign to the model_type property of this DecisionOperator.
        ...
        :param key:
            The value to assign to the key property of this DecisionOperator.
        :type key: str

        :param model_version:
            The value to assign to the model_version property of this DecisionOperator.
        :type model_version: str

        :param parent_ref:
            The value to assign to the parent_ref property of this DecisionOperator.
        :type parent_ref: oci.data_integration.models.ParentReference

        :param name:
            The value to assign to the name property of this DecisionOperator.
        :type name: str

        :param description:
            The value to assign to the description property of this DecisionOperator.
        :type description: str

        :param object_version:
            The value to assign to the object_version property of this DecisionOperator.
        :type object_version: int

        :param input_ports:
            The value to assign to the input_ports property of this DecisionOperator.
        :type input_ports: list[oci.data_integration.models.InputPort]

        :param output_ports:
            The value to assign to the output_ports property of this DecisionOperator.
        :type output_ports: list[oci.data_integration.models.TypedObject]

        :param object_status:
            The value to assign to the object_status property of this DecisionOperator.
        :type object_status: int

        :param identifier:
            The value to assign to the identifier property of this DecisionOperator.
        :type identifier: str

        :param parameters:
            The value to assign to the parameters property of this DecisionOperator.
        :type parameters: list[oci.data_integration.models.Parameter]

        :param op_config_values:
            The value to assign to the op_config_values property of this DecisionOperator.
        :type op_config_values: oci.data_integration.models.ConfigValues

        :param trigger_rule:
            The value to assign to the trigger_rule property of this DecisionOperator.
        ...
        :param config_provider_delegate:
            The value to assign to the config_provider_delegate property of this DecisionOperator.
        ...
        self._model_type = 'DECISION_OPERATOR'

    @property
    def trigger_rule(self):
        """
        Gets the trigger_rule of this DecisionOperator.
        ...
        :return: The trigger_rule of this DecisionOperator.
        :rtype: str
        """
    ...
    def trigger_rule(self, trigger_rule):
        """
        Sets the trigger_rule of this DecisionOperator.
        The merge condition. The conditions are
        ALL_SUCCESS - All the preceeding operators need to be successful.
        ALL_FAILED - All the preceeding operators should have failed.
        ALL_COMPLETE - All the preceeding operators should have completed. It could have executed successfully or failed.
        ...
        :param trigger_rule: The trigger_rule of this DecisionOperator.
        :type: str
        """
    ...
    def config_provider_delegate(self):
        """
        Gets the config_provider_delegate of this DecisionOperator.

        :return: The config_provider_delegate of this DecisionOperator.
    ...
    def config_provider_delegate(self, config_provider_delegate):
        """
        Sets the config_provider_delegate of this DecisionOperator.

        :param config_provider_delegate: The config_provider_delegate of this DecisionOperator.
