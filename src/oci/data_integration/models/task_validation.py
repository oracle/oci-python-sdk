...
class TaskValidation(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new TaskValidation object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param total_message_count:
            The value to assign to the total_message_count property of this TaskValidation.
        :type total_message_count: int

        :param error_message_count:
            The value to assign to the error_message_count property of this TaskValidation.
        :type error_message_count: int

        :param warn_message_count:
            The value to assign to the warn_message_count property of this TaskValidation.
        :type warn_message_count: int

        :param info_message_count:
            The value to assign to the info_message_count property of this TaskValidation.
        :type info_message_count: int

        :param validation_messages:
            The value to assign to the validation_messages property of this TaskValidation.
        :type validation_messages: dict(str, list[ValidationMessage])

        :param key:
            The value to assign to the key property of this TaskValidation.
        :type key: str

        :param model_type:
            The value to assign to the model_type property of this TaskValidation.
        :type model_type: str

        :param model_version:
            The value to assign to the model_version property of this TaskValidation.
        :type model_version: str

        :param parent_ref:
            The value to assign to the parent_ref property of this TaskValidation.
        :type parent_ref: ParentReference

        :param name:
            The value to assign to the name property of this TaskValidation.
        :type name: str

        :param description:
            The value to assign to the description property of this TaskValidation.
        :type description: str

        :param object_version:
            The value to assign to the object_version property of this TaskValidation.
        :type object_version: int

        :param object_status:
            The value to assign to the object_status property of this TaskValidation.
        :type object_status: int

        :param identifier:
            The value to assign to the identifier property of this TaskValidation.
        :type identifier: str

        :param metadata:
            The value to assign to the metadata property of this TaskValidation.
    ...
    def model_type(self):
        """
        Gets the model_type of this TaskValidation.
        The type of the object.


        :return: The model_type of this TaskValidation.
        :rtype: str
        """
    ...
    def model_type(self, model_type):
        """
        Sets the model_type of this TaskValidation.
        The type of the object.


        :param model_type: The model_type of this TaskValidation.
        :type: str
        """
    ...
    def model_version(self):
        """
        Gets the model_version of this TaskValidation.
        The model version of an object.


        :return: The model_version of this TaskValidation.
        :rtype: str
        """
    ...
    def model_version(self, model_version):
        """
        Sets the model_version of this TaskValidation.
        The model version of an object.


        :param model_version: The model_version of this TaskValidation.
        :type: str
        """
    ...
    def parent_ref(self):
        """
        Gets the parent_ref of this TaskValidation.

        :return: The parent_ref of this TaskValidation.
    ...
    def parent_ref(self, parent_ref):
        """
        Sets the parent_ref of this TaskValidation.

        :param parent_ref: The parent_ref of this TaskValidation.
    ...
    def description(self):
        """
        Gets the description of this TaskValidation.
        Detailed description for the object.


        :return: The description of this TaskValidation.
        :rtype: str
        """
    ...
    def description(self, description):
        """
        Sets the description of this TaskValidation.
        Detailed description for the object.


        :param description: The description of this TaskValidation.
        :type: str
        """
    ...
    def object_version(self):
        """
        Gets the object_version of this TaskValidation.
        The version of the object that is used to track changes in the object instance.


        :return: The object_version of this TaskValidation.
        :rtype: int
        """
    ...
    def object_version(self, object_version):
        """
        Sets the object_version of this TaskValidation.
        The version of the object that is used to track changes in the object instance.


        :param object_version: The object_version of this TaskValidation.
        :type: int
        """
    ...
    def object_status(self):
        """
        Gets the object_status of this TaskValidation.
        The status of an object that can be set to value 1 for shallow references across objects, other values reserved.


        :return: The object_status of this TaskValidation.
        :rtype: int
        """
    ...
    def object_status(self, object_status):
        """
        Sets the object_status of this TaskValidation.
        The status of an object that can be set to value 1 for shallow references across objects, other values reserved.


        :param object_status: The object_status of this TaskValidation.
        :type: int
        """
    ...
    def metadata(self):
        """
        Gets the metadata of this TaskValidation.

        :return: The metadata of this TaskValidation.
    ...
    def metadata(self, metadata):
        """
        Sets the metadata of this TaskValidation.

        :param metadata: The metadata of this TaskValidation.
        :type: ObjectMetadata
        """
