...
class TemplateSummary(object):
    ...
    #: A constant which can be used with the lifecycle_state property of a TemplateSummary.
    ...
    def __init__(self, **kwargs):
        ...
        :param key:
            The value to assign to the key property of this TemplateSummary.
        :type key: str

        :param model_type:
            The value to assign to the model_type property of this TemplateSummary.
        :type model_type: str

        :param model_version:
            The value to assign to the model_version property of this TemplateSummary.
        :type model_version: str

        :param name:
            The value to assign to the name property of this TemplateSummary.
        :type name: str
        ...
        :param application_version:
            The value to assign to the application_version property of this TemplateSummary.
        :type application_version: int

        :param object_status:
            The value to assign to the object_status property of this TemplateSummary.
        :type object_status: int

        :param identifier:
            The value to assign to the identifier property of this TemplateSummary.
        :type identifier: str

        :param parent_ref:
            The value to assign to the parent_ref property of this TemplateSummary.
        :type parent_ref: oci.data_integration.models.ParentReference

        :param object_version:
            The value to assign to the object_version property of this TemplateSummary.
        :type object_version: int

        :param dependent_object_metadata:
            The value to assign to the dependent_object_metadata property of this TemplateSummary.
        :type dependent_object_metadata: list[oci.data_integration.models.PatchObjectMetadata]

        :param published_object_metadata:
            The value to assign to the published_object_metadata property of this TemplateSummary.
        :type published_object_metadata: dict(str, PatchObjectMetadata)

        :param source_application_info:
            The value to assign to the source_application_info property of this TemplateSummary.
        :type source_application_info: oci.data_integration.models.SourceApplicationInfo

        :param time_patched:
            The value to assign to the time_patched property of this TemplateSummary.
        ...
        :param time_updated:
            The value to assign to the time_updated property of this TemplateSummary.
        ...
        :param metadata:
            The value to assign to the metadata property of this TemplateSummary.
        :type metadata: oci.data_integration.models.ObjectMetadata

        :param key_map:
            The value to assign to the key_map property of this TemplateSummary.
    ...
    def key(self):
        """
        Gets the key of this TemplateSummary.
        Generated key that can be used in API calls to identify application.


        :return: The key of this TemplateSummary.
        :rtype: str
        """
        return self._key
    ...
    def key(self, key):
        """
        Sets the key of this TemplateSummary.
        Generated key that can be used in API calls to identify application.


        :param key: The key of this TemplateSummary.
        :type: str
        """
        self._key = key
    ...
    def model_type(self):
        """
        Gets the model_type of this TemplateSummary.
        The object type.


        :return: The model_type of this TemplateSummary.
        :rtype: str
        """
    ...
    def model_type(self, model_type):
        """
        Sets the model_type of this TemplateSummary.
        The object type.


        :param model_type: The model_type of this TemplateSummary.
        :type: str
        """
    ...
    def model_version(self):
        """
        Gets the model_version of this TemplateSummary.
        The object's model version.


        :return: The model_version of this TemplateSummary.
        :rtype: str
        """
    ...
    def model_version(self, model_version):
        """
        Sets the model_version of this TemplateSummary.
        The object's model version.


        :param model_version: The model_version of this TemplateSummary.
        :type: str
        """
    ...
    def application_version(self):
        """
        Gets the application_version of this TemplateSummary.
        The application's version.


        :return: The application_version of this TemplateSummary.
        :rtype: int
        """
    ...
    def application_version(self, application_version):
        """
        Sets the application_version of this TemplateSummary.
        The application's version.


        :param application_version: The application_version of this TemplateSummary.
        :type: int
        """
    ...
    def object_status(self):
        """
        Gets the object_status of this TemplateSummary.
        The status of an object that can be set to value 1 for shallow references across objects, other values reserved.


        :return: The object_status of this TemplateSummary.
        :rtype: int
        """
    ...
    def object_status(self, object_status):
        """
        Sets the object_status of this TemplateSummary.
        The status of an object that can be set to value 1 for shallow references across objects, other values reserved.


        :param object_status: The object_status of this TemplateSummary.
        :type: int
        """
    ...
    def identifier(self):
        """
        Gets the identifier of this TemplateSummary.
        Value can only contain upper case letters, underscore, and numbers. It should begin with upper case letter or underscore. The value can be modified.


        :return: The identifier of this TemplateSummary.
        :rtype: str
        """
    ...
    def identifier(self, identifier):
        """
        Sets the identifier of this TemplateSummary.
        Value can only contain upper case letters, underscore, and numbers. It should begin with upper case letter or underscore. The value can be modified.


        :param identifier: The identifier of this TemplateSummary.
        :type: str
        """
    ...
    def parent_ref(self):
        ...
        :return: The parent_ref of this TemplateSummary.
    ...
    def parent_ref(self, parent_ref):
        """
        Sets the parent_ref of this TemplateSummary.

        :param parent_ref: The parent_ref of this TemplateSummary.
    ...
    def object_version(self):
        """
        Gets the object_version of this TemplateSummary.
        The version of the object that is used to track changes in the object instance.


        :return: The object_version of this TemplateSummary.
        :rtype: int
        """
    ...
    def object_version(self, object_version):
        """
        Sets the object_version of this TemplateSummary.
        The version of the object that is used to track changes in the object instance.


        :param object_version: The object_version of this TemplateSummary.
        :type: int
        """
    ...
    def dependent_object_metadata(self):
        """
        Gets the dependent_object_metadata of this TemplateSummary.
        A list of dependent objects in this patch.


        :return: The dependent_object_metadata of this TemplateSummary.
    ...
    def dependent_object_metadata(self, dependent_object_metadata):
        """
        Sets the dependent_object_metadata of this TemplateSummary.
        A list of dependent objects in this patch.


        :param dependent_object_metadata: The dependent_object_metadata of this TemplateSummary.
    ...
    def published_object_metadata(self):
        """
        Gets the published_object_metadata of this TemplateSummary.
        A list of objects that are published or unpublished in this patch.


        :return: The published_object_metadata of this TemplateSummary.
    ...
    def published_object_metadata(self, published_object_metadata):
        """
        Sets the published_object_metadata of this TemplateSummary.
        A list of objects that are published or unpublished in this patch.


        :param published_object_metadata: The published_object_metadata of this TemplateSummary.
    ...
    def source_application_info(self):
        ...
        :return: The source_application_info of this TemplateSummary.
    ...
    def source_application_info(self, source_application_info):
        """
        Sets the source_application_info of this TemplateSummary.

        :param source_application_info: The source_application_info of this TemplateSummary.
    ...
    def time_patched(self):
        """
        Gets the time_patched of this TemplateSummary.
        The date and time the application was patched, in the timestamp format defined by RFC3339.


        :return: The time_patched of this TemplateSummary.
        :rtype: datetime
        """
    ...
    def time_patched(self, time_patched):
        """
        Sets the time_patched of this TemplateSummary.
        The date and time the application was patched, in the timestamp format defined by RFC3339.


        :param time_patched: The time_patched of this TemplateSummary.
        :type: datetime
        """
    ...
    def time_updated(self, time_updated):
        """
        Sets the time_updated of this TemplateSummary.
        The date and time the application was updated, in the timestamp format defined by RFC3339.
        example: 2019-08-25T21:10:29.41Z


        :param time_updated: The time_updated of this TemplateSummary.
        :type: datetime
        """
    ...
    def metadata(self):
        ...
        :return: The metadata of this TemplateSummary.
    ...
    def metadata(self, metadata):
        """
        Sets the metadata of this TemplateSummary.

        :param metadata: The metadata of this TemplateSummary.
    ...
    def key_map(self):
        """
        Gets the key_map of this TemplateSummary.
        A key map. If provided, key is replaced with generated key. This structure provides mapping between user provided key and generated key.


        :return: The key_map of this TemplateSummary.
        :rtype: dict(str, str)
        """
    ...
    def key_map(self, key_map):
        """
        Sets the key_map of this TemplateSummary.
        A key map. If provided, key is replaced with generated key. This structure provides mapping between user provided key and generated key.


        :param key_map: The key_map of this TemplateSummary.
        :type: dict(str, str)
        """
