...
class PublishedObjectSummaryFromDataLoaderTask(PublishedObjectSummary):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new PublishedObjectSummaryFromDataLoaderTask object with values from keyword arguments. The default value of the :py:attr:`~oci.data_integration.models.PublishedObjectSummaryFromDataLoaderTask.model_type` attribute
        ...
        :param key:
            The value to assign to the key property of this PublishedObjectSummaryFromDataLoaderTask.
        :type key: str

        :param model_version:
            The value to assign to the model_version property of this PublishedObjectSummaryFromDataLoaderTask.
        ...
        :param description:
            The value to assign to the description property of this PublishedObjectSummaryFromDataLoaderTask.
        :type description: str

        :param object_version:
            The value to assign to the object_version property of this PublishedObjectSummaryFromDataLoaderTask.
        :type object_version: int

        :param object_status:
            The value to assign to the object_status property of this PublishedObjectSummaryFromDataLoaderTask.
        :type object_status: int

        :param identifier:
            The value to assign to the identifier property of this PublishedObjectSummaryFromDataLoaderTask.
        :type identifier: str
    ...
    def input_ports(self):
        """
        Gets the input_ports of this PublishedObjectSummaryFromDataLoaderTask.
    ...
    def input_ports(self, input_ports):
        """
        Sets the input_ports of this PublishedObjectSummaryFromDataLoaderTask.
        An array of input ports.
    ...
    def output_ports(self):
        """
        Gets the output_ports of this PublishedObjectSummaryFromDataLoaderTask.
    ...
    def output_ports(self, output_ports):
        """
        Sets the output_ports of this PublishedObjectSummaryFromDataLoaderTask.
        An array of output ports.
    ...
    def parameters(self):
        """
        Gets the parameters of this PublishedObjectSummaryFromDataLoaderTask.
    ...
    def parameters(self, parameters):
        """
        Sets the parameters of this PublishedObjectSummaryFromDataLoaderTask.
        An array of parameters.
