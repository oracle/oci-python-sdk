...
class EntityShapeFromFile(EntityShape):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new EntityShapeFromFile object with values from keyword arguments. The default value of the :py:attr:`~oci.data_integration.models.EntityShapeFromFile.model_type` attribute
