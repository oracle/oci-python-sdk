...
class ConnectionFromOracleDetails(ConnectionDetails):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ConnectionFromOracleDetails object with values from keyword arguments. The default value of the :py:attr:`~oci.data_integration.models.ConnectionFromOracleDetails.model_type` attribute
        ...
        :param key:
            The value to assign to the key property of this ConnectionFromOracleDetails.
        :type key: str

        :param model_version:
            The value to assign to the model_version property of this ConnectionFromOracleDetails.
        ...
        :param description:
            The value to assign to the description property of this ConnectionFromOracleDetails.
        :type description: str

        :param object_version:
            The value to assign to the object_version property of this ConnectionFromOracleDetails.
        :type object_version: int

        :param object_status:
            The value to assign to the object_status property of this ConnectionFromOracleDetails.
        :type object_status: int

        :param identifier:
            The value to assign to the identifier property of this ConnectionFromOracleDetails.
        :type identifier: str
    ...
    def username(self):
        """
        Gets the username of this ConnectionFromOracleDetails.
        The user name for the connection.


        :return: The username of this ConnectionFromOracleDetails.
        :rtype: str
        """
    ...
    def username(self, username):
        """
        Sets the username of this ConnectionFromOracleDetails.
        The user name for the connection.


        :param username: The username of this ConnectionFromOracleDetails.
        :type: str
        """
    ...
    def password(self):
        """
        Gets the password of this ConnectionFromOracleDetails.
        The password for the connection.


        :return: The password of this ConnectionFromOracleDetails.
        :rtype: str
        """
    ...
    def password(self, password):
        """
        Sets the password of this ConnectionFromOracleDetails.
        The password for the connection.


        :param password: The password of this ConnectionFromOracleDetails.
        :type: str
        """
