...
class Connection(object):
    ...
    def get_subtype(object_dictionary):
        ...
        if type == 'MYSQL_HEATWAVE_CONNECTION':
            return 'ConnectionFromMySqlHeatWave'
