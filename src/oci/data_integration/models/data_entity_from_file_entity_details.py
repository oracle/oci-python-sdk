...
class DataEntityFromFileEntityDetails(DataEntityDetails):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new DataEntityFromFileEntityDetails object with values from keyword arguments. The default value of the :py:attr:`~oci.data_integration.models.DataEntityFromFileEntityDetails.model_type` attribute
        ...
        :param key:
            The value to assign to the key property of this DataEntityFromFileEntityDetails.
        :type key: str

        :param model_version:
            The value to assign to the model_version property of this DataEntityFromFileEntityDetails.
        ...
        :param description:
            The value to assign to the description property of this DataEntityFromFileEntityDetails.
        :type description: str

        :param object_version:
            The value to assign to the object_version property of this DataEntityFromFileEntityDetails.
        :type object_version: int

        :param external_key:
            The value to assign to the external_key property of this DataEntityFromFileEntityDetails.
        ...
        :param other_type_label:
            The value to assign to the other_type_label property of this DataEntityFromFileEntityDetails.
        ...
        :param identifier:
            The value to assign to the identifier property of this DataEntityFromFileEntityDetails.
        :type identifier: str
    ...
    def object_version(self):
        """
        Gets the object_version of this DataEntityFromFileEntityDetails.
    ...
    def object_version(self, object_version):
        """
        Sets the object_version of this DataEntityFromFileEntityDetails.
        The version of the object that is used to track changes in the object instance.
    ...
    def shape_id(self):
        """
        Gets the shape_id of this DataEntityFromFileEntityDetails.
        The shape ID.


        :return: The shape_id of this DataEntityFromFileEntityDetails.
        :rtype: str
        """
    ...
    def shape_id(self, shape_id):
        """
        Sets the shape_id of this DataEntityFromFileEntityDetails.
        The shape ID.


        :param shape_id: The shape_id of this DataEntityFromFileEntityDetails.
        :type: str
        """
    ...
    def entity_type(self, entity_type):
        """
        Sets the entity_type of this DataEntityFromFileEntityDetails.
        The entity type.
    ...
    def other_type_label(self):
        """
        Gets the other_type_label of this DataEntityFromFileEntityDetails.
        Specifies other type label.


        :return: The other_type_label of this DataEntityFromFileEntityDetails.
        :rtype: str
        """
    ...
    def other_type_label(self, other_type_label):
        """
        Sets the other_type_label of this DataEntityFromFileEntityDetails.
        Specifies other type label.


        :param other_type_label: The other_type_label of this DataEntityFromFileEntityDetails.
        :type: str
        """
    ...
    def unique_keys(self):
        """
        Gets the unique_keys of this DataEntityFromFileEntityDetails.
    ...
    def unique_keys(self, unique_keys):
        """
        Sets the unique_keys of this DataEntityFromFileEntityDetails.
        An array of unique keys.
    ...
    def foreign_keys(self):
        """
        Gets the foreign_keys of this DataEntityFromFileEntityDetails.
    ...
    def foreign_keys(self, foreign_keys):
        """
        Sets the foreign_keys of this DataEntityFromFileEntityDetails.
        An array of foreign keys.
    ...
    def resource_name(self):
        """
        Gets the resource_name of this DataEntityFromFileEntityDetails.
        The resource name.


        :return: The resource_name of this DataEntityFromFileEntityDetails.
        :rtype: str
        """
    ...
    def resource_name(self, resource_name):
        """
        Sets the resource_name of this DataEntityFromFileEntityDetails.
        The resource name.


        :param resource_name: The resource_name of this DataEntityFromFileEntityDetails.
        :type: str
        """
    ...
    def object_status(self):
        """
        Gets the object_status of this DataEntityFromFileEntityDetails.
        The status of an object that can be set to value 1 for shallow references across objects, other values reserved.


        :return: The object_status of this DataEntityFromFileEntityDetails.
        :rtype: int
        """
    ...
    def object_status(self, object_status):
        """
        Sets the object_status of this DataEntityFromFileEntityDetails.
        The status of an object that can be set to value 1 for shallow references across objects, other values reserved.


        :param object_status: The object_status of this DataEntityFromFileEntityDetails.
        :type: int
        """
