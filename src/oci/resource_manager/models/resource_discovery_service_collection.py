...
class ResourceDiscoveryServiceCollection(object):
    """
    The list of `services supported for use with Resource Discovery`__.
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ResourceDiscoveryServiceCollection object with values from keyword arguments.
    ...
    def items(self):
        """
        **[Required]** Gets the items of this ResourceDiscoveryServiceCollection.
    ...
    def items(self, items):
        """
        Sets the items of this ResourceDiscoveryServiceCollection.
        Collection of supported services for Resource Discovery.
