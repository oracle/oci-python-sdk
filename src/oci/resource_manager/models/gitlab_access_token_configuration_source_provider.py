...
class GitlabAccessTokenConfigurationSourceProvider(ConfigurationSourceProvider):
    ...
    def __init__(self, **kwargs):
        ...
        :param username:
            The value to assign to the username property of this GitlabAccessTokenConfigurationSourceProvider.
        :type username: str

        :param secret_id:
            The value to assign to the secret_id property of this GitlabAccessTokenConfigurationSourceProvider.
        :type secret_id: str
