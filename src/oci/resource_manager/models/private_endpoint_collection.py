...
class PrivateEndpointCollection(object):
    ...
    def __init__(self, **kwargs):
        ...
        :type items: list[oci.resource_manager.models.PrivateEndpointSummary]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this PrivateEndpointCollection.
        ...
        :rtype: list[oci.resource_manager.models.PrivateEndpointSummary]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.resource_manager.models.PrivateEndpointSummary]
        """
        self._items = items
