...
class UpdateDevOpsConfigSourceDetails(UpdateConfigSourceDetails):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new UpdateDevOpsConfigSourceDetails object with values from keyword arguments. The default value of the :py:attr:`~oci.resource_manager.models.UpdateDevOpsConfigSourceDetails.config_source_type` attribute
        of this class is ``DEVOPS_CONFIG_SOURCE`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param config_source_type:
            The value to assign to the config_source_type property of this UpdateDevOpsConfigSourceDetails.
        :type config_source_type: str

        :param working_directory:
            The value to assign to the working_directory property of this UpdateDevOpsConfigSourceDetails.
        :type working_directory: str

        :param project_id:
            The value to assign to the project_id property of this UpdateDevOpsConfigSourceDetails.
        :type project_id: str

        :param repository_id:
            The value to assign to the repository_id property of this UpdateDevOpsConfigSourceDetails.
        :type repository_id: str

        :param branch_name:
            The value to assign to the branch_name property of this UpdateDevOpsConfigSourceDetails.
    ...
    def branch_name(self):
        """
        Gets the branch_name of this UpdateDevOpsConfigSourceDetails.
        The name of the branch that contains the Terraform configuration.


        :return: The branch_name of this UpdateDevOpsConfigSourceDetails.
        :rtype: str
        """
    ...
    def branch_name(self, branch_name):
        """
        Sets the branch_name of this UpdateDevOpsConfigSourceDetails.
        The name of the branch that contains the Terraform configuration.


        :param branch_name: The branch_name of this UpdateDevOpsConfigSourceDetails.
        :type: str
        """
