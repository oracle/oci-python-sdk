...
class ConfigurationSourceProviderCollection(object):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ConfigurationSourceProviderCollection object with values from keyword arguments.
    ...
    def items(self, items):
        """
        Sets the items of this ConfigurationSourceProviderCollection.
        Collection of configuration source providers.
