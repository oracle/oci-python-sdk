...
class ZprCidrUnsupportedSecurityActionDetails(object):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ZprCidrUnsupportedSecurityActionDetails object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param is_restricted_or_partial:
            The value to assign to the is_restricted_or_partial property of this ZprCidrUnsupportedSecurityActionDetails.
        :type is_restricted_or_partial: bool

        :param evaluated_zpr_policies:
            The value to assign to the evaluated_zpr_policies property of this ZprCidrUnsupportedSecurityActionDetails.
    ...
    def is_restricted_or_partial(self):
        """
        **[Required]** Gets the is_restricted_or_partial of this ZprCidrUnsupportedSecurityActionDetails.
        If true, the evaluated zpr policy ID details are incomplete.


        :return: The is_restricted_or_partial of this ZprCidrUnsupportedSecurityActionDetails.
        :rtype: bool
        """
    ...
    def is_restricted_or_partial(self, is_restricted_or_partial):
        """
        Sets the is_restricted_or_partial of this ZprCidrUnsupportedSecurityActionDetails.
        If true, the evaluated zpr policy ID details are incomplete.


        :param is_restricted_or_partial: The is_restricted_or_partial of this ZprCidrUnsupportedSecurityActionDetails.
        :type: bool
        """
    ...
    def evaluated_zpr_policies(self):
        """
        Gets the evaluated_zpr_policies of this ZprCidrUnsupportedSecurityActionDetails.
        The list of evaluated zpr policies associated with the OCI resource.


        :return: The evaluated_zpr_policies of this ZprCidrUnsupportedSecurityActionDetails.
    ...
    def evaluated_zpr_policies(self, evaluated_zpr_policies):
        """
        Sets the evaluated_zpr_policies of this ZprCidrUnsupportedSecurityActionDetails.
        The list of evaluated zpr policies associated with the OCI resource.


        :param evaluated_zpr_policies: The evaluated_zpr_policies of this ZprCidrUnsupportedSecurityActionDetails.
