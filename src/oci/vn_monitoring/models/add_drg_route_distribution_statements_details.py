...
class AddDrgRouteDistributionStatementsDetails(object):
    ...
    def __init__(self, **kwargs):
        ...
        :type statements: list[oci.vn_monitoring.models.AddDrgRouteDistributionStatementDetails]
    ...
    def statements(self):
        ...
        **[Required]** Gets the statements of this AddDrgRouteDistributionStatementsDetails.
        ...
        :rtype: list[oci.vn_monitoring.models.AddDrgRouteDistributionStatementDetails]
        """
    ...
    def statements(self, statements):
        ...
        :type: list[oci.vn_monitoring.models.AddDrgRouteDistributionStatementDetails]
        """
