...
class ZprNsgUnsupportedSecurityActionDetails(object):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ZprNsgUnsupportedSecurityActionDetails object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param is_restricted_or_partial:
            The value to assign to the is_restricted_or_partial property of this ZprNsgUnsupportedSecurityActionDetails.
        :type is_restricted_or_partial: bool

        :param evaluated_zpr_policies:
            The value to assign to the evaluated_zpr_policies property of this ZprNsgUnsupportedSecurityActionDetails.
    ...
    def is_restricted_or_partial(self):
        """
        **[Required]** Gets the is_restricted_or_partial of this ZprNsgUnsupportedSecurityActionDetails.
        If true, the evaluated zpr policy ID details are incomplete.


        :return: The is_restricted_or_partial of this ZprNsgUnsupportedSecurityActionDetails.
        :rtype: bool
        """
    ...
    def is_restricted_or_partial(self, is_restricted_or_partial):
        """
        Sets the is_restricted_or_partial of this ZprNsgUnsupportedSecurityActionDetails.
        If true, the evaluated zpr policy ID details are incomplete.


        :param is_restricted_or_partial: The is_restricted_or_partial of this ZprNsgUnsupportedSecurityActionDetails.
        :type: bool
        """
    ...
    def evaluated_zpr_policies(self):
        """
        Gets the evaluated_zpr_policies of this ZprNsgUnsupportedSecurityActionDetails.
        The list of evaluated zpr policies associated with the OCI resource.


        :return: The evaluated_zpr_policies of this ZprNsgUnsupportedSecurityActionDetails.
    ...
    def evaluated_zpr_policies(self, evaluated_zpr_policies):
        """
        Sets the evaluated_zpr_policies of this ZprNsgUnsupportedSecurityActionDetails.
        The list of evaluated zpr policies associated with the OCI resource.


        :param evaluated_zpr_policies: The evaluated_zpr_policies of this ZprNsgUnsupportedSecurityActionDetails.
