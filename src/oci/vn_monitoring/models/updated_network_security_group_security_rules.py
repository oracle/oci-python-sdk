...
class UpdatedNetworkSecurityGroupSecurityRules(object):
    ...
    def __init__(self, **kwargs):
        ...
        :type security_rules: list[oci.vn_monitoring.models.SecurityRule]
    ...
    def security_rules(self):
        ...
        :rtype: list[oci.vn_monitoring.models.SecurityRule]
        """
    ...
    def security_rules(self, security_rules):
        ...
        :type: list[oci.vn_monitoring.models.SecurityRule]
        """
