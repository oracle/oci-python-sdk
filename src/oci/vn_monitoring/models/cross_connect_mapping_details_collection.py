...
class CrossConnectMappingDetailsCollection(object):
    ...
    def __init__(self, **kwargs):
        ...
        :type items: list[oci.vn_monitoring.models.CrossConnectMappingDetails]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this CrossConnectMappingDetailsCollection.
        ...
        :rtype: list[oci.vn_monitoring.models.CrossConnectMappingDetails]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.vn_monitoring.models.CrossConnectMappingDetails]
        """
        self._items = items
