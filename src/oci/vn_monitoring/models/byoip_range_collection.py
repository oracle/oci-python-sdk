...
class ByoipRangeCollection(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ByoipRangeCollection object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param items:
            The value to assign to the items property of this ByoipRangeCollection.
        :type items: list[oci.vn_monitoring.models.ByoipRangeSummary]

        """
        self.swagger_types = {
            'items': 'list[ByoipRangeSummary]'
        }
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this ByoipRangeCollection.
        ...
        :rtype: list[oci.vn_monitoring.models.ByoipRangeSummary]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.vn_monitoring.models.ByoipRangeSummary]
        """
        self._items = items
