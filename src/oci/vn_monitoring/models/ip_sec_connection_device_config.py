...
class IPSecConnectionDeviceConfig(object):
    ...
    def __init__(self, **kwargs):
        ...
        :type tunnels: list[oci.vn_monitoring.models.TunnelConfig]
    ...
    def tunnels(self):
        ...
        :rtype: list[oci.vn_monitoring.models.TunnelConfig]
        """
    ...
    def tunnels(self, tunnels):
        ...
        :type: list[oci.vn_monitoring.models.TunnelConfig]
        """
