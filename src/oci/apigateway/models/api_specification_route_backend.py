...
class ApiSpecificationRouteBackend(object):
    ...
    #: A constant which can be used with the type property of a ApiSpecificationRouteBackend.
    #: This constant has a value of "OAUTH2_LOGIN_BACKEND"
    TYPE_OAUTH2_LOGIN_BACKEND = "OAUTH2_LOGIN_BACKEND"
    ...
    def __init__(self, **kwargs):
        ...
        * :class:`~oci.apigateway.models.OAuth2LoginBackend`
        * :class:`~oci.apigateway.models.DynamicRoutingBackend`
        ...
        :param type:
            ...
            Allowed values for this property are: "ORACLE_FUNCTIONS_BACKEND", "HTTP_BACKEND", "STOCK_RESPONSE_BACKEND", "DYNAMIC_ROUTING_BACKEND", "OAUTH2_LOGOUT_BACKEND", "OAUTH2_LOGIN_BACKEND", 'UNKNOWN_ENUM_VALUE'.
    ...
    def get_subtype(object_dictionary):
        ...
        if type == 'OAUTH2_LOGIN_BACKEND':
            return 'OAuth2LoginBackend'
    ...
    def type(self, type):
        ...
        :type: str
        """
        allowed_values = ["ORACLE_FUNCTIONS_BACKEND", "HTTP_BACKEND", "STOCK_RESPONSE_BACKEND", "DYNAMIC_ROUTING_BACKEND", "OAUTH2_LOGOUT_BACKEND", "OAUTH2_LOGIN_BACKEND"]
