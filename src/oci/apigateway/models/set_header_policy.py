...
class SetHeaderPolicy(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new SetHeaderPolicy object with values from keyword arguments.
    ...
    def items(self):
        """
        **[Required]** Gets the items of this SetHeaderPolicy.
        The list of headers.
    ...
    def items(self, items):
        """
        Sets the items of this SetHeaderPolicy.
        The list of headers.
