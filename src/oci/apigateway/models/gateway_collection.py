...
class GatewayCollection(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new GatewayCollection object with values from keyword arguments.
    ...
    def items(self):
        """
        **[Required]** Gets the items of this GatewayCollection.
        Gateway summaries.
    ...
    def items(self, items):
        """
        Sets the items of this GatewayCollection.
        Gateway summaries.
