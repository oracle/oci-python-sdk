...
class EntitlementTarget(object):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new EntitlementTarget object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param deployment_id:
            The value to assign to the deployment_id property of this EntitlementTarget.
    ...
    def deployment_id(self, deployment_id):
        """
        Sets the deployment_id of this EntitlementTarget.
        The `OCID`__ of a deployment
        resource.
