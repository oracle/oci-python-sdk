...
class ApiCollection(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ApiCollection object with values from keyword arguments.
    ...
    def items(self):
        """
        **[Required]** Gets the items of this ApiCollection.
        API summaries.
    ...
    def items(self, items):
        """
        Sets the items of this ApiCollection.
        API summaries.
