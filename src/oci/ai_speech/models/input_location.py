...
class InputLocation(object):
    ...
    LOCATION_TYPE_OBJECT_LIST_INLINE_INPUT_LOCATION = "OBJECT_LIST_INLINE_INPUT_LOCATION"

    #: A constant which can be used with the location_type property of a InputLocation.
    #: This constant has a value of "OBJECT_LIST_FILE_INPUT_LOCATION"
    ...
    def __init__(self, **kwargs):
        ...
        * :class:`~oci.ai_speech.models.ObjectListFileInputLocation`
        * :class:`~oci.ai_speech.models.ObjectListInlineInputLocation`
    ...
    def get_subtype(object_dictionary):
        ...
        if type == 'OBJECT_LIST_FILE_INPUT_LOCATION':
            return 'ObjectListFileInputLocation'
    ...
    def location_type(self, location_type):
        ...
        :type: str
        """
        allowed_values = ["OBJECT_LIST_INLINE_INPUT_LOCATION", "OBJECT_LIST_FILE_INPUT_LOCATION"]
