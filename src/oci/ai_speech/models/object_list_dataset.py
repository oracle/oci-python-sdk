...
class ObjectListDataset(LocationDetails):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ObjectListDataset object with values from keyword arguments. The default value of the :py:attr:`~oci.ai_speech.models.ObjectListDataset.location_type` attribute
