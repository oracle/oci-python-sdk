...
class ObjectLocation(object):
    ...
    def __init__(self, **kwargs):
        ...
        :param object_names:
            The value to assign to the object_names property of this ObjectLocation.
    ...
    def object_names(self):
        """
        **[Required]** Gets the object_names of this ObjectLocation.
    ...
    def object_names(self, object_names):
        """
        Sets the object_names of this ObjectLocation.
        Object Storage object names.
