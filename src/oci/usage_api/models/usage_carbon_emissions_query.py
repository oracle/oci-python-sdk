...
class UsageCarbonEmissionsQuery(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new UsageCarbonEmissionsQuery object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param id:
            The value to assign to the id property of this UsageCarbonEmissionsQuery.
        :type id: str

        :param compartment_id:
            The value to assign to the compartment_id property of this UsageCarbonEmissionsQuery.
        :type compartment_id: str

        :param query_definition:
            The value to assign to the query_definition property of this UsageCarbonEmissionsQuery.
    ...
    def id(self):
        """
        **[Required]** Gets the id of this UsageCarbonEmissionsQuery.
        The query OCID.


        :return: The id of this UsageCarbonEmissionsQuery.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        """
        Sets the id of this UsageCarbonEmissionsQuery.
        The query OCID.


        :param id: The id of this UsageCarbonEmissionsQuery.
        :type: str
        """
        self._id = id
    ...
    def compartment_id(self):
        """
        **[Required]** Gets the compartment_id of this UsageCarbonEmissionsQuery.
        The compartment OCID.


        :return: The compartment_id of this UsageCarbonEmissionsQuery.
        :rtype: str
        """
    ...
    def compartment_id(self, compartment_id):
        """
        Sets the compartment_id of this UsageCarbonEmissionsQuery.
        The compartment OCID.


        :param compartment_id: The compartment_id of this UsageCarbonEmissionsQuery.
        :type: str
        """
    ...
    def query_definition(self, query_definition):
        """
        Sets the query_definition of this UsageCarbonEmissionsQuery.
