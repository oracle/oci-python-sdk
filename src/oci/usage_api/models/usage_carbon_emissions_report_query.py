...
class UsageCarbonEmissionsReportQuery(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new UsageCarbonEmissionsReportQuery object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param tenant_id:
            The value to assign to the tenant_id property of this UsageCarbonEmissionsReportQuery.
        :type tenant_id: str

        :param time_usage_started:
            The value to assign to the time_usage_started property of this UsageCarbonEmissionsReportQuery.
        ...
        :param group_by:
            The value to assign to the group_by property of this UsageCarbonEmissionsReportQuery.
        :type group_by: list[str]

        :param group_by_tag:
            The value to assign to the group_by_tag property of this UsageCarbonEmissionsReportQuery.
        :type group_by_tag: list[oci.usage_api.models.Tag]

        :param compartment_depth:
            The value to assign to the compartment_depth property of this UsageCarbonEmissionsReportQuery.
        :type compartment_depth: int

        :param filter:
            The value to assign to the filter property of this UsageCarbonEmissionsReportQuery.
        :type filter: oci.usage_api.models.Filter

        :param date_range_name:
            The value to assign to the date_range_name property of this UsageCarbonEmissionsReportQuery.
    ...
    def tenant_id(self):
        """
        **[Required]** Gets the tenant_id of this UsageCarbonEmissionsReportQuery.
        Tenant ID.


        :return: The tenant_id of this UsageCarbonEmissionsReportQuery.
        :rtype: str
        """
    ...
    def tenant_id(self, tenant_id):
        """
        Sets the tenant_id of this UsageCarbonEmissionsReportQuery.
        Tenant ID.


        :param tenant_id: The tenant_id of this UsageCarbonEmissionsReportQuery.
        :type: str
        """
    ...
    def time_usage_started(self):
        """
        Gets the time_usage_started of this UsageCarbonEmissionsReportQuery.
        The usage start time.


        :return: The time_usage_started of this UsageCarbonEmissionsReportQuery.
        :rtype: datetime
        """
    ...
    def time_usage_started(self, time_usage_started):
        """
        Sets the time_usage_started of this UsageCarbonEmissionsReportQuery.
        The usage start time.


        :param time_usage_started: The time_usage_started of this UsageCarbonEmissionsReportQuery.
        :type: datetime
        """
    ...
    def time_usage_ended(self):
        """
        Gets the time_usage_ended of this UsageCarbonEmissionsReportQuery.
        The usage end time.


        :return: The time_usage_ended of this UsageCarbonEmissionsReportQuery.
        :rtype: datetime
        """
    ...
    def time_usage_ended(self, time_usage_ended):
        """
        Sets the time_usage_ended of this UsageCarbonEmissionsReportQuery.
        The usage end time.


        :param time_usage_ended: The time_usage_ended of this UsageCarbonEmissionsReportQuery.
        :type: datetime
        """
    ...
    def group_by(self):
        """
        Gets the group_by of this UsageCarbonEmissionsReportQuery.
        ...
        :return: The group_by of this UsageCarbonEmissionsReportQuery.
        :rtype: list[str]
        """
    ...
    def group_by(self, group_by):
        """
        Sets the group_by of this UsageCarbonEmissionsReportQuery.
        Specifies what to aggregate the result by.
        For example:
          `[\"tagNamespace\", \"tagKey\", \"tagValue\", \"service\", \"skuName\", \"skuPartNumber\", \"unit\",
            \"compartmentName\", \"compartmentPath\", \"compartmentId\", \"platform\", \"region\", \"logicalAd\",
        ...
        :param group_by: The group_by of this UsageCarbonEmissionsReportQuery.
        :type: list[str]
        """
    ...
    def group_by_tag(self):
        """
        Gets the group_by_tag of this UsageCarbonEmissionsReportQuery.
        GroupBy a specific tagKey. Provide the tagNamespace and tagKey in the tag object. Only supports one tag in the list.
        For example:
          `[{\"namespace\":\"oracle\", \"key\":\"createdBy\"]`


        :return: The group_by_tag of this UsageCarbonEmissionsReportQuery.
    ...
    def group_by_tag(self, group_by_tag):
        """
        Sets the group_by_tag of this UsageCarbonEmissionsReportQuery.
        GroupBy a specific tagKey. Provide the tagNamespace and tagKey in the tag object. Only supports one tag in the list.
        For example:
          `[{\"namespace\":\"oracle\", \"key\":\"createdBy\"]`


        :param group_by_tag: The group_by_tag of this UsageCarbonEmissionsReportQuery.
    ...
    def compartment_depth(self):
        """
        Gets the compartment_depth of this UsageCarbonEmissionsReportQuery.
        The compartment depth level.


        :return: The compartment_depth of this UsageCarbonEmissionsReportQuery.
        :rtype: int
        """
    ...
    def compartment_depth(self, compartment_depth):
        """
        Sets the compartment_depth of this UsageCarbonEmissionsReportQuery.
        The compartment depth level.


        :param compartment_depth: The compartment_depth of this UsageCarbonEmissionsReportQuery.
        :type: int
        """
    ...
    def filter(self):
        ...
        :return: The filter of this UsageCarbonEmissionsReportQuery.
    ...
    def filter(self, filter):
        """
        Sets the filter of this UsageCarbonEmissionsReportQuery.

        :param filter: The filter of this UsageCarbonEmissionsReportQuery.
    ...
    def date_range_name(self):
        ...
        :return: The date_range_name of this UsageCarbonEmissionsReportQuery.
        :rtype: str
        """
    ...
    def date_range_name(self, date_range_name):
        ...
        :type: str
        """
        allowed_values = ["LAST_TWO_MONTHS", "LAST_THREE_MONTHS", "LAST_SIX_MONTHS", "LAST_ONE_YEAR", "CUSTOM"]
