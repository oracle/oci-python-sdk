...
class EmailRecipientsGroupCollection(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new EmailRecipientsGroupCollection object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param items:
            The value to assign to the items property of this EmailRecipientsGroupCollection.
        :type items: list[oci.usage_api.models.EmailRecipientsGroupSummary]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this EmailRecipientsGroupCollection.
        ...
        :rtype: list[oci.usage_api.models.EmailRecipientsGroupSummary]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.usage_api.models.EmailRecipientsGroupSummary]
        """
        self._items = items
