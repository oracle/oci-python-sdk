...
class DatabaseToolsConnectionMySql(DatabaseToolsConnection):
    ...
    def __init__(self, **kwargs):
        ...
        :param runtime_endpoint:
            The value to assign to the runtime_endpoint property of this DatabaseToolsConnectionMySql.
        :type runtime_endpoint: str

        :param runtime_identity:
            The value to assign to the runtime_identity property of this DatabaseToolsConnectionMySql.
