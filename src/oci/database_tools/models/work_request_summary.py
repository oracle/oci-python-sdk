...
class WorkRequestSummary(object):
    ...
    #: This constant has a value of "CREATE_DATABASE_TOOLS_CONNECTION"
    OPERATION_TYPE_CREATE_DATABASE_TOOLS_CONNECTION = "CREATE_DATABASE_TOOLS_CONNECTION"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "UPDATE_DATABASE_TOOLS_CONNECTION"
    OPERATION_TYPE_UPDATE_DATABASE_TOOLS_CONNECTION = "UPDATE_DATABASE_TOOLS_CONNECTION"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "DELETE_DATABASE_TOOLS_CONNECTION"
    OPERATION_TYPE_DELETE_DATABASE_TOOLS_CONNECTION = "DELETE_DATABASE_TOOLS_CONNECTION"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "CREATE_DATABASE_TOOLS_SERVICE_INSTANCE"
    OPERATION_TYPE_CREATE_DATABASE_TOOLS_SERVICE_INSTANCE = "CREATE_DATABASE_TOOLS_SERVICE_INSTANCE"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "UPDATE_DATABASE_TOOLS_SERVICE_INSTANCE"
    OPERATION_TYPE_UPDATE_DATABASE_TOOLS_SERVICE_INSTANCE = "UPDATE_DATABASE_TOOLS_SERVICE_INSTANCE"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "DELETE_DATABASE_TOOLS_SERVICE_INSTANCE"
    OPERATION_TYPE_DELETE_DATABASE_TOOLS_SERVICE_INSTANCE = "DELETE_DATABASE_TOOLS_SERVICE_INSTANCE"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "CREATE_DATABASE_TOOLS_PRIVATE_ENDPOINT"
    OPERATION_TYPE_CREATE_DATABASE_TOOLS_PRIVATE_ENDPOINT = "CREATE_DATABASE_TOOLS_PRIVATE_ENDPOINT"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "UPDATE_DATABASE_TOOLS_PRIVATE_ENDPOINT"
    OPERATION_TYPE_UPDATE_DATABASE_TOOLS_PRIVATE_ENDPOINT = "UPDATE_DATABASE_TOOLS_PRIVATE_ENDPOINT"

    #: A constant which can be used with the operation_type property of a WorkRequestSummary.
    #: This constant has a value of "DELETE_DATABASE_TOOLS_PRIVATE_ENDPOINT"
    OPERATION_TYPE_DELETE_DATABASE_TOOLS_PRIVATE_ENDPOINT = "DELETE_DATABASE_TOOLS_PRIVATE_ENDPOINT"
    ...
    def __init__(self, **kwargs):
        ...
        :param operation_type:
            ...
            Allowed values for this property are: "CREATE_DATABASE_TOOLS_CONNECTION", "UPDATE_DATABASE_TOOLS_CONNECTION", "DELETE_DATABASE_TOOLS_CONNECTION", "CREATE_DATABASE_TOOLS_SERVICE_INSTANCE", "UPDATE_DATABASE_TOOLS_SERVICE_INSTANCE", "DELETE_DATABASE_TOOLS_SERVICE_INSTANCE", "CREATE_DATABASE_TOOLS_PRIVATE_ENDPOINT", "UPDATE_DATABASE_TOOLS_PRIVATE_ENDPOINT", "DELETE_DATABASE_TOOLS_PRIVATE_ENDPOINT", 'UNKNOWN_ENUM_VALUE'.
        ...
        :type resources: list[oci.database_tools.models.WorkRequestResource]
    ...
    def resources(self):
        ...
        :rtype: list[oci.database_tools.models.WorkRequestResource]
        """
    ...
    def resources(self, resources):
        ...
        :type: list[oci.database_tools.models.WorkRequestResource]
        """
