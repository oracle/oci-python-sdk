...
class CreateDatabaseToolsRelatedResourceDetails(object):
    """
    The related resource
    """

    #: A constant which can be used with the entity_type property of a CreateDatabaseToolsRelatedResourceDetails.
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new CreateDatabaseToolsRelatedResourceDetails object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param entity_type:
            The value to assign to the entity_type property of this CreateDatabaseToolsRelatedResourceDetails.
            Allowed values for this property are: "AUTONOMOUSDATABASE", "DATABASE", "PLUGGABLEDATABASE"
        :type entity_type: str

        :param identifier:
            The value to assign to the identifier property of this CreateDatabaseToolsRelatedResourceDetails.
        :type identifier: str
    ...
    def entity_type(self):
        """
        **[Required]** Gets the entity_type of this CreateDatabaseToolsRelatedResourceDetails.
        The resource entity type.

        Allowed values for this property are: "AUTONOMOUSDATABASE", "DATABASE", "PLUGGABLEDATABASE"


        :return: The entity_type of this CreateDatabaseToolsRelatedResourceDetails.
        :rtype: str
        """
    ...
    def entity_type(self, entity_type):
        """
        Sets the entity_type of this CreateDatabaseToolsRelatedResourceDetails.
        The resource entity type.


        :param entity_type: The entity_type of this CreateDatabaseToolsRelatedResourceDetails.
        :type: str
        """
