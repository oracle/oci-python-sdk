...
class WorkRequestCollection(object):
    ...
    def __init__(self, **kwargs):
        ...
        :type items: list[oci.database_tools.models.WorkRequestSummary]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this WorkRequestCollection.
        ...
        :rtype: list[oci.database_tools.models.WorkRequestSummary]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.database_tools.models.WorkRequestSummary]
        """
        self._items = items
