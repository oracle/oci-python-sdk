...
class DatabaseToolsConnectionOracleDatabaseProxyClientNoProxyDetails(DatabaseToolsConnectionOracleDatabaseProxyClientDetails):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new DatabaseToolsConnectionOracleDatabaseProxyClientNoProxyDetails object with values from keyword arguments. The default value of the :py:attr:`~oci.database_tools.models.DatabaseToolsConnectionOracleDatabaseProxyClientNoProxyDetails.proxy_authentication_type` attribute
        of this class is ``NO_PROXY`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param proxy_authentication_type:
            The value to assign to the proxy_authentication_type property of this DatabaseToolsConnectionOracleDatabaseProxyClientNoProxyDetails.
