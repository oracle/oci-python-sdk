...
class DatabaseToolsConnectionCollection(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new DatabaseToolsConnectionCollection object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param items:
            The value to assign to the items property of this DatabaseToolsConnectionCollection.
        :type items: list[oci.database_tools.models.DatabaseToolsConnectionSummary]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this DatabaseToolsConnectionCollection.
        ...
        :rtype: list[oci.database_tools.models.DatabaseToolsConnectionSummary]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.database_tools.models.DatabaseToolsConnectionSummary]
        """
        self._items = items
