...
class DatabaseToolsKeyStoreContentSecretIdSummary(DatabaseToolsKeyStoreContentSummary):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new DatabaseToolsKeyStoreContentSecretIdSummary object with values from keyword arguments. The default value of the :py:attr:`~oci.database_tools.models.DatabaseToolsKeyStoreContentSecretIdSummary.value_type` attribute
        of this class is ``SECRETID`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param value_type:
            The value to assign to the value_type property of this DatabaseToolsKeyStoreContentSecretIdSummary.
            Allowed values for this property are: "SECRETID"
        :type value_type: str

        :param secret_id:
            The value to assign to the secret_id property of this DatabaseToolsKeyStoreContentSecretIdSummary.
        :type secret_id: str
