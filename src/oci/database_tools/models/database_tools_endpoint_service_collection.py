...
class DatabaseToolsEndpointServiceCollection(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new DatabaseToolsEndpointServiceCollection object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param items:
            The value to assign to the items property of this DatabaseToolsEndpointServiceCollection.
        :type items: list[oci.database_tools.models.DatabaseToolsEndpointServiceSummary]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this DatabaseToolsEndpointServiceCollection.
        ...
        :rtype: list[oci.database_tools.models.DatabaseToolsEndpointServiceSummary]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.database_tools.models.DatabaseToolsEndpointServiceSummary]
        """
        self._items = items
