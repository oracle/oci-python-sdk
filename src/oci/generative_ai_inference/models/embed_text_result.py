...
class EmbedTextResult(object):
    ...
    def __init__(self, **kwargs):
        ...
        :param embeddings_by_type:
            The value to assign to the embeddings_by_type property of this EmbedTextResult.
        :type embeddings_by_type: object
    ...
    @property
    def embeddings_by_type(self):
        """
        Gets the embeddings_by_type of this EmbedTextResult.
        The embeddings corresponding to embedding types input.


        :return: The embeddings_by_type of this EmbedTextResult.
        :rtype: object
        """
        return self._embeddings_by_type

    @embeddings_by_type.setter
    def embeddings_by_type(self, embeddings_by_type):
        """
        Sets the embeddings_by_type of this EmbedTextResult.
        The embeddings corresponding to embedding types input.


        :param embeddings_by_type: The embeddings_by_type of this EmbedTextResult.
        :type: object
        """
        self._embeddings_by_type = embeddings_by_type
