...
class AudioUrl(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new AudioUrl object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param url:
            The value to assign to the url property of this AudioUrl.
        :type url: str

        :param detail:
            The value to assign to the detail property of this AudioUrl.
    ...
    def url(self):
        """
        **[Required]** Gets the url of this AudioUrl.
    ...
    def detail(self):
        """
        Gets the detail of this AudioUrl.
        ...
        :return: The detail of this AudioUrl.
        :rtype: str
        """
        return self._detail
    ...
    def detail(self, detail):
        """
        Sets the detail of this AudioUrl.
        The default value is AUTO and only AUTO is supported. This option controls how to convert the base64 encoded audio to tokens.


        :param detail: The detail of this AudioUrl.
        :type: str
        """
