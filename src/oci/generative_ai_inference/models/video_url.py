...
class VideoUrl(object):
    ...
    #: A constant which can be used with the detail property of a VideoUrl.
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new VideoUrl object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param url:
            The value to assign to the url property of this VideoUrl.
        :type url: str

        :param detail:
            The value to assign to the detail property of this VideoUrl.
    ...
    def url(self):
        """
        **[Required]** Gets the url of this VideoUrl.
        The base64 encoded video data or a video uri if it's supported.
    ...
    def detail(self):
        """
        Gets the detail of this VideoUrl.
        ...
        :return: The detail of this VideoUrl.
        :rtype: str
        """
        return self._detail
    ...
    def detail(self, detail):
        """
        Sets the detail of this VideoUrl.
        The default value is AUTO and only AUTO is supported. This option controls how to convert the base64 encoded video to tokens.


        :param detail: The detail of this VideoUrl.
        :type: str
        """
