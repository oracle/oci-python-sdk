...
class JsonObjectResponseFormat(ResponseFormat):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new JsonObjectResponseFormat object with values from keyword arguments. The default value of the :py:attr:`~oci.generative_ai_inference.models.JsonObjectResponseFormat.type` attribute
        of this class is ``JSON_OBJECT`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param type:
            The value to assign to the type property of this JsonObjectResponseFormat.
