...
class UpdateRepositoryDetails(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new UpdateRepositoryDetails object with values from keyword arguments. This class has the following subclasses and if you are using this class as input
        to a service operations then you should favor using a subclass over the base class:

        * :class:`~oci.artifacts.models.UpdateGenericRepositoryDetails`

        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param display_name:
            The value to assign to the display_name property of this UpdateRepositoryDetails.
    ...
    def get_subtype(object_dictionary):
        ...
        if type == 'GENERIC':
            return 'UpdateGenericRepositoryDetails'
        else:
    ...
    def display_name(self):
        """
        Gets the display_name of this UpdateRepositoryDetails.
        The repository name.


        :return: The display_name of this UpdateRepositoryDetails.
        :rtype: str
        """
    ...
    def display_name(self, display_name):
        """
        Sets the display_name of this UpdateRepositoryDetails.
        The repository name.


        :param display_name: The display_name of this UpdateRepositoryDetails.
        :type: str
        """
