...
class PatchInstruction(object):
    ...
    def __init__(self, **kwargs):
        ...
        * :class:`~oci.distributed_database_v26.models.PatchRemoveInstruction`
        * :class:`~oci.distributed_database_v26.models.PatchInsertInstruction`
        * :class:`~oci.distributed_database_v26.models.PatchMergeInstruction`
