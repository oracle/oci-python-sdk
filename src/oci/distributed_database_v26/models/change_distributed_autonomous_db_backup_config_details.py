...
class ChangeDistributedAutonomousDbBackupConfigDetails(object):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ChangeDistributedAutonomousDbBackupConfigDetails object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param db_backup_config:
            The value to assign to the db_backup_config property of this ChangeDistributedAutonomousDbBackupConfigDetails.
    ...
    def db_backup_config(self, db_backup_config):
        """
        Sets the db_backup_config of this ChangeDistributedAutonomousDbBackupConfigDetails.
