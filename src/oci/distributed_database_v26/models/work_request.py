...
class WorkRequest(object):
    ...
    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "ADD_DISTRIBUTED_DB_DG_EXADB"
    OPERATION_TYPE_ADD_DISTRIBUTED_DB_DG_EXADB = "ADD_DISTRIBUTED_DB_DG_EXADB"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "ADD_DISTRIBUTED_DB_DG_ADB"
    OPERATION_TYPE_ADD_DISTRIBUTED_DB_DG_ADB = "ADD_DISTRIBUTED_DB_DG_ADB"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "REMOVE_DISTRIBUTED_DB_DG_ADB"
    OPERATION_TYPE_REMOVE_DISTRIBUTED_DB_DG_ADB = "REMOVE_DISTRIBUTED_DB_DG_ADB"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "REMOVE_DISTRIBUTED_DB_DG_EXADB"
    OPERATION_TYPE_REMOVE_DISTRIBUTED_DB_DG_EXADB = "REMOVE_DISTRIBUTED_DB_DG_EXADB"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "CONFIGURE_DISTRIBUTED_DB_GSMS_WALLET"
    OPERATION_TYPE_CONFIGURE_DISTRIBUTED_DB_GSMS_WALLET = "CONFIGURE_DISTRIBUTED_DB_GSMS_WALLET"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "VALIDATE_CA_BUNDLE"
    OPERATION_TYPE_VALIDATE_CA_BUNDLE = "VALIDATE_CA_BUNDLE"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "RECREATE_FAILED_RESOURCE"
    OPERATION_TYPE_RECREATE_FAILED_RESOURCE = "RECREATE_FAILED_RESOURCE"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "MOVE_REPLICATION_UNITS"
    OPERATION_TYPE_MOVE_REPLICATION_UNITS = "MOVE_REPLICATION_UNITS"
    ...
    def __init__(self, **kwargs):
        ...
        :type resources: list[oci.distributed_database_v26.models.WorkRequestResource]
    ...
    def operation_type(self, operation_type):
        ...
        :type: str
        """
        allowed_values = ["CREATE_DISTRIBUTED_DB", "PATCH_DISTRIBUTED_DB_INSERT_SHARDS", "PATCH_DISTRIBUTED_DB_REMOVE_SHARDS", "PATCH_DISTRIBUTED_DB_MERGE_CATALOG_SHARDS", "DELETE_DISTRIBUTED_DB", "CHANGE_DISTRIBUTED_DB_COMPARTMENT", "CONFIGURE_DISTRIBUTED_DB_GSMS", "CONFIGURE_DISTRIBUTED_DB_SHARDING", "ROTATE_DISTRIBUTED_DB_PASSWORDS", "START_DISTRIBUTED_DB", "STOP_DISTRIBUTED_DB", "START_DISTRIBUTED_DB_SHARD", "START_DISTRIBUTED_DB_CATALOG", "STOP_DISTRIBUTED_DB_SHARD", "STOP_DISTRIBUTED_DB_CATALOG", "CREATE_DISTRIBUTED_DB_SHARD", "CREATE_DISTRIBUTED_DB_CATALOG", "CREATE_DISTRIBUTED_DB_GSM", "UPDATE_DISTRIBUTED_DB_CATALOG_SHARDS", "VALIDATE_NETWORK", "EXECUTE_VALIDATE_NETWORK_TESTS", "CREATE_PRIVATE_ENDPOINT", "DELETE_PRIVATE_ENDPOINT", "CHANGE_PRIVATE_ENDPOINT_COMPARTMENT", "REINSTATE_PROXY_INSTANCE", "DELETE_DISTRIBUTED_DB_SHARD", "DELETE_DISTRIBUTED_DB_CATALOG", "DELETE_DISTRIBUTED_DB_GSM", "ADD_GDSCONTROL_NODE", "CHANGE_DISTRIBUTED_DB_BACKUP_CONFIG", "ADD_DISTRIBUTED_DB_DG_EXADB", "ADD_DISTRIBUTED_DB_DG_ADB", "REMOVE_DISTRIBUTED_DB_DG_ADB", "REMOVE_DISTRIBUTED_DB_DG_EXADB", "CONFIGURE_DISTRIBUTED_DB_GSMS_WALLET", "VALIDATE_CA_BUNDLE", "RECREATE_FAILED_RESOURCE", "MOVE_REPLICATION_UNITS"]
    ...
    def resources(self):
        ...
        **[Required]** Gets the resources of this WorkRequest.
        ...
        :rtype: list[oci.distributed_database_v26.models.WorkRequestResource]
        """
    ...
    def resources(self, resources):
        ...
        :type: list[oci.distributed_database_v26.models.WorkRequestResource]
        """
