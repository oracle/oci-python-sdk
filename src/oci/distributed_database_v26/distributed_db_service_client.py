...
from .models import distributed_database_v26_type_mapping
...
class DistributedDbServiceClient(object):
    ...
    def __init__(self, config, **kwargs):
        ...
        """
        if not OCI_SDK_ENABLED_SERVICES_SET.is_service_enabled("distributed_database_v26"):
        ...
        self.base_client = BaseClient("distributed_db_service", config, signer, distributed_database_v26_type_mapping, **base_client_init_kwargs)
    ...
    def add_distributed_database_gds_control_node(self, distributed_database_id, add_distributed_database_gds_control_node_details, **kwargs):
        ...
        :param oci.distributed_database_v26.models.AddDistributedDatabaseGdsControlNodeDetails add_distributed_database_gds_control_node_details: (required)
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/distributeddatabasev26/add_distributed_database_gds_control_node.py.html>`__ to see an example of how to use add_distributed_database_gds_control_node API.
        """
        ...
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedDatabase/AddDistributedDatabaseGdsControlNode"
    ...
    def change_distributed_database_compartment(self, change_distributed_database_compartment_details, distributed_database_id, **kwargs):
        ...
        :param oci.distributed_database_v26.models.ChangeDistributedDatabaseCompartmentDetails change_distributed_database_compartment_details: (required)
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/distributeddatabasev26/change_distributed_database_compartment.py.html>`__ to see an example of how to use change_distributed_database_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedDatabaseId']
        ...
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedDatabase/ChangeDistributedDatabaseCompartment"
    ...
    def change_distributed_db_backup_config(self, distributed_database_id, change_distributed_db_backup_config_details, **kwargs):
        ...
        :param oci.distributed_database_v26.models.ChangeDistributedDbBackupConfigDetails change_distributed_db_backup_config_details: (required)
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/distributeddatabasev26/change_distributed_db_backup_config.py.html>`__ to see an example of how to use change_distributed_db_backup_config API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedDatabaseId']
        ...
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedDatabase/ChangeDistributedDbBackupConfig"
    ...
    def configure_distributed_database_auto_resource_management(self, distributed_database_id, configure_distributed_database_auto_resource_management_details, **kwargs):
        """
        ...
        :param oci.distributed_database_v26.models.ConfigureDistributedDatabaseAutoResourceManagementDetails configure_distributed_database_auto_resource_management_details: (required)
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.distributed_database_v26.models.DistributedDatabaseAutoResourceManagementDetails`
        :rtype: :class:`~oci.response.Response`

        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/distributeddatabasev26/configure_distributed_database_auto_resource_management.py.html>`__ to see an example of how to use configure_distributed_database_auto_resource_management API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedDatabaseId']
        resource_path = "/distributedDatabases/{distributedDatabaseId}/actions/configureAutoResourceManagement"
        method = "POST"
        operation_name = "configure_distributed_database_auto_resource_management"
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedDatabase/ConfigureDistributedDatabaseAutoResourceManagement"
        ...
        if extra_kwargs:
            raise ValueError(
                f"configure_distributed_database_auto_resource_management got unknown kwargs: {extra_kwargs!r}")
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                response_type="DistributedDatabaseAutoResourceManagementDetails",
                allow_control_chars=kwargs.get('allow_control_chars'),
                enable_strict_url_encoding=kwargs.get('enable_strict_url_encoding'),
                operation_name=operation_name,
                api_reference_link=api_reference_link,
    ...
    def configure_distributed_database_gsms(self, configure_distributed_database_gsms_details, distributed_database_id, **kwargs):
        ...
        :param oci.distributed_database_v26.models.ConfigureDistributedDatabaseGsmsDetails configure_distributed_database_gsms_details: (required)
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/distributeddatabasev26/configure_distributed_database_gsms.py.html>`__ to see an example of how to use configure_distributed_database_gsms API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedDatabaseId']
        ...
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedDatabase/ConfigureDistributedDatabaseGsms"
    ...
    def configure_distributed_database_sharding(self, distributed_database_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/distributeddatabasev26/configure_distributed_database_sharding.py.html>`__ to see an example of how to use configure_distributed_database_sharding API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedDatabaseId']
        ...
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedDatabase/ConfigureDistributedDatabaseSharding"
    ...
    def create_distributed_database(self, create_distributed_database_details, **kwargs):
        ...
        :param oci.distributed_database_v26.models.CreateDistributedDatabaseDetails create_distributed_database_details: (required)
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.distributed_database_v26.models.DistributedDatabase`
        :rtype: :class:`~oci.response.Response`

        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/distributeddatabasev26/create_distributed_database.py.html>`__ to see an example of how to use create_distributed_database API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def delete_distributed_database(self, distributed_database_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/distributeddatabasev26/delete_distributed_database.py.html>`__ to see an example of how to use delete_distributed_database API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedDatabaseId']
        ...
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedDatabase/DeleteDistributedDatabase"
    ...
    def generate_distributed_database_wallet(self, distributed_database_id, generate_distributed_database_wallet_details, **kwargs):
        ...
        :param oci.distributed_database_v26.models.GenerateDistributedDatabaseWalletDetails generate_distributed_database_wallet_details: (required)
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/distributeddatabasev26/generate_distributed_database_wallet.py.html>`__ to see an example of how to use generate_distributed_database_wallet API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedDatabaseId']
        ...
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedDatabase/GenerateDistributedDatabaseWallet"
    ...
    def get_distributed_database(self, distributed_database_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/distributeddatabasev26/get_distributed_database.py.html>`__ to see an example of how to use get_distributed_database API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedDatabaseId']
        resource_path = "/distributedDatabases/{distributedDatabaseId}"
        ...
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedDatabase/GetDistributedDatabase"
    ...
    def get_distributed_database_raft_metric(self, distributed_database_id, **kwargs):
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.distributed_database_v26.models.DistributedDatabaseRaftMetric`
        :rtype: :class:`~oci.response.Response`

        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/distributeddatabasev26/get_distributed_database_raft_metric.py.html>`__ to see an example of how to use get_distributed_database_raft_metric API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedDatabaseId']
        ...
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedDatabase/GetDistributedDatabaseRaftMetric"
    ...
    def get_distributed_database_ru_change_log(self, distributed_database_id, **kwargs):
        """
        ...
        :param str source_shard_name: (optional)
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.distributed_database_v26.models.DistributedDatabaseRuChangeLog`
        :rtype: :class:`~oci.response.Response`

        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/distributeddatabasev26/get_distributed_database_ru_change_log.py.html>`__ to see an example of how to use get_distributed_database_ru_change_log API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedDatabaseId']
        resource_path = "/distributedDatabases/{distributedDatabaseId}/ruChangeLog"
        method = "GET"
        operation_name = "get_distributed_database_ru_change_log"
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedDatabase/GetDistributedDatabaseRuChangeLog"
        ...
        if extra_kwargs:
            raise ValueError(
                f"get_distributed_database_ru_change_log got unknown kwargs: {extra_kwargs!r}")
        ...
        query_params = {
            "sourceShardName": kwargs.get("source_shard_name", missing)
        }
        query_params = {k: v for (k, v) in six.iteritems(query_params) if v is not missing and v is not None}
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                query_params=query_params,
                header_params=header_params,
                response_type="DistributedDatabaseRuChangeLog",
                allow_control_chars=kwargs.get('allow_control_chars'),
                enable_strict_url_encoding=kwargs.get('enable_strict_url_encoding'),
                operation_name=operation_name,
                api_reference_link=api_reference_link,
    ...
    def list_distributed_databases(self, compartment_id, **kwargs):
        ...
        :param bool is_auto_resource_management_enabled: (optional)
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.distributed_database_v26.models.DistributedDatabaseCollection`
        :rtype: :class:`~oci.response.Response`

        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/distributeddatabasev26/list_distributed_databases.py.html>`__ to see an example of how to use list_distributed_databases API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        ...
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedDatabaseCollection/ListDistributedDatabases"
        ...
        expected_kwargs = [
            ...
            "sort_by",
            "opc_request_id",
            "is_auto_resource_management_enabled",
            "display_name",
            "db_deployment_type",
            "metadata"
        ]
        ...
        query_params = {
            ...
            "isAutoResourceManagementEnabled": kwargs.get("is_auto_resource_management_enabled", missing),
    ...
    def move_distributed_database_replication_unit(self, distributed_database_id, move_distributed_database_replication_unit_details, **kwargs):
        ...
        :param oci.distributed_database_v26.models.MoveDistributedDatabaseReplicationUnitDetails move_distributed_database_replication_unit_details: (required)
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/distributeddatabasev26/move_distributed_database_replication_unit.py.html>`__ to see an example of how to use move_distributed_database_replication_unit API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedDatabaseId']
        ...
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedDatabase/MoveDistributedDatabaseReplicationUnit"
    ...
    def patch_distributed_database(self, distributed_database_id, patch_distributed_database_details, **kwargs):
        ...
        :param oci.distributed_database_v26.models.PatchDistributedDatabaseDetails patch_distributed_database_details: (required)
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/distributeddatabasev26/patch_distributed_database.py.html>`__ to see an example of how to use patch_distributed_database API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedDatabaseId']
        resource_path = "/distributedDatabases/{distributedDatabaseId}"
        ...
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedDatabase/PatchDistributedDatabase"
    ...
    def recreate_failed_distributed_database_resource(self, distributed_database_id, resource_name, **kwargs):
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/distributeddatabasev26/recreate_failed_distributed_database_resource.py.html>`__ to see an example of how to use recreate_failed_distributed_database_resource API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        ...
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedDatabase/RecreateFailedDistributedDatabaseResource"
    ...
    def rotate_distributed_database_passwords(self, distributed_database_id, rotate_distributed_database_passwords_details, **kwargs):
        """
        ...
        :param oci.distributed_database_v26.models.RotateDistributedDatabasePasswordsDetails rotate_distributed_database_passwords_details: (required)
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/distributeddatabasev26/rotate_distributed_database_passwords.py.html>`__ to see an example of how to use rotate_distributed_database_passwords API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedDatabaseId']
        ...
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedDatabase/RotateDistributedDatabasePasswords"
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                path_params=path_params,
                header_params=header_params,
                body=rotate_distributed_database_passwords_details,
                allow_control_chars=kwargs.get('allow_control_chars'),
                enable_strict_url_encoding=kwargs.get('enable_strict_url_encoding'),
                operation_name=operation_name,
                api_reference_link=api_reference_link,
    ...
    def scale_distributed_database_gsms(self, scale_distributed_database_gsms_details, distributed_database_id, **kwargs):
        """
        Scale global service manager(GSM aka shard manager) instances for the Globally distributed database.


        :param oci.distributed_database_v26.models.ScaleDistributedDatabaseGsmsDetails scale_distributed_database_gsms_details: (required)
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/distributeddatabasev26/scale_distributed_database_gsms.py.html>`__ to see an example of how to use scale_distributed_database_gsms API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedDatabaseId']
        resource_path = "/distributedDatabases/{distributedDatabaseId}/actions/scaleGsms"
        method = "POST"
        operation_name = "scale_distributed_database_gsms"
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedDatabase/ScaleDistributedDatabaseGsms"
        ...
        if extra_kwargs:
            raise ValueError(
                f"scale_distributed_database_gsms got unknown kwargs: {extra_kwargs!r}")
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                path_params=path_params,
                header_params=header_params,
                body=scale_distributed_database_gsms_details,
                allow_control_chars=kwargs.get('allow_control_chars'),
                enable_strict_url_encoding=kwargs.get('enable_strict_url_encoding'),
                operation_name=operation_name,
                api_reference_link=api_reference_link,
    ...
    def start_distributed_database(self, distributed_database_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/distributeddatabasev26/start_distributed_database.py.html>`__ to see an example of how to use start_distributed_database API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedDatabaseId']
        ...
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedDatabase/StartDistributedDatabase"
    ...
    def stop_distributed_database(self, distributed_database_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/distributeddatabasev26/stop_distributed_database.py.html>`__ to see an example of how to use stop_distributed_database API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedDatabaseId']
        ...
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedDatabase/StopDistributedDatabase"
    ...
    def update_distributed_database(self, distributed_database_id, update_distributed_database_details, **kwargs):
        ...
        :param oci.distributed_database_v26.models.UpdateDistributedDatabaseDetails update_distributed_database_details: (required)
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/distributeddatabasev26/update_distributed_database.py.html>`__ to see an example of how to use update_distributed_database API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedDatabaseId']
        resource_path = "/distributedDatabases/{distributedDatabaseId}"
        ...
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedDatabase/UpdateDistributedDatabase"
    ...
    def validate_distributed_database_network(self, distributed_database_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/distributeddatabasev26/validate_distributed_database_network.py.html>`__ to see an example of how to use validate_distributed_database_network API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['distributedDatabaseId']
        ...
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/globally-distributed-database/20260101/DistributedDatabase/ValidateDistributedDatabaseNetwork"
