...
from .models import container_registry_type_mapping
...
class ContainerRegistryClient(object):
    ...
    def __init__(self, config, **kwargs):
        ...
        """
        if not OCI_SDK_ENABLED_SERVICES_SET.is_service_enabled("container_registry"):
        ...
        base_client_init_kwargs = {
            ...
            'base_path': '/20180419',
            'service_endpoint_template': 'https://ocir.{region}.oci.{secondLevelDomain}',
            'endpoint_service_name': 'ocir',
        ...
        self.base_client = BaseClient("container_registry", config, signer, container_registry_type_mapping, **base_client_init_kwargs)
    ...
    def get_access_token(self, **kwargs):
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.container_registry.models.AccessToken`
        :rtype: :class:`~oci.response.Response`

        :example:
        Click `here <https://docs.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/containerregistry/get_access_token.py.html>`__ to see an example of how to use get_access_token API.
        """
        ...
        if extra_kwargs:
            raise ValueError(
                f"get_access_token got unknown kwargs: {extra_kwargs!r}")
