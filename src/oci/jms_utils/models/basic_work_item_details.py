...
class BasicWorkItemDetails(WorkItemDetails):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new BasicWorkItemDetails object with values from keyword arguments. The default value of the :py:attr:`~oci.jms_utils.models.BasicWorkItemDetails.kind` attribute
