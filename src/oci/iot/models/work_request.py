...
class WorkRequest(object):
    ...
    #: This constant has a value of "CREATE_IOT_DOMAIN"
    OPERATION_TYPE_CREATE_IOT_DOMAIN = "CREATE_IOT_DOMAIN"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "UPDATE_IOT_DOMAIN"
    OPERATION_TYPE_UPDATE_IOT_DOMAIN = "UPDATE_IOT_DOMAIN"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "DELETE_IOT_DOMAIN"
    OPERATION_TYPE_DELETE_IOT_DOMAIN = "DELETE_IOT_DOMAIN"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "MOVE_IOT_DOMAIN"
    OPERATION_TYPE_MOVE_IOT_DOMAIN = "MOVE_IOT_DOMAIN"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "MOVE_IOT_DOMAIN_GROUP"
    OPERATION_TYPE_MOVE_IOT_DOMAIN_GROUP = "MOVE_IOT_DOMAIN_GROUP"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "CREATE_IOT_DOMAIN_GROUP"
    OPERATION_TYPE_CREATE_IOT_DOMAIN_GROUP = "CREATE_IOT_DOMAIN_GROUP"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "UPDATE_IOT_DOMAIN_GROUP"
    OPERATION_TYPE_UPDATE_IOT_DOMAIN_GROUP = "UPDATE_IOT_DOMAIN_GROUP"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "DELETE_IOT_DOMAIN_GROUP"
    OPERATION_TYPE_DELETE_IOT_DOMAIN_GROUP = "DELETE_IOT_DOMAIN_GROUP"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "CONFIGURE_DOMAIN_DATA_ACCESS"
    OPERATION_TYPE_CONFIGURE_DOMAIN_DATA_ACCESS = "CONFIGURE_DOMAIN_DATA_ACCESS"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "CONFIGURE_DOMAIN_GROUP_DATA_ACCESS"
    OPERATION_TYPE_CONFIGURE_DOMAIN_GROUP_DATA_ACCESS = "CONFIGURE_DOMAIN_GROUP_DATA_ACCESS"
    ...
    def __init__(self, **kwargs):
        ...
        :param status:
            ...
            Allowed values for this property are: "ACCEPTED", "IN_PROGRESS", "WAITING", "NEEDS_ATTENTION", "FAILED", "SUCCEEDED", 'UNKNOWN_ENUM_VALUE'.
            Any unrecognized values returned by a service will be mapped to 'UNKNOWN_ENUM_VALUE'.
        :type status: str
        ...
        :type resources: list[oci.iot.models.WorkRequestResource]
    ...
    def status(self, status):
        ...
        :type: str
        """
        allowed_values = ["ACCEPTED", "IN_PROGRESS", "WAITING", "NEEDS_ATTENTION", "FAILED", "SUCCEEDED"]
    ...
    def resources(self):
        ...
        **[Required]** Gets the resources of this WorkRequest.
        ...
        :rtype: list[oci.iot.models.WorkRequestResource]
        """
    ...
    def resources(self, resources):
        ...
        :type: list[oci.iot.models.WorkRequestResource]
        """
