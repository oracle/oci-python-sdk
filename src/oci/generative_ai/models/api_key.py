...
class ApiKey(object):
    ...
    def __init__(self, **kwargs):
        ...
        :param display_name:
            The value to assign to the display_name property of this ApiKey.
        ...
        :param compartment_id:
            The value to assign to the compartment_id property of this ApiKey.
        ...
        :param time_updated:
            The value to assign to the time_updated property of this ApiKey.
        :type time_updated: datetime

        :param keys:
            The value to assign to the keys property of this ApiKey.
        ...
        :param lifecycle_details:
            The value to assign to the lifecycle_details property of this ApiKey.
        :type lifecycle_details: str

        :param freeform_tags:
            The value to assign to the freeform_tags property of this ApiKey.
        :type freeform_tags: dict(str, str)

        :param defined_tags:
            The value to assign to the defined_tags property of this ApiKey.
        :type defined_tags: dict(str, dict(str, object))

        :param system_tags:
            The value to assign to the system_tags property of this ApiKey.
    ...
    def id(self):
        """
        **[Required]** Gets the id of this ApiKey.
        the ApiKey id.
    ...
    def display_name(self):
        """
        **[Required]** Gets the display_name of this ApiKey.
        A user-friendly name. Does not have to be unique, and it's changeable.


        :return: The display_name of this ApiKey.
        :rtype: str
        """
    ...
    def display_name(self, display_name):
        ...
        :param display_name: The display_name of this ApiKey.
        :type: str
        """
    ...
    def compartment_id(self):
        """
        **[Required]** Gets the compartment_id of this ApiKey.
        The compartment OCID to create the apiKey in.


        :return: The compartment_id of this ApiKey.
        :rtype: str
        """
    ...
    def compartment_id(self, compartment_id):
        """
        Sets the compartment_id of this ApiKey.
        The compartment OCID to create the apiKey in.


        :param compartment_id: The compartment_id of this ApiKey.
        :type: str
        """
    ...
    def time_created(self):
        """
        **[Required]** Gets the time_created of this ApiKey.
    ...
    def time_updated(self):
        """
        Gets the time_updated of this ApiKey.
        The date and time the ApiKey was updated, in the format defined by RFC 3339.


        :return: The time_updated of this ApiKey.
        :rtype: datetime
        """
    ...
    def time_updated(self, time_updated):
        """
        Sets the time_updated of this ApiKey.
        The date and time the ApiKey was updated, in the format defined by RFC 3339.


        :param time_updated: The time_updated of this ApiKey.
        :type: datetime
        """
    ...
    def keys(self):
        """
        **[Required]** Gets the keys of this ApiKey.
        The list of keys.


        :return: The keys of this ApiKey.
    ...
    def keys(self, keys):
        """
        Sets the keys of this ApiKey.
        The list of keys.


        :param keys: The keys of this ApiKey.
    ...
    def lifecycle_details(self, lifecycle_details):
        """
        Sets the lifecycle_details of this ApiKey.
        A message describing the current state with detail that can provide actionable information.


        :param lifecycle_details: The lifecycle_details of this ApiKey.
        :type: str
        """
    ...
    def freeform_tags(self):
        """
        Gets the freeform_tags of this ApiKey.
    ...
    def freeform_tags(self, freeform_tags):
        """
        Sets the freeform_tags of this ApiKey.
        Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace.
        For more information, see `Resource Tags`__.
    ...
    def defined_tags(self):
        """
        Gets the defined_tags of this ApiKey.
    ...
    def defined_tags(self, defined_tags):
        """
        Sets the defined_tags of this ApiKey.
        Defined tags for this resource. Each key is predefined and scoped to a namespace.
        For more information, see `Resource Tags`__.
    ...
    def system_tags(self):
        """
        Gets the system_tags of this ApiKey.
        System tags for this resource. Each key is predefined and scoped to a namespace.

        Example: `{\"orcl-cloud\": {\"free-tier-retained\": \"true\"}}`


        :return: The system_tags of this ApiKey.
        :rtype: dict(str, dict(str, object))
        """
    ...
    def system_tags(self, system_tags):
        """
        Sets the system_tags of this ApiKey.
        System tags for this resource. Each key is predefined and scoped to a namespace.

        Example: `{\"orcl-cloud\": {\"free-tier-retained\": \"true\"}}`


        :param system_tags: The system_tags of this ApiKey.
        :type: dict(str, dict(str, object))
        """
