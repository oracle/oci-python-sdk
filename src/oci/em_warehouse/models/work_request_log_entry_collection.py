...
class WorkRequestLogEntryCollection(object):
    ...
    def __init__(self, **kwargs):
        ...
        :type items: list[oci.em_warehouse.models.WorkRequestLogEntry]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this WorkRequestLogEntryCollection.
        ...
        :rtype: list[oci.em_warehouse.models.WorkRequestLogEntry]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.em_warehouse.models.WorkRequestLogEntry]
        """
        self._items = items
