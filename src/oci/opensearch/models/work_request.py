...
class WorkRequest(object):
    ...
    #: This constant has a value of "CREATE_OPENSEARCH_CLUSTER"
    OPERATION_TYPE_CREATE_OPENSEARCH_CLUSTER = "CREATE_OPENSEARCH_CLUSTER"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "UPDATE_OPENSEARCH_CLUSTER"
    OPERATION_TYPE_UPDATE_OPENSEARCH_CLUSTER = "UPDATE_OPENSEARCH_CLUSTER"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "DELETE_OPENSEARCH_CLUSTER"
    OPERATION_TYPE_DELETE_OPENSEARCH_CLUSTER = "DELETE_OPENSEARCH_CLUSTER"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "MOVE_OPENSEARCH_CLUSTER"
    OPERATION_TYPE_MOVE_OPENSEARCH_CLUSTER = "MOVE_OPENSEARCH_CLUSTER"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "RESTORE_OPENSEARCH_CLUSTER"
    OPERATION_TYPE_RESTORE_OPENSEARCH_CLUSTER = "RESTORE_OPENSEARCH_CLUSTER"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "BACKUP_OPENSEARCH_CLUSTER"
    OPERATION_TYPE_BACKUP_OPENSEARCH_CLUSTER = "BACKUP_OPENSEARCH_CLUSTER"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "UPDATE_OPENSEARCH_CLUSTER_BACKUP"
    OPERATION_TYPE_UPDATE_OPENSEARCH_CLUSTER_BACKUP = "UPDATE_OPENSEARCH_CLUSTER_BACKUP"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "MOVE_OPENSEARCH_CLUSTER_BACKUP"
    OPERATION_TYPE_MOVE_OPENSEARCH_CLUSTER_BACKUP = "MOVE_OPENSEARCH_CLUSTER_BACKUP"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "DELETE_OPENSEARCH_CLUSTER_BACKUP"
    OPERATION_TYPE_DELETE_OPENSEARCH_CLUSTER_BACKUP = "DELETE_OPENSEARCH_CLUSTER_BACKUP"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "UPDATE_OPENSEARCH_CLUSTER_SECURITY_CONFIG"
    ...
    def __init__(self, **kwargs):
        ...
        :param operation_type:
            ...
            Allowed values for this property are: "CREATE_OPENSEARCH_CLUSTER", "UPDATE_OPENSEARCH_CLUSTER", "DELETE_OPENSEARCH_CLUSTER", "MOVE_OPENSEARCH_CLUSTER", "RESTORE_OPENSEARCH_CLUSTER", "BACKUP_OPENSEARCH_CLUSTER", "UPDATE_OPENSEARCH_CLUSTER_BACKUP", "MOVE_OPENSEARCH_CLUSTER_BACKUP", "DELETE_OPENSEARCH_CLUSTER_BACKUP", "UPDATE_OPENSEARCH_CLUSTER_SECURITY_CONFIG", 'UNKNOWN_ENUM_VALUE'.
        ...
        :type resources: list[oci.opensearch.models.WorkRequestResource]
    ...
    def operation_type(self, operation_type):
        ...
        :type: str
        """
        allowed_values = ["CREATE_OPENSEARCH_CLUSTER", "UPDATE_OPENSEARCH_CLUSTER", "DELETE_OPENSEARCH_CLUSTER", "MOVE_OPENSEARCH_CLUSTER", "RESTORE_OPENSEARCH_CLUSTER", "BACKUP_OPENSEARCH_CLUSTER", "UPDATE_OPENSEARCH_CLUSTER_BACKUP", "MOVE_OPENSEARCH_CLUSTER_BACKUP", "DELETE_OPENSEARCH_CLUSTER_BACKUP", "UPDATE_OPENSEARCH_CLUSTER_SECURITY_CONFIG"]
    ...
    def resources(self):
        ...
        **[Required]** Gets the resources of this WorkRequest.
        ...
        :rtype: list[oci.opensearch.models.WorkRequestResource]
        """
    ...
    def resources(self, resources):
        ...
        :type: list[oci.opensearch.models.WorkRequestResource]
        """
    ...
    def time_started(self):
        ...
        The date and time the work request transitioned from ACCEPTED to IN_PROGRESS, in the format defined by `RFC 3339`__.
    ...
    def time_finished(self):
        ...
        The date and time the work request reached a terminal state, either FAILED or SUCCEEDED, in the format defined by `RFC 3339`__.
