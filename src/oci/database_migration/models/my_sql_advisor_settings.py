...
class MySqlAdvisorSettings(object):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new MySqlAdvisorSettings object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param is_skip_advisor:
            The value to assign to the is_skip_advisor property of this MySqlAdvisorSettings.
        :type is_skip_advisor: bool

        :param is_ignore_errors:
            The value to assign to the is_ignore_errors property of this MySqlAdvisorSettings.
    ...
    def is_skip_advisor(self):
        """
        Gets the is_skip_advisor of this MySqlAdvisorSettings.
        True to skip the Pre-Migration Advisor execution. Default is false.


        :return: The is_skip_advisor of this MySqlAdvisorSettings.
        :rtype: bool
        """
    ...
    def is_skip_advisor(self, is_skip_advisor):
        """
        Sets the is_skip_advisor of this MySqlAdvisorSettings.
        True to skip the Pre-Migration Advisor execution. Default is false.


        :param is_skip_advisor: The is_skip_advisor of this MySqlAdvisorSettings.
        :type: bool
        """
    ...
    def is_ignore_errors(self):
        """
        Gets the is_ignore_errors of this MySqlAdvisorSettings.
        True to not interrupt migration execution due to Pre-Migration Advisor errors. Default is false.


        :return: The is_ignore_errors of this MySqlAdvisorSettings.
        :rtype: bool
        """
    ...
    def is_ignore_errors(self, is_ignore_errors):
        """
        Sets the is_ignore_errors of this MySqlAdvisorSettings.
        True to not interrupt migration execution due to Pre-Migration Advisor errors. Default is false.


        :param is_ignore_errors: The is_ignore_errors of this MySqlAdvisorSettings.
        :type: bool
        """
