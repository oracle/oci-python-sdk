...
class OracleAssessment(Assessment):
    """
    ...
    def __init__(self, **kwargs):
        ...
        :param id:
            The value to assign to the id property of this OracleAssessment.
        :type id: str

        :param description:
            The value to assign to the description property of this OracleAssessment.
        ...
        :param display_name:
            The value to assign to the display_name property of this OracleAssessment.
        :type display_name: str

        :param compartment_id:
            The value to assign to the compartment_id property of this OracleAssessment.
        ...
        :param migration_id:
            The value to assign to the migration_id property of this OracleAssessment.
        :type migration_id: str

        :param source_database_connection:
            The value to assign to the source_database_connection property of this OracleAssessment.
        :type source_database_connection: oci.database_migration.models.SourceAssessmentConnection

        :param target_database_connection:
            The value to assign to the target_database_connection property of this OracleAssessment.
        ...
        :param time_created:
            The value to assign to the time_created property of this OracleAssessment.
        :type time_created: datetime

        :param time_updated:
            The value to assign to the time_updated property of this OracleAssessment.
        :type time_updated: datetime

        :param freeform_tags:
            The value to assign to the freeform_tags property of this OracleAssessment.
        :type freeform_tags: dict(str, str)

        :param defined_tags:
            The value to assign to the defined_tags property of this OracleAssessment.
    ...
    def is_cdb_supported(self):
        """
        Gets the is_cdb_supported of this OracleAssessment.
        True if CDB should be defined, false otherwise.


        :return: The is_cdb_supported of this OracleAssessment.
        :rtype: bool
        """
    ...
    def is_cdb_supported(self, is_cdb_supported):
        """
        Sets the is_cdb_supported of this OracleAssessment.
        True if CDB should be defined, false otherwise.


        :param is_cdb_supported: The is_cdb_supported of this OracleAssessment.
        :type: bool
        """
