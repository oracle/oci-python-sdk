...
class CreateCurlTransferDetails(CreateHostDumpTransferDetails):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new CreateCurlTransferDetails object with values from keyword arguments. The default value of the :py:attr:`~oci.database_migration.models.CreateCurlTransferDetails.kind` attribute
