...
class ObjectStorageDataTransferMediumDetails(DataTransferMediumDetailsV2):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ObjectStorageDataTransferMediumDetails object with values from keyword arguments. The default value of the :py:attr:`~oci.database_migration.models.ObjectStorageDataTransferMediumDetails.type` attribute
        of this class is ``OBJECT_STORAGE`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param type:
            The value to assign to the type property of this ObjectStorageDataTransferMediumDetails.
            Allowed values for this property are: "DBLINK", "OBJECT_STORAGE", "AWS_S3", "NFS"
        :type type: str

        :param object_storage_bucket:
            The value to assign to the object_storage_bucket property of this ObjectStorageDataTransferMediumDetails.
    ...
    def object_storage_bucket(self):
        """
        Gets the object_storage_bucket of this ObjectStorageDataTransferMediumDetails.

        :return: The object_storage_bucket of this ObjectStorageDataTransferMediumDetails.
    ...
    def object_storage_bucket(self, object_storage_bucket):
        """
        Sets the object_storage_bucket of this ObjectStorageDataTransferMediumDetails.

        :param object_storage_bucket: The object_storage_bucket of this ObjectStorageDataTransferMediumDetails.
