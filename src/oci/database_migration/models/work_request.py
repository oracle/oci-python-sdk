...
class WorkRequest(object):
    ...
    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "CREATE_ASSESSMENT"
    OPERATION_TYPE_CREATE_ASSESSMENT = "CREATE_ASSESSMENT"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "DELETE_ASSESSMENT"
    OPERATION_TYPE_DELETE_ASSESSMENT = "DELETE_ASSESSMENT"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "UPDATE_ASSESSMENT"
    OPERATION_TYPE_UPDATE_ASSESSMENT = "UPDATE_ASSESSMENT"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "RUN_ASSESSOR_ACTION"
    OPERATION_TYPE_RUN_ASSESSOR_ACTION = "RUN_ASSESSOR_ACTION"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "RUN_MIGRATE_TABLE_ASSESSOR"
    OPERATION_TYPE_RUN_MIGRATE_TABLE_ASSESSOR = "RUN_MIGRATE_TABLE_ASSESSOR"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "RUN_COMPATIBILITY_ASSESSOR"
    OPERATION_TYPE_RUN_COMPATIBILITY_ASSESSOR = "RUN_COMPATIBILITY_ASSESSOR"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "RUN_VIABILITY_ASSESSOR"
    OPERATION_TYPE_RUN_VIABILITY_ASSESSOR = "RUN_VIABILITY_ASSESSOR"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "CONFIGURE_MIGRATION_ASSESSOR"
    OPERATION_TYPE_CONFIGURE_MIGRATION_ASSESSOR = "CONFIGURE_MIGRATION_ASSESSOR"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "CREATE_MIGRATION_ASSESSOR"
    OPERATION_TYPE_CREATE_MIGRATION_ASSESSOR = "CREATE_MIGRATION_ASSESSOR"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "PREPARE_SOURCE_ASSESSOR"
    OPERATION_TYPE_PREPARE_SOURCE_ASSESSOR = "PREPARE_SOURCE_ASSESSOR"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "PREPARE_TARGET_ASSESSOR"
    OPERATION_TYPE_PREPARE_TARGET_ASSESSOR = "PREPARE_TARGET_ASSESSOR"

    #: A constant which can be used with the operation_type property of a WorkRequest.
    #: This constant has a value of "CONFIRM_VIABILITY_ASSESSOR"
    OPERATION_TYPE_CONFIRM_VIABILITY_ASSESSOR = "CONFIRM_VIABILITY_ASSESSOR"
    ...
    def operation_type(self, operation_type):
        ...
        :type: str
        """
        allowed_values = ["CREATE_MIGRATION", "CLONE_MIGRATION", "DELETE_MIGRATION", "UPDATE_MIGRATION", "START_MIGRATION", "VALIDATE_MIGRATION", "CREATE_CONNECTION", "DELETE_CONNECTION", "UPDATE_CONNECTION", "CREATE_ASSESSMENT", "DELETE_ASSESSMENT", "UPDATE_ASSESSMENT", "RUN_ASSESSOR_ACTION", "RUN_MIGRATE_TABLE_ASSESSOR", "RUN_COMPATIBILITY_ASSESSOR", "RUN_VIABILITY_ASSESSOR", "CONFIGURE_MIGRATION_ASSESSOR", "CREATE_MIGRATION_ASSESSOR", "PREPARE_SOURCE_ASSESSOR", "PREPARE_TARGET_ASSESSOR", "CONFIRM_VIABILITY_ASSESSOR"]
