...
class UpdateOracleConnectionDetails(UpdateConnectionDetails):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new UpdateOracleConnectionDetails object with values from keyword arguments. The default value of the :py:attr:`~oci.database_migration.models.UpdateOracleConnectionDetails.connection_type` attribute
        ...
        :param replication_username:
            The value to assign to the replication_username property of this UpdateOracleConnectionDetails.
        :type replication_username: str

        :param replication_password:
            The value to assign to the replication_password property of this UpdateOracleConnectionDetails.
        ...
        :param ssh_host:
            The value to assign to the ssh_host property of this UpdateOracleConnectionDetails.
        :type ssh_host: str

        :param ssh_key:
            The value to assign to the ssh_key property of this UpdateOracleConnectionDetails.
        :type ssh_key: str

        :param ssh_user:
            The value to assign to the ssh_user property of this UpdateOracleConnectionDetails.
        :type ssh_user: str

        :param ssh_sudo_location:
            The value to assign to the ssh_sudo_location property of this UpdateOracleConnectionDetails.
    ...
    def ssh_host(self):
        """
        Gets the ssh_host of this UpdateOracleConnectionDetails.
        Name of the host the SSH key is valid for.


        :return: The ssh_host of this UpdateOracleConnectionDetails.
        :rtype: str
        """
    ...
    def ssh_host(self, ssh_host):
        """
        Sets the ssh_host of this UpdateOracleConnectionDetails.
        Name of the host the SSH key is valid for.


        :param ssh_host: The ssh_host of this UpdateOracleConnectionDetails.
        :type: str
        """
    ...
    def ssh_key(self):
        """
        Gets the ssh_key of this UpdateOracleConnectionDetails.
        Private SSH key string.


        :return: The ssh_key of this UpdateOracleConnectionDetails.
        :rtype: str
        """
    ...
    def ssh_key(self, ssh_key):
        """
        Sets the ssh_key of this UpdateOracleConnectionDetails.
        Private SSH key string.


        :param ssh_key: The ssh_key of this UpdateOracleConnectionDetails.
        :type: str
        """
    ...
    def ssh_user(self):
        """
        Gets the ssh_user of this UpdateOracleConnectionDetails.
        The username (credential) used when creating or updating this resource.


        :return: The ssh_user of this UpdateOracleConnectionDetails.
        :rtype: str
        """
    ...
    def ssh_user(self, ssh_user):
        """
        Sets the ssh_user of this UpdateOracleConnectionDetails.
        The username (credential) used when creating or updating this resource.


        :param ssh_user: The ssh_user of this UpdateOracleConnectionDetails.
        :type: str
        """
    ...
    def ssh_sudo_location(self):
        """
        Gets the ssh_sudo_location of this UpdateOracleConnectionDetails.
        Sudo location


        :return: The ssh_sudo_location of this UpdateOracleConnectionDetails.
        :rtype: str
        """
    ...
    def ssh_sudo_location(self, ssh_sudo_location):
        """
        Sets the ssh_sudo_location of this UpdateOracleConnectionDetails.
        Sudo location


        :param ssh_sudo_location: The ssh_sudo_location of this UpdateOracleConnectionDetails.
        :type: str
        """
