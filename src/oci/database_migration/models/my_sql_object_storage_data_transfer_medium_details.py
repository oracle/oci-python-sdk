...
class MySqlObjectStorageDataTransferMediumDetails(MySqlDataTransferMediumDetails):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new MySqlObjectStorageDataTransferMediumDetails object with values from keyword arguments. The default value of the :py:attr:`~oci.database_migration.models.MySqlObjectStorageDataTransferMediumDetails.type` attribute
        of this class is ``OBJECT_STORAGE`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param type:
            The value to assign to the type property of this MySqlObjectStorageDataTransferMediumDetails.
            Allowed values for this property are: "OBJECT_STORAGE"
        :type type: str

        :param object_storage_bucket:
            The value to assign to the object_storage_bucket property of this MySqlObjectStorageDataTransferMediumDetails.
    ...
    def object_storage_bucket(self):
        ...
        :return: The object_storage_bucket of this MySqlObjectStorageDataTransferMediumDetails.
    ...
    def object_storage_bucket(self, object_storage_bucket):
        """
        Sets the object_storage_bucket of this MySqlObjectStorageDataTransferMediumDetails.

        :param object_storage_bucket: The object_storage_bucket of this MySqlObjectStorageDataTransferMediumDetails.
