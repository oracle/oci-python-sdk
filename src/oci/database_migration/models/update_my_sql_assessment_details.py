...
class UpdateMySqlAssessmentDetails(UpdateAssessmentDetails):
    """
    Update MySql Assessment resource parameters.
    """

    #: A constant which can be used with the migration_scope property of a UpdateMySqlAssessmentDetails.
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new UpdateMySqlAssessmentDetails object with values from keyword arguments. The default value of the :py:attr:`~oci.database_migration.models.UpdateMySqlAssessmentDetails.database_combination` attribute
        of this class is ``MYSQL`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param description:
            The value to assign to the description property of this UpdateMySqlAssessmentDetails.
        :type description: str

        :param database_combination:
            The value to assign to the database_combination property of this UpdateMySqlAssessmentDetails.
            Allowed values for this property are: "MYSQL", "ORACLE"
        :type database_combination: str

        :param display_name:
            The value to assign to the display_name property of this UpdateMySqlAssessmentDetails.
        :type display_name: str

        :param network_speed_megabit_per_second:
            The value to assign to the network_speed_megabit_per_second property of this UpdateMySqlAssessmentDetails.
        ...
        :param acceptable_downtime:
            The value to assign to the acceptable_downtime property of this UpdateMySqlAssessmentDetails.
        ...
        :param database_data_size:
            The value to assign to the database_data_size property of this UpdateMySqlAssessmentDetails.
        ...
        :param ddl_expectation:
            The value to assign to the ddl_expectation property of this UpdateMySqlAssessmentDetails.
            Allowed values for this property are: "DDL_EXPECTED", "DDL_NOT_EXPECTED"
        :type ddl_expectation: str

        :param creation_type:
            The value to assign to the creation_type property of this UpdateMySqlAssessmentDetails.
        ...
        :param source_database_connection:
            The value to assign to the source_database_connection property of this UpdateMySqlAssessmentDetails.
        :type source_database_connection: oci.database_migration.models.SourceAssessmentConnection

        :param target_database_connection:
            The value to assign to the target_database_connection property of this UpdateMySqlAssessmentDetails.
        :type target_database_connection: oci.database_migration.models.TargetAssessmentConnection

        :param freeform_tags:
            The value to assign to the freeform_tags property of this UpdateMySqlAssessmentDetails.
        :type freeform_tags: dict(str, str)

        :param defined_tags:
            The value to assign to the defined_tags property of this UpdateMySqlAssessmentDetails.
        :type defined_tags: dict(str, dict(str, object))

        :param migration_scope:
            The value to assign to the migration_scope property of this UpdateMySqlAssessmentDetails.
    ...
    def migration_scope(self):
        """
        Gets the migration_scope of this UpdateMySqlAssessmentDetails.
        Assessment migration scope.

        Allowed values for this property are: "SCHEMA", "FULL"


        :return: The migration_scope of this UpdateMySqlAssessmentDetails.
        :rtype: str
        """
    ...
    def migration_scope(self, migration_scope):
        """
        Sets the migration_scope of this UpdateMySqlAssessmentDetails.
        Assessment migration scope.


        :param migration_scope: The migration_scope of this UpdateMySqlAssessmentDetails.
        :type: str
        """
