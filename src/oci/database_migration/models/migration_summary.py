...
class MigrationSummary(object):
    ...
    #: A constant which can be used with the database_combination property of a MigrationSummary.
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new MigrationSummary object with values from keyword arguments. This class has the following subclasses and if you are using this class as input
        to a service operations then you should favor using a subclass over the base class:

        * :class:`~oci.database_migration.models.OracleMigrationSummary`
        * :class:`~oci.database_migration.models.MySqlMigrationSummary`
        ...
        :param database_combination:
            The value to assign to the database_combination property of this MigrationSummary.
    ...
    def get_subtype(object_dictionary):
        ...
        if type == 'ORACLE':
            return 'OracleMigrationSummary'

        if type == 'MYSQL':
            return 'MySqlMigrationSummary'
        else:
    ...
    def database_combination(self):
        """
        **[Required]** Gets the database_combination of this MigrationSummary.
        ...
        :return: The database_combination of this MigrationSummary.
        :rtype: str
        """
    ...
    def database_combination(self, database_combination):
        """
        Sets the database_combination of this MigrationSummary.
        The combination of source and target databases participating in a migration.
        Example: ORACLE means the migration is meant for migrating Oracle source and target databases.


        :param database_combination: The database_combination of this MigrationSummary.
        :type: str
        """
