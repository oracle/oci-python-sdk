...
class WorkRequestCollection(object):
    ...
    def __init__(self, **kwargs):
        ...
        :type items: list[oci.data_flow.models.WorkRequestSummary]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this WorkRequestCollection.
        ...
        :rtype: list[oci.data_flow.models.WorkRequestSummary]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.data_flow.models.WorkRequestSummary]
        """
        self._items = items
