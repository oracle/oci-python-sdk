...
class ShowOCIService(object):
    ...
    def __load_identity_compartments(self, identity):
        ...
        try:
            ...
            all_compartments = []
            try:
                all_compartments = oci.pagination.list_call_get_all_results(identity.list_compartments,
                                                                            tenancy['id'],
            ...
            def build_compartments_nested(identity_client, cid, path):
                try:
                    compartment_list = [item for item in all_compartments if item.compartment_id == cid]
                    ...
                    for c in compartment_list:
                        if c.lifecycle_state == oci.identity.models.Compartment.LIFECYCLE_STATE_ACTIVE:
                            ...
                            build_compartments_nested(identity_client, c.id, value['path'])
