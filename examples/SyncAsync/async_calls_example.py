...
"""Run three OCI Generative AI chat calls concurrently with the async client."""
...
async def main():
    ...
    async with AsyncGenerativeAiInferenceClient(
        ...
        # asyncio.gather schedules all three independent API calls concurrently.
    ...
    print("Async elapsed time: {:.2f} seconds".format(time.perf_counter() - started))
