...
#
# https://docs.oracle.com/iaas/Content/ContEng/Concepts/contengoverview.htm
...
def create_vcn(vn_client, ads, number_of_worker_subnets=1, number_of_lb_subnets=1):
    ...
    See https://docs.oracle.com/iaas/Content/ContEng/Concepts/contengnetworkconfig.htm#VCN
    ...
    https://docs.oracle.com/iaas/Content/ContEng/Concepts/contengnetworkconfigexample.htm
    ...
    # https://docs.oracle.com/iaas/Content/ContEng/Concepts/contengnetworkconfig.htm#securitylistconfig
    ################
    ...
    # https://docs.oracle.com/iaas/Content/ContEng/Concepts/contengnetworkconfig.htm#subnetconfig
    ################
